...
// This code is duplicated from https://github.com/kubernetes/code-generator/blob/master/cmd/deepcopy-gen/main.go
// so that this repository can utilize the deepcopy-gen functionality.
package main
