...
// This code is duplicated from https://github.com/kubernetes/code-generator/blob/master/cmd/client-gen/main.go
// so that this repository can utilize the client-gen functionality.
package main
