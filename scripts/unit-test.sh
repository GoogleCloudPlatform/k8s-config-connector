...
unset VALIDATE_URLS
UNIT_TEST_PACKAGES=$(go list ./pkg/... ./cmd/... ./config/tests/... ./dev/tools/crd-mcp-server/... ./scripts/resource-autogen/... ./scripts/generate-google3-docs/... ./tests/... ./experiments/conductor/cmd/runner/... | grep -v tests/e2e)
