...
<td>bigqueryconnection/v1/connections</td>
</tr>
<tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}The password for the credential.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}The username for the credential.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
...
spec:
  ...
  projectRef:
    external: ${PROJECT_ID?}
  description: "BigQueryConnection CloudResource Connection"
  cloudResource:
    serviceAccountId: ""
```
