...
<td><a href="https://docs.cloud.google.com/compute/docs/reference/rest/beta/networkFirewallPolicies">https://docs.cloud.google.com/compute/docs/reference/rest/beta/networkFirewallPolicies</a></td>
</tr>
<tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>The ComputeNetworkFirewallPolicy name. If not given, the metadata.name will be used.</p>
        </td>
    </tr>
</tbody>
</table>
...
<tbody>
    <tr>
        ...
        <td>
            ...
            <p>Conditions represent the latest available observations of the ComputeNetworkFirewallPolicy's current state.</p>
        </td>
    </tr>
    <tr>
        <td><code>conditions[]</code></td>
