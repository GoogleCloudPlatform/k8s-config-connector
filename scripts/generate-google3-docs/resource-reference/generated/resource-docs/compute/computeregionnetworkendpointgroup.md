...
title: "ComputeRegionNetworkEndpointGroup"
---
<table>
<thead>
<tr>
...
<td><a href="https://docs.cloud.google.com/compute/docs/reference/rest/beta/regionNetworkEndpointGroups">https://docs.cloud.google.com/compute/docs/reference/rest/beta/regionNetworkEndpointGroups</a></td>
</tr>
<tr>
...
<tbody>
    <tr>
        ...
        <td>
            ...
            <p>Immutable. Only valid when networkEndpointType is "SERVERLESS".
Only one of cloud_run, app_engine, cloud_function or serverless_deployment may be set.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>Immutable. A user-defined name of the Cloud Function.
The function name is case-sensitive and must be 1-63 characters long.
Example value: "func1".</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <p>Allowed value: The `name` field of a `CloudFunctionsFunction` resource.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. A template to parse function field from a request URL. URL mask allows
for routing to multiple Cloud Functions without having to create
multiple Network Endpoint Groups and backend services.

For example, request URLs "mydomain.com/function1" and "mydomain.com/function2"
can be backed by the same Serverless NEG with URL mask "/". The URL mask
will parse them to { function = "function1" } and { function = "function2" } respectively.</p>
        </td>
    </tr>
    <tr>
        <td>
...
Only one of cloud_run, app_engine, cloud_function or serverless_deployment may be set.</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>Immutable. Cloud Run service is the main resource of Cloud Run.
The service must be 1-63 characters long, and comply with RFC1035.
Example value: "run-service".</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Allowed value: The `name` field of a `RunService` resource.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. Cloud Run tag represents the "named-revision" to provide
additional fine-grained traffic routing information.
The tag must be 1-63 characters long, and comply with RFC1035.
Example value: "revision-0010".</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. A template to parse service and tag fields from a request URL.
...
and { service="bar2", tag="foo2" } respectively.</p>
        </td>
    </tr>
    <tr>
        <td>
...
you create the resource.</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>Immutable. This field is only used for PSC.
...
"default" project network if unspecified.</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. The target service url used to set up private service connection to
a Google API or a PSC Producer Service Attachment.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. A reference to the region where the Serverless NEGs Reside.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>Immutable. This field is only used for PSC.
Optional URL of the subnetwork to which all network endpoints in the NEG belong.</p>
        </td>
    </tr>
    <tr>
        <td>
