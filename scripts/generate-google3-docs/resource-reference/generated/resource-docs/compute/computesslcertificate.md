...
<td>computesslcertificate<br>gcpcomputesslcertificate<br>gcpcomputesslcertificates</td>
</tr>
<tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>Immutable. The write-only private key in PEM format.</p>
        </td>
    </tr>
    <tr>
        <td>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <p>Conditions represent the latest available observations of the ComputeSSLCertificate's current state.</p>
        </td>
    </tr>
    <tr>
        <td><code>conditions[]</code></td>
