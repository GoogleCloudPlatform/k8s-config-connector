...
resource, this field is visible only if it has a non-empty value.{% endverbatim %}</p>
    ...
    <tr>
        ...
        <td>
            ...
            <p>{% verbatim %}Immutable. The customer-supplied encryption key of the snapshot. Required if the
source snapshot is protected by a customer-supplied encryption key.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
