...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. The networking tier used for configuring this address. If this field is not specified, it is assumed to be PREMIUM. This argument should not be used when configuring Internal addresses, because network tier cannot be set for internal traffic; it's always Premium. Possible values: ["PREMIUM", "STANDARD"].</p>
        </td>
    </tr>
    <tr>
        <td>
