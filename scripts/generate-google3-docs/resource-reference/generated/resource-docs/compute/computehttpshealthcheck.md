...
<td><a href="https://docs.cloud.google.com/compute/docs/reference/rest/v1/httpsHealthChecks">https://docs.cloud.google.com/compute/docs/reference/rest/v1/httpsHealthChecks</a></td>
</tr>
<tr>
...
consecutive successes. The default value is 2.</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>The value of the host header in the HTTPS health check request. If
