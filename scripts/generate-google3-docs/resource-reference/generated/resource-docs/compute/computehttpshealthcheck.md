...
{% block page_title %}ComputeHTTPSHealthCheck{% endblock %}
{% block body %}
...
<td>gcpcomputehttpshealthcheck<br>gcpcomputehttpshealthchecks<br>computehttpshealthcheck</td>
</tr>
<tr>
...
consecutive successes. The default value is 2.{% endverbatim %}</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}The value of the host header in the HTTPS health check request. If
