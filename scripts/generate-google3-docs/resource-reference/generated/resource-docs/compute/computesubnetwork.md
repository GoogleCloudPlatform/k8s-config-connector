...
cannot enable direct path. Possible values: ["EXTERNAL"].{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
...
access Google APIs and services by using Private Google Access.{% endverbatim %}</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}Immutable. The purpose of the resource. A subnetwork with purpose set to
...
If set to INTERNAL_HTTPS_LOAD_BALANCER you must also set the 'role' field.{% endverbatim %}</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}The role of subnetwork. Currently, this field is only used when
