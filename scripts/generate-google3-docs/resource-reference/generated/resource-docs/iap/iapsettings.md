...
spec:
  # Replace ${PROJECT_ID?} with your project ID
  name: projects/${PROJECT_ID?}/iap_web/compute-us-central1/services/iapsettings-dep-backendservice
  accessSettings:
    corsSettings:
      allowHTTPOptions: true
    reauthSettings:
