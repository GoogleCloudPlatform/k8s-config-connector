...
<td>gcpsourcereporepositories<br>gcpsourcereporepository<br>sourcereporepository</td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        ...
        <p>projects/{{project}}/repos/{{name}}</p>
...
<tbody>
    <tr>
        ...
        <td>
            ...
            <p>How this repository publishes a change in the repository through Cloud Pub/Sub.
Keyed by the topic names.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            ...
            <p>The format of the Cloud Pub/Sub messages.
- PROTOBUF: The message payload is a serialized protocol buffer of SourceRepoEvent.
- JSON: The message payload is a JSON string of SourceRepoEvent. Possible values: ["PROTOBUF", "JSON"].</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>Service account used for publishing Cloud Pub/Sub messages. This
...
account.</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Allowed value: The `name` field of a `PubSubTopic` resource.</p>
        </td>
    </tr>
    <tr>
        <td>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">integer</code></p>
            <p>The disk usage of the repo, in bytes.</p>
        </td>
    </tr>
    <tr>
        <td><code>url</code></td>
        <td>
            <p><code class="apitype">string</code></p>
            <p>URL to clone the repository from Google Cloud Source Repositories.</p>
        </td>
    </tr>
</tbody>
</table>
