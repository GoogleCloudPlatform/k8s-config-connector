...
{% block page_title %}ServiceDirectoryNamespace{% endblock %}
{% block body %}
...
<tr>
    ...
    <td>
        ...
        <p>{% verbatim %}projects/{{project}}/locations/{{location}}/namespaces/{{namespace_id}}{% endverbatim %}</p>
...
'gcloud beta service-directory locations list'.{% endverbatim %}</p>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}Immutable. Optional. The namespaceId of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default.{% endverbatim %}</p>
        </td>
    </tr>
</tbody>
</table>
