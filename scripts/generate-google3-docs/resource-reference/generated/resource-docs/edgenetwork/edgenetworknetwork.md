...
<td>projects.locations.zones.networks</td>
</tr>
<tr>
...
<td>edgenetworknetwork<br>gcpedgenetworknetwork<br>gcpedgenetworknetworks</td>
</tr>
<tr>
...
<td>edgenetworknetworks.edgenetwork.cnrm.cloud.google.com</td>
</tr>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <p>Immutable. IP (L3) MTU value of the network. Default value is '1500'. Possible values are: '1500', '9000'.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. Optional. The networkId of the resource. Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default.</p>
        </td>
    </tr>
    <tr>
        <td>
...
'projects/{{project}}/locations/{{location}}/zones/{{zone}}/networks/{{network_id}}'.</p>
        </td>
    </tr>
    <tr>
