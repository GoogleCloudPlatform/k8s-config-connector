...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>{% verbatim %}KMSCryptoKeyRef defines the resource reference to KMSCryptoKey, which "External" field holds the GCP identifier for the KRM object.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
