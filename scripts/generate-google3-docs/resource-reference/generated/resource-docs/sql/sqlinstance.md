...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}A reference to an externally managed SpannerInstance resource. Should be in the format "projects/{{projectID}}/buckets/{{bucketID}}".{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}The name of a SpannerInstance resource.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}The namespace of a SpannerInstance resource.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
