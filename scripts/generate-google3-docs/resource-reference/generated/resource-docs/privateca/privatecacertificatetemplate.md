...
title: "PrivateCACertificateTemplate"
---
<table>
<thead>
<tr>
...
<tbody>
    <tr>
        ...
        <td>
            ...
            <p>Optional. A human-readable description of scenarios this template is intended for.</p>
        </td>
    </tr>
    <tr>
        <td>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Output only. The time at which this CertificateTemplate was created.</p>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Output only. The time at which this CertificateTemplate was updated.</p>
        </td>
    </tr>
</tbody>
</table>
