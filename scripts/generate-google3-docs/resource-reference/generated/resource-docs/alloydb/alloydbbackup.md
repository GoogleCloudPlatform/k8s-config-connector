...
<tbody>
    <tr>
        ...
        <td>
            ...
            <p>{% verbatim %}Conditions represent the latest available observations of the AlloyDBBackup's current state.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td><code>conditions[]</code></td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}A unique specifier for the AlloyDBBackup resource in GCP.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
