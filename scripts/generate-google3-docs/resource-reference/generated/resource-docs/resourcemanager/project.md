...
title: "Project"
---
Note: To create <code>Project</code> resources, your Config Connector
IAM service account must have
`roles/resourcemanager.projectCreator` on the Google Cloud
organization in which you want to create the project, and the
IAM service account must belong to a project with the
Cloud Resource Manager API enabled.

Note: To link <code>Project</code> resources to Cloud Billing
accounts, your Config Connector IAM service account
must have `roles/billing.user` on the Cloud Billing account, and the
IAM service account must belong to a project with the
