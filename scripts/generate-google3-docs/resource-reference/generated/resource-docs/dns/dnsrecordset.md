...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>Immutable. The DNS name this record set will apply to.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>The configuration for steering traffic based on query. You can specify either Weighted Round Robin(WRR) type or Geolocation(GEO) type.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <p>Specifies whether to enable fencing for geo queries.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <p>The configuration for Geo location based routing policy.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>For A and AAAA types only. The list of targets to be health checked. These can be specified along with `rrdatas` within this item.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">list (object)</code></p>
            <p>The list of internal load balancers to health check.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>The configured IP protocol of the load balancer. This value is case-sensitive. Possible values: ["tcp", "udp"].</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>The type of load balancer. This value is case-sensitive. Possible values: ["regionalL4ilb", "regionalL7ilb", "globalL7ilb"].</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>The configured port of the load balancer.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>The location name defined in Google Cloud.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>The configuration for a primary-backup policy with global to regional failover. Queries are responded to with the global primary targets, but if none of the primary targets are healthy, then we fallback to a regional failover policy.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">list (object)</code></p>
            <p>The backup geo targets, which provide a regional failover policy for the otherwise global primary targets.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">boolean</code></p>
            <p>Specifies whether to enable fencing for backup geo queries.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>The list of global primary targets to be health checked.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            ...
            <p>Specifies the percentage of traffic to send to the backup targets even when the primary targets are healthy.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">list (object)</code></p>
            <p>The configuration for Weighted Round Robin based routing policy.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>The list of targets to be health checked. Note that if DNSSEC is enabled for this zone, only one of `rrdatas` or `health_checked_targets` can be set.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">float</code></p>
            <p>The ratio of traffic routed to the target.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <p>DEPRECATED. Although this field is still available, there is limited support. We recommend that you use `spec.rrdatasRefs` instead.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            ...
            <p>The time-to-live of this record set (seconds).</p>
        </td>
    </tr>
    <tr>
        <td>
