...
{% block page_title %}IAMWorkloadIdentityPool{% endblock %}
{% block body %}
...
<tbody>
    <tr>
        ...
        <td>
            ...
            <p>{% verbatim %}A description of the pool. Cannot exceed 256 characters.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>{% verbatim %}A display name for the pool. Cannot exceed 32 characters.{% endverbatim %}</p>
        </td>
    </tr>
    <tr>
        <td>
