...
<tbody>
    ...
    <tr>
        ...
        <td>
            ...
            <p>The storage class that objects in the bucket eventually transition to if they are not accessed for a certain period of time. Supported values include: NEARLINE, ARCHIVE.</p>
        </td>
    </tr>
    <tr>
        <td>
