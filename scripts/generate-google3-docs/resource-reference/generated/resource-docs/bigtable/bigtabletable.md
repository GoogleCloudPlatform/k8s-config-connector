...
<td><a href="https://docs.cloud.google.com/bigtable/docs/reference/admin/rest/v2/projects.instances.tables">https://docs.cloud.google.com/bigtable/docs/reference/admin/rest/v2/projects.instances.tables</a></td>
</tr>
<tr>
<td>Config Connector Resource Short Names</td>
<td>bigtabletable<br>gcpbigtabletable<br>gcpbigtabletables</td>
</tr>
<tr>
...
<tr>
    ...
    <td>
        ...
        <p>projects/{{project}}/instances/{{instance_name}}/tables/{{name}}</p>
...
<tbody>
    <tr>
        ...
        <td>
            ...
            <p>Duration to retain change stream data for the table. Set to 0 to disable. Must be between 1 and 7 days..</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <p>The names of the column families that should be created immediately upon table creation, specified by name. The values that may be set are specified here. At least one column family must be specified.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>NOTE: DeletionProtection proto field is changed from string (1.38) to bool (1.40) in cloud.google.com/go/bigtable/admin/apiv2/adminpb
...
Note one can still delete the data stored in the table through Data APIs.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            <p><code class="apitype">object</code></p>
            <p>Immutable. The instance to create the table in.</p>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>The BigtableTable name. If not given, the metadata.name will be used.</p>
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td>
            ...
            <p>A list of predefined keys to split the table on.</p>
        </td>
    </tr>
    <tr>
        <td>
...
<tbody>
    ...
    <tr>
        ...
        <td>
            <p><code class="apitype">string</code></p>
            <p>A unique specifier for the BigtableTable resource in Google Cloud.</p>
        </td>
    </tr>
    <tr>
