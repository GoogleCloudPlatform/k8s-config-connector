...
directive strips the <code>nodeConfig</code> and <code>nodeVersion</code> from the
desired state during updates, while preserving them during initial cluster
creation. This unblocks users who need to specify <code>nodeConfig</code> or
<code>nodeVersion</code> for the temporary default pool (e.g. for custom
