...
<tbody>
    ...
    <tr>
        <td>
            <p><code>encryptionConfiguration.kmsKeyRef.autoKeyRef</code></p>
            <p><i>Optional</i></p>
        </td>
        <td>
            <p><code class="apitype">object</code></p>
    ...
    <tr>
        <td>
            <p><code>encryptionConfiguration.kmsKeyRef.autoKeyRef.name</code></p>
            <p><i>Optional</i></p>
        </td>
        <td>
            <p><code class="apitype">string</code></p>
    ...
    <tr>
        <td>
            <p><code>encryptionConfiguration.kmsKeyRef.autoKeyRef.namespace</code></p>
            <p><i>Optional</i></p>
        </td>
        <td>
            <p><code class="apitype">string</code></p>
