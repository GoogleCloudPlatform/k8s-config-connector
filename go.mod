...
require (
	cloud.google.com/go/alloydb v1.1.0
	cloud.google.com/go/apikeys v1.1.0
	...
	cloud.google.com/go/workstations v0.4.0
...
require (
	cloud.google.com/go/cloudquotas v1.3.0 // indirect
	cloud.google.com/go/managedkafka v0.4.0 // indirect
	cloud.google.com/go/privilegedaccessmanager v0.2.1 // indirect
	cloud.google.com/go/securesourcemanager v1.1.1 // indirect
