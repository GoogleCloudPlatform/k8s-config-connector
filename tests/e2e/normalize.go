...
func buildKRMNormalizer(t *testing.T, u *unstructured.Unstructured, project testgcp.GCPProject, folderID string, uniqueID string) *objectWalker {
	...
	visitor.ReplacePath(".status.observedState.autoclass.terminalStorageClassUpdateTime", "1970-01-01T00:00:00Z")
	visitor.ReplacePath(".status.observedState.autoclass.toggleTime", "1970-01-01T00:00:00Z")
