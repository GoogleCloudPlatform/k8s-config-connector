	...
	t.Run("fixtures", func(t *testing.T) {
		...
		for _, fixture := range fixtures {
			...
			t.Run(testName, func(t *testing.T) {
				...
				if fixture.GVK.Group == "networkservices.cnrm.cloud.google.com" && fixture.GVK.Kind == "NetworkServicesServiceLBPolicy" {
					t.Skip("skipping NetworkServicesServiceLBPolicy as the controller is not implemented yet")
				}
