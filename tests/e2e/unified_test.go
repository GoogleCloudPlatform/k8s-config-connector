	...
	t.Run("fixtures", func(t *testing.T) {
		...
		for _, fixture := range fixtures {
			...
			t.Run(testName, func(t *testing.T) {
				...
				if fixture.GVK.Group == "discoveryengine.cnrm.cloud.google.com" && fixture.GVK.Kind == "DiscoveryEngineWidgetConfig" {
					t.Skip("skipping DiscoveryEngineWidgetConfig as the controller is not implemented yet")
				}
