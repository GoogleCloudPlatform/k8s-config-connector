	...
	t.Run("fixtures", func(t *testing.T) {
		...
		for _, fixture := range fixtures {
			...
			t.Run(testName, func(t *testing.T) {
				...
				if fixture.GVK.Group == "networksecurity.cnrm.cloud.google.com" && fixture.GVK.Kind == "NetworkSecurityMirroringDeploymentGroup" {
					t.Skip("skipping NetworkSecurityMirroringDeploymentGroup as the controller is not implemented yet")
				}
