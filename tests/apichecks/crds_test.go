...
func TestCRDObjectTypes(t *testing.T) {
	...
	knownInvalidCRDs := map[string]bool{
		...
		"vertexaionlineevaluators.vertexai.cnrm.cloud.google.com":                       true, // spec.metricSources[].metric.exactMatchSpec and status.observedState.stateDetails[] are empty objects
