...
*   **Bias for Action:** We prefer correct code over "perfect" code. If the controller is complete/idiomatic, test fixtures exist, and all CI checks are green (success), LGTM the PR.
...
Use to `.gemini/skills/reviewgen-greenfield-controller/SKILL.md` to conduct the review.
