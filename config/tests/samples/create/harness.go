...
func MaybeSkip(t *testing.T, testKey string, resources []*unstructured.Unstructured) {
	...
	if gcpTarget == "mock" {
		for _, resource := range resources {
			...
			case schema.GroupKind{Group: "compute.cnrm.cloud.google.com", Kind: "ComputePublicAdvertisedPrefix"}:
			case schema.GroupKind{Group: "compute.cnrm.cloud.google.com", Kind: "ComputePublicDelegatedPrefix"}:
