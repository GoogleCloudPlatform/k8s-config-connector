...
func MaybeSkip(t *testing.T, testKey string, resources []*unstructured.Unstructured) {
	...
	if gcpTarget == "mock" {
		for _, resource := range resources {
			...
			case schema.GroupKind{Group: "gkehub.cnrm.cloud.google.com", Kind: "GKEHubNamespace"}:
			case schema.GroupKind{Group: "gkehub.cnrm.cloud.google.com", Kind: "GKEHubMembershipBinding"}:
			case schema.GroupKind{Group: "gkehub.cnrm.cloud.google.com", Kind: "GKEHubScopeRBACRoleBinding"}:
