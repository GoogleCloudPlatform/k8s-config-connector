...
func run(ctx context.Context) error {
	...
	for {
		...
		// Cleanup stale watches. This shouldn't actually be necessary since CRDs aren't ever
		// deleted in practice, but it seems like not a bad idea to handle this case anyway.
