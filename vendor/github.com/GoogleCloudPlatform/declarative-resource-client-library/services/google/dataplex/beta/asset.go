...
func (r *Asset) ID() (string, error) {
	...
	params := map[string]interface{}{
		...
		"resourceSpec":    dcl.ValueOrEmptyString(nr.ResourceSpec),
		"resourceStatus":  dcl.ValueOrEmptyString(nr.ResourceStatus),
		"securityStatus":  dcl.ValueOrEmptyString(nr.SecurityStatus),
		"discoverySpec":   dcl.ValueOrEmptyString(nr.DiscoverySpec),
		"discoveryStatus": dcl.ValueOrEmptyString(nr.DiscoveryStatus),
