...
func (r *Function) ID() (string, error) {
	...
	params := map[string]interface{}{
		...
		"sourceArchiveUrl":           dcl.ValueOrEmptyString(nr.SourceArchiveUrl),
		"sourceRepository":           dcl.ValueOrEmptyString(nr.SourceRepository),
		"httpsTrigger":               dcl.ValueOrEmptyString(nr.HttpsTrigger),
		"eventTrigger":               dcl.ValueOrEmptyString(nr.EventTrigger),
		"status":                     dcl.ValueOrEmptyString(nr.Status),
		"entryPoint":                 dcl.ValueOrEmptyString(nr.EntryPoint),
		"runtime":                    dcl.ValueOrEmptyString(nr.Runtime),
		"timeout":                    dcl.ValueOrEmptyString(nr.Timeout),
		"availableMemoryMb":          dcl.ValueOrEmptyString(nr.AvailableMemoryMb),
		"serviceAccountEmail":        dcl.ValueOrEmptyString(nr.ServiceAccountEmail),
		"updateTime":                 dcl.ValueOrEmptyString(nr.UpdateTime),
		"versionId":                  dcl.ValueOrEmptyString(nr.VersionId),
		"labels":                     dcl.ValueOrEmptyString(nr.Labels),
		"environmentVariables":       dcl.ValueOrEmptyString(nr.EnvironmentVariables),
		"maxInstances":               dcl.ValueOrEmptyString(nr.MaxInstances),
		"vPCConnector":               dcl.ValueOrEmptyString(nr.VPCConnector),
		"vPCConnectorEgressSettings": dcl.ValueOrEmptyString(nr.VPCConnectorEgressSettings),
		"ingressSettings":            dcl.ValueOrEmptyString(nr.IngressSettings),
