...
func (r *Organization) ID() (string, error) {
	...
	params := map[string]interface{}{
		...
		"expiresAt":                        dcl.ValueOrEmptyString(nr.ExpiresAt),
		"environments":                     dcl.ValueOrEmptyString(nr.Environments),
		"properties":                       dcl.ValueOrEmptyString(nr.Properties),
		"analyticsRegion":                  dcl.ValueOrEmptyString(nr.AnalyticsRegion),
		"authorizedNetwork":                dcl.ValueOrEmptyString(nr.AuthorizedNetwork),
		"runtimeType":                      dcl.ValueOrEmptyString(nr.RuntimeType),
		"subscriptionType":                 dcl.ValueOrEmptyString(nr.SubscriptionType),
		"billingType":                      dcl.ValueOrEmptyString(nr.BillingType),
		"addonsConfig":                     dcl.ValueOrEmptyString(nr.AddonsConfig),
		"caCertificate":                    dcl.ValueOrEmptyString(nr.CaCertificate),
		"runtimeDatabaseEncryptionKeyName": dcl.ValueOrEmptyString(nr.RuntimeDatabaseEncryptionKeyName),
