...
func (r *ClusterConfigGkeClusterConfig) validate() error {
...
func (r *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) validate() error {
	return nil
}
...
func canonicalizeClusterConfig(des, initial *ClusterConfig, opts ...dcl.ApplyOption) *ClusterConfig {
	...
	cDes.GkeClusterConfig = canonicalizeClusterConfigGkeClusterConfig(des.GkeClusterConfig, initial.GkeClusterConfig, opts...)
...
func canonicalizeNewClusterConfig(c *Client, des, nw *ClusterConfig) *ClusterConfig {
	...
	nw.GkeClusterConfig = canonicalizeNewClusterConfigGkeClusterConfig(c, des.GkeClusterConfig, nw.GkeClusterConfig)
...
func canonicalizeClusterConfigGkeClusterConfig(des, initial *ClusterConfigGkeClusterConfig, opts ...dcl.ApplyOption) *ClusterConfigGkeClusterConfig {
	...
	cDes := &ClusterConfigGkeClusterConfig{}

	cDes.NamespacedGkeDeploymentTarget = canonicalizeClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(des.NamespacedGkeDeploymentTarget, initial.NamespacedGkeDeploymentTarget, opts...)
...
func canonicalizeClusterConfigGkeClusterConfigSlice(des, initial []ClusterConfigGkeClusterConfig, opts ...dcl.ApplyOption) []ClusterConfigGkeClusterConfig {
	...
	if len(des) != len(initial) {
		...
		items := make([]ClusterConfigGkeClusterConfig, 0, len(des))
		for _, d := range des {
			cd := canonicalizeClusterConfigGkeClusterConfig(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]ClusterConfigGkeClusterConfig, 0, len(des))
	for i, d := range des {
		cd := canonicalizeClusterConfigGkeClusterConfig(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewClusterConfigGkeClusterConfig(c *Client, des, nw *ClusterConfigGkeClusterConfig) *ClusterConfigGkeClusterConfig {
	...
	nw.NamespacedGkeDeploymentTarget = canonicalizeNewClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, des.NamespacedGkeDeploymentTarget, nw.NamespacedGkeDeploymentTarget)

	return nw
}

func canonicalizeNewClusterConfigGkeClusterConfigSet(c *Client, des, nw []ClusterConfigGkeClusterConfig) []ClusterConfigGkeClusterConfig {
	if des == nil {
		return nw
	}
...
func canonicalizeNewClusterConfigGkeClusterConfigSlice(c *Client, des, nw []ClusterConfigGkeClusterConfig) []ClusterConfigGkeClusterConfig {
	...
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewClusterConfigGkeClusterConfig(c, &d, &n))
	}
...
func canonicalizeClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(des, initial []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, opts ...dcl.ApplyOption) []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	...
	if len(des) != len(initial) {
		...
		items := make([]ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, 0, len(des))
		for _, d := range des {
			cd := canonicalizeClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, 0, len(des))
	for i, d := range des {
		cd := canonicalizeClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c *Client, des, nw *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
...
func canonicalizeNewClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSet(c *Client, des, nw []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	if des == nil {
		return nw
	}
...
func canonicalizeNewClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(c *Client, des, nw []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	...
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, &d, &n))
	}
...
func compareClusterConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.GceClusterConfig, actual.GceClusterConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigGceClusterConfigNewStyle, EmptyObject: EmptyClusterConfigGceClusterConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("GceClusterConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.MasterConfig, actual.MasterConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigMasterConfigNewStyle, EmptyObject: EmptyClusterConfigMasterConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("MasterConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.WorkerConfig, actual.WorkerConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigWorkerConfigNewStyle, EmptyObject: EmptyClusterConfigWorkerConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("WorkerConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.SecondaryWorkerConfig, actual.SecondaryWorkerConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigSecondaryWorkerConfigNewStyle, EmptyObject: EmptyClusterConfigSecondaryWorkerConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("SecondaryWorkerConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.SoftwareConfig, actual.SoftwareConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigSoftwareConfigNewStyle, EmptyObject: EmptyClusterConfigSoftwareConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("SoftwareConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.EndpointConfig, actual.EndpointConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigEndpointConfigNewStyle, EmptyObject: EmptyClusterConfigEndpointConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("EndpointConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.GkeClusterConfig, actual.GkeClusterConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigGkeClusterConfigNewStyle, EmptyObject: EmptyClusterConfigGkeClusterConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("GkeClusterConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterConfigMasterConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.DiskConfig, actual.DiskConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigMasterConfigDiskConfigNewStyle, EmptyObject: EmptyClusterConfigMasterConfigDiskConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("DiskConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.ManagedGroupConfig, actual.ManagedGroupConfig, dcl.DiffInfo{OutputOnly: true, ObjectFunction: compareClusterConfigMasterConfigManagedGroupConfigNewStyle, EmptyObject: EmptyClusterConfigMasterConfigManagedGroupConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("ManagedGroupConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.Accelerators, actual.Accelerators, dcl.DiffInfo{ObjectFunction: compareClusterConfigMasterConfigAcceleratorsNewStyle, EmptyObject: EmptyClusterConfigMasterConfigAccelerators, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("Accelerators")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterConfigWorkerConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.DiskConfig, actual.DiskConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigWorkerConfigDiskConfigNewStyle, EmptyObject: EmptyClusterConfigWorkerConfigDiskConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("DiskConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.Accelerators, actual.Accelerators, dcl.DiffInfo{ObjectFunction: compareClusterConfigWorkerConfigAcceleratorsNewStyle, EmptyObject: EmptyClusterConfigWorkerConfigAccelerators, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("Accelerators")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterConfigSecondaryWorkerConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.DiskConfig, actual.DiskConfig, dcl.DiffInfo{ObjectFunction: compareClusterConfigSecondaryWorkerConfigDiskConfigNewStyle, EmptyObject: EmptyClusterConfigSecondaryWorkerConfigDiskConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("DiskConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.Accelerators, actual.Accelerators, dcl.DiffInfo{ObjectFunction: compareClusterConfigSecondaryWorkerConfigAcceleratorsNewStyle, EmptyObject: EmptyClusterConfigSecondaryWorkerConfigAccelerators, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("Accelerators")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterConfigGkeClusterConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*ClusterConfigGkeClusterConfig)
	if !ok {
		desiredNotPointer, ok := d.(ClusterConfigGkeClusterConfig)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterConfigGkeClusterConfig or *ClusterConfigGkeClusterConfig", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*ClusterConfigGkeClusterConfig)
	if !ok {
		actualNotPointer, ok := a.(ClusterConfigGkeClusterConfig)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterConfigGkeClusterConfig", a)
		}
		actual = &actualNotPointer
	}

	if ds, err := dcl.Diff(desired.NamespacedGkeDeploymentTarget, actual.NamespacedGkeDeploymentTarget, dcl.DiffInfo{ObjectFunction: compareClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetNewStyle, EmptyObject: EmptyClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("NamespacedGkeDeploymentTarget")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
	if !ok {
		desiredNotPointer, ok := d.(ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget or *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
	if !ok {
		actualNotPointer, ok := a.(ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget", a)
		}
		actual = &actualNotPointer
	}
...
func expandClusterConfig(c *Client, f *ClusterConfig, res *Cluster) (map[string]interface{}, error) {
	...
	if v, err := expandClusterConfigGkeClusterConfig(c, f.GkeClusterConfig, res); err != nil {
...
func flattenClusterConfig(c *Client, i interface{}, res *Cluster) *ClusterConfig {
	...
	r.GkeClusterConfig = flattenClusterConfigGkeClusterConfig(c, m["gkeClusterConfig"], res)
...
// expandClusterConfigGkeClusterConfigMap expands the contents of ClusterConfigGkeClusterConfig into a JSON
// request object.
func expandClusterConfigGkeClusterConfigMap(c *Client, f map[string]ClusterConfigGkeClusterConfig, res *Cluster) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandClusterConfigGkeClusterConfig(c, &item, res)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandClusterConfigGkeClusterConfigSlice expands the contents of ClusterConfigGkeClusterConfig into a JSON
// request object.
func expandClusterConfigGkeClusterConfigSlice(c *Client, f []ClusterConfigGkeClusterConfig, res *Cluster) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenClusterConfigGkeClusterConfigMap flattens the contents of ClusterConfigGkeClusterConfig from a JSON
// response object.
func flattenClusterConfigGkeClusterConfigMap(c *Client, i interface{}, res *Cluster) map[string]ClusterConfigGkeClusterConfig {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]ClusterConfigGkeClusterConfig{}
	}
	...
	for k, item := range a {
		items[k] = *flattenClusterConfigGkeClusterConfig(c, item.(map[string]interface{}), res)
	}

	return items
}

// flattenClusterConfigGkeClusterConfigSlice flattens the contents of ClusterConfigGkeClusterConfig from a JSON
// response object.
func flattenClusterConfigGkeClusterConfigSlice(c *Client, i interface{}, res *Cluster) []ClusterConfigGkeClusterConfig {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]ClusterConfigGkeClusterConfig, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenClusterConfigGkeClusterConfig(c, item.(map[string]interface{}), res))
	}

	return items
}

// expandClusterConfigGkeClusterConfig expands an instance of ClusterConfigGkeClusterConfig into a JSON
// request object.
func expandClusterConfigGkeClusterConfig(c *Client, f *ClusterConfigGkeClusterConfig, res *Cluster) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}

	m := make(map[string]interface{})
	if v, err := expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, f.NamespacedGkeDeploymentTarget, res); err != nil {
...
// flattenClusterConfigGkeClusterConfig flattens an instance of ClusterConfigGkeClusterConfig from a JSON
// response object.
func flattenClusterConfigGkeClusterConfig(c *Client, i interface{}, res *Cluster) *ClusterConfigGkeClusterConfig {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}
	...
	if dcl.IsEmptyValueIndirect(i) {
		return EmptyClusterConfigGkeClusterConfig
	}
	r.NamespacedGkeDeploymentTarget = flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, m["namespacedGkeDeploymentTarget"], res)

	return r
}

// expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap expands the contents of ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget into a JSON
// request object.
func expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap(c *Client, f map[string]ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, res *Cluster) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, &item, res)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice expands the contents of ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget into a JSON
// request object.
func expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(c *Client, f []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, res *Cluster) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap flattens the contents of ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget from a JSON
// response object.
func flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap(c *Client, i interface{}, res *Cluster) map[string]ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}
	}
	...
	items := make(map[string]ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
	for k, item := range a {
		items[k] = *flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, item.(map[string]interface{}), res)
	}

	return items
}

// flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice flattens the contents of ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget from a JSON
// response object.
func flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(c *Client, i interface{}, res *Cluster) []ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, item.(map[string]interface{}), res))
	}

	return items
}

// expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget expands an instance of ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget into a JSON
// request object.
func expandClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c *Client, f *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, res *Cluster) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}
...
// flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget flattens an instance of ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget from a JSON
// response object.
func flattenClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c *Client, i interface{}, res *Cluster) *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}

	if dcl.IsEmptyValueIndirect(i) {
		return EmptyClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
	}
...
func extractClusterConfigFields(r *Cluster, o *ClusterConfig) error {
	...
	if vGkeClusterConfig == nil {
		// note: explicitly not the empty object.
		vGkeClusterConfig = &ClusterConfigGkeClusterConfig{}
	}
...
func extractClusterConfigGkeClusterConfigFields(r *Cluster, o *ClusterConfigGkeClusterConfig) error {
	vNamespacedGkeDeploymentTarget := o.NamespacedGkeDeploymentTarget
	if vNamespacedGkeDeploymentTarget == nil {
		// note: explicitly not the empty object.
		vNamespacedGkeDeploymentTarget = &ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}
	}
...
func extractClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetFields(r *Cluster, o *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) error {
	return nil
}
...
func postReadExtractClusterConfigGkeClusterConfigFields(r *Cluster, o *ClusterConfigGkeClusterConfig) error {
	vNamespacedGkeDeploymentTarget := o.NamespacedGkeDeploymentTarget
	if vNamespacedGkeDeploymentTarget == nil {
		// note: explicitly not the empty object.
		vNamespacedGkeDeploymentTarget = &ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}
...
func postReadExtractClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetFields(r *Cluster, o *ClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) error {
	return nil
}
