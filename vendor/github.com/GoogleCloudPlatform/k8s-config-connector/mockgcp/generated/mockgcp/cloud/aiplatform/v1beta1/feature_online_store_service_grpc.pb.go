...
// - protoc             v3.12.4
// source: mockgcp/cloud/aiplatform/v1beta1/feature_online_store_service.proto
...
func (c *featureOnlineStoreServiceClient) FetchFeatureValues(ctx context.Context, in *FetchFeatureValuesRequest, opts ...grpc.CallOption) (*FetchFeatureValuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1beta1.FeatureOnlineStoreService/FetchFeatureValues", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *featureOnlineStoreServiceClient) SearchNearestEntities(ctx context.Context, in *SearchNearestEntitiesRequest, opts ...grpc.CallOption) (*SearchNearestEntitiesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1beta1.FeatureOnlineStoreService/SearchNearestEntities", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedFeatureOnlineStoreServiceServer
...
// UnimplementedFeatureOnlineStoreServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedFeatureOnlineStoreServiceServer) mustEmbedUnimplementedFeatureOnlineStoreServiceServer() {
}
...
func _FeatureOnlineStoreService_FetchFeatureValues_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1beta1.FeatureOnlineStoreService/FetchFeatureValues",
	}
...
func _FeatureOnlineStoreService_SearchNearestEntities_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1beta1.FeatureOnlineStoreService/SearchNearestEntities",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var FeatureOnlineStoreService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.cloud.aiplatform.v1beta1.FeatureOnlineStoreService",
	...
	Metadata: "mockgcp/cloud/aiplatform/v1beta1/feature_online_store_service.proto",
}
