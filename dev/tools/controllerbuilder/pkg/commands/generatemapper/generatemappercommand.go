...
func RunGenerateMapper(ctx context.Context, o *GenerateMapperOptions) error {
	...
	if gv.Group == "gsuiteaddons.cnrm.cloud.google.com" {
		mapperGenerator.AddProtoMessageNotMappedToGoStruct("google.protobuf.Value", "apiextensionsv1.JSON")
		mapperGenerator.AddProtoMessageNotMappedToGoStruct("google.protobuf.ListValue", "apiextensionsv1.JSON")
	}
