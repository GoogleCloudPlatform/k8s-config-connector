...
func GoPackageForProto(parentFile protoreflect.FileDescriptor) string {
	...
	case "cloud.google.com/go/enterpriseknowledgegraph/apiv1/enterpriseknowledgegraphpb":
		return "google.golang.org/genproto/googleapis/cloud/enterpriseknowledgegraph/v1"
	}
