...
type {{ .Kind }}Status struct {
	...
	// A unique specifier for the {{ .Kind }} resource in Google Cloud.
...
// {{ .Kind }}ObservedState is the state of the {{ .Kind }} resource as most recently observed in Google Cloud.
{{- if .KindProtoTag }}
