...
# This should be the path where you have cloned the GoB repository.
# e.g., "/usr/local/google/home/${username}/cnrm/""
SOURCE_CHECKOUT_PATH="${REPO_PATH}"

# The Buganizer issue for push justification.
# As seen in the doc: '--push-options push-justification=[b/382575614]'
