...
| `mocks` | MockGCP alignment and golden logs (`_http_mock.log`) | **149** / 213 | `70.0%` |
...
| :---: | :--- | :--- | :---: | :---: | :--- |
| #1 | `resourcemanager` | `Folder` | `456` | **In Progress** | `Mapper/Fuzz` |
| #2 | `resourcemanager` | `Project` | `451` | **In Progress** | `Mapper/Fuzz` |
| #3 | `kms` | `KMSKeyRing` | `143` | **In Progress** | `Default to Direct Controller` |
| #4 | `kms` | `KMSCryptoKey` | `141` | **In Progress** | `Default to Direct Controller` |
| #5 | `compute` | `ComputeNetwork` | `140` | **In Progress** | `Default to Direct Controller` |
...
| #16 | `pubsub` | `PubSubSchema` | `9` | **In Progress** | `Default to Direct Controller` |
| #17 | `bigtable` | `BigtableInstance` | `8` | **In Progress** | `Mapper/Fuzz` |
| #18 | `pubsub` | `PubSubTopic` | `8` | **In Progress** | `Default to Direct Controller` |
| #19 | `apigee` | `ApigeeOrganization` | `7` | **In Progress** | `Mapper/Fuzz` |
| #20 | `compute` | `ComputeBackendBucket` | `7` | **In Progress** | `Identity/Ref` |
| #21 | `compute` | `ComputeInstanceTemplate` | `7` | **In Progress** | `Types` |
...
| `compute` | `ComputeNetworkFirewallPolicy` | `Terraform` | **In Progress** | Yes |  | Yes | Yes |  |  |  |  |
