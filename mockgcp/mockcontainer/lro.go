...
func (s *ClusterManagerV1) newLRO(ctx context.Context, projectID string) (*pb.Operation, error) {
	lro, err := s.operations.NewLRO(ctx)
	if err != nil {
		return nil, err
	}
	selfLinkPrefix := "https://container.googleapis.com/v1beta1/projects/" + projectID + "/global/operations/"
...
func mapToComputeLRO(lro *lropb.Operation, selfLinkPrefix string) (*pb.Operation, error) {
	...
	computeLRO.SelfLink = selfLinkPrefix + lroName
