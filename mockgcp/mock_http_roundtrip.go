...
import (
	...
	"github.com/GoogleCloudPlatform/k8s-config-connector/mockgcp/mockcontainerattachedcluster"
...
func NewMockRoundTripper(t *testing.T, k8sClient client.Client, storage storage.Storage) *mockRoundTripper {
	...
	services = append(services, mockcontainerattachedcluster.New(env, storage))
