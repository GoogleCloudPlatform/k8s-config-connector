...
import (
	...
	"github.com/GoogleCloudPlatform/k8s-config-connector/mockgcp/mockbeyondcorp"
	...
	"github.com/GoogleCloudPlatform/k8s-config-connector/mockgcp/mockgeminidataanalytics"
...
func NewMockRoundTripper(ctx context.Context, k8sClient client.Client, storage storage.Storage) (Interface, error) {
	...
	services = append(services, mockgeminidataanalytics.New(env, storage))
	...
	services = append(services, mockbeyondcorp.New(env, storage))
