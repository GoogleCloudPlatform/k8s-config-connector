...
// MockService represents a mocked OrgPolicy service.
...
func (s *MockService) ExpectedHosts() []string {
	return []string{"orgpolicy.googleapis.com"}
}

func (s *MockService) Register(grpcServer *grpc.Server) {
	pb.RegisterOrgPolicyServer(grpcServer, &orgPolicyV2{MockService: s})
}
