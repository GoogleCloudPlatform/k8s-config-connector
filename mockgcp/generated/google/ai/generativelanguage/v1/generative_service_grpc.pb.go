...
func (c *generativeServiceClient) StreamGenerateContent(ctx context.Context, in *GenerateContentRequest, opts ...grpc.CallOption) (GenerativeService_StreamGenerateContentClient, error) {
	stream, err := c.cc.NewStream(ctx, &GenerativeService_ServiceDesc.Streams[0], "/google.ai.generativelanguage.v1.GenerativeService/StreamGenerateContent", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedGenerativeServiceServer must be embedded to have forward compatible implementations.
