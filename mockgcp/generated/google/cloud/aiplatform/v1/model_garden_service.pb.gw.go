...
func RegisterModelGardenServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extAiplatformpb.ModelGardenServiceServer) error {
	...
	mux.Handle("GET", pattern_ModelGardenService_GetPublisherModel_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.aiplatform.v1.ModelGardenService/GetPublisherModel", runtime.WithHTTPPathPattern("/v1/{name=publishers/*/models/*}"))
		if err != nil {
	...
	mux.Handle("POST", pattern_ModelGardenService_Deploy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.aiplatform.v1.ModelGardenService/Deploy", runtime.WithHTTPPathPattern("/v1/{destination=projects/*/locations/*}:deploy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterModelGardenServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extAiplatformpb.ModelGardenServiceClient) error {
	...
	mux.Handle("GET", pattern_ModelGardenService_GetPublisherModel_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.aiplatform.v1.ModelGardenService/GetPublisherModel", runtime.WithHTTPPathPattern("/v1/{name=publishers/*/models/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ModelGardenService_Deploy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.aiplatform.v1.ModelGardenService/Deploy", runtime.WithHTTPPathPattern("/v1/{destination=projects/*/locations/*}:deploy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
