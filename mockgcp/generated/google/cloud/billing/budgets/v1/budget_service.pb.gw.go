...
import (
	...
	extBudgetspb "cloud.google.com/go/billing/budgets/apiv1/budgetspb"
...
func RegisterBudgetServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extBudgetspb.BudgetServiceServer) error {
	...
	mux.Handle("POST", pattern_BudgetService_CreateBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/CreateBudget", runtime.WithHTTPPathPattern("/v1/{parent=billingAccounts/*}/budgets"))
		if err != nil {
	...
	mux.Handle("PATCH", pattern_BudgetService_UpdateBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/UpdateBudget", runtime.WithHTTPPathPattern("/v1/{budget.name=billingAccounts/*/budgets/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BudgetService_GetBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/GetBudget", runtime.WithHTTPPathPattern("/v1/{name=billingAccounts/*/budgets/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BudgetService_ListBudgets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/ListBudgets", runtime.WithHTTPPathPattern("/v1/{parent=billingAccounts/*}/budgets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_BudgetService_DeleteBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/DeleteBudget", runtime.WithHTTPPathPattern("/v1/{name=billingAccounts/*/budgets/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBudgetServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extBudgetspb.BudgetServiceClient) error {
	...
	mux.Handle("POST", pattern_BudgetService_CreateBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/CreateBudget", runtime.WithHTTPPathPattern("/v1/{parent=billingAccounts/*}/budgets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_BudgetService_UpdateBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/UpdateBudget", runtime.WithHTTPPathPattern("/v1/{budget.name=billingAccounts/*/budgets/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BudgetService_GetBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/GetBudget", runtime.WithHTTPPathPattern("/v1/{name=billingAccounts/*/budgets/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_BudgetService_ListBudgets_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/ListBudgets", runtime.WithHTTPPathPattern("/v1/{parent=billingAccounts/*}/budgets"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_BudgetService_DeleteBudget_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.billing.budgets.v1.BudgetService/DeleteBudget", runtime.WithHTTPPathPattern("/v1/{name=billingAccounts/*/budgets/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
