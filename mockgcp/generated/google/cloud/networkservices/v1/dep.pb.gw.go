...
func RegisterDepServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extNetworkservicespb.DepServiceServer) error {
	...
	mux.Handle("GET", pattern_DepService_ListLbEdgeExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/ListLbEdgeExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_GetLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/GetLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/CreateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/UpdateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{lb_edge_extension.name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/DeleteLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterDepServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extNetworkservicespb.DepServiceClient) error {
	...
	mux.Handle("GET", pattern_DepService_ListLbEdgeExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/ListLbEdgeExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_GetLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/GetLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/CreateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/UpdateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{lb_edge_extension.name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.cloud.networkservices.v1.DepService/DeleteLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
