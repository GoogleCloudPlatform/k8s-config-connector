...
func RegisterCloudQuotasHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CloudQuotasServer) error {
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaInfos_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaInfos", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*/services/*}/quotaInfos"))
		if err != nil {
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaInfos_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaInfos", runtime.WithHTTPPathPattern("/v1/{parent=organizations/*/locations/*/services/*}/quotaInfos"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaInfos_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaInfos", runtime.WithHTTPPathPattern("/v1/{parent=folders/*/locations/*/services/*}/quotaInfos"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaInfo", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/services/*/quotaInfos/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaInfo_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaInfo", runtime.WithHTTPPathPattern("/v1/{name=organizations/*/locations/*/services/*/quotaInfos/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaInfo_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaInfo", runtime.WithHTTPPathPattern("/v1/{name=folders/*/locations/*/services/*/quotaInfos/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaPreferences_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaPreferences", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaPreferences_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaPreferences", runtime.WithHTTPPathPattern("/v1/{parent=folders/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaPreferences_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaPreferences", runtime.WithHTTPPathPattern("/v1/{parent=organizations/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaPreference_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaPreference", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaPreference_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaPreference", runtime.WithHTTPPathPattern("/v1/{name=organizations/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaPreference_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaPreference", runtime.WithHTTPPathPattern("/v1/{name=folders/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CloudQuotas_CreateQuotaPreference_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/CreateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CloudQuotas_CreateQuotaPreference_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/CreateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{parent=folders/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CloudQuotas_CreateQuotaPreference_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/CreateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{parent=organizations/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_CloudQuotas_UpdateQuotaPreference_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/UpdateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{quota_preference.name=projects/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_CloudQuotas_UpdateQuotaPreference_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/UpdateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{quota_preference.name=folders/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_CloudQuotas_UpdateQuotaPreference_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/UpdateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{quota_preference.name=organizations/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterCloudQuotasHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CloudQuotasClient) error {
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaInfos_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaInfos", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*/services/*}/quotaInfos"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaInfos_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaInfos", runtime.WithHTTPPathPattern("/v1/{parent=organizations/*/locations/*/services/*}/quotaInfos"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaInfos_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaInfos", runtime.WithHTTPPathPattern("/v1/{parent=folders/*/locations/*/services/*}/quotaInfos"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaInfo", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/services/*/quotaInfos/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaInfo_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaInfo", runtime.WithHTTPPathPattern("/v1/{name=organizations/*/locations/*/services/*/quotaInfos/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaInfo_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaInfo", runtime.WithHTTPPathPattern("/v1/{name=folders/*/locations/*/services/*/quotaInfos/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaPreferences_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaPreferences", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaPreferences_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaPreferences", runtime.WithHTTPPathPattern("/v1/{parent=folders/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_ListQuotaPreferences_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/ListQuotaPreferences", runtime.WithHTTPPathPattern("/v1/{parent=organizations/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaPreference_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaPreference", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaPreference_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaPreference", runtime.WithHTTPPathPattern("/v1/{name=organizations/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_CloudQuotas_GetQuotaPreference_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/GetQuotaPreference", runtime.WithHTTPPathPattern("/v1/{name=folders/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CloudQuotas_CreateQuotaPreference_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/CreateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CloudQuotas_CreateQuotaPreference_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/CreateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{parent=folders/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_CloudQuotas_CreateQuotaPreference_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/CreateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{parent=organizations/*/locations/*}/quotaPreferences"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_CloudQuotas_UpdateQuotaPreference_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/UpdateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{quota_preference.name=projects/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_CloudQuotas_UpdateQuotaPreference_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/UpdateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{quota_preference.name=folders/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_CloudQuotas_UpdateQuotaPreference_2, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/google.api.cloudquotas.v1.CloudQuotas/UpdateQuotaPreference", runtime.WithHTTPPathPattern("/v1/{quota_preference.name=organizations/*/locations/*/quotaPreferences/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
