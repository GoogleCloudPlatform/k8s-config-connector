...
var (
	filter_DepService_ListLbEdgeExtensions_0 = &utilities.DoubleArray{Encoding: map[string]int{"parent": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_DepService_ListLbEdgeExtensions_0(ctx context.Context, marshaler runtime.Marshaler, client extNetworkservicespb.DepServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.ListLbEdgeExtensionsRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DepService_ListLbEdgeExtensions_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.ListLbEdgeExtensions(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DepService_ListLbEdgeExtensions_0(ctx context.Context, marshaler runtime.Marshaler, server extNetworkservicespb.DepServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.ListLbEdgeExtensionsRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ListLbEdgeExtensions(ctx, &protoReq)
	return msg, metadata, err

}

func request_DepService_GetLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, client extNetworkservicespb.DepServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.GetLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetLbEdgeExtension(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DepService_GetLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, server extNetworkservicespb.DepServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.GetLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetLbEdgeExtension(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_DepService_CreateLbEdgeExtension_0 = &utilities.DoubleArray{Encoding: map[string]int{"lb_edge_extension": 0, "parent": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)

func request_DepService_CreateLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, client extNetworkservicespb.DepServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.CreateLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.LbEdgeExtension); err != nil && err != io.EOF {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DepService_CreateLbEdgeExtension_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.CreateLbEdgeExtension(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DepService_CreateLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, server extNetworkservicespb.DepServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.CreateLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.CreateLbEdgeExtension(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_DepService_UpdateLbEdgeExtension_0 = &utilities.DoubleArray{Encoding: map[string]int{"lb_edge_extension": 0, "name": 1}, Base: []int{1, 2, 1, 0, 0}, Check: []int{0, 1, 2, 3, 2}}
)

func request_DepService_UpdateLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, client extNetworkservicespb.DepServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.UpdateLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	if protoReq.UpdateMask == nil || len(protoReq.UpdateMask.GetPaths()) == 0 {
		if fieldMask, err := runtime.FieldMaskFromRequestBody(newReader(), protoReq.LbEdgeExtension); err != nil {
			return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
		} else {
			protoReq.UpdateMask = fieldMask
		}
	...
	val, ok = pathParams["lb_edge_extension.name"]
	if !ok {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "missing parameter %s", "lb_edge_extension.name")
	}

	err = runtime.PopulateFieldFromPath(&protoReq, "lb_edge_extension.name", val)
	if err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "type mismatch, parameter: %s, error: %v", "lb_edge_extension.name", err)
	}

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DepService_UpdateLbEdgeExtension_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.UpdateLbEdgeExtension(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DepService_UpdateLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, server extNetworkservicespb.DepServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.UpdateLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateLbEdgeExtension(ctx, &protoReq)
	return msg, metadata, err

}

var (
	filter_DepService_DeleteLbEdgeExtension_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_DepService_DeleteLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, client extNetworkservicespb.DepServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.DeleteLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DepService_DeleteLbEdgeExtension_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.DeleteLbEdgeExtension(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DepService_DeleteLbEdgeExtension_0(ctx context.Context, marshaler runtime.Marshaler, server extNetworkservicespb.DepServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq extNetworkservicespb.DeleteLbEdgeExtensionRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.DeleteLbEdgeExtension(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDepServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extNetworkservicespb.DepServiceServer) error {
	...
	mux.Handle("GET", pattern_DepService_ListLbTrafficExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListLbTrafficExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbTrafficExtensions"))
		if err != nil {
	...
	mux.Handle("GET", pattern_DepService_GetLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbTrafficExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbTrafficExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{lb_traffic_extension.name=projects/*/locations/*/lbTrafficExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbTrafficExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_ListLbRouteExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListLbRouteExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbRouteExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_GetLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbRouteExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbRouteExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{lb_route_extension.name=projects/*/locations/*/lbRouteExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbRouteExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_ListLbEdgeExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListLbEdgeExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DepService_ListLbEdgeExtensions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DepService_ListLbEdgeExtensions_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("GET", pattern_DepService_GetLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DepService_GetLbEdgeExtension_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DepService_GetLbEdgeExtension_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_DepService_CreateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DepService_CreateLbEdgeExtension_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DepService_CreateLbEdgeExtension_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("PATCH", pattern_DepService_UpdateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{lb_edge_extension.name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DepService_UpdateLbEdgeExtension_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DepService_UpdateLbEdgeExtension_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("DELETE", pattern_DepService_DeleteLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DepService_DeleteLbEdgeExtension_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DepService_DeleteLbEdgeExtension_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_DepService_ListAuthzExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListAuthzExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/authzExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_GetAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetAuthzExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/authzExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateAuthzExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/authzExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateAuthzExtension", runtime.WithHTTPPathPattern("/v1/{authz_extension.name=projects/*/locations/*/authzExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteAuthzExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/authzExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterDepServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extNetworkservicespb.DepServiceClient) error {
	...
	mux.Handle("GET", pattern_DepService_ListLbTrafficExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListLbTrafficExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbTrafficExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_GetLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbTrafficExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbTrafficExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{lb_traffic_extension.name=projects/*/locations/*/lbTrafficExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteLbTrafficExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteLbTrafficExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbTrafficExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_ListLbRouteExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListLbRouteExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbRouteExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_GetLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbRouteExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbRouteExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{lb_route_extension.name=projects/*/locations/*/lbRouteExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteLbRouteExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteLbRouteExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbRouteExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_ListLbEdgeExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListLbEdgeExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DepService_ListLbEdgeExtensions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_DepService_GetLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DepService_GetLbEdgeExtension_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_DepService_CreateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/lbEdgeExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DepService_CreateLbEdgeExtension_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("PATCH", pattern_DepService_UpdateLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{lb_edge_extension.name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DepService_UpdateLbEdgeExtension_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("DELETE", pattern_DepService_DeleteLbEdgeExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteLbEdgeExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/lbEdgeExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DepService_DeleteLbEdgeExtension_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_DepService_ListAuthzExtensions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/ListAuthzExtensions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/authzExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DepService_GetAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/GetAuthzExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/authzExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DepService_CreateAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/CreateAuthzExtension", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/authzExtensions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DepService_UpdateAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/UpdateAuthzExtension", runtime.WithHTTPPathPattern("/v1/{authz_extension.name=projects/*/locations/*/authzExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DepService_DeleteAuthzExtension_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.networkservices.v1.DepService/DeleteAuthzExtension", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/authzExtensions/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	...
	pattern_DepService_ListLbEdgeExtensions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3, 2, 4}, []string{"v1", "projects", "locations", "parent", "lbEdgeExtensions"}, ""))

	pattern_DepService_GetLbEdgeExtension_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 2, 3, 1, 0, 4, 6, 5, 4}, []string{"v1", "projects", "locations", "lbEdgeExtensions", "name"}, ""))

	pattern_DepService_CreateLbEdgeExtension_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3, 2, 4}, []string{"v1", "projects", "locations", "parent", "lbEdgeExtensions"}, ""))

	pattern_DepService_UpdateLbEdgeExtension_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 2, 3, 1, 0, 4, 6, 5, 4}, []string{"v1", "projects", "locations", "lbEdgeExtensions", "lb_edge_extension.name"}, ""))

	pattern_DepService_DeleteLbEdgeExtension_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 2, 3, 1, 0, 4, 6, 5, 4}, []string{"v1", "projects", "locations", "lbEdgeExtensions", "name"}, ""))
...
var (
	...
	forward_DepService_ListLbEdgeExtensions_0 = runtime.ForwardResponseMessage

	forward_DepService_GetLbEdgeExtension_0 = runtime.ForwardResponseMessage

	forward_DepService_CreateLbEdgeExtension_0 = runtime.ForwardResponseMessage

	forward_DepService_UpdateLbEdgeExtension_0 = runtime.ForwardResponseMessage

	forward_DepService_DeleteLbEdgeExtension_0 = runtime.ForwardResponseMessage
