...
// source: mockgcp/cloud/dataproc/v1/autoscaling_policies.proto
...
func RegisterAutoscalingPolicyServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extDataprocpb.AutoscalingPolicyServiceServer) error {
	...
	mux.Handle("POST", pattern_AutoscalingPolicyService_CreateAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/CreateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/autoscalingPolicies"))
		if err != nil {
	...
	mux.Handle("POST", pattern_AutoscalingPolicyService_CreateAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/CreateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/regions/*}/autoscalingPolicies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_AutoscalingPolicyService_UpdateAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/UpdateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{policy.name=projects/*/locations/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_AutoscalingPolicyService_UpdateAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/UpdateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{policy.name=projects/*/regions/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_GetAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/GetAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_GetAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/GetAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/regions/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_ListAutoscalingPolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/ListAutoscalingPolicies", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/autoscalingPolicies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_ListAutoscalingPolicies_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/ListAutoscalingPolicies", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/regions/*}/autoscalingPolicies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AutoscalingPolicyService_DeleteAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/DeleteAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AutoscalingPolicyService_DeleteAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/DeleteAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/regions/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterAutoscalingPolicyServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extDataprocpb.AutoscalingPolicyServiceClient) error {
	...
	mux.Handle("POST", pattern_AutoscalingPolicyService_CreateAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/CreateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/autoscalingPolicies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_AutoscalingPolicyService_CreateAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/CreateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/regions/*}/autoscalingPolicies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_AutoscalingPolicyService_UpdateAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/UpdateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{policy.name=projects/*/locations/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_AutoscalingPolicyService_UpdateAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/UpdateAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{policy.name=projects/*/regions/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_GetAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/GetAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_GetAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/GetAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/regions/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_ListAutoscalingPolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/ListAutoscalingPolicies", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/autoscalingPolicies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_AutoscalingPolicyService_ListAutoscalingPolicies_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/ListAutoscalingPolicies", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/regions/*}/autoscalingPolicies"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AutoscalingPolicyService_DeleteAutoscalingPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/DeleteAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_AutoscalingPolicyService_DeleteAutoscalingPolicy_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.AutoscalingPolicyService/DeleteAutoscalingPolicy", runtime.WithHTTPPathPattern("/v1/{name=projects/*/regions/*/autoscalingPolicies/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
