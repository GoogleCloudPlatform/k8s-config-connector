...
// source: mockgcp/cloud/dataproc/v1/clusters.proto
...
func RegisterClusterControllerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extDataprocpb.ClusterControllerServer) error {
	...
	mux.Handle("POST", pattern_ClusterController_CreateCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/CreateCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters"))
		if err != nil {
	...
	mux.Handle("PATCH", pattern_ClusterController_UpdateCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/UpdateCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ClusterController_StopCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/StopCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}:stop"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ClusterController_StartCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/StartCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}:start"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ClusterController_DeleteCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/DeleteCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ClusterController_GetCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/GetCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ClusterController_ListClusters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/ListClusters", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ClusterController_DiagnoseCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/DiagnoseCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}:diagnose"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterClusterControllerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extDataprocpb.ClusterControllerClient) error {
	...
	mux.Handle("POST", pattern_ClusterController_CreateCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/CreateCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_ClusterController_UpdateCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/UpdateCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ClusterController_StopCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/StopCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}:stop"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ClusterController_StartCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/StartCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}:start"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_ClusterController_DeleteCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/DeleteCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ClusterController_GetCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/GetCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ClusterController_ListClusters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/ListClusters", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ClusterController_DiagnoseCluster_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.dataproc.v1.ClusterController/DiagnoseCluster", runtime.WithHTTPPathPattern("/v1/projects/{project_id}/regions/{region}/clusters/{cluster_name}:diagnose"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
