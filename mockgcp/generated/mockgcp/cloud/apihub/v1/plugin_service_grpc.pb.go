...
func (c *apiHubPluginClient) GetPlugin(ctx context.Context, in *GetPluginRequest, opts ...grpc.CallOption) (*Plugin, error) {
	out := new(Plugin)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.apihub.v1.ApiHubPlugin/GetPlugin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiHubPluginClient) EnablePlugin(ctx context.Context, in *EnablePluginRequest, opts ...grpc.CallOption) (*Plugin, error) {
	out := new(Plugin)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.apihub.v1.ApiHubPlugin/EnablePlugin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *apiHubPluginClient) DisablePlugin(ctx context.Context, in *DisablePluginRequest, opts ...grpc.CallOption) (*Plugin, error) {
	out := new(Plugin)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.apihub.v1.ApiHubPlugin/DisablePlugin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedApiHubPluginServer
...
// UnimplementedApiHubPluginServer must be embedded to have forward compatible implementations.
...
func (UnimplementedApiHubPluginServer) mustEmbedUnimplementedApiHubPluginServer() {}
...
func _ApiHubPlugin_GetPlugin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.apihub.v1.ApiHubPlugin/GetPlugin",
	}
...
func _ApiHubPlugin_EnablePlugin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.apihub.v1.ApiHubPlugin/EnablePlugin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ApiHubPlugin_DisablePlugin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.apihub.v1.ApiHubPlugin/DisablePlugin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ApiHubPlugin_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.cloud.apihub.v1.ApiHubPlugin",
	...
	Metadata: "mockgcp/cloud/apihub/v1/plugin_service.proto",
}
