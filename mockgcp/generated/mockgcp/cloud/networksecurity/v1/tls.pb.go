...
// 	protoc        v3.12.4
// source: mockgcp/cloud/networksecurity/v1/tls.proto
...
func (x *GrpcEndpoint) Reset() {
	*x = GrpcEndpoint{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[0]
...
func (*GrpcEndpoint) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescGZIP(), []int{0}
}
...
func (x *ValidationCA) Reset() {
	*x = ValidationCA{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ValidationCA) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescGZIP(), []int{1}
}
...
func (x *CertificateProviderInstance) Reset() {
	*x = CertificateProviderInstance{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CertificateProviderInstance) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescGZIP(), []int{2}
}
...
func (x *CertificateProvider) Reset() {
	*x = CertificateProvider{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CertificateProvider) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescGZIP(), []int{3}
}
...
var File_mockgcp_cloud_networksecurity_v1_tls_proto protoreflect.FileDescriptor

var file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x2f, 0x74, 0x6c, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x20, 0x6d, 0x6f,
	...
	,
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0xfa, 0x01, 0x0a, 0x13, 0x43, 0x65, 0x72, 0x74, 0x69,
	0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x55,
	...
	0x75, 0x72, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x72, 0x70, 0x63, 0x45, 0x6e, 0x64,
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x0c, 0x67, 0x72, 0x70, 0x63, 0x45, 0x6e, 0x64,
	0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x83, 0x01, 0x0a, 0x1d, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x5f, 0x69,
	0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3d, 0x2e,
	...
	0x69, 0x64, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x48, 0x00, 0x52, 0x1b,
	0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x76, 0x69,
	0x64, 0x65, 0x72, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x42, 0x06, 0x0a, 0x04, 0x74,
	0x79, 0x70, 0x65, 0x42, 0xea, 0x01, 0x0a, 0x24, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x6f, 0x63, 0x6b,
	0x67, 0x63, 0x70, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72,
	0x6b, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x2e, 0x76, 0x31, 0x42, 0x08, 0x54, 0x6c,
...
var (
	file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescOnce sync.Once
	file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescData = file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDesc
)

func file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescGZIP() []byte {
	file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescOnce.Do(func() {
		file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescData = protoimpl.X.CompressGZIP(file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescData)
	})
	return file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDescData
}

var file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_mockgcp_cloud_networksecurity_v1_tls_proto_goTypes = []interface{}{
	(*GrpcEndpoint)(nil),                // 0: mockgcp.cloud.networksecurity.v1.GrpcEndpoint
	(*ValidationCA)(nil),                // 1: mockgcp.cloud.networksecurity.v1.ValidationCA
	(*CertificateProviderInstance)(nil), // 2: mockgcp.cloud.networksecurity.v1.CertificateProviderInstance
	(*CertificateProvider)(nil),         // 3: mockgcp.cloud.networksecurity.v1.CertificateProvider
}
var file_mockgcp_cloud_networksecurity_v1_tls_proto_depIdxs = []int32{
	0, // 0: mockgcp.cloud.networksecurity.v1.ValidationCA.grpc_endpoint:type_name -> mockgcp.cloud.networksecurity.v1.GrpcEndpoint
	2, // 1: mockgcp.cloud.networksecurity.v1.ValidationCA.certificate_provider_instance:type_name -> mockgcp.cloud.networksecurity.v1.CertificateProviderInstance
	0, // 2: mockgcp.cloud.networksecurity.v1.CertificateProvider.grpc_endpoint:type_name -> mockgcp.cloud.networksecurity.v1.GrpcEndpoint
	2, // 3: mockgcp.cloud.networksecurity.v1.CertificateProvider.certificate_provider_instance:type_name -> mockgcp.cloud.networksecurity.v1.CertificateProviderInstance
...
func init() { file_mockgcp_cloud_networksecurity_v1_tls_proto_init() }
func file_mockgcp_cloud_networksecurity_v1_tls_proto_init() {
	if File_mockgcp_cloud_networksecurity_v1_tls_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*ValidationCA_GrpcEndpoint)(nil),
		(*ValidationCA_CertificateProviderInstance)(nil),
	}
	file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mockgcp_cloud_networksecurity_v1_tls_proto_goTypes,
		DependencyIndexes: file_mockgcp_cloud_networksecurity_v1_tls_proto_depIdxs,
		MessageInfos:      file_mockgcp_cloud_networksecurity_v1_tls_proto_msgTypes,
	}.Build()
	File_mockgcp_cloud_networksecurity_v1_tls_proto = out.File
	file_mockgcp_cloud_networksecurity_v1_tls_proto_rawDesc = nil
	file_mockgcp_cloud_networksecurity_v1_tls_proto_goTypes = nil
	file_mockgcp_cloud_networksecurity_v1_tls_proto_depIdxs = nil
}
