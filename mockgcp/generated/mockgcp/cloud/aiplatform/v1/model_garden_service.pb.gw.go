...
func RegisterModelGardenServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ModelGardenServiceServer) error {
	...
	mux.Handle("GET", pattern_ModelGardenService_GetPublisherModel_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.aiplatform.v1.ModelGardenService/GetPublisherModel", runtime.WithHTTPPathPattern("/v1/{name=publishers/*/models/*}"))
		if err != nil {
...
func RegisterModelGardenServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ModelGardenServiceClient) error {
	...
	mux.Handle("GET", pattern_ModelGardenService_GetPublisherModel_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.aiplatform.v1.ModelGardenService/GetPublisherModel", runtime.WithHTTPPathPattern("/v1/{name=publishers/*/models/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
