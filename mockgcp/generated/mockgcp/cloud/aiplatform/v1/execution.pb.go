...
// 	protoc        v3.12.4
// source: mockgcp/cloud/aiplatform/v1/execution.proto
...
func (Execution_State) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_aiplatform_v1_execution_proto_enumTypes[0].Descriptor()
}

func (Execution_State) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_aiplatform_v1_execution_proto_enumTypes[0]
}
...
func (Execution_State) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescGZIP(), []int{0, 0}
}
...
type Execution struct {
	...
	State Execution_State `protobuf:"varint,6,opt,name=state,proto3,enum=mockgcp.cloud.aiplatform.v1.Execution_State" json:"state,omitempty"`
	...
	Metadata *_struct.Struct `protobuf:"bytes,15,opt,name=metadata,proto3" json:"metadata,omitempty"`
...
func (x *Execution) Reset() {
	*x = Execution{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_aiplatform_v1_execution_proto_msgTypes[0]
...
func (*Execution) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescGZIP(), []int{0}
}
...
func (x *Execution) GetMetadata() *_struct.Struct {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var File_mockgcp_cloud_aiplatform_v1_execution_proto protoreflect.FileDescriptor

var file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDesc = []byte{
	...
	0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1b, 0x6d,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc2, 0x06, 0x0a, 0x09, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74,
	...
	0x42, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c,
	...
	0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x05, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x65, 0x74, 0x61, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x04, 0x65, 0x74, 0x61, 0x67, 0x12, 0x4a, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x32, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67, 0x63,
	0x70, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x61, 0x69, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f,
	0x72, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
	...
	0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x7d, 0x42, 0xcd, 0x01, 0x0a, 0x1f, 0x63,
	0x6f, 0x6d, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67, 0x63, 0x70, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	0x2e, 0x61, 0x69, 0x70, 0x6c, 0x61, 0x74, 0x66, 0x6f, 0x72, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x0e,
...
var (
	file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescOnce sync.Once
	file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescData = file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDesc
)

func file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescGZIP() []byte {
	file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescOnce.Do(func() {
		file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescData = protoimpl.X.CompressGZIP(file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescData)
	})
	return file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDescData
}

var file_mockgcp_cloud_aiplatform_v1_execution_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_mockgcp_cloud_aiplatform_v1_execution_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_mockgcp_cloud_aiplatform_v1_execution_proto_goTypes = []interface{}{
	(Execution_State)(0),        // 0: mockgcp.cloud.aiplatform.v1.Execution.State
	(*Execution)(nil),           // 1: mockgcp.cloud.aiplatform.v1.Execution
	nil,                         // 2: mockgcp.cloud.aiplatform.v1.Execution.LabelsEntry
	(*timestamp.Timestamp)(nil), // 3: google.protobuf.Timestamp
	(*_struct.Struct)(nil),      // 4: google.protobuf.Struct
}
var file_mockgcp_cloud_aiplatform_v1_execution_proto_depIdxs = []int32{
	0, // 0: mockgcp.cloud.aiplatform.v1.Execution.state:type_name -> mockgcp.cloud.aiplatform.v1.Execution.State
	2, // 1: mockgcp.cloud.aiplatform.v1.Execution.labels:type_name -> mockgcp.cloud.aiplatform.v1.Execution.LabelsEntry
	3, // 2: mockgcp.cloud.aiplatform.v1.Execution.create_time:type_name -> google.protobuf.Timestamp
	3, // 3: mockgcp.cloud.aiplatform.v1.Execution.update_time:type_name -> google.protobuf.Timestamp
	4, // 4: mockgcp.cloud.aiplatform.v1.Execution.metadata:type_name -> google.protobuf.Struct
...
func init() { file_mockgcp_cloud_aiplatform_v1_execution_proto_init() }
func file_mockgcp_cloud_aiplatform_v1_execution_proto_init() {
	if File_mockgcp_cloud_aiplatform_v1_execution_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mockgcp_cloud_aiplatform_v1_execution_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mockgcp_cloud_aiplatform_v1_execution_proto_goTypes,
		DependencyIndexes: file_mockgcp_cloud_aiplatform_v1_execution_proto_depIdxs,
		EnumInfos:         file_mockgcp_cloud_aiplatform_v1_execution_proto_enumTypes,
		MessageInfos:      file_mockgcp_cloud_aiplatform_v1_execution_proto_msgTypes,
	}.Build()
	File_mockgcp_cloud_aiplatform_v1_execution_proto = out.File
	file_mockgcp_cloud_aiplatform_v1_execution_proto_rawDesc = nil
	file_mockgcp_cloud_aiplatform_v1_execution_proto_goTypes = nil
	file_mockgcp_cloud_aiplatform_v1_execution_proto_depIdxs = nil
}
