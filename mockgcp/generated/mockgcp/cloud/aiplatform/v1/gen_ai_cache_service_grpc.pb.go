...
type GenAiCacheServiceClient interface {
	...
	DeleteCachedContent(ctx context.Context, in *DeleteCachedContentRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *genAiCacheServiceClient) CreateCachedContent(ctx context.Context, in *CreateCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/CreateCachedContent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) GetCachedContent(ctx context.Context, in *GetCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	out := new(CachedContent)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/GetCachedContent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) UpdateCachedContent(ctx context.Context, in *UpdateCachedContentRequest, opts ...grpc.CallOption) (*CachedContent, error) {
	out := new(CachedContent)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/UpdateCachedContent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) DeleteCachedContent(ctx context.Context, in *DeleteCachedContentRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/DeleteCachedContent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *genAiCacheServiceClient) ListCachedContents(ctx context.Context, in *ListCachedContentsRequest, opts ...grpc.CallOption) (*ListCachedContentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/ListCachedContents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedGenAiCacheServiceServer
...
type GenAiCacheServiceServer interface {
	...
	// Deletes cached content
	DeleteCachedContent(context.Context, *DeleteCachedContentRequest) (*empty.Empty, error)
	// Lists cached contents in a project
...
// UnimplementedGenAiCacheServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedGenAiCacheServiceServer) DeleteCachedContent(context.Context, *DeleteCachedContentRequest) (*empty.Empty, error) {
...
func (UnimplementedGenAiCacheServiceServer) mustEmbedUnimplementedGenAiCacheServiceServer() {}
...
func _GenAiCacheService_CreateCachedContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/CreateCachedContent",
	}
...
func _GenAiCacheService_GetCachedContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/GetCachedContent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GenAiCacheService_UpdateCachedContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/UpdateCachedContent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GenAiCacheService_DeleteCachedContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/DeleteCachedContent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GenAiCacheService_ListCachedContents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.GenAiCacheService/ListCachedContents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var GenAiCacheService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.cloud.aiplatform.v1.GenAiCacheService",
	...
	Metadata: "mockgcp/cloud/aiplatform/v1/gen_ai_cache_service.proto",
}
