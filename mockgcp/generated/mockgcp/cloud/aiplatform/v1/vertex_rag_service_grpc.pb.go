...
func (c *vertexRagServiceClient) RetrieveContexts(ctx context.Context, in *RetrieveContextsRequest, opts ...grpc.CallOption) (*RetrieveContextsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.VertexRagService/RetrieveContexts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vertexRagServiceClient) AugmentPrompt(ctx context.Context, in *AugmentPromptRequest, opts ...grpc.CallOption) (*AugmentPromptResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.VertexRagService/AugmentPrompt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *vertexRagServiceClient) CorroborateContent(ctx context.Context, in *CorroborateContentRequest, opts ...grpc.CallOption) (*CorroborateContentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.aiplatform.v1.VertexRagService/CorroborateContent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedVertexRagServiceServer
...
// UnimplementedVertexRagServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedVertexRagServiceServer) mustEmbedUnimplementedVertexRagServiceServer() {}
...
func _VertexRagService_RetrieveContexts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.VertexRagService/RetrieveContexts",
	}
...
func _VertexRagService_AugmentPrompt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.VertexRagService/AugmentPrompt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _VertexRagService_CorroborateContent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.aiplatform.v1.VertexRagService/CorroborateContent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var VertexRagService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.cloud.aiplatform.v1.VertexRagService",
	...
	Metadata: "mockgcp/cloud/aiplatform/v1/vertex_rag_service.proto",
}
