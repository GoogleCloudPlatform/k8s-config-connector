...
// source: mockgcp/cloud/discoveryengine/v1/data_store_service.proto
...
func RegisterDataStoreServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extDiscoveryenginepb.DataStoreServiceServer) error {
	...
	mux.Handle("POST", pattern_DataStoreService_CreateDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/CreateDataStore", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/dataStores"))
		if err != nil {
	...
	mux.Handle("POST", pattern_DataStoreService_CreateDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/CreateDataStore", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*/collections/*}/dataStores"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_GetDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/GetDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_GetDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/GetDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/collections/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_ListDataStores_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/ListDataStores", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/dataStores"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_ListDataStores_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/ListDataStores", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*/collections/*}/dataStores"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DataStoreService_DeleteDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/DeleteDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DataStoreService_DeleteDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/DeleteDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/collections/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DataStoreService_UpdateDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/UpdateDataStore", runtime.WithHTTPPathPattern("/v1/{data_store.name=projects/*/locations/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DataStoreService_UpdateDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/UpdateDataStore", runtime.WithHTTPPathPattern("/v1/{data_store.name=projects/*/locations/*/collections/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterDataStoreServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extDiscoveryenginepb.DataStoreServiceClient) error {
	...
	mux.Handle("POST", pattern_DataStoreService_CreateDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/CreateDataStore", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/dataStores"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_DataStoreService_CreateDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/CreateDataStore", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*/collections/*}/dataStores"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_GetDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/GetDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_GetDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/GetDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/collections/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_ListDataStores_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/ListDataStores", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/dataStores"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_DataStoreService_ListDataStores_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/ListDataStores", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*/collections/*}/dataStores"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DataStoreService_DeleteDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/DeleteDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_DataStoreService_DeleteDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/DeleteDataStore", runtime.WithHTTPPathPattern("/v1/{name=projects/*/locations/*/collections/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DataStoreService_UpdateDataStore_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/UpdateDataStore", runtime.WithHTTPPathPattern("/v1/{data_store.name=projects/*/locations/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PATCH", pattern_DataStoreService_UpdateDataStore_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.discoveryengine.v1.DataStoreService/UpdateDataStore", runtime.WithHTTPPathPattern("/v1/{data_store.name=projects/*/locations/*/collections/*/dataStores/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
