...
func request_ImageVersions_ListImageVersions_0(ctx context.Context, marshaler runtime.Marshaler, client ImageVersionsClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_ImageVersions_ListImageVersions_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.ListImageVersions(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
func local_request_ImageVersions_ListImageVersions_0(ctx context.Context, marshaler runtime.Marshaler, server ImageVersionsServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := server.ListImageVersions(ctx, &protoReq)
	return msg, metadata, err

}

// RegisterImageVersionsHandlerServer registers the http handlers for service ImageVersions to "mux".
...
func RegisterImageVersionsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ImageVersionsServer) error {
	...
	mux.Handle("GET", pattern_ImageVersions_ListImageVersions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.orchestration.airflow.service.v1beta1.ImageVersions/ListImageVersions", runtime.WithHTTPPathPattern("/v1beta1/{parent=projects/*/locations/*}/imageVersions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ImageVersions_ListImageVersions_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_ImageVersions_ListImageVersions_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
// RegisterImageVersionsHandlerFromEndpoint is same as RegisterImageVersionsHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterImageVersionsHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterImageVersionsHandler(ctx, mux, conn)
}
...
func RegisterImageVersionsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImageVersionsClient) error {
	...
	mux.Handle("GET", pattern_ImageVersions_ListImageVersions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.orchestration.airflow.service.v1beta1.ImageVersions/ListImageVersions", runtime.WithHTTPPathPattern("/v1beta1/{parent=projects/*/locations/*}/imageVersions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ImageVersions_ListImageVersions_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ImageVersions_ListImageVersions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3, 2, 4}, []string{"v1beta1", "projects", "locations", "parent", "imageVersions"}, ""))
)

var (
	forward_ImageVersions_ListImageVersions_0 = runtime.ForwardResponseMessage
)
