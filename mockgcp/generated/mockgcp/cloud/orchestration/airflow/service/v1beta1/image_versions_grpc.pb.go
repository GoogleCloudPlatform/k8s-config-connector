...
func (c *imageVersionsClient) ListImageVersions(ctx context.Context, in *ListImageVersionsRequest, opts ...grpc.CallOption) (*ListImageVersionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1beta1.ImageVersions/ListImageVersions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ImageVersions_ListImageVersions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1beta1.ImageVersions/ListImageVersions",
	}
...
var ImageVersions_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.cloud.orchestration.airflow.service.v1beta1.ImageVersions",
	...
	Metadata: "mockgcp/cloud/orchestration/airflow/service/v1beta1/image_versions.proto",
}
