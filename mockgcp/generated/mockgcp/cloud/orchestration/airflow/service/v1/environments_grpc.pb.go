...
type EnvironmentsClient interface {
	...
	// This method is supported for Cloud Composer environments in versions
	// composer-3-airflow-*.*.*-build.* and newer.
	DeleteUserWorkloadsSecret(ctx context.Context, in *DeleteUserWorkloadsSecretRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	...
	// This method is supported for Cloud Composer environments in versions
	// composer-3-airflow-*.*.*-build.* and newer.
	DeleteUserWorkloadsConfigMap(ctx context.Context, in *DeleteUserWorkloadsConfigMapRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *environmentsClient) ListWorkloads(ctx context.Context, in *ListWorkloadsRequest, opts ...grpc.CallOption) (*ListWorkloadsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/ListWorkloads", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) CheckUpgrade(ctx context.Context, in *CheckUpgradeRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/CheckUpgrade", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) CreateUserWorkloadsSecret(ctx context.Context, in *CreateUserWorkloadsSecretRequest, opts ...grpc.CallOption) (*UserWorkloadsSecret, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/CreateUserWorkloadsSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) GetUserWorkloadsSecret(ctx context.Context, in *GetUserWorkloadsSecretRequest, opts ...grpc.CallOption) (*UserWorkloadsSecret, error) {
	out := new(UserWorkloadsSecret)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/GetUserWorkloadsSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) ListUserWorkloadsSecrets(ctx context.Context, in *ListUserWorkloadsSecretsRequest, opts ...grpc.CallOption) (*ListUserWorkloadsSecretsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/ListUserWorkloadsSecrets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) UpdateUserWorkloadsSecret(ctx context.Context, in *UpdateUserWorkloadsSecretRequest, opts ...grpc.CallOption) (*UserWorkloadsSecret, error) {
	out := new(UserWorkloadsSecret)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/UpdateUserWorkloadsSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) DeleteUserWorkloadsSecret(ctx context.Context, in *DeleteUserWorkloadsSecretRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/DeleteUserWorkloadsSecret", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) CreateUserWorkloadsConfigMap(ctx context.Context, in *CreateUserWorkloadsConfigMapRequest, opts ...grpc.CallOption) (*UserWorkloadsConfigMap, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/CreateUserWorkloadsConfigMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) GetUserWorkloadsConfigMap(ctx context.Context, in *GetUserWorkloadsConfigMapRequest, opts ...grpc.CallOption) (*UserWorkloadsConfigMap, error) {
	out := new(UserWorkloadsConfigMap)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/GetUserWorkloadsConfigMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) ListUserWorkloadsConfigMaps(ctx context.Context, in *ListUserWorkloadsConfigMapsRequest, opts ...grpc.CallOption) (*ListUserWorkloadsConfigMapsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/ListUserWorkloadsConfigMaps", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) UpdateUserWorkloadsConfigMap(ctx context.Context, in *UpdateUserWorkloadsConfigMapRequest, opts ...grpc.CallOption) (*UserWorkloadsConfigMap, error) {
	out := new(UserWorkloadsConfigMap)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/UpdateUserWorkloadsConfigMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *environmentsClient) DeleteUserWorkloadsConfigMap(ctx context.Context, in *DeleteUserWorkloadsConfigMapRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/DeleteUserWorkloadsConfigMap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EnvironmentsServer interface {
	...
	// This method is supported for Cloud Composer environments in versions
	// composer-3-airflow-*.*.*-build.* and newer.
	DeleteUserWorkloadsSecret(context.Context, *DeleteUserWorkloadsSecretRequest) (*empty.Empty, error)
	// Creates a user workloads ConfigMap.
	//
	// This method is supported for Cloud Composer environments in versions
	// composer-3-airflow-*.*.*-build.* and newer.
	...
	// This method is supported for Cloud Composer environments in versions
	// composer-3-airflow-*.*.*-build.* and newer.
	DeleteUserWorkloadsConfigMap(context.Context, *DeleteUserWorkloadsConfigMapRequest) (*empty.Empty, error)
	// Creates a snapshots of a Cloud Composer environment.
	//
	// As a result of this operation, snapshot of environment's state is stored
	// in a location specified in the SaveSnapshotRequest.
...
func (UnimplementedEnvironmentsServer) DeleteUserWorkloadsSecret(context.Context, *DeleteUserWorkloadsSecretRequest) (*empty.Empty, error) {
...
func (UnimplementedEnvironmentsServer) DeleteUserWorkloadsConfigMap(context.Context, *DeleteUserWorkloadsConfigMapRequest) (*empty.Empty, error) {
...
func _Environments_ListWorkloads_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/ListWorkloads",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_CheckUpgrade_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/CheckUpgrade",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_CreateUserWorkloadsSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/CreateUserWorkloadsSecret",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_GetUserWorkloadsSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/GetUserWorkloadsSecret",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_ListUserWorkloadsSecrets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/ListUserWorkloadsSecrets",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_UpdateUserWorkloadsSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/UpdateUserWorkloadsSecret",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_DeleteUserWorkloadsSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/DeleteUserWorkloadsSecret",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_CreateUserWorkloadsConfigMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/CreateUserWorkloadsConfigMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_GetUserWorkloadsConfigMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/GetUserWorkloadsConfigMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_ListUserWorkloadsConfigMaps_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/ListUserWorkloadsConfigMaps",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_UpdateUserWorkloadsConfigMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/UpdateUserWorkloadsConfigMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Environments_DeleteUserWorkloadsConfigMap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.orchestration.airflow.service.v1.Environments/DeleteUserWorkloadsConfigMap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
