...
func RegisterImageVersionsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ImageVersionsServer) error {
	...
	mux.Handle("GET", pattern_ImageVersions_ListImageVersions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.orchestration.airflow.service.v1.ImageVersions/ListImageVersions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/imageVersions"))
		if err != nil {
...
func RegisterImageVersionsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ImageVersionsClient) error {
	...
	mux.Handle("GET", pattern_ImageVersions_ListImageVersions_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.orchestration.airflow.service.v1.ImageVersions/ListImageVersions", runtime.WithHTTPPathPattern("/v1/{parent=projects/*/locations/*}/imageVersions"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ImageVersions_ListImageVersions_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3, 2, 4}, []string{"v1", "projects", "locations", "parent", "imageVersions"}, ""))
)
