...
func RegisterServiceUsageHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ServiceUsageServer) error {
	...
	mux.Handle("POST", pattern_ServiceUsage_EnableService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/EnableService", runtime.WithHTTPPathPattern("/v1/{name=*/*/services/*}:enable"))
		if err != nil {
	...
	mux.Handle("POST", pattern_ServiceUsage_DisableService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/DisableService", runtime.WithHTTPPathPattern("/v1/{name=*/*/services/*}:disable"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ServiceUsage_GetService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/GetService", runtime.WithHTTPPathPattern("/v1/{name=*/*/services/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ServiceUsage_ListServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/ListServices", runtime.WithHTTPPathPattern("/v1/{parent=*/*}/services"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ServiceUsage_BatchEnableServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/BatchEnableServices", runtime.WithHTTPPathPattern("/v1/{parent=*/*}/services:batchEnable"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ServiceUsage_BatchGetServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/BatchGetServices", runtime.WithHTTPPathPattern("/v1/{parent=*/*}/services:batchGet"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterServiceUsageHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServiceUsageClient) error {
	...
	mux.Handle("POST", pattern_ServiceUsage_EnableService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/EnableService", runtime.WithHTTPPathPattern("/v1/{name=*/*/services/*}:enable"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ServiceUsage_DisableService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/DisableService", runtime.WithHTTPPathPattern("/v1/{name=*/*/services/*}:disable"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ServiceUsage_GetService_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/GetService", runtime.WithHTTPPathPattern("/v1/{name=*/*/services/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ServiceUsage_ListServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/ListServices", runtime.WithHTTPPathPattern("/v1/{parent=*/*}/services"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ServiceUsage_BatchEnableServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/BatchEnableServices", runtime.WithHTTPPathPattern("/v1/{parent=*/*}/services:batchEnable"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_ServiceUsage_BatchGetServices_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.cloud.serviceusage.v1.ServiceUsage/BatchGetServices", runtime.WithHTTPPathPattern("/v1/{parent=*/*}/services:batchGet"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
