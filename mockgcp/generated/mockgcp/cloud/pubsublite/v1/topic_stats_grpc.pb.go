...
func (c *topicStatsServiceClient) ComputeMessageStats(ctx context.Context, in *ComputeMessageStatsRequest, opts ...grpc.CallOption) (*ComputeMessageStatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.pubsublite.v1.TopicStatsService/ComputeMessageStats", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topicStatsServiceClient) ComputeHeadCursor(ctx context.Context, in *ComputeHeadCursorRequest, opts ...grpc.CallOption) (*ComputeHeadCursorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.pubsublite.v1.TopicStatsService/ComputeHeadCursor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *topicStatsServiceClient) ComputeTimeCursor(ctx context.Context, in *ComputeTimeCursorRequest, opts ...grpc.CallOption) (*ComputeTimeCursorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.cloud.pubsublite.v1.TopicStatsService/ComputeTimeCursor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedTopicStatsServiceServer
...
// UnimplementedTopicStatsServiceServer must be embedded to have forward compatible implementations.
...
func (UnimplementedTopicStatsServiceServer) mustEmbedUnimplementedTopicStatsServiceServer() {}
...
func _TopicStatsService_ComputeMessageStats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.pubsublite.v1.TopicStatsService/ComputeMessageStats",
	}
...
func _TopicStatsService_ComputeHeadCursor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.pubsublite.v1.TopicStatsService/ComputeHeadCursor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TopicStatsService_ComputeTimeCursor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.cloud.pubsublite.v1.TopicStatsService/ComputeTimeCursor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var TopicStatsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.cloud.pubsublite.v1.TopicStatsService",
	...
	Metadata: "mockgcp/cloud/pubsublite/v1/topic_stats.proto",
}
