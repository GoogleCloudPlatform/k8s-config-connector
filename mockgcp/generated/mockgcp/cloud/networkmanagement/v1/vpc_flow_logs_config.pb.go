...
// 	protoc        v3.12.4
// source: mockgcp/cloud/networkmanagement/v1/vpc_flow_logs_config.proto
...
func (VpcFlowLogsConfig_State) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[0].Descriptor()
}

func (VpcFlowLogsConfig_State) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[0]
}
...
func (VpcFlowLogsConfig_State) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{0, 0}
}
...
func (VpcFlowLogsConfig_AggregationInterval) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[1].Descriptor()
}

func (VpcFlowLogsConfig_AggregationInterval) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[1]
}
...
func (VpcFlowLogsConfig_AggregationInterval) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{0, 1}
}
...
func (VpcFlowLogsConfig_Metadata) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[2].Descriptor()
}

func (VpcFlowLogsConfig_Metadata) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[2]
}
...
func (VpcFlowLogsConfig_Metadata) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{0, 2}
}
...
func (VpcFlowLogsConfig_CrossProjectMetadata) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[3].Descriptor()
}

func (VpcFlowLogsConfig_CrossProjectMetadata) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[3]
}
...
func (VpcFlowLogsConfig_CrossProjectMetadata) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{0, 3}
}
...
func (VpcFlowLogsConfig_TargetResourceState) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[4].Descriptor()
}

func (VpcFlowLogsConfig_TargetResourceState) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[4]
}
...
func (VpcFlowLogsConfig_TargetResourceState) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{0, 4}
}
...
func (EffectiveVpcFlowLogsConfig_Scope) Descriptor() protoreflect.EnumDescriptor {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[5].Descriptor()
}

func (EffectiveVpcFlowLogsConfig_Scope) Type() protoreflect.EnumType {
	return &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes[5]
}
...
func (EffectiveVpcFlowLogsConfig_Scope) EnumDescriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{1, 0}
}
...
type VpcFlowLogsConfig struct {
	...
	State *VpcFlowLogsConfig_State `protobuf:"varint,3,opt,name=state,proto3,enum=mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig_State,oneof" json:"state,omitempty"`
	// Optional. The aggregation interval for the logs. Default value is
	// INTERVAL_5_SEC.
	AggregationInterval *VpcFlowLogsConfig_AggregationInterval `protobuf:"varint,4,opt,name=aggregation_interval,json=aggregationInterval,proto3,enum=mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig_AggregationInterval,oneof" json:"aggregation_interval,omitempty"`
	...
	Metadata *VpcFlowLogsConfig_Metadata `protobuf:"varint,6,opt,name=metadata,proto3,enum=mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig_Metadata,oneof" json:"metadata,omitempty"`
	...
	CrossProjectMetadata *VpcFlowLogsConfig_CrossProjectMetadata `protobuf:"varint,13,opt,name=cross_project_metadata,json=crossProjectMetadata,proto3,enum=mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig_CrossProjectMetadata,oneof" json:"cross_project_metadata,omitempty"`
	// Output only. Describes the state of the configured target resource for
	// diagnostic purposes.
	TargetResourceState *VpcFlowLogsConfig_TargetResourceState `protobuf:"varint,12,opt,name=target_resource_state,json=targetResourceState,proto3,enum=mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig_TargetResourceState,oneof" json:"target_resource_state,omitempty"`
...
func (x *VpcFlowLogsConfig) Reset() {
	*x = VpcFlowLogsConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes[0]
...
func (*VpcFlowLogsConfig) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{0}
}
...
func (x *VpcFlowLogsConfig) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
func (x *VpcFlowLogsConfig) GetUpdateTime() *timestamp.Timestamp {
	if x != nil {
		return x.UpdateTime
	}
	return nil
...
type EffectiveVpcFlowLogsConfig struct {
	...
	Scope *EffectiveVpcFlowLogsConfig_Scope `protobuf:"varint,12,opt,name=scope,proto3,enum=mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig_Scope,oneof" json:"scope,omitempty"`
}

func (x *EffectiveVpcFlowLogsConfig) Reset() {
	*x = EffectiveVpcFlowLogsConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*EffectiveVpcFlowLogsConfig) Descriptor() ([]byte, []int) {
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP(), []int{1}
}
...
var File_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto protoreflect.FileDescriptor

var file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDesc = []byte{
	...
	0x67, 0x73, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x22, 0x6d, 0x6f, 0x63, 0x6b, 0x67, 0x63, 0x70, 0x2e, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e, 0x6e,
	...
	0x22, 0x9b, 0x12, 0x0a, 0x11, 0x56, 0x70, 0x63, 0x46, 0x6c, 0x6f, 0x77, 0x4c, 0x6f, 0x67, 0x73,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x12, 0x5b, 0x0a, 0x05, 0x73,
	0x74, 0x61, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3b, 0x2e, 0x6d, 0x6f, 0x63,
	...
	0x67, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x42, 0x03, 0xe0, 0x41, 0x01, 0x48, 0x02, 0x52, 0x05,
	0x73, 0x74, 0x61, 0x74, 0x65, 0x88, 0x01, 0x01, 0x12, 0x86, 0x01, 0x0a, 0x14, 0x61, 0x67, 0x67,
	0x72, 0x65, 0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61,
	0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x49, 0x2e, 0x6d, 0x6f, 0x63, 0x6b, 0x67, 0x63,
	...
	,
	...
	,
	...
	0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x72, 0x6f, 0x73, 0x73, 0x50, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x03, 0xe0, 0x41,
	0x01, 0x48, 0x07, 0x52, 0x14, 0x63, 0x72, 0x6f, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63,
	0x74, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x88, 0x01, 0x01, 0x12, 0x87, 0x01, 0x0a,
	0x15, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x5f, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x49, 0x2e, 0x6d,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x39, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65,
	...
	,
	...
	,
	...
	0x6c, 0x6f, 0x77, 0x4c, 0x6f, 0x67, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x51, 0x70,
	0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x2f, 0x7b, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74,
	0x7d, 0x2f, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x7b, 0x6c, 0x6f, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x7d, 0x2f, 0x76, 0x70, 0x63, 0x46, 0x6c, 0x6f, 0x77, 0x4c, 0x6f,
	0x67, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x73, 0x2f, 0x7b, 0x76, 0x70, 0x63, 0x5f, 0x66,
	0x6c, 0x6f, 0x77, 0x5f, 0x6c, 0x6f, 0x67, 0x73, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x7d,
	...
	,
	...
	,
	...
	,
	...
	0x74, 0x65, 0x72, 0x5f, 0x65, 0x78, 0x70, 0x72, 0x42, 0x19, 0x0a, 0x17, 0x5f, 0x63, 0x72, 0x6f,
	0x73, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64,
	0x61, 0x74, 0x61, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x42, 0xf3, 0x02,
	...
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x16, 0x56, 0x70, 0x63, 0x46, 0x6c, 0x6f,
	0x77, 0x4c, 0x6f, 0x67, 0x73, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x6e, 0x74, 0x3a, 0x3a, 0x56, 0x31, 0xea, 0x41, 0x6a, 0x0a, 0x35, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	0x72, 0x6b, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x61, 0x70, 0x69, 0x73, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x4f, 0x72, 0x67, 0x61,
	0x6e, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
...
var (
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescOnce sync.Once
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescData = file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDesc
)

func file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescGZIP() []byte {
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescOnce.Do(func() {
		file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescData)
	})
	return file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDescData
}

var file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes = make([]protoimpl.EnumInfo, 6)
var file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_goTypes = []interface{}{
	(VpcFlowLogsConfig_State)(0),                // 0: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.State
	(VpcFlowLogsConfig_AggregationInterval)(0),  // 1: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.AggregationInterval
	(VpcFlowLogsConfig_Metadata)(0),             // 2: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.Metadata
	(VpcFlowLogsConfig_CrossProjectMetadata)(0), // 3: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.CrossProjectMetadata
	(VpcFlowLogsConfig_TargetResourceState)(0),  // 4: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.TargetResourceState
	(EffectiveVpcFlowLogsConfig_Scope)(0),       // 5: mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig.Scope
	(*VpcFlowLogsConfig)(nil),                   // 6: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig
	(*EffectiveVpcFlowLogsConfig)(nil),          // 7: mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig
	nil,                                         // 8: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.LabelsEntry
	(*timestamp.Timestamp)(nil),                 // 9: google.protobuf.Timestamp
}
var file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_depIdxs = []int32{
	0,  // 0: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.state:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.State
	1,  // 1: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.aggregation_interval:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.AggregationInterval
	2,  // 2: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.metadata:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.Metadata
	3,  // 3: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.cross_project_metadata:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.CrossProjectMetadata
	4,  // 4: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.target_resource_state:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.TargetResourceState
	8,  // 5: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.labels:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.LabelsEntry
	9,  // 6: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.create_time:type_name -> google.protobuf.Timestamp
	9,  // 7: mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.update_time:type_name -> google.protobuf.Timestamp
	0,  // 8: mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig.state:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.State
	1,  // 9: mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig.aggregation_interval:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.AggregationInterval
	2,  // 10: mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig.metadata:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.Metadata
	3,  // 11: mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig.cross_project_metadata:type_name -> mockgcp.cloud.networkmanagement.v1.VpcFlowLogsConfig.CrossProjectMetadata
	5,  // 12: mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig.scope:type_name -> mockgcp.cloud.networkmanagement.v1.EffectiveVpcFlowLogsConfig.Scope
...
func init() { file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_init() }
func file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_init() {
	if File_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VpcFlowLogsConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EffectiveVpcFlowLogsConfig); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes[1].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDesc,
			NumEnums:      6,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_goTypes,
		DependencyIndexes: file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_depIdxs,
		EnumInfos:         file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_enumTypes,
		MessageInfos:      file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_msgTypes,
	}.Build()
	File_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto = out.File
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_rawDesc = nil
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_goTypes = nil
	file_mockgcp_cloud_networkmanagement_v1_vpc_flow_logs_config_proto_depIdxs = nil
}
