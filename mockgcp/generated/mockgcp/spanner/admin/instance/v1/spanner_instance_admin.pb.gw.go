...
func request_InstanceAdmin_MoveInstance_0(ctx context.Context, marshaler runtime.Marshaler, client InstanceAdminClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq MoveInstanceRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.MoveInstance(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_InstanceAdmin_MoveInstance_0(ctx context.Context, marshaler runtime.Marshaler, server InstanceAdminServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq MoveInstanceRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.MoveInstance(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterInstanceAdminHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InstanceAdminServer) error {
	...
	mux.Handle("POST", pattern_InstanceAdmin_MoveInstance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.spanner.admin.instance.v1.InstanceAdmin/MoveInstance", runtime.WithHTTPPathPattern("/v1/{name=projects/*/instances/*}:move"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_InstanceAdmin_MoveInstance_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_InstanceAdmin_MoveInstance_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterInstanceAdminHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InstanceAdminClient) error {
	...
	mux.Handle("POST", pattern_InstanceAdmin_MoveInstance_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.spanner.admin.instance.v1.InstanceAdmin/MoveInstance", runtime.WithHTTPPathPattern("/v1/{name=projects/*/instances/*}:move"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_InstanceAdmin_MoveInstance_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_InstanceAdmin_MoveInstance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 4, 4, 5, 3}, []string{"v1", "projects", "instances", "name"}, "move"))
)
...
var (
	...
	forward_InstanceAdmin_MoveInstance_0 = runtime.ForwardResponseMessage
)
