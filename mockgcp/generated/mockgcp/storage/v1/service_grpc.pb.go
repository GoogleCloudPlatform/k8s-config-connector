...
type BucketsServerClient interface {
	...
	RestoreBucket(ctx context.Context, in *RestoreBucketRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *bucketsServerClient) RestoreBucket(ctx context.Context, in *RestoreBucketRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type BucketsServerServer interface {
	...
	// Restores a soft-deleted bucket.
	RestoreBucket(context.Context, *RestoreBucketRequest) (*empty.Empty, error)
	// Updates a bucket. Changes to the bucket will be readable immediately after writing, but configuration changes may take time to propagate.
...
func (UnimplementedBucketsServerServer) RestoreBucket(context.Context, *RestoreBucketRequest) (*empty.Empty, error) {
