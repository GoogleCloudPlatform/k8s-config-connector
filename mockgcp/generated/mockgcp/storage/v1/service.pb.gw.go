...
var (
	filter_FoldersServer_DeleteRecursiveFolder_0 = &utilities.DoubleArray{Encoding: map[string]int{"bucket": 0, "name": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)

func request_FoldersServer_DeleteRecursiveFolder_0(ctx context.Context, marshaler runtime.Marshaler, client FoldersServerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteRecursiveFolderRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_FoldersServer_DeleteRecursiveFolder_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.DeleteRecursiveFolder(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_FoldersServer_DeleteRecursiveFolder_0(ctx context.Context, marshaler runtime.Marshaler, server FoldersServerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeleteRecursiveFolderRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.DeleteRecursiveFolder(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterFoldersServerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FoldersServerServer) error {
	...
	mux.Handle("POST", pattern_FoldersServer_DeleteRecursiveFolder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.storage.v1.FoldersServer/DeleteRecursiveFolder", runtime.WithHTTPPathPattern("/storage/v1/b/{bucket}/folders/{name}/deleteRecursive"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_FoldersServer_DeleteRecursiveFolder_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_FoldersServer_DeleteRecursiveFolder_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterFoldersServerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FoldersServerClient) error {
	...
	mux.Handle("POST", pattern_FoldersServer_DeleteRecursiveFolder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.storage.v1.FoldersServer/DeleteRecursiveFolder", runtime.WithHTTPPathPattern("/storage/v1/b/{bucket}/folders/{name}/deleteRecursive"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_FoldersServer_DeleteRecursiveFolder_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_FoldersServer_DeleteRecursiveFolder_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"storage", "v1", "b", "bucket", "folders", "name", "deleteRecursive"}, ""))
...
var (
	...
	forward_FoldersServer_DeleteRecursiveFolder_0 = runtime.ForwardResponseMessage
