...
func request_ArtifactRegistry_ExportArtifact_0(ctx context.Context, marshaler runtime.Marshaler, client ArtifactRegistryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ExportArtifactRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ExportArtifact(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ArtifactRegistry_ExportArtifact_0(ctx context.Context, marshaler runtime.Marshaler, server ArtifactRegistryServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ExportArtifactRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.ExportArtifact(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterArtifactRegistryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ArtifactRegistryServer) error {
	...
	mux.Handle("POST", pattern_ArtifactRegistry_ExportArtifact_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.devtools.artifactregistry.v1.ArtifactRegistry/ExportArtifact", runtime.WithHTTPPathPattern("/v1/{repository=projects/*/locations/*/repositories/*}:exportArtifact"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ArtifactRegistry_ExportArtifact_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_ArtifactRegistry_ExportArtifact_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterArtifactRegistryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ArtifactRegistryClient) error {
	...
	mux.Handle("POST", pattern_ArtifactRegistry_ExportArtifact_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.devtools.artifactregistry.v1.ArtifactRegistry/ExportArtifact", runtime.WithHTTPPathPattern("/v1/{repository=projects/*/locations/*/repositories/*}:exportArtifact"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ArtifactRegistry_ExportArtifact_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_ArtifactRegistry_ExportArtifact_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 2, 2, 1, 0, 2, 3, 1, 0, 4, 6, 5, 4}, []string{"v1", "projects", "locations", "repositories", "repository"}, "exportArtifact"))
)
...
var (
	...
	forward_ArtifactRegistry_ExportArtifact_0 = runtime.ForwardResponseMessage
)
