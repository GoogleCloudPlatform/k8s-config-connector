...
type AccessContextManagerClient interface {
	...
	// [mockgcp.identity.accesscontextmanager.v1.AccessPolicy] in an
	// organization.
	...
	// [mockgcp.identity.accesscontextmanager.v1.AccessPolicy] based on the name.
	...
	// [mockgcp.identity.accesscontextmanager.v1.AccessPolicy]. The
	// long-running operation from this RPC has a successful status after the
	// changes to the [access policy]
	// [mockgcp.identity.accesscontextmanager.v1.AccessPolicy] propagate
	...
	// [mockgcp.identity.accesscontextmanager.v1.AccessPolicy] based on the
	// resource name. The long-running operation has a successful status after the
	// [access policy] [mockgcp.identity.accesscontextmanager.v1.AccessPolicy]
	...
	// the [access level]
	// [mockgcp.identity.accesscontextmanager.v1.AccessLevel] propagate
	...
	// [mockgcp.identity.accesscontextmanager.v1.AccessLevel] has been removed
	...
	// [mockgcp.identity.accesscontextmanager.v1.AccessLevel] in an [access
	// policy] [mockgcp.identity.accesscontextmanager.v1.AccessPolicy] with
	// the [access levels]
	// [mockgcp.identity.accesscontextmanager.v1.AccessLevel] provided. This
	// is done atomically. The long-running operation from this RPC has a
	// successful status after all replacements propagate to long-lasting
	// storage. If the replacement contains errors, an error response is returned
	// for the first error encountered.  Upon error, the replacement is cancelled,
	// and existing [access levels]
	// [mockgcp.identity.accesscontextmanager.v1.AccessLevel] are not
	// affected. The Operation.response field contains
	// ReplaceAccessLevelsResponse. Removing [access levels]
	// [mockgcp.identity.accesscontextmanager.v1.AccessLevel] contained in existing
	// [service perimeters]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] result in an
	// error.
	...
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] for an
	// access policy.
	...
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] based on the
	// resource name.
	GetServicePerimeter(ctx context.Context, in *GetServicePerimeterRequest, opts ...grpc.CallOption) (*ServicePerimeter, error)
	// Creates a [service perimeter]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter]. The
	// long-running operation from this RPC has a successful status after the
	// [service perimeter]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter]
	// propagates to long-lasting storage. If a [service perimeter]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] contains
	// errors, an error response is returned for the first error encountered.
	...
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] is removed from
	...
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] in an [access
	// policy] [mockgcp.identity.accesscontextmanager.v1.AccessPolicy] with the
	// [service perimeters]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] provided. This
	// is done atomically. The long-running operation from this RPC has a
	// successful status after all replacements propagate to long-lasting storage.
	// Replacements containing errors result in an error response for the first
	// error encountered. Upon an error, replacement are cancelled and existing
	// [service perimeters]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] are not
	// affected. The Operation.response field contains
	...
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] in an
	// [access policy][mockgcp.identity.accesscontextmanager.v1.AccessPolicy].
	// A commit operation on a service perimeter involves copying its `spec` field
	// to the `status` field of the service perimeter. Only [service perimeters]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] with
	// `use_explicit_dry_run_spec` field set to true are affected by a commit
	// operation. The long-running operation from this RPC has a successful
	// status after the dry-run specifications for all the [service perimeters]
	// [mockgcp.identity.accesscontextmanager.v1.ServicePerimeter] have been
	...
	// [mockgcp.identity.accesscontextmanager.v1.GcpUserAccessBinding] for a
	...
	// [mockgcp.identity.accesscontextmanager.v1.GcpUserAccessBinding] with
	// the given name.
	...
	// [mockgcp.identity.accesscontextmanager.v1.GcpUserAccessBinding]. If the
	// client specifies a [name]
	// [mockgcp.identity.accesscontextmanager.v1.GcpUserAccessBinding.name],
	// the server ignores it. Fails if a resource already exists with the same
	// [group_key]
	// [mockgcp.identity.accesscontextmanager.v1.GcpUserAccessBinding.group_key].
	...
	// policy][mockgcp.identity.accesscontextmanager.v1.AccessPolicy].
	...
	// [AccessPolicy][mockgcp.identity.accesscontextmanager.v1.AccessPolicy],
	// [AccessLevel][mockgcp.identity.accesscontextmanager.v1.AccessLevel], or
	// [ServicePerimeter][mockgcp.identity.accesscontextmanager.v1.ServicePerimeter
...
func (c *accessContextManagerClient) ListAccessPolicies(ctx context.Context, in *ListAccessPoliciesRequest, opts ...grpc.CallOption) (*ListAccessPoliciesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListAccessPolicies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) GetAccessPolicy(ctx context.Context, in *GetAccessPolicyRequest, opts ...grpc.CallOption) (*AccessPolicy, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetAccessPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) CreateAccessPolicy(ctx context.Context, in *AccessPolicy, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateAccessPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) UpdateAccessPolicy(ctx context.Context, in *UpdateAccessPolicyRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateAccessPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) DeleteAccessPolicy(ctx context.Context, in *DeleteAccessPolicyRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteAccessPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) ListAccessLevels(ctx context.Context, in *ListAccessLevelsRequest, opts ...grpc.CallOption) (*ListAccessLevelsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListAccessLevels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) GetAccessLevel(ctx context.Context, in *GetAccessLevelRequest, opts ...grpc.CallOption) (*AccessLevel, error) {
	out := new(AccessLevel)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetAccessLevel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) CreateAccessLevel(ctx context.Context, in *CreateAccessLevelRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateAccessLevel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) UpdateAccessLevel(ctx context.Context, in *UpdateAccessLevelRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateAccessLevel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) DeleteAccessLevel(ctx context.Context, in *DeleteAccessLevelRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteAccessLevel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) ReplaceAccessLevels(ctx context.Context, in *ReplaceAccessLevelsRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ReplaceAccessLevels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) ListServicePerimeters(ctx context.Context, in *ListServicePerimetersRequest, opts ...grpc.CallOption) (*ListServicePerimetersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListServicePerimeters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) GetServicePerimeter(ctx context.Context, in *GetServicePerimeterRequest, opts ...grpc.CallOption) (*ServicePerimeter, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetServicePerimeter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) CreateServicePerimeter(ctx context.Context, in *CreateServicePerimeterRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateServicePerimeter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) UpdateServicePerimeter(ctx context.Context, in *UpdateServicePerimeterRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateServicePerimeter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) DeleteServicePerimeter(ctx context.Context, in *DeleteServicePerimeterRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteServicePerimeter", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) ReplaceServicePerimeters(ctx context.Context, in *ReplaceServicePerimetersRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ReplaceServicePerimeters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) CommitServicePerimeters(ctx context.Context, in *CommitServicePerimetersRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CommitServicePerimeters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) ListGcpUserAccessBindings(ctx context.Context, in *ListGcpUserAccessBindingsRequest, opts ...grpc.CallOption) (*ListGcpUserAccessBindingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListGcpUserAccessBindings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) GetGcpUserAccessBinding(ctx context.Context, in *GetGcpUserAccessBindingRequest, opts ...grpc.CallOption) (*GcpUserAccessBinding, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetGcpUserAccessBinding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) CreateGcpUserAccessBinding(ctx context.Context, in *CreateGcpUserAccessBindingRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateGcpUserAccessBinding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) UpdateGcpUserAccessBinding(ctx context.Context, in *UpdateGcpUserAccessBindingRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateGcpUserAccessBinding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) DeleteGcpUserAccessBinding(ctx context.Context, in *DeleteGcpUserAccessBindingRequest, opts ...grpc.CallOption) (*longrunningpb.Operation, error) {
	out := new(longrunningpb.Operation)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteGcpUserAccessBinding", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) SetIamPolicy(ctx context.Context, in *iampb.SetIamPolicyRequest, opts ...grpc.CallOption) (*iampb.Policy, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/SetIamPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) GetIamPolicy(ctx context.Context, in *iampb.GetIamPolicyRequest, opts ...grpc.CallOption) (*iampb.Policy, error) {
	out := new(iampb.Policy)
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetIamPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accessContextManagerClient) TestIamPermissions(ctx context.Context, in *iampb.TestIamPermissionsRequest, opts ...grpc.CallOption) (*iampb.TestIamPermissionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/TestIamPermissions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations must embed UnimplementedAccessContextManagerServer
...
// UnimplementedAccessContextManagerServer must be embedded to have forward compatible implementations.
...
func (UnimplementedAccessContextManagerServer) mustEmbedUnimplementedAccessContextManagerServer() {}
...
func _AccessContextManager_ListAccessPolicies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListAccessPolicies",
	}
...
func _AccessContextManager_GetAccessPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetAccessPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_CreateAccessPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateAccessPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_UpdateAccessPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateAccessPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_DeleteAccessPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteAccessPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_ListAccessLevels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListAccessLevels",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_GetAccessLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetAccessLevel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_CreateAccessLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateAccessLevel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_UpdateAccessLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateAccessLevel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_DeleteAccessLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteAccessLevel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_ReplaceAccessLevels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ReplaceAccessLevels",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_ListServicePerimeters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListServicePerimeters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_GetServicePerimeter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetServicePerimeter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_CreateServicePerimeter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateServicePerimeter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_UpdateServicePerimeter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateServicePerimeter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_DeleteServicePerimeter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteServicePerimeter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_ReplaceServicePerimeters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ReplaceServicePerimeters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_CommitServicePerimeters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CommitServicePerimeters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_ListGcpUserAccessBindings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/ListGcpUserAccessBindings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_GetGcpUserAccessBinding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetGcpUserAccessBinding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_CreateGcpUserAccessBinding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/CreateGcpUserAccessBinding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_UpdateGcpUserAccessBinding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/UpdateGcpUserAccessBinding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_DeleteGcpUserAccessBinding_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/DeleteGcpUserAccessBinding",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_SetIamPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/SetIamPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_GetIamPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/GetIamPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AccessContextManager_TestIamPermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/mockgcp.identity.accesscontextmanager.v1.AccessContextManager/TestIamPermissions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var AccessContextManager_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mockgcp.identity.accesscontextmanager.v1.AccessContextManager",
	...
	Metadata: "mockgcp/identity/accesscontextmanager/v1/access_context_manager.proto",
}
