...
// source: mockgcp/iam/v2/policy.proto
...
func RegisterPoliciesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server iampb_0.PoliciesServer) error {
	...
	mux.Handle("GET", pattern_Policies_ListPolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/ListPolicies", runtime.WithHTTPPathPattern("/v2/{parent=policies/*/*}"))
		if err != nil {
	...
	mux.Handle("GET", pattern_Policies_GetPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/GetPolicy", runtime.WithHTTPPathPattern("/v2/{name=policies/*/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Policies_CreatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/CreatePolicy", runtime.WithHTTPPathPattern("/v2/{parent=policies/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_Policies_UpdatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/UpdatePolicy", runtime.WithHTTPPathPattern("/v2/{policy.name=policies/*/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_Policies_DeletePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/DeletePolicy", runtime.WithHTTPPathPattern("/v2/{name=policies/*/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterPoliciesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client iampb_0.PoliciesClient) error {
	...
	mux.Handle("GET", pattern_Policies_ListPolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/ListPolicies", runtime.WithHTTPPathPattern("/v2/{parent=policies/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_Policies_GetPolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/GetPolicy", runtime.WithHTTPPathPattern("/v2/{name=policies/*/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_Policies_CreatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/CreatePolicy", runtime.WithHTTPPathPattern("/v2/{parent=policies/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("PUT", pattern_Policies_UpdatePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/UpdatePolicy", runtime.WithHTTPPathPattern("/v2/{policy.name=policies/*/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("DELETE", pattern_Policies_DeletePolicy_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/mockgcp.iam.v2.Policies/DeletePolicy", runtime.WithHTTPPathPattern("/v2/{name=policies/*/*/*}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
