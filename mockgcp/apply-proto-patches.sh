...
sed -i 's/^[[:space:]]*DECRYPTED = 2;/    DECRYPTED = 2;\n\n    \/\/ Secrets in etcd are encrypted.\n    ALL_OBJECTS_ENCRYPTION_ENABLED = 3;/' ${REPO_ROOT}/mockgcp/third_party/googleapis/google/container/v1beta1/cluster_service.proto
