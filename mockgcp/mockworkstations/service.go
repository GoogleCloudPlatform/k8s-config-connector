...
// MockService represents a mocked workstations service.
...
type workstationsServer struct {
	*MockService
	pb.UnimplementedWorkstationsServer
}

func (s *MockService) Register(grpcServer *grpc.Server) {
	pb.RegisterWorkstationsServer(grpcServer, &workstationsServer{MockService: s})
}

func (s *MockService) NewHTTPMux(ctx context.Context, conn *grpc.ClientConn) (http.Handler, error) {
	mux, err := httpmux.NewServeMux(ctx, conn, pb.RegisterWorkstationsHandler,
