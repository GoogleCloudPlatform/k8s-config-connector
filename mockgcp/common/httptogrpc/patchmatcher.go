...
type pathMatcher struct {
	// httpPath is the original HTTP path pattern
	httpPath string
...
// type matchEndComponent struct {
// }

// func newMatchEndComponent() *matchEndComponent {
// 	return &matchEndComponent{}
// }

// func (m *matchEndComponent) Match(tokens []string, matches map[string]string) (bool, []string) {
// 	if len(tokens) == 0 {
// 		return true, nil
// 	}
// 	return false, nil
