...
// http.host: dialogflow.googleapis.com
// proto.service: google.cloud.dialogflow.v2beta1.SipTrunks
...
func (s *MockService) ExpectedHosts() []string {
	return []string{"dialogflow.googleapis.com"}
}
...
type sipTrunksServer struct {
	*MockService
	pb.UnimplementedSipTrunksServer
}
