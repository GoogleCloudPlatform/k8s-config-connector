...
func (s *DocumentProcessorV1Beta3) GetProcessor(ctx context.Context, req *pb.GetProcessorRequest) (*pb.Processor, error) {
...
func (s *DocumentProcessorV1Beta3) CreateProcessor(ctx context.Context, req *pb.CreateProcessorRequest) (*pb.Processor, error) {
...
func (s *DocumentProcessorV1Beta3) DeleteProcessor(ctx context.Context, req *pb.DeleteProcessorRequest) (*longrunningpb.Operation, error) {
	name, err := s.ParseProcessorName(req.GetName())
	if err != nil {
		return nil, err
	}
...
func (s *DocumentProcessorV1Beta3) ParseProcessorName(name string) (*ProcessorName, error) {
