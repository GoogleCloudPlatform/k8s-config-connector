...
func (s *MockService) ExpectedHosts() []string {
	return []string{
		...
		"contactcenterinsights.{location}.rep.googleapis.com",
		"contactcenterinsights.{location}.rep.googleapis.com:443",
		"contactcenterinsights.{location}.googleapis.com",
		"contactcenterinsights.{location}.googleapis.com:443",
	}
}
...
func (s *MockService) NewHTTPMux(ctx context.Context, conn *grpc.ClientConn) (http.Handler, error) {
	...
	mux.RewriteHeaders = func(ctx context.Context, response http.ResponseWriter, payload proto.Message) {
		response.Header().Set("Server", "scaffolding on HTTPServer2")
