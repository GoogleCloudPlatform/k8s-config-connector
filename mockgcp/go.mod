...
require (
	...
	cloud.google.com/go/discoveryengine v1.15.0 // indirect
	...
	github.com/hashicorp/terraform-provider-google-beta v3.73.0+incompatible // indirect
	...
	k8s.io/client-go v0.27.11 // indirect
