...
import (
	...
	pb_http "github.com/GoogleCloudPlatform/k8s-config-connector/mockgcp/generated/google/cloud/gkemulticloud/v1"
...
func (s *MockService) NewHTTPMux(ctx context.Context, conn *grpc.ClientConn) (*runtime.ServeMux, error) {
	...
	if err := pb_http.RegisterAttachedClustersHandler(ctx, mux, conn); err != nil {
		return nil, err
	}
