...
import (
	...
	pb "github.com/GoogleCloudPlatform/k8s-config-connector/mockgcp/generated/mockgcp/cloud/serviceusage/v1beta1"
...
func (s *ServiceUsageV1Beta1) GenerateServiceIdentity(ctx context.Context, req *pb.GenerateServiceIdentityRequest) (*longrunning.Operation, error) {
	...
	case "notebooks.googleapis.com":
		identity.Email = "service-" + strconv.FormatInt(name.Project.Number, 10) + "@gcp-sa-notebooks.iam.gserviceaccount.com"
	default:
