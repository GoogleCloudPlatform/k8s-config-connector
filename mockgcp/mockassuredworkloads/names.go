...
func (n *workloadName) String() string {
	return "organizations/" + n.Organization + "/locations/" + n.Location + "/workloads/" + n.Workload
}

// parseWorkloadName parses a string into a workloadName.
// Expected format: organizations/{orgID}/locations/{locationID}/workloads/{workloadID}
