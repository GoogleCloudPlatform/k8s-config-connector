...
func (s *MockService) Register(grpcServer *grpc.Server) {
	...
	discoveryenginepb.RegisterLicenseConfigServiceServer(grpcServer, &licenseConfigService{MockService: s})
}
...
func (s *MockService) NewHTTPMux(ctx context.Context, conn *grpc.ClientConn) (http.Handler, error) {
	...
	mux.AddService(discoveryenginepb.NewLicenseConfigServiceClient(conn))
