...
func (in *ContainerReconcilerSpec) DeepCopyInto(out *ContainerReconcilerSpec) {
	*out = *in
	if in.RateLimit != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerReconcilerSpec.
func (in *ContainerReconcilerSpec) DeepCopy() *ContainerReconcilerSpec {
	if in == nil {
		return nil
	}
	out := new(ContainerReconcilerSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NamespacedControllerReconcilerSpec) DeepCopyInto(out *NamespacedControllerReconcilerSpec) {
	*out = *in
	if in.Containers != nil {
		in, out := &in.Containers, &out.Containers
		*out = make([]ContainerReconcilerSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
