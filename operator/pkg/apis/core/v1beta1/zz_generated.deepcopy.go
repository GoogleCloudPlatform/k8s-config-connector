...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResourceKinds) DeepCopyInto(out *ResourceKinds) {
	*out = *in
	if in.Allowlist != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResourceKinds.
func (in *ResourceKinds) DeepCopy() *ResourceKinds {
	if in == nil {
		return nil
	}
	out := new(ResourceKinds)
