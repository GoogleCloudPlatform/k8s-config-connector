...
class Role(object):
    ...
    def apply(self):
        stub = role_pb2_grpc.IamAlphaRoleServiceStub(channel.Channel())
        request = role_pb2.ApplyIamAlphaRoleRequest()
        ...
        response = stub.ApplyIamAlphaRole(request)
    ...
    def delete(self):
        stub = role_pb2_grpc.IamAlphaRoleServiceStub(channel.Channel())
        request = role_pb2.DeleteIamAlphaRoleRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteIamAlphaRole(request)

    @classmethod
    def list(self, parent, service_account_file=""):
        stub = role_pb2_grpc.IamAlphaRoleServiceStub(channel.Channel())
        request = role_pb2.ListIamAlphaRoleRequest()
        request.service_account_file = service_account_file
        request.Parent = parent

        return stub.ListIamAlphaRole(request).items

    def to_proto(self):
        resource = role_pb2.IamAlphaRole()
        if Primitive.to_proto(self.name):
...
class RoleLocalizedValues(object):
    ...
    def to_proto(self, resource):
        ...
        res = role_pb2.IamAlphaRoleLocalizedValues()
...
class RoleStageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return role_pb2.IamAlphaRoleStageEnum.Value(
            "IamAlphaRoleStageEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return role_pb2.IamAlphaRoleStageEnum.Name(resource)[
            len("IamAlphaRoleStageEnum") :
        ]
