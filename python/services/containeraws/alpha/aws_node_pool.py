...
from google3.cloud.graphite.mmv2.services.google.container_aws import aws_node_pool_pb2
...
class AwsNodePool(object):
    ...
    def apply(self):
        stub = aws_node_pool_pb2_grpc.ContainerawsAlphaAwsNodePoolServiceStub(
            channel.Channel()
        )
        request = aws_node_pool_pb2.ApplyContainerawsAlphaAwsNodePoolRequest()
        ...
        response = stub.ApplyContainerawsAlphaAwsNodePool(request)
    ...
    def delete(self):
        ...
        request = aws_node_pool_pb2.DeleteContainerawsAlphaAwsNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteContainerawsAlphaAwsNodePool(request)

    def list(self):
        stub = aws_node_pool_pb2_grpc.ContainerawsAlphaAwsNodePoolServiceStub(
            channel.Channel()
        )
        request = aws_node_pool_pb2.ListContainerawsAlphaAwsNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListContainerawsAlphaAwsNodePool(request).items

    def to_proto(self):
        resource = aws_node_pool_pb2.ContainerawsAlphaAwsNodePool()
        if Primitive.to_proto(self.name):
...
class AwsNodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfig()
...
class AwsNodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfigRootVolume()
...
class AwsNodePoolConfigTaints(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfigTaints()
...
class AwsNodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfigSshConfig()
...
class AwsNodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolAutoscaling()
...
class AwsNodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolMaxPodsConstraint()
...
class AwsNodePoolConfigRootVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum.Value(
            "ContainerawsAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("ContainerawsAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum") :
        ]
...
class AwsNodePoolConfigTaintsEffectEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfigTaintsEffectEnum.Value(
            "ContainerawsAlphaAwsNodePoolConfigTaintsEffectEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolConfigTaintsEffectEnum.Name(
            resource
        )[
            len("ContainerawsAlphaAwsNodePoolConfigTaintsEffectEnum") :
        ]
...
class AwsNodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolStateEnum.Value(
            "ContainerawsAlphaAwsNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.ContainerawsAlphaAwsNodePoolStateEnum.Name(resource)[
            len("ContainerawsAlphaAwsNodePoolStateEnum") :
        ]
