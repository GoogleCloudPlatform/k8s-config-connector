...
class OAuthIdpConfig(object):
    ...
    def apply(self):
        ...
        request = oauth_idp_config_pb2.ApplyIdentitytoolkitAlphaOAuthIdpConfigRequest()
        ...
        response = stub.ApplyIdentitytoolkitAlphaOAuthIdpConfig(request)
    ...
    def delete(self):
        ...
        request = oauth_idp_config_pb2.DeleteIdentitytoolkitAlphaOAuthIdpConfigRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = oauth_idp_config_pb2.IdentitytoolkitAlphaOAuthIdpConfig()
        if Primitive.to_proto(self.name):
...
class OAuthIdpConfigResponseType(object):
    ...
    def to_proto(self, resource):
        ...
        res = oauth_idp_config_pb2.IdentitytoolkitAlphaOAuthIdpConfigResponseType()
