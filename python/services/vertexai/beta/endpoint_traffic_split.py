...
class EndpointTrafficSplit(object):
    ...
    def apply(self):
        stub = (
            endpoint_traffic_split_pb2_grpc.VertexaiBetaEndpointTrafficSplitServiceStub(
                channel.Channel()
            )
        )
        request = (
            endpoint_traffic_split_pb2.ApplyVertexaiBetaEndpointTrafficSplitRequest()
        )
        ...
        response = stub.ApplyVertexaiBetaEndpointTrafficSplit(request)
    ...
    def delete(self):
        ...
        request = (
            endpoint_traffic_split_pb2.DeleteVertexaiBetaEndpointTrafficSplitRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.endpoint):
            request.resource.endpoint = Primitive.to_proto(self.endpoint)
        ...
        response = stub.DeleteVertexaiBetaEndpointTrafficSplit(request)
    ...
    def list(self, location, service_account_file=""):
        ...
        request = (
            endpoint_traffic_split_pb2.ListVertexaiBetaEndpointTrafficSplitRequest()
        )
        request.service_account_file = service_account_file
        request.Location = location

        return stub.ListVertexaiBetaEndpointTrafficSplit(request).items

    def to_proto(self):
        resource = endpoint_traffic_split_pb2.VertexaiBetaEndpointTrafficSplit()
        if Primitive.to_proto(self.endpoint):
...
class EndpointTrafficSplitTrafficSplit(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_traffic_split_pb2.VertexaiBetaEndpointTrafficSplitTrafficSplit()
