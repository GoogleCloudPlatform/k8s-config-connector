...
class MetadataStore(object):
    ...
    def apply(self):
        stub = metadata_store_pb2_grpc.VertexaiBetaMetadataStoreServiceStub(
            channel.Channel()
        )
        request = metadata_store_pb2.ApplyVertexaiBetaMetadataStoreRequest()
        ...
        response = stub.ApplyVertexaiBetaMetadataStore(request)
    ...
    def delete(self):
        ...
        request = metadata_store_pb2.DeleteVertexaiBetaMetadataStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiBetaMetadataStore(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = metadata_store_pb2.ListVertexaiBetaMetadataStoreRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexaiBetaMetadataStore(request).items

    def to_proto(self):
        resource = metadata_store_pb2.VertexaiBetaMetadataStore()
        if Primitive.to_proto(self.name):
...
class MetadataStoreEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexaiBetaMetadataStoreEncryptionSpec()
...
class MetadataStoreState(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexaiBetaMetadataStoreState()
