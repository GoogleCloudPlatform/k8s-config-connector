...
class MetadataSchema(object):
    ...
    def apply(self):
        stub = metadata_schema_pb2_grpc.VertexaiBetaMetadataSchemaServiceStub(
            channel.Channel()
        )
        request = metadata_schema_pb2.ApplyVertexaiBetaMetadataSchemaRequest()
        ...
        response = stub.ApplyVertexaiBetaMetadataSchema(request)
    ...
    def delete(self):
        ...
        request = metadata_schema_pb2.DeleteVertexaiBetaMetadataSchemaRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiBetaMetadataSchema(request)
    ...
    def list(self, project, location, metadataStore, service_account_file=""):
        ...
        request = metadata_schema_pb2.ListVertexaiBetaMetadataSchemaRequest()
        ...
        return stub.ListVertexaiBetaMetadataSchema(request).items

    def to_proto(self):
        resource = metadata_schema_pb2.VertexaiBetaMetadataSchema()
        if Primitive.to_proto(self.name):
...
class MetadataSchemaSchemaTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexaiBetaMetadataSchemaSchemaTypeEnum.Value(
            "VertexaiBetaMetadataSchemaSchemaTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexaiBetaMetadataSchemaSchemaTypeEnum.Name(
            resource
        )[len("VertexaiBetaMetadataSchemaSchemaTypeEnum") :]
