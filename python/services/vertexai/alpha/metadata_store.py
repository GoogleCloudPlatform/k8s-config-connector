...
from google3.cloud.graphite.mmv2.services.google.vertex_ai import metadata_store_pb2
from google3.cloud.graphite.mmv2.services.google.vertex_ai import (
    metadata_store_pb2_grpc,
)
...
class MetadataStore(object):
    ...
    def apply(self):
        stub = metadata_store_pb2_grpc.VertexaiAlphaMetadataStoreServiceStub(
            channel.Channel()
        )
        request = metadata_store_pb2.ApplyVertexaiAlphaMetadataStoreRequest()
        ...
        response = stub.ApplyVertexaiAlphaMetadataStore(request)
    ...
    def delete(self):
        ...
        request = metadata_store_pb2.DeleteVertexaiAlphaMetadataStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiAlphaMetadataStore(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = metadata_store_pb2.ListVertexaiAlphaMetadataStoreRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexaiAlphaMetadataStore(request).items

    def to_proto(self):
        resource = metadata_store_pb2.VertexaiAlphaMetadataStore()
        if Primitive.to_proto(self.name):
...
class MetadataStoreEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexaiAlphaMetadataStoreEncryptionSpec()
...
class MetadataStoreState(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexaiAlphaMetadataStoreState()
