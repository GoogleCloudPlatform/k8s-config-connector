...
from google3.cloud.graphite.mmv2.services.google.vertex_ai import endpoint_pb2
from google3.cloud.graphite.mmv2.services.google.vertex_ai import endpoint_pb2_grpc
...
class Endpoint(object):
    ...
    def apply(self):
        stub = endpoint_pb2_grpc.VertexaiAlphaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ApplyVertexaiAlphaEndpointRequest()
        ...
        response = stub.ApplyVertexaiAlphaEndpoint(request)
    ...
    def delete(self):
        stub = endpoint_pb2_grpc.VertexaiAlphaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.DeleteVertexaiAlphaEndpointRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiAlphaEndpoint(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = endpoint_pb2_grpc.VertexaiAlphaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ListVertexaiAlphaEndpointRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexaiAlphaEndpoint(request).items

    def to_proto(self):
        resource = endpoint_pb2.VertexaiAlphaEndpoint()
        if Primitive.to_proto(self.name):
...
class EndpointDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiAlphaEndpointDeployedModels()
...
class EndpointDeployedModelsDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiAlphaEndpointDeployedModelsDedicatedResources()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexaiAlphaEndpointDeployedModelsDedicatedResourcesMachineSpec()
        )
...
class EndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexaiAlphaEndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs()
        )
...
class EndpointDeployedModelsAutomaticResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiAlphaEndpointDeployedModelsAutomaticResources()
        if Primitive.to_proto(resource.min_replica_count):
            res.min_replica_count = Primitive.to_proto(resource.min_replica_count)
        if Primitive.to_proto(resource.max_replica_count):
            res.max_replica_count = Primitive.to_proto(resource.max_replica_count)
...
class EndpointDeployedModelsPrivateEndpoints(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiAlphaEndpointDeployedModelsPrivateEndpoints()
...
class EndpointEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiAlphaEndpointEncryptionSpec()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexaiAlphaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Value(
            "VertexaiAlphaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexaiAlphaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Name(
            resource
        )[
            len(
                "VertexaiAlphaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum"
            ) :
        ]
