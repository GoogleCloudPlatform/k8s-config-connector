...
class TcpRoute(object):
    ...
    def apply(self):
        stub = tcp_route_pb2_grpc.NetworkservicesBetaTcpRouteServiceStub(
            channel.Channel()
        )
        request = tcp_route_pb2.ApplyNetworkservicesBetaTcpRouteRequest()
        ...
        response = stub.ApplyNetworkservicesBetaTcpRoute(request)
    ...
    def delete(self):
        ...
        request = tcp_route_pb2.DeleteNetworkservicesBetaTcpRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesBetaTcpRoute(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = tcp_route_pb2.ListNetworkservicesBetaTcpRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesBetaTcpRoute(request).items

    def to_proto(self):
        resource = tcp_route_pb2.NetworkservicesBetaTcpRoute()
        if Primitive.to_proto(self.name):
...
class TcpRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesBetaTcpRouteRules()
...
class TcpRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesBetaTcpRouteRulesMatches()
...
class TcpRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesBetaTcpRouteRulesAction()
...
class TcpRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesBetaTcpRouteRulesActionDestinations()
