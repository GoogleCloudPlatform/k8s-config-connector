...
class Organization(object):
    ...
    def apply(self):
        stub = organization_pb2_grpc.ApigeeBetaOrganizationServiceStub(
            channel.Channel()
        )
        request = organization_pb2.ApplyApigeeBetaOrganizationRequest()
        ...
        response = stub.ApplyApigeeBetaOrganization(request)
    ...
    def delete(self):
        ...
        request = organization_pb2.DeleteApigeeBetaOrganizationRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApigeeBetaOrganization(request)
    ...
    def list(self, service_account_file=""):
        ...
        request = organization_pb2.ListApigeeBetaOrganizationRequest()
        request.service_account_file = service_account_file
        return stub.ListApigeeBetaOrganization(request).items

    def to_proto(self):
        resource = organization_pb2.ApigeeBetaOrganization()
        if Primitive.to_proto(self.name):
...
class OrganizationAddonsConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = organization_pb2.ApigeeBetaOrganizationAddonsConfig()
...
class OrganizationAddonsConfigAdvancedApiOpsConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = organization_pb2.ApigeeBetaOrganizationAddonsConfigAdvancedApiOpsConfig()
...
class OrganizationAddonsConfigMonetizationConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = organization_pb2.ApigeeBetaOrganizationAddonsConfigMonetizationConfig()
        if Primitive.to_proto(resource.enabled):
            res.enabled = Primitive.to_proto(resource.enabled)
        return res
...
class OrganizationRuntimeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationRuntimeTypeEnum.Value(
            "ApigeeBetaOrganizationRuntimeTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationRuntimeTypeEnum.Name(resource)[
            len("ApigeeBetaOrganizationRuntimeTypeEnum") :
        ]
...
class OrganizationSubscriptionTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationSubscriptionTypeEnum.Value(
            "ApigeeBetaOrganizationSubscriptionTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationSubscriptionTypeEnum.Name(
            resource
        )[len("ApigeeBetaOrganizationSubscriptionTypeEnum") :]
...
class OrganizationBillingTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationBillingTypeEnum.Value(
            "ApigeeBetaOrganizationBillingTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationBillingTypeEnum.Name(resource)[
            len("ApigeeBetaOrganizationBillingTypeEnum") :
        ]
...
class OrganizationStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationStateEnum.Value(
            "ApigeeBetaOrganizationStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return organization_pb2.ApigeeBetaOrganizationStateEnum.Name(resource)[
            len("ApigeeBetaOrganizationStateEnum") :
        ]
