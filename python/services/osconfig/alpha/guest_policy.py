...
class GuestPolicy(object):
    ...
    def apply(self):
        stub = guest_policy_pb2_grpc.OsconfigAlphaGuestPolicyServiceStub(
            channel.Channel()
        )
        request = guest_policy_pb2.ApplyOsconfigAlphaGuestPolicyRequest()
        ...
        response = stub.ApplyOsconfigAlphaGuestPolicy(request)
    ...
    def delete(self):
        ...
        request = guest_policy_pb2.DeleteOsconfigAlphaGuestPolicyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteOsconfigAlphaGuestPolicy(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = guest_policy_pb2.ListOsconfigAlphaGuestPolicyRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListOsconfigAlphaGuestPolicy(request).items

    def to_proto(self):
        resource = guest_policy_pb2.OsconfigAlphaGuestPolicy()
        if Primitive.to_proto(self.name):
...
class GuestPolicyAssignment(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyAssignment()
...
class GuestPolicyAssignmentGroupLabels(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyAssignmentGroupLabels()
...
class GuestPolicyAssignmentOSTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyAssignmentOSTypes()
...
class GuestPolicyPackages(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyPackages()
...
class GuestPolicyPackageRepositories(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyPackageRepositories()
...
class GuestPolicyPackageRepositoriesApt(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyPackageRepositoriesApt()
...
class GuestPolicyPackageRepositoriesYum(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyPackageRepositoriesYum()
...
class GuestPolicyPackageRepositoriesZypper(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyPackageRepositoriesZypper()
        if Primitive.to_proto(resource.id):
            res.id = Primitive.to_proto(resource.id)
        if Primitive.to_proto(resource.display_name):
            res.display_name = Primitive.to_proto(resource.display_name)
...
class GuestPolicyPackageRepositoriesGoo(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyPackageRepositoriesGoo()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class GuestPolicyRecipes(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipes()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class GuestPolicyRecipesArtifacts(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesArtifacts()
        if Primitive.to_proto(resource.id):
            res.id = Primitive.to_proto(resource.id)
...
class GuestPolicyRecipesArtifactsRemote(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesArtifactsRemote()
        if Primitive.to_proto(resource.uri):
            res.uri = Primitive.to_proto(resource.uri)
...
class GuestPolicyRecipesArtifactsGcs(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesArtifactsGcs()
...
class GuestPolicyRecipesInstallSteps(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallSteps()
...
class GuestPolicyRecipesInstallStepsFileCopy(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsFileCopy()
...
class GuestPolicyRecipesInstallStepsArchiveExtraction(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsArchiveExtraction()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        if Primitive.to_proto(resource.destination):
...
class GuestPolicyRecipesInstallStepsMsiInstallation(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsMsiInstallation()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
...
class GuestPolicyRecipesInstallStepsDpkgInstallation(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsDpkgInstallation()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        return res
...
class GuestPolicyRecipesInstallStepsRpmInstallation(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsRpmInstallation()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        return res
...
class GuestPolicyRecipesInstallStepsFileExec(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsFileExec()
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
...
class GuestPolicyRecipesInstallStepsScriptRun(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsScriptRun()
...
class GuestPolicyRecipesUpdateSteps(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateSteps()
...
class GuestPolicyRecipesUpdateStepsFileCopy(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsFileCopy()
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        if Primitive.to_proto(resource.destination):
            res.destination = Primitive.to_proto(resource.destination)
...
class GuestPolicyRecipesUpdateStepsArchiveExtraction(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsArchiveExtraction()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        if Primitive.to_proto(resource.destination):
...
class GuestPolicyRecipesUpdateStepsMsiInstallation(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsMsiInstallation()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        if Primitive.to_proto(resource.flags):
...
class GuestPolicyRecipesUpdateStepsDpkgInstallation(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsDpkgInstallation()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        return res
...
class GuestPolicyRecipesUpdateStepsRpmInstallation(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsRpmInstallation()
        )
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        return res
...
class GuestPolicyRecipesUpdateStepsFileExec(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsFileExec()
        if Primitive.to_proto(resource.artifact_id):
            res.artifact_id = Primitive.to_proto(resource.artifact_id)
        if Primitive.to_proto(resource.local_path):
            res.local_path = Primitive.to_proto(resource.local_path)
...
class GuestPolicyRecipesUpdateStepsScriptRun(object):
    ...
    def to_proto(self, resource):
        ...
        res = guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsScriptRun()
        if Primitive.to_proto(resource.script):
            res.script = Primitive.to_proto(resource.script)
        if int64Array.to_proto(resource.allowed_exit_codes):
            res.allowed_exit_codes.extend(
...
class GuestPolicyPackagesDesiredStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyPackagesDesiredStateEnum.Value(
            "OsconfigAlphaGuestPolicyPackagesDesiredStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyPackagesDesiredStateEnum.Name(
            resource
        )[len("OsconfigAlphaGuestPolicyPackagesDesiredStateEnum") :]
...
class GuestPolicyPackagesManagerEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyPackagesManagerEnum.Value(
            "OsconfigAlphaGuestPolicyPackagesManagerEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyPackagesManagerEnum.Name(
            resource
        )[len("OsconfigAlphaGuestPolicyPackagesManagerEnum") :]
...
class GuestPolicyPackageRepositoriesAptArchiveTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyPackageRepositoriesAptArchiveTypeEnum.Value(
            "OsconfigAlphaGuestPolicyPackageRepositoriesAptArchiveTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyPackageRepositoriesAptArchiveTypeEnum.Name(
            resource
        )[
            len("OsconfigAlphaGuestPolicyPackageRepositoriesAptArchiveTypeEnum") :
        ]
...
class GuestPolicyRecipesInstallStepsArchiveExtractionTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsArchiveExtractionTypeEnum.Value(
            "OsconfigAlphaGuestPolicyRecipesInstallStepsArchiveExtractionTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsArchiveExtractionTypeEnum.Name(
            resource
        )[
            len(
                "OsconfigAlphaGuestPolicyRecipesInstallStepsArchiveExtractionTypeEnum"
            ) :
        ]
...
class GuestPolicyRecipesInstallStepsScriptRunInterpreterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsScriptRunInterpreterEnum.Value(
            "OsconfigAlphaGuestPolicyRecipesInstallStepsScriptRunInterpreterEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesInstallStepsScriptRunInterpreterEnum.Name(
            resource
        )[
            len("OsconfigAlphaGuestPolicyRecipesInstallStepsScriptRunInterpreterEnum") :
        ]
...
class GuestPolicyRecipesUpdateStepsArchiveExtractionTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsArchiveExtractionTypeEnum.Value(
            "OsconfigAlphaGuestPolicyRecipesUpdateStepsArchiveExtractionTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsArchiveExtractionTypeEnum.Name(
            resource
        )[
            len("OsconfigAlphaGuestPolicyRecipesUpdateStepsArchiveExtractionTypeEnum") :
        ]
...
class GuestPolicyRecipesUpdateStepsScriptRunInterpreterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsScriptRunInterpreterEnum.Value(
            "OsconfigAlphaGuestPolicyRecipesUpdateStepsScriptRunInterpreterEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesUpdateStepsScriptRunInterpreterEnum.Name(
            resource
        )[
            len("OsconfigAlphaGuestPolicyRecipesUpdateStepsScriptRunInterpreterEnum") :
        ]
...
class GuestPolicyRecipesDesiredStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesDesiredStateEnum.Value(
            "OsconfigAlphaGuestPolicyRecipesDesiredStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return guest_policy_pb2.OsconfigAlphaGuestPolicyRecipesDesiredStateEnum.Name(
            resource
        )[len("OsconfigAlphaGuestPolicyRecipesDesiredStateEnum") :]
