...
class NotificationChannelVerificationStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return notification_channel_pb2.MonitoringNotificationChannelVerificationStatusEnum.Value(
            "MonitoringNotificationChannelVerificationStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return notification_channel_pb2.MonitoringNotificationChannelVerificationStatusEnum.Name(
            resource
        )[
            len("MonitoringNotificationChannelVerificationStatusEnum") :
        ]
