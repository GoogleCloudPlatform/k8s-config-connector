...
class Group(object):
    ...
    def apply(self):
        stub = group_pb2_grpc.CloudidentityGroupServiceStub(channel.Channel())
        request = group_pb2.ApplyCloudidentityGroupRequest()
    ...
    def delete(self):
        stub = group_pb2_grpc.CloudidentityGroupServiceStub(channel.Channel())
        request = group_pb2.DeleteCloudidentityGroupRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def list(self, parent, service_account_file=""):
        stub = group_pb2_grpc.CloudidentityGroupServiceStub(channel.Channel())
        request = group_pb2.ListCloudidentityGroupRequest()
        request.service_account_file = service_account_file
        request.Parent = parent

        return stub.ListCloudidentityGroup(request).items
...
class GroupDirectMemberCountPerType(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityGroupDirectMemberCountPerType()
...
class GroupDynamicGroupMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityGroupDynamicGroupMetadata()
...
class GroupDynamicGroupMetadataQueries(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityGroupDynamicGroupMetadataQueries()
...
class GroupDynamicGroupMetadataStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityGroupDynamicGroupMetadataStatus()
...
class GroupDynamicGroupMetadataQueriesResourceTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityGroupDynamicGroupMetadataQueriesResourceTypeEnum.Value(
            "CloudidentityGroupDynamicGroupMetadataQueriesResourceTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityGroupDynamicGroupMetadataQueriesResourceTypeEnum.Name(
            resource
        )[
            len("CloudidentityGroupDynamicGroupMetadataQueriesResourceTypeEnum") :
        ]
...
class GroupDynamicGroupMetadataStatusStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityGroupDynamicGroupMetadataStatusStatusEnum.Value(
            "CloudidentityGroupDynamicGroupMetadataStatusStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityGroupDynamicGroupMetadataStatusStatusEnum.Name(
            resource
        )[len("CloudidentityGroupDynamicGroupMetadataStatusStatusEnum") :]
...
class GroupInitialGroupConfigEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityGroupInitialGroupConfigEnum.Value(
            "CloudidentityGroupInitialGroupConfigEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityGroupInitialGroupConfigEnum.Name(resource)[
            len("CloudidentityGroupInitialGroupConfigEnum") :
        ]
