...
class Instance(object):
    ...
    def apply(self):
        ...
        request = instance_pb2.ApplyDatafusionAlphaInstanceRequest()
        ...
        response = stub.ApplyDatafusionAlphaInstance(request)
    ...
    def delete(self):
        stub = instance_pb2_grpc.DatafusionAlphaInstanceServiceStub(channel.Channel())
        request = instance_pb2.DeleteDatafusionAlphaInstanceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = instance_pb2.DatafusionAlphaInstance()
        if Primitive.to_proto(self.name):
...
class InstanceNetworkConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.DatafusionAlphaInstanceNetworkConfig()
...
class InstanceAvailableVersion(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.DatafusionAlphaInstanceAvailableVersion()
...
class InstanceTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.DatafusionAlphaInstanceTypeEnum.Value(
            "DatafusionAlphaInstanceTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.DatafusionAlphaInstanceTypeEnum.Name(resource)[
            len("DatafusionAlphaInstanceTypeEnum") :
        ]
...
class InstanceStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.DatafusionAlphaInstanceStateEnum.Value(
            "DatafusionAlphaInstanceStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.DatafusionAlphaInstanceStateEnum.Name(resource)[
            len("DatafusionAlphaInstanceStateEnum") :
        ]
