...
class Asset(object):
    ...
    def apply(self):
        stub = asset_pb2_grpc.DataplexAlphaAssetServiceStub(channel.Channel())
        request = asset_pb2.ApplyDataplexAlphaAssetRequest()
        ...
        response = stub.ApplyDataplexAlphaAsset(request)
    ...
    def delete(self):
        stub = asset_pb2_grpc.DataplexAlphaAssetServiceStub(channel.Channel())
        request = asset_pb2.DeleteDataplexAlphaAssetRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDataplexAlphaAsset(request)

    @classmethod
    def list(self, project, location, dataplexZone, lake, service_account_file=""):
        stub = asset_pb2_grpc.DataplexAlphaAssetServiceStub(channel.Channel())
        request = asset_pb2.ListDataplexAlphaAssetRequest()
        ...
        return stub.ListDataplexAlphaAsset(request).items

    def to_proto(self):
        resource = asset_pb2.DataplexAlphaAsset()
        if Primitive.to_proto(self.name):
...
class AssetResourceSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetResourceSpec()
...
class AssetResourceStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetResourceStatus()
...
class AssetSecurityStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetSecurityStatus()
...
class AssetDiscoverySpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetDiscoverySpec()
...
class AssetDiscoverySpecCsvOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetDiscoverySpecCsvOptions()
...
class AssetDiscoverySpecJsonOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetDiscoverySpecJsonOptions()
        if Primitive.to_proto(resource.encoding):
            res.encoding = Primitive.to_proto(resource.encoding)
        if Primitive.to_proto(resource.disable_type_inference):
            res.disable_type_inference = Primitive.to_proto(
...
class AssetDiscoveryStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetDiscoveryStatus()
...
class AssetDiscoveryStatusStats(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAlphaAssetDiscoveryStatusStats()
...
class AssetStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetStateEnum.Value(
            "DataplexAlphaAssetStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetStateEnum.Name(resource)[
            len("DataplexAlphaAssetStateEnum") :
        ]
...
class AssetResourceSpecTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetResourceSpecTypeEnum.Value(
            "DataplexAlphaAssetResourceSpecTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetResourceSpecTypeEnum.Name(resource)[
            len("DataplexAlphaAssetResourceSpecTypeEnum") :
        ]
...
class AssetResourceSpecReadAccessModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetResourceSpecReadAccessModeEnum.Value(
            "DataplexAlphaAssetResourceSpecReadAccessModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetResourceSpecReadAccessModeEnum.Name(
            resource
        )[len("DataplexAlphaAssetResourceSpecReadAccessModeEnum") :]
...
class AssetResourceStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetResourceStatusStateEnum.Value(
            "DataplexAlphaAssetResourceStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetResourceStatusStateEnum.Name(resource)[
            len("DataplexAlphaAssetResourceStatusStateEnum") :
        ]
...
class AssetSecurityStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetSecurityStatusStateEnum.Value(
            "DataplexAlphaAssetSecurityStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetSecurityStatusStateEnum.Name(resource)[
            len("DataplexAlphaAssetSecurityStatusStateEnum") :
        ]
...
class AssetDiscoveryStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetDiscoveryStatusStateEnum.Value(
            "DataplexAlphaAssetDiscoveryStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAlphaAssetDiscoveryStatusStateEnum.Name(resource)[
            len("DataplexAlphaAssetDiscoveryStatusStateEnum") :
        ]
