...
class Zone(object):
    ...
    def apply(self):
        stub = zone_pb2_grpc.DataplexZoneServiceStub(channel.Channel())
        request = zone_pb2.ApplyDataplexZoneRequest()
        ...
        response = stub.ApplyDataplexZone(request)
    ...
    def delete(self):
        stub = zone_pb2_grpc.DataplexZoneServiceStub(channel.Channel())
        request = zone_pb2.DeleteDataplexZoneRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDataplexZone(request)

    @classmethod
    def list(self, project, location, lake, service_account_file=""):
        stub = zone_pb2_grpc.DataplexZoneServiceStub(channel.Channel())
        request = zone_pb2.ListDataplexZoneRequest()
        ...
        return stub.ListDataplexZone(request).items

    def to_proto(self):
        resource = zone_pb2.DataplexZone()
        if Primitive.to_proto(self.name):
...
class ZoneDiscoverySpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexZoneDiscoverySpec()
...
class ZoneDiscoverySpecCsvOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexZoneDiscoverySpecCsvOptions()
...
class ZoneDiscoverySpecJsonOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexZoneDiscoverySpecJsonOptions()
        if Primitive.to_proto(resource.encoding):
            res.encoding = Primitive.to_proto(resource.encoding)
        if Primitive.to_proto(resource.disable_type_inference):
            res.disable_type_inference = Primitive.to_proto(
...
class ZoneResourceSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexZoneResourceSpec()
...
class ZoneAssetStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexZoneAssetStatus()
...
class ZoneStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexZoneStateEnum.Value(
            "DataplexZoneStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexZoneStateEnum.Name(resource)[
            len("DataplexZoneStateEnum") :
        ]
...
class ZoneTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexZoneTypeEnum.Value("DataplexZoneTypeEnum%s" % resource)

    @classmethod
    def from_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexZoneTypeEnum.Name(resource)[
            len("DataplexZoneTypeEnum") :
        ]
...
class ZoneResourceSpecLocationTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexZoneResourceSpecLocationTypeEnum.Value(
            "DataplexZoneResourceSpecLocationTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexZoneResourceSpecLocationTypeEnum.Name(resource)[
            len("DataplexZoneResourceSpecLocationTypeEnum") :
        ]
