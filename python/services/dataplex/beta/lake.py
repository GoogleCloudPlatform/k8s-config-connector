...
class Lake(object):
    ...
    def apply(self):
        stub = lake_pb2_grpc.DataplexBetaLakeServiceStub(channel.Channel())
        request = lake_pb2.ApplyDataplexBetaLakeRequest()
        ...
        response = stub.ApplyDataplexBetaLake(request)
    ...
    def delete(self):
        stub = lake_pb2_grpc.DataplexBetaLakeServiceStub(channel.Channel())
        request = lake_pb2.DeleteDataplexBetaLakeRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDataplexBetaLake(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = lake_pb2_grpc.DataplexBetaLakeServiceStub(channel.Channel())
        request = lake_pb2.ListDataplexBetaLakeRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListDataplexBetaLake(request).items

    def to_proto(self):
        resource = lake_pb2.DataplexBetaLake()
        if Primitive.to_proto(self.name):
...
class LakeMetastore(object):
    ...
    def to_proto(self, resource):
        ...
        res = lake_pb2.DataplexBetaLakeMetastore()
...
class LakeAssetStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = lake_pb2.DataplexBetaLakeAssetStatus()
...
class LakeMetastoreStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = lake_pb2.DataplexBetaLakeMetastoreStatus()
...
class LakeStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexBetaLakeStateEnum.Value(
            "DataplexBetaLakeStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexBetaLakeStateEnum.Name(resource)[
            len("DataplexBetaLakeStateEnum") :
        ]
...
class LakeMetastoreStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexBetaLakeMetastoreStatusStateEnum.Value(
            "DataplexBetaLakeMetastoreStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexBetaLakeMetastoreStatusStateEnum.Name(resource)[
            len("DataplexBetaLakeMetastoreStatusStateEnum") :
        ]
