...
import (
	...
	sdkgrpc "github.com/GoogleCloudPlatform/declarative-resource-client-library/python/proto/cloudkms/cloudkms_go_proto"
)
...
func RegisterServers(s *grpc.Server) {
	...
	sdkgrpc.RegisterCloudkmsEkmConnectionServiceServer(s, &EkmConnectionServer{})
