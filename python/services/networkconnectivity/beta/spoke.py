...
class Spoke(object):
    ...
    def apply(self):
        stub = spoke_pb2_grpc.NetworkconnectivityBetaSpokeServiceStub(channel.Channel())
        request = spoke_pb2.ApplyNetworkconnectivityBetaSpokeRequest()
        ...
        response = stub.ApplyNetworkconnectivityBetaSpoke(request)
    ...
    def delete(self):
        stub = spoke_pb2_grpc.NetworkconnectivityBetaSpokeServiceStub(channel.Channel())
        request = spoke_pb2.DeleteNetworkconnectivityBetaSpokeRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkconnectivityBetaSpoke(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = spoke_pb2_grpc.NetworkconnectivityBetaSpokeServiceStub(channel.Channel())
        request = spoke_pb2.ListNetworkconnectivityBetaSpokeRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkconnectivityBetaSpoke(request).items

    def to_proto(self):
        resource = spoke_pb2.NetworkconnectivityBetaSpoke()
        if Primitive.to_proto(self.name):
...
class SpokeLinkedVpnTunnels(object):
    ...
    def to_proto(self, resource):
        ...
        res = spoke_pb2.NetworkconnectivityBetaSpokeLinkedVpnTunnels()
...
class SpokeLinkedInterconnectAttachments(object):
    ...
    def to_proto(self, resource):
        ...
        res = spoke_pb2.NetworkconnectivityBetaSpokeLinkedInterconnectAttachments()
        if Primitive.to_proto(resource.uris):
            res.uris.extend(Primitive.to_proto(resource.uris))
        if Primitive.to_proto(resource.site_to_site_data_transfer):
            res.site_to_site_data_transfer = Primitive.to_proto(
...
class SpokeLinkedRouterApplianceInstances(object):
    ...
    def to_proto(self, resource):
        ...
        res = spoke_pb2.NetworkconnectivityBetaSpokeLinkedRouterApplianceInstances()
...
class SpokeLinkedRouterApplianceInstancesInstances(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            spoke_pb2.NetworkconnectivityBetaSpokeLinkedRouterApplianceInstancesInstances()
        )
...
class SpokeLinkedVPCNetwork(object):
    ...
    def to_proto(self, resource):
        ...
        res = spoke_pb2.NetworkconnectivityBetaSpokeLinkedVPCNetwork()
...
class SpokeStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return spoke_pb2.NetworkconnectivityBetaSpokeStateEnum.Value(
            "NetworkconnectivityBetaSpokeStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return spoke_pb2.NetworkconnectivityBetaSpokeStateEnum.Name(resource)[
            len("NetworkconnectivityBetaSpokeStateEnum") :
        ]
