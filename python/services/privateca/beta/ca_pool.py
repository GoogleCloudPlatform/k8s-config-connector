...
class CaPool(object):
    ...
    def apply(self):
        stub = ca_pool_pb2_grpc.PrivatecaBetaCaPoolServiceStub(channel.Channel())
        request = ca_pool_pb2.ApplyPrivatecaBetaCaPoolRequest()
        ...
        response = stub.ApplyPrivatecaBetaCaPool(request)
    ...
    def delete(self):
        stub = ca_pool_pb2_grpc.PrivatecaBetaCaPoolServiceStub(channel.Channel())
        request = ca_pool_pb2.DeletePrivatecaBetaCaPoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeletePrivatecaBetaCaPool(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = ca_pool_pb2_grpc.PrivatecaBetaCaPoolServiceStub(channel.Channel())
        request = ca_pool_pb2.ListPrivatecaBetaCaPoolRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListPrivatecaBetaCaPool(request).items

    def to_proto(self):
        resource = ca_pool_pb2.PrivatecaBetaCaPool()
        if Primitive.to_proto(self.name):
...
class CaPoolIssuancePolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicy()
...
class CaPoolIssuancePolicyAllowedKeyTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyAllowedKeyTypes()
...
class CaPoolIssuancePolicyAllowedKeyTypesRsa(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyAllowedKeyTypesRsa()
...
class CaPoolIssuancePolicyAllowedKeyTypesEllipticCurve(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurve()
        )
...
class CaPoolIssuancePolicyAllowedIssuanceModes(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyAllowedIssuanceModes()
...
class CaPoolIssuancePolicyBaselineValues(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValues()
...
class CaPoolIssuancePolicyBaselineValuesKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValuesKeyUsage()
...
class CaPoolIssuancePolicyBaselineValuesKeyUsageBaseKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValuesKeyUsageBaseKeyUsage()
        )
...
class CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage()
        )
...
class CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsages(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsages()
        )
...
class CaPoolIssuancePolicyBaselineValuesPolicyIds(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValuesPolicyIds()
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CaPoolIssuancePolicyBaselineValuesAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValuesAdditionalExtensions()
        )
...
class CaPoolIssuancePolicyBaselineValuesAdditionalExtensionsObjectId(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyBaselineValuesAdditionalExtensionsObjectId()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CaPoolIssuancePolicyIdentityConstraints(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyIdentityConstraints()
...
class CaPoolIssuancePolicyIdentityConstraintsCelExpression(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyIdentityConstraintsCelExpression()
        )
...
class CaPoolIssuancePolicyPassthroughExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyPassthroughExtensions()
...
class CaPoolIssuancePolicyPassthroughExtensionsAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyPassthroughExtensionsAdditionalExtensions()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CaPoolPublishingOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaBetaCaPoolPublishingOptions()
...
class CaPoolTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaBetaCaPoolTierEnum.Value(
            "PrivatecaBetaCaPoolTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaBetaCaPoolTierEnum.Name(resource)[
            len("PrivatecaBetaCaPoolTierEnum") :
        ]
...
class CaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum.Value(
            "PrivatecaBetaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum.Name(
            resource
        )[
            len(
                "PrivatecaBetaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum"
            ) :
        ]
...
class CaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum.Value(
            "PrivatecaBetaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaBetaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum.Name(
            resource
        )[
            len(
                "PrivatecaBetaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum"
            ) :
        ]
