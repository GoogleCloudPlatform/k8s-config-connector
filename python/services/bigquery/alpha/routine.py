...
class Routine(object):
    ...
    def apply(self):
        stub = routine_pb2_grpc.BigqueryAlphaRoutineServiceStub(channel.Channel())
        request = routine_pb2.ApplyBigqueryAlphaRoutineRequest()
        ...
        response = stub.ApplyBigqueryAlphaRoutine(request)
    ...
    def delete(self):
        stub = routine_pb2_grpc.BigqueryAlphaRoutineServiceStub(channel.Channel())
        request = routine_pb2.DeleteBigqueryAlphaRoutineRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteBigqueryAlphaRoutine(request)

    @classmethod
    def list(self, project, dataset, service_account_file=""):
        stub = routine_pb2_grpc.BigqueryAlphaRoutineServiceStub(channel.Channel())
        request = routine_pb2.ListBigqueryAlphaRoutineRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Dataset = dataset

        return stub.ListBigqueryAlphaRoutine(request).items

    def to_proto(self):
        resource = routine_pb2.BigqueryAlphaRoutine()
        if Primitive.to_proto(self.name):
...
class RoutineArguments(object):
    ...
    def to_proto(self, resource):
        ...
        res = routine_pb2.BigqueryAlphaRoutineArguments()
...
class RoutineArgumentsDataType(object):
    ...
    def to_proto(self, resource):
        ...
        res = routine_pb2.BigqueryAlphaRoutineArgumentsDataType()
...
class RoutineArgumentsDataTypeStructType(object):
    ...
    def to_proto(self, resource):
        ...
        res = routine_pb2.BigqueryAlphaRoutineArgumentsDataTypeStructType()
...
class RoutineArgumentsDataTypeStructTypeFields(object):
    ...
    def to_proto(self, resource):
        ...
        res = routine_pb2.BigqueryAlphaRoutineArgumentsDataTypeStructTypeFields()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class RoutineRoutineTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineRoutineTypeEnum.Value(
            "BigqueryAlphaRoutineRoutineTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineRoutineTypeEnum.Name(resource)[
            len("BigqueryAlphaRoutineRoutineTypeEnum") :
        ]
...
class RoutineLanguageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineLanguageEnum.Value(
            "BigqueryAlphaRoutineLanguageEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineLanguageEnum.Name(resource)[
            len("BigqueryAlphaRoutineLanguageEnum") :
        ]
...
class RoutineArgumentsArgumentKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineArgumentsArgumentKindEnum.Value(
            "BigqueryAlphaRoutineArgumentsArgumentKindEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineArgumentsArgumentKindEnum.Name(resource)[
            len("BigqueryAlphaRoutineArgumentsArgumentKindEnum") :
        ]
...
class RoutineArgumentsModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineArgumentsModeEnum.Value(
            "BigqueryAlphaRoutineArgumentsModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineArgumentsModeEnum.Name(resource)[
            len("BigqueryAlphaRoutineArgumentsModeEnum") :
        ]
...
class RoutineArgumentsDataTypeTypeKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineArgumentsDataTypeTypeKindEnum.Value(
            "BigqueryAlphaRoutineArgumentsDataTypeTypeKindEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineArgumentsDataTypeTypeKindEnum.Name(
            resource
        )[len("BigqueryAlphaRoutineArgumentsDataTypeTypeKindEnum") :]
...
class RoutineDeterminismLevelEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineDeterminismLevelEnum.Value(
            "BigqueryAlphaRoutineDeterminismLevelEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return routine_pb2.BigqueryAlphaRoutineDeterminismLevelEnum.Name(resource)[
            len("BigqueryAlphaRoutineDeterminismLevelEnum") :
        ]
