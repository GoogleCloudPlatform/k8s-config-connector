...
class FirewallPolicyRule(object):
    ...
    def apply(self):
        ...
        request = firewall_policy_rule_pb2.ApplyComputeAlphaFirewallPolicyRuleRequest()
        ...
        response = stub.ApplyComputeAlphaFirewallPolicyRule(request)
    ...
    def delete(self):
        ...
        request = firewall_policy_rule_pb2.DeleteComputeAlphaFirewallPolicyRuleRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
    ...
    def to_proto(self):
        resource = firewall_policy_rule_pb2.ComputeAlphaFirewallPolicyRule()
        if Primitive.to_proto(self.description):
...
class FirewallPolicyRuleMatch(object):
    ...
    def to_proto(self, resource):
        ...
        res = firewall_policy_rule_pb2.ComputeAlphaFirewallPolicyRuleMatch()
...
class FirewallPolicyRuleMatchLayer4Configs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            firewall_policy_rule_pb2.ComputeAlphaFirewallPolicyRuleMatchLayer4Configs()
        )
