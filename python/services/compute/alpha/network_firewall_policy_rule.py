...
class NetworkFirewallPolicyRule(object):
    ...
    def apply(self):
        stub = network_firewall_policy_rule_pb2_grpc.ComputeAlphaNetworkFirewallPolicyRuleServiceStub(
            channel.Channel()
        )
        request = (
            network_firewall_policy_rule_pb2.ApplyComputeAlphaNetworkFirewallPolicyRuleRequest()
        )
        ...
        response = stub.ApplyComputeAlphaNetworkFirewallPolicyRule(request)
    ...
    def delete(self):
        ...
        request = (
            network_firewall_policy_rule_pb2.DeleteComputeAlphaNetworkFirewallPolicyRuleRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
        ...
        response = stub.DeleteComputeAlphaNetworkFirewallPolicyRule(request)
    ...
    def list(self, project, location, firewallPolicy, service_account_file=""):
        ...
        request = (
            network_firewall_policy_rule_pb2.ListComputeAlphaNetworkFirewallPolicyRuleRequest()
        )
        ...
        return stub.ListComputeAlphaNetworkFirewallPolicyRule(request).items

    def to_proto(self):
        resource = (
            network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRule()
        )
        if Primitive.to_proto(self.description):
...
class NetworkFirewallPolicyRuleMatch(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleMatch()
        )
...
class NetworkFirewallPolicyRuleMatchLayer4Configs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleMatchLayer4Configs()
        )
...
class NetworkFirewallPolicyRuleMatchSrcSecureTags(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleMatchSrcSecureTags()
        )
...
class NetworkFirewallPolicyRuleTargetSecureTags(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleTargetSecureTags()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class NetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum.Value(
            "ComputeAlphaNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum.Name(
            resource
        )[
            len("ComputeAlphaNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum") :
        ]
...
class NetworkFirewallPolicyRuleDirectionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleDirectionEnum.Value(
            "ComputeAlphaNetworkFirewallPolicyRuleDirectionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleDirectionEnum.Name(
            resource
        )[
            len("ComputeAlphaNetworkFirewallPolicyRuleDirectionEnum") :
        ]
...
class NetworkFirewallPolicyRuleTargetSecureTagsStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleTargetSecureTagsStateEnum.Value(
            "ComputeAlphaNetworkFirewallPolicyRuleTargetSecureTagsStateEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeAlphaNetworkFirewallPolicyRuleTargetSecureTagsStateEnum.Name(
            resource
        )[
            len("ComputeAlphaNetworkFirewallPolicyRuleTargetSecureTagsStateEnum") :
        ]
