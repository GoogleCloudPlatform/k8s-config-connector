...
class Router(object):
    ...
    def apply(self):
        stub = router_pb2_grpc.ComputeBetaRouterServiceStub(channel.Channel())
        request = router_pb2.ApplyComputeBetaRouterRequest()
        ...
        response = stub.ApplyComputeBetaRouter(request)
    ...
    def delete(self):
        stub = router_pb2_grpc.ComputeBetaRouterServiceStub(channel.Channel())
        request = router_pb2.DeleteComputeBetaRouterRequest()
        request.service_account_file = self.service_account_file
        if RouterNatsArray.to_proto(self.nats):
            request.resource.nats.extend(RouterNatsArray.to_proto(self.nats))
        if Primitive.to_proto(self.name):
        ...
        response = stub.DeleteComputeBetaRouter(request)

    @classmethod
    def list(self, project, region, service_account_file=""):
        stub = router_pb2_grpc.ComputeBetaRouterServiceStub(channel.Channel())
        request = router_pb2.ListComputeBetaRouterRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Region = region

        return stub.ListComputeBetaRouter(request).items

    def to_proto(self):
        resource = router_pb2.ComputeBetaRouter()
        if RouterNatsArray.to_proto(self.nats):
...
class RouterNats(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterNats()
...
class RouterNatsLogConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterNatsLogConfig()
...
class RouterNatsSubnetworks(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterNatsSubnetworks()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class RouterInterfaces(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterInterfaces()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class RouterBgpPeers(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterBgpPeers()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class RouterBgpPeersAdvertisedIPRanges(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterBgpPeersAdvertisedIPRanges()
...
class RouterBgp(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterBgp()
...
class RouterBgpAdvertisedIPRanges(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_pb2.ComputeBetaRouterBgpAdvertisedIPRanges()
        if Primitive.to_proto(resource.range):
            res.range = Primitive.to_proto(resource.range)
        if Primitive.to_proto(resource.description):
            res.description = Primitive.to_proto(resource.description)
...
class RouterNatsLogConfigFilterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterNatsLogConfigFilterEnum.Value(
            "ComputeBetaRouterNatsLogConfigFilterEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterNatsLogConfigFilterEnum.Name(resource)[
            len("ComputeBetaRouterNatsLogConfigFilterEnum") :
        ]
...
class RouterNatsSourceSubnetworkIPRangesToNatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterNatsSourceSubnetworkIPRangesToNatEnum.Value(
            "ComputeBetaRouterNatsSourceSubnetworkIPRangesToNatEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterNatsSourceSubnetworkIPRangesToNatEnum.Name(
            resource
        )[len("ComputeBetaRouterNatsSourceSubnetworkIPRangesToNatEnum") :]
...
class RouterNatsNatIPAllocateOptionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterNatsNatIPAllocateOptionEnum.Value(
            "ComputeBetaRouterNatsNatIPAllocateOptionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterNatsNatIPAllocateOptionEnum.Name(resource)[
            len("ComputeBetaRouterNatsNatIPAllocateOptionEnum") :
        ]
...
class RouterInterfacesManagementTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterInterfacesManagementTypeEnum.Value(
            "ComputeBetaRouterInterfacesManagementTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterInterfacesManagementTypeEnum.Name(resource)[
            len("ComputeBetaRouterInterfacesManagementTypeEnum") :
        ]
...
class RouterBgpPeersAdvertisedGroupsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterBgpPeersAdvertisedGroupsEnum.Value(
            "ComputeBetaRouterBgpPeersAdvertisedGroupsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterBgpPeersAdvertisedGroupsEnum.Name(resource)[
            len("ComputeBetaRouterBgpPeersAdvertisedGroupsEnum") :
        ]
...
class RouterBgpAdvertiseModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterBgpAdvertiseModeEnum.Value(
            "ComputeBetaRouterBgpAdvertiseModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return router_pb2.ComputeBetaRouterBgpAdvertiseModeEnum.Name(resource)[
            len("ComputeBetaRouterBgpAdvertiseModeEnum") :
        ]
