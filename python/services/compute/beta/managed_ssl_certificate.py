...
class ManagedSslCertificate(object):
    ...
    def apply(self):
        stub = managed_ssl_certificate_pb2_grpc.ComputeBetaManagedSslCertificateServiceStub(
            channel.Channel()
        )
        request = (
            managed_ssl_certificate_pb2.ApplyComputeBetaManagedSslCertificateRequest()
        )
    ...
    def delete(self):
        ...
        request = (
            managed_ssl_certificate_pb2.DeleteComputeBetaManagedSslCertificateRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeBetaManagedSslCertificate(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = (
            managed_ssl_certificate_pb2.ListComputeBetaManagedSslCertificateRequest()
        )
...
class ManagedSslCertificateManaged(object):
    ...
    def to_proto(self, resource):
        ...
        res = managed_ssl_certificate_pb2.ComputeBetaManagedSslCertificateManaged()
...
class ManagedSslCertificateManagedStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return managed_ssl_certificate_pb2.ComputeBetaManagedSslCertificateManagedStatusEnum.Value(
            "ComputeBetaManagedSslCertificateManagedStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return managed_ssl_certificate_pb2.ComputeBetaManagedSslCertificateManagedStatusEnum.Name(
            resource
        )[
...
class ManagedSslCertificateTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return managed_ssl_certificate_pb2.ComputeBetaManagedSslCertificateTypeEnum.Value(
            "ComputeBetaManagedSslCertificateTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return managed_ssl_certificate_pb2.ComputeBetaManagedSslCertificateTypeEnum.Name(
            resource
        )[
            len("ComputeBetaManagedSslCertificateTypeEnum") :
        ]
