...
class Address(object):
    ...
    def apply(self):
        stub = address_pb2_grpc.ComputeBetaAddressServiceStub(channel.Channel())
        request = address_pb2.ApplyComputeBetaAddressRequest()
        ...
        response = stub.ApplyComputeBetaAddress(request)
    ...
    def delete(self):
        stub = address_pb2_grpc.ComputeBetaAddressServiceStub(channel.Channel())
        request = address_pb2.DeleteComputeBetaAddressRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeBetaAddress(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = address_pb2_grpc.ComputeBetaAddressServiceStub(channel.Channel())
        request = address_pb2.ListComputeBetaAddressRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListComputeBetaAddress(request).items

    def to_proto(self):
        resource = address_pb2.ComputeBetaAddress()
        if Primitive.to_proto(self.name):
...
class AddressStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressStatusEnum.Value(
            "ComputeBetaAddressStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressStatusEnum.Name(resource)[
            len("ComputeBetaAddressStatusEnum") :
        ]
...
class AddressNetworkTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressNetworkTierEnum.Value(
            "ComputeBetaAddressNetworkTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressNetworkTierEnum.Name(resource)[
            len("ComputeBetaAddressNetworkTierEnum") :
        ]
...
class AddressIPVersionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressIPVersionEnum.Value(
            "ComputeBetaAddressIPVersionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressIPVersionEnum.Name(resource)[
            len("ComputeBetaAddressIPVersionEnum") :
        ]
...
class AddressAddressTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressAddressTypeEnum.Value(
            "ComputeBetaAddressAddressTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressAddressTypeEnum.Name(resource)[
            len("ComputeBetaAddressAddressTypeEnum") :
        ]
...
class AddressPurposeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressPurposeEnum.Value(
            "ComputeBetaAddressPurposeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return address_pb2.ComputeBetaAddressPurposeEnum.Name(resource)[
            len("ComputeBetaAddressPurposeEnum") :
        ]
