...
class VpnTunnel(object):
    ...
    def apply(self):
        ...
        request = vpn_tunnel_pb2.ApplyComputeBetaVpnTunnelRequest()
        ...
        response = stub.ApplyComputeBetaVpnTunnel(request)
...
class VpnTunnelStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return vpn_tunnel_pb2.ComputeBetaVpnTunnelStatusEnum.Value(
            "ComputeBetaVpnTunnelStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return vpn_tunnel_pb2.ComputeBetaVpnTunnelStatusEnum.Name(resource)[
            len("ComputeBetaVpnTunnelStatusEnum") :
        ]
