...
class DiskGuestOSFeature(object):
    ...
    def to_proto(self, resource):
        ...
        res = disk_pb2.ComputeDiskGuestOSFeature()
...
class DiskEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = disk_pb2.ComputeDiskEncryptionKey()
...
class DiskGuestOSFeatures(object):
    ...
    def to_proto(self, resource):
        ...
        res = disk_pb2.ComputeDiskGuestOSFeatures()
...
class DiskGuestOSFeatureTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeatureTypeEnum.Value(
            "ComputeDiskGuestOSFeatureTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeatureTypeEnum.Name(resource)[
            len("ComputeDiskGuestOSFeatureTypeEnum") :
        ]
...
class DiskGuestOSFeatureTypeAltEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeatureTypeAltEnum.Value(
            "ComputeDiskGuestOSFeatureTypeAltEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeatureTypeAltEnum.Name(resource)[
            len("ComputeDiskGuestOSFeatureTypeAltEnum") :
        ]
...
class DiskStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskStatusEnum.Value(
            "ComputeDiskStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskStatusEnum.Name(resource)[
            len("ComputeDiskStatusEnum") :
        ]
...
class DiskGuestOSFeaturesTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeaturesTypeEnum.Value(
            "ComputeDiskGuestOSFeaturesTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeaturesTypeEnum.Name(resource)[
            len("ComputeDiskGuestOSFeaturesTypeEnum") :
        ]
...
class DiskGuestOSFeaturesTypeAltsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeaturesTypeAltsEnum.Value(
            "ComputeDiskGuestOSFeaturesTypeAltsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return disk_pb2.ComputeDiskGuestOSFeaturesTypeAltsEnum.Name(resource)[
            len("ComputeDiskGuestOSFeaturesTypeAltsEnum") :
        ]
