...
class BackendService(object):
    ...
    def apply(self):
        stub = backend_service_pb2_grpc.ComputeBackendServiceServiceStub(
            channel.Channel()
        )
        request = backend_service_pb2.ApplyComputeBackendServiceRequest()
        ...
        response = stub.ApplyComputeBackendService(request)
    ...
    def delete(self):
        ...
        request = backend_service_pb2.DeleteComputeBackendServiceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeBackendService(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = backend_service_pb2.ListComputeBackendServiceRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListComputeBackendService(request).items

    def to_proto(self):
        resource = backend_service_pb2.ComputeBackendService()
        if Primitive.to_proto(self.name):
...
class BackendServiceBackends(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceBackends()
...
class BackendServiceFailoverPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceFailoverPolicy()
...
class BackendServiceConnectionDraining(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceConnectionDraining()
...
class BackendServiceIap(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceIap()
...
class BackendServiceCdnPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceCdnPolicy()
...
class BackendServiceCdnPolicyCacheKeyPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceCdnPolicyCacheKeyPolicy()
...
class BackendServiceCdnPolicyNegativeCachingPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceCdnPolicyNegativeCachingPolicy()
...
class BackendServiceCdnPolicyBypassCacheOnRequestHeaders(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            backend_service_pb2.ComputeBackendServiceCdnPolicyBypassCacheOnRequestHeaders()
        )
...
class BackendServiceLogConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceLogConfig()
...
class BackendServiceSecuritySettings(object):
    def __init__(self, client_tls_policy: str = None, subject_alt_names: list = None):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceSecuritySettings()
...
class BackendServiceConsistentHash(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceConsistentHash()
...
class BackendServiceConsistentHashHttpCookie(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceConsistentHashHttpCookie()
...
class BackendServiceConsistentHashHttpCookieTtl(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceConsistentHashHttpCookieTtl()
...
class BackendServiceCircuitBreakers(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceCircuitBreakers()
...
class BackendServiceOutlierDetection(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceOutlierDetection()
...
class BackendServiceOutlierDetectionInterval(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceOutlierDetectionInterval()
        if Primitive.to_proto(resource.seconds):
            res.seconds = Primitive.to_proto(resource.seconds)
        if Primitive.to_proto(resource.nanos):
            res.nanos = Primitive.to_proto(resource.nanos)
...
class BackendServiceOutlierDetectionBaseEjectionTime(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            backend_service_pb2.ComputeBackendServiceOutlierDetectionBaseEjectionTime()
        )
        if Primitive.to_proto(resource.seconds):
            res.seconds = Primitive.to_proto(resource.seconds)
        if Primitive.to_proto(resource.nanos):
...
class BackendServiceMaxStreamDuration(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_service_pb2.ComputeBackendServiceMaxStreamDuration()
        if Primitive.to_proto(resource.seconds):
            res.seconds = Primitive.to_proto(resource.seconds)
        if Primitive.to_proto(resource.nanos):
            res.nanos = Primitive.to_proto(resource.nanos)
...
class BackendServiceBackendsBalancingModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceBackendsBalancingModeEnum.Value(
            "ComputeBackendServiceBackendsBalancingModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceBackendsBalancingModeEnum.Name(
            resource
        )[len("ComputeBackendServiceBackendsBalancingModeEnum") :]
...
class BackendServiceProtocolEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceProtocolEnum.Value(
            "ComputeBackendServiceProtocolEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceProtocolEnum.Name(resource)[
            len("ComputeBackendServiceProtocolEnum") :
        ]
...
class BackendServiceSessionAffinityEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceSessionAffinityEnum.Value(
            "ComputeBackendServiceSessionAffinityEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceSessionAffinityEnum.Name(
            resource
        )[len("ComputeBackendServiceSessionAffinityEnum") :]
...
class BackendServiceLoadBalancingSchemeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceLoadBalancingSchemeEnum.Value(
            "ComputeBackendServiceLoadBalancingSchemeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceLoadBalancingSchemeEnum.Name(
            resource
        )[len("ComputeBackendServiceLoadBalancingSchemeEnum") :]
...
class BackendServiceCdnPolicyCacheModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceCdnPolicyCacheModeEnum.Value(
            "ComputeBackendServiceCdnPolicyCacheModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceCdnPolicyCacheModeEnum.Name(
            resource
        )[len("ComputeBackendServiceCdnPolicyCacheModeEnum") :]
...
class BackendServiceLocalityLbPolicyEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceLocalityLbPolicyEnum.Value(
            "ComputeBackendServiceLocalityLbPolicyEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return backend_service_pb2.ComputeBackendServiceLocalityLbPolicyEnum.Name(
            resource
        )[len("ComputeBackendServiceLocalityLbPolicyEnum") :]
