...
class Function(object):
    ...
    def apply(self):
        stub = function_pb2_grpc.CloudfunctionsAlphaFunctionServiceStub(
            channel.Channel()
        )
        request = function_pb2.ApplyCloudfunctionsAlphaFunctionRequest()
        ...
        response = stub.ApplyCloudfunctionsAlphaFunction(request)
    ...
    def delete(self):
        ...
        request = function_pb2.DeleteCloudfunctionsAlphaFunctionRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudfunctionsAlphaFunction(request)
    ...
    def list(self, project, region, service_account_file=""):
        ...
        request = function_pb2.ListCloudfunctionsAlphaFunctionRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Region = region

        return stub.ListCloudfunctionsAlphaFunction(request).items

    def to_proto(self):
        resource = function_pb2.CloudfunctionsAlphaFunction()
        if Primitive.to_proto(self.name):
...
class FunctionSourceRepository(object):
    ...
    def to_proto(self, resource):
        ...
        res = function_pb2.CloudfunctionsAlphaFunctionSourceRepository()
...
class FunctionHttpsTrigger(object):
    ...
    def to_proto(self, resource):
        ...
        res = function_pb2.CloudfunctionsAlphaFunctionHttpsTrigger()
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
...
class FunctionEventTrigger(object):
    ...
    def to_proto(self, resource):
        ...
        res = function_pb2.CloudfunctionsAlphaFunctionEventTrigger()
...
class FunctionHttpsTriggerSecurityLevelEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            function_pb2.CloudfunctionsAlphaFunctionHttpsTriggerSecurityLevelEnum.Value(
                "CloudfunctionsAlphaFunctionHttpsTriggerSecurityLevelEnum%s" % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            function_pb2.CloudfunctionsAlphaFunctionHttpsTriggerSecurityLevelEnum.Name(
                resource
            )[len("CloudfunctionsAlphaFunctionHttpsTriggerSecurityLevelEnum") :]
        )
...
class FunctionStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsAlphaFunctionStatusEnum.Value(
            "CloudfunctionsAlphaFunctionStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsAlphaFunctionStatusEnum.Name(resource)[
            len("CloudfunctionsAlphaFunctionStatusEnum") :
        ]
...
class FunctionVPCConnectorEgressSettingsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsAlphaFunctionVPCConnectorEgressSettingsEnum.Value(
            "CloudfunctionsAlphaFunctionVPCConnectorEgressSettingsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            function_pb2.CloudfunctionsAlphaFunctionVPCConnectorEgressSettingsEnum.Name(
                resource
            )[len("CloudfunctionsAlphaFunctionVPCConnectorEgressSettingsEnum") :]
        )
...
class FunctionIngressSettingsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsAlphaFunctionIngressSettingsEnum.Value(
            "CloudfunctionsAlphaFunctionIngressSettingsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsAlphaFunctionIngressSettingsEnum.Name(
            resource
        )[len("CloudfunctionsAlphaFunctionIngressSettingsEnum") :]
