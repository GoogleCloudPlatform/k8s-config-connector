...
class WorkerPool(object):
    ...
    def apply(self):
        stub = worker_pool_pb2_grpc.CloudbuildWorkerPoolServiceStub(channel.Channel())
        request = worker_pool_pb2.ApplyCloudbuildWorkerPoolRequest()
        ...
        response = stub.ApplyCloudbuildWorkerPool(request)
    ...
    def delete(self):
        stub = worker_pool_pb2_grpc.CloudbuildWorkerPoolServiceStub(channel.Channel())
        request = worker_pool_pb2.DeleteCloudbuildWorkerPoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudbuildWorkerPool(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = worker_pool_pb2_grpc.CloudbuildWorkerPoolServiceStub(channel.Channel())
        request = worker_pool_pb2.ListCloudbuildWorkerPoolRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListCloudbuildWorkerPool(request).items

    def to_proto(self):
        resource = worker_pool_pb2.CloudbuildWorkerPool()
        if Primitive.to_proto(self.name):
...
class WorkerPoolPrivatePoolV1Config(object):
    ...
    def to_proto(self, resource):
        ...
        res = worker_pool_pb2.CloudbuildWorkerPoolPrivatePoolV1Config()
...
class WorkerPoolPrivatePoolV1ConfigWorkerConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = worker_pool_pb2.CloudbuildWorkerPoolPrivatePoolV1ConfigWorkerConfig()
...
class WorkerPoolPrivatePoolV1ConfigNetworkConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = worker_pool_pb2.CloudbuildWorkerPoolPrivatePoolV1ConfigNetworkConfig()
...
class WorkerPoolWorkerConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = worker_pool_pb2.CloudbuildWorkerPoolWorkerConfig()
        if Primitive.to_proto(resource.machine_type):
            res.machine_type = Primitive.to_proto(resource.machine_type)
        if Primitive.to_proto(resource.disk_size_gb):
            res.disk_size_gb = Primitive.to_proto(resource.disk_size_gb)
...
class WorkerPoolNetworkConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = worker_pool_pb2.CloudbuildWorkerPoolNetworkConfig()
        if Primitive.to_proto(resource.peered_network):
            res.peered_network = Primitive.to_proto(resource.peered_network)
        if Primitive.to_proto(resource.peered_network_ip_range):
            res.peered_network_ip_range = Primitive.to_proto(
...
class WorkerPoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return worker_pool_pb2.CloudbuildWorkerPoolStateEnum.Value(
            "CloudbuildWorkerPoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return worker_pool_pb2.CloudbuildWorkerPoolStateEnum.Name(resource)[
            len("CloudbuildWorkerPoolStateEnum") :
        ]
...
class WorkerPoolPrivatePoolV1ConfigNetworkConfigEgressOptionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return worker_pool_pb2.CloudbuildWorkerPoolPrivatePoolV1ConfigNetworkConfigEgressOptionEnum.Value(
            "CloudbuildWorkerPoolPrivatePoolV1ConfigNetworkConfigEgressOptionEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return worker_pool_pb2.CloudbuildWorkerPoolPrivatePoolV1ConfigNetworkConfigEgressOptionEnum.Name(
            resource
        )[
            len(
                "CloudbuildWorkerPoolPrivatePoolV1ConfigNetworkConfigEgressOptionEnum"
            ) :
        ]
