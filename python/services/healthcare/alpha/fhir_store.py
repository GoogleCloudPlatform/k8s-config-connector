...
class FhirStore(object):
    ...
    def apply(self):
        stub = fhir_store_pb2_grpc.HealthcareAlphaFhirStoreServiceStub(
            channel.Channel()
        )
        request = fhir_store_pb2.ApplyHealthcareAlphaFhirStoreRequest()
        ...
        response = stub.ApplyHealthcareAlphaFhirStore(request)
    ...
    def delete(self):
        ...
        request = fhir_store_pb2.DeleteHealthcareAlphaFhirStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteHealthcareAlphaFhirStore(request)
    ...
    def list(self, project, location, dataset, service_account_file=""):
        ...
        request = fhir_store_pb2.ListHealthcareAlphaFhirStoreRequest()
        ...
        return stub.ListHealthcareAlphaFhirStore(request).items

    def to_proto(self):
        resource = fhir_store_pb2.HealthcareAlphaFhirStore()
        if Primitive.to_proto(self.name):
...
class FhirStoreNotificationConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareAlphaFhirStoreNotificationConfig()
...
class FhirStoreStreamConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareAlphaFhirStoreStreamConfigs()
...
class FhirStoreStreamConfigsBigqueryDestination(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareAlphaFhirStoreStreamConfigsBigqueryDestination()
...
class FhirStoreStreamConfigsBigqueryDestinationSchemaConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            fhir_store_pb2.HealthcareAlphaFhirStoreStreamConfigsBigqueryDestinationSchemaConfig()
        )
...
class FhirStoreValidationConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareAlphaFhirStoreValidationConfig()
...
class FhirStoreVersionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareAlphaFhirStoreVersionEnum.Value(
            "HealthcareAlphaFhirStoreVersionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareAlphaFhirStoreVersionEnum.Name(resource)[
            len("HealthcareAlphaFhirStoreVersionEnum") :
        ]
...
class FhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareAlphaFhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum.Value(
            "HealthcareAlphaFhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareAlphaFhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum.Name(
            resource
        )[
            len(
                "HealthcareAlphaFhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum"
            ) :
        ]
...
class FhirStoreComplexDataTypeReferenceParsingEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareAlphaFhirStoreComplexDataTypeReferenceParsingEnum.Value(
            "HealthcareAlphaFhirStoreComplexDataTypeReferenceParsingEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareAlphaFhirStoreComplexDataTypeReferenceParsingEnum.Name(
            resource
        )[
            len("HealthcareAlphaFhirStoreComplexDataTypeReferenceParsingEnum") :
        ]
