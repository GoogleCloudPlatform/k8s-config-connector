...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkManagementVpcFlowLogsConfigRef) DeepCopyInto(out *NetworkManagementVpcFlowLogsConfigRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkManagementVpcFlowLogsConfigRef.
func (in *NetworkManagementVpcFlowLogsConfigRef) DeepCopy() *NetworkManagementVpcFlowLogsConfigRef {
	if in == nil {
		return nil
	}
	out := new(NetworkManagementVpcFlowLogsConfigRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkManagementVpcFlowLogsConfigSpec) DeepCopyInto(out *NetworkManagementVpcFlowLogsConfigSpec) {
	*out = *in
	...
	if in.InterconnectAttachmentRef != nil {
		...
		*out = new(v1beta1.ComputeInterconnectAttachmentRef)
		**out = **in
	}
	if in.VPNTunnelRef != nil {
		in, out := &in.VPNTunnelRef, &out.VPNTunnelRef
		*out = new(v1beta1.ComputeVPNTunnelRef)
		**out = **in
	}
	if in.Labels != nil {
		in, out := &in.Labels, &out.Labels
