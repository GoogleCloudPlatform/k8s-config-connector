...
/* found existing non-generated go type "Endpoint_CloudRunRevisionEndpoint", skipping
...
/* found existing non-generated go type "EndpointObservedState", skipping
...
// +kcc:observedstate:proto=google.cloud.networkmanagement.v1.Endpoint.AppEngineVersionEndpoint
type Endpoint_AppEngineVersionEndpointObservedState struct {
}

// +kcc:observedstate:proto=google.cloud.networkmanagement.v1.Endpoint.CloudFunctionEndpoint
type Endpoint_CloudFunctionEndpointObservedState struct {
}

/* found existing non-generated go type "Endpoint_CloudRunRevisionEndpointObservedState", skipping
...
// +kcc:observedstate:proto=google.cloud.networkmanagement.v1.ProbingDetails
...
type RouteInfoObservedState struct {
	...
	// +kcc:proto:field=google.cloud.networkmanagement.v1.RouteInfo.next_hop_uri
	NextHopURI *string `json:"nextHopURI,omitempty"`

	// URI of a VPC network where the next hop resource is located.
	// +kcc:proto:field=google.cloud.networkmanagement.v1.RouteInfo.next_hop_network_uri
	...
	//  SUBNET/STATIC route.
	// +kcc:proto:field=google.cloud.networkmanagement.v1.RouteInfo.originating_route_uri
	...
	// +kcc:proto:field=google.cloud.networkmanagement.v1.RouteInfo.originating_route_display_name
	...
	// +kcc:proto:field=google.cloud.networkmanagement.v1.RouteInfo.ncc_hub_route_uri
...
type StepObservedState struct {
	...
	// +kcc:proto:field=google.cloud.networkmanagement.v1.Step.direct_vpc_egress_connection
	DirectVPCEgressConnection *DirectVPCEgressConnectionInfoObservedState `json:"directVPCEgressConnection,omitempty"`

	// Display information of a serverless public (external) connection.
	// +kcc:proto:field=google.cloud.networkmanagement.v1.Step.serverless_external_connection
	ServerlessExternalConnection *ServerlessExternalConnectionInfoObservedState `json:"serverlessExternalConnection,omitempty"`
...
/* found existing non-generated go type "StatusObservedState", skipping
