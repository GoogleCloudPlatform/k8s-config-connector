...
/* unreachable type CloudRunJobInfo
// +kcc:proto=google.cloud.networkmanagement.v1.CloudRunJobInfo
type CloudRunJobInfo struct {
	// Name of a Cloud Run job.
	// +kcc:proto:field=google.cloud.networkmanagement.v1.CloudRunJobInfo.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// URI of a Cloud Run job.
	// +kcc:proto:field=google.cloud.networkmanagement.v1.CloudRunJobInfo.uri
	URI *string `json:"uri,omitempty"`

	// Location in which this job is deployed.
	// +kcc:proto:field=google.cloud.networkmanagement.v1.CloudRunJobInfo.location
...
/* unreachable type PrivateConnectionInfo
// +kcc:proto=google.cloud.networkmanagement.v1.PrivateConnectionInfo
type PrivateConnectionInfo struct {
	...
	// +kcc:proto:field=google.cloud.networkmanagement.v1.PrivateConnectionInfo.uri
	URI *string `json:"uri,omitempty"`
}
*/
