...
func (i *ConnectivityTestIdentity) Parent() *ConnectivityTestParent {
	return i.parent
}
...
func (p *ConnectivityTestParent) String() string {
	return "projects/" + p.ProjectID + "/locations/" + p.Location
}

// New builds a ConnectivityTestIdentity from the Config Connector ConnectivityTest object.
func NewConnectivityTestIdentity(ctx context.Context, reader client.Reader, obj *NetworkManagementConnectivityTest) (*ConnectivityTestIdentity, error) {
	...
	if externalRef != "" {
		...
		actualParent, actualResourceID, err := ParseConnectivityTestExternal(externalRef)
		if err != nil {
			return nil, err
		}
	...
	return &ConnectivityTestIdentity{
		parent: &ConnectivityTestParent{
			ProjectID: projectID,
			Location:  location,
		},
...
var _ identity.Identity = &ConnectivityTestIdentity{}
