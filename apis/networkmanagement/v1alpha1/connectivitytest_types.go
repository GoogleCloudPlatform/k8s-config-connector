...
type NetworkManagementConnectivityTestStatus struct {
	...
	// A unique specifier for the NetworkManagementConnectivityTest resource in Google Cloud.
...
// NetworkManagementConnectivityTestObservedState is the state of the NetworkManagementConnectivityTest resource as most recently observed in Google Cloud.
// +kcc:proto=google.cloud.networkmanagement.v1.ConnectivityTest
