...
func (in *ClusterGkeNodeConfig) DeepCopyInto(out *ClusterGkeNodeConfig) {
	*out = *in
	if in.Accelerators != nil {
		...
		*out = make([]ClusterGkeNodePoolAccelerators, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterGkeNodePoolAccelerators) DeepCopyInto(out *ClusterGkeNodePoolAccelerators) {
	*out = *in
	if in.AcceleratorCount != nil {
		in, out := &in.AcceleratorCount, &out.AcceleratorCount
		*out = new(int64)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterGkeNodePoolAccelerators.
func (in *ClusterGkeNodePoolAccelerators) DeepCopy() *ClusterGkeNodePoolAccelerators {
	if in == nil {
		return nil
	}
	out := new(ClusterGkeNodePoolAccelerators)
	in.DeepCopyInto(out)
	return out
}
