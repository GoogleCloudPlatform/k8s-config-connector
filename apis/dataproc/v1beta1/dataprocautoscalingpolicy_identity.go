...
var (
	...
	_ identity.Resource   = &DataprocAutoscalingPolicy{}
)
...
// DataprocAutoscalingPolicyIdentity is the identity of a GCP DataprocAutoscalingPolicy resource.
...
func getIdentityFromDataprocAutoscalingPolicySpec(ctx context.Context, reader client.Reader, obj *DataprocAutoscalingPolicy) (*DataprocAutoscalingPolicyIdentity, error) {
...
func (obj *DataprocAutoscalingPolicy) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	specIdentity, err := getIdentityFromDataprocAutoscalingPolicySpec(ctx, reader, obj)
	if err != nil {
		return nil, err
	}
	...
	if externalRef != "" {
		...
		statusIdentity := &DataprocAutoscalingPolicyIdentity{}
		if err := statusIdentity.FromExternal(externalRef); err != nil {
			return nil, err
		}

		if statusIdentity.String() != specIdentity.String() {
			return nil, fmt.Errorf("cannot change DataprocAutoscalingPolicy identity (old=%q, new=%q)", statusIdentity.String(), specIdentity.String())
		}
	}
