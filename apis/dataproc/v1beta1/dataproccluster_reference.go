...
type DataprocClusterRef struct {
	...
	// Should be in the format "projects/{project}/regions/{region}/clusters/{cluster}".
...
func (r *DataprocClusterRef) NormalizedExternal(ctx context.Context, reader client.Reader, defaultNamespace string) (string, error) {
