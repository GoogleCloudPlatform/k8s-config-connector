...
type ClusterConfig struct {
	...
	StagingBucketRef *DataprocStagingBucketRef `json:"stagingBucketRef,omitempty"`
	...
	TempBucketRef *DataprocTempBucketRef `json:"tempBucketRef,omitempty"`
...
type EncryptionConfig struct {
	...
	GcePdKmsKeyRef *DataprocPdKmsKeyRef `json:"gcePdKmsKeyRef,omitempty"`
}
...
type GceClusterConfig struct {
	...
	NetworkRef *DataprocComputeNetworkRef `json:"networkRef,omitempty"`
	...
	ServiceAccountRef *DataprocIamServiceAccountRef `json:"serviceAccountRef,omitempty"`
	...
	SubnetworkRef *DataprocComputeSubnetworkRef `json:"subnetworkRef,omitempty"`
...
type InstanceGroupConfig struct {
	...
	ImageRef *DataprocComputeImageRef `json:"imageRef,omitempty"`
...
type KerberosConfig struct {
	...
	KmsKeyRef *DataprocKmsKeyRef `json:"kmsKeyRef,omitempty"`
...
type GkeClusterConfig struct {
	...
	GkeClusterTargetRef *DataprocContainerClusterRef `json:"gkeClusterTargetRef,omitempty"`
...
type GkeNodePoolConfig_GkeNodeConfig struct {
	...
	EphemeralStorageConfig *GkeNodePoolConfig_GkeNodeConfig_EphemeralStorageConfig `json:"ephemeralStorageConfig,omitempty"`
...
// +kcc:proto=google.cloud.dataproc.v1.GkeNodePoolConfig.GkeNodeConfig.EphemeralStorageConfig
// +kubebuilder:object:generate=true
type GkeNodePoolConfig_GkeNodeConfig_EphemeralStorageConfig struct {
