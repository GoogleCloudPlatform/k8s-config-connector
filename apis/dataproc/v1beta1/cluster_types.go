...
type ClusterNodePoolConfig struct {
	...
	// +optional
	Config *ClusterGkeNodeConfig `json:"config,omitempty"`
...
type ClusterNodePoolTarget struct {
	...
	/* Immutable. */
	NodePoolRef containerv1beta1.ContainerNodePoolRef `json:"nodePoolRef"`
...
type ClusterConfig struct {
	...
	// +optional
	DataprocMetricConfig *ClusterDataprocMetricConfig `json:"dataprocMetricConfig,omitempty"`

	/* Immutable. Optional. Encryption config for the cluster. */
	// +optional
	EncryptionConfig *ClusterEncryptionConfig `json:"encryptionConfig,omitempty"`

	/* Immutable. Optional. Port access config for the cluster. */
	// +optional
	EndpointConfig *ClusterEndpointConfig `json:"endpointConfig,omitempty"`

	/* Immutable. Optional. Compute Engine config settings for a cluster. */
	// +optional
	GceClusterConfig *ClusterGceClusterConfig `json:"gceClusterConfig,omitempty"`

	/* Immutable. Optional. Commands to run on each node after the cluster is configured. */
	// +optional
	InitializationActions []ClusterInitializationActions `json:"initializationActions,omitempty"`

	/* Immutable. Optional. Lifecycle config for the cluster. */
	// +optional
	...
	/* Immutable. Optional. Metastore config for the cluster. */
	// +optional
	MetastoreConfig *ClusterMetastoreConfig `json:"metastoreConfig,omitempty"`

	/* Immutable. Optional. The Compute Engine config settings for secondary worker instances in a cluster. */
	// +optional
	SecondaryWorkerConfig *ClusterSecondaryWorkerConfig `json:"secondaryWorkerConfig,omitempty"`

	/* Immutable. Optional. Security config for the cluster. */
	// +optional
	SecurityConfig *ClusterSecurityConfig `json:"securityConfig,omitempty"`

	/* Immutable. Optional. Software config for the cluster. */
	// +optional
