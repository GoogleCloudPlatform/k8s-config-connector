...
var DataprocClusterIdentityFormat = gcpurls.Template[DataprocClusterIdentity](
	"dataproc.googleapis.com",
	"projects/{project}/regions/{region}/clusters/{cluster}",
)

// DataprocClusterIdentity represents the identity of a DataprocCluster.
...
func (i *DataprocClusterIdentity) FromExternal(ref string) error {
	...
	if !match {
		return fmt.Errorf("format of DataprocCluster external=%q was not known (use %s)", ref, DataprocClusterIdentityFormat.CanonicalForm())
	}
