...
// DataprocAutoscalingPolicyRef defines the resource reference to DataprocAutoscalingPolicy, which "External" field
// holds the GCP identifier for the KRM object.
type DataprocAutoscalingPolicyRef struct {
	// A reference to an externally managed DataprocAutoscalingPolicy resource.
	// Should be in the format "projects/{{projectID}}/regions/{{region}}/autoscalingPolicies/{{autoscalingPolicyID}}".
