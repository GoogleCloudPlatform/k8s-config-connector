...
var IdentityPlatformConfigGVK = GroupVersion.WithKind("IdentityPlatformConfig")
...
// +openapi:GoogleCloudIdentitytoolkitAdminV2Trigger
type ConfigTriggers struct {
	// +optional
	FunctionUriRef *ConfigFunctionUriRef `json:"functionUriRef,omitempty"`
...
// +kcc:spec:proto=dcl.IdentitytoolkitBetaConfig
...
type IdentityPlatformConfig struct {
	...
	// +required
	Spec   IdentityPlatformConfigSpec   `json:"spec"`
...
type ConfigFunctionUriRef struct {
	/* HTTP URI trigger for the Cloud Function. Allowed value: The `httpsTrigger.url` field of a `CloudFunctionsFunction` resource. */
	// +optional
	External string `json:"external,omitempty"`
