...
var EdgenetworkNetworkGVK = GroupVersion.WithKind("EdgenetworkNetwork")
...
type EdgenetworkNetworkSpec struct {
	// The EdgenetworkNetwork name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// EdgenetworkNetworkStatus defines the config connector machine state of EdgenetworkNetwork
type EdgenetworkNetworkStatus struct {
	...
	// A unique specifier for the EdgenetworkNetwork resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *EdgenetworkNetworkObservedState `json:"observedState,omitempty"`
}

// EdgenetworkNetworkObservedState is the state of the EdgenetworkNetwork resource as most recently observed in GCP.
// +kcc:proto=google.cloud.edgenetwork.v1.Network
type EdgenetworkNetworkObservedState struct {
}
...
// EdgenetworkNetwork is the Schema for the EdgenetworkNetwork API
