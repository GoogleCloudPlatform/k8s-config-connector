...
type PubsubTopicSpec struct {
	// The PubsubTopic name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// PubsubTopicStatus defines the config connector machine state of PubsubTopic
type PubsubTopicStatus struct {
	...
	// A unique specifier for the PubsubTopic resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *PubsubTopicObservedState `json:"observedState,omitempty"`
}

// PubsubTopicObservedState is the state of the PubsubTopic resource as most recently observed in GCP.
// +kcc:proto=google.pubsub.v1.Topic
type PubsubTopicObservedState struct {
}
...
// PubsubTopic is the Schema for the PubsubTopic API
