...
type PubsubSubscriptionSpec struct {
	// The PubsubSubscription name. If not given, the metadata.name will be used.
...
type PubsubSubscriptionStatus struct {
	...
	// A unique specifier for the PubsubSubscription resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *PubsubSubscriptionObservedState `json:"observedState,omitempty"`
}

// PubsubSubscriptionObservedState is the state of the PubsubSubscription resource as most recently observed in GCP.
// +kcc:proto=google.pubsub.v1.Subscription
type PubsubSubscriptionObservedState struct {
}
