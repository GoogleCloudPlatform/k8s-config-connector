...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IAPBrandRef) DeepCopyInto(out *IAPBrandRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IAPBrandRef.
func (in *IAPBrandRef) DeepCopy() *IAPBrandRef {
	if in == nil {
		return nil
	}
	out := new(IAPBrandRef)
