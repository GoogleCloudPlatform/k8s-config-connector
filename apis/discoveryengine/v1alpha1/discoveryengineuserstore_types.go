...
type DiscoveryEngineUserStoreSpec struct {
	...
	//
	// If the default LicenseConfig doesn't have remaining license seats left,
	// new users will not be assigned with license and will be blocked for
	// Vertex AI Search features. This is used if `license_assignment_tier_rules`
	// is not configured.
	// +kubebuilder:validation:Optional
	...
	// to use the default license config as long as the default license config
	// has seats left.
	// +kubebuilder:validation:Optional
