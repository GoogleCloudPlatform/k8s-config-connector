...
// DiscoveryEngineSampleQueryIdentity is the identity of a GCP DiscoveryEngineSampleQuery resource.
...
func getIdentityFromDiscoveryEngineSampleQuerySpec(ctx context.Context, reader client.Reader, obj *DiscoveryEngineSampleQuery) (*DiscoveryEngineSampleQueryIdentity, error) {
	...
	identity := &DiscoveryEngineSampleQueryIdentity{
		Project:        projectID,
		Location:       location,
		SampleQuerySet: obj.Spec.SampleQuerySet,
