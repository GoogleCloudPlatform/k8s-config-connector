...
type DiscoveryEngineSearchEngineStatus struct {
	...
	ObservedState *DiscoveryEngineSearchEngineObservedState `json:"observedState,omitempty"`
}

// DiscoveryEngineSearchEngineObservedState is the state of the DiscoveryEngineSearchEngine resource as most recently observed in GCP.
// +kcc:observedstate:proto=google.cloud.discoveryengine.v1.SiteSearchEngine
type DiscoveryEngineSearchEngineObservedState struct {
}
...
// DiscoveryEngineSearchEngine is the Schema for the DiscoveryEngineSearchEngine API
