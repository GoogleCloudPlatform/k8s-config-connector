...
var _ refs.Ref = &DiscoveryEngineAssistantRef{}
...
func (r *DiscoveryEngineAssistantRef) ValidateExternal(ref string) error {
	_, err := ParseDiscoveryEngineAssistantExternal(ref)
	return err
}
...
func init() {
	refs.Register(&DiscoveryEngineAssistantRef{}, &DiscoveryEngineAssistant{})
}
