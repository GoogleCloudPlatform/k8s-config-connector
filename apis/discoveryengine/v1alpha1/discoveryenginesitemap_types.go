...
// +kcc:spec:proto=google.cloud.discoveryengine.v1.Sitemap
type DiscoveryEngineSitemapSpec struct {
	...
	// The DiscoveryEngineSitemap name. If not given, it will be server generated.
	ResourceID *string `json:"resourceID,omitempty"`

	// Public URI for the sitemap, e.g. `www.example.com/sitemap.xml`.
	// +kcc:proto:field=google.cloud.discoveryengine.v1.Sitemap.uri
	// +required
...
// +kcc:observedstate:proto=google.cloud.discoveryengine.v1.Sitemap
type DiscoveryEngineSitemapObservedState struct {
	// Output only. The sitemap's creation time.
	// +kcc:proto:field=google.cloud.discoveryengine.v1.Sitemap.create_time
