...
//         // Required. The data store's email address. If this field is not set when
//         // creating or updating the data store, an INVALID_ARGUMENT error is returned.
//         Email *string `json:"email,omitempty"`

//         // Required. The parent project id of the data store. If this field is not
//         // set when creating or updating the data store, an INVALID_ARGUMENT error is
//         // returned.
//         ProjectRef *v1beta1.ProjectRef `json:"projectRef,omitempty"`
// }

// type DocumentProcessingConfig struct {
//         // The processor configurations for this data store.
...
//         // +kubebuilder:validation:XValidation:rule="self == oldSelf",message="ResourceID field is immutable"
//         // Immutable.
//         // The name of the processor. If not given, metadata.name will be used.
//         ResourceID *string `json:"resourceID,omitempty"`

//         // +kubebuilder:validation:XValidation:rule="self == oldSelf",message="Type field is immutable"
//         // Immutable. The type of the processor.
//         Type *string `json:"type,omitempty"`

//         // Common configurations of all processors.
//         CommonConfig *CommonConfig `json:"commonConfig,omitempty"`

//         // Configurations for public website enrichment processor.
//         WebsiteProcessorConfig *WebsiteProcessorConfig `json:"websiteProcessorConfig,omitempty"`

//         // Configurations for the google workspace enrichment processor.
//         GoogleWorkspaceProcessorConfig *GoogleWorkspaceProcessorConfig `json:"googleWorkspaceProcessorConfig,omitempty"`
// }

// type CommonConfig struct {
//         // Whether to enable the processor to enrich the documents.
//         EnableEnrichment *bool `json:"enableEnrichment,omitempty"`
// }

// type WebsiteProcessorConfig struct {
//         // +kubebuilder:validation:XValidation:rule="self == oldSelf",message="Source field is immutable"
//         // Immutable. The source URL of the website.
//         Source *string `json:"source,omitempty"`
// }

// type GoogleWorkspaceProcessorConfig struct {
//         // +kubebuilder:validation:XValidation:rule="self == oldSelf",message="DataSource field is immutable"
//         // Immutable. The data source that the processor should take enrichment
//         // from.
