...
var _ refs.Ref = &DiscoveryEngineDataConnectorRef{}
...
type DiscoveryEngineDataConnectorRef struct {
	// A reference to an externally managed DiscoveryEngineDataConnector resource. Should be in the format "projects/{{projectID}}/locations/{{location}}/collections/{{collection}}/dataConnector"
...
func init() {
	refs.Register(&DiscoveryEngineDataConnectorRef{}, &DiscoveryEngineDataConnector{})
}
...
func (r *DiscoveryEngineDataConnectorRef) SetExternal(external string) {
	r.External = external
	r.Name = ""
	r.Namespace = ""
}
