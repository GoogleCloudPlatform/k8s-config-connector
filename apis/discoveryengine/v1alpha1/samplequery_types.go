...
type DiscoveryEngineSampleQuerySpec struct {
	...
	// Immutable. The SampleQuerySet for the SampleQuery.
	SampleQuerySet string `json:"sampleQuerySet"`

	// The query entry.
	QueryEntry *SampleQuery_QueryEntry `json:"queryEntry,omitempty"`

	// Immutable. The DiscoveryEngineSampleQuery name. If not given, the metadata.name will be used.
...
type DiscoveryEngineSampleQueryObservedState struct {
	// Output only. Timestamp the SampleQuery was created.
