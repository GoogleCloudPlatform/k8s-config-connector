...
type DiscoveryEngineControlStatus struct {
	...
	// A unique specifier for the DiscoveryEngineControl resource in Google Cloud.
...
// DiscoveryEngineControlObservedState is the state of the DiscoveryEngineControl resource as most recently observed in Google Cloud.
