...
go run . generate-types --service google.cloud.discoveryengine.v1beta --api-version discoveryengine.cnrm.cloud.google.com/v1alpha1 --resource DiscoveryEngineServingConfig:ServingConfig
