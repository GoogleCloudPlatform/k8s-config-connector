...
var StorageTransferAgentPoolGVK = GroupVersion.WithKind("StorageTransferAgentPool")
...
type StorageTransferAgentPoolSpec struct {
	// The StorageTransferAgentPool name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`

	Parent `json:",inline"`
}

// StorageTransferAgentPoolStatus defines the config connector machine state of StorageTransferAgentPool
type StorageTransferAgentPoolStatus struct {
	...
	// A unique specifier for the StorageTransferAgentPool resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *StorageTransferAgentPoolObservedState `json:"observedState,omitempty"`
}

// StorageTransferAgentPoolObservedState is the state of the StorageTransferAgentPool resource as most recently observed in GCP.
// +kcc:proto=google.storagetransfer.v1.AgentPool
type StorageTransferAgentPoolObservedState struct {
}
...
// StorageTransferAgentPool is the Schema for the StorageTransferAgentPool API
