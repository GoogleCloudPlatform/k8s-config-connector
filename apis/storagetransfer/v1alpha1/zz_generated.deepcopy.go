...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgentPoolObservedState) DeepCopyInto(out *AgentPoolObservedState) {
	*out = *in
	if in.State != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgentPoolObservedState.
func (in *AgentPoolObservedState) DeepCopy() *AgentPoolObservedState {
	if in == nil {
		return nil
	}
	out := new(AgentPoolObservedState)
	in.DeepCopyInto(out)
	return out
}
