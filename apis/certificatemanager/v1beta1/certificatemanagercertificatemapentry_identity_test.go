...
func TestCertificateManagerCertificateMapEntryIdentity_FromExternal(t *testing.T) {
	tests := []struct {
		name    string
		ref     string
		wantErr bool
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			i := &CertificateManagerCertificateMapEntryIdentity{}
...
func TestCertificateManagerCertificateMapEntryRef_Normalize(t *testing.T) {
	s := runtime.NewScheme()
	_ = AddToScheme(s)
	...
	certMapEntry := &unstructured.Unstructured{}
	certMapEntry.SetGroupVersionKind(CertificateManagerCertificateMapEntryGVK)
	certMapEntry.SetName("my-entry")
	certMapEntry.SetNamespace("my-ns")
	certMapEntry.Object["spec"] = map[string]interface{}{
		"resourceID": "my-entry-id",
		"projectRef": map[string]interface{}{
			"external": "my-project",
		},
	...
	tests := []struct {
	...
	}{
		{
			...
			ref: &CertificateManagerCertificateMapEntryRef{
				External: "projects/my-project/locations/global/certificateMaps/my-certmap/certificateMapEntries/my-entry",
			},
