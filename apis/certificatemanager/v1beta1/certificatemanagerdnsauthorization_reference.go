...
// CertificateManagerDNSAuthorizationRef defines the resource reference to CertificateManagerDNSAuthorization, which "External" field
...
func (r *CertificateManagerDNSAuthorizationRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromCertificateManagerDNSAuthorizationSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
