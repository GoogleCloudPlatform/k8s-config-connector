...
type CertificatemanagerCertificateMapEntrySpec struct {
	// The CertificatemanagerCertificateMapEntry name. If not given, the metadata.name will be used.
...
type CertificatemanagerCertificateMapEntryStatus struct {
	...
	// A unique specifier for the CertificatemanagerCertificateMapEntry resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *CertificatemanagerCertificateMapEntryObservedState `json:"observedState,omitempty"`
}

// CertificatemanagerCertificateMapEntryObservedState is the state of the CertificatemanagerCertificateMapEntry resource as most recently observed in GCP.
// +kcc:proto=google.cloud.certificatemanager.v1.CertificateMapEntry
type CertificatemanagerCertificateMapEntryObservedState struct {
}

// +genclient
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// TODO(user): make sure the pluralizaiton below is correct
// +kubebuilder:resource:categories=gcp,shortName=gcpcertificatemanagercertificatemapentry;gcpcertificatemanagercertificatemapentrys
