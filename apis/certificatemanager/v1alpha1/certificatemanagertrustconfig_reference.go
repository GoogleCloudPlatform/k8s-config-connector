...
func init() {
	refs.Register(&CertificateManagerTrustConfigRef{}, &CertificateManagerTrustConfig{})
}
...
func (r *CertificateManagerTrustConfigRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		obj, err := common.ToStructuredType[*CertificateManagerTrustConfig](u)
		if err != nil {
			return ""
		}
		identity, err := getIdentityFromCertificateManagerTrustConfigSpec(ctx, reader, obj)
		if err != nil {
			return ""
		}
