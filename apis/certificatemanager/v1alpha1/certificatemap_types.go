...
var CertificatemanagerCertificateMapGVK = GroupVersion.WithKind("CertificatemanagerCertificateMap")
...
type CertificatemanagerCertificateMapStatus struct {
	...
	// A unique specifier for the CertificatemanagerCertificateMap resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *CertificatemanagerCertificateMapObservedState `json:"observedState,omitempty"`
}

// CertificatemanagerCertificateMapObservedState is the state of the CertificatemanagerCertificateMap resource as most recently observed in GCP.
// +kcc:proto=google.cloud.certificatemanager.v1.CertificateMap
type CertificatemanagerCertificateMapObservedState struct {
}
