...
var _ refsv1beta1.ExternalNormalizer = &DataExchangeRef{}

// DataExchangeRef defines the resource reference to BigQueryAnalyticsHubDataExchange, which "External" field
// holds the GCP identifier for the KRM object.
type DataExchangeRef struct {
	// A reference to an externally managed BigQueryAnalyticsHubDataExchange resource.
	// Should be of the format `projects/{{projectID}}/locations/{{location}}/dataExchanges/{{dataExchangeID}}`.
...
// NormalizedExternal provisions the "External" value for other resource that depends on BigQueryAnalyticsHubDataExchange.
...
func (r *DataExchangeRef) NormalizedExternal(ctx context.Context, reader client.Reader, otherNamespace string) (string, error) {
