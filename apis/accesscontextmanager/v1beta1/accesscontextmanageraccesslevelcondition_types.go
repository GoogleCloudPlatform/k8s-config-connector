...
type AccessContextManagerAccessLevelConditionSpec struct {
	// The AccessContextManagerAccessLevel that this condition belongs to.
	// +required
	...
	/* Immutable. Optional. The AccessContextManagerAccessLevelCondition name. If not given, the metadata.name will be used. */
	// +optional
