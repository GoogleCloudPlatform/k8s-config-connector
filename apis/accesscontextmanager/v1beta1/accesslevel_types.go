...
type AccessContextManagerAccessLevelStatus struct {
	...
	// A unique specifier for the AccessContextManagerAccessLevel resource in Google Cloud.
...
// AccessContextManagerAccessLevelObservedState is the state of the AccessContextManagerAccessLevel resource as most recently observed in Google Cloud.
