...
type ServiceNetworkingPeeredDNSDomainStatus struct {
	...
	// A unique specifier for the ServiceNetworkingPeeredDNSDomain resource in Google Cloud.
...
// ServiceNetworkingPeeredDNSDomainObservedState is the state of the ServiceNetworkingPeeredDNSDomain resource as most recently observed in Google Cloud.
