...
type OsconfigOSPolicyAssignmentStatus struct {
	...
	ObservedState *OsconfigOSPolicyAssignmentObservedState `json:"observedState,omitempty"`
}

// OsconfigOSPolicyAssignmentObservedState is the state of the OsconfigOSPolicyAssignment resource as most recently observed in GCP.
// +kcc:proto=google.cloud.osconfig.v1.OSPolicyAssignment
type OsconfigOSPolicyAssignmentObservedState struct {
}
