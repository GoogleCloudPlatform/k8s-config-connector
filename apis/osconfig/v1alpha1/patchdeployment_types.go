...
var OsconfigPatchDeploymentGVK = GroupVersion.WithKind("OsconfigPatchDeployment")
...
type OsconfigPatchDeploymentSpec struct {
	// The OsconfigPatchDeployment name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// OsconfigPatchDeploymentStatus defines the config connector machine state of OsconfigPatchDeployment
type OsconfigPatchDeploymentStatus struct {
	...
	// A unique specifier for the OsconfigPatchDeployment resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *OsconfigPatchDeploymentObservedState `json:"observedState,omitempty"`
}

// OsconfigPatchDeploymentObservedState is the state of the OsconfigPatchDeployment resource as most recently observed in GCP.
// +kcc:proto=google.cloud.osconfig.v1.PatchDeployment
type OsconfigPatchDeploymentObservedState struct {
}
...
// OsconfigPatchDeployment is the Schema for the OsconfigPatchDeployment API
