...
type OsconfigGuestPolicySpec struct {
	// The OsconfigGuestPolicy name. If not given, the metadata.name will be used.
...
type OsconfigGuestPolicyStatus struct {
	...
	// A unique specifier for the OsconfigGuestPolicy resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *OsconfigGuestPolicyObservedState `json:"observedState,omitempty"`
}

// OsconfigGuestPolicyObservedState is the state of the OsconfigGuestPolicy resource as most recently observed in GCP.
// +kcc:proto=google.cloud.osconfig.v1beta.GuestPolicy
type OsconfigGuestPolicyObservedState struct {
}

// +genclient
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// TODO(user): make sure the pluralizaiton below is correct
// +kubebuilder:resource:categories=gcp,shortName=gcposconfigguestpolicy;gcposconfigguestpolicys
