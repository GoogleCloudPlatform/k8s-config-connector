...
if [ -d "${REPO_ROOT}/pkg/controller/direct/osconfig" ]; then
  go run -mod=readonly golang.org/x/tools/cmd/goimports@${GOLANG_X_TOOLS_VERSION} -w pkg/controller/direct/osconfig/
fi
