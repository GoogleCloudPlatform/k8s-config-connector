...
type Build struct {
	...
	// +kcc:proto:field=google.devtools.cloudbuild.v1.Build.git_config
...
type Dependency struct {
	...
	//  source as well).
	// +kcc:proto:field=google.devtools.cloudbuild.v1.Dependency.empty
...
type Dependency_GitSourceDependency struct {
	...
	// +kcc:proto:field=google.devtools.cloudbuild.v1.Dependency.GitSourceDependency.repository
	Repository *Dependency_GitSourceRepository `json:"repository,omitempty"`

	// Required. The revision that we will fetch the repo at.
	// +kcc:proto:field=google.devtools.cloudbuild.v1.Dependency.GitSourceDependency.revision
	Revision *string `json:"revision,omitempty"`

	// Optional. True if submodules should be fetched too (default false).
	// +kcc:proto:field=google.devtools.cloudbuild.v1.Dependency.GitSourceDependency.recurse_submodules
	RecurseSubmodules *bool `json:"recurseSubmodules,omitempty"`

	// Optional. How much history should be fetched for the build (default 1, -1
	//  for all history).
	// +kcc:proto:field=google.devtools.cloudbuild.v1.Dependency.GitSourceDependency.depth
...
/* unreachable type ApprovalConfigObservedState
...
/* unreachable type Build_FailureInfoObservedState
...
/* unreachable type Build_WarningObservedState
...
/* unreachable type FileHashesObservedState
...
/* unreachable type HashObservedState
...
/* unreachable type RepoSourceObservedState
...
/* unreachable type ResultsObservedState
...
/* unreachable type TimeSpanObservedState
