...
type BuildTrigger struct {
	...
	// +kcc:proto:field=google.devtools.cloudbuild.v1.BuildTrigger.resource_name
...
type GitHubEventsConfig struct {
	...
	// +kcc:proto:field=google.devtools.cloudbuild.v1.GitHubEventsConfig.installation_id
