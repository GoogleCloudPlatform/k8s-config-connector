...
type FirestoreBackupScheduleStatus struct {
	...
	// A unique specifier for the FirestoreBackupSchedule resource in Google Cloud.
...
// FirestoreBackupScheduleObservedState is the state of the FirestoreBackupSchedule resource as most recently observed in Google Cloud.
