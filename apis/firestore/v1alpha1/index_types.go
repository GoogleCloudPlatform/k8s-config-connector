...
type FirestoreIndexSpec struct {
	// The FirestoreIndex name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// FirestoreIndexStatus defines the config connector machine state of FirestoreIndex
type FirestoreIndexStatus struct {
	...
	// A unique specifier for the FirestoreIndex resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *FirestoreIndexObservedState `json:"observedState,omitempty"`
}

// FirestoreIndexObservedState is the state of the FirestoreIndex resource as most recently observed in GCP.
// +kcc:proto=google.firestore.admin.v1.Index
type FirestoreIndexObservedState struct {
}

// +genclient
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// TODO(user): make sure the pluralizaiton below is correct
// +kubebuilder:resource:categories=gcp,shortName=gcpfirestoreindex;gcpfirestoreindexs
