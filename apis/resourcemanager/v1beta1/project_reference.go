...
type ProjectRef struct {
	...
	// The name of a Project resource.
	Name string `json:"name,omitempty"`

	// The namespace of a Project resource.
...
func (r *ProjectRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		typed, err := common.ToStructuredType[*Project](u)
		if err != nil {
			return ""
		}
		identity, err := getIdentityFromProjectSpec(ctx, reader, typed)
		if err != nil {
			return ""
		}
