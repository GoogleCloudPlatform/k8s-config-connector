...
type PrincipalAccessBoundaryPolicy struct {
	...
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.name
	Name *string `json:"name,omitempty"`

	// Optional. The etag for the principal access boundary.
	//  If this is provided on update, it must match the server's etag.
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.etag
	Etag *string `json:"etag,omitempty"`

	// Optional. The description of the principal access boundary policy. Must be
	//  less than or equal to 63 characters.
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// Optional. User defined annotations. See
	//  https://google.aip.dev/148#annotations for more details such as format and
	//  size limitations
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.annotations
	Annotations map[string]string `json:"annotations,omitempty"`

	// Optional. The details for the principal access boundary policy.
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.details
	Details *PrincipalAccessBoundaryPolicyDetails `json:"details,omitempty"`
}

// +kcc:proto=google.iam.v3.PrincipalAccessBoundaryPolicyDetails
type PrincipalAccessBoundaryPolicyDetails struct {
	...
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicyDetails.rules
	...
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicyDetails.enforcement_version
	EnforcementVersion *string `json:"enforcementVersion,omitempty"`
}

// +kcc:proto=google.iam.v3.PrincipalAccessBoundaryPolicyRule
type PrincipalAccessBoundaryPolicyRule struct {
	...
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicyRule.description
	...
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicyRule.resources
	Resources []string `json:"resources,omitempty"`

	// Required. The access relationship of principals to the resources in this
	//  rule.
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicyRule.effect
...
type PrincipalAccessBoundaryPolicyObservedState struct {
	...
	//  policy.
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.uid
	Uid *string `json:"uid,omitempty"`

	// Output only. The time when the principal access boundary policy was
	//  created.
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The time when the principal access boundary policy was most
	//  recently updated.
	// +kcc:proto:field=google.iam.v3.PrincipalAccessBoundaryPolicy.update_time
