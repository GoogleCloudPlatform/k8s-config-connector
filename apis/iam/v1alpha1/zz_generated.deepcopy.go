...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DenyRuleObservedState) DeepCopyInto(out *DenyRuleObservedState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DenyRuleObservedState.
func (in *DenyRuleObservedState) DeepCopy() *DenyRuleObservedState {
	if in == nil {
		return nil
	}
	out := new(DenyRuleObservedState)
	in.DeepCopyInto(out)
	return out
}
