...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IAMDenyPolicyParentRef) DeepCopyInto(out *IAMDenyPolicyParentRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IAMDenyPolicyParentRef.
func (in *IAMDenyPolicyParentRef) DeepCopy() *IAMDenyPolicyParentRef {
	if in == nil {
		return nil
	}
	out := new(IAMDenyPolicyParentRef)
	in.DeepCopyInto(out)
	return out
}
