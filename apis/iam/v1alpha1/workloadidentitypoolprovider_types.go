...
var IamWorkloadIdentityPoolProviderGVK = GroupVersion.WithKind("IamWorkloadIdentityPoolProvider")
...
type IamWorkloadIdentityPoolProviderSpec struct {
	// The IamWorkloadIdentityPoolProvider name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// IamWorkloadIdentityPoolProviderStatus defines the config connector machine state of IamWorkloadIdentityPoolProvider
type IamWorkloadIdentityPoolProviderStatus struct {
	...
	// A unique specifier for the IamWorkloadIdentityPoolProvider resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *IamWorkloadIdentityPoolProviderObservedState `json:"observedState,omitempty"`
}

// IamWorkloadIdentityPoolProviderObservedState is the state of the IamWorkloadIdentityPoolProvider resource as most recently observed in GCP.
// +kcc:proto=google.iam.v1beta.WorkloadIdentityPoolProvider
type IamWorkloadIdentityPoolProviderObservedState struct {
}
...
// IamWorkloadIdentityPoolProvider is the Schema for the IamWorkloadIdentityPoolProvider API
