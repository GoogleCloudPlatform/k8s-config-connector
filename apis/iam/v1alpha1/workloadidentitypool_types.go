...
var IamWorkloadIdentityPoolGVK = GroupVersion.WithKind("IamWorkloadIdentityPool")
...
type IamWorkloadIdentityPoolSpec struct {
	// The IamWorkloadIdentityPool name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// IamWorkloadIdentityPoolStatus defines the config connector machine state of IamWorkloadIdentityPool
type IamWorkloadIdentityPoolStatus struct {
	...
	// A unique specifier for the IamWorkloadIdentityPool resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *IamWorkloadIdentityPoolObservedState `json:"observedState,omitempty"`
}

// IamWorkloadIdentityPoolObservedState is the state of the IamWorkloadIdentityPool resource as most recently observed in GCP.
// +kcc:proto=google.iam.v1beta.WorkloadIdentityPool
type IamWorkloadIdentityPoolObservedState struct {
}
...
// IamWorkloadIdentityPool is the Schema for the IamWorkloadIdentityPool API
