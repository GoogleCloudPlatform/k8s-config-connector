...
func (in *ServiceAccountKeyIdentity) DeepCopyInto(out *ServiceAccountKeyIdentity) {
	*out = *in
	out.ServiceAccountKeyParent = in.ServiceAccountKeyParent
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceAccountKeyParent) DeepCopyInto(out *ServiceAccountKeyParent) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceAccountKeyParent.
func (in *ServiceAccountKeyParent) DeepCopy() *ServiceAccountKeyParent {
	if in == nil {
		return nil
	}
	out := new(ServiceAccountKeyParent)
	in.DeepCopyInto(out)
	return out
}
