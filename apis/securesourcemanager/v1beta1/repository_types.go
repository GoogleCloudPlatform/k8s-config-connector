...
type SecureSourceManagerRepositoryStatus struct {
	...
	// A unique specifier for the SecureSourceManagerRepository resource in Google Cloud.
...
// SecureSourceManagerRepositoryObservedState is the state of the SecureSourceManagerRepository resource as most recently observed in Google Cloud.
