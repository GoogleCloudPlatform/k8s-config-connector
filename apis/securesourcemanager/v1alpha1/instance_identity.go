...
// InstanceIdentity defines the resource reference to SecuresourcemanagerInstance, which "External" field
...
func NewInstanceIdentity(ctx context.Context, reader client.Reader, obj *SecuresourcemanagerInstance) (*InstanceIdentity, error) {
