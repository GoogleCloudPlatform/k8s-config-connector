...
// +kcc:proto=google.cloud.retail.v2.AttributesConfig
type AttributesConfig struct {
	// Required. Immutable. The fully qualified resource name of the attribute
	//  config. Format: `projects/*/locations/*/catalogs/*/attributesConfig`
	// +kcc:proto:field=google.cloud.retail.v2.AttributesConfig.name
...
// +kcc:proto=google.cloud.retail.v2.CatalogAttribute
type CatalogAttribute struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.key
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.indexable_option
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.dynamic_facetable_option
	...
	//  [AttributesConfig.attribute_config_level][google.cloud.retail.v2.AttributesConfig.attribute_config_level]
	//  is CATALOG_LEVEL_ATTRIBUTE_CONFIG, otherwise throws INVALID_FORMAT error.
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.searchable_option
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.exact_searchable_option
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.retrievable_option
	RetrievableOption *string `json:"retrievableOption,omitempty"`

	// Contains facet options.
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.facet_config
	FacetConfig *CatalogAttribute_FacetConfig `json:"facetConfig,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2.CatalogAttribute.FacetConfig
type CatalogAttribute_FacetConfig struct {
	...
	//  bound.
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.facet_intervals
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.ignored_facet_values
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.merged_facet_values
	...
	//  key.
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.merged_facet
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.rerank_config
	RerankConfig *CatalogAttribute_FacetConfig_RerankConfig `json:"rerankConfig,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2.CatalogAttribute.FacetConfig.IgnoredFacetValues
type CatalogAttribute_FacetConfig_IgnoredFacetValues struct {
	...
	//  128 characters.
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.IgnoredFacetValues.values
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.IgnoredFacetValues.start_time
	StartTime *string `json:"startTime,omitempty"`

	// If start time is empty and end time is not empty, then ignore these
	//  facet values before end time.
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.IgnoredFacetValues.end_time
	EndTime *string `json:"endTime,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2.CatalogAttribute.FacetConfig.MergedFacet
type CatalogAttribute_FacetConfig_MergedFacet struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.MergedFacet.merged_facet_key
	MergedFacetKey *string `json:"mergedFacetKey,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2.CatalogAttribute.FacetConfig.MergedFacetValue
type CatalogAttribute_FacetConfig_MergedFacetValue struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.MergedFacetValue.values
	Values []string `json:"values,omitempty"`
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.MergedFacetValue.merged_value
	MergedValue *string `json:"mergedValue,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2.CatalogAttribute.FacetConfig.RerankConfig
type CatalogAttribute_FacetConfig_RerankConfig struct {
	...
	//  serving.
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.RerankConfig.rerank_facet
	...
	// +kcc:proto:field=google.cloud.retail.v2.CatalogAttribute.FacetConfig.RerankConfig.facet_values
...
type AttributesConfigObservedState struct {
	...
	//  for this catalog.
	// +kcc:proto:field=google.cloud.retail.v2.AttributesConfig.attribute_config_level
