...
// +kcc:proto=google.cloud.retail.v2beta.Audience
type Audience struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Audience.genders
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Audience.age_groups
	AgeGroups []string `json:"ageGroups,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.ColorInfo
type ColorInfo struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.ColorInfo.color_families
	...
	//  [color](https://support.google.com/merchants/answer/6324487). Schema.org
	//  property [Product.color](https://schema.org/color).
	// +kcc:proto:field=google.cloud.retail.v2beta.ColorInfo.colors
	Colors []string `json:"colors,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.CustomAttribute
type CustomAttribute struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.CustomAttribute.text
	...
	//  [numbers][google.cloud.retail.v2beta.CustomAttribute.numbers] should be
	//  set. Otherwise, an INVALID_ARGUMENT error is returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.CustomAttribute.numbers
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.CustomAttribute.searchable
	...
	//  for more details.
	// +kcc:proto:field=google.cloud.retail.v2beta.CustomAttribute.indexable
	Indexable *bool `json:"indexable,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.FulfillmentInfo
type FulfillmentInfo struct {
	...
	//  INVALID_ARGUMENT error is returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.FulfillmentInfo.type
	...
	//  returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.FulfillmentInfo.place_ids
	PlaceIds []string `json:"placeIds,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.Image
type Image struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Image.uri
	...
	//  returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.Image.height
	...
	//  This field must be nonnegative. Otherwise, an INVALID_ARGUMENT error is
	//  returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.Image.width
...
// +kcc:proto=google.cloud.retail.v2beta.LocalInventory
type LocalInventory struct {
	// The place ID for the current set of inventory information.
	// +kcc:proto:field=google.cloud.retail.v2beta.LocalInventory.place_id
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.LocalInventory.price_info
	...
	//  returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.LocalInventory.fulfillment_types
	FulfillmentTypes []string `json:"fulfillmentTypes,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.PriceInfo
type PriceInfo struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.currency_code
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.price
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.original_price
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.cost
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.price_effective_time
	...
	//  Do not set if [price][google.cloud.retail.v2beta.PriceInfo.price] is always
	//  effective because it will cause additional latency during search.
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.price_expire_time
	PriceExpireTime *string `json:"priceExpireTime,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.PriceInfo.PriceRange
type PriceInfo_PriceRange struct {
	...
	//  [Product.primary_product_id][google.cloud.retail.v2beta.Product.primary_product_id].
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.PriceRange.price
	...
	//  [Product][google.cloud.retail.v2beta.Product] having the same
	//  [Product.primary_product_id][google.cloud.retail.v2beta.Product.primary_product_id].
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.PriceRange.original_price
	OriginalPrice *Interval `json:"originalPrice,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.Product
type Product struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.expire_time
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.ttl
	Ttl *string `json:"ttl,omitempty"`

	// Immutable. Full resource name of the product, such as
	//  `projects/*/locations/global/catalogs/default_catalog/branches/default_branch/products/product_id`.
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.name
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.id
	...
	//  if unset.
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.type
	Type *string `json:"type,omitempty"`
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.primary_product_id
	...
	//  return.
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.collection_member_ids
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.gtin
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.categories
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.title
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.brands
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.description
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.language_code
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.tags
	...
	//  Corresponding properties: Google Merchant Center property
	//  [price](https://support.google.com/merchants/answer/6324371).
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.price_info
	PriceInfo *PriceInfo `json:"priceInfo,omitempty"`

	// The rating of this product.
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.rating
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.available_time
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.availability
	Availability *string `json:"availability,omitempty"`

	// The available quantity of the item.
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.available_quantity
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.fulfillment_info
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.uri
	URI *string `json:"uri,omitempty"`
	...
	//  [image_link](https://support.google.com/merchants/answer/6324350).
	//  Schema.org property [Product.image](https://schema.org/image).
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.images
	Images []Image `json:"images,omitempty"`

	// The target group associated with a given audience (e.g. male, veterans,
	//  car owners, musicians, etc.) of the product.
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.audience
	...
	//  [color](https://support.google.com/merchants/answer/6324487). Schema.org
	//  property [Product.color](https://schema.org/color).
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.color_info
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.sizes
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.materials
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.patterns
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.conditions
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.promotions
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.publish_time
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.retrievable_fields
	RetrievableFields *FieldMask `json:"retrievableFields,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.Promotion
type Promotion struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Promotion.promotion_id
	PromotionID *string `json:"promotionID,omitempty"`
}

// +kcc:proto=google.cloud.retail.v2beta.Rating
type Rating struct {
	...
	//  returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.Rating.rating_count
	...
	//  returned.
	// +kcc:proto:field=google.cloud.retail.v2beta.Rating.average_rating
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Rating.rating_histogram
...
type PriceInfoObservedState struct {
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.PriceInfo.price_range
...
type ProductObservedState struct {
	...
	//  [ProductService.GetProduct][google.cloud.retail.v2beta.ProductService.GetProduct].
	//  Do not set this field in API requests.
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.variants
	...
	// +kcc:proto:field=google.cloud.retail.v2beta.Product.local_inventories
