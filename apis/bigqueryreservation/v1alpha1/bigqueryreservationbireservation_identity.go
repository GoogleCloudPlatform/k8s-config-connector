...
func (i *BigQueryReservationBiReservationIdentity) ParentString() string {
...
func (obj *BigQueryReservationBiReservation) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	...
	if externalRef != "" {
		...
		if statusIdentity.Location != specIdentity.Location {
			return nil, fmt.Errorf("spec.location changed, expect %s, got %s", statusIdentity.Location, specIdentity.Location)
		}
	}
...
func getIdentityFromBigQueryReservationBiReservationSpec(ctx context.Context, reader client.Reader, obj *BigQueryReservationBiReservation) (*BigQueryReservationBiReservationIdentity, error) {
	...
	return &BigQueryReservationBiReservationIdentity{
		Project:  projectID,
		Location: location,
	}, nil
}
