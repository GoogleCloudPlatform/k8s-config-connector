...
func getIdentityFromBigQueryReservationReservationGroupSpec(ctx context.Context, reader client.Reader, obj client.Object) (*BigQueryReservationReservationGroupIdentity, error) {
