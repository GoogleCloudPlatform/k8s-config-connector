...
func init() {
	refs.Register(&BigQueryReservationReservationGroupRef{}, &BigQueryReservationReservationGroup{})
}
...
func (r *BigQueryReservationReservationGroupRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &BigQueryReservationReservationGroupIdentity{}
...
func (r *BigQueryReservationReservationGroupRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		obj, err := common.ToStructuredType[*BigQueryReservationReservationGroup](u)
		if err != nil {
			return ""
		}
		identity, err := getIdentityFromBigQueryReservationReservationGroupSpec(ctx, reader, obj)
		if err != nil {
			return ""
		}
