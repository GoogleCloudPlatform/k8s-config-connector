...
// BigQueryReservationReservationGroupRef defines the resource reference to BigQueryReservationReservationGroup, which "External" field
...
func (r *BigQueryReservationReservationGroupRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromBigQueryReservationReservationGroupSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
