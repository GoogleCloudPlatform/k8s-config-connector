...
type Assignment struct {
	...
	// +kcc:proto:field=google.cloud.bigquery.reservation.v1.Assignment.principal
	...
	// +kcc:proto:field=google.cloud.bigquery.reservation.v1.Assignment.precedence
	...
	// +kcc:proto:field=google.cloud.bigquery.reservation.v1.Assignment.condition
...
/* found existing non-generated go type with proto tag "google.cloud.bigquery.reservation.v1.SchedulingPolicy", skipping
...
type ReservationObservedState struct {
	...
	// +kcc:proto:field=google.cloud.bigquery.reservation.v1.Reservation.reservation_group_path
