...
func (in *BigQueryReservationReservationSpec) DeepCopyInto(out *BigQueryReservationReservationSpec) {
	*out = *in
	...
	if in.ReservationGroupRef != nil {
		in, out := &in.ReservationGroupRef, &out.ReservationGroupRef
		*out = new(ReservationGroupRef)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReservationGroupParent) DeepCopyInto(out *ReservationGroupParent) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReservationGroupParent.
func (in *ReservationGroupParent) DeepCopy() *ReservationGroupParent {
	if in == nil {
		return nil
	}
	out := new(ReservationGroupParent)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReservationGroupRef) DeepCopyInto(out *ReservationGroupRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReservationGroupRef.
func (in *ReservationGroupRef) DeepCopy() *ReservationGroupRef {
	if in == nil {
		return nil
	}
	out := new(ReservationGroupRef)
