...
type StorageFolderStatus struct {
	...
	// A unique specifier for the StorageFolder resource in Google Cloud.
...
// StorageFolderObservedState is the state of the StorageFolder resource as most recently observed in Google Cloud.
