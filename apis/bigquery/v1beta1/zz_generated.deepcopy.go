...
func (in *BigQueryDatasetObservedState) DeepCopyInto(out *BigQueryDatasetObservedState) {
	*out = *in
	...
	if in.Replicas != nil {
		...
		*out = make([]DatasetObservedReplica, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatasetObservedReplica) DeepCopyInto(out *DatasetObservedReplica) {
	*out = *in
	if in.ID != nil {
		in, out := &in.ID, &out.ID
		*out = new(string)
	...
	if in.SyncStatus != nil {
		...
		*out = make([]DatasetSyncStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatasetObservedReplica.
func (in *DatasetObservedReplica) DeepCopy() *DatasetObservedReplica {
	if in == nil {
		return nil
	}
	out := new(DatasetObservedReplica)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DatasetSyncStatus) DeepCopyInto(out *DatasetSyncStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DatasetSyncStatus.
func (in *DatasetSyncStatus) DeepCopy() *DatasetSyncStatus {
	if in == nil {
		return nil
	}
	out := new(DatasetSyncStatus)
	in.DeepCopyInto(out)
	return out
}
