...
func TestBigQueryTableRef_ValidateExternal(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			external: "projects/my-project/datasets/my-dataset/tables/my-table",
			wantErr:  false,
		},
		{
		...
		},
		{
			...
			external: "datasets/my-dataset/tables/my-table",
			wantErr:  true,
		},
		{
			name:     "missing dataset",
			external: "projects/my-project/tables/my-table",
			wantErr:  true,
		},
		{
