...
var _ v1beta1.Ref = &BigQueryDatasetAccessRef{}

// BigQueryDatasetAccessRef is a reference to a BigQueryDatasetAccess resource.
type BigQueryDatasetAccessRef struct {
	// A reference to an externally managed BigQueryDatasetAccess resource.
	// Should be in the format "projects/{project}/datasets/{dataset}/access/{accessID}".
...
func init() {
	v1beta1.Register(&BigQueryDatasetAccessRef{})
}
...
func (r *BigQueryDatasetAccessRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	...
	return v1beta1.NormalizeWithFallback(ctx, reader, r, defaultNamespace, fallback)
}
