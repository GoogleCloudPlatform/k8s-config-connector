...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TasksQueueRef) DeepCopyInto(out *TasksQueueRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TasksQueueRef.
func (in *TasksQueueRef) DeepCopy() *TasksQueueRef {
	if in == nil {
		return nil
	}
	out := new(TasksQueueRef)
	in.DeepCopyInto(out)
	return out
}
