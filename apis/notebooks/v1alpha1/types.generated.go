...
// +kcc:proto=google.cloud.notebooks.v1beta1.Environment
type Environment struct {

	// Display name of this environment for the UI.
	// +kcc:proto:field=google.cloud.notebooks.v1beta1.Environment.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// A brief description of this environment.
	// +kcc:proto:field=google.cloud.notebooks.v1beta1.Environment.description
	Description *string `json:"description,omitempty"`

	// Use a Compute Engine VM image to start the notebook instance.
	// +kcc:proto:field=google.cloud.notebooks.v1beta1.Environment.vm_image
	VmImage *VmImage `json:"vmImage,omitempty"`

	// Use a container image to start the notebook instance.
	// +kcc:proto:field=google.cloud.notebooks.v1beta1.Environment.container_image
	ContainerImage *ContainerImage `json:"containerImage,omitempty"`

	// Path to a Bash script that automatically runs after a notebook instance
	//  fully boots up. The path must be a URL or
	//  Cloud Storage path. Example: `"gs://path-to-file/file-name"`
	// +kcc:proto:field=google.cloud.notebooks.v1beta1.Environment.post_startup_script
...
type EnvironmentObservedState struct {
	...
	// +kcc:proto:field=google.cloud.notebooks.v1beta1.Environment.name
	Name *string `json:"name,omitempty"`

	// Output only. The time at which this environment was created.
	// +kcc:proto:field=google.cloud.notebooks.v1beta1.Environment.create_time
