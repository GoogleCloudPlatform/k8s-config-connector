...
type NotebooksEnvironmentStatus struct {
	...
	// A unique specifier for the NotebooksEnvironment resource in Google Cloud.
...
// NotebooksEnvironmentObservedState is the state of the NotebooksEnvironment resource as most recently observed in Google Cloud.
