...
var (
	_ identity.ServerGeneratedIdentity = &SQLAdminBackupIdentity{}
...
// SQLAdminBackupIdentity is the identity of a GCP SQLAdminBackup resource.
...
func (i *SQLAdminBackupIdentity) HasIdentitySpecified() bool {
	return i.Backup != ""
}
...
func (i *SQLAdminBackupIdentity) ParentString() string {
...
func getIdentityFromSQLAdminBackupSpec(ctx context.Context, reader client.Reader, obj *SQLAdminBackup) (*SQLAdminBackupIdentity, error) {
	// For SQLAdminBackup, resourceID is optional and can be empty.
...
func (obj *SQLAdminBackup) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	...
	if externalRef != "" {
		...
		if specIdentity.Backup == "" {
			specIdentity.Backup = statusIdentity.Backup
		}
