...
func TestFinancialServicesInstanceIdentity_FromExternal(t *testing.T) {
	tests := []struct {
		name    string
		ref     string
		wantErr bool
		want    *FinancialServicesInstanceIdentity
	}{
		{
		...
		{
			name: "full url",
			ref:  "https://financialservices.googleapis.com/projects/my-project/locations/us-central1/instances/my-instance",
			want: &FinancialServicesInstanceIdentity{
				Project:  "my-project",
				Location: "us-central1",
				Instance: "my-instance",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			i := &FinancialServicesInstanceIdentity{}
