...
// ServerGeneratedType is a marker interface for identities that can be generated by the server.
type ServerGeneratedType interface {
	Identity
	// Marker function for server-generated identities.
