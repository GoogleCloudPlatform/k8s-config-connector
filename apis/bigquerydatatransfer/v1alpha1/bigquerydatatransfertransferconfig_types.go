...
var BigQueryDataTransferTransferConfigGVK = GroupVersion.WithKind("BigQueryDataTransferTransferConfig")
...
// BigQueryDataTransferTransferConfigSpec defines the desired state of BigQueryDataTransferTransferConfig
// +kcc:spec:proto=google.cloud.bigquery.datatransfer.v1.TransferConfig
type BigQueryDataTransferTransferConfigSpec struct {
...
type BigQueryDataTransferTransferConfigStatus struct {
	...
	// A unique specifier for the BigQueryDataTransferTransferConfig resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *BigQueryDataTransferTransferConfigObservedState `json:"observedState,omitempty"`
}
...
// +kubebuilder:resource:categories=gcp,shortName=gcpbigquerydatatransfertransferconfig;gcpbigquerydatatransfertransferconfigs
...
// BigQueryDataTransferTransferConfig is the Schema for the BigQueryDataTransferTransferConfig API
// +k8s:openapi-gen=true
type BigQueryDataTransferTransferConfig struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	// +required
	Spec   BigQueryDataTransferTransferConfigSpec   `json:"spec,omitempty"`
	Status BigQueryDataTransferTransferConfigStatus `json:"status,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// BigQueryDataTransferTransferConfigList contains a list of BigQueryDataTransferTransferConfig
type BigQueryDataTransferTransferConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BigQueryDataTransferTransferConfig `json:"items"`
}
