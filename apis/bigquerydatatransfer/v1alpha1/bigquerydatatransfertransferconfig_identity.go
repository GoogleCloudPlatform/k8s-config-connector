...
var BigQueryDataTransferTransferConfigIdentityFormat = gcpurls.Template[BigQueryDataTransferTransferConfigIdentity]("bigquerydatatransfer.googleapis.com", "projects/{project}/locations/{location}/transferConfigs/{transferConfig}")
