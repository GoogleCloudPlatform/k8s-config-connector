...
type GoogleAPISource struct {
	...
	// +kcc:proto:field=google.cloud.eventarc.v1.GoogleApiSource.organization_subscription
	OrganizationSubscription *GoogleAPISource_OrganizationSubscription `json:"organizationSubscription,omitempty"`
	...
	// +kcc:proto:field=google.cloud.eventarc.v1.GoogleApiSource.project_subscriptions
	ProjectSubscriptions *GoogleAPISource_ProjectSubscriptions `json:"projectSubscriptions,omitempty"`
}
*/

/* unreachable type GoogleAPISource_OrganizationSubscription
// +kcc:proto=google.cloud.eventarc.v1.GoogleApiSource.OrganizationSubscription
type GoogleAPISource_OrganizationSubscription struct {
	// Required. Enable org level subscription.
	// +kcc:proto:field=google.cloud.eventarc.v1.GoogleApiSource.OrganizationSubscription.enabled
	Enabled *bool `json:"enabled,omitempty"`
}
*/

/* unreachable type GoogleAPISource_ProjectSubscriptions
// +kcc:proto=google.cloud.eventarc.v1.GoogleApiSource.ProjectSubscriptions
type GoogleAPISource_ProjectSubscriptions struct {
	...
	// +kcc:proto:field=google.cloud.eventarc.v1.GoogleApiSource.ProjectSubscriptions.list
