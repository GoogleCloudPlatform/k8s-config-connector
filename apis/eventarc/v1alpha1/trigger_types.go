...
var EventarcTriggerGVK = GroupVersion.WithKind("EventarcTrigger")
...
type EventarcTriggerSpec struct {
	// The EventarcTrigger name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// EventarcTriggerStatus defines the config connector machine state of EventarcTrigger
type EventarcTriggerStatus struct {
	...
	// A unique specifier for the EventarcTrigger resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *EventarcTriggerObservedState `json:"observedState,omitempty"`
}

// EventarcTriggerObservedState is the state of the EventarcTrigger resource as most recently observed in GCP.
// +kcc:proto=google.cloud.eventarc.v1.Trigger
type EventarcTriggerObservedState struct {
}
...
// EventarcTrigger is the Schema for the EventarcTrigger API
