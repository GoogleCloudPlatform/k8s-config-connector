...
# Format files
go run golang.org/x/tools/cmd/goimports@v0.29.0 -w  pkg/controller/direct/privateca/
go run golang.org/x/tools/cmd/goimports@v0.29.0 -w  apis/privateca/v1beta1/