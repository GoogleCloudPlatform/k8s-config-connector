...
# Format files
go run -mod=readonly golang.org/x/tools/cmd/goimports@v0.29.0 -w  pkg/controller/direct/privateca/
go run -mod=readonly golang.org/x/tools/cmd/goimports@v0.29.0 -w  apis/privateca/v1beta1/