...
type GKEHubScopeSpec struct {
	...
	/* Immutable. The location of the scope */
	// +optional
...
type GKEHubScopeStatus struct {
	...
	/* Output only. Time the scope was created. */
	// +optional
	CreateTime *string `json:"createTime,omitempty"`

	/* Output only. Time the scope was last updated. */
	// +optional
	UpdateTime *string `json:"updateTime,omitempty"`

	/* Output only. Time the scope was deleted. */
	// +optional
...
type ScopeLifecycleStateStatus struct {
	/* Output only. Code describes the current state of the scope. Possible values: CODE_UNSPECIFIED, CREATING, READY, DELETING, UPDATING */
	// +optional
