...
// +kcc:proto=google.cloud.gkehub.v1.Authority
type Authority struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.Authority.issuer
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.Authority.oidc_jwks
	OidcJwks []byte `json:"oidcJwks,omitempty"`
}

// +kcc:proto=google.cloud.gkehub.v1.GkeCluster
type GkeCluster struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.GkeCluster.resource_link
	ResourceLink *string `json:"resourceLink,omitempty"`
}

// +kcc:proto=google.cloud.gkehub.v1.KubernetesMetadata
type KubernetesMetadata struct {
}

// +kcc:proto=google.cloud.gkehub.v1.KubernetesResource
type KubernetesResource struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesResource.membership_cr_manifest
	MembershipCrManifest *string `json:"membershipCrManifest,omitempty"`

	// Optional. Options for Kubernetes resource generation.
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesResource.resource_options
	ResourceOptions *ResourceOptions `json:"resourceOptions,omitempty"`
}

// +kcc:proto=google.cloud.gkehub.v1.Membership
type Membership struct {
	// Optional. Endpoint information to reach this member.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.endpoint
	Endpoint *MembershipEndpoint `json:"endpoint,omitempty"`

	// Optional. Labels for this membership.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.labels
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.external_id
	ExternalID *string `json:"externalID,omitempty"`

	// Optional. How to identify workloads from this Membership.
	//  See the documentation on Workload Identity for more details:
	//  https://cloud.google.com/kubernetes-engine/docs/how-to/workload-identity
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.authority
	Authority *Authority `json:"authority,omitempty"`

	// Optional. The monitoring config information for this membership.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.monitoring_config
	MonitoringConfig *MonitoringConfig `json:"monitoringConfig,omitempty"`
}

// +kcc:proto=google.cloud.gkehub.v1.MembershipEndpoint
type MembershipEndpoint struct {
	// Optional. GKE-specific information. Only present if this Membership is a GKE cluster.
	// +kcc:proto:field=google.cloud.gkehub.v1.MembershipEndpoint.gke_cluster
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.MembershipEndpoint.kubernetes_resource
	KubernetesResource *KubernetesResource `json:"kubernetesResource,omitempty"`
}

// +kcc:proto=google.cloud.gkehub.v1.MembershipState
type MembershipState struct {
}

// +kcc:proto=google.cloud.gkehub.v1.MonitoringConfig
type MonitoringConfig struct {
	// Immutable. Project used to report Metrics
	// +kcc:proto:field=google.cloud.gkehub.v1.MonitoringConfig.project_id
	ProjectID *string `json:"projectID,omitempty"`

	// Immutable. Location used to report Metrics
	// +kcc:proto:field=google.cloud.gkehub.v1.MonitoringConfig.location
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.MonitoringConfig.cluster
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.MonitoringConfig.kubernetes_metrics_prefix
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.MonitoringConfig.cluster_hash
	ClusterHash *string `json:"clusterHash,omitempty"`
}

// +kcc:proto=google.cloud.gkehub.v1.ResourceManifest
type ResourceManifest struct {
	// YAML manifest of the resource.
	// +kcc:proto:field=google.cloud.gkehub.v1.ResourceManifest.manifest
	...
	//  cluster.
	// +kcc:proto:field=google.cloud.gkehub.v1.ResourceManifest.cluster_scoped
	ClusterScoped *bool `json:"clusterScoped,omitempty"`
}

// +kcc:proto=google.cloud.gkehub.v1.ResourceOptions
type ResourceOptions struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.ResourceOptions.connect_version
	...
	//  <1.16.
	// +kcc:proto:field=google.cloud.gkehub.v1.ResourceOptions.v1beta1_crd
	V1beta1Crd *bool `json:"v1beta1Crd,omitempty"`

	// Optional. Major version of the Kubernetes cluster. This is only used to
	//  determine which version to use for the CustomResourceDefinition resources,
	//  `apiextensions/v1beta1` or`apiextensions/v1`.
	// +kcc:proto:field=google.cloud.gkehub.v1.ResourceOptions.k8s_version
...
type AuthorityObservedState struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.Authority.workload_identity_pool
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.Authority.identity_provider
...
type GkeClusterObservedState struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.GkeCluster.cluster_missing
...
type KubernetesMetadataObservedState struct {
	...
	//  `/version`.
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesMetadata.kubernetes_api_server_version
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesMetadata.node_provider_id
	NodeProviderID *string `json:"nodeProviderID,omitempty"`

	// Output only. Node count as reported by Kubernetes nodes resources.
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesMetadata.node_count
	NodeCount *int32 `json:"nodeCount,omitempty"`

	// Output only. vCPU count as reported by Kubernetes nodes resources.
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesMetadata.vcpu_count
	VcpuCount *int32 `json:"vcpuCount,omitempty"`

	// Output only. The total memory capacity as reported by the sum of all
	//  Kubernetes nodes resources, defined in MB.
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesMetadata.memory_mb
	MemoryMb *int32 `json:"memoryMb,omitempty"`

	// Output only. The time at which these details were last updated. This
	//  update_time is different from the Membership-level update_time since
	//  EndpointDetails are updated internally for API consumers.
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesMetadata.update_time
...
type KubernetesResourceObservedState struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesResource.membership_resources
	...
	//  the resource manifest after the initial registration, the caller should
	//  make a UpdateMembership call with an empty field mask.
	// +kcc:proto:field=google.cloud.gkehub.v1.KubernetesResource.connect_resources
...
type MembershipObservedState struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.name
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.description
	Description *string `json:"description,omitempty"`

	// Output only. State of the Membership resource.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.state
	State *MembershipState `json:"state,omitempty"`

	// Output only. When the Membership was created.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. When the Membership was last updated.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.update_time
	UpdateTime *string `json:"updateTime,omitempty"`

	// Output only. When the Membership was deleted.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.delete_time
	...
	//  unset.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.last_connection_time
	LastConnectionTime *string `json:"lastConnectionTime,omitempty"`

	// Output only. Google-generated UUID for this resource. This is unique across
	//  all Membership resources. If a Membership resource is deleted and another
	//  resource with the same name is created, it gets a different unique_id.
	// +kcc:proto:field=google.cloud.gkehub.v1.Membership.unique_id
...
type MembershipEndpointObservedState struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.MembershipEndpoint.kubernetes_metadata
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.MembershipEndpoint.google_managed
...
type MembershipStateObservedState struct {
	...
	// +kcc:proto:field=google.cloud.gkehub.v1.MembershipState.code
