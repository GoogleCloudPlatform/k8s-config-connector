...
func TestGKEHubFleetIdentity_FromExternal(t *testing.T) {
	tests := []struct {
		name     string
		external string
		want     *GKEHubFleetIdentity
		wantErr  bool
	}{
		{
			name:     "canonical format",
			external: "projects/my-project/locations/global/fleets/my-fleet",
			want: &GKEHubFleetIdentity{
				Project:  "my-project",
				Location: "global",
				Fleet:    "my-fleet",
