...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *APIKeysKeyRef) DeepCopyInto(out *APIKeysKeyRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APIKeysKeyRef.
func (in *APIKeysKeyRef) DeepCopy() *APIKeysKeyRef {
	if in == nil {
		return nil
	}
	out := new(APIKeysKeyRef)
	in.DeepCopyInto(out)
	return out
}
