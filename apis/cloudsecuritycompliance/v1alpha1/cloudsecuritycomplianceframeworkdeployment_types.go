...
type CloudSecurityComplianceFrameworkDeploymentSpec struct {
	...
	// Required. TargetResourceConfig referencing either an already existing
	...
	FrameworkRef *CloudSecurityComplianceFrameworkRef `json:"frameworkRef"`
...
// CloudControlObservedState is the state of the CloudControl as observed in GCP, mapped from the skipped generated type.
