...
var DatafusionInstanceGVK = GroupVersion.WithKind("DatafusionInstance")
...
type DatafusionInstanceSpec struct {
	// The DatafusionInstance name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// DatafusionInstanceStatus defines the config connector machine state of DatafusionInstance
type DatafusionInstanceStatus struct {
	...
	// A unique specifier for the DatafusionInstance resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *DatafusionInstanceObservedState `json:"observedState,omitempty"`
}

// DatafusionInstanceObservedState is the state of the DatafusionInstance resource as most recently observed in GCP.
// +kcc:proto=google.cloud.datafusion.v1.Instance
type DatafusionInstanceObservedState struct {
}
...
// DatafusionInstance is the Schema for the DatafusionInstance API
