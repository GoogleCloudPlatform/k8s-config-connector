...
type ServicedirectoryEndpointSpec struct {
	// The ServicedirectoryEndpoint name. If not given, the metadata.name will be used.
...
type ServicedirectoryEndpointStatus struct {
	...
	// A unique specifier for the ServicedirectoryEndpoint resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *ServicedirectoryEndpointObservedState `json:"observedState,omitempty"`
}
