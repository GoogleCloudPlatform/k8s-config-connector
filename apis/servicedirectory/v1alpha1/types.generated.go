...
type Service struct {
	...
	// +kcc:proto:field=google.cloud.servicedirectory.v1.Service.name
	Name *string `json:"name,omitempty"`
	...
	//  They have the same syntax and read/write to the same location in Service
	//  Directory.
	// +kcc:proto:field=google.cloud.servicedirectory.v1.Service.annotations
	Annotations map[string]string `json:"annotations,omitempty"`
}
...
type ServiceObservedState struct {
	...
	// +kcc:proto:field=google.cloud.servicedirectory.v1.Service.endpoints
	Endpoints []Endpoint `json:"endpoints,omitempty"`

	// Output only. The globally unique identifier of the service in the UUID4
	//  format.
	// +kcc:proto:field=google.cloud.servicedirectory.v1.Service.uid
	Uid *string `json:"uid,omitempty"`
}
