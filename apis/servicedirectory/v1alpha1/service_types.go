...
// +kcc:proto=google.cloud.servicedirectory.v1.Service
type ServicedirectoryServiceSpec struct {
	// The ServicedirectoryService name. If not given, the metadata.name will be used.
...
type ServicedirectoryServiceStatus struct {
	...
	// A unique specifier for the ServicedirectoryService resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *ServicedirectoryServiceObservedState `json:"observedState,omitempty"`
}
