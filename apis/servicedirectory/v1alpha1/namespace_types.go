...
type ServicedirectoryNamespaceSpec struct {
	// The ServicedirectoryNamespace name. If not given, the metadata.name will be used.
...
type ServicedirectoryNamespaceStatus struct {
	...
	// A unique specifier for the ServicedirectoryNamespace resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *ServicedirectoryNamespaceObservedState `json:"observedState,omitempty"`
}
