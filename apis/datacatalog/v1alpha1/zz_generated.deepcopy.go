...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EntryObservedState) DeepCopyInto(out *EntryObservedState) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EntryObservedState.
func (in *EntryObservedState) DeepCopy() *EntryObservedState {
	if in == nil {
		return nil
	}
	out := new(EntryObservedState)
	in.DeepCopyInto(out)
	return out
}
