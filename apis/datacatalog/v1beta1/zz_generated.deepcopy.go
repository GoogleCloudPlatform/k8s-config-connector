...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PolicyTagObservedState) DeepCopyInto(out *PolicyTagObservedState) {
	*out = *in
	if in.ChildPolicyTags != nil {
		in, out := &in.ChildPolicyTags, &out.ChildPolicyTags
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicyTagObservedState.
func (in *PolicyTagObservedState) DeepCopy() *PolicyTagObservedState {
	if in == nil {
		return nil
	}
	out := new(PolicyTagObservedState)
	in.DeepCopyInto(out)
	return out
}
