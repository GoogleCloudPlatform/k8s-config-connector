...
type MemorystoreInstanceBackupSpec struct {
	// Optional. The backup collection that this backup belongs to.
	BackupCollectionExternal *string `json:"backupCollectionExternal,omitempty"`

	// Optional. The ref to the memorystore instance that this backup will be created from.
