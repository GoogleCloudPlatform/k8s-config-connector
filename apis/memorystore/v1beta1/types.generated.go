...
/* unreachable type MigrationConfig
// +kcc:proto=google.cloud.memorystore.v1.MigrationConfig
...
/* unreachable type SelfManagedSource
// +kcc:proto=google.cloud.memorystore.v1.SelfManagedSource
type SelfManagedSource struct {
	...
	// +kcc:proto:field=google.cloud.memorystore.v1.SelfManagedSource.ip_address
	IPAddress *string `json:"ipAddress,omitempty"`
	...
	// +kcc:proto:field=google.cloud.memorystore.v1.SelfManagedSource.port
	Port *int32 `json:"port,omitempty"`
	...
	// +kcc:proto:field=google.cloud.memorystore.v1.SelfManagedSource.network_attachment
...
type InstanceObservedState struct {
	...
	// +kcc:proto:field=google.cloud.memorystore.v1.Instance.migration_config
	MigrationConfig *MigrationConfigObservedState `json:"migrationConfig,omitempty"`
}
*/
...
/* unreachable type MigrationConfigObservedState
// +kcc:observedstate:proto=google.cloud.memorystore.v1.MigrationConfig
type MigrationConfigObservedState struct {
	// Output only. Configuration for migrating from a self-managed Valkey/Redis
	//  instance
	// +kcc:proto:field=google.cloud.memorystore.v1.MigrationConfig.self_managed_source
	SelfManagedSource *SelfManagedSource `json:"selfManagedSource,omitempty"`

	// Output only. Migration state of the instance.
	// +kcc:proto:field=google.cloud.memorystore.v1.MigrationConfig.state
	State *string `json:"state,omitempty"`
	...
	// +kcc:proto:field=google.cloud.memorystore.v1.MigrationConfig.force_finish_migration
	ForceFinishMigration *bool `json:"forceFinishMigration,omitempty"`
}
*/
