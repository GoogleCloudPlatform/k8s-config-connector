...
import (
	...
	"github.com/GoogleCloudPlatform/k8s-config-connector/apis/memorystore/v1alpha1"
...
func (in *MemorystoreInstanceSpec) DeepCopyInto(out *MemorystoreInstanceSpec) {
	*out = *in
	...
	if in.GcsBackupSource != nil {
		in, out := &in.GcsBackupSource, &out.GcsBackupSource
		*out = new(Instance_GCSBackupSource)
		(*in).DeepCopyInto(*out)
	}
