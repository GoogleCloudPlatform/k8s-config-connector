...
type MemorystoreInstanceSpec struct {
	...
	// Optional. This field can be used to trigger self service update to indicate the
...
type MemorystoreInstanceObservedState struct {
	...
	// Output only. This field is used to determine the available maintenance versions for the
	//  self service update.
	// +kcc:proto:field=google.cloud.memorystore.v1.Instance.effective_maintenance_version
	AvailableMaintenanceVersions []string `json:"available_maintenance_versions,omitempty"`
}
