...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Instance_ConnectionDetailSpec) DeepCopyInto(out *Instance_ConnectionDetailSpec) {
	*out = *in
	if in.PSCAutoConnectionSpec != nil {
		in, out := &in.PSCAutoConnectionSpec, &out.PSCAutoConnectionSpec
		*out = new(PSCAutoConnectionSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.PSCConnectionSpec != nil {
		in, out := &in.PSCConnectionSpec, &out.PSCConnectionSpec
		*out = new(PSCConnectionSpec)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Instance_ConnectionDetailSpec.
func (in *Instance_ConnectionDetailSpec) DeepCopy() *Instance_ConnectionDetailSpec {
	if in == nil {
		return nil
	}
	out := new(Instance_ConnectionDetailSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Instance_InstanceEndpointSpec) DeepCopyInto(out *Instance_InstanceEndpointSpec) {
	*out = *in
	if in.Connections != nil {
		in, out := &in.Connections, &out.Connections
		*out = make([]Instance_ConnectionDetailSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Instance_InstanceEndpointSpec.
func (in *Instance_InstanceEndpointSpec) DeepCopy() *Instance_InstanceEndpointSpec {
	if in == nil {
		return nil
	}
	out := new(Instance_InstanceEndpointSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MemorystoreInstanceSpec) DeepCopyInto(out *MemorystoreInstanceSpec) {
	*out = *in
	...
	if in.Endpoints != nil {
		in, out := &in.Endpoints, &out.Endpoints
		*out = make([]Instance_InstanceEndpointSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PSCConnectionSpec) DeepCopyInto(out *PSCConnectionSpec) {
	*out = *in
	if in.IPAddress != nil {
		in, out := &in.IPAddress, &out.IPAddress
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PSCConnectionSpec.
func (in *PSCConnectionSpec) DeepCopy() *PSCConnectionSpec {
	if in == nil {
		return nil
	}
	out := new(PSCConnectionSpec)
