...
type MemorystoreInstanceBackupObservedState struct {
	...
	// Output only. Node type of the instance. For valid values,
	//  see https://docs.cloud.google.com/memorystore/docs/valkey/reference/rest/v1/NodeType
	...
	// Output only. Type of the backup. For valid values,
