...
// +kcc:proto=google.cloud.securityposture.v1.PostureTemplate
...
// +kcc:proto=google.cloud.securityposture.v1.PostureTemplate
type PostureTemplateObservedState struct {
	...
	// +kcc:proto:field=google.cloud.securityposture.v1.PostureTemplate.name
	Name *string `json:"name,omitempty"`

	// Output only. The revision_id of a PostureTemplate.
	// +kcc:proto:field=google.cloud.securityposture.v1.PostureTemplate.revision_id
	RevisionID *string `json:"revisionID,omitempty"`

	// Output only. Description of the Posture template.
	// +kcc:proto:field=google.cloud.securityposture.v1.PostureTemplate.description
	Description *string `json:"description,omitempty"`

	// Output only. State of PostureTemplate resource.
	// +kcc:proto:field=google.cloud.securityposture.v1.PostureTemplate.state
	State *string `json:"state,omitempty"`

	// Output only. Policy_sets to be used by the user.
	// +kcc:proto:field=google.cloud.securityposture.v1.PostureTemplate.policy_sets
