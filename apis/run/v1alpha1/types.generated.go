...
type Service struct {
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.name
	Name *string `json:"name,omitempty"`

	// User-provided description of the Service. This field currently has a
	//  512-character limit.
	// +kcc:proto:field=google.cloud.run.v2.Service.description
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.labels
	Labels map[string]string `json:"labels,omitempty"`
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.annotations
	Annotations map[string]string `json:"annotations,omitempty"`

	// Arbitrary identifier for the API client.
	// +kcc:proto:field=google.cloud.run.v2.Service.client
	Client *string `json:"client,omitempty"`

	// Arbitrary version identifier for the API client.
	// +kcc:proto:field=google.cloud.run.v2.Service.client_version
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.ingress
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.launch_stage
	LaunchStage *string `json:"launchStage,omitempty"`

	// Optional. Settings for the Binary Authorization feature.
	// +kcc:proto:field=google.cloud.run.v2.Service.binary_authorization
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.traffic
	Traffic []TrafficTarget `json:"traffic,omitempty"`

	// Optional. Specifies service-level scaling settings
	// +kcc:proto:field=google.cloud.run.v2.Service.scaling
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.invoker_iam_disabled
	InvokerIamDisabled *bool `json:"invokerIamDisabled,omitempty"`

	// Optional. Disables public resolution of the default URI of this service.
	// +kcc:proto:field=google.cloud.run.v2.Service.default_uri_disabled
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.custom_audiences
...
type ServiceObservedState struct {
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.generation
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.conditions
	...
	// +kcc:proto:field=google.cloud.run.v2.Service.satisfies_pzs
