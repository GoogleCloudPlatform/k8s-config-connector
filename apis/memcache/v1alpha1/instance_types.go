...
var MemcacheInstanceGVK = GroupVersion.WithKind("MemcacheInstance")
...
type MemcacheInstanceSpec struct {
	// The MemcacheInstance name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// MemcacheInstanceStatus defines the config connector machine state of MemcacheInstance
type MemcacheInstanceStatus struct {
	...
	// A unique specifier for the MemcacheInstance resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *MemcacheInstanceObservedState `json:"observedState,omitempty"`
}

// MemcacheInstanceObservedState is the state of the MemcacheInstance resource as most recently observed in GCP.
// +kcc:proto=google.cloud.memcache.v1.Instance
type MemcacheInstanceObservedState struct {
}
...
// MemcacheInstance is the Schema for the MemcacheInstance API
