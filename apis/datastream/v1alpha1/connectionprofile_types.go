...
type DatastreamConnectionProfileStatus struct {
	...
	// A unique specifier for the DatastreamConnectionProfile resource in Google Cloud.
...
// DatastreamConnectionProfileObservedState is the state of the DatastreamConnectionProfile resource as most recently observed in Google Cloud.
