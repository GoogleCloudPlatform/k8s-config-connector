...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StreamObservedState) DeepCopyInto(out *StreamObservedState) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StreamObservedState.
func (in *StreamObservedState) DeepCopy() *StreamObservedState {
	if in == nil {
		return nil
	}
	out := new(StreamObservedState)
	in.DeepCopyInto(out)
	return out
}
