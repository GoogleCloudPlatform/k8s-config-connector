...
// New builds a ConnectionProfileIdentity from the Config Connector ConnectionProfile object.
func NewConnectionProfileIdentity(ctx context.Context, reader client.Reader, obj *DatastreamConnectionProfile) (*ConnectionProfileIdentity, error) {
