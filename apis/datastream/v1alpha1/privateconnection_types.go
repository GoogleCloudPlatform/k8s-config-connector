...
type DatastreamPrivateConnectionStatus struct {
	...
	// A unique specifier for the DatastreamPrivateConnection resource in Google Cloud.
...
// DatastreamPrivateConnectionObservedState is the state of the DatastreamPrivateConnection resource as most recently observed in Google Cloud.
