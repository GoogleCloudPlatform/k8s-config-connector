...
type TPUQueuedResourceSpec struct {
	...
	// Optional. The reservation in which the resource should be provisioned.
...
// Node is the embedded speculative representation of Node
...
// NodeObservedState is the embedded observed state of Node
