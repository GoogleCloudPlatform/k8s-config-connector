...
var TPUQueuedResourceIdentityFormat = gcpurls.Template[TPUQueuedResourceIdentity]("tpu.googleapis.com", "projects/{project}/locations/{location}/queuedResources/{queuedResource}")

// TPUQueuedResourceIdentity is the identity of a GCP TPUQueuedResource resource.
...
func (i *TPUQueuedResourceIdentity) ParentString() string {
	return fmt.Sprintf("projects/%s/locations/%s", i.Project, i.Location)
}

func getIdentityFromTPUQueuedResourceSpec(ctx context.Context, reader client.Reader, obj *TPUQueuedResource) (*TPUQueuedResourceIdentity, error) {
