...
type TPUVirtualMachineStatus struct {
	...
	// A unique specifier for the TPUVirtualMachine resource in Google Cloud.
...
// TPUVirtualMachineObservedState is the state of the TPUVirtualMachine resource as most recently observed in Google Cloud.
