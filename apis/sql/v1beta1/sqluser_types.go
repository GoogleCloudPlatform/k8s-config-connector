...
type SQLUserPasswordPolicy struct {
	...
	// +optional
	Status []SQLUserPasswordStatus `json:"status,omitempty"`
}

type SQLUserPasswordStatus struct {
...
type SQLUserSpec struct {
	...
	// +optional
	PasswordPolicy *SQLUserPasswordPolicy `json:"passwordPolicy,omitempty"`
	...
	// For CLOUD_IAM_SERVICE_ACCOUNT and CLOUD_IAM_USER types, this is the only
	// way to assign PostgreSQL roles declaratively.
	// +optional
	DatabaseRoles []string `json:"databaseRoles,omitempty"`
	*/
}

type SQLUserSqlServerUserDetailsStatus struct {
...
type SQLUserStatusFields struct {
	...
	// +optional
	SqlServerUserDetails []SQLUserSqlServerUserDetailsStatus `json:"sqlServerUserDetails,omitempty"`
}
...
// SQLUser is the Schema for the sql user API
...
type SQLUser struct {
	...
	Status SQLUserStatusFields `json:"status,omitempty"`
}
