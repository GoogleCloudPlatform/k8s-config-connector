...
func (in *SQLInstanceStatus) DeepCopyInto(out *SQLInstanceStatus) {
	*out = *in
	...
	if in.LastAppliedSpecHash != nil {
		in, out := &in.LastAppliedSpecHash, &out.LastAppliedSpecHash
		*out = new(string)
		**out = **in
	}
	if in.LastAppliedGCPHash != nil {
		in, out := &in.LastAppliedGCPHash, &out.LastAppliedGCPHash
		*out = new(string)
		**out = **in
	}
}
