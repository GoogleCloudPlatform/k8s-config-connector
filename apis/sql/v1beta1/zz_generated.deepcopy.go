...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstancePscAutoConnectionConfig) DeepCopyInto(out *InstancePscAutoConnectionConfig) {
	*out = *in
	...
	if in.ConsumerNetworkRef != nil {
		in, out := &in.ConsumerNetworkRef, &out.ConsumerNetworkRef
		*out = new(refs.ComputeNetworkRef)
		**out = **in
	}
	...
	if in.ConsumerServiceProjectId != nil {
		in, out := &in.ConsumerServiceProjectId, &out.ConsumerServiceProjectId
		*out = new(string)
		**out = **in
	}
	if in.IpAddress != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstancePscAutoConnectionConfig.
func (in *InstancePscAutoConnectionConfig) DeepCopy() *InstancePscAutoConnectionConfig {
	if in == nil {
		return nil
	}
	out := new(InstancePscAutoConnectionConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstancePscConfig) DeepCopyInto(out *InstancePscConfig) {
	*out = *in
	...
	if in.PscAutoConnections != nil {
		...
		*out = make([]InstancePscAutoConnectionConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *ReplicationClusterObservedState) DeepCopyInto(out *ReplicationClusterObservedState) {
	*out = *in
	if in.FailoverDRReplicaName != nil {
		in, out := &in.FailoverDRReplicaName, &out.FailoverDRReplicaName
		*out = new(string)
		**out = **in
	}
	if in.DRReplica != nil {
