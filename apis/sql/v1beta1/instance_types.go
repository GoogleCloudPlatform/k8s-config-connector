...
type InstanceIpConfiguration struct {
	...
	/* Specify how SSL connection should be enforced in DB connections. This field provides more SSL enforcement options compared to requireSsl. To change this field, also set the corresponding value in requireSsl if it has been set. */
	// +optional
