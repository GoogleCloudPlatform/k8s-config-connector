...
// AspectTypeIdentity defines the resource reference to DataplexAspectType, which "External" field
...
func NewAspectTypeIdentity(ctx context.Context, reader client.Reader, obj *DataplexAspectType) (*AspectTypeIdentity, error) {
	...
	if externalRef != "" {
		...
		actualParent, actualResourceID, err := ParseAspectTypeExternal(externalRef)
		if err != nil {
			return nil, err
		}
