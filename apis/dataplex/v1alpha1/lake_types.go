...
type DataplexLakeStatus struct {
	...
	// A unique specifier for the DataplexLake resource in Google Cloud.
...
// DataplexLakeObservedState is the state of the DataplexLake resource as most recently observed in Google Cloud.
