...
type DataplexMetadataFeedSpec struct {
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.scope
	Scope *MetadataFeed_Scope `json:"scope,omitempty"`

	// Optional. The filters of the metadata feed.
	//  Only the changes that match the filters are published.
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.filters
	Filters *MetadataFeed_Filters `json:"filters,omitempty"`

	// Optional. User-defined labels.
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.labels
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.pubsub_topic
...
type MetadataFeed_Scope struct {
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.Scope.organization_level
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.Scope.projects
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.Scope.entry_groups
...
type MetadataFeed_Filters struct {
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.Filters.entry_types
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.Filters.aspect_types
	...
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.Filters.change_types
...
type DataplexMetadataFeedObservedState struct {
	...
	//  ID is different.
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.uid
	Uid *string `json:"uid,omitempty"`

	// Output only. The time when the feed was created.
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The time when the feed was updated.
	// +kcc:proto:field=google.cloud.dataplex.v1.MetadataFeed.update_time
