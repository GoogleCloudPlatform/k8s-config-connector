...
var _ reference.Ref = &ApigeeEnvgroupRef{}
...
func (r *ApigeeEnvgroupRef) NormalizeOnTemplate(ctx context.Context, reader client.Reader, defaultNamespace, tpl string) error {
