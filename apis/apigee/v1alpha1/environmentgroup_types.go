...
type ApigeeEnvgroupStatus struct {
	...
	// A unique specifier for the ApigeeEnvgroup resource in Google Cloud.
...
// ApigeeEnvgroupObservedState is the state of the ApigeeEnvgroup resource as most recently observed in Google Cloud.
