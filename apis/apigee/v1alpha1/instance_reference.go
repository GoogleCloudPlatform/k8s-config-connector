...
var _ reference.Ref = &ApigeeInstanceRef{}
...
func (r *ApigeeInstanceRef) NormalizeOnTemplate(ctx context.Context, reader client.Reader, defaultNamespace, tpl string) error {
