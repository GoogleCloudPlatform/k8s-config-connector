...
type ApigeeAPIProductSpec struct {
	...
	// Optional. Configuration used to group Apigee proxies with gRPC services and method names.
	...
	// Optional. Configuration used to group Apigee proxies with resources, method types, LLM model and quotas.
	...
	// Optional. Number of LLM tokens permitted per app by this API product for the specified `llm_quota_interval` and `llm_quota_time_unit`.
	// +kcc:proto:field=mockgcp.cloud.apigee.v1.GoogleCloudApigeeV1ApiProduct.llm_quota
	...
	// +kcc:proto:field=mockgcp.cloud.apigee.v1.GoogleCloudApigeeV1ApiProduct.llm_quota_interval
	...
	// +kcc:proto:field=mockgcp.cloud.apigee.v1.GoogleCloudApigeeV1ApiProduct.llm_quota_time_unit
