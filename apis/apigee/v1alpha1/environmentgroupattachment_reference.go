...
var _ reference.Ref = &ApigeeEnvgroupAttachmentRef{}
...
func (r *ApigeeEnvgroupAttachmentRef) NormalizeOnTemplate(ctx context.Context, reader client.Reader, defaultNamespace, tpl string) error {
