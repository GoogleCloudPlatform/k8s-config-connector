...
var _ reference.Ref = &ApigeeEndpointAttachmentRef{}
...
func (r *ApigeeEndpointAttachmentRef) NormalizeOnTemplate(ctx context.Context, reader client.Reader, defaultNamespace, tpl string) error {
