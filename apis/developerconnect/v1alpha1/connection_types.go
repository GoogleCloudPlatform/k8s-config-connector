...
type DevConnectConnectionStatus struct {
	...
	// A unique specifier for the DevConnectConnection resource in Google Cloud.
...
// DevConnectConnectionObservedState is the state of the DevConnectConnection resource as most recently observed in Google Cloud.
