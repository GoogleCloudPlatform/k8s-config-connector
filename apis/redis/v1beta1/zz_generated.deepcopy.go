...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisBackupRef) DeepCopyInto(out *RedisBackupRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RedisBackupRef.
func (in *RedisBackupRef) DeepCopy() *RedisBackupRef {
	if in == nil {
		return nil
	}
	out := new(RedisBackupRef)
...
func (in *RedisClusterObservedState) DeepCopyInto(out *RedisClusterObservedState) {
	*out = *in
	...
	if in.ClusterEndpoints != nil {
		...
		*out = make([]ClusterEndpointObservedState, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
