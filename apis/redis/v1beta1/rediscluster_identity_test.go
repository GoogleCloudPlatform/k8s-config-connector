...
func TestRedisClusterIdentity_FromExternal(t *testing.T) {
	tests := []struct {
		name    string
		ref     string
		wantErr bool
		want    *RedisClusterIdentity
	}{
		{
		...
		{
			name: "full url",
			ref:  "https://redis.googleapis.com/projects/my-project/locations/us-central1/clusters/my-cluster",
			want: &RedisClusterIdentity{
				Project:  "my-project",
				Location: "us-central1",
				Cluster:  "my-cluster",
