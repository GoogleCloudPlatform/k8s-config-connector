...
// +kcc:spec:proto=google.cloud.redis.v1.Instance
type RedisInstanceSpec struct {
	...
	// +optional
	CustomerManagedKeyRef *InstanceCustomerManagedKeyRef `json:"customerManagedKeyRef,omitempty"`
...
// +kcc:observedstate:proto=google.cloud.redis.v1.Instance
