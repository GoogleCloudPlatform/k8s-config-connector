...
type Instance struct {
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// Resource labels to represent user provided metadata
	// +kcc:proto:field=google.cloud.redis.v1.Instance.labels
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.location_id
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.alternative_location_id
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.redis_version
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.reserved_ip_range
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.secondary_ip_range
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.redis_configs
	...
	//  will be used.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.authorized_network
	AuthorizedNetwork *string `json:"authorizedNetwork,omitempty"`

	// Optional. The network connect mode of the Redis instance.
	//  If not provided, the connect mode defaults to DIRECT_PEERING.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.connect_mode
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.auth_enabled
	AuthEnabled *bool `json:"authEnabled,omitempty"`

	// Optional. The TLS mode of the Redis instance.
	//  If not provided, TLS is disabled for the instance.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.transit_encryption_mode
	TransitEncryptionMode *string `json:"transitEncryptionMode,omitempty"`

	// Optional. The maintenance policy for the instance. If not provided,
	//  maintenance events can be performed at any time.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.maintenance_policy
	...
	//  default is also 0.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.replica_count
	ReplicaCount *int32 `json:"replicaCount,omitempty"`

	// Optional. Read replicas mode for the instance. Defaults to
	//  READ_REPLICAS_DISABLED.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.read_replicas_mode
	...
	//  create the instance.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.customer_managed_key
	CustomerManagedKey *string `json:"customerManagedKey,omitempty"`

	// Optional. Persistence configuration parameters
	// +kcc:proto:field=google.cloud.redis.v1.Instance.persistence_config
	PersistenceConfig *PersistenceConfig `json:"persistenceConfig,omitempty"`

	// Optional. reasons that causes instance in "SUSPENDED" state.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.suspension_reasons
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.maintenance_version
	...
	//  to.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.available_maintenance_versions
	AvailableMaintenanceVersions []string `json:"availableMaintenanceVersions,omitempty"`
}

// +kcc:proto=google.cloud.redis.v1.MaintenancePolicy
type MaintenancePolicy struct {

	// Optional. Description of what this policy is for. Create/Update methods
	//  return INVALID_ARGUMENT if the length is greater than 512.
	// +kcc:proto:field=google.cloud.redis.v1.MaintenancePolicy.description
	Description *string `json:"description,omitempty"`

	// Optional. Maintenance window that is applied to resources covered by this
	//  policy. Minimum 1. For the current version, the maximum number of
	//  weekly_window is expected to be one.
	// +kcc:proto:field=google.cloud.redis.v1.MaintenancePolicy.weekly_maintenance_window
	WeeklyMaintenanceWindow []WeeklyMaintenanceWindow `json:"weeklyMaintenanceWindow,omitempty"`
}

// +kcc:proto=google.cloud.redis.v1.MaintenanceSchedule
type MaintenanceSchedule struct {

	// If the scheduled maintenance can be rescheduled, default is true.
	// +kcc:proto:field=google.cloud.redis.v1.MaintenanceSchedule.can_reschedule
...
type PersistenceConfig struct {
	...
	// +kcc:proto:field=google.cloud.redis.v1.PersistenceConfig.persistence_mode
	...
	// +kcc:proto:field=google.cloud.redis.v1.PersistenceConfig.rdb_snapshot_period
	...
	//  time will be used.
	// +kcc:proto:field=google.cloud.redis.v1.PersistenceConfig.rdb_snapshot_start_time
	RdbSnapshotStartTime *string `json:"rdbSnapshotStartTime,omitempty"`
}

// +kcc:proto=google.cloud.redis.v1.TlsCertificate
type TlsCertificate struct {
	// Serial number, as extracted from the certificate.
	// +kcc:proto:field=google.cloud.redis.v1.TlsCertificate.serial_number
	SerialNumber *string `json:"serialNumber,omitempty"`

	// PEM representation.
	// +kcc:proto:field=google.cloud.redis.v1.TlsCertificate.cert
	Cert *string `json:"cert,omitempty"`

	// Sha1 Fingerprint of the certificate.
	// +kcc:proto:field=google.cloud.redis.v1.TlsCertificate.sha1_fingerprint
...
type InstanceObservedState struct {
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.host
	Host *string `json:"host,omitempty"`

	// Output only. The port number of the exposed Redis endpoint.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.port
	Port *int32 `json:"port,omitempty"`

	// Output only. The current zone where the Redis primary node is located. In
	//  basic tier, this will always be the same as [location_id]. In
	//  standard tier, this can be the zone of any node in the instance.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.current_location_id
	CurrentLocationID *string `json:"currentLocationID,omitempty"`

	// Output only. The time the instance was created.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The current state of this instance.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.state
	State *string `json:"state,omitempty"`

	// Output only. Additional information about the current status of this
	//  instance, if available.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.status_message
	...
	//  operation.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.persistence_iam_identity
	PersistenceIamIdentity *string `json:"persistenceIamIdentity,omitempty"`

	// Output only. List of server CA certificates for the instance.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.server_ca_certs
	...
	//  scheduled.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.maintenance_schedule
	MaintenanceSchedule *MaintenanceSchedule `json:"maintenanceSchedule,omitempty"`

	// Output only. Info per node.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.nodes
	...
	// +kcc:proto:field=google.cloud.redis.v1.Instance.read_endpoint
	ReadEndpoint *string `json:"readEndpoint,omitempty"`

	// Output only. The port number of the exposed readonly redis
	//  endpoint. Standard tier only. Write requests should target 'port'.
	// +kcc:proto:field=google.cloud.redis.v1.Instance.read_endpoint_port
...
type MaintenancePolicyObservedState struct {
	...
	// +kcc:proto:field=google.cloud.redis.v1.MaintenancePolicy.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The time when the policy was last updated.
	// +kcc:proto:field=google.cloud.redis.v1.MaintenancePolicy.update_time
...
type MaintenanceScheduleObservedState struct {
	...
	//  instance.
	// +kcc:proto:field=google.cloud.redis.v1.MaintenanceSchedule.start_time
	StartTime *string `json:"startTime,omitempty"`

	// Output only. The end time of any upcoming scheduled maintenance for this
	//  instance.
	// +kcc:proto:field=google.cloud.redis.v1.MaintenanceSchedule.end_time
	EndTime *string `json:"endTime,omitempty"`

	// Output only. The deadline that the maintenance schedule start time can not
	//  go beyond, including reschedule.
	// +kcc:proto:field=google.cloud.redis.v1.MaintenanceSchedule.schedule_deadline_time
...
type NodeInfoObservedState struct {
	...
	// +kcc:proto:field=google.cloud.redis.v1.NodeInfo.id
	ID *string `json:"id,omitempty"`

	// Output only. Location of the node.
	// +kcc:proto:field=google.cloud.redis.v1.NodeInfo.zone
...
type PersistenceConfigObservedState struct {
	...
	// +kcc:proto:field=google.cloud.redis.v1.PersistenceConfig.rdb_next_snapshot_time
...
type TlsCertificateObservedState struct {
	...
	// +kcc:proto:field=google.cloud.redis.v1.TlsCertificate.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The time when the certificate expires in [RFC
	//  3339](https://tools.ietf.org/html/rfc3339) format, for example
	//  `2020-05-18T00:00:00.094Z`.
	// +kcc:proto:field=google.cloud.redis.v1.TlsCertificate.expire_time
...
type WeeklyMaintenanceWindowObservedState struct {
	...
	//  fixed at 1 hour.
	// +kcc:proto:field=google.cloud.redis.v1.WeeklyMaintenanceWindow.duration
