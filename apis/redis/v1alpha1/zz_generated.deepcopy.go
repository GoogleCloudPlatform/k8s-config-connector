...
func (in *CertificateAuthority) DeepCopyInto(out *CertificateAuthority) {
	*out = *in
	if in.ManagedServerCa != nil {
		...
		*out = new(CertificateAuthority_ManagedCertificateAuthority)
		(*in).DeepCopyInto(*out)
	}
	if in.Name != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificateAuthority_ManagedCertificateAuthority) DeepCopyInto(out *CertificateAuthority_ManagedCertificateAuthority) {
	*out = *in
	if in.CaCerts != nil {
		in, out := &in.CaCerts, &out.CaCerts
		*out = make([]CertificateAuthority_ManagedCertificateAuthority_CertChain, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertificateAuthority_ManagedCertificateAuthority.
func (in *CertificateAuthority_ManagedCertificateAuthority) DeepCopy() *CertificateAuthority_ManagedCertificateAuthority {
	if in == nil {
		return nil
	}
	out := new(CertificateAuthority_ManagedCertificateAuthority)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CertificateAuthority_ManagedCertificateAuthority_CertChain) DeepCopyInto(out *CertificateAuthority_ManagedCertificateAuthority_CertChain) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CertificateAuthority_ManagedCertificateAuthority_CertChain.
func (in *CertificateAuthority_ManagedCertificateAuthority_CertChain) DeepCopy() *CertificateAuthority_ManagedCertificateAuthority_CertChain {
	if in == nil {
		return nil
	}
	out := new(CertificateAuthority_ManagedCertificateAuthority_CertChain)
	in.DeepCopyInto(out)
	return out
}
