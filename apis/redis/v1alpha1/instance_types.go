...
// +kcc:proto=google.cloud.redis.v1.Instance
type RedisInstanceSpec struct {
	// The RedisInstance name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// RedisInstanceStatus defines the config connector machine state of RedisInstance
type RedisInstanceStatus struct {
	...
	// A unique specifier for the RedisInstance resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *RedisInstanceObservedState `json:"observedState,omitempty"`
}

// RedisInstanceObservedState is the state of the RedisInstance resource as most recently observed in GCP.
// +kcc:proto=google.cloud.redis.v1.Instance
type RedisInstanceObservedState struct {
}
...
// RedisInstance is the Schema for the RedisInstance API
