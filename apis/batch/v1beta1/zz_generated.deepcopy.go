...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BatchJobRef) DeepCopyInto(out *BatchJobRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BatchJobRef.
func (in *BatchJobRef) DeepCopy() *BatchJobRef {
	if in == nil {
		return nil
	}
	out := new(BatchJobRef)
