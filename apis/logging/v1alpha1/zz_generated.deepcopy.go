...
func (in *LogEntry) DeepCopyInto(out *LogEntry) {
	*out = *in
	...
	if in.ProtoPayload != nil {
		in, out := &in.ProtoPayload, &out.ProtoPayload
		*out = new(Any)
		(*in).DeepCopyInto(*out)
	}
	if in.TextPayload != nil {
		in, out := &in.TextPayload, &out.TextPayload
		*out = new(string)
		**out = **in
	}
	if in.JsonPayload != nil {
		in, out := &in.JsonPayload, &out.JsonPayload
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LogEntryObservedState) DeepCopyInto(out *LogEntryObservedState) {
	*out = *in
	if in.ReceiveTimestamp != nil {
		in, out := &in.ReceiveTimestamp, &out.ReceiveTimestamp
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LogEntryObservedState.
func (in *LogEntryObservedState) DeepCopy() *LogEntryObservedState {
	if in == nil {
		return nil
	}
	out := new(LogEntryObservedState)
	in.DeepCopyInto(out)
	return out
}
