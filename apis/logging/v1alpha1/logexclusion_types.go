...
type LoggingLogExclusionSpec struct {
	// The LoggingLogExclusion name. If not given, the metadata.name will be used.
...
type LoggingLogExclusionStatus struct {
	...
	// A unique specifier for the LoggingLogExclusion resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *LoggingLogExclusionObservedState `json:"observedState,omitempty"`
}

// LoggingLogExclusionObservedState is the state of the LoggingLogExclusion resource as most recently observed in GCP.
// +kcc:proto=google.logging.v2.LogExclusion
type LoggingLogExclusionObservedState struct {
}
