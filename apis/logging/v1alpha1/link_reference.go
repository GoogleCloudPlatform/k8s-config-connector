...
var _ refsv1beta1.ExternalNormalizer = &LinkRef{}

// LinkRef defines the resource reference to LoggingLink, which "External" field
...
func (r *LinkRef) NormalizedExternal(ctx context.Context, reader client.Reader, otherNamespace string) (string, error) {
