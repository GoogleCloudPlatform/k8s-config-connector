...
type LoggingLogBucketSpec struct {
	// The LoggingLogBucket name. If not given, the metadata.name will be used.
...
type LoggingLogBucketStatus struct {
	...
	// A unique specifier for the LoggingLogBucket resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *LoggingLogBucketObservedState `json:"observedState,omitempty"`
}

// LoggingLogBucketObservedState is the state of the LoggingLogBucket resource as most recently observed in GCP.
// +kcc:proto=google.logging.v2.LogBucket
type LoggingLogBucketObservedState struct {
}
