...
type LoggingLogViewSpec struct {
	// The LoggingLogView name. If not given, the metadata.name will be used.
...
type LoggingLogViewStatus struct {
	...
	// A unique specifier for the LoggingLogView resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *LoggingLogViewObservedState `json:"observedState,omitempty"`
}

// LoggingLogViewObservedState is the state of the LoggingLogView resource as most recently observed in GCP.
// +kcc:proto=google.logging.v2.LogView
type LoggingLogViewObservedState struct {
}
