...
var LoggingLogExclusionGVK = GroupVersion.WithKind("LoggingLogExclusion")

// LoggingLogExclusionSpec defines the desired state of LoggingLogExclusion
// +kcc:spec:proto=google.logging.v2.LogExclusion
...
// LoggingLogExclusionStatus defines the config connector machine state of LoggingLogExclusion
...
// LoggingLogExclusion is the Schema for the LoggingLogExclusion API
