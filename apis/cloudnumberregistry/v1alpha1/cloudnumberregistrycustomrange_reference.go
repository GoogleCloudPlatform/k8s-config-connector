...
// CloudNumberRegistryCustomRangeRef is a reference to a CloudNumberRegistryCustomRange.
type CloudNumberRegistryCustomRangeRef struct {
	// A reference to an externally managed CloudNumberRegistryCustomRange resource.
	// Should be in the format "projects/{{projectID}}/locations/{{location}}/customRanges/{{customRangeID}}".
...
func init() {
	refs.Register(&CloudNumberRegistryCustomRangeRef{}, &CloudNumberRegistryCustomRange{})
}
