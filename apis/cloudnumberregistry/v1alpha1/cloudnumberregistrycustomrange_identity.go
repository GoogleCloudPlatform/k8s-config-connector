...
var CloudNumberRegistryCustomRangeIdentityFormat = gcpurls.Template[CloudNumberRegistryCustomRangeIdentity]("cloudnumberregistry.googleapis.com", "projects/{project}/locations/{location}/customRanges/{custom_range}")
...
func (i *CloudNumberRegistryCustomRangeIdentity) ParentString() string {
