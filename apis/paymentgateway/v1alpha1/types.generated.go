...
type FinancialTransaction struct {
	...
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.name
	Name *string `json:"name,omitempty"`

	// Information about the transaction.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.info
	Info *TransactionInfo `json:"info,omitempty"`

	// A list of rules specified by the payments orchestrator for this API
	//  transaction.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.payment_rules
	PaymentRules []FinancialTransaction_PaymentRule `json:"paymentRules,omitempty"`
}

// +kcc:proto=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.PaymentRule
type FinancialTransaction_PaymentRule struct {
	// The rule's name.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.PaymentRule.payment_rule
	PaymentRule *string `json:"paymentRule,omitempty"`

	// The rule's value.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.PaymentRule.value
...
// +kcc:proto=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction
type FinancialTransactionObservedState struct {
	// Information about the transaction.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.info
	...
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.retrieval_reference_number
	RetrievalReferenceNumber *string `json:"retrievalReferenceNumber,omitempty"`

	// Output only. The payer in the transaction.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.payer
	Payer *SettlementParticipant `json:"payer,omitempty"`

	// Output only. The payee in the transaction.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.payee
	Payee *SettlementParticipant `json:"payee,omitempty"`

	// Output only. The amount for payment settlement in the transaction.
	// +kcc:proto:field=google.cloud.paymentgateway.issuerswitch.v1.FinancialTransaction.amount
