...
var (
	_ identity.IdentityV2          = &KMSKeyHandleIdentity{}
	_ identity.ServerGeneratedType = &KMSKeyHandleIdentity{}
...
// IsServerGenerated implements identity.ServerGeneratedType
func (i *KMSKeyHandleIdentity) IsServerGenerated() bool {
	return true
}
...
func getIdentityFromKMSKeyHandleSpec(ctx context.Context, reader client.Reader, obj client.Object) (*KMSKeyHandleIdentity, error) {
	...
	// We read spec.resourceID directly to preserve an empty string if it is not set.
	// Unlike most resources, KMSKeyHandle uses a server-generated ID if not provided,
	// so we cannot use refs.GetResourceID as it falls back to the object's Name.
