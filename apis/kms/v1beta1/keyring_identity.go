...
func ParseKMSKeyRingExternal(external string) (*KMSKeyRingIdentity, error) {
	...
	// projects/{{project_id}}/locations/{{region}}/keyRings/{{key_ring_id}}
	...
	return nil, fmt.Errorf("format of KMSKeyRing external=%q was not known (use projects/{{project_id}}/locations/{{region}}/keyRings/{{key_ring_id}})", external)
}
