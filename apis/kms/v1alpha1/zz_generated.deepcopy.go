...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KMSCryptoKeyVersionIdentity) DeepCopyInto(out *KMSCryptoKeyVersionIdentity) {
	*out = *in
	if in.parent != nil {
		in, out := &in.parent, &out.parent
		*out = new(kmsv1beta1.KMSCryptoKeyIdentity)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KMSCryptoKeyVersionIdentity.
func (in *KMSCryptoKeyVersionIdentity) DeepCopy() *KMSCryptoKeyVersionIdentity {
	if in == nil {
		return nil
	}
	out := new(KMSCryptoKeyVersionIdentity)
	in.DeepCopyInto(out)
	return out
}
