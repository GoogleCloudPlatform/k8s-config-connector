...
type ImportJobIdentity struct {
	parent *kmsv1beta1.KMSKeyRingIdentity
	id     string
}
...
func (i *ImportJobIdentity) Parent() *kmsv1beta1.KMSKeyRingIdentity {
	return i.parent
}
...
func NewImportJobIdentity(ctx context.Context, reader client.Reader, obj *KMSImportJob) (*ImportJobIdentity, error) {
	...
	kmsKeyRing, err := kmsv1beta1.ParseKMSKeyRingExternal(kmsKeyRingExternal)
	if err != nil {
		return nil, err
	}
...
func ParseImportJobExternal(external string) (*kmsv1beta1.KMSKeyRingIdentity, string, error) {
	...
	p := &kmsv1beta1.KMSKeyRingIdentity{
