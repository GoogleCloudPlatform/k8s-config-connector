...
type Draft struct {
	// name of resource
	// +kcc:proto:field=google.cloud.visionai.v1.Draft.name
	Name *string `json:"name,omitempty"`

	// Labels as key value pairs
	// +kcc:proto:field=google.cloud.visionai.v1.Draft.labels
	Labels map[string]string `json:"labels,omitempty"`

	// Required. A user friendly display name for the solution.
	// +kcc:proto:field=google.cloud.visionai.v1.Draft.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// A description for this application.
	// +kcc:proto:field=google.cloud.visionai.v1.Draft.description
	Description *string `json:"description,omitempty"`

	// The draft application configs which haven't been updated to an application.
	// +kcc:proto:field=google.cloud.visionai.v1.Draft.draft_application_configs
	DraftApplicationConfigs *ApplicationConfigs `json:"draftApplicationConfigs,omitempty"`
}
...
// +kcc:proto=google.cloud.visionai.v1.Draft
type DraftObservedState struct {
	// Output only. [Output only] Create timestamp
	// +kcc:proto:field=google.cloud.visionai.v1.Draft.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. [Output only] Create timestamp
	// +kcc:proto:field=google.cloud.visionai.v1.Draft.update_time
