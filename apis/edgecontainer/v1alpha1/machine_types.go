...
type EdgeContainerMachineStatus struct {
	...
	// A unique specifier for the EdgeContainerMachine resource in Google Cloud.
...
// EdgeContainerMachineObservedState is the state of the EdgeContainerMachine resource as most recently observed in Google Cloud.
