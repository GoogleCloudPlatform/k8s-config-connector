...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Authorization", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster", skipping
...
/* unreachable type Cluster_ConnectionState
// +kcc:proto=google.cloud.edgecontainer.v1.Cluster.ConnectionState
type Cluster_ConnectionState struct {
}
*/

/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster.ControlPlane", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster.ControlPlane.Local", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster.ControlPlane.Remote", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster.ControlPlaneEncryption", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster.MaintenanceEvent", skipping
...
/* unreachable type Cluster_SurvivabilityConfig
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster.SystemAddonsConfig", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Cluster.SystemAddonsConfig.Ingress", skipping
...
/* unreachable type Cluster_SystemAddonsConfig_VMServiceConfig
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.ClusterNetworking", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.ClusterUser", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.Fleet", skipping
...
/* unreachable type MaintenanceExclusionWindow
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.MaintenancePolicy", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.MaintenanceWindow", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.RecurringTimeWindow", skipping
...
/* found existing non-generated go type with proto tag "google.cloud.edgecontainer.v1.TimeWindow", skipping
...
// +kcc:observedstate:proto=google.cloud.edgecontainer.v1.Cluster
type ClusterObservedState struct {
	...
	ConnectionState *Cluster_ConnectionStateObservedState `json:"connectionState,omitempty"`
}
*/

/* unreachable type Cluster_ConnectionStateObservedState
// +kcc:observedstate:proto=google.cloud.edgecontainer.v1.Cluster.ConnectionState
...
// +kcc:observedstate:proto=google.cloud.edgecontainer.v1.Cluster.ControlPlaneEncryption
...
// +kcc:observedstate:proto=google.cloud.edgecontainer.v1.Cluster.MaintenanceEvent
...
// +kcc:observedstate:proto=google.cloud.edgecontainer.v1.Fleet
