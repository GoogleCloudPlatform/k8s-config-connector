...
type NetworkconnectivitySpokeStatus struct {
	...
	ObservedState *NetworkconnectivitySpokeObservedState `json:"observedState,omitempty"`
}

// NetworkconnectivitySpokeObservedState is the state of the NetworkconnectivitySpoke resource as most recently observed in GCP.
// +kcc:proto=google.cloud.networkconnectivity.v1.Spoke
type NetworkconnectivitySpokeObservedState struct {
}
