...
// NetworkConnectivityRegionalEndpointObservedState is the state of the NetworkConnectivityRegionalEndpoint resource as most recently observed in Google Cloud.
