...
var NetworkconnectivityHubGVK = GroupVersion.WithKind("NetworkconnectivityHub")
...
type NetworkconnectivityHubSpec struct {
	// The NetworkconnectivityHub name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// NetworkconnectivityHubStatus defines the config connector machine state of NetworkconnectivityHub
type NetworkconnectivityHubStatus struct {
	...
	// A unique specifier for the NetworkconnectivityHub resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *NetworkconnectivityHubObservedState `json:"observedState,omitempty"`
}

// NetworkconnectivityHubObservedState is the state of the NetworkconnectivityHub resource as most recently observed in GCP.
// +kcc:proto=google.cloud.networkconnectivity.v1.Hub
type NetworkconnectivityHubObservedState struct {
}
...
// NetworkconnectivityHub is the Schema for the NetworkconnectivityHub API
