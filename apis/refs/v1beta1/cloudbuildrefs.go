...
type GithubEnterpriseConfigRef struct {
...
type CloudBuildV2RepositoryRef struct {
	// The qualified resource name of the Repo API repository. Format: projects/*locations/*connections/*repositories/*
	External string `json:"external,omitempty"`
	// Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names
	Name string `json:"name,omitempty"`
	// Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/
...
type SourceRepoRepositoryRef struct {
	// The name of the Cloud Source Repository.
	External string `json:"external,omitempty"`
	// Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names
	Name string `json:"name,omitempty"`
	// Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/
