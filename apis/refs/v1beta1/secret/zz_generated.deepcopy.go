...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LegacyObservedState) DeepCopyInto(out *LegacyObservedState) {
	*out = *in
	if in.Value != nil {
		in, out := &in.Value, &out.Value
		*out = new(string)
	...
	if in.ValueFrom != nil {
		in, out := &in.ValueFrom, &out.ValueFrom
		*out = new(LegacyValueFromObservedState)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LegacyObservedState.
func (in *LegacyObservedState) DeepCopy() *LegacyObservedState {
	if in == nil {
		return nil
	}
	out := new(LegacyObservedState)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LegacyValueFromObservedState) DeepCopyInto(out *LegacyValueFromObservedState) {
	*out = *in
	if in.SecretKeyRef != nil {
		in, out := &in.SecretKeyRef, &out.SecretKeyRef
		*out = new(v1alpha1.SecretKeyRefObservedState)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LegacyValueFromObservedState.
func (in *LegacyValueFromObservedState) DeepCopy() *LegacyValueFromObservedState {
	if in == nil {
		return nil
	}
	out := new(LegacyValueFromObservedState)
