...
// NetworkSecurityInterceptDeploymentGroupRef defines the resource reference to NetworkSecurityInterceptDeploymentGroup, which "External" field
...
type NetworkSecurityInterceptDeploymentGroupRef struct {
	...
	// Should be of the format `projects/{{projectID}}/locations/{{location}}/interceptDeploymentGroups/{{interceptDeploymentGroupID}}`.
