...
func ResolveKMSCryptoKeyRef(ctx context.Context, reader client.Reader, src client.Object, ref *KMSCryptoKeyRef) (*KMSCryptoKeyRef, error) {
	...
	// External should be in the `projects/[project_id]/locations/[region]/keyRings/[key_ring_id]/cryptoKeys/[key]` format
	if ref.External != "" {
		...
		return nil, fmt.Errorf("format of KMSCryptoKeyRef external=%q was not known (use projects/[project_id]/locations/[region]/keyRings/[key_ring_id]/cryptoKeys/[key])", ref.External)
	}
