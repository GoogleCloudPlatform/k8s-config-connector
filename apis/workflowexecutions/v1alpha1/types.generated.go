...
// resource: WorkflowsExecution:Execution
...
// +kcc:observedstate:proto=google.cloud.workflows.executions.v1.Execution.Error
type Execution_ErrorObservedState struct {
	...
	StackTrace *Execution_StackTraceObservedState `json:"stackTrace,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.workflows.executions.v1.Execution.StackTrace
type Execution_StackTraceObservedState struct {
	// An array of stack elements.
	// +kcc:proto:field=google.cloud.workflows.executions.v1.Execution.StackTrace.elements
	Elements []Execution_StackTraceElementObservedState `json:"elements,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.workflows.executions.v1.Execution.StackTraceElement
type Execution_StackTraceElementObservedState struct {
	...
	Position *Execution_StackTraceElement_PositionObservedState `json:"position,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.workflows.executions.v1.Execution.StackTraceElement.Position
type Execution_StackTraceElement_PositionObservedState struct {
...
// +kcc:observedstate:proto=google.cloud.workflows.executions.v1.Execution.StateError
type Execution_StateErrorObservedState struct {
...
// +kcc:observedstate:proto=google.cloud.workflows.executions.v1.Execution.Status
type Execution_StatusObservedState struct {
	...
	CurrentSteps []Execution_Status_StepObservedState `json:"currentSteps,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.workflows.executions.v1.Execution.Status.Step
type Execution_Status_StepObservedState struct {
