...
// +kcc:proto=google.cloud.scheduler.v1.AppEngineHttpTarget
type AppEngineHttpTarget struct {
	// The HTTP method to use for the request. PATCH and OPTIONS are not
	//  permitted.
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineHttpTarget.http_method
	HTTPMethod *string `json:"httpMethod,omitempty"`

	// App Engine Routing setting for the job.
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineHttpTarget.app_engine_routing
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineHttpTarget.relative_uri
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineHttpTarget.headers
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineHttpTarget.body
	Body []byte `json:"body,omitempty"`
}

// +kcc:proto=google.cloud.scheduler.v1.AppEngineRouting
type AppEngineRouting struct {
	// App service.
	//
	//  By default, the job is sent to the service which is the default
	//  service when the job is attempted.
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineRouting.service
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineRouting.version
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineRouting.instance
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.AppEngineRouting.host
	Host *string `json:"host,omitempty"`
}

// +kcc:proto=google.cloud.scheduler.v1.HttpTarget
type HttpTarget struct {
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.HttpTarget.uri
	URI *string `json:"uri,omitempty"`

	// Which HTTP method to use for the request.
	// +kcc:proto:field=google.cloud.scheduler.v1.HttpTarget.http_method
	HTTPMethod *string `json:"httpMethod,omitempty"`
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.HttpTarget.headers
	Headers map[string]string `json:"headers,omitempty"`

	// HTTP request body. A request body is allowed only if the HTTP
	//  method is POST, PUT, or PATCH. It is an error to set body on a job with an
	//  incompatible [HttpMethod][google.cloud.scheduler.v1.HttpMethod].
	// +kcc:proto:field=google.cloud.scheduler.v1.HttpTarget.body
	Body []byte `json:"body,omitempty"`
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.HttpTarget.oauth_token
	...
	//  yourself.
	// +kcc:proto:field=google.cloud.scheduler.v1.HttpTarget.oidc_token
...
type Job struct {
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.name
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.description
	Description *string `json:"description,omitempty"`

	// Pub/Sub target.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.pubsub_target
	PubsubTarget *PubsubTarget `json:"pubsubTarget,omitempty"`

	// App Engine HTTP target.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.app_engine_http_target
	AppEngineHTTPTarget *AppEngineHttpTarget `json:"appEngineHTTPTarget,omitempty"`

	// HTTP target.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.http_target
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.schedule
	...
	//  as GMT).
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.time_zone
	TimeZone *string `json:"timeZone,omitempty"`

	// Output only. The creation time of the job.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.user_update_time
	UserUpdateTime *string `json:"userUpdateTime,omitempty"`

	// Output only. State of the job.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.state
	State *string `json:"state,omitempty"`

	// Output only. The response from the target for the last attempted execution.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.status
	Status *Status `json:"status,omitempty"`

	// Output only. The next time the job is scheduled. Note that this may be a
	//  retry of a previously failed attempt or the next execution time
	//  according to the schedule.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.schedule_time
	ScheduleTime *string `json:"scheduleTime,omitempty"`

	// Output only. The time the last job attempt started.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.last_attempt_time
	LastAttemptTime *string `json:"lastAttemptTime,omitempty"`

	// Settings that determine the retry behavior.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.retry_config
	...
	//  field is ignored.
	// +kcc:proto:field=google.cloud.scheduler.v1.Job.attempt_deadline
	AttemptDeadline *string `json:"attemptDeadline,omitempty"`
}

// +kcc:proto=google.cloud.scheduler.v1.OAuthToken
type OAuthToken struct {
	// [Service account email](https://cloud.google.com/iam/docs/service-accounts)
	//  to be used for generating OAuth token.
	//  The service account must be within the same project as the job. The caller
	//  must have iam.serviceAccounts.actAs permission for the service account.
	// +kcc:proto:field=google.cloud.scheduler.v1.OAuthToken.service_account_email
	ServiceAccountEmail *string `json:"serviceAccountEmail,omitempty"`

	// OAuth scope to be used for generating OAuth access token.
	//  If not specified, "https://www.googleapis.com/auth/cloud-platform"
	//  will be used.
	// +kcc:proto:field=google.cloud.scheduler.v1.OAuthToken.scope
	Scope *string `json:"scope,omitempty"`
}

// +kcc:proto=google.cloud.scheduler.v1.OidcToken
type OidcToken struct {
	// [Service account email](https://cloud.google.com/iam/docs/service-accounts)
	//  to be used for generating OIDC token.
	//  The service account must be within the same project as the job. The caller
	//  must have iam.serviceAccounts.actAs permission for the service account.
	// +kcc:proto:field=google.cloud.scheduler.v1.OidcToken.service_account_email
	ServiceAccountEmail *string `json:"serviceAccountEmail,omitempty"`

	// Audience to be used when generating OIDC token. If not specified, the URI
	//  specified in target will be used.
	// +kcc:proto:field=google.cloud.scheduler.v1.OidcToken.audience
	Audience *string `json:"audience,omitempty"`
}

// +kcc:proto=google.cloud.scheduler.v1.PubsubTarget
type PubsubTarget struct {
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.PubsubTarget.topic_name
	...
	//  attribute.
	// +kcc:proto:field=google.cloud.scheduler.v1.PubsubTarget.data
	...
	//  Pubsub message must contain either non-empty data, or at least one
	//  attribute.
	// +kcc:proto:field=google.cloud.scheduler.v1.PubsubTarget.attributes
	Attributes map[string]string `json:"attributes,omitempty"`
}

// +kcc:proto=google.cloud.scheduler.v1.RetryConfig
type RetryConfig struct {
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.RetryConfig.retry_count
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.RetryConfig.max_retry_duration
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.RetryConfig.min_backoff_duration
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.RetryConfig.max_backoff_duration
	...
	// +kcc:proto:field=google.cloud.scheduler.v1.RetryConfig.max_doublings
