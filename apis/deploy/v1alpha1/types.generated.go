...
// +kcc:proto=google.cloud.deploy.v1.BuildArtifact
type BuildArtifact struct {
	// Image name in Skaffold configuration.
	// +kcc:proto:field=google.cloud.deploy.v1.BuildArtifact.image
	Image *string `json:"image,omitempty"`

	// Image tag to use. This will generally be the full path to an image, such
	//  as "gcr.io/my-project/busybox:1.2.3" or
	//  "gcr.io/my-project/busybox@sha256:abc123".
	// +kcc:proto:field=google.cloud.deploy.v1.BuildArtifact.tag
...
// +kcc:proto=google.cloud.deploy.v1.CloudRunRenderMetadata
...
type Release struct {
	...
	// +kcc:proto:field=google.cloud.deploy.v1.Release.name
	Name *string `json:"name,omitempty"`

	// Description of the `Release`. Max length is 255 characters.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.description
	Description *string `json:"description,omitempty"`

	// User annotations. These attributes can only be set and used by the
	//  user, and not by Cloud Deploy. See https://google.aip.dev/128#annotations
	//  for more details such as format and size limitations.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.annotations
	Annotations map[string]string `json:"annotations,omitempty"`
	...
	//
	//  Both keys and values are additionally constrained to be <= 128 bytes.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.labels
	Labels map[string]string `json:"labels,omitempty"`

	// Cloud Storage URI of tar.gz archive containing Skaffold configuration.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.skaffold_config_uri
	SkaffoldConfigURI *string `json:"skaffoldConfigURI,omitempty"`

	// Filepath of the Skaffold config inside of the config URI.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.skaffold_config_path
	SkaffoldConfigPath *string `json:"skaffoldConfigPath,omitempty"`

	// List of artifacts to pass through to Skaffold command.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.build_artifacts
	BuildArtifacts []BuildArtifact `json:"buildArtifacts,omitempty"`

	// This checksum is computed by the server based on the value of other
	//  fields, and may be sent on update and delete requests to ensure the
	//  client has an up-to-date value before proceeding.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.etag
	Etag *string `json:"etag,omitempty"`
	...
	// +kcc:proto:field=google.cloud.deploy.v1.Release.skaffold_version
	SkaffoldVersion *string `json:"skaffoldVersion,omitempty"`

	// Optional. The deploy parameters to use for all targets in this release.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.deploy_parameters
	DeployParameters map[string]string `json:"deployParameters,omitempty"`
}

// +kcc:proto=google.cloud.deploy.v1.Release.ReleaseCondition
type Release_ReleaseCondition struct {
	// Details around the Releases's overall status.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.ReleaseCondition.release_ready_condition
	ReleaseReadyCondition *Release_ReleaseReadyCondition `json:"releaseReadyCondition,omitempty"`

	// Details around the support state of the release's Skaffold
	//  version.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.ReleaseCondition.skaffold_supported_condition
	SkaffoldSupportedCondition *Release_SkaffoldSupportedCondition `json:"skaffoldSupportedCondition,omitempty"`
}

// +kcc:proto=google.cloud.deploy.v1.Release.ReleaseReadyCondition
type Release_ReleaseReadyCondition struct {
	...
	// +kcc:proto:field=google.cloud.deploy.v1.Release.ReleaseReadyCondition.status
	Status *bool `json:"status,omitempty"`
}

// +kcc:proto=google.cloud.deploy.v1.Release.SkaffoldSupportedCondition
type Release_SkaffoldSupportedCondition struct {
	// True if the version of Skaffold used by this release is supported.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.SkaffoldSupportedCondition.status
	Status *bool `json:"status,omitempty"`

	// The Skaffold support state for this release's version of Skaffold.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.SkaffoldSupportedCondition.skaffold_support_state
	...
	//  maintenance mode.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.SkaffoldSupportedCondition.maintenance_mode_time
	MaintenanceModeTime *string `json:"maintenanceModeTime,omitempty"`

	// The time at which this release's version of Skaffold will no longer be
	//  supported.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.SkaffoldSupportedCondition.support_expiration_time
	SupportExpirationTime *string `json:"supportExpirationTime,omitempty"`
}

// +kcc:proto=google.cloud.deploy.v1.Release.TargetRender
type Release_TargetRender struct {
}

// +kcc:proto=google.cloud.deploy.v1.RenderMetadata
...
// +kcc:proto=google.cloud.deploy.v1.TargetArtifact
type TargetArtifact struct {
}

// +kcc:proto=google.cloud.deploy.v1.TargetArtifact.PhaseArtifact
...
type ReleaseObservedState struct {
	...
	// +kcc:proto:field=google.cloud.deploy.v1.Release.uid
	Uid *string `json:"uid,omitempty"`

	// Output only. Indicates whether this is an abandoned release.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.abandoned
	Abandoned *bool `json:"abandoned,omitempty"`

	// Output only. Time at which the `Release` was created.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Time at which the render began.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.render_start_time
	RenderStartTime *string `json:"renderStartTime,omitempty"`

	// Output only. Time at which the render completed.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.render_end_time
	RenderEndTime *string `json:"renderEndTime,omitempty"`

	// Output only. Snapshot of the parent pipeline taken at release creation
	//  time.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.delivery_pipeline_snapshot
	DeliveryPipelineSnapshot *DeliveryPipeline `json:"deliveryPipelineSnapshot,omitempty"`

	// Output only. Snapshot of the targets taken at release creation time.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.target_snapshots
	...
	// +kcc:proto:field=google.cloud.deploy.v1.Release.custom_target_type_snapshots
	CustomTargetTypeSnapshots []CustomTargetType `json:"customTargetTypeSnapshots,omitempty"`

	// Output only. Current state of the render operation.
	// +kcc:proto:field=google.cloud.deploy.v1.Release.render_state
	...
	// +kcc:proto:field=google.cloud.deploy.v1.Release.condition
	Condition *Release_ReleaseCondition `json:"condition,omitempty"`
}
