...
var DeployCustomTargetTypeGVK = GroupVersion.WithKind("DeployCustomTargetType")
...
// DeployCustomTargetTypeStatus defines the config connector machine state of DeployCustomTargetType
type DeployCustomTargetTypeStatus struct {
	...
	ObservedState *DeployCustomTargetTypeObservedState `json:"observedState,omitempty"`
}

// DeployCustomTargetTypeObservedState is the state of the DeployCustomTargetType resource as most recently observed in GCP.
// +kcc:proto=google.cloud.deploy.v1.CustomTargetType
type DeployCustomTargetTypeObservedState struct {
}
