...
PROTO_SHA="8b8b58da61b3ae8ac868ba64b52f9a637ec5fa56"
...
${CONTROLLERBUILDER} generate-types \
  ...
  --service google.cloud.support.v2 \
  --api-version cloudsupport.cnrm.cloud.google.com/v1alpha1 \
  --resource CloudSupportSupportEventSubscription:SupportEventSubscription \
...
if [ -d "${REPO_ROOT}/pkg/controller/direct/cloudsupport" ]; then
  go run -mod=readonly golang.org/x/tools/cmd/goimports@${GOLANG_X_TOOLS_VERSION} -w pkg/controller/direct/cloudsupport/
fi
