...
var GKEMulticloudAttachedClusterIdentityFormat = gcpurls.Template[GKEMulticloudAttachedClusterIdentity]("gkemulticloud.googleapis.com", "projects/{project}/locations/{location}/attachedClusters/{attachedCluster}")

// GKEMulticloudAttachedClusterIdentity is the identity of a GCP GKEMulticloudAttachedCluster resource.
...
func getIdentityFromGKEMulticloudAttachedClusterSpec(ctx context.Context, reader client.Reader, obj *GKEMulticloudAttachedCluster) (*GKEMulticloudAttachedClusterIdentity, error) {
