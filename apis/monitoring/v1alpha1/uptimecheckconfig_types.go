...
type MonitoringUptimeCheckConfigSpec struct {
	// The MonitoringUptimeCheckConfig name. If not given, the metadata.name will be used.
...
type MonitoringUptimeCheckConfigStatus struct {
	...
	// A unique specifier for the MonitoringUptimeCheckConfig resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *MonitoringUptimeCheckConfigObservedState `json:"observedState,omitempty"`
}

// MonitoringUptimeCheckConfigObservedState is the state of the MonitoringUptimeCheckConfig resource as most recently observed in GCP.
// +kcc:proto=google.monitoring.v3.UptimeCheckConfig
type MonitoringUptimeCheckConfigObservedState struct {
}
