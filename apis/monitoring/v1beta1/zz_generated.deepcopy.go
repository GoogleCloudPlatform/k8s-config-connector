...
<<<<<<< HEAD
=======
func (in *Dashboard_LabelsEntry) DeepCopyInto(out *Dashboard_LabelsEntry) {
	*out = *in
	if in.Key != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Dashboard_LabelsEntry.
func (in *Dashboard_LabelsEntry) DeepCopy() *Dashboard_LabelsEntry {
	if in == nil {
		return nil
	}
	out := new(Dashboard_LabelsEntry)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
>>>>>>> 78948da42 (update gen crd script)
