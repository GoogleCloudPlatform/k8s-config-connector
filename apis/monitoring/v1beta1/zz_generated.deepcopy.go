...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpsAnalyticsQuery) DeepCopyInto(out *OpsAnalyticsQuery) {
	*out = *in
	if in.Sql != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpsAnalyticsQuery.
func (in *OpsAnalyticsQuery) DeepCopy() *OpsAnalyticsQuery {
	if in == nil {
		return nil
	}
	out := new(OpsAnalyticsQuery)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TimeSeriesQuery) DeepCopyInto(out *TimeSeriesQuery) {
	*out = *in
	...
	if in.OpsAnalyticsQuery != nil {
		in, out := &in.OpsAnalyticsQuery, &out.OpsAnalyticsQuery
		*out = new(OpsAnalyticsQuery)
		(*in).DeepCopyInto(*out)
	}
	if in.UnitOverride != nil {
