...
func (r *MonitoringAlertPolicyRef) GetGVK() schema.GroupVersionKind {
	return MonitoringAlertPolicyGVK
}

func (r *MonitoringAlertPolicyRef) GetNamespacedName() types.NamespacedName {
...
func (r *MonitoringAlertPolicyRef) GetExternal() string {
	return r.External
}
...
func (r *MonitoringAlertPolicyRef) ValidateExternal(ref string) error {
	id := &MonitoringAlertPolicyIdentity{}
...
func (r *MonitoringAlertPolicyRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &MonitoringAlertPolicyIdentity{}
