...
type MonitoringDashboardRef struct {
	...
	// The name of a MonitoringDashboard resource.
	Name string `json:"name,omitempty"`

	// The namespace of a MonitoringDashboard resource.
...
func (r *MonitoringDashboardRef) GetGVK() schema.GroupVersionKind {
	return MonitoringDashboardGVK
}

func (r *MonitoringDashboardRef) GetNamespacedName() types.NamespacedName {
...
func (r *MonitoringDashboardRef) GetExternal() string {
	return r.External
}
...
func (r *MonitoringDashboardRef) ValidateExternal(ref string) error {
	id := &MonitoringDashboardIdentity{}
...
func (r *MonitoringDashboardRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &MonitoringDashboardIdentity{}
