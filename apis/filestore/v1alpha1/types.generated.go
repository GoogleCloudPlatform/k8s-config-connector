...
// +kcc:proto=google.cloud.filestore.v1beta1.DirectoryServicesConfig
type DirectoryServicesConfig struct {
	// Configuration for Managed Service for Microsoft Active Directory.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.DirectoryServicesConfig.managed_active_directory
	ManagedActiveDirectory *ManagedActiveDirectoryConfig `json:"managedActiveDirectory,omitempty"`
}

// +kcc:proto=google.cloud.filestore.v1beta1.FileShareConfig
type FileShareConfig struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.FileShareConfig.name
	Name *string `json:"name,omitempty"`

	// File share capacity in gigabytes (GB).
	//  Filestore defines 1 GB as 1024^3 bytes.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.FileShareConfig.capacity_gb
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.FileShareConfig.source_backup
	SourceBackup *string `json:"sourceBackup,omitempty"`

	// Nfs Export Options.
	//  There is a limit of 10 export options per file share.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.FileShareConfig.nfs_export_options
	NfsExportOptions []NfsExportOptions `json:"nfsExportOptions,omitempty"`
}

// +kcc:proto=google.cloud.filestore.v1beta1.Instance
type Instance struct {

	// The description of the instance (2048 characters or less).
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.description
	Description *string `json:"description,omitempty"`

	// The service tier of the instance.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.tier
	Tier *string `json:"tier,omitempty"`

	// Resource labels to represent user provided metadata.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.labels
	Labels map[string]string `json:"labels,omitempty"`

	// File system shares on the instance.
	//  For this version, only a single file share is supported.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.file_shares
	FileShares []FileShareConfig `json:"fileShares,omitempty"`

	// VPC networks to which the instance is connected.
	//  For this version, only a single network is supported.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.networks
	Networks []NetworkConfig `json:"networks,omitempty"`

	// Server-specified ETag for the instance resource to prevent simultaneous
	//  updates from overwriting each other.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.etag
	Etag *string `json:"etag,omitempty"`

	// KMS key name used for data encryption.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.kms_key_name
	KMSKeyName *string `json:"kmsKeyName,omitempty"`

	// The max number of shares allowed.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.max_share_count
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.capacity_gb
	CapacityGB *int64 `json:"capacityGB,omitempty"`
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.multi_share_enabled
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.protocol
	Protocol *string `json:"protocol,omitempty"`

	// Directory Services configuration for Kerberos-based authentication.
	//  Should only be set if protocol is "NFS_V4_1".
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.directory_services
	DirectoryServices *DirectoryServicesConfig `json:"directoryServices,omitempty"`
}

// +kcc:proto=google.cloud.filestore.v1beta1.ManagedActiveDirectoryConfig
type ManagedActiveDirectoryConfig struct {
	// Fully qualified domain name.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.ManagedActiveDirectoryConfig.domain
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.ManagedActiveDirectoryConfig.computer
	Computer *string `json:"computer,omitempty"`
}

// +kcc:proto=google.cloud.filestore.v1beta1.NetworkConfig
type NetworkConfig struct {
	// The name of the Google Compute Engine
	//  [VPC network](https://cloud.google.com/vpc/docs/vpc) to which the
	//  instance is connected.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.NetworkConfig.network
	Network *string `json:"network,omitempty"`

	// Internet protocol versions for which the instance has IP addresses
	//  assigned. For this version, only MODE_IPV4 is supported.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.NetworkConfig.modes
	...
	//  network.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.NetworkConfig.reserved_ip_range
	ReservedIPRange *string `json:"reservedIPRange,omitempty"`

	// The network connect mode of the Filestore instance.
	//  If not provided, the connect mode defaults to DIRECT_PEERING.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.NetworkConfig.connect_mode
...
type InstanceObservedState struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.name
	Name *string `json:"name,omitempty"`

	// Output only. The instance state.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.state
	State *string `json:"state,omitempty"`

	// Output only. Additional information about the instance state, if available.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.status_message
	StatusMessage *string `json:"statusMessage,omitempty"`

	// Output only. The time when the instance was created.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.create_time
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.satisfies_pzs
	SatisfiesPzs *bool `json:"satisfiesPzs,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.satisfies_pzi
	SatisfiesPzi *bool `json:"satisfiesPzi,omitempty"`

	// Output only. Field indicates all the reasons the instance is in "SUSPENDED"
	//  state.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.suspension_reasons
	SuspensionReasons []string `json:"suspensionReasons,omitempty"`

	// Output only. The max capacity of the instance.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.max_capacity_gb
	MaxCapacityGB *int64 `json:"maxCapacityGB,omitempty"`

	// Output only. The increase/decrease capacity step size.
	// +kcc:proto:field=google.cloud.filestore.v1beta1.Instance.capacity_step_size_gb
...
type NetworkConfigObservedState struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1beta1.NetworkConfig.ip_addresses
