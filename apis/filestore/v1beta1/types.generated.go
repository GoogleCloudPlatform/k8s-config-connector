...
/* found existing non-generated go type with proto tag "google.cloud.filestore.v1.FileShareConfig", skipping
...
type Instance struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.replication
	...
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.tags
	...
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.protocol
	Protocol *string `json:"protocol,omitempty"`

	// Optional. Used to configure performance.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.performance_config
	PerformanceConfig *Instance_PerformanceConfig `json:"performanceConfig,omitempty"`

	// Optional. Indicates whether the instance is protected against deletion.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.deletion_protection_enabled
	DeletionProtectionEnabled *bool `json:"deletionProtectionEnabled,omitempty"`

	// Optional. The reason for enabling deletion protection.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.deletion_protection_reason
...
type Instance_PerformanceConfig struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.PerformanceConfig.iops_per_tb
	IopsPerTb *Instance_IopsPerTb `json:"iopsPerTb,omitempty"`
...
/* found existing non-generated go type with proto tag "google.cloud.filestore.v1.NfsExportOptions", skipping
...
type Replication struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1.Replication.role
...
// +kcc:observedstate:proto=google.cloud.filestore.v1.Instance
type InstanceObservedState struct {
	...
	// Optional. Replication configuration.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.replication
	Replication *ReplicationObservedState `json:"replication,omitempty"`
	...
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.custom_performance_supported
	CustomPerformanceSupported *bool `json:"customPerformanceSupported,omitempty"`

	// Output only. Used for getting performance limits.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.performance_limits
	PerformanceLimits *Instance_PerformanceLimitsObservedState `json:"performanceLimits,omitempty"`
}
*/
...
type Instance_PerformanceLimitsObservedState struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.PerformanceLimits.max_iops
	MaxIops *int64 `json:"maxIops,omitempty"`

	// Output only. The max read IOPS.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.PerformanceLimits.max_read_iops
	MaxReadIops *int64 `json:"maxReadIops,omitempty"`

	// Output only. The max write IOPS.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.PerformanceLimits.max_write_iops
	MaxWriteIops *int64 `json:"maxWriteIops,omitempty"`

	// Output only. The max read throughput in bytes per second.
	// +kcc:proto:field=google.cloud.filestore.v1.Instance.PerformanceLimits.max_read_throughput_bps
	MaxReadThroughputBps *int64 `json:"maxReadThroughputBps,omitempty"`
...
// +kcc:observedstate:proto=google.cloud.filestore.v1.NetworkConfig
...
type ReplicaConfigObservedState struct {
	...
	// +kcc:proto:field=google.cloud.filestore.v1.ReplicaConfig.state
	State *string `json:"state,omitempty"`

	// Output only. Additional information about the replication state, if
	//  available.
	// +kcc:proto:field=google.cloud.filestore.v1.ReplicaConfig.state_reasons
