...
${CONTROLLERBUILDER} generate-types \
  ...
  --api-version filestore.cnrm.cloud.google.com/v1beta1 \
...
if [ -d "${REPO_ROOT}/pkg/controller/direct/filestore" ]; then
  go run -mod=readonly golang.org/x/tools/cmd/goimports@${GOLANG_X_TOOLS_VERSION} -w pkg/controller/direct/filestore/
fi
