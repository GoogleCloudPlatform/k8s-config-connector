...
// +kcc:proto=google.cloud.tasks.v2beta3.AppEngineHttpQueue
type AppEngineHttpQueue struct {
	...
	//  [task-level
	//  app_engine_routing][google.cloud.tasks.v2beta3.AppEngineHttpRequest.app_engine_routing].
	// +kcc:proto:field=google.cloud.tasks.v2beta3.AppEngineHttpQueue.app_engine_routing_override
...
// +kcc:proto=google.cloud.tasks.v2beta3.HttpTarget
type HttpTarget struct {
	// URI override.
	//
	//  When specified, overrides the execution URI for all the tasks in the queue.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.uri_override
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.http_method
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.header_overrides
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.oauth_token
	...
	//  yourself.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.oidc_token
	OidcToken *OidcToken `json:"oidcToken,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.HttpTarget.Header
type HttpTarget_Header struct {
	// The Key of the header.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.Header.key
	Key *string `json:"key,omitempty"`

	// The Value of the header.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.Header.value
	Value *string `json:"value,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.HttpTarget.HeaderOverride
type HttpTarget_HeaderOverride struct {
	// header embodying a key and a value.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.HttpTarget.HeaderOverride.header
...
// +kcc:proto=google.cloud.tasks.v2beta3.PathOverride
type PathOverride struct {
	// The URI path (e.g., /users/1234). Default is an empty string.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.PathOverride.path
	Path *string `json:"path,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.QueryOverride
type QueryOverride struct {
	// The query parameters (e.g., qparam1=123&qparam2=456). Default is an empty
	//  string.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.QueryOverride.query_params
	QueryParams *string `json:"queryParams,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.Queue
type Queue struct {
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.name
	...
	//  this proto.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.app_engine_http_queue
	AppEngineHTTPQueue *AppEngineHttpQueue `json:"appEngineHTTPQueue,omitempty"`

	// Modifies HTTP target for HTTP tasks.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.http_target
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.rate_limits
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.retry_config
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.state
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.purge_time
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.task_ttl
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.tombstone_ttl
	TombstoneTtl *string `json:"tombstoneTtl,omitempty"`

	// Configuration options for writing logs to
	//  [Stackdriver Logging](https://cloud.google.com/logging/docs/). If this
	//  field is unset, then no logs are written.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.stackdriver_logging_config
	...
	//  selected.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.type
	Type *string `json:"type,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.QueueStats
type QueueStats struct {
}

// +kcc:proto=google.cloud.tasks.v2beta3.RateLimits
type RateLimits struct {
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RateLimits.max_dispatches_per_second
	...
	//  updating
	//  [max_dispatches_per_second][google.cloud.tasks.v2beta3.RateLimits.max_dispatches_per_second].
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RateLimits.max_burst_size
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RateLimits.max_concurrent_dispatches
	MaxConcurrentDispatches *int32 `json:"maxConcurrentDispatches,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.RetryConfig
type RetryConfig struct {
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RetryConfig.max_attempts
	...
	//  [task_age_limit in
	//  queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters).
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RetryConfig.max_retry_duration
	...
	//  queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters).
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RetryConfig.min_backoff
	...
	//  queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters).
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RetryConfig.max_backoff
	...
	//  [max_doublings in
	//  queue.yaml/xml](https://cloud.google.com/appengine/docs/standard/python/config/queueref#retry_parameters).
	// +kcc:proto:field=google.cloud.tasks.v2beta3.RetryConfig.max_doublings
	MaxDoublings *int32 `json:"maxDoublings,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.StackdriverLoggingConfig
type StackdriverLoggingConfig struct {
	// Specifies the fraction of operations to write to
	//  [Stackdriver Logging](https://cloud.google.com/logging/docs/).
	//  This field may contain any value between 0.0 and 1.0, inclusive.
	//  0.0 is the default and means that no operations are logged.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.StackdriverLoggingConfig.sampling_ratio
	SamplingRatio *float64 `json:"samplingRatio,omitempty"`
}

// +kcc:proto=google.cloud.tasks.v2beta3.UriOverride
type UriOverride struct {
	// Scheme override.
	//
	//  When specified, the task URI scheme is replaced by the provided value (HTTP
	//  or HTTPS).
	// +kcc:proto:field=google.cloud.tasks.v2beta3.UriOverride.scheme
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.UriOverride.host
	Host *string `json:"host,omitempty"`
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.UriOverride.port
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.UriOverride.path_override
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.UriOverride.query_override
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.UriOverride.uri_override_enforce_mode
...
type QueueObservedState struct {
	...
	//  FieldMask.
	// +kcc:proto:field=google.cloud.tasks.v2beta3.Queue.stats
...
type QueueStatsObservedState struct {
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.QueueStats.tasks_count
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.QueueStats.oldest_estimated_arrival_time
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.QueueStats.executed_last_minute_count
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.QueueStats.concurrent_dispatches_count
	...
	// +kcc:proto:field=google.cloud.tasks.v2beta3.QueueStats.effective_execution_rate
