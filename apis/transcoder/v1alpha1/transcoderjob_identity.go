...
func (i *TranscoderJobIdentity) ID() string {
	return i.Job
}
...
func getIdentityFromTranscoderJobSpec(ctx context.Context, reader client.Reader, obj client.Object) (*TranscoderJobIdentity, error) {
...
func (obj *TranscoderJob) ExternalIdentifier() *string {
