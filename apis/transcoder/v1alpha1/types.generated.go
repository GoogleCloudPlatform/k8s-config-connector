...
// +kcc:proto=google.cloud.video.transcoder.v1.InputAttributes
...
type MuxStream struct {
	...
	// +kcc:proto:field=google.cloud.video.transcoder.v1.MuxStream.fmp4
	Fmp4 *MuxStream_Fmp4Config `json:"fmp4,omitempty"`
}

// +kcc:proto=google.cloud.video.transcoder.v1.MuxStream.Fmp4Config
type MuxStream_Fmp4Config struct {
	...
	//  - `hvc1` (default)
	//  - `hev1`
	// +kcc:proto:field=google.cloud.video.transcoder.v1.MuxStream.Fmp4Config.codec_tag
...
// +kcc:proto=google.cloud.video.transcoder.v1.TrackDefinition
type TrackDefinition struct {
	// The input track.
	// +kcc:proto:field=google.cloud.video.transcoder.v1.TrackDefinition.input_track
	InputTrack *int32 `json:"inputTrack,omitempty"`
	...
	// +kcc:proto:field=google.cloud.video.transcoder.v1.TrackDefinition.languages
	...
	// +kcc:proto:field=google.cloud.video.transcoder.v1.TrackDefinition.detect_languages
...
type VideoStream_H264CodecSettings struct {
	...
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.H264CodecSettings.frame_rate_conversion_strategy
	...
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.H264CodecSettings.sdr
	Sdr *VideoStream_H264ColorFormatSdr `json:"sdr,omitempty"`

	// Optional. HLG color format setting for H264.
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.H264CodecSettings.hlg
	Hlg *VideoStream_H264ColorFormatHlg `json:"hlg,omitempty"`
}
...
type VideoStream_H265CodecSettings struct {
	...
	// Optional. Frame rate conversion strategy for desired frame rate. The
	//  default is `DOWNSAMPLE`.
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.H265CodecSettings.frame_rate_conversion_strategy
	FrameRateConversionStrategy *string `json:"frameRateConversionStrategy,omitempty"`
	...
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.H265CodecSettings.sdr
	Sdr *VideoStream_H265ColorFormatSdr `json:"sdr,omitempty"`

	// Optional. HLG color format setting for H265.
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.H265CodecSettings.hlg
	Hlg *VideoStream_H265ColorFormatHlg `json:"hlg,omitempty"`

	// Optional. HDR10 color format setting for H265.
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.H265CodecSettings.hdr10
	Hdr10 *VideoStream_H265ColorFormatHdr10 `json:"hdr10,omitempty"`
}
...
type VideoStream_Vp9CodecSettings struct {
	...
	// Optional. Frame rate conversion strategy for desired frame rate. The
	//  default is `DOWNSAMPLE`.
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.Vp9CodecSettings.frame_rate_conversion_strategy
	FrameRateConversionStrategy *string `json:"frameRateConversionStrategy,omitempty"`
	...
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.Vp9CodecSettings.sdr
	Sdr *VideoStream_Vp9ColorFormatSdr `json:"sdr,omitempty"`

	// Optional. HLG color format setting for VP9.
	// +kcc:proto:field=google.cloud.video.transcoder.v1.VideoStream.Vp9CodecSettings.hlg
	Hlg *VideoStream_Vp9ColorFormatHlg `json:"hlg,omitempty"`
}
