...
func (in *CloudIdentityMembershipObservedState) DeepCopyInto(out *CloudIdentityMembershipObservedState) {
	*out = *in
	if in.Roles != nil {
		...
		*out = make([]*MembershipRolesObservedState, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MembershipRolesObservedState)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MembershipRolesObservedState) DeepCopyInto(out *MembershipRolesObservedState) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MembershipRolesObservedState.
func (in *MembershipRolesObservedState) DeepCopy() *MembershipRolesObservedState {
	if in == nil {
		return nil
	}
	out := new(MembershipRolesObservedState)
