...
// +kcc:spec:proto=google.apps.cloudidentity.groups.v1beta1.Membership
type CloudIdentityMembershipSpec struct {
	...
	// This field is considered output only and should not be set as PreferredMemberKey is required.
	...
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.Membership.preferred_member_key
	// +required
	PreferredMemberKey *EntityKey `json:"preferredMemberKey,omitempty"`

	// The `MembershipRole`s that apply to the `Membership`. If unspecified, defaults to a single `MembershipRole` with `name` `MEMBER`. Must not contain duplicate `MembershipRole`s with the same `name`.
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.Membership.roles
	// +required
...
type CloudIdentityMembershipStatus struct {
	...
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.Membership.delivery_setting
	...
	// Generated by DCL: https://github.com/GoogleCloudPlatform/declarative-resource-client-library/blob/main/services/google/cloudidentity/membership.go#L35
	...
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.Membership.type
	Type *string `json:"type,omitempty"`

	// Output only. The time when the `Membership` was last updated.
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.Membership.update_time
	// +kubebuilder:validation:Format=date-time
...
type MembershipExpiryDetail struct {
	...
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.ExpiryDetail.expire_time
	// +kubebuilder:validation:Format=date-time
	ExpireTime *string `json:"expireTime,omitempty"`
}

// +kcc:proto=google.apps.cloudidentity.groups.v1beta1.MembershipRoleRestrictionEvaluation
type MembershipRoleRestrictionEvaluation struct {
	// Output only. The current state of the restriction
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.MembershipRoleRestrictionEvaluation.state
	State *string `json:"state,omitempty"`
}

// +kcc:proto=google.apps.cloudidentity.groups.v1beta1.RestrictionEvaluations
type MembershipRestrictionEvaluations struct {
	// Evaluation of the member restriction applied to this membership. Empty if the user lacks permission to view the restriction evaluation.
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.RestrictionEvaluations.member_restriction_evaluation
...
type MembershipRoles struct {
	...
	// +kcc:proto:field=google.apps.cloudidentity.groups.v1beta1.MembershipRole.expiry_detail
