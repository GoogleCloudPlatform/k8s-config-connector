...
type BillingInfo struct {
	...
	UserCountBilling *UserCountBillingInfo `json:"userCountBilling"`
}
...
type LicenseManagerConfigurationSpec struct {
	...
	// Required. LicenseType to be applied for billing. Possible values: LICENSE_TYPE_PER_MONTH_PER_USER, LICENSE_TYPE_BRING_YOUR_OWN_LICENSE
	// +kubebuilder:validation:Required
	// +kubebuilder:validation:Enum=LICENSE_TYPE_PER_MONTH_PER_USER;LICENSE_TYPE_BRING_YOUR_OWN_LICENSE
	...
	CurrentBillingInfo *BillingInfo `json:"currentBillingInfo"`
	...
	NextBillingInfo *BillingInfo `json:"nextBillingInfo"`
