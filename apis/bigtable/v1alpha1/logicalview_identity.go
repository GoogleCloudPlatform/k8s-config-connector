...
func (i *LogicalViewIdentity) Parent() *v1beta1.BigtableInstanceIdentity {
	return i.parent
}
...
func ParseLogicalViewExternal(external string) (*v1beta1.BigtableInstanceIdentity, string, error) {
