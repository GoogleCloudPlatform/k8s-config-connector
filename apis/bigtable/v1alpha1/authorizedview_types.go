...
type BigtableAuthorizedViewStatus struct {
	...
	// A unique specifier for the BigtableAuthorizedView resource in Google Cloud.
...
// BigtableAuthorizedViewObservedState is the state of the BigtableAuthorizedView resource as most recently observed in Google Cloud.
