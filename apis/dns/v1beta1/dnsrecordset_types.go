...
var DNSRecordSetGVK = GroupVersion.WithKind("DNSRecordSet")

type RegionRef struct {
	/* The compute region name, when not managed by Config Connector. */
	// +optional
	External string `json:"external,omitempty"`

	// Name of a ComputeRegion object.
	// +optional
	Name string `json:"name,omitempty"`

	// Namespace of a ComputeRegion object
	// +optional
...
type DNSRecordSetSpec struct {
	ManagedZoneRef DNSManagedZoneRef `json:"managedZoneRef"`
