...
func getIdentityFromDataflowFlexTemplateJobSpec(ctx context.Context, reader client.Reader, obj *DataflowFlexTemplateJob) (*DataflowFlexTemplateJobIdentity, error) {
	...
	identity := &DataflowFlexTemplateJobIdentity{
		Project:  projectID,
		Location: region,
		Job:      resourceID,
	}
