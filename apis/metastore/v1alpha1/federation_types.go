...
type MetastoreFederationStatus struct {
	...
	// A unique specifier for the MetastoreFederation resource in Google Cloud.
...
// MetastoreFederationObservedState is the state of the MetastoreFederation resource as most recently observed in Google Cloud.
