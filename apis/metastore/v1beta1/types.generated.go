...
type KerberosConfig struct {
	...
	Keytab *v1alpha1.Secret `json:"keytab,omitempty"`
...
type NetworkConfig struct {
	...
	Consumers []v1alpha1.NetworkConfig_Consumer `json:"consumers,omitempty"`
}
...
type NetworkConfigObservedState struct {
	...
	//  Metastore instance.
	// +kcc:proto:field=google.cloud.metastore.v1.NetworkConfig.consumers
	Consumers []v1alpha1.NetworkConfig_ConsumerObservedState `json:"consumers,omitempty"`
}
