...
type AllUpdatesRule struct {
	...
	PubsubTopic *pubsub.PubSubTopicRef `json:"pubsubTopicRef,omitempty"`
	...
	MonitoringNotificationChannels []*monitoring.NotificationChannelRef `json:"monitoringNotificationChannels,omitempty"`
