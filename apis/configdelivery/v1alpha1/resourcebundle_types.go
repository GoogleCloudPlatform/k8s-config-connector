...
type ConfigDeliveryResourceBundleStatus struct {
	...
	// A unique specifier for the ConfigDeliveryResourceBundle resource in Google Cloud.
...
// ConfigDeliveryResourceBundleObservedState is the state of the ConfigDeliveryResourceBundle resource as most recently observed in Google Cloud.
