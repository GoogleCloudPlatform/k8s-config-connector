...
// +kcc:proto=google.cloud.modelarmor.v1.FloorSetting
type FloorSetting struct {
	// Identifier. The resource name.
	// +kcc:proto:field=google.cloud.modelarmor.v1.FloorSetting.name
	Name *string `json:"name,omitempty"`

	// Required. ModelArmor filter configuration.
	// +kcc:proto:field=google.cloud.modelarmor.v1.FloorSetting.filter_config
	FilterConfig *FilterConfig `json:"filterConfig,omitempty"`

	// Optional. Floor Settings enforcement status.
	// +kcc:proto:field=google.cloud.modelarmor.v1.FloorSetting.enable_floor_setting_enforcement
...
// +kcc:proto=google.cloud.modelarmor.v1.FloorSetting
type FloorSettingObservedState struct {
	// Output only. [Output only] Create timestamp
	// +kcc:proto:field=google.cloud.modelarmor.v1.FloorSetting.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. [Output only] Update timestamp
	// +kcc:proto:field=google.cloud.modelarmor.v1.FloorSetting.update_time
