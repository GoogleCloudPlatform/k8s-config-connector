...
// DocumentAIProcessorSpec defines the desired state of DocumentAIProcessorSpec
// +kcc:proto=google.cloud.documentai.v1beta3.Processor
...
type DocumentAIProcessorObservedState struct {
	...
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Processor.name
	Name *string `json:"name,omitempty"`

	// The time the processor was created.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Processor.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The state of the processor.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Processor.state
	State *string `json:"state,omitempty"`

	// Output only. The processor version aliases.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Processor.processor_version_aliases
	ProcessorVersionAliases []ProcessorVersionAlias `json:"processorVersionAliases,omitempty"`

	// Output only. Immutable. The http endpoint that can be called to invoke
	//  processing.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Processor.process_endpoint
	ProcessEndpoint *string `json:"processEndpoint,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Processor.satisfies_pzs
	SatisfiesPzs *bool `json:"satisfiesPzs,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Processor.satisfies_pzi
