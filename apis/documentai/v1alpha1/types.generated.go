...
// +kcc:proto=google.cloud.documentai.v1beta3.Evaluation
type Evaluation struct {
	// The resource name of the evaluation.
	//  Format:
	//  `projects/{project}/locations/{location}/processors/{processor}/processorVersions/{processor_version}/evaluations/{evaluation}`
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.name
	Name *string `json:"name,omitempty"`

	// The time that the evaluation was created.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Counters for the documents used in the evaluation.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.document_counters
	DocumentCounters *Evaluation_Counters `json:"documentCounters,omitempty"`

	// Metrics for all the entities in aggregate.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.all_entities_metrics
	...
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.kms_key_name
	KMSKeyName *string `json:"kmsKeyName,omitempty"`

	// The KMS key version with which data is encrypted.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.kms_key_version_name
	KMSKeyVersionName *string `json:"kmsKeyVersionName,omitempty"`
}

// +kcc:proto=google.cloud.documentai.v1beta3.Evaluation.ConfidenceLevelMetrics
type Evaluation_ConfidenceLevelMetrics struct {
	// The confidence level.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.ConfidenceLevelMetrics.confidence_level
	ConfidenceLevel *float32 `json:"confidenceLevel,omitempty"`

	// The metrics at the specific confidence level.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.ConfidenceLevelMetrics.metrics
	Metrics *Evaluation_Metrics `json:"metrics,omitempty"`
}

// +kcc:proto=google.cloud.documentai.v1beta3.Evaluation.Counters
type Evaluation_Counters struct {
	// How many documents were sent for evaluation.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.Counters.input_documents_count
	...
	//  pass validation.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.Counters.invalid_documents_count
	...
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.Counters.failed_documents_count
	FailedDocumentsCount *int32 `json:"failedDocumentsCount,omitempty"`

	// How many documents were used in the evaluation.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.Counters.evaluated_documents_count
...
// +kcc:proto=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics
type Evaluation_MultiConfidenceMetrics struct {
	// Metrics across confidence levels with fuzzy matching enabled.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics.confidence_level_metrics
	ConfidenceLevelMetrics []Evaluation_ConfidenceLevelMetrics `json:"confidenceLevelMetrics,omitempty"`

	// Metrics across confidence levels with only exact matching.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics.confidence_level_metrics_exact
	...
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics.auprc
	Auprc *float32 `json:"auprc,omitempty"`

	// The Estimated Calibration Error (ECE) of the confidence of the predicted
	//  entities.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics.estimated_calibration_error
	...
	//  only.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics.auprc_exact
	AuprcExact *float32 `json:"auprcExact,omitempty"`

	// The ECE for the predicted entities with fuzzy matching disabled, i.e.,
	//  exact matching only.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics.estimated_calibration_error_exact
	EstimatedCalibrationErrorExact *float32 `json:"estimatedCalibrationErrorExact,omitempty"`

	// The metrics type for the label.
	// +kcc:proto:field=google.cloud.documentai.v1beta3.Evaluation.MultiConfidenceMetrics.metrics_type
