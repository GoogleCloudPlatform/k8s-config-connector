...
var (
	VertexAIIndexEndpointIdentityFormat = gcpurls.Template[VertexAIIndexEndpointIdentity]("aiplatform.googleapis.com", "projects/{project}/locations/{location}/indexEndpoints/{indexendpoint}")
)

// VertexAIIndexEndpointIdentity is the identity of a GCP VertexAIIndexEndpoint resource.
