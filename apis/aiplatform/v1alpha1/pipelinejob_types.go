...
type VertexAIPipelineJobObservedState struct {
	// Output only. Pipeline job create time.
	// +optional
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Pipeline job start time.
	// +optional
	StartTime *string `json:"startTime,omitempty"`

	// Output only. Pipeline job end time.
	// +optional
	EndTime *string `json:"endTime,omitempty"`

	// Output only. Pipeline job update time.
	// +optional
	UpdateTime *string `json:"updateTime,omitempty"`

	// Output only. The state of the pipeline job.
	// +optional
