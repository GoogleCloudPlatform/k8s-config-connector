...
// AIPlatformSpecialistPoolRef is a reference to a GCP AIPlatformSpecialistPool.
type AIPlatformSpecialistPoolRef struct {
	// A reference to an externally managed AIPlatformSpecialistPool resource. Should be in the format "projects/{{projectID}}/locations/{{location}}/specialistPools/{{specialistPool}}"
