...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AIPlatformModelIdentity) DeepCopyInto(out *AIPlatformModelIdentity) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AIPlatformModelIdentity.
func (in *AIPlatformModelIdentity) DeepCopy() *AIPlatformModelIdentity {
	if in == nil {
		return nil
	}
	out := new(AIPlatformModelIdentity)
	in.DeepCopyInto(out)
	return out
}
