...
type VertexAIIndexEndpointRef struct {
	// A reference to an externally managed VertexAIIndexEndpoint resource. Should be in the format "projects/{{projectID}}/locations/{{location}}/indexEndpoints/{{indexendpoint}}"
...
func (r *VertexAIIndexEndpointRef) SetExternal(external string) {
	r.External = external
}

func (r *VertexAIIndexEndpointRef) ValidateExternal(external string) error {
...
func (r *VertexAIIndexEndpointRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromVertexAIIndexEndpointSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
