...
func getIdentityFromVertexAIScheduleSpec(ctx context.Context, reader client.Reader, obj client.Object) (*VertexAIScheduleIdentity, error) {
...
func (obj *VertexAISchedule) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	...
	if externalRef != "" {
		...
		if *specIdentity != *statusIdentity {
			return nil, fmt.Errorf("cannot change spec after resource has been created. specIdentity=%+v, statusIdentity=%+v", specIdentity, statusIdentity)
		}
	}
...
func (obj *VertexAISchedule) ExternalIdentifier() (string, error) {
	return common.ValueOf(obj.Status.ExternalRef), nil
}
