...
// VertexAIPersistentResourceIdentity is the identity of a GCP VertexAIPersistentResource resource.
...
func (i *VertexAIPersistentResourceIdentity) ParentString() string {
	return "projects/" + i.Project + "/locations/" + i.Location
}

func getIdentityFromVertexAIPersistentResourceSpec(ctx context.Context, reader client.Reader, obj *VertexAIPersistentResource) (*VertexAIPersistentResourceIdentity, error) {
