...
type StudySpec_ParameterSpec_ConditionalParameterSpec struct {
	...
	// ParameterSpec is a recursive type (StudySpec_ParameterSpec contains StudySpec_ParameterSpec_ConditionalParameterSpec which contains StudySpec_ParameterSpec).
