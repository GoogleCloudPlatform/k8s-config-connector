...
type AIPlatformModelStatus struct {
	...
	// A unique specifier for the AIPlatformModel resource in Google Cloud.
...
// AIPlatformModelObservedState is the state of the AIPlatformModel resource as most recently observed in Google Cloud.
