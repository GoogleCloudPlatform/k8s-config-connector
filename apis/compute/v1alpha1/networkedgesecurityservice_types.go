...
// ComputeNetworkEdgeSecurityServiceObservedState is the state of the ComputeNetworkEdgeSecurityService resource as most recently observed in Google Cloud.
