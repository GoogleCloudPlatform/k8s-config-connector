...
// ComputeFutureReservationParent holds the fields describing the parent of the ComputeFutureReservation resource.
type ComputeFutureReservationParent struct {
	// +required
...
// +kcc:spec:proto=google.cloud.compute.v1.FutureReservation
type ComputeFutureReservationSpec struct {
	// Parent reference.
	ComputeFutureReservationParent `json:",inline"`
