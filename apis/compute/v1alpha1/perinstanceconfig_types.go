...
type ComputePerInstanceConfigSpec struct {
	...
	InstanceGroupManagerRef *computev1beta1.ComputeInstanceGroupManagerRef `json:"instanceGroupManagerRef"`
	...
	* NONE. */
	...
	// The ComputePerInstanceConfig name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// ComputePerInstanceConfigStatus defines the config connector machine state of ComputePerInstanceConfig
type ComputePerInstanceConfigStatus struct {
	...
	// A unique specifier for the ComputePerInstanceConfig resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *ComputePerInstanceConfigObservedState `json:"observedState,omitempty"`
}

// ComputePerInstanceConfigObservedState is the state of the ComputePerInstanceConfig resource as most recently observed in GCP.
// +kcc:observedstate:proto=google.cloud.compute.v1.PerInstanceConfig
type ComputePerInstanceConfigObservedState struct {
}
...
// ComputePerInstanceConfig is the Schema for the ComputePerInstanceConfig API
