...
type ComputeFutureReservationStatus struct {
	...
	// A unique specifier for the ComputeFutureReservation resource in Google Cloud.
...
// ComputeFutureReservationObservedState is the state of the ComputeFutureReservation resource as most recently observed in Google Cloud.
