...
// +kcc:spec:proto=google.cloud.compute.v1beta.SecurityPolicyAssociation
...
// ComputeOrganizationSecurityPolicyAssociationStatus defines the config connector machine state of ComputeOrganizationSecurityPolicyAssociation
...
// ComputeOrganizationSecurityPolicyAssociation is the Schema for the ComputeOrganizationSecurityPolicyAssociation API
