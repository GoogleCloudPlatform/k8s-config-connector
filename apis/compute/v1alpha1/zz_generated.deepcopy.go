...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeNetworkFirewallPolicyRuleObservedState) DeepCopyInto(out *ComputeNetworkFirewallPolicyRuleObservedState) {
	*out = *in
	if in.Kind != nil {
		in, out := &in.Kind, &out.Kind
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComputeNetworkFirewallPolicyRuleObservedState.
func (in *ComputeNetworkFirewallPolicyRuleObservedState) DeepCopy() *ComputeNetworkFirewallPolicyRuleObservedState {
	if in == nil {
		return nil
	}
	out := new(ComputeNetworkFirewallPolicyRuleObservedState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComputeNetworkFirewallPolicyRuleSpec) DeepCopyInto(out *ComputeNetworkFirewallPolicyRuleSpec) {
	*out = *in
	...
	if in.FirewallPolicyRef != nil {
		...
		*out = new(v1beta1.ComputeNetworkFirewallPolicyRef)
		**out = **in
	}
	if in.Match != nil {
	...
	if in.TargetSecureTags != nil {
		...
		*out = make([]FirewallPolicyRuleSecureTag, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.TargetServiceAccountRefs != nil {
		...
		*out = make([]*v1beta1.IAMServiceAccountRef, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
