...
func (in *AutoscalingPolicy) DeepCopyInto(out *AutoscalingPolicy) {
	*out = *in
	...
	if in.ScalingSchedules != nil {
		...
		*out = make([]AutoscalingPolicyScalingSchedule, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComputeRegionAutoscalerObservedState) DeepCopyInto(out *ComputeRegionAutoscalerObservedState) {
	*out = *in
	if in.CreationTimestamp != nil {
		in, out := &in.CreationTimestamp, &out.CreationTimestamp
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComputeRegionAutoscalerObservedState.
func (in *ComputeRegionAutoscalerObservedState) DeepCopy() *ComputeRegionAutoscalerObservedState {
	if in == nil {
		return nil
	}
	out := new(ComputeRegionAutoscalerObservedState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComputeRegionAutoscalerSpec) DeepCopyInto(out *ComputeRegionAutoscalerSpec) {
	*out = *in
	...
	if in.TargetRef != nil {
		...
		*out = new(computev1beta1.ComputeInstanceGroupManagerRef)
		**out = **in
	}
}
