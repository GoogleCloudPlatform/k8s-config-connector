...
type InstanceProperties struct {
	...
	// +kcc:proto:field=google.cloud.compute.v1.InstanceProperties.local_ssd_encryption_mode
...
type Interconnect struct {
	...
	//  location field.
	// +kcc:proto:field=google.cloud.compute.v1.Interconnect.effective_location
...
/* unreachable type ShareSettingsFolderConfig
// +kcc:proto=google.cloud.compute.v1beta.ShareSettingsFolderConfig
type ShareSettingsFolderConfig struct {
	...
	// +kcc:proto:field=google.cloud.compute.v1beta.ShareSettingsFolderConfig.folder_id
