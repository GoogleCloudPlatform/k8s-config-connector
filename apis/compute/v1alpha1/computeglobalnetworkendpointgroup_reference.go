...
type ComputeGlobalNetworkEndpointGroupRef struct {
	...
	// Should be in the format "projects/{{projectID}}/global/networkEndpointGroups/{{globalNetworkEndpointGroupID}}".
...
func (r *ComputeGlobalNetworkEndpointGroupRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	...
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromComputeGlobalNetworkEndpointGroupSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
