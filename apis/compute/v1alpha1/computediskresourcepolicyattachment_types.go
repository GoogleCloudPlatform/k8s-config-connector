...
type ComputeDiskResourcePolicyAttachmentSpec struct {
	// Reference to the ComputeDisk to which the policy is attached.
	// +required
	DiskRef *refsv1beta1.ComputeDiskRef `json:"diskRef"`

	// Reference to the project that this resource belongs to.
	// +required
	ProjectRef *refsv1beta1.ProjectRef `json:"projectRef"`

	// Immutable. Optional. The name of the resource (the policy name to attach). Used for creation and acquisition. When unset, the value of `metadata.name` is used as the default.
	// +optional
...
type ComputeDiskResourcePolicyAttachmentStatus struct {
	...
	// A unique specifier for the ComputeDiskResourcePolicyAttachment resource in GCP.
	// +optional
