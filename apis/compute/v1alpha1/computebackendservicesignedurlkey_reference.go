...
type ComputeBackendServiceSignedURLKeyRef struct {
	...
	// Should be in the format "projects/{{projectID}}/global/backendServices/{{backendService}}/signedUrlKeys/{{signedUrlKey}}".
...
func init() {
	refs.Register(&ComputeBackendServiceSignedURLKeyRef{}, &ComputeBackendServiceSignedURLKey{})
}
