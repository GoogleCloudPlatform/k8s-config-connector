...
type ComputeNetworkAttachmentStatus struct {
	...
	// A unique specifier for the ComputeNetworkAttachment resource in Google Cloud.
...
// ComputeNetworkAttachmentObservedState is the state of the ComputeNetworkAttachment resource as most recently observed in Google Cloud.
