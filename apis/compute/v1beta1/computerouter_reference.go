...
func init() {
	refs.Register(&ComputeRouterRef{}, &ComputeRouter{})
}
...
func (r *ComputeRouterRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	...
	fallback := func(u *unstructured.Unstructured) string {
		...
		obj, err := common.ToStructuredType[*ComputeRouter](u)
		if err != nil {
			return ""
		}
		identity, err := getIdentityFromComputeRouterSpec(ctx, reader, obj)
		if err != nil {
			return ""
		}
