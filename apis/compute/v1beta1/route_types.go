...
type ComputeRouteNetworkRef struct {
...
type ComputeRouteNextHopILBRef struct {
...
type ComputeRouteNextHopInstanceRef struct {
...
type ComputeRouteNextHopVPNTunnelRef struct {
...
type ComputeRouteSpec struct {
	...
	NetworkRef *ComputeRouteNetworkRef `json:"networkRef"`
	...
	// +optional
	NextHopILBRef *ComputeRouteNextHopILBRef `json:"nextHopILBRef,omitempty"`

	/* Instance that should handle matching packets. */
	// +optional
	NextHopInstanceRef *ComputeRouteNextHopInstanceRef `json:"nextHopInstanceRef,omitempty"`

	/* Immutable. Network IP address of an instance that should
	...
	// +optional
	NextHopVPNTunnelRef *ComputeRouteNextHopVPNTunnelRef `json:"nextHopVPNTunnelRef,omitempty"`
	...
	/* Immutable. A list of instance tags to which this route
	   applies. */
	// +optional
...
// +kcc:status:proto=google.cloud.compute.v1.Route
