...
type ComputeHTTPSHealthCheckSpec struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.compute.v1.HealthCheck.https_health_check.host
	Host *string `json:"host,omitempty"`

	// The TCP port number for the HTTPS health check request. The default value is 443.
	// +optional
	// +kcc:proto:field=google.cloud.compute.v1.HealthCheck.https_health_check.port
	Port *int32 `json:"port,omitempty"`

	// The request path of the HTTPS health check request. The default value is /.
	// +optional
	// +kcc:proto:field=google.cloud.compute.v1.HealthCheck.https_health_check.request_path
