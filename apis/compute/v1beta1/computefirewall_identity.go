...
var (
	_ identity.IdentityV2 = &ComputeFirewallIdentity{}
	_ identity.Resource   = &ComputeFirewall{}
)

var ComputeFirewallIdentityFormat = gcpurls.Template[ComputeFirewallIdentity]("compute.googleapis.com", "projects/{project}/global/firewalls/{firewall}")

// ComputeFirewallIdentity is the identity of a GCP ComputeFirewall resource.
// +k8s:deepcopy-gen=false
type ComputeFirewallIdentity struct {
	Project  string
	Firewall string
}

func (i *ComputeFirewallIdentity) String() string {
	return ComputeFirewallIdentityFormat.ToString(*i)
}

func (i *ComputeFirewallIdentity) FromExternal(ref string) error {
...
func (i *ComputeFirewallIdentity) Host() string {
	return ComputeFirewallIdentityFormat.Host()
}

func (i *ComputeFirewallIdentity) ParentString() string {
	return fmt.Sprintf("projects/%s", i.Project)
}

func ParseComputeFirewallExternal(external string) (*ComputeFirewallIdentity, error) {
	if external == "" {
...
func getIdentityFromComputeFirewallSpec(ctx context.Context, reader client.Reader, obj *ComputeFirewall) (*ComputeFirewallIdentity, error) {
	...
	identity := &ComputeFirewallIdentity{
		Project:  projectID,
		Firewall: resourceID,
	}
	return identity, nil
...
func (obj *ComputeFirewall) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	...
	if selfLink != "" {
		statusIdentity := &ComputeFirewallIdentity{}
