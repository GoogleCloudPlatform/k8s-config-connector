...
var _ refsv1beta1.Ref = &ComputeInstanceTemplateRef{}
var ComputeInstanceTemplateGVK = GroupVersion.WithKind("ComputeInstanceTemplate")

type ComputeInstanceTemplateRef struct {
	// The value of an externally managed ComputeInstanceTemplate resource.
	// Should be in the format "https://www.googleapis.com/compute/{{version}}/projects/{{projectId}}/global/instanceTemplates/{{name}}" or "projects/{{projectId}}/global/instanceTemplates/{{name}}"
	External string `json:"external,omitempty"`

	// The name of a ComputeInstanceTemplate resource.
	Name string `json:"name,omitempty"`

	// The namespace of a ComputeInstanceTemplate resource.
	Namespace string `json:"namespace,omitempty"`
}

func (r *ComputeInstanceTemplateRef) GetGVK() schema.GroupVersionKind {
	return ComputeInstanceTemplateGVK
}
