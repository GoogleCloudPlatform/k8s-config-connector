...
var (
	ComputeRouterInterfaceGVK        = GroupVersion.WithKind("ComputeRouterInterface")
	ComputeRouterGVK                 = GroupVersion.WithKind("ComputeRouter")
	ComputeVPNTunnelGVK              = GroupVersion.WithKind("ComputeVPNTunnel")
	ComputeInterconnectAttachmentGVK = GroupVersion.WithKind("ComputeInterconnectAttachment")
)
...
var _ refsv1beta1.Ref = &ComputeVPNTunnelRef{}

type ComputeVPNTunnelRef struct {
	/* Allowed value: The `name` field of a `ComputeVPNTunnel` resource. */
	External string `json:"external,omitempty"`
	/* Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names */
	Name string `json:"name,omitempty"`
	/* Namespace of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ */
...
var _ refsv1beta1.Ref = &ComputeRouterRef{}
...
var _ refsv1beta1.Ref = &ComputeRouterInterfaceRef{}
...
func (r *ComputeRouterInterfaceRef) GetGVK() schema.GroupVersionKind {
	return ComputeRouterInterfaceGVK
}

func (r *ComputeRouterInterfaceRef) GetNamespacedName() types.NamespacedName {
	return types.NamespacedName{
		Name:      r.Name,
		Namespace: r.Namespace,
	}
...
func (r *ComputeRouterInterfaceRef) GetExternal() string {
	return r.External
}

func (r *ComputeRouterInterfaceRef) SetExternal(ref string) {
	r.External = ref
	r.Name = ""
	r.Namespace = ""
}

func (r *ComputeRouterInterfaceRef) ValidateExternal(ref string) error {
	return nil
}

func (r *ComputeRouterInterfaceRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	return refsv1beta1.Normalize(ctx, reader, r, defaultNamespace)
}
...
type ComputeRouterInterfaceSpec struct {
	// +optional
	LinkedInterconnectAttachmentRef *ComputeInterconnectAttachmentRef `json:"interconnectAttachmentRef,omitempty"`
	...
	// +optional
	LinkedVPNTunnelRef *ComputeVPNTunnelRef `json:"vpnTunnelRef,omitempty"`
}
...
func init() {
	...
	refsv1beta1.Register(&ComputeInterconnectAttachmentRef{})
	refsv1beta1.Register(&ComputeVPNTunnelRef{})
	refsv1beta1.Register(&ComputeRouterRef{})
	refsv1beta1.Register(&ComputeRouterInterfaceRef{})
}
