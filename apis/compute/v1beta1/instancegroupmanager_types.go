...
type ComputeInstanceGroupManagerHealthCheckRef struct {
...
type ComputeInstanceGroupManagerInstanceTemplateRef struct {
...
type ComputeInstanceGroupManagerServiceAccountRef struct {
...
type ComputeInstanceGroupManagerTargetPoolRef struct {
...
type InstanceGroupManagerAutoHealingPolicy struct {
	// +optional
	HealthCheckRef *ComputeInstanceGroupManagerHealthCheckRef `json:"healthCheckRef,omitempty"`
...
type InstanceGroupManagerZone struct {
...
type InstanceGroupManagerDistributionPolicy struct {
	...
	// +optional
	Zones []InstanceGroupManagerZone `json:"zones,omitempty"`
}
...
type InstanceGroupManagerPreservedStateDisk struct {
...
type InstanceGroupManagerPreservedStateExternalIp struct {
...
type InstanceGroupManagerPreservedStateInternalIp struct {
	/* These stateful IPs will never be released during autohealing, update or VM instance recreate operations. This flag is used to configure if the IP reservation should be deleted after it is no longer used by the group, e.g. when the given instance or the whole group is deleted. Possible values: NEVER, ON_PERMANENT_INSTANCE_DELETION */
	// +optional
	AutoDelete *string `json:"autoDelete,omitempty"`
}
...
type InstanceGroupManagerPreservedState struct {
	...
	// +optional
	Disks map[string]InstanceGroupManagerPreservedStateDisk `json:"disks,omitempty"`

	/* External network IPs assigned to the instances that will be preserved on instance delete, update, etc. This map is keyed with the network interface name. */
	// +optional
	ExternalIps map[string]InstanceGroupManagerPreservedStateExternalIp `json:"externalIps,omitempty"`

	/* Internal network IPs assigned to the instances that will be preserved on instance delete, update, etc. This map is keyed with the network interface name. */
	// +optional
	InternalIps map[string]InstanceGroupManagerPreservedStateInternalIp `json:"internalIps,omitempty"`
}
...
type InstanceGroupManagerVersion struct {
	// +optional
	InstanceTemplateRef *ComputeInstanceGroupManagerInstanceTemplateRef `json:"instanceTemplateRef,omitempty"`
...
type ComputeInstanceGroupManagerSpec struct {
	...
	// +optional
	NamedPorts []InstanceGroupManagerNamedPort `json:"namedPorts,omitempty"`
	...
	// +optional
	ServiceAccountRef *ComputeInstanceGroupManagerServiceAccountRef `json:"serviceAccountRef,omitempty"`
	...
	// +optional
	TargetPools []ComputeInstanceGroupManagerTargetPoolRef `json:"targetPools,omitempty"`
...
type ComputeInstanceGroupManager struct {
	...
	Spec   ComputeInstanceGroupManagerSpec   `json:"spec"`
