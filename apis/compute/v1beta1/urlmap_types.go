...
type UrlmapAbortRequired struct {
...
type UrlmapCorsPolicyRequired struct {
	// +optional
	AllowCredentials *bool `json:"allowCredentials,omitempty"`
...
type UrlmapDefaultService struct {
	// +optional
	BackendBucketRef *UrlmapResourceRef `json:"backendBucketRef,omitempty"`

	// +optional
	BackendServiceRef *UrlmapResourceRef `json:"backendServiceRef,omitempty"`
}
...
type UrlmapDefaultCustomErrorResponsePolicy struct {
	...
	// +optional
	ErrorServiceRef *UrlmapResourceRef `json:"errorServiceRef,omitempty"`
}

// +kcc:proto=google.cloud.compute.v1.CustomErrorResponseRule
...
type UrlmapDelayRequired struct {
	FixedDelay UrlmapFixedDelayRequired `json:"fixedDelay"`

	Percentage float64 `json:"percentage"`
}

type UrlmapDelayRouteRules struct {
	// +optional
	FixedDelay *UrlmapFixedDelayRequired `json:"fixedDelay,omitempty"`
...
type UrlmapFaultInjectionPolicyRequired struct {
	// +optional
	Abort *UrlmapAbortRequired `json:"abort,omitempty"`

	// +optional
	Delay *UrlmapDelayRequired `json:"delay,omitempty"`
}

type UrlmapFaultInjectionPolicyRouteRules struct {
	// +optional
	Abort *UrlmapAbort `json:"abort,omitempty"`

	// +optional
	Delay *UrlmapDelayRouteRules `json:"delay,omitempty"`
}
...
type UrlmapFixedDelayRequired struct {
	// +optional
	Nanos *int64 `json:"nanos,omitempty"`
...
type UrlmapHeaderActionOptional struct {
	// +optional
	RequestHeadersToAdd []UrlmapRequestHeadersToAddOptional `json:"requestHeadersToAdd,omitempty"`

	// +optional
	RequestHeadersToRemove []string `json:"requestHeadersToRemove,omitempty"`

	// +optional
	ResponseHeadersToAdd []UrlmapResponseHeadersToAddOptional `json:"responseHeadersToAdd,omitempty"`
...
type UrlmapPathMatcher struct {
	...
	// +optional
	DefaultRouteAction *UrlmapRouteActionPathMatcherDefaultRouteAction `json:"defaultRouteAction,omitempty"`
...
type UrlmapPathRule struct {
	...
	// +optional
	RouteAction *UrlmapRouteActionPathRule `json:"routeAction,omitempty"`
	...
	be set. */
	// +optional
	UrlRedirect *UrlmapDefaultUrlRedirect `json:"urlRedirect,omitempty"`
}
...
type UrlmapPerTryTimeoutRequired struct {
	// +optional
	Nanos *int64 `json:"nanos,omitempty"`
...
type UrlmapRequestHeadersToAddOptional struct {
	/* The name of the header. */
	// +optional
...
type UrlmapRequestMirrorPolicyRequired struct {
	BackendServiceRef UrlmapResourceRef `json:"backendServiceRef"`
}
...
type UrlmapResponseHeadersToAddOptional struct {
	/* The name of the header. */
	// +optional
	HeaderName *string `json:"headerName,omitempty"`
...
type UrlmapRetryPolicyOptional struct {
	// +optional
	NumRetries *int64 `json:"numRetries,omitempty"`

	// +optional
	PerTryTimeout *UrlmapPerTryTimeoutRequired `json:"perTryTimeout,omitempty"`

	// +optional
	RetryConditions []string `json:"retryConditions,omitempty"`
}

type UrlmapRetryPolicyRequired struct {
...
type UrlmapRouteActionRouteRules struct {
	/* The specification for allowing client side cross-origin requests. Please see W3C
	Recommendation for Cross Origin Resource Sharing. */
	// +optional
	CorsPolicy *UrlmapCorsPolicy `json:"corsPolicy,omitempty"`
	...
	ignored by clients that are configured with a fault_injection_policy. */
	// +optional
	FaultInjectionPolicy *UrlmapFaultInjectionPolicyRouteRules `json:"faultInjectionPolicy,omitempty"`
	...
	service, the host / authority header is suffixed with -shadow. */
	// +optional
	RequestMirrorPolicy *UrlmapRequestMirrorPolicyRequired `json:"requestMirrorPolicy,omitempty"`

	/* Specifies the retry policy associated with this route. */
	// +optional
	RetryPolicy *UrlmapRetryPolicyRequired `json:"retryPolicy,omitempty"`
	...
	specified, the default value is 15 seconds. */
	// +optional
	Timeout *UrlmapTimeoutRequired `json:"timeout,omitempty"`

	/* The spec to modify the URL of the request, prior to forwarding the request to
	the matched service. */
	// +optional
	UrlRewrite *UrlmapUrlRewriteWithPathTemplate `json:"urlRewrite,omitempty"`
	...
	HttpRouteAction. */
	// +optional
	WeightedBackendServices []UrlmapWeightedBackendServicesRequired `json:"weightedBackendServices,omitempty"`
}

type UrlmapRouteActionPathRule struct {
	/* The specification for allowing client side cross-origin requests. Please see W3C
	Recommendation for Cross Origin Resource Sharing. */
	// +optional
	CorsPolicy *UrlmapCorsPolicyRequired `json:"corsPolicy,omitempty"`
	...
	ignored by clients that are configured with a fault_injection_policy. */
	// +optional
	FaultInjectionPolicy *UrlmapFaultInjectionPolicyRequired `json:"faultInjectionPolicy,omitempty"`
	...
	/* Specifies the retry policy associated with this route. */
	// +optional
	RetryPolicy *UrlmapRetryPolicyOptional `json:"retryPolicy,omitempty"`
...
type UrlmapRouteActionPathMatcherDefaultRouteAction struct {
	/* The specification for allowing client side cross-origin requests. Please see W3C
	Recommendation for Cross Origin Resource Sharing. */
	// +optional
	CorsPolicy *UrlmapCorsPolicy `json:"corsPolicy,omitempty"`
...
type UrlmapRouteRules struct {
	...
	or urlRedirect must be set. */
	// +optional
	RouteAction *UrlmapRouteActionRouteRules `json:"routeAction,omitempty"`
...
type UrlmapTimeoutRequired struct {
	// +optional
	Nanos *int64 `json:"nanos,omitempty"`
...
type UrlmapUrlRewriteWithPathTemplate struct {
	/* Prior to forwarding the request to the selected service, the request's host
	header is replaced with contents of hostRewrite. The value must be between 1 and
	255 characters. */
	// +optional
...
type UrlmapWeightedBackendServices struct {
	...
	// +optional
	HeaderAction *UrlmapHeaderActionOptional `json:"headerAction,omitempty"`
...
type UrlmapWeightedBackendServicesRequired struct {
	BackendServiceRef UrlmapResourceRef `json:"backendServiceRef"`
...
type ComputeURLMap struct {
	...
	// +required
	Spec   ComputeURLMapSpec   `json:"spec"`
