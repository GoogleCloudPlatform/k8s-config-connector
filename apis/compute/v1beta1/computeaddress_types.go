...
type ComputeAddressSpec struct {
	...
	/* Immutable. The IP Version that will be used by this
	...
	/* Immutable. The prefix length if the resource represents
	   an IP range. */
	// +optional
...
// +kcc:status:proto=google.cloud.compute.v1.Address
