...
var ComputeProjectMetadataGVK = GroupVersion.WithKind("ComputeProjectMetadata")

// ComputeProjectMetadataSpec defines the desired state of ComputeProjectMetadata
// +kcc:spec:proto=google.cloud.compute.v1.Metadata
type ComputeProjectMetadataSpec struct {
	/* A series of key value pairs. */
	Metadata map[string]string `json:"metadata"`
}

// ComputeProjectMetadataStatus defines the config connector machine state of ComputeProjectMetadata
...
// +kubebuilder:resource:categories=gcp,shortName=gcpcomputeprojectmetadata;gcpcomputeprojectmetadatas,path=computeprojectmetadatas
...
// ComputeProjectMetadata is the Schema for the ComputeProjectMetadata API
// +k8s:openapi-gen=true
type ComputeProjectMetadata struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   ComputeProjectMetadataSpec   `json:"spec"`
