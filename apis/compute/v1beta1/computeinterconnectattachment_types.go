...
// +kcc:spec:proto=google.cloud.compute.v1.InterconnectAttachment
type ComputeInterconnectAttachmentSpec struct {
	...
	* IPSEC - The VLAN attachment carries only encrypted traffic that is
	...
	// +optional
	IpsecInternalAddresses []ComputeAddressRef `json:"ipsecInternalAddresses,omitempty"`
...
// ComputeInterconnectAttachmentStatus defines the config connector machine state of ComputeInterconnectAttachment
