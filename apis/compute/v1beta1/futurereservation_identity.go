...
type FutureReservationIdentity struct {
	parent *FutureReservationParentIdentity
	id     string
}
...
func (i *FutureReservationIdentity) Parent() *FutureReservationParentIdentity {
	return i.parent
}

type FutureReservationParentIdentity struct {
	ProjectID string
	Zone      string
}

func (p *FutureReservationParentIdentity) String() string {
...
func ParseFutureReservationExternal(external string) (parent *FutureReservationParentIdentity, resourceID string, err error) {
