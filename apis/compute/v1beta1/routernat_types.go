...
type RouternatAction struct {
	// +optional
	SourceNatActiveIpsRefs []ResourceRef `json:"sourceNatActiveIpsRefs,omitempty"`

	// +optional
	SourceNatDrainIpsRefs []ResourceRef `json:"sourceNatDrainIpsRefs,omitempty"`
}
...
type RouternatSubnetwork struct {
	...
	SubnetworkRef ResourceRef `json:"subnetworkRef"`
}
...
type ComputeRouterNATSpec struct {
	// +optional
	DrainNatIps []ResourceRef `json:"drainNatIps,omitempty"`
	...
	// +optional
	NatIps []ResourceRef `json:"natIps,omitempty"`
	...
	RouterRef ResourceRef `json:"routerRef"`
...
type ComputeRouterNAT struct {
	...
	Spec   ComputeRouterNATSpec   `json:"spec"`
