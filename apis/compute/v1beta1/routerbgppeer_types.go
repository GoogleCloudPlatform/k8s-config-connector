...
type ComputeRouterPeerSpec struct {
	...
	* 'ALL_SUBNETS': Advertises all of the router's own VPC subnets.
	...
	// +optional
	RouterApplianceInstanceRef *ComputeRouterPeerRef `json:"routerApplianceInstanceRef,omitempty"`

	/* The interface the BGP peer is associated with. */
	RouterInterfaceRef ComputeRouterPeerRef `json:"routerInterfaceRef"`

	/* The Cloud Router in which this BGP peer will be configured. */
	RouterRef ComputeRouterPeerRef `json:"routerRef"`
}
...
type ComputeRouterPeer struct {
	...
	Spec   ComputeRouterPeerSpec   `json:"spec"`
