...
type ComputeNetworkSpec struct {
	...
	// Default value: "AFTER_CLASSIC_FIREWALL" Possible values: ["BEFORE_CLASSIC_FIREWALL", "AFTER_CLASSIC_FIREWALL"].
...
type ComputeNetworkStatus struct {
	...
	// is selected by GCP.
	// +kcc:proto:field=google.cloud.compute.v1.Network.gateway_ipv4
