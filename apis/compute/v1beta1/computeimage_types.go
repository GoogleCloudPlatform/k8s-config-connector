...
type ImageImageEncryptionKey struct {
	...
	KMS. */
	// +optional
	KmsKeySelfLinkRef *kmsv1beta1.KMSCryptoKeyRef `json:"kmsKeySelfLinkRef,omitempty"`
...
type ComputeImageSpec struct {
	...
	// +optional
	DiskRef *ComputeDiskRef `json:"diskRef,omitempty"`
...
// +kcc:status:proto=google.cloud.compute.v1.Image
