...
// distributed under the License is distributed on invites or implied.
...
// ComputeDiskRef is a reference to a GCP ComputeDisk.
type ComputeDiskRef struct {
	// A reference to an externally managed ComputeDisk resource.
	// Should be in the format "projects/{{projectID}}/zones/{{zone}}/disks/{{diskID}}" or "projects/{{projectID}}/regions/{{region}}/disks/{{diskID}}".
