...
// +kubebuilder:validation:XValidation:rule="has(self.instanceGroupRef) != has(self.networkEndpointGroupRef)",message="exactly one of instanceGroupRef or networkEndpointGroupRef must be specified"
...
// +kubebuilder:validation:XValidation:rule="has(self.oauth2ClientId) != has(self.oauth2ClientIdRef)",message="exactly one of oauth2ClientId or oauth2ClientIdRef must be specified"
