...
func (r *ComputeSSLCertificateRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	...
	if externalRef == "" {
		if externalRef, err = sslCertificateLegacyExternalRef(ctx, reader, u); err != nil {
			return err
		}
	}
	if externalRef == "" {
...
func sslCertificateLegacyExternalRef(ctx context.Context, reader client.Reader, u *unstructured.Unstructured) (string, error) {
