...
type ComputeInterconnectAttachmentRouterRef struct {
...
type ComputeInterconnectAttachmentIpsecInternalAddressesRef struct {
...
type ComputeInterconnectAttachmentSpec struct {
	...
	* IPSEC - The VLAN attachment carries only encrypted traffic that is
	...
	// +optional
	IpsecInternalAddresses []ComputeInterconnectAttachmentIpsecInternalAddressesRef `json:"ipsecInternalAddresses,omitempty"`
	...
	is configured. */
	RouterRef ComputeInterconnectAttachmentRouterRef `json:"routerRef"`
...
// ComputeInterconnectAttachment is the Schema for the ComputeInterconnectAttachment API
