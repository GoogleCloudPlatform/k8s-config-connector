...
var ComputeHTTPSHealthCheckGVK = GroupVersion.WithKind("ComputeHTTPSHealthCheck")
...
// ComputeHTTPSHealthCheckStatus defines the config connector machine state of ComputeHTTPSHealthCheck
...
// ComputeHTTPSHealthCheck is the Schema for the ComputeHTTPSHealthCheck API
