...
type DiskAsyncPrimaryDisk struct {
	...
	DiskRef ComputeDiskRef `json:"diskRef"`
}
...
// +kcc:spec:proto=google.cloud.compute.v1.Disk
type ComputeDiskSpec struct {
	...
	// +optional
	ImageRef *ComputeImageRef `json:"imageRef,omitempty"`
	...
	// +optional
	SnapshotRef *ComputeSnapshotRef `json:"snapshotRef,omitempty"`
...
// ComputeDiskStatus defines the config connector machine state of ComputeDisk
type ComputeDiskStatus struct {
	...
	// A unique specifier for the ComputeDisk resource in GCP.
	// +optional
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	// +optional
	ObservedState *ComputeDiskObservedState `json:"observedState,omitempty"`
...
// ComputeDiskObservedState is the state of the ComputeDisk resource as most recently observed in GCP.
// +kcc:observedstate:proto=google.cloud.compute.v1.Disk
type ComputeDiskObservedState struct {
}
...
// ComputeDisk is the Schema for the ComputeDisk API
