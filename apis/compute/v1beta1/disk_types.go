...
type DiskDiskEncryptionKey struct {
	...
	// +optional
	RsaEncryptedKey *secret.Legacy `json:"rsaEncryptedKey,omitempty"`
...
type ComputeDiskSpec struct {
	...
	// +optional
	SourceImageRef *ComputeImageRef `json:"imageRef,omitempty"`
	...
	// +optional
	SourceSnapshotRef *ComputeSnapshotRef `json:"snapshotRef,omitempty"`
...
// +kcc:status:proto=google.cloud.compute.v1.Disk
