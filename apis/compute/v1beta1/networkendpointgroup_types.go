...
type RegionnetworkendpointgroupCloudFunction struct {
	...
	Example value: "func1". */
	// +optional
	FunctionRef *CloudFunctionsFunctionRef `json:"functionRef,omitempty"`
...
type RegionnetworkendpointgroupCloudRun struct {
	...
	// +optional
	ServiceRef *RunServiceRef `json:"serviceRef,omitempty"`
...
// +kcc:status:proto=google.cloud.compute.v1.NetworkEndpointGroup
