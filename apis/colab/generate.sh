...
if [ -d "${REPO_ROOT}/pkg/controller/direct/colab" ]; then
  go run -mod=readonly golang.org/x/tools/cmd/goimports@${GOLANG_X_TOOLS_VERSION} -w pkg/controller/direct/colab/
fi
