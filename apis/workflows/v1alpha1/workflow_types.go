...
type WorkflowsWorkflowSpec struct {
	// The WorkflowsWorkflow name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// WorkflowsWorkflowStatus defines the config connector machine state of WorkflowsWorkflow
type WorkflowsWorkflowStatus struct {
	...
	// A unique specifier for the WorkflowsWorkflow resource in GCP.
...
// WorkflowsWorkflowObservedState is the state of the WorkflowsWorkflow resource as most recently observed in GCP.
// +kcc:proto=google.cloud.workflows.v1.Workflow
...
// WorkflowsWorkflow is the Schema for the WorkflowsWorkflow API
