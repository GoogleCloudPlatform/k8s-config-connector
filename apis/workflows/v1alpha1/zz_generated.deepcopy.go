...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Workflow_StateErrorObservedState) DeepCopyInto(out *Workflow_StateErrorObservedState) {
	*out = *in
	if in.Details != nil {
		in, out := &in.Details, &out.Details
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Workflow_StateErrorObservedState.
func (in *Workflow_StateErrorObservedState) DeepCopy() *Workflow_StateErrorObservedState {
	if in == nil {
		return nil
	}
	out := new(Workflow_StateErrorObservedState)
	in.DeepCopyInto(out)
	return out
}
