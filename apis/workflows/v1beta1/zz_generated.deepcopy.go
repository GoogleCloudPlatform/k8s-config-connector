...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Workflow_StateError) DeepCopyInto(out *Workflow_StateError) {
	*out = *in
	if in.Details != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Workflow_StateError.
func (in *Workflow_StateError) DeepCopy() *Workflow_StateError {
	if in == nil {
		return nil
	}
	out := new(Workflow_StateError)
	in.DeepCopyInto(out)
	return out
}
