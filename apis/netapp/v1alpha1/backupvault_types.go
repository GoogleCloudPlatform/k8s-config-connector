...
type BackupVaultStatus struct {
	...
	// A unique specifier for the NetAppBackupVault resource in Google Cloud.
...
// NetAppBackupVaultObservedState is the state of the NetAppBackupVault resource as most recently observed in Google Cloud.
