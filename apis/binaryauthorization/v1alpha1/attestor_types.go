...
var BinaryauthorizationAttestorGVK = GroupVersion.WithKind("BinaryauthorizationAttestor")
...
type BinaryauthorizationAttestorSpec struct {
	// The BinaryauthorizationAttestor name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// BinaryauthorizationAttestorStatus defines the config connector machine state of BinaryauthorizationAttestor
type BinaryauthorizationAttestorStatus struct {
	...
	// A unique specifier for the BinaryauthorizationAttestor resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *BinaryauthorizationAttestorObservedState `json:"observedState,omitempty"`
}

// BinaryauthorizationAttestorObservedState is the state of the BinaryauthorizationAttestor resource as most recently observed in GCP.
// +kcc:proto=google.cloud.binaryauthorization.v1.Attestor
type BinaryauthorizationAttestorObservedState struct {
}
...
// BinaryauthorizationAttestor is the Schema for the BinaryauthorizationAttestor API
