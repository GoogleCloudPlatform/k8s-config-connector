...
// +kcc:spec:proto=google.cloud.binaryauthorization.v1.Attestor
type BinaryAuthorizationAttestorSpec struct {
	...
	// +optional
	UserOwnedGrafeasNote *UserOwnedGrafeasNote `json:"userOwnedDrydockNote,omitempty"`
}
...
// +kcc:status:proto=google.cloud.binaryauthorization.v1.Attestor
type BinaryAuthorizationAttestorStatus struct {
	...
	// +optional
	UserOwnedGrafeasNote *UserOwnedGrafeasNoteStatus `json:"userOwnedDrydockNote,omitempty"`
}

// +kcc:status:proto=google.cloud.binaryauthorization.v1.UserOwnedGrafeasNote
type UserOwnedGrafeasNoteStatus struct {
