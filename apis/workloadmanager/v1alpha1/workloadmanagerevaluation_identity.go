...
// WorkloadManagerEvaluationIdentity is the identity of a GCP WorkloadManagerEvaluation resource.
...
func (i *WorkloadManagerEvaluationIdentity) ParentString() string {
	return fmt.Sprintf("projects/%s/locations/%s", i.Project, i.Location)
}

func getIdentityFromWorkloadManagerEvaluationSpec(ctx context.Context, reader client.Reader, obj *WorkloadManagerEvaluation) (*WorkloadManagerEvaluationIdentity, error) {
