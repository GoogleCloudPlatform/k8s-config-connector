...
var DialogflowIntentGVK = GroupVersion.WithKind("DialogflowIntent")
...
type DialogflowIntentSpec struct {
	// The DialogflowIntent name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// DialogflowIntentStatus defines the config connector machine state of DialogflowIntent
type DialogflowIntentStatus struct {
	...
	// A unique specifier for the DialogflowIntent resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *DialogflowIntentObservedState `json:"observedState,omitempty"`
}

// DialogflowIntentObservedState is the state of the DialogflowIntent resource as most recently observed in GCP.
// +kcc:proto=google.cloud.dialogflow.cx.v3.Intent
type DialogflowIntentObservedState struct {
}
...
// DialogflowIntent is the Schema for the DialogflowIntent API
