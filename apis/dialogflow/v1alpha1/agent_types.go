...
var DialogflowAgentGVK = GroupVersion.WithKind("DialogflowAgent")
...
type DialogflowAgentSpec struct {
	// The DialogflowAgent name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// DialogflowAgentStatus defines the config connector machine state of DialogflowAgent
type DialogflowAgentStatus struct {
	...
	// A unique specifier for the DialogflowAgent resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *DialogflowAgentObservedState `json:"observedState,omitempty"`
}

// DialogflowAgentObservedState is the state of the DialogflowAgent resource as most recently observed in GCP.
// +kcc:proto=google.cloud.dialogflow.cx.v3.Agent
type DialogflowAgentObservedState struct {
}
...
// DialogflowAgent is the Schema for the DialogflowAgent API
