...
type ConnectionObservedState struct {
	...
	// +optional
	// +kubebuilder:validation:Enum=STATE_UNSPECIFIED;CONNECTED;DISCONNECTED;AUTHENTICATION_FAILED;KEEPALIVE
	...
	// The error details for the connection. Only populated when authentication errors occur.
	// +optional
...
type Connection_ErrorDetailsObservedState struct {
	...
	// +optional
	// +kubebuilder:validation:Enum=CERTIFICATE_STATE_UNSPECIFIED;CERTIFICATE_VALID;CERTIFICATE_INVALID;CERTIFICATE_EXPIRED;CERTIFICATE_HOSTNAME_NOT_FOUND;CERTIFICATE_UNAUTHENTICATED;CERTIFICATE_TRUST_STORE_NOT_FOUND;CERTIFICATE_HOSTNAME_INVALID_FORMAT;CERTIFICATE_QUOTA_EXCEEDED
