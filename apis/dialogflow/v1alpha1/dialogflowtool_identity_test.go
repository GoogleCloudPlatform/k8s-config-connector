...
func TestDialogflowToolIdentity_FromExternal(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			ref:  "projects/my-project/locations/us-central1/tools/my-tool",
			want: &DialogflowToolIdentity{
				Project:  "my-project",
		...
		{
			name: "full url",
			ref:  "https://dialogflow.googleapis.com/projects/my-project/locations/us-central1/tools/my-tool",
			want: &DialogflowToolIdentity{
				Project:  "my-project",
				Location: "us-central1",
				Tool:     "my-tool",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.wantErr {
				...
				if i.Tool != tt.want.Tool {
					t.Errorf("Tool = %v, want %v", i.Tool, tt.want.Tool)
				}
			}
		})
	}
