...
// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.Agent
type Agent struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.name
	Name *string `json:"name,omitempty"`

	// Required. The human-readable name of the agent, unique within the location.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.display_name
	...
	//  [Agents.UpdateAgent][google.cloud.dialogflow.cx.v3beta1.Agents.UpdateAgent]
	//  method.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.default_language_code
	DefaultLanguageCode *string `json:"defaultLanguageCode,omitempty"`

	// The list of all languages supported by the agent (except for the
	//  `default_language_code`).
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.supported_language_codes
	SupportedLanguageCodes []string `json:"supportedLanguageCodes,omitempty"`

	// Required. The time zone of the agent from the [time zone
	//  database](https://www.iana.org/time-zones), e.g., America/New_York,
	//  Europe/Paris.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.time_zone
	TimeZone *string `json:"timeZone,omitempty"`

	// The description of the agent. The maximum length is 500 characters. If
	//  exceeded, the request is rejected.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.description
	...
	//  integration.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.avatar_uri
	AvatarURI *string `json:"avatarURI,omitempty"`

	// Speech recognition related settings.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.speech_to_text_settings
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.start_flow
	...
	//   "00000000-0000-0000-0000-000000000000" is allowed.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.start_playbook
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.security_settings
	...
	//  instead.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.enable_stackdriver_logging
	EnableStackdriverLogging *bool `json:"enableStackdriverLogging,omitempty"`

	// Indicates if automatic spell correction is enabled in detect intent
	//  requests.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.enable_spell_correction
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.enable_multi_language_training
	EnableMultiLanguageTraining *bool `json:"enableMultiLanguageTraining,omitempty"`

	// Indicates whether the agent is locked for changes. If the agent is locked,
	//  modifications to the agent will be rejected except for [RestoreAgent][].
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.locked
	Locked *bool `json:"locked,omitempty"`

	// Hierarchical advanced settings for this agent. The settings exposed at the
	//  lower level overrides the settings exposed at the higher level.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.advanced_settings
	AdvancedSettings *AdvancedSettings `json:"advancedSettings,omitempty"`

	// Git integration settings for this agent.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.git_integration_settings
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.bigquery_export_settings
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.text_to_speech_settings
	TextToSpeechSettings *TextToSpeechSettings `json:"textToSpeechSettings,omitempty"`

	// Gen App Builder-related agent-level settings.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.gen_app_builder_settings
	GenAppBuilderSettings *Agent_GenAppBuilderSettings `json:"genAppBuilderSettings,omitempty"`

	// Optional. Answer feedback collection settings.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.answer_feedback_settings
	AnswerFeedbackSettings *Agent_AnswerFeedbackSettings `json:"answerFeedbackSettings,omitempty"`

	// Optional. Settings for end user personalization.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.personalization_settings
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.client_certificate_settings
	ClientCertificateSettings *Agent_ClientCertificateSettings `json:"clientCertificateSettings,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.Agent.AnswerFeedbackSettings
type Agent_AnswerFeedbackSettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.AnswerFeedbackSettings.enable_answer_feedback
	EnableAnswerFeedback *bool `json:"enableAnswerFeedback,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.Agent.ClientCertificateSettings
type Agent_ClientCertificateSettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.ClientCertificateSettings.ssl_certificate
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.ClientCertificateSettings.private_key
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.ClientCertificateSettings.passphrase
	Passphrase *string `json:"passphrase,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.Agent.GenAppBuilderSettings
type Agent_GenAppBuilderSettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.GenAppBuilderSettings.engine
	Engine *string `json:"engine,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings
type Agent_GitIntegrationSettings struct {
	// GitHub settings.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings.github_settings
	GithubSettings *Agent_GitIntegrationSettings_GithubSettings `json:"githubSettings,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings.GithubSettings
type Agent_GitIntegrationSettings_GithubSettings struct {
	// The unique repository display name for the GitHub repository.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings.GithubSettings.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// The GitHub repository URI related to the agent.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings.GithubSettings.repository_uri
	RepositoryURI *string `json:"repositoryURI,omitempty"`

	// The branch of the GitHub repository tracked for this agent.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings.GithubSettings.tracking_branch
	TrackingBranch *string `json:"trackingBranch,omitempty"`

	// The access token used to authenticate the access to the GitHub
	//  repository.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings.GithubSettings.access_token
	AccessToken *string `json:"accessToken,omitempty"`

	// A list of branches configured to be used from Dialogflow.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.GitIntegrationSettings.GithubSettings.branches
	Branches []string `json:"branches,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.Agent.PersonalizationSettings
type Agent_PersonalizationSettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.Agent.PersonalizationSettings.default_end_user_metadata
	DefaultEndUserMetadata map[string]string `json:"defaultEndUserMetadata,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.BigQueryExportSettings
type BigQueryExportSettings struct {
	// The field to indicate whether the BigQuery export is enabled.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.BigQueryExportSettings.enabled
	Enabled *bool `json:"enabled,omitempty"`

	// The BigQuery table to export.
	//  Format: `projects/<ProjectID>/datasets/<DatasetID>/tables/<TableID>`.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.BigQueryExportSettings.bigquery_table
...
// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.SpeechToTextSettings
type SpeechToTextSettings struct {
	// Whether to use speech adaptation for speech recognition.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SpeechToTextSettings.enable_speech_adaptation
...
// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.TextToSpeechSettings
