...
type Deployment struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.name
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.flow_version
	FlowVersion *string `json:"flowVersion,omitempty"`

	// The current state of the deployment.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.state
	State *string `json:"state,omitempty"`

	// Result of the deployment.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.result
	Result *Deployment_Result `json:"result,omitempty"`

	// Start time of this deployment.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.start_time
	StartTime *string `json:"startTime,omitempty"`

	// End time of this deployment.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.end_time
	EndTime *string `json:"endTime,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3.Deployment.Result
type Deployment_Result struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.Result.deployment_test_results
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3.Deployment.Result.experiment
