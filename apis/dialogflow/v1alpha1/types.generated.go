...
// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.SecuritySettings
type SecuritySettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.name
	Name *string `json:"name,omitempty"`

	// Required. The human-readable name of the security settings, unique within
	//  the location.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// Strategy that defines how we do redaction.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.redaction_strategy
	...
	//  logging.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.redaction_scope
	...
	//  `SecuritySettings`.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.inspect_template
	...
	//  `SecuritySettings`.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.deidentify_template
	...
	//  change stays intact.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.retention_window_days
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.retention_strategy
	RetentionStrategy *string `json:"retentionStrategy,omitempty"`

	// List of types of data to remove when retention settings triggers purge.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.purge_data_types
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.audio_export_settings
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.insights_export_settings
	InsightsExportSettings *SecuritySettings_InsightsExportSettings `json:"insightsExportSettings,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.AudioExportSettings
type SecuritySettings_AudioExportSettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.AudioExportSettings.gcs_bucket
	GcsBucket *string `json:"gcsBucket,omitempty"`

	// Filename pattern for exported audio.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.AudioExportSettings.audio_export_pattern
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.AudioExportSettings.enable_audio_redaction
	EnableAudioRedaction *bool `json:"enableAudioRedaction,omitempty"`

	// File format for exported audio file. Currently only in telephony
	//  recordings.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.AudioExportSettings.audio_format
	AudioFormat *string `json:"audioFormat,omitempty"`

	// Whether to store TTS audio. By default, TTS audio from the virtual agent
	//  is not exported.
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.AudioExportSettings.store_tts_audio
	StoreTtsAudio *bool `json:"storeTtsAudio,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.InsightsExportSettings
type SecuritySettings_InsightsExportSettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.SecuritySettings.InsightsExportSettings.enable_insights_export
