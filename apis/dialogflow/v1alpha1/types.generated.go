...
// +kcc:proto=google.cloud.dialogflow.v2.AutomatedAgentConfig
type AutomatedAgentConfig struct {
	...
	//  is used.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AutomatedAgentConfig.agent
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AutomatedAgentConfig.session_ttl
...
type ConversationProfile struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.ConversationProfile.name
...
// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig
type HumanAgentAssistantConfig struct {
	// Pub/Sub topic on which to publish new agent assistant events.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.notification_config
	NotificationConfig *NotificationConfig `json:"notificationConfig,omitempty"`

	// Configuration for agent assistance of human agent participant.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.human_agent_suggestion_config
	...
	//  Currently, this feature is not general available, please contact Google
	//  to get access.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.end_user_suggestion_config
	EndUserSuggestionConfig *HumanAgentAssistantConfig_SuggestionConfig `json:"endUserSuggestionConfig,omitempty"`

	// Configuration for message analysis.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.message_analysis_config
	MessageAnalysisConfig *HumanAgentAssistantConfig_MessageAnalysisConfig `json:"messageAnalysisConfig,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.ConversationModelConfig
type HumanAgentAssistantConfig_ConversationModelConfig struct {
	// Conversation model resource name. Format: `projects/<Project
	//  ID>/conversationModels/<Model ID>`.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.ConversationModelConfig.model
	...
	//      - 1.0
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.ConversationModelConfig.baseline_model_version
	BaselineModelVersion *string `json:"baselineModelVersion,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.ConversationProcessConfig
type HumanAgentAssistantConfig_ConversationProcessConfig struct {
	...
	//  and FAQ suggestion
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.ConversationProcessConfig.recent_sentences_count
	RecentSentencesCount *int32 `json:"recentSentencesCount,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.MessageAnalysisConfig
type HumanAgentAssistantConfig_MessageAnalysisConfig struct {
	...
	//  Currently, this feature is not general available, please contact Google
	//  to get access.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.MessageAnalysisConfig.enable_entity_extraction
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.MessageAnalysisConfig.enable_sentiment_analysis
...
// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig
type HumanAgentAssistantConfig_SuggestionFeatureConfig struct {
	// The suggestion feature.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.suggestion_feature
	...
	//  KNOWLEDGE_ASSIST.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.enable_event_based_suggestion
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.disable_agent_query_logging
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.enable_query_suggestion_when_no_answer
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.enable_conversation_augmented_query
	...
	//  Supported features: KNOWLEDGE_ASSIST
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.enable_query_suggestion_only
	EnableQuerySuggestionOnly *bool `json:"enableQuerySuggestionOnly,omitempty"`

	// Settings of suggestion trigger.
	//
	//  Currently, only ARTICLE_SUGGESTION and FAQ will use this field.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.suggestion_trigger_settings
	SuggestionTriggerSettings *HumanAgentAssistantConfig_SuggestionTriggerSettings `json:"suggestionTriggerSettings,omitempty"`

	// Configs of query.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.query_config
	QueryConfig *HumanAgentAssistantConfig_SuggestionQueryConfig `json:"queryConfig,omitempty"`

	// Configs of custom conversation model.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.conversation_model_config
	ConversationModelConfig *HumanAgentAssistantConfig_ConversationModelConfig `json:"conversationModelConfig,omitempty"`

	// Configs for processing conversation.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.conversation_process_config
	ConversationProcessConfig *HumanAgentAssistantConfig_ConversationProcessConfig `json:"conversationProcessConfig,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig
type HumanAgentAssistantConfig_SuggestionQueryConfig struct {
	// Query from knowledgebase. It is used by:
	//  ARTICLE_SUGGESTION, FAQ.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.knowledge_base_query_source
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.document_query_source
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.dialogflow_query_source
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.max_results
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.confidence_threshold
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.context_filter_settings
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.sections
	...
	//  Supported features: KNOWLEDGE_ASSIST.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.context_size
	ContextSize *int32 `json:"contextSize,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings
type HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings.drop_handoff_messages
	DropHandoffMessages *bool `json:"dropHandoffMessages,omitempty"`

	// If set to true, all messages from virtual agent are dropped.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings.drop_virtual_agent_messages
	DropVirtualAgentMessages *bool `json:"dropVirtualAgentMessages,omitempty"`

	// If set to true, all messages from ivr stage are dropped.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings.drop_ivr_messages
	DropIvrMessages *bool `json:"dropIvrMessages,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource
type HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.agent
	Agent *string `json:"agent,omitempty"`

	// Optional. The Dialogflow assist configuration for human agent.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.human_agent_side_config
...
// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.HumanAgentSideConfig
type HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource_HumanAgentSideConfig struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource.HumanAgentSideConfig.agent
	Agent *string `json:"agent,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.DocumentQuerySource
type HumanAgentAssistantConfig_SuggestionQueryConfig_DocumentQuerySource struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.DocumentQuerySource.documents
...
// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.Sections
type HumanAgentAssistantConfig_SuggestionQueryConfig_Sections struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionQueryConfig.Sections.section_types
	SectionTypes []string `json:"sectionTypes,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionTriggerSettings
type HumanAgentAssistantConfig_SuggestionTriggerSettings struct {
	// Do not trigger if last utterance is small talk.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionTriggerSettings.no_smalltalk
	NoSmalltalk *bool `json:"noSmalltalk,omitempty"`

	// Only trigger suggestion if participant role of last utterance is
	//  END_USER.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionTriggerSettings.only_end_user
	OnlyEndUser *bool `json:"onlyEndUser,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentHandoffConfig
type HumanAgentHandoffConfig struct {
	// Uses [LivePerson](https://www.liveperson.com).
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.live_person_config
	LivePersonConfig *HumanAgentHandoffConfig_LivePersonConfig `json:"livePersonConfig,omitempty"`

	// Uses Salesforce Live Agent.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.salesforce_live_agent_config
	SalesforceLiveAgentConfig *HumanAgentHandoffConfig_SalesforceLiveAgentConfig `json:"salesforceLiveAgentConfig,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.LivePersonConfig
type HumanAgentHandoffConfig_LivePersonConfig struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.LivePersonConfig.account_number
	AccountNumber *string `json:"accountNumber,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.SalesforceLiveAgentConfig
type HumanAgentHandoffConfig_SalesforceLiveAgentConfig struct {
	// Required. The organization ID of the Salesforce account.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.SalesforceLiveAgentConfig.organization_id
	OrganizationID *string `json:"organizationID,omitempty"`

	// Required. Live Agent deployment ID.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.SalesforceLiveAgentConfig.deployment_id
	DeploymentID *string `json:"deploymentID,omitempty"`

	// Required. Live Agent chat button ID.
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.SalesforceLiveAgentConfig.button_id
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.HumanAgentHandoffConfig.SalesforceLiveAgentConfig.endpoint_domain
	EndpointDomain *string `json:"endpointDomain,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.LoggingConfig
type LoggingConfig struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.LoggingConfig.enable_stackdriver_logging
...
// +kcc:proto=google.cloud.dialogflow.v2.SpeechToTextConfig
type SpeechToTextConfig struct {
	...
	//  error.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.speech_model_variant
	...
	//  for model selection.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.model
	Model *string `json:"model,omitempty"`

	// List of names of Cloud Speech phrase sets that are used for transcription.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.phrase_sets
	PhraseSets []string `json:"phraseSets,omitempty"`

	// Audio encoding of the audio content to process.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.audio_encoding
	...
	//  more details.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.sample_rate_hertz
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.language_code
	LanguageCode *string `json:"languageCode,omitempty"`
	...
	//  information.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.enable_word_info
	EnableWordInfo *bool `json:"enableWordInfo,omitempty"`

	// Use timeout based endpointing, interpreting endpointer sensitivy as
	//  seconds of timeout value.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SpeechToTextConfig.use_timeout_based_endpointing
	UseTimeoutBasedEndpointing *bool `json:"useTimeoutBasedEndpointing,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.SuggestionFeature
type SuggestionFeature struct {
	// Type of Human Agent Assistant API feature to request.
	// +kcc:proto:field=google.cloud.dialogflow.v2.SuggestionFeature.type
