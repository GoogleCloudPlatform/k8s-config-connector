...
// +kcc:proto=google.cloud.dialogflow.v2.AgentAssistantFeedback
type AgentAssistantFeedback struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.answer_relevance
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.document_correctness
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.document_efficiency
	DocumentEfficiency *string `json:"documentEfficiency,omitempty"`

	// Optional. Feedback for conversation summarization.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.summarization_feedback
	SummarizationFeedback *AgentAssistantFeedback_SummarizationFeedback `json:"summarizationFeedback,omitempty"`

	// Optional. Feedback for knowledge search.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.knowledge_search_feedback
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.knowledge_assist_feedback
	KnowledgeAssistFeedback *AgentAssistantFeedback_KnowledgeAssistFeedback `json:"knowledgeAssistFeedback,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.AgentAssistantFeedback.KnowledgeAssistFeedback
type AgentAssistantFeedback_KnowledgeAssistFeedback struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.KnowledgeAssistFeedback.answer_copied
	...
	//  [AnswerFeedback.clicked][google.cloud.dialogflow.v2.AnswerFeedback.clicked]
	//  will be updated to be true.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.KnowledgeAssistFeedback.clicked_uris
	ClickedUris []string `json:"clickedUris,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.AgentAssistantFeedback.KnowledgeSearchFeedback
type AgentAssistantFeedback_KnowledgeSearchFeedback struct {
	// Whether the answer was copied by the human agent or not.
	//  If the value is set to be true,
	//  [AnswerFeedback.clicked][google.cloud.dialogflow.v2.AnswerFeedback.clicked]
	//  will be updated to be true.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.KnowledgeSearchFeedback.answer_copied
	AnswerCopied *bool `json:"answerCopied,omitempty"`
	...
	//  [AnswerFeedback.clicked][google.cloud.dialogflow.v2.AnswerFeedback.clicked]
	//  will be updated to be true.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.KnowledgeSearchFeedback.clicked_uris
	ClickedUris []string `json:"clickedUris,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.AgentAssistantFeedback.SummarizationFeedback
type AgentAssistantFeedback_SummarizationFeedback struct {
	// Timestamp when composing of the summary starts.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.SummarizationFeedback.start_time
	StartTime *string `json:"startTime,omitempty"`

	// Timestamp when the summary was submitted.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.SummarizationFeedback.submit_time
	SubmitTime *string `json:"submitTime,omitempty"`

	// Text of actual submitted summary.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.SummarizationFeedback.summary_text
	SummaryText *string `json:"summaryText,omitempty"`

	// Optional. Actual text sections of submitted summary.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantFeedback.SummarizationFeedback.text_sections
	TextSections map[string]string `json:"textSections,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.AgentAssistantRecord
type AgentAssistantRecord struct {
}

// +kcc:proto=google.cloud.dialogflow.v2.AnswerFeedback
type AnswerFeedback struct {
	// The correctness level of the specific answer.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerFeedback.correctness_level
	CorrectnessLevel *string `json:"correctnessLevel,omitempty"`

	// Detail feedback of agent assist suggestions.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerFeedback.agent_assistant_detail_feedback
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerFeedback.clicked
	Clicked *bool `json:"clicked,omitempty"`

	// Time when the answer/item was clicked.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerFeedback.click_time
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerFeedback.displayed
	Displayed *bool `json:"displayed,omitempty"`

	// Time when the answer/item was displayed.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerFeedback.display_time
	DisplayTime *string `json:"displayTime,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.AnswerRecord
type AnswerRecord struct {
	// The unique identifier of this answer record.
	//  Format: `projects/<Project ID>/locations/<Location
	//  ID>/answerRecords/<Answer Record ID>`.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerRecord.name
	Name *string `json:"name,omitempty"`

	// Required. The AnswerFeedback for this record. You can set this with
	//  [AnswerRecords.UpdateAnswerRecord][google.cloud.dialogflow.v2.AnswerRecords.UpdateAnswerRecord]
	//  in order to give us feedback about this answer.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerRecord.answer_feedback
	AnswerFeedback *AnswerFeedback `json:"answerFeedback,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.ArticleAnswer
type ArticleAnswer struct {
	// The article title.
	// +kcc:proto:field=google.cloud.dialogflow.v2.ArticleAnswer.title
	Title *string `json:"title,omitempty"`

	// The article URI.
	// +kcc:proto:field=google.cloud.dialogflow.v2.ArticleAnswer.uri
	URI *string `json:"uri,omitempty"`

	// Article snippets.
	// +kcc:proto:field=google.cloud.dialogflow.v2.ArticleAnswer.snippets
	...
	//  (completely certain).
	// +kcc:proto:field=google.cloud.dialogflow.v2.ArticleAnswer.confidence
	Confidence *float32 `json:"confidence,omitempty"`

	// A map that contains metadata about the answer and the
	//  document from which it originates.
	// +kcc:proto:field=google.cloud.dialogflow.v2.ArticleAnswer.metadata
	Metadata map[string]string `json:"metadata,omitempty"`

	// The name of answer record, in the format of
	//  "projects/<Project ID>/locations/<Location ID>/answerRecords/<Answer Record
	//  ID>"
	// +kcc:proto:field=google.cloud.dialogflow.v2.ArticleAnswer.answer_record
...
// +kcc:proto=google.cloud.dialogflow.v2.DialogflowAssistAnswer
type DialogflowAssistAnswer struct {
	// Result from v2 agent.
	// +kcc:proto:field=google.cloud.dialogflow.v2.DialogflowAssistAnswer.query_result
	QueryResult *QueryResult `json:"queryResult,omitempty"`

	// An intent suggestion generated from conversation.
	// +kcc:proto:field=google.cloud.dialogflow.v2.DialogflowAssistAnswer.intent_suggestion
	IntentSuggestion *IntentSuggestion `json:"intentSuggestion,omitempty"`

	// The name of answer record, in the format of
	//  "projects/<Project ID>/locations/<Location ID>/answerRecords/<Answer Record
	//  ID>"
	// +kcc:proto:field=google.cloud.dialogflow.v2.DialogflowAssistAnswer.answer_record
	AnswerRecord *string `json:"answerRecord,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.FaqAnswer
type FaqAnswer struct {
	// The piece of text from the `source` knowledge base document.
	// +kcc:proto:field=google.cloud.dialogflow.v2.FaqAnswer.answer
	Answer *string `json:"answer,omitempty"`

	// The system's confidence score that this Knowledge answer is a good match
	//  for this conversational query, range from 0.0 (completely uncertain)
	//  to 1.0 (completely certain).
	// +kcc:proto:field=google.cloud.dialogflow.v2.FaqAnswer.confidence
	Confidence *float32 `json:"confidence,omitempty"`

	// The corresponding FAQ question.
	// +kcc:proto:field=google.cloud.dialogflow.v2.FaqAnswer.question
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.FaqAnswer.source
	Source *string `json:"source,omitempty"`

	// A map that contains metadata about the answer and the
	//  document from which it originates.
	// +kcc:proto:field=google.cloud.dialogflow.v2.FaqAnswer.metadata
	Metadata map[string]string `json:"metadata,omitempty"`

	// The name of answer record, in the format of
	//  "projects/<Project ID>/locations/<Location ID>/answerRecords/<Answer Record
	//  ID>"
	// +kcc:proto:field=google.cloud.dialogflow.v2.FaqAnswer.answer_record
	AnswerRecord *string `json:"answerRecord,omitempty"`
}
...
// +kcc:proto=google.cloud.dialogflow.v2.IntentSuggestion
type IntentSuggestion struct {
	// The display name of the intent.
	// +kcc:proto:field=google.cloud.dialogflow.v2.IntentSuggestion.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// The unique identifier of this
	//  [intent][google.cloud.dialogflow.v2.Intent]. Format: `projects/<Project
	//  ID>/locations/<Location ID>/agent/intents/<Intent ID>`.
	// +kcc:proto:field=google.cloud.dialogflow.v2.IntentSuggestion.intent_v2
	IntentV2 *string `json:"intentV2,omitempty"`

	// Human readable description for better understanding an intent like its
	//  scope, content, result etc. Maximum character limit: 140 characters.
	// +kcc:proto:field=google.cloud.dialogflow.v2.IntentSuggestion.description
	Description *string `json:"description,omitempty"`
}

// +kcc:proto=google.cloud.dialogflow.v2.QueryResult
type QueryResult struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.query_text
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.language_code
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.speech_recognition_confidence
	SpeechRecognitionConfidence *float32 `json:"speechRecognitionConfidence,omitempty"`

	// The action name from the matched intent.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.action
	Action *string `json:"action,omitempty"`
	...
	//  map from composite entity property names to property values, otherwise,
	//  use parameter value.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.parameters
	Parameters map[string]string `json:"parameters,omitempty"`
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.all_required_params_present
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.cancels_slot_filling
	CancelsSlotFilling *bool `json:"cancelsSlotFilling,omitempty"`

	// The text to be pronounced to the user or shown on the screen.
	//  Note: This is a legacy field, `fulfillment_messages` should be preferred.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.fulfillment_text
	FulfillmentText *string `json:"fulfillmentText,omitempty"`

	// The collection of rich messages to present to the user.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.fulfillment_messages
	FulfillmentMessages []Intent_Message `json:"fulfillmentMessages,omitempty"`

	// If the query was fulfilled by a webhook call, this field is set to the
	//  value of the `source` field returned in the webhook response.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.webhook_source
	WebhookSource *string `json:"webhookSource,omitempty"`

	// If the query was fulfilled by a webhook call, this field is set to the
	//  value of the `payload` field returned in the webhook response.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.webhook_payload
	...
	//  before the query.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.output_contexts
	OutputContexts []Context `json:"outputContexts,omitempty"`

	// The intent that matched the conversational query. Some, not
	//  all fields are filled in this message, including but not limited to:
	//  `name`, `display_name`, `end_interaction` and `is_fallback`.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.intent
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.intent_detection_confidence
	...
	//  - webhook errors
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.diagnostic_info
	DiagnosticInfo map[string]string `json:"diagnosticInfo,omitempty"`

	// The sentiment analysis result, which depends on the
	//  `sentiment_analysis_request_config` specified in the request.
	// +kcc:proto:field=google.cloud.dialogflow.v2.QueryResult.sentiment_analysis_result
...
type AgentAssistantRecordObservedState struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantRecord.article_suggestion_answer
	ArticleSuggestionAnswer *ArticleAnswer `json:"articleSuggestionAnswer,omitempty"`

	// Output only. The FAQ answer.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantRecord.faq_answer
	FaqAnswer *FaqAnswer `json:"faqAnswer,omitempty"`

	// Output only. Dialogflow assist answer.
	// +kcc:proto:field=google.cloud.dialogflow.v2.AgentAssistantRecord.dialogflow_assist_answer
...
type AnswerRecordObservedState struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.v2.AnswerRecord.agent_assistant_record
