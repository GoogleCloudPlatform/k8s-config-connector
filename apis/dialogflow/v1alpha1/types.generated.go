...
// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup
type TransitionRouteGroup struct {
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup.name
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup.display_name
	...
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup.transition_routes
...
// +kcc:proto=google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup
type TransitionRouteGroupObservedState struct {
	// Transition routes associated with the
	//  [TransitionRouteGroup][google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup].
	// +kcc:proto:field=google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroup.transition_routes
