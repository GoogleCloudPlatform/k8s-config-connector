...
var DialogflowToolIdentityFormat = gcpurls.Template[DialogflowToolIdentity]("dialogflow.googleapis.com", "projects/{project}/locations/{location}/tools/{tool}")
...
func getIdentityFromDialogflowToolSpec(ctx context.Context, reader client.Reader, obj client.Object) (*DialogflowToolIdentity, error) {
