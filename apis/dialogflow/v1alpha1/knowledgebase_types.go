...
type DialogflowKnowledgeBaseStatus struct {
	...
	// A unique specifier for the DialogflowKnowledgeBase resource in GCP.
...
// DialogflowKnowledgeBaseObservedState is the state of the DialogflowKnowledgeBase resource as most recently observed in GCP.
// +kcc:proto=google.cloud.dialogflow.v2.KnowledgeBase
