...
// +kcc:proto=google.cloud.alloydb.v1.CloudSQLBackupRunSource
type CloudSQLBackupRunSource struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.CloudSQLBackupRunSource.project
	Project *string `json:"project,omitempty"`

	// Required. The CloudSQL instance ID.
	// +kcc:proto:field=google.cloud.alloydb.v1.CloudSQLBackupRunSource.instance_id
	InstanceID *string `json:"instanceID,omitempty"`

	// Required. The CloudSQL backup run ID.
	// +kcc:proto:field=google.cloud.alloydb.v1.CloudSQLBackupRunSource.backup_run_id
...
// +kcc:proto=google.cloud.alloydb.v1.Instance
type Instance struct {

	// User-settable and human-readable display name for the Instance.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// Labels as key value pairs
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.labels
	Labels map[string]string `json:"labels,omitempty"`

	// Required. The type of the instance. Specified at creation time.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.instance_type
	InstanceType *string `json:"instanceType,omitempty"`

	// Configurations for the machines that host the underlying
	//  database engine.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.machine_config
	...
	//  least two zones).
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.availability_type
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.gce_zone
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.database_flags
	DatabaseFlags map[string]string `json:"databaseFlags,omitempty"`

	// Configuration for query insights.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.query_insights_config
	QueryInsightsConfig *Instance_QueryInsightsInstanceConfig `json:"queryInsightsConfig,omitempty"`

	// Configuration for observability.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.observability_config
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.read_pool_config
	ReadPoolConfig *Instance_ReadPoolConfig `json:"readPoolConfig,omitempty"`

	// For Resource freshness validation (https://google.aip.dev/154)
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.etag
	Etag *string `json:"etag,omitempty"`

	// Annotations to allow client tools to store small amount of arbitrary data.
	//  This is distinct from labels.
	//  https://google.aip.dev/128
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.annotations
	Annotations map[string]string `json:"annotations,omitempty"`

	// Optional. Client connection specific configurations
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.client_connection_config
	ClientConnectionConfig *Instance_ClientConnectionConfig `json:"clientConnectionConfig,omitempty"`

	// Optional. The configuration for Private Service Connect (PSC) for the
	//  instance.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.psc_instance_config
	PSCInstanceConfig *Instance_PSCInstanceConfig `json:"pscInstanceConfig,omitempty"`

	// Optional. Instance-level network configuration.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.network_config
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.activation_policy
	ActivationPolicy *string `json:"activationPolicy,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.ClientConnectionConfig
type Instance_ClientConnectionConfig struct {
	// Optional. Configuration to enforce connectors only (ex: AuthProxy)
	//  connections to the database.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ClientConnectionConfig.require_connectors
	RequireConnectors *bool `json:"requireConnectors,omitempty"`

	// Optional. SSL configuration option for this instance.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ClientConnectionConfig.ssl_config
	SSLConfig *SSLConfig `json:"sslConfig,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.InstanceNetworkConfig.AuthorizedNetwork
type Instance_InstanceNetworkConfig_AuthorizedNetwork struct {
	// CIDR range for one authorzied network of the instance.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.InstanceNetworkConfig.AuthorizedNetwork.cidr_range
	CIDRRange *string `json:"cidrRange,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.MachineConfig
type Instance_MachineConfig struct {
	// The number of CPU's in the VM instance.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.MachineConfig.cpu_count
	CPUCount *int32 `json:"cpuCount,omitempty"`

	// Machine type of the VM instance. E.g. "n2-highmem-4",
	//  "n2-highmem-8", "c4a-highmem-4-lssd".
	//  cpu_count must match the number of vCPUs in the machine type.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.MachineConfig.machine_type
	MachineType *string `json:"machineType,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.Node
type Instance_Node struct {
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig
type Instance_ObservabilityInstanceConfig struct {
	// Observability feature status for an instance.
	//  This flag is turned "off" by default.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.enabled
	Enabled *bool `json:"enabled,omitempty"`

	// Preserve comments in query string for an instance.
	//  This flag is turned "off" by default.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.preserve_comments
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.track_wait_events
	TrackWaitEvents *bool `json:"trackWaitEvents,omitempty"`

	// Query string length. The default value is 10k.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.max_query_string_length
	MaxQueryStringLength *int32 `json:"maxQueryStringLength,omitempty"`

	// Record application tags for an instance.
	//  This flag is turned "off" by default.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.record_application_tags
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.query_plans_per_minute
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.track_active_queries
	TrackActiveQueries *bool `json:"trackActiveQueries,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.PscAutoConnectionConfig
type Instance_PSCAutoConnectionConfig struct {
	// The consumer project to which the PSC service automation endpoint will
	//  be created.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscAutoConnectionConfig.consumer_project
	...
	//  consumer project.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscAutoConnectionConfig.consumer_network
	ConsumerNetwork *string `json:"consumerNetwork,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.PscInstanceConfig
type Instance_PSCInstanceConfig struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscInstanceConfig.allowed_consumer_projects
	...
	//  interface.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscInstanceConfig.psc_interface_configs
	PSCInterfaceConfigs []Instance_PSCInterfaceConfig `json:"pscInterfaceConfigs,omitempty"`

	// Optional. Configurations for setting up PSC service automation.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscInstanceConfig.psc_auto_connections
	PSCAutoConnections []Instance_PSCAutoConnectionConfig `json:"pscAutoConnections,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.PscInterfaceConfig
type Instance_PSCInterfaceConfig struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscInterfaceConfig.network_attachment_resource
	NetworkAttachmentResource *string `json:"networkAttachmentResource,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.QueryInsightsInstanceConfig
type Instance_QueryInsightsInstanceConfig struct {
	// Record application tags for an instance.
	//  This flag is turned "on" by default.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.QueryInsightsInstanceConfig.record_application_tags
	RecordApplicationTags *bool `json:"recordApplicationTags,omitempty"`

	// Record client address for an instance. Client address is PII information.
	//  This flag is turned "on" by default.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.QueryInsightsInstanceConfig.record_client_address
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.QueryInsightsInstanceConfig.query_string_length
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.QueryInsightsInstanceConfig.query_plans_per_minute
	QueryPlansPerMinute *uint32 `json:"queryPlansPerMinute,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.Instance.ReadPoolConfig
type Instance_ReadPoolConfig struct {
	// Read capacity, i.e. number of nodes in a read pool instance.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ReadPoolConfig.node_count
...
type MaintenanceUpdatePolicy struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.MaintenanceUpdatePolicy.deny_maintenance_periods
	DenyMaintenancePeriods []MaintenanceUpdatePolicy_DenyMaintenancePeriod `json:"denyMaintenancePeriods,omitempty"`
}

// +kcc:proto=google.cloud.alloydb.v1.MaintenanceUpdatePolicy.DenyMaintenancePeriod
type MaintenanceUpdatePolicy_DenyMaintenancePeriod struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.MaintenanceUpdatePolicy.DenyMaintenancePeriod.start_date
	...
	//  * A full date, with non-zero year, month and day values OR
	//  * A month and day value, with a zero year for recurring
	// +kcc:proto:field=google.cloud.alloydb.v1.MaintenanceUpdatePolicy.DenyMaintenancePeriod.end_date
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.MaintenanceUpdatePolicy.DenyMaintenancePeriod.time
...
// +kcc:observedstate:proto=google.cloud.alloydb.v1.Backup.QuantityBasedExpiry
...
// +kcc:observedstate:proto=google.cloud.alloydb.v1.Cluster.PrimaryConfig
...
// +kcc:observedstate:proto=google.cloud.alloydb.v1.Cluster.PscConfig
type Cluster_PSCConfigObservedState struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Cluster.PscConfig.service_owned_project_number
	ServiceOwnedProjectNumber *int64 `json:"serviceOwnedProjectNumber,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.alloydb.v1.EncryptionInfo
...
// +kcc:observedstate:proto=google.cloud.alloydb.v1.Instance
type InstanceObservedState struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.name
	Name *string `json:"name,omitempty"`

	// Output only. The system-generated UID of the resource. The UID is assigned
	//  when the resource is created, and it is retained until it is deleted.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.uid
	Uid *string `json:"uid,omitempty"`

	// Output only. Create time stamp
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Update time stamp
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.update_time
	UpdateTime *string `json:"updateTime,omitempty"`

	// Output only. Delete time stamp
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.delete_time
	DeleteTime *string `json:"deleteTime,omitempty"`

	// Output only. The current serving state of the instance.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.state
	State *string `json:"state,omitempty"`

	// Output only. This is set for the read-write VM of the PRIMARY instance
	//  only.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.writable_node
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.nodes
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ip_address
	IPAddress *string `json:"ipAddress,omitempty"`

	// Output only. The public IP addresses for the Instance. This is available
	//  ONLY when enable_public_ip is set. This is the connection endpoint for an
	//  end-user application.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.public_ip_address
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.reconciling
	Reconciling *bool `json:"reconciling,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.satisfies_pzs
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.outbound_public_ip_addresses
	OutboundPublicIPAddresses []string `json:"outboundPublicIPAddresses,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.alloydb.v1.Instance.InstanceNetworkConfig
type Instance_InstanceNetworkConfigObservedState struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.InstanceNetworkConfig.network
	Network *string `json:"network,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.alloydb.v1.Instance.Node
type Instance_NodeObservedState struct {
	// Output only. The Compute Engine zone of the VM e.g. "us-central1-b".
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.Node.zone_id
	ZoneID *string `json:"zoneID,omitempty"`

	// Output only. The identifier of the VM e.g.
	//  "test-read-0601-407e52be-ms3l".
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.Node.id
	ID *string `json:"id,omitempty"`

	// Output only. The private IP address of the VM e.g. "10.57.0.34".
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.Node.ip
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.Node.state
	State *string `json:"state,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig
type Instance_ObservabilityInstanceConfigObservedState struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.ObservabilityInstanceConfig.track_wait_event_types
	TrackWaitEventTypes *bool `json:"trackWaitEventTypes,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.alloydb.v1.Instance.PscAutoConnectionConfig
type Instance_PSCAutoConnectionConfigObservedState struct {
	// Output only. The IP address of the PSC service automation endpoint.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscAutoConnectionConfig.ip_address
	IPAddress *string `json:"ipAddress,omitempty"`
	...
	//  deletion.
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscAutoConnectionConfig.status
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscAutoConnectionConfig.consumer_network_status
	ConsumerNetworkStatus *string `json:"consumerNetworkStatus,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.alloydb.v1.Instance.PscInstanceConfig
type Instance_PSCInstanceConfigObservedState struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscInstanceConfig.service_attachment_link
	...
	// +kcc:proto:field=google.cloud.alloydb.v1.Instance.PscInstanceConfig.psc_dns_name
...
// +kcc:observedstate:proto=google.cloud.alloydb.v1.MaintenanceSchedule
