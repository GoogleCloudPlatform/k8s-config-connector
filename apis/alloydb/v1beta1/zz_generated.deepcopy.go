...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AlloyDBUserRef) DeepCopyInto(out *AlloyDBUserRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AlloyDBUserRef.
func (in *AlloyDBUserRef) DeepCopy() *AlloyDBUserRef {
	if in == nil {
		return nil
	}
	out := new(AlloyDBUserRef)
	in.DeepCopyInto(out)
	return out
}
