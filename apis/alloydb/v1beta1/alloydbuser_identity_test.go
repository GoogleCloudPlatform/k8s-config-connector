...
func TestAlloyDBUserIdentity_FromExternal(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			ref:  "projects/my-project/locations/us-central1/clusters/my-cluster/users/my-user",
			want: &AlloyDBUserIdentity{
				Project:  "my-project",
		...
		{
			name: "full url",
			ref:  "https://alloydb.googleapis.com/projects/my-project/locations/us-central1/clusters/my-cluster/users/my-user",
			want: &AlloyDBUserIdentity{
				Project:  "my-project",
				Location: "us-central1",
				Cluster:  "my-cluster",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.wantErr {
				...
				if i.User != tt.want.User {
					t.Errorf("User = %v, want %v", i.User, tt.want.User)
				}
			}
		})
	}
