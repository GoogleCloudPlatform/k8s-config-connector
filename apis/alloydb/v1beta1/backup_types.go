...
var AlloyDBBackupGVK = GroupVersion.WithKind("AlloyDBBackup")

// AlloyDBBackupSpec defines the desired state of AlloyDBBackup
// +kcc:spec:proto=google.cloud.alloydb.v1.Backup
type AlloyDBBackupSpec struct {
	/* The full resource name of the backup source cluster (e.g., projects/{project}/locations/{location}/clusters/{clusterId}). */
	ClusterNameRef oldrefs.ResourceRef `json:"clusterNameRef"`
	...
	ProjectRef oldrefs.ResourceRef `json:"projectRef"`
...
// AlloyDBBackupStatus defines the config connector machine state of AlloyDBBackup
...
// +kcc:observedstate:proto=google.cloud.alloydb.v1.Backup
