...
// +kcc:proto=google.cloud.alloydb.v1beta.Backup
type Backup struct {

	// User-settable and human-readable display name for the Backup.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// Labels as key value pairs
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.labels
	Labels map[string]string `json:"labels,omitempty"`

	// The backup type, which suggests the trigger for the backup.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.type
	Type *string `json:"type,omitempty"`

	// User-provided description of the backup.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.description
	Description *string `json:"description,omitempty"`

	// Required. The full resource name of the backup source cluster
	//  (e.g., projects/{project}/locations/{region}/clusters/{cluster_id}).
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.cluster_name
	...
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.encryption_config
	EncryptionConfig *EncryptionConfig `json:"encryptionConfig,omitempty"`

	// For Resource freshness validation (https://google.aip.dev/154)
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.etag
	Etag *string `json:"etag,omitempty"`

	// Annotations to allow client tools to store small amount of arbitrary data.
	//  This is distinct from labels.
	//  https://google.aip.dev/128
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.annotations
	...
	//  ```
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.tags
...
type BackupObservedState struct {
	...
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.name
	Name *string `json:"name,omitempty"`

	// Output only. The system-generated UID of the resource. The UID is assigned
	//  when the resource is created, and it is retained until it is deleted.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.uid
	Uid *string `json:"uid,omitempty"`

	// Output only. Create time stamp
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Update time stamp
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.update_time
	UpdateTime *string `json:"updateTime,omitempty"`

	// Output only. Delete time stamp
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.delete_time
	DeleteTime *string `json:"deleteTime,omitempty"`

	// Output only. The current state of the backup.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.state
	State *string `json:"state,omitempty"`

	// Output only. The system-generated UID of the cluster which was used to
	//  create this resource.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.cluster_uid
	...
	//  maintenance.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.reconciling
	Reconciling *bool `json:"reconciling,omitempty"`

	// Output only. The encryption information for the backup.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.encryption_info
	EncryptionInfo *EncryptionInfo `json:"encryptionInfo,omitempty"`

	// Output only. The size of the backup in bytes.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.size_bytes
	SizeBytes *int64 `json:"sizeBytes,omitempty"`

	// Output only. The time at which after the backup is eligible to be garbage
	//  collected. It is the duration specified by the backup's retention policy,
	//  added to the backup's create_time.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.expiry_time
	...
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.expiry_quantity
	ExpiryQuantity *Backup_QuantityBasedExpiry `json:"expiryQuantity,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.satisfies_pzs
	...
	// +kcc:proto:field=google.cloud.alloydb.v1beta.Backup.database_version
