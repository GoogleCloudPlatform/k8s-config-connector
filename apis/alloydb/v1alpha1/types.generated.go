...
// +kcc:proto=google.cloud.alloydb.v1beta.User
type User struct {

	// Input only. Password for the user.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.User.password
	...
	// +kcc:proto:field=google.cloud.alloydb.v1beta.User.database_roles
	DatabaseRoles []string `json:"databaseRoles,omitempty"`

	// Optional. Type of this user.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.User.user_type
	UserType *string `json:"userType,omitempty"`

	// Input only. If the user already exists and it has additional roles, keep
	//  them granted.
	// +kcc:proto:field=google.cloud.alloydb.v1beta.User.keep_extra_roles
