...
// ErrorReportingNotificationSettingsIdentity is the identity of a GCP ErrorReportingNotificationSettings resource.
...
func getIdentityFromErrorReportingNotificationSettingsSpec(ctx context.Context, reader client.Reader, obj *ErrorReportingNotificationSettings) (*ErrorReportingNotificationSettingsIdentity, error) {
...
func (obj *ErrorReportingNotificationSettings) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	return getIdentityFromErrorReportingNotificationSettingsSpec(ctx, reader, obj)
}

func (i *ErrorReportingNotificationSettingsIdentity) ParentString() string {
	return fmt.Sprintf("projects/%s/locations/global", i.Project)
}
