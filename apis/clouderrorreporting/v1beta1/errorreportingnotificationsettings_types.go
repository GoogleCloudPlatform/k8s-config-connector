...
type ErrorReportingNotificationSettingsSpec struct {
	...
	// Optional. The notification channels to send error reports to.
	// +optional
	NotificationChannels []refs.MonitoringNotificationChannelRef `json:"notificationChannels,omitempty"`
}

type ErrorReportingNotificationSettingsStatus struct {
	// Conditions represent the latest available observations of the
	// ErrorReportingNotificationSettings's current state.
...
// +kubebuilder:resource:categories=gcp,shortName=gcperrorreportingnotificationsettings;gcperrorreportingnotificationsettingslist
...
// ErrorReportingNotificationSettings is the Schema for the clouderrorreporting API
...
type ErrorReportingNotificationSettings struct {
	...
	// +required
	Spec ErrorReportingNotificationSettingsSpec `json:"spec"`
