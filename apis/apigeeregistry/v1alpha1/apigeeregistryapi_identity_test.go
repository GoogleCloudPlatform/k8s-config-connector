...
func TestApigeeRegistryAPIIdentity_FromExternal(t *testing.T) {
	tests := []struct {
		name     string
		input    string
		expected *ApigeeRegistryAPIIdentity
		hasError bool
	}{
		{
		...
		},
		{
			...
			input: "apigeeregistry.googleapis.com/projects/my-project/locations/us-central1/apis/my-api",
			expected: &ApigeeRegistryAPIIdentity{
				Project:  "my-project",
				Location: "us-central1",
				Api:      "my-api",
		...
		},
		{
			...
			input:    "projects/my-project/locations/us-central1/invalid/my-api",
			expected: nil,
			hasError: true,
		},
	}
