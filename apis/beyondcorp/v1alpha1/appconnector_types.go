...
var BeyondcorpAppConnectorGVK = GroupVersion.WithKind("BeyondcorpAppConnector")
...
type BeyondcorpAppConnectorSpec struct {
	// The BeyondcorpAppConnector name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// BeyondcorpAppConnectorStatus defines the config connector machine state of BeyondcorpAppConnector
type BeyondcorpAppConnectorStatus struct {
	...
	// A unique specifier for the BeyondcorpAppConnector resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *BeyondcorpAppConnectorObservedState `json:"observedState,omitempty"`
}

// BeyondcorpAppConnectorObservedState is the state of the BeyondcorpAppConnector resource as most recently observed in GCP.
// +kcc:proto=google.cloud.beyondcorp.appconnectors.v1.AppConnector
type BeyondcorpAppConnectorObservedState struct {
}
...
// BeyondcorpAppConnector is the Schema for the BeyondcorpAppConnector API
