...
type BeyondCorpClientConnectorServiceRef struct {
	...
	// The name of a BeyondCorpClientConnectorService resource.
	Name string `json:"name,omitempty"`

	// The namespace of a BeyondCorpClientConnectorService resource.
...
func (r *BeyondCorpClientConnectorServiceRef) GetGVK() schema.GroupVersionKind {
	return BeyondCorpClientConnectorServiceGVK
}

func (r *BeyondCorpClientConnectorServiceRef) GetNamespacedName() types.NamespacedName {
...
func (r *BeyondCorpClientConnectorServiceRef) GetExternal() string {
	return r.External
}
...
func (r *BeyondCorpClientConnectorServiceRef) ValidateExternal(ref string) error {
	id := &BeyondCorpClientConnectorServiceIdentity{}
...
func (r *BeyondCorpClientConnectorServiceRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &BeyondCorpClientConnectorServiceIdentity{}
...
func (r *BeyondCorpClientConnectorServiceRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromBeyondCorpClientConnectorServiceSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
