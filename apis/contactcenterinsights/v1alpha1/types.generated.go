...
/* found existing non-generated go type "AnnotatorSelector_SummarizationConfig", skipping
...
type AnalysisObservedState struct {
	...
	AnalysisResult *AnalysisResultObservedState `json:"analysisResult,omitempty"`
...
// +kcc:observedstate:proto=google.cloud.contactcenterinsights.v1.AnalysisResult.CallAnalysisMetadata
...
type QaAnswerObservedState struct {
	...
	// List of all individual answers given to the question.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.QaAnswer.answer_sources
	AnswerSources []QaAnswer_AnswerSourceObservedState `json:"answerSources,omitempty"`
}

// +kcc:observedstate:proto=google.cloud.contactcenterinsights.v1.QaAnswer.AnswerSource
type QaAnswer_AnswerSourceObservedState struct {
	// What created the answer.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.QaAnswer.AnswerSource.source_type
	SourceType *string `json:"sourceType,omitempty"`
