...
// +kcc:proto=google.cloud.contactcenterinsights.v1.AnswerFeedback
type AnswerFeedback struct {
	// The correctness level of an answer.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.AnswerFeedback.correctness_level
	CorrectnessLevel *string `json:"correctnessLevel,omitempty"`

	// Indicates whether an answer or item was clicked by the human agent.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.AnswerFeedback.clicked
	Clicked *bool `json:"clicked,omitempty"`

	// Indicates whether an answer or item was displayed to the human agent in the
	//  agent desktop UI.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.AnswerFeedback.displayed
	Displayed *bool `json:"displayed,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.ArticleSuggestionData
type ArticleSuggestionData struct {
	// Article title.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.ArticleSuggestionData.title
	Title *string `json:"title,omitempty"`

	// Article URI.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.ArticleSuggestionData.uri
	URI *string `json:"uri,omitempty"`

	// The system's confidence score that this article is a good match for this
	//  conversation, ranging from 0.0 (completely uncertain) to 1.0 (completely
	//  certain).
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.ArticleSuggestionData.confidence_score
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.ArticleSuggestionData.metadata
	Metadata map[string]string `json:"metadata,omitempty"`

	// The name of the answer record.
	//  Format:
	//  projects/{project}/locations/{location}/answerRecords/{answer_record}
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.ArticleSuggestionData.query_record
	QueryRecord *string `json:"queryRecord,omitempty"`

	// The knowledge document that this answer was extracted from.
	//  Format:
	//  projects/{project}/knowledgeBases/{knowledge_base}/documents/{document}
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.ArticleSuggestionData.source
...
type Conversation struct {
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.name
	Name *string `json:"name,omitempty"`
...
type Conversation_CallMetadata struct {
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.CallMetadata.customer_channel
	CustomerChannel *int32 `json:"customerChannel,omitempty"`

	// The audio channel that contains the agent.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.CallMetadata.agent_channel
	AgentChannel *int32 `json:"agentChannel,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata
type Conversation_QualityMetadata struct {
	// An arbitrary integer value indicating the customer's satisfaction rating.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.customer_satisfaction_rating
	CustomerSatisfactionRating *int32 `json:"customerSatisfactionRating,omitempty"`

	// The amount of time the customer waited to connect with an agent.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.wait_duration
	WaitDuration *string `json:"waitDuration,omitempty"`

	// An arbitrary string value specifying the menu path the customer took.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.menu_path
	MenuPath *string `json:"menuPath,omitempty"`

	// Information about agents involved in the call.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.agent_info
	AgentInfo []Conversation_QualityMetadata_AgentInfo `json:"agentInfo,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.AgentInfo
type Conversation_QualityMetadata_AgentInfo struct {
	// A user-specified string representing the agent.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.AgentInfo.agent_id
	AgentID *string `json:"agentID,omitempty"`

	// The agent's name.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.AgentInfo.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// A user-specified string representing the agent's team.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.AgentInfo.team
	Team *string `json:"team,omitempty"`

	// A user-provided string indicating the outcome of the agent's segment of
	//  the call.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.AgentInfo.disposition_code
	DispositionCode *string `json:"dispositionCode,omitempty"`

	// The agent type, e.g. HUMAN_AGENT.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.QualityMetadata.AgentInfo.agent_type
	AgentType *string `json:"agentType,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.Conversation.Transcript
type Conversation_Transcript struct {
	// A list of sequential transcript segments that comprise the conversation.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.transcript_segments
	TranscriptSegments []Conversation_Transcript_TranscriptSegment `json:"transcriptSegments,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment
type Conversation_Transcript_TranscriptSegment struct {
	// The time that the message occurred, if provided.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.message_time
	MessageTime *string `json:"messageTime,omitempty"`

	// The text of this segment.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.text
	Text *string `json:"text,omitempty"`

	// A confidence estimate between 0.0 and 1.0 of the fidelity of this
	//  segment. A default value of 0.0 indicates that the value is unset.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.confidence
	Confidence *float32 `json:"confidence,omitempty"`

	// A list of the word-specific information for each word in the segment.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.words
	Words []Conversation_Transcript_TranscriptSegment_WordInfo `json:"words,omitempty"`

	// The language code of this segment as a
	//  [BCP-47](https://www.rfc-editor.org/rfc/bcp/bcp47.txt) language tag.
	//  Example: "en-US".
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.language_code
	LanguageCode *string `json:"languageCode,omitempty"`
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.channel_tag
	ChannelTag *int32 `json:"channelTag,omitempty"`

	// The participant of this segment.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.segment_participant
	SegmentParticipant *ConversationParticipant `json:"segmentParticipant,omitempty"`

	// CCAI metadata relating to the current transcript segment.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.dialogflow_segment_metadata
	DialogflowSegmentMetadata *Conversation_Transcript_TranscriptSegment_DialogflowSegmentMetadata `json:"dialogflowSegmentMetadata,omitempty"`

	// The sentiment for this transcript segment.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.sentiment
	Sentiment *SentimentData `json:"sentiment,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.DialogflowSegmentMetadata
type Conversation_Transcript_TranscriptSegment_DialogflowSegmentMetadata struct {
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.DialogflowSegmentMetadata.smart_reply_allowlist_covered
	SmartReplyAllowlistCovered *bool `json:"smartReplyAllowlistCovered,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.WordInfo
type Conversation_Transcript_TranscriptSegment_WordInfo struct {
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.WordInfo.start_offset
	StartOffset *string `json:"startOffset,omitempty"`

	// Time offset of the end of this word relative to the beginning of the
	//  total conversation.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.WordInfo.end_offset
	EndOffset *string `json:"endOffset,omitempty"`

	// The word itself. Includes punctuation marks that surround the word.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.Conversation.Transcript.TranscriptSegment.WordInfo.word
...
type DialogflowIntent struct {
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.DialogflowIntent.display_name
	DisplayName *string `json:"displayName,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.DialogflowInteractionData
type DialogflowInteractionData struct {
	// The Dialogflow intent resource path. Format:
	//  projects/{project}/agent/{agent}/intents/{intent}
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.DialogflowInteractionData.dialogflow_intent_id
	DialogflowIntentID *string `json:"dialogflowIntentID,omitempty"`

	// The confidence of the match ranging from 0.0 (completely uncertain) to 1.0
	//  (completely certain).
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.DialogflowInteractionData.confidence
	Confidence *float32 `json:"confidence,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.DialogflowSource
type DialogflowSource struct {

	// Cloud Storage URI that points to a file that contains the conversation
	//  audio.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.DialogflowSource.audio_uri
...
type FaqAnswerData struct {
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.FaqAnswerData.answer
	Answer *string `json:"answer,omitempty"`

	// The system's confidence score that this answer is a good match for this
	//  conversation, ranging from 0.0 (completely uncertain) to 1.0 (completely
	//  certain).
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.FaqAnswerData.confidence_score
	ConfidenceScore *float32 `json:"confidenceScore,omitempty"`

	// The corresponding FAQ question.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.FaqAnswerData.question
	Question *string `json:"question,omitempty"`

	// Map that contains metadata about the FAQ answer and the document that
	//  it originates from.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.FaqAnswerData.metadata
	Metadata map[string]string `json:"metadata,omitempty"`

	// The name of the answer record.
	//  Format:
	//  projects/{project}/locations/{location}/answerRecords/{answer_record}
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.FaqAnswerData.query_record
	QueryRecord *string `json:"queryRecord,omitempty"`

	// The knowledge document that this answer was extracted from.
	//  Format:
	//  projects/{project}/knowledgeBases/{knowledge_base}/documents/{document}.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.FaqAnswerData.source
	Source *string `json:"source,omitempty"`
}
...
type GcsSource struct {
	// Cloud Storage URI that points to a file that contains the conversation
	//  audio.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.GcsSource.audio_uri
	AudioURI *string `json:"audioURI,omitempty"`

	// Immutable. Cloud Storage URI that points to a file that contains the
	//  conversation transcript.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.GcsSource.transcript_uri
...
// +kcc:proto=google.cloud.contactcenterinsights.v1.RuntimeAnnotation
type RuntimeAnnotation struct {
	// Agent Assist Article Suggestion data.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.article_suggestion
	ArticleSuggestion *ArticleSuggestionData `json:"articleSuggestion,omitempty"`

	// Agent Assist FAQ answer data.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.faq_answer
	FaqAnswer *FaqAnswerData `json:"faqAnswer,omitempty"`

	// Agent Assist Smart Reply data.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.smart_reply
	SmartReply *SmartReplyData `json:"smartReply,omitempty"`

	// Agent Assist Smart Compose suggestion data.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.smart_compose_suggestion
	SmartComposeSuggestion *SmartComposeSuggestionData `json:"smartComposeSuggestion,omitempty"`

	// Dialogflow interaction data.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.dialogflow_interaction
	DialogflowInteraction *DialogflowInteractionData `json:"dialogflowInteraction,omitempty"`

	// Conversation summarization suggestion data.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.conversation_summarization_suggestion
	ConversationSummarizationSuggestion *ConversationSummarizationSuggestionData `json:"conversationSummarizationSuggestion,omitempty"`

	// The unique identifier of the annotation.
	//  Format:
	//  projects/{project}/locations/{location}/conversationDatasets/{dataset}/conversationDataItems/{data_item}/conversationAnnotations/{annotation}
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.annotation_id
	AnnotationID *string `json:"annotationID,omitempty"`

	// The time at which this annotation was created.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// The boundary in the conversation where the annotation starts, inclusive.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.start_boundary
	StartBoundary *AnnotationBoundary `json:"startBoundary,omitempty"`

	// The boundary in the conversation where the annotation ends, inclusive.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.end_boundary
	EndBoundary *AnnotationBoundary `json:"endBoundary,omitempty"`

	// The feedback that the customer has about the answer in `data`.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.answer_feedback
	AnswerFeedback *AnswerFeedback `json:"answerFeedback,omitempty"`

	// Explicit input used for generating the answer
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.user_input
	UserInput *RuntimeAnnotation_UserInput `json:"userInput,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.UserInput
type RuntimeAnnotation_UserInput struct {
	...
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.UserInput.query
	Query *string `json:"query,omitempty"`

	// The resource name of associated generator. Format:
	//  `projects/<Project ID>/locations/<Location ID>/generators/<Generator ID>`
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.UserInput.generator_name
	GeneratorName *string `json:"generatorName,omitempty"`

	// Query source for the answer.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.RuntimeAnnotation.UserInput.query_source
...
// +kcc:proto=google.cloud.contactcenterinsights.v1.SmartComposeSuggestionData
type SmartComposeSuggestionData struct {
	// The content of the suggestion.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartComposeSuggestionData.suggestion
	Suggestion *string `json:"suggestion,omitempty"`

	// The system's confidence score that this suggestion is a good match for this
	//  conversation, ranging from 0.0 (completely uncertain) to 1.0 (completely
	//  certain).
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartComposeSuggestionData.confidence_score
	ConfidenceScore *float64 `json:"confidenceScore,omitempty"`

	// Map that contains metadata about the Smart Compose suggestion and the
	//  document from which it originates.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartComposeSuggestionData.metadata
	Metadata map[string]string `json:"metadata,omitempty"`

	// The name of the answer record.
	//  Format:
	//  projects/{project}/locations/{location}/answerRecords/{answer_record}
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartComposeSuggestionData.query_record
	QueryRecord *string `json:"queryRecord,omitempty"`
}

// +kcc:proto=google.cloud.contactcenterinsights.v1.SmartReplyData
type SmartReplyData struct {
	// The content of the reply.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartReplyData.reply
	Reply *string `json:"reply,omitempty"`

	// The system's confidence score that this reply is a good match for this
	//  conversation, ranging from 0.0 (completely uncertain) to 1.0 (completely
	//  certain).
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartReplyData.confidence_score
	ConfidenceScore *float64 `json:"confidenceScore,omitempty"`

	// Map that contains metadata about the Smart Reply and the document from
	//  which it originates.
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartReplyData.metadata
	Metadata map[string]string `json:"metadata,omitempty"`

	// The name of the answer record.
	//  Format:
	//  projects/{project}/locations/{location}/answerRecords/{answer_record}
	// +kcc:proto:field=google.cloud.contactcenterinsights.v1.SmartReplyData.query_record
	QueryRecord *string `json:"queryRecord,omitempty"`
}
