...
import (
	dialogflowv1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/apis/dialogflow/v1alpha1"
...
type CCInsightsAnalysisRuleAnnotatorSelector struct {
	...
	// +optional
	PhraseMatcherRefs []CCInsightsPhraseMatcherRef `json:"phraseMatcherRefs,omitempty"`
	...
	// +optional
	IssueModelRefs []CCInsightsIssueModelRef `json:"issueModelRefs,omitempty"`
...
type CCInsightsAnalysisRuleAnnotatorSelector_SummarizationConfig struct {
	...
	// +optional
	ConversationProfileRef *dialogflowv1alpha1.DialogflowConversationProfileRef `json:"conversationProfileRef,omitempty"`
