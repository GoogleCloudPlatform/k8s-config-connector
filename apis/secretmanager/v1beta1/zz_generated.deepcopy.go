...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretManagerSecretVersionObservation) DeepCopyInto(out *SecretManagerSecretVersionObservation) {
	*out = *in
	if in.CreateTime != nil {
		in, out := &in.CreateTime, &out.CreateTime
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretManagerSecretVersionObservation.
func (in *SecretManagerSecretVersionObservation) DeepCopy() *SecretManagerSecretVersionObservation {
	if in == nil {
		return nil
	}
	out := new(SecretManagerSecretVersionObservation)
	in.DeepCopyInto(out)
	return out
}
