...
var DatabaseMigrationConversionWorkspaceGVK = GroupVersion.WithKind("DatabaseMigrationConversionWorkspace")

// DatabaseMigrationConversionWorkspaceSpec defines the desired state of DatabaseMigrationConversionWorkspace
...
// DatabaseMigrationConversionWorkspaceStatus defines the config connector machine state of DatabaseMigrationConversionWorkspace
type DatabaseMigrationConversionWorkspaceStatus struct {
	...
	ObservedState *DatabaseMigrationConversionWorkspaceObservedState `json:"observedState,omitempty"`
}

// DatabaseMigrationConversionWorkspaceObservedState is the state of the DatabaseMigrationConversionWorkspace resource as most recently observed in Google Cloud.
// +kcc:observedstate:proto=google.cloud.clouddms.v1.ConversionWorkspace
type DatabaseMigrationConversionWorkspaceObservedState struct {
...
// +kubebuilder:resource:categories=gcp,shortName=gcpdatabasemigrationconversionworkspace;gcpdatabasemigrationconversionworkspaces
...
// DatabaseMigrationConversionWorkspace is the Schema for the DatabaseMigrationConversionWorkspace API
// +k8s:openapi-gen=true
type DatabaseMigrationConversionWorkspace struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	// +required
	Spec   DatabaseMigrationConversionWorkspaceSpec   `json:"spec,omitempty"`
	Status DatabaseMigrationConversionWorkspaceStatus `json:"status,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// DatabaseMigrationConversionWorkspaceList contains a list of DatabaseMigrationConversionWorkspace
type DatabaseMigrationConversionWorkspaceList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DatabaseMigrationConversionWorkspace `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DatabaseMigrationConversionWorkspace{}, &DatabaseMigrationConversionWorkspaceList{})
}
