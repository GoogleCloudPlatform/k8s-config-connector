...
type DatabaseMigrationConnectionProfileRef struct {
	...
	// The name of a DatabaseMigrationConnectionProfile resource.
...
func (r *DatabaseMigrationConnectionProfileRef) GetGVK() schema.GroupVersionKind {
	return DatabaseMigrationConnectionProfileGVK
}

func (r *DatabaseMigrationConnectionProfileRef) GetNamespacedName() types.NamespacedName {
...
func (r *DatabaseMigrationConnectionProfileRef) GetExternal() string {
	return r.External
}

func (r *DatabaseMigrationConnectionProfileRef) SetExternal(ref string) {
	r.External = ref
}
