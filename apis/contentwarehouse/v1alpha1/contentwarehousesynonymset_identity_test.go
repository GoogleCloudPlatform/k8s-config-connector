...
func TestContentWarehouseSynonymSetIdentity_FromExternal(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			ref:  "projects/my-project/locations/us/synonymSets/my-synonymset",
			want: &ContentWarehouseSynonymSetIdentity{
				Project:  "my-project",
				Location: "us",
		...
		{
			name: "full url",
			ref:  "https://contentwarehouse.googleapis.com/projects/my-project/locations/us/synonymSets/my-synonymset",
			want: &ContentWarehouseSynonymSetIdentity{
				Project:  "my-project",
				Location: "us",
				Context:  "my-synonymset",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.wantErr {
				...
				if i.Context != tt.want.Context {
					t.Errorf("Context = %v, want %v", i.Context, tt.want.Context)
				}
			}
		})
	}
