...
// ContentWarehouseSynonymSetRef is a reference to a GCP ContentWarehouseSynonymSet.
type ContentWarehouseSynonymSetRef struct {
	// A reference to an externally managed ContentWarehouseSynonymSet resource. Should be in the format "projects/{{projectID}}/locations/{{location}}/synonymSets/{{context}}"
...
func init() {
	refs.Register(&ContentWarehouseSynonymSetRef{}, &ContentWarehouseSynonymSet{})
}
...
func (r *ContentWarehouseSynonymSetRef) SetExternal(external string) {
	r.External = external
}
...
func (r *ContentWarehouseSynonymSetRef) Normalize(ctx context.Context, reader client.Reader, otherNamespace string) error {
...
func (r *ContentWarehouseSynonymSetRef) Resolve(ctx context.Context, reader client.Reader, src client.Object) (string, error) {
	if r == nil {
		return "", nil
	}
