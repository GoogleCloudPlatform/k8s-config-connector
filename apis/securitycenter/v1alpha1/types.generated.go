...
type EffectiveSecurityHealthAnalyticsCustomModuleObservedState struct {
	...
	// +kcc:proto:field=google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule.name
	Name *string `json:"name,omitempty"`

	// Output only. The user-specified configuration for the module.
	// +kcc:proto:field=google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule.custom_config
	CustomConfig *CustomConfig `json:"customConfig,omitempty"`

	// Output only. The effective state of enablement for the module at the given
	//  level of the hierarchy.
	// +kcc:proto:field=google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule.enablement_state
	...
	// +kcc:proto:field=google.cloud.securitycenter.v1.EffectiveSecurityHealthAnalyticsCustomModule.display_name
