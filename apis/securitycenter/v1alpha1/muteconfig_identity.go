...
var _ identity.Identity = &SecurityCenterMuteConfigIdentity{}
...
func (i *SecurityCenterMuteConfigIdentity) ID() string {
	return i.id
}

func (i *SecurityCenterMuteConfigIdentity) Parent() *SecurityCenterParent {
	return i.parent
}

func (i *SecurityCenterMuteConfigIdentity) FromExternal(external string) error {
...
func (obj *SecurityCenterMuteConfig) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	...
	if external := common.ValueOf(obj.Status.ExternalRef); external != "" {
		actual := &SecurityCenterMuteConfigIdentity{}
	...
	return &SecurityCenterMuteConfigIdentity{
		parent: parent,
		id:     resourceID,
	}, nil
}
