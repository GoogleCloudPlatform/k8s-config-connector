...
type CustomTargetTypeStatus struct {
	...
	// A unique specifier for the CloudDeployCustomTargetType resource in Google Cloud.
...
// CustomTargetTypeObservedState is the state of the CloudDeployCustomTargetType resource as most recently observed in Google Cloud.
