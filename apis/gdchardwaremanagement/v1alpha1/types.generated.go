...
/* found existing non-generated go type with proto tag "google.cloud.gdchardwaremanagement.v1alpha.Hardware", skipping

// +kcc:proto=google.cloud.gdchardwaremanagement.v1alpha.Hardware
type Hardware struct {
	// Identifier. Name of this hardware.
	//  Format: `projects/{project}/locations/{location}/hardware/{hardware}`
	// +kcc:proto:field=google.cloud.gdchardwaremanagement.v1alpha.Hardware.name
...
type HardwareObservedState struct {
