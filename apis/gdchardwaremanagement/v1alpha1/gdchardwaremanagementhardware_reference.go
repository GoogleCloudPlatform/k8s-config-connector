...
// GDCHardwareManagementHardwareRef is a reference to a GDCHardwareManagementHardware.
type GDCHardwareManagementHardwareRef struct {
	// A reference to an externally managed GDCHardwareManagementHardware resource.
	// Should be in the format "projects/{{projectID}}/locations/{{location}}/hardware/{{hardwareID}}".
...
func (r *GDCHardwareManagementHardwareRef) SetExternal(ref string) {
	r.External = ref
	r.Name = ""
	r.Namespace = ""
}
...
func (r *GDCHardwareManagementHardwareRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		obj, err := common.ToStructuredType[*GDCHardwareManagementHardware](u)
		if err != nil {
			return ""
		}
		identity, err := getIdentityFromGDCHardwareManagementHardwareSpec(ctx, reader, obj)
		if err != nil {
			return ""
		}
