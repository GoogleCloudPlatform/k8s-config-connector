...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DenoiserConfig) DeepCopyInto(out *DenoiserConfig) {
	*out = *in
	if in.DenoiseAudio != nil {
		in, out := &in.DenoiseAudio, &out.DenoiseAudio
		*out = new(bool)
		**out = **in
	}
	if in.SnrThreshold != nil {
		in, out := &in.SnrThreshold, &out.SnrThreshold
		*out = new(float32)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DenoiserConfig.
func (in *DenoiserConfig) DeepCopy() *DenoiserConfig {
	if in == nil {
		return nil
	}
	out := new(DenoiserConfig)
	in.DeepCopyInto(out)
	return out
}
