...
var (
	_ identity.IdentityV2 = &DataLineageProcessIdentity{}
	_ identity.Resource   = &DataLineageProcess{}
)
...
func (i *DataLineageProcessIdentity) String() string {
	return DataLineageProcessIdentityFormat.ToString(*i)
}

func (i *DataLineageProcessIdentity) FromExternal(ref string) error {
	parsed, match, err := DataLineageProcessIdentityFormat.Parse(ref)
	if err != nil {
		return fmt.Errorf("format of DataLineageProcess external=%q was not known (use %s): %w", ref, DataLineageProcessIdentityFormat.CanonicalForm(), err)
	}
	if !match {
		return fmt.Errorf("format of DataLineageProcess external=%q was not known (use %s)", ref, DataLineageProcessIdentityFormat.CanonicalForm())
	}
...
func (i *DataLineageProcessIdentity) Host() string {
...
func getIdentityFromDataLineageProcessSpec(ctx context.Context, reader client.Reader, obj client.Object) (*DataLineageProcessIdentity, error) {
	...
	identity := &DataLineageProcessIdentity{
		Project:  projectID,
		Location: location,
		Process:  resourceID,
	}
