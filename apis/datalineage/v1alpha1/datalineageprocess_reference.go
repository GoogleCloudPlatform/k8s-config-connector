...
type DataLineageProcessRef struct {
	...
	// The namespace of a DataLineageProcess resource.
	Namespace string `json:"namespace,omitempty"`
}

func init() {
	refs.Register(&DataLineageProcessRef{})
}

func (r *DataLineageProcessRef) GetGVK() schema.GroupVersionKind {
	return DataLineageProcessGVK
}

func (r *DataLineageProcessRef) GetNamespacedName() types.NamespacedName {
...
func (r *DataLineageProcessRef) GetExternal() string {
	return r.External
}

func (r *DataLineageProcessRef) SetExternal(ref string) {
	r.External = ref
}

func (r *DataLineageProcessRef) ValidateExternal(ref string) error {
	id := &DataLineageProcessIdentity{}
...
func (r *DataLineageProcessRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &DataLineageProcessIdentity{}
