...
var StorageBucketObjectGVK_Ref = schema.GroupVersionKind{
	Group:   "storage.cnrm.cloud.google.com",
	Version: "v1beta1",
	Kind:    "StorageBucketObject",
}

var _ refs.Ref = &StorageBucketObjectRef{}
...
func init() {
	refs.Register(&StorageBucketObjectRef{}, &StorageBucketObject{})
}

func (r *StorageBucketObjectRef) GetGVK() schema.GroupVersionKind {
	return StorageBucketObjectGVK_Ref
}
...
func (r *StorageBucketObjectRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &StorageBucketObjectIdentity{}
