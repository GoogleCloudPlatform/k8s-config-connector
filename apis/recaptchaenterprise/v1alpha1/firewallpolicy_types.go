...
// ReCAPTCHAEnterpriseFirewallPolicyObservedState is the state of the ReCAPTCHAEnterpriseFirewallPolicy resource as most recently observed in Google Cloud.
