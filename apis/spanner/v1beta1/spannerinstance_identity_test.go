...
func TestSpannerInstanceIdentity_FromExternal(t *testing.T) {
	tests := []struct {
		name    string
		ref     string
		wantErr bool
		want    *SpannerInstanceIdentity
	}{
		{
		...
		{
			name: "full url",
			ref:  "https://spanner.googleapis.com/projects/my-project/instances/my-instance",
			want: &SpannerInstanceIdentity{
				Project:  "my-project",
				Instance: "my-instance",
			},
