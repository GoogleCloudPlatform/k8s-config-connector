...
func (in *DataEncryptionState) DeepCopyInto(out *DataEncryptionState) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DataEncryptionState.
func (in *DataEncryptionState) DeepCopy() *DataEncryptionState {
	if in == nil {
		return nil
	}
	out := new(DataEncryptionState)
	in.DeepCopyInto(out)
	return out
}
