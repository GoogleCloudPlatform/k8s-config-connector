...
func TestLustreInstanceIdentity_FromExternal(t *testing.T) {
	tests := []struct {
		name    string
		ref     string
		wantErr bool
		want    *LustreInstanceIdentity
	}{
		{
		...
		{
			name: "full url",
			ref:  "https://lustre.googleapis.com/projects/my-project/locations/us-central1/instances/my-instance",
			want: &LustreInstanceIdentity{
				Project:  "my-project",
				Location: "us-central1",
				Instance: "my-instance",
...
func TestLustreInstance_GetIdentity(t *testing.T) {
