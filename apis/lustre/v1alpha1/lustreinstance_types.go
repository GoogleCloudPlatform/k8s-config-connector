...
type LustreInstanceSpec struct {
	...
	// +required
	// +kubebuilder:validation:Minimum=18000
	// +kubebuilder:validation:Maximum=954000
	...
	// +required
	// +kubebuilder:validation:Enum=125;250;500;1000
...
type LustreInstanceObservedState struct {
	...
	// +optional
	// +kubebuilder:validation:Enum=STATE_UNSPECIFIED;ACTIVE;CREATING;DELETING;UPGRADING;REPAIRING;STOPPED;UPDATING
