...
var _ refs.ExternalRef = &NetworkSecurityDNSThreatDetectorRef{}

// NetworkSecurityDNSThreatDetectorRef is a reference to a GCP NetworkSecurityDNSThreatDetector.
...
func (r *NetworkSecurityDNSThreatDetectorRef) ValidateExternal(external string) error {
	id := &NetworkSecurityDNSThreatDetectorIdentity{}
	return id.FromExternal(external)
}

func (r *NetworkSecurityDNSThreatDetectorRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &NetworkSecurityDNSThreatDetectorIdentity{}
...
func (r *NetworkSecurityDNSThreatDetectorRef) Normalize(ctx context.Context, reader client.Reader, otherNamespace string) error {
	return refs.NormalizeWithFallback(ctx, reader, r, otherNamespace, func(u *unstructured.Unstructured) string {
		structured, err := common.ToStructuredType[*NetworkSecurityDNSThreatDetector](u)
		if err != nil {
			return ""
		}
		id, err := getIdentityFromNetworkSecurityDNSThreatDetectorSpec(ctx, reader, structured)
		if err != nil {
			return ""
		}
		return id.String()
