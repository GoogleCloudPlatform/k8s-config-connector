...
// MirroringDeploymentGroupConnectedEndpointGroupObservedState is the observed state of a connected endpoint group.
// +kcc:observedstate:proto=google.cloud.networksecurity.v1.MirroringDeploymentGroup.ConnectedEndpointGroup
type MirroringDeploymentGroupConnectedEndpointGroupObservedState struct {
	// Output only. The connected endpoint group's resource name, for example:
	// `projects/123456789/locations/global/mirroringEndpointGroups/my-eg`.
	Name *string `json:"name,omitempty"`
}

// MirroringDeploymentGroupDeploymentObservedState is the observed state of a nested deployment.
// +kcc:observedstate:proto=google.cloud.networksecurity.v1.MirroringDeploymentGroup.Deployment
type MirroringDeploymentGroupDeploymentObservedState struct {
...
type NetworkSecurityMirroringDeploymentGroupObservedState struct {
	...
	ConnectedEndpointGroups []MirroringDeploymentGroupConnectedEndpointGroupObservedState `json:"connectedEndpointGroups,omitempty"`

	// Output only. The list of Mirroring Deployments that belong to this group.
	NestedDeployments []MirroringDeploymentGroupDeploymentObservedState `json:"nestedDeployments,omitempty"`
	...
	// of the normal operation (e.g. adding a new deployment to the group)
