...
// NetworkSecurityPartnerSSEGatewayIdentity is the identity of a GCP NetworkSecurityPartnerSSEGateway resource.
...
func (i *NetworkSecurityPartnerSSEGatewayIdentity) ParentString() string {
	return fmt.Sprintf("projects/%s/locations/%s", i.Project, i.Location)
}

func getIdentityFromNetworkSecurityPartnerSSEGatewaySpec(ctx context.Context, reader client.Reader, obj *NetworkSecurityPartnerSSEGateway) (*NetworkSecurityPartnerSSEGatewayIdentity, error) {
