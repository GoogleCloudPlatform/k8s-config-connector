...
type NetworkSecurityUrlListSpec struct {
	...
	// Optional. Set of label tags associated with the UrlList resource.
...
type NetworkSecurityUrlListObservedState struct {
	...
	// which may be sent on update and delete requests to ensure the client has an
	// up-to-date value before proceeding.
	// +kcc:proto:field=google.cloud.networksecurity.v1.UrlList.etag
