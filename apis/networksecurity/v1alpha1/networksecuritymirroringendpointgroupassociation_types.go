...
type NetworkSecurityMirroringEndpointGroupAssociationSpec struct {
	...
	//  resources.
	// +optional
	// +kcc:proto:field=google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation.labels
...
type NetworkSecurityMirroringEndpointGroupAssociationObservedState struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The timestamp when the resource was most recently updated.
	//  See https://google.aip.dev/148#timestamps.
	// +optional
	// +kcc:proto:field=google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation.update_time
	...
	// +optional
	// +kcc:proto:field=google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation.locations_details
	...
	// +optional
	// +kcc:proto:field=google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation.state
	...
	// +optional
	// +kcc:proto:field=google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation.reconciling
	...
	// +optional
	// +kcc:proto:field=google.cloud.networksecurity.v1.MirroringEndpointGroupAssociation.locations
