...
func TestNetworkSecurityTLSInspectionPolicyIdentity(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "basic",
			external: "projects/my-project/locations/us-central1/tlsInspectionPolicies/my-tlsinspectionpolicy",
			want: &NetworkSecurityTLSInspectionPolicyIdentity{
				Project:             "my-project",
				Location:            "us-central1",
				TlsInspectionPolicy: "my-tlsinspectionpolicy",
			},
		},
		{
			name:     "invalid format",
			external: "invalid/my-project/locations/us-central1/tlsInspectionPolicies/my-tlsinspectionpolicy",
			wantErr:  true,
		},
	}
