...
type AuthzPolicy_Target struct {
	...
	Resources []computev1beta1.ForwardingRuleRef `json:"resources,omitempty"`
}
...
type AuthzPolicy_AuthzRule_RequestResource struct {
	...
	IAMServiceAccount *AuthzPolicy_AuthzRule_StringMatch `json:"iamServiceAccount,omitempty"`
}
...
type AuthzPolicy_AuthzRule_RequestResource_TagValueIDSet struct {
	...
	TagValues []tagsv1beta1.TagsTagValueRef `json:"tagValues,omitempty"`
}
...
type AuthzPolicy_AuthzRule_To struct {
	...
	//  must be specified.
	// +kcc:proto:field=google.cloud.networksecurity.v1.AuthzPolicy.ChangeRule.To.not_operations
...
// AuthzPolicy_CustomProvider_CloudIAP is the configuration for Cloud IAP.
type AuthzPolicy_CustomProvider_CloudIAP struct {
	// Optional. If True, Cloud IAP is enabled.
