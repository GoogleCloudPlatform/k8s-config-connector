...
type NetworkSecurityBackendAuthenticationConfigStatus struct {
	...
	// A unique specifier for the NetworkSecurityBackendAuthenticationConfig resource in Google Cloud.
...
// NetworkSecurityBackendAuthenticationConfigObservedState is the state of the NetworkSecurityBackendAuthenticationConfig resource as most recently observed in Google Cloud.
