...
// +kcc:spec:proto=google.cloud.networksecurity.v1beta1.DnsThreatDetector
type NetworkSecurityDnsThreatDetectorSpec struct {
	// Optional. Labels as key value pairs
	Labels map[string]string `json:"labels,omitempty"`

	// Optional. Included networks.
	ExcludedNetworks []computev1beta1.ComputeNetworkRef `json:"excludedNetworks,omitempty"`

	// Required. Provider for the DnsThreatDetector.
...
// +kcc:observedstate:proto=google.cloud.networksecurity.v1beta1.DnsThreatDetector
