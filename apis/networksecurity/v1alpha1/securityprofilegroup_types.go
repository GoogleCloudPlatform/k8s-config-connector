...
type NetworkSecuritySecurityProfileGroupSpec struct {
	// The project that this resource belongs to. Exactly one of projectRef or organizationRef must be specified.
	ProjectRef *refsv1beta1.ProjectRef `json:"projectRef,omitempty"`

	// The organization that this resource belongs to. Exactly one of projectRef or organizationRef must be specified.
...
type NetworkSecuritySecurityProfileGroupObservedState struct {
	...
	// +kcc:proto:field=google.cloud.networksecurity.v1.SecurityProfileGroup.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Last resource update timestamp.
	// +kcc:proto:field=google.cloud.networksecurity.v1.SecurityProfileGroup.update_time
	UpdateTime *string `json:"updateTime,omitempty"`

	// Output only. This checksum is computed by the server based on the value of other fields,
	// and may be sent on update and delete requests to ensure the client has an up-to-date value before proceeding.
