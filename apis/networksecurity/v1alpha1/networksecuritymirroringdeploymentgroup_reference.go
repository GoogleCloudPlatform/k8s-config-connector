...
// NetworkSecurityMirroringDeploymentGroupRef is a reference to a GCP NetworkSecurityMirroringDeploymentGroup.
...
func init() {
	refs.Register(&NetworkSecurityMirroringDeploymentGroupRef{}, &NetworkSecurityMirroringDeploymentGroup{})
}
