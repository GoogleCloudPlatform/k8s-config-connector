...
// NetworkSecuritySecurityProfileGroupRef defines the resource reference to NetworkSecuritySecurityProfileGroup, which "External" field
...
func (r *NetworkSecuritySecurityProfileGroupRef) SetExternal(ref string) {
	r.External = ref
}

func (r *NetworkSecuritySecurityProfileGroupRef) ValidateExternal(ref string) error {
...
func (r *NetworkSecuritySecurityProfileGroupRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &NetworkSecuritySecurityProfileGroupIdentity{}
...
func (r *NetworkSecuritySecurityProfileGroupRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromNetworkSecuritySecurityProfileGroupSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
