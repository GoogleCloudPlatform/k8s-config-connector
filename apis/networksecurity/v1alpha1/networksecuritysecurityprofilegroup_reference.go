...
// NetworkSecuritySecurityProfileGroupRef is a reference to a GCP NetworkSecuritySecurityProfileGroup.
type NetworkSecuritySecurityProfileGroupRef struct {
	// A reference to an externally managed NetworkSecuritySecurityProfileGroup resource. Should be in the format "projects/{{projectID}}/locations/{{location}}/securityProfileGroups/{{securityProfileGroup}}"
...
func (r *NetworkSecuritySecurityProfileGroupRef) ValidateExternal(external string) error {
	return (&NetworkSecuritySecurityProfileGroupIdentity{}).FromExternal(external)
}

func (r *NetworkSecuritySecurityProfileGroupRef) ParseExternalToIdentity() (identity.Identity, error) {
	i := &NetworkSecuritySecurityProfileGroupIdentity{}
