...
type NetworkSecurityBackendAuthenticationConfigRef struct {
	...
	// The namespace of a NetworkSecurityBackendAuthenticationConfig resource.
...
func (r *NetworkSecurityBackendAuthenticationConfigRef) GetGVK() schema.GroupVersionKind {
	return NetworkSecurityBackendAuthenticationConfigGVK
}

func (r *NetworkSecurityBackendAuthenticationConfigRef) GetNamespacedName() types.NamespacedName {
...
func (r *NetworkSecurityBackendAuthenticationConfigRef) GetExternal() string {
	return r.External
}
...
func (r *NetworkSecurityBackendAuthenticationConfigRef) ValidateExternal(ref string) error {
	id := &NetworkSecurityBackendAuthenticationConfigIdentity{}
...
func (r *NetworkSecurityBackendAuthenticationConfigRef) ParseExternalToIdentity() (identity.Identity, error) {
	id := &NetworkSecurityBackendAuthenticationConfigIdentity{}
...
func (r *NetworkSecurityBackendAuthenticationConfigRef) Normalize(ctx context.Context, reader client.Reader, defaultNamespace string) error {
	fallback := func(u *unstructured.Unstructured) string {
		identity, err := getIdentityFromNetworkSecurityBackendAuthenticationConfigSpec(ctx, reader, u)
		if err != nil {
			return ""
		}
