...
type NetworkSecurityFirewallEndpointObservedState struct {
	...
	Associations []FirewallEndpointAssociationReferenceObservedState `json:"associations,omitempty"`
}

// +kcc:proto=google.cloud.networksecurity.v1.FirewallEndpoint.AssociationReference
type FirewallEndpointAssociationReferenceObservedState struct {
