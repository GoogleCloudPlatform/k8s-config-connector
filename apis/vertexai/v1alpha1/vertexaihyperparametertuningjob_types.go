...
// +kcc:spec:proto=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob
type VertexAIHyperparameterTuningJobSpec struct {
	...
	//  characters.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.display_name
	// +required
	DisplayName *string `json:"displayName,omitempty"`

	// Required. Study configuration of the HyperparameterTuningJob.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.study_spec
	// +required
	StudySpec *StudySpec `json:"studySpec,omitempty"`

	// Required. The desired total number of Trials.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.max_trial_count
	// +required
	MaxTrialCount *int32 `json:"maxTrialCount,omitempty"`

	// Required. The desired number of Trials to run in parallel.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.parallel_trial_count
	// +required
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.max_failed_trial_count
	// +optional
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.trial_job_spec
	// +required
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.labels
	// +optional
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.encryption_spec
	// +optional
...
// +kcc:observedstate:proto=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob
type VertexAIHyperparameterTuningJobObservedState struct {
	// Output only. Resource name of the HyperparameterTuningJob.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.name
	Name *string `json:"name,omitempty"`

	// Required. Study configuration of the HyperparameterTuningJob.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.study_spec
	StudySpec *StudySpecObservedState `json:"studySpec,omitempty"`

	// Output only. Trials of the HyperparameterTuningJob.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.trials
	Trials []TrialObservedState `json:"trials,omitempty"`

	// Output only. The detailed state of the job.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.state
	State *string `json:"state,omitempty"`

	// Output only. Time when the HyperparameterTuningJob was created.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Time when the HyperparameterTuningJob for the first time
	//  entered the `JOB_STATE_RUNNING` state.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.start_time
	StartTime *string `json:"startTime,omitempty"`

	// Output only. Time when the HyperparameterTuningJob entered any of the
	//  following states: `JOB_STATE_SUCCEEDED`, `JOB_STATE_FAILED`,
	//  `JOB_STATE_CANCELLED`.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.end_time
	EndTime *string `json:"endTime,omitempty"`

	// Output only. Time when the HyperparameterTuningJob was most recently
	//  updated.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.update_time
	UpdateTime *string `json:"updateTime,omitempty"`

	// Output only. Only populated when job's state is JOB_STATE_FAILED or
	//  JOB_STATE_CANCELLED.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.error
	Error *common.Status `json:"error,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.satisfies_pzs
	SatisfiesPzs *bool `json:"satisfiesPzs,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.HyperparameterTuningJob.satisfies_pzi
