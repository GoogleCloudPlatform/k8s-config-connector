...
var VertexAITensorboardExperimentGVK = GroupVersion.WithKind("VertexAITensorboardExperiment")

// VertexAITensorboardExperimentSpec defines the desired state of VertexAITensorboardExperiment
type VertexAITensorboardExperimentSpec struct {
	...
	// The parent Tensorboard of this resource.
	// +required
...
// VertexAITensorboardExperimentStatus defines the config connector machine state of VertexAITensorboardExperiment
type VertexAITensorboardExperimentStatus struct {
	...
	ObservedState *VertexAITensorboardExperimentObservedState `json:"observedState,omitempty"`
}
...
// VertexAITensorboardExperiment is the Schema for the VertexAITensorboardExperiment API
