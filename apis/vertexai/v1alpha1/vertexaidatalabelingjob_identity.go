...
const VertexAIDataLabelingJobIdentityURL = "projects/{project}/locations/{location}/dataLabelingJobs/{dataLabelingJob}"

var VertexAIDataLabelingJobIdentityFormat = gcpurls.Template[VertexAIDataLabelingJobIdentity](
	"vertexai.googleapis.com",
	VertexAIDataLabelingJobIdentityURL,
)

// VertexAIDataLabelingJobIdentity represents the identity of a VertexAIDataLabelingJob.
...
func (obj *VertexAIDataLabelingJob) GetIdentity(ctx context.Context, reader client.Reader) (identity.Identity, error) {
	...
	if externalRef != "" {
		...
		if statusIdentity.String() != specIdentity.String() {
			return nil, fmt.Errorf("cannot change VertexAIDataLabelingJob identity (old=%q, new=%q)", statusIdentity.String(), specIdentity.String())
		}
	}
