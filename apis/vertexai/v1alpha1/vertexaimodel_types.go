...
var VertexAIModelGVK = GroupVersion.WithKind("VertexAIModel")

// VertexAIModelSpec defines the desired state of VertexAIModel
// +kcc:spec:proto=google.cloud.aiplatform.v1beta1.Model
type VertexAIModelSpec struct {
	...
	//  model.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.version_aliases
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.version_description
	VersionDescription *string `json:"versionDescription,omitempty"`

	// The default checkpoint id of a model version.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.default_checkpoint_id
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.predict_schemata
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.metadata_schema_uri
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.metadata
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.container_spec
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.artifact_uri
	...
	//  of
	//  [BatchPredictionJob][google.cloud.aiplatform.v1beta1.BatchPredictionJob].
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.explanation_spec
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.labels
	Labels map[string]string `json:"labels,omitempty"`

	// Customer-managed encryption key spec for a Model. If set, this
	//  Model and all sub-resources of this Model will be secured by this key.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.encryption_spec
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.base_model_source
	BaseModelSource *Model_BaseModelSource `json:"baseModelSource,omitempty"`
}

// VertexAIModelStatus defines the config connector machine state of VertexAIModel
type VertexAIModelStatus struct {
	...
	// A unique specifier for the VertexAIModel resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *VertexAIModelObservedState `json:"observedState,omitempty"`
}

// VertexAIModelObservedState is the state of the VertexAIModel resource as most recently observed in GCP.
// +kcc:observedstate:proto=google.cloud.aiplatform.v1beta1.Model
type VertexAIModelObservedState struct {
	// Output only. Immutable. The version ID of the model.
	//  A new version is committed when a new model version is uploaded or
	//  trained under an existing model id. It is an auto-incrementing decimal
	//  number in string representation.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.version_id
	VersionID *string `json:"versionID,omitempty"`

	// Output only. Timestamp when this version was created.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.version_create_time
	VersionCreateTime *string `json:"versionCreateTime,omitempty"`

	// Output only. Timestamp when this version was most recently updated.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.version_update_time
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.supported_export_formats
	...
	//  Model, if any.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.training_pipeline
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.supported_deployment_resources_types
	...
	//  or
	//  [PredictionService.Explain][google.cloud.aiplatform.v1beta1.PredictionService.Explain].
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.supported_input_storage_formats
	...
	//  or
	//  [PredictionService.Explain][google.cloud.aiplatform.v1beta1.PredictionService.Explain].
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.supported_output_storage_formats
	SupportedOutputStorageFormats []string `json:"supportedOutputStorageFormats,omitempty"`

	// Output only. Timestamp when this Model was uploaded into Vertex AI.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Timestamp when this Model was most recently updated.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.update_time
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.deployed_models
	...
	//  Model Garden.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.model_source_info
	ModelSourceInfo *ModelSourceInfo `json:"modelSourceInfo,omitempty"`

	// Output only. If this Model is a copy of another Model, this contains info
	//  about the original.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.original_model_info
	...
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.metadata_artifact
	MetadataArtifact *string `json:"metadataArtifact,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.satisfies_pzs
	SatisfiesPzs *bool `json:"satisfiesPzs,omitempty"`

	// Output only. Reserved for future use.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.satisfies_pzi
	SatisfiesPzi *bool `json:"satisfiesPzi,omitempty"`

	// Optional. Output only. The checkpoints of the model.
	// +kcc:proto:field=google.cloud.aiplatform.v1beta1.Model.checkpoints
	Checkpoints []Checkpoint `json:"checkpoints,omitempty"`
}

// +genclient
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// +kubebuilder:resource:categories=gcp,shortName=gcpvertexaimodel;gcpvertexaimodels
...
// VertexAIModel is the Schema for the VertexAIModel API
...
type VertexAIModel struct {
	...
	// +required
	Spec   VertexAIModelSpec   `json:"spec,omitempty"`
	Status VertexAIModelStatus `json:"status,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// VertexAIModelList contains a list of VertexAIModel
type VertexAIModelList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VertexAIModel `json:"items"`
}
