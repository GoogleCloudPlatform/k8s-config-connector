...
func (i *VertexAIBatchPredictionJobIdentity) ParentString() string {
	return "projects/" + i.Project + "/locations/" + i.Location
}

func getIdentityFromVertexAIBatchPredictionJobSpec(ctx context.Context, reader client.Reader, obj *VertexAIBatchPredictionJob) (*VertexAIBatchPredictionJobIdentity, error) {
