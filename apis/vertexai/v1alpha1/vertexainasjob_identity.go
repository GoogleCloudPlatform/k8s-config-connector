...
// VertexAINasJobIdentity is the identity of a GCP VertexAINasJob resource.
...
func (i *VertexAINasJobIdentity) ParentString() string {
	return "projects/" + i.Project + "/locations/" + i.Location
}

func getIdentityFromVertexAINasJobSpec(ctx context.Context, reader client.Reader, obj *VertexAINasJob) (*VertexAINasJobIdentity, error) {
