...
// See the License for the do specific language governing permissions and
...
func (i *VertexAINotebookExecutionJobIdentity) ParentString() string {
	return "projects/" + i.Project + "/locations/" + i.Location
}

func getIdentityFromVertexAINotebookExecutionJobSpec(ctx context.Context, reader client.Reader, obj *VertexAINotebookExecutionJob) (*VertexAINotebookExecutionJobIdentity, error) {
