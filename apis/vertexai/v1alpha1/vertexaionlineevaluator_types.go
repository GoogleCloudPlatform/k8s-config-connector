...
type VertexAIOnlineEvaluatorSpec struct {
	...
	// Optional. User provided display name of the OnlineEvaluator.
	DisplayName *string `json:"displayName,omitempty"`

	// Optional. Configuration for GCP Cloud Observability as data source.
	CloudObservability *OnlineEvaluator_CloudObservability `json:"cloudObservability,omitempty"`

	// Optional. Configuration for online evaluation.
	Config *OnlineEvaluator_Config `json:"config,omitempty"`

	// Optional. Agent resource that is monitored and evaluated.
	AgentResource *string `json:"agentResource,omitempty"`

	// Optional. The metric sources configuration.
...
type VertexAIOnlineEvaluatorObservedState struct {
	// Output only. The resource name of the OnlineEvaluator.
	Name *string `json:"name,omitempty"`

	// Output only. The state of the OnlineEvaluator.
	State *string `json:"state,omitempty"`

	// Output only. State details of the OnlineEvaluator.
	StateDetails *OnlineEvaluator_StateDetails `json:"stateDetails,omitempty"`

	// Output only. Timestamp when this OnlineEvaluator was created.
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. Timestamp when this OnlineEvaluator was most recently updated.
