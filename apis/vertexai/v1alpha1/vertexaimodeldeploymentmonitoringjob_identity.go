...
// VertexAIModelDeploymentMonitoringJobIdentity is the identity of a GCP VertexAIModelDeploymentMonitoringJob resource.
...
func getIdentityFromVertexAIModelDeploymentMonitoringJobSpec(ctx context.Context, reader client.Reader, obj *VertexAIModelDeploymentMonitoringJob) (*VertexAIModelDeploymentMonitoringJobIdentity, error) {
