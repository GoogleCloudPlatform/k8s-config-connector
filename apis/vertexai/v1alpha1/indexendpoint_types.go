...
type DeployedIndexObservedState struct {
	...
	//  The field is used to identify the index deployment.
	...
	//  [read][google.longrunning.Operations.GetOperation] IndexEndpoint.update_time
	//  or Index.update_time.
	//  In such a case if that are not synchronous
	...
	//  Please specify the configuration for the deployed index.
	...
	// Optional. A list of Projects from which the forwarding rule will target the service
	//  attachment.
