...
type BackupRef struct {
	// A reference to an externally managed BackupDRBackup resource. Should be in the format "projects/{{projectID}}/locations/{{location}}/backupVaults/{{backupvaultID}}/dataSources/{{datasourceID}}/backups/{{backupID}}"
