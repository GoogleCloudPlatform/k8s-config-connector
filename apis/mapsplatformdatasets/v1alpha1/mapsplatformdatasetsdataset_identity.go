...
// MapsPlatformDatasetsDatasetIdentity is the identity of a GCP MapsPlatformDatasetsDataset resource.
...
func (i *MapsPlatformDatasetsDatasetIdentity) ParentString() string {
	return "projects/" + i.Project
}

func getIdentityFromMapsPlatformDatasetsDatasetSpec(ctx context.Context, reader client.Reader, obj *MapsPlatformDatasetsDataset) (*MapsPlatformDatasetsDatasetIdentity, error) {
	...
	datasetIdentity := &MapsPlatformDatasetsDatasetIdentity{
		Project: projectID,
		Dataset: resourceID,
	}
	return datasetIdentity, nil
}
