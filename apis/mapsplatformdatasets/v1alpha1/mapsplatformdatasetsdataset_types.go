...
type MapsPlatformDatasetsDatasetSpec struct {
	...
	// +kcc:proto:field=google.maps.mapsplatformdatasets.v1.Dataset.display_name
	DisplayName *string `json:"displayName,omitempty"`

	// A description of this dataset.
	// +kubebuilder:validation:Optional
	// +kcc:proto:field=google.maps.mapsplatformdatasets.v1.Dataset.description
	Description *string `json:"description,omitempty"`

	// The version ID of the dataset.
	// +kubebuilder:validation:Optional
	// +kcc:proto:field=google.maps.mapsplatformdatasets.v1.Dataset.version_id
	VersionID *string `json:"versionID,omitempty"`

	// Specified use case for this dataset.
	// +kubebuilder:validation:Optional
	// +kcc:proto:field=google.maps.mapsplatformdatasets.v1.Dataset.usage
	Usage []string `json:"usage,omitempty"`

	// A local file source for the dataset for a single upload.
	// +kubebuilder:validation:Optional
	// +kcc:proto:field=google.maps.mapsplatformdatasets.v1.Dataset.local_file_source
	...
	// +kubebuilder:validation:Optional
	// +kcc:proto:field=google.maps.mapsplatformdatasets.v1.Dataset.gcs_source
