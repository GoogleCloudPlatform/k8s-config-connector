...
var AppHubServiceProjectAttachmentGVK = GroupVersion.WithKind("AppHubServiceProjectAttachment")
...
// AppHubServiceProjectAttachmentSpec defines the desired state of AppHubServiceProjectAttachment
...
type AppHubServiceProjectAttachmentStatus struct {
...
// AppHubServiceProjectAttachment is the Schema for the AppHubServiceProjectAttachment API
...
type AppHubServiceProjectAttachment struct {
	...
	// +required
	Spec   AppHubServiceProjectAttachmentSpec   `json:"spec,omitempty"`
	Status AppHubServiceProjectAttachmentStatus `json:"status,omitempty"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
// AppHubServiceProjectAttachmentList contains a list of AppHubServiceProjectAttachment
type AppHubServiceProjectAttachmentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AppHubServiceProjectAttachment `json:"items"`
}

func init() {
	SchemeBuilder.Register(&AppHubServiceProjectAttachment{}, &AppHubServiceProjectAttachmentList{})
}
