...
// +kcc:spec:proto=google.cloud.securitycentermanagement.v1.SecurityHealthAnalyticsCustomModule
type SecurityCenterManagementSecurityHealthAnalyticsCustomModuleSpec struct {
	...
	// +kubebuilder:validation:Enum=ENABLEMENT_STATE_UNSPECIFIED;ENABLED;DISABLED
...
// +kcc:observedstate:proto=google.cloud.securitycentermanagement.v1.SecurityHealthAnalyticsCustomModule
