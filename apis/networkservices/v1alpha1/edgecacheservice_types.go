...
type EdgeCacheService_Routing struct {
	...
	HostRules []EdgeCacheService_HostRule `json:"hostRules"`
	...
	PathMatchers []EdgeCacheService_PathMatcher `json:"pathMatchers"`
}

// +kcc:proto=google.cloud.networkservices.v1.HostRule
type EdgeCacheService_HostRule struct {
...
type EdgeCacheService_PathMatcher struct {
	...
	RouteRules []EdgeCacheService_RouteRule `json:"routeRules"`
}

// +kcc:proto=google.cloud.networkservices.v1.RouteRule
type EdgeCacheService_RouteRule struct {
	...
	MatchRules []EdgeCacheService_MatchRule `json:"matchRules"`
	...
	HeaderAction *EdgeCacheService_HeaderAction `json:"headerAction,omitempty"`
	...
	RouteAction *EdgeCacheService_RouteAction `json:"routeAction,omitempty"`
	...
	UrlRedirect *EdgeCacheService_UrlRedirect `json:"urlRedirect,omitempty"`

	// Optional. The origin that requests are routed to when this rule matches.
	// Format: projects/{project}/locations/{location}/edgeCacheOrigins/{origin}
	...
	RouteMethods *EdgeCacheService_RouteMethods `json:"routeMethods,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.RouteMethods
type EdgeCacheService_RouteMethods struct {
...
type EdgeCacheService_MatchRule struct {
	...
	HeaderMatches []EdgeCacheService_HeaderMatch `json:"headerMatches,omitempty"`
	...
	QueryParameterMatches []EdgeCacheService_QueryParameterMatch `json:"queryParameterMatches,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.HeaderMatch
type EdgeCacheService_HeaderMatch struct {
	...
	// Optional. Specifies that the header must exist.
	// +kcc:proto:field=google.cloud.networkservices.v1.HeaderMatch.present_match
	PresentMatch *bool `json:"presentMatch,omitempty"`

	// Optional. The value of the header must exactly match the contents of exactMatch.
...
type EdgeCacheService_QueryParameterMatch struct {
	...
	// Optional. Specifies that the query parameter must exist.
	// +kcc:proto:field=google.cloud.networkservices.v1.QueryParameterMatch.present_match
	PresentMatch *bool `json:"presentMatch,omitempty"`

	// Optional. The value of the query parameter must exactly match the contents
	// of exactMatch.
...
type EdgeCacheService_HeaderAction struct {
	// Optional. Describes headers to add to the request before forwarding to origin.
	// +kcc:proto:field=google.cloud.networkservices.v1.HeaderAction.request_headers_to_add
	RequestHeadersToAdd []EdgeCacheService_AddHeader `json:"requestHeadersToAdd,omitempty"`
	...
	RequestHeadersToRemove []EdgeCacheService_RemoveHeader `json:"requestHeadersToRemove,omitempty"`

	// Optional. Describes headers to add to the response before sending to the client.
	// +kcc:proto:field=google.cloud.networkservices.v1.HeaderAction.response_headers_to_add
	ResponseHeadersToAdd []EdgeCacheService_AddHeader `json:"responseHeadersToAdd,omitempty"`
	...
	ResponseHeadersToRemove []EdgeCacheService_RemoveHeader `json:"responseHeadersToRemove,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.AddHeader
type EdgeCacheService_AddHeader struct {
...
type EdgeCacheService_RemoveHeader struct {
...
type EdgeCacheService_RouteAction struct {
	// Optional. The policy that determines the caching behavior for the route.
	// +kcc:proto:field=google.cloud.networkservices.v1.RouteAction.cdn_policy
	CdnPolicy *EdgeCacheService_CdnPolicy `json:"cdnPolicy,omitempty"`
	...
	UrlRewrite *EdgeCacheService_UrlRewrite `json:"urlRewrite,omitempty"`
	...
	CorsPolicy *EdgeCacheService_CorsPolicy `json:"corsPolicy,omitempty"`
...
type EdgeCacheService_CdnPolicy struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.CdnPolicy.negative_caching_policy
	...
	CacheKeyPolicy *EdgeCacheService_CacheKeyPolicy `json:"cacheKeyPolicy,omitempty"`
	...
	// Format: projects/{project}/locations/{location}/edgeCacheKeysets/{keyset}
	...
	SignedTokenOptions *EdgeCacheService_SignedTokenOptions `json:"signedTokenOptions,omitempty"`
	...
	AddSignatures *EdgeCacheService_AddSignatures `json:"addSignatures,omitempty"`
...
type EdgeCacheService_CacheKeyPolicy struct {
...
type EdgeCacheService_SignedTokenOptions struct {
...
type EdgeCacheService_AddSignatures struct {
...
type EdgeCacheService_UrlRedirect struct {
...
type EdgeCacheService_UrlRewrite struct {
...
type EdgeCacheService_CorsPolicy struct {
...
type EdgeCacheService_LogConfig struct {
...
type NetworkServicesEdgeCacheServiceSpec struct {
	...
	*parent.ProjectAndLocationRef `json:",inline"`
	...
	Routing *EdgeCacheService_Routing `json:"routing"`
	...
	// Format: projects/{project}/global/sslCertificates/{certificate}
	...
	LogConfig *EdgeCacheService_LogConfig `json:"logConfig,omitempty"`
