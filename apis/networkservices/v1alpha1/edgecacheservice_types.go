...
// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.AddSignatures
type EdgeCacheServiceAddSignatures struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.AddSignatures.actions
	...
	* 'Headers'
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.AddSignatures.copied_parameters
	...
	* 'yourKeyset'
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.AddSignatures.token_query_parameter
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.AddSignatures.token_ttl
	TokenTtl *string `json:"tokenTtl,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy
type EdgeCacheServiceCacheKeyPolicy struct {
	/* If true, requests to different hosts will be cached separately.

	Note: this should only be enabled if hosts share the same origin and content. Removing the host from the cache key may inadvertently result in different objects being cached than intended, depending on which route the first user matched. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy.exclude_host
	...
	included. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy.exclude_query_string
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy.excluded_query_parameters
	ExcludedQueryParameters []string `json:"excludedQueryParameters,omitempty"`

	/* If true, http and https requests will be cached separately. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy.include_protocol
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy.included_cookie_names
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy.included_header_names
	...
	Either specify includedQueryParameters or excludedQueryParameters, not both. '&' and '=' will be percent encoded and not treated as delimiters. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CacheKeyPolicy.included_query_parameters
	IncludedQueryParameters []string `json:"includedQueryParameters,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy
type EdgeCacheServiceCdnPolicy struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.add_signatures
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.cache_key_policy
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.cache_mode
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.client_ttl
	...
	A duration in seconds terminated by 's'. Example: "3s". */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.default_ttl
	...
	A duration in seconds terminated by 's'. Example: "3s". */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.max_ttl
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.negative_caching
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.negative_caching_policy
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.signed_request_maximum_expiration_ttl
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.signed_request_mode
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CdnPolicy.signed_token_options
	SignedTokenOptions *EdgeCacheServiceSignedTokenOptions `json:"signedTokenOptions,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.CorsPolicy
type EdgeCacheServiceCorsPolicy struct {
	/* In response to a preflight request, setting this to true indicates that the actual request can include user credentials.

	This translates to the Access-Control-Allow-Credentials response header. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CorsPolicy.allow_credentials
	AllowCredentials *bool `json:"allowCredentials,omitempty"`

	/* Specifies the content for the Access-Control-Allow-Headers response header. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CorsPolicy.allow_headers
	AllowHeaders []string `json:"allowHeaders,omitempty"`

	/* Specifies the content for the Access-Control-Allow-Methods response header. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CorsPolicy.allow_methods
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CorsPolicy.allow_origins
	AllowOrigins []string `json:"allowOrigins,omitempty"`

	/* If true, specifies the CORS policy is disabled. The default value is false, which indicates that the CORS policy is in effect. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CorsPolicy.disabled
	Disabled *bool `json:"disabled,omitempty"`

	/* Specifies the content for the Access-Control-Allow-Headers response header. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.CorsPolicy.expose_headers
...
type EdgeCacheServiceHeaderAction struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderAction.request_header_to_add
	RequestHeaderToAdd []EdgeCacheServiceRequestHeaderToAdd `json:"requestHeaderToAdd,omitempty"`

	/* A list of header names for headers that need to be removed from the request prior to forwarding the request to the origin. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderAction.request_header_to_remove
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderAction.response_header_to_add
	ResponseHeaderToAdd []EdgeCacheServiceResponseHeaderToAdd `json:"responseHeaderToAdd,omitempty"`

	/* A list of header names for headers that need to be removed from the request prior to forwarding the request to the origin. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderAction.response_header_to_remove
	ResponseHeaderToRemove []EdgeCacheServiceResponseHeaderToRemove `json:"responseHeaderToRemove,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.HeaderMatch
type EdgeCacheServiceHeaderMatch struct {
	/* The value of the header should exactly match contents of exactMatch. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderMatch.exact_match
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderMatch.invert_match
	InvertMatch *bool `json:"invertMatch,omitempty"`

	/* The value of the header must start with the contents of prefixMatch. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderMatch.prefix_match
	PrefixMatch *string `json:"prefixMatch,omitempty"`

	/* A header with the contents of headerName must exist. The match takes place whether or not the request's header has a value. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderMatch.present_match
	PresentMatch *bool `json:"presentMatch,omitempty"`

	/* The value of the header must end with the contents of suffixMatch. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HeaderMatch.suffix_match
	SuffixMatch *string `json:"suffixMatch,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.HostRule
type EdgeCacheServiceHostRule struct {
	/* A human-readable description of the hostRule. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HostRule.description
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.HostRule.hosts
...
// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.MatchRule
type EdgeCacheServiceMatchRule struct {
	/* For satisfying the matchRule condition, the path of the request must exactly match the value specified in fullPathMatch after removing any query parameters and anchor that may be part of the original URL. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.MatchRule.full_path_match
	FullPathMatch *string `json:"fullPathMatch,omitempty"`

	/* Specifies a list of header match criteria, all of which must match corresponding headers in the request. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.MatchRule.header_match
	HeaderMatch []EdgeCacheServiceHeaderMatch `json:"headerMatch,omitempty"`

	/* Specifies that prefixMatch and fullPathMatch matches are case sensitive. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.MatchRule.ignore_case
	...
	captures in total. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.MatchRule.path_template_match
	PathTemplateMatch *string `json:"pathTemplateMatch,omitempty"`

	/* For satisfying the matchRule condition, the request's path must begin with the specified prefixMatch. prefixMatch must begin with a /. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.MatchRule.prefix_match
	PrefixMatch *string `json:"prefixMatch,omitempty"`

	/* Specifies a list of query parameter match criteria, all of which must match corresponding query parameters in the request. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.MatchRule.query_parameter_match
	QueryParameterMatch []EdgeCacheServiceQueryParameterMatch `json:"queryParameterMatch,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.PathMatcher
type EdgeCacheServicePathMatcher struct {
	/* A human-readable description of the resource. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.PathMatcher.description
	Description *string `json:"description,omitempty"`
...
// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.QueryParameterMatch
type EdgeCacheServiceQueryParameterMatch struct {
	/* The queryParameterMatch matches if the value of the parameter exactly matches the contents of exactMatch. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.QueryParameterMatch.exact_match
	ExactMatch *string `json:"exactMatch,omitempty"`
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.QueryParameterMatch.present_match
	PresentMatch *bool `json:"presentMatch,omitempty"`
}
...
type EdgeCacheServiceRequestHeaderToAdd struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RequestHeaderToAdd.replace
...
type EdgeCacheServiceResponseHeaderToAdd struct {
	...
	/* Whether to replace all existing headers with the same name. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.ResponseHeaderToAdd.replace
	Replace *bool `json:"replace,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.ResponseHeaderToRemove
...
type EdgeCacheServiceRouteAction struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteAction.cdn_policy
	CdnPolicy *EdgeCacheServiceCdnPolicy `json:"cdnPolicy,omitempty"`

	/* CORSPolicy defines Cross-Origin-Resource-Sharing configuration, including which CORS response headers will be set. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteAction.cors_policy
	CorsPolicy *EdgeCacheServiceCorsPolicy `json:"corsPolicy,omitempty"`

	/* The URL rewrite configuration for requests that match this route. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteAction.url_rewrite
	UrlRewrite *EdgeCacheServiceUrlRewrite `json:"urlRewrite,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.RouteRule
type EdgeCacheServiceRouteRule struct {
	/* A human-readable description of the routeRule. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteRule.description
	Description *string `json:"description,omitempty"`

	/* The header actions, including adding & removing headers, for requests that match this route. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteRule.header_action
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteRule.match_rules
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteRule.route_action
	RouteAction *EdgeCacheServiceRouteAction `json:"routeAction,omitempty"`

	/* The URL redirect configuration for requests that match this route. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.RouteRule.url_redirect
	UrlRedirect *EdgeCacheServiceUrlRedirect `json:"urlRedirect,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.Routing
type EdgeCacheServiceRouting struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.Routing.host_rules
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.Routing.path_matchers
	PathMatcher []EdgeCacheServicePathMatcher `json:"pathMatcher"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.SignedTokenOptions
type EdgeCacheServiceSignedTokenOptions struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.SignedTokenOptions.allowed_signature_algorithms
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.SignedTokenOptions.token_query_parameter
	TokenQueryParameter *string `json:"tokenQueryParameter,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.UrlRedirect
type EdgeCacheServiceUrlRedirect struct {
	/* The host that will be used in the redirect response instead of the one that was supplied in the request. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRedirect.host_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRedirect.https_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRedirect.path_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRedirect.prefix_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRedirect.redirect_response_code
	RedirectResponseCode *string `json:"redirectResponseCode,omitempty"`

	/* If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRedirect.strip_query
	StripQuery *bool `json:"stripQuery,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1.EdgeCacheService.UrlRewrite
type EdgeCacheServiceUrlRewrite struct {
	/* Prior to forwarding the request to the selected origin, the request's host header is replaced with contents of hostRewrite. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRewrite.host_rewrite
	HostRewrite *string `json:"hostRewrite,omitempty"`

	/* Prior to forwarding the request to the selected origin, the matching portion of the request's path is replaced by pathPrefixRewrite. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRewrite.path_prefix_rewrite
	...
	specified. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheService.UrlRewrite.path_template_rewrite
