...
type EdgecacheserviceAddSignatures struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.AddSignatures.actions
	...
	* 'Headers'
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.AddSignatures.copied_parameters
	...
	* 'yourKeyset'
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.AddSignatures.token_query_parameter
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.AddSignatures.token_ttl
...
type EdgecacheserviceCacheKeyPolicy struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.CacheKeyPolicy.exclude_host
	...
	included. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.CacheKeyPolicy.exclude_query_string
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.CacheKeyPolicy.excluded_query_parameters
	ExcludedQueryParameters []string `json:"excludedQueryParameters,omitempty"`

	/* If true, http and https requests will be cached separately. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.CacheKeyPolicy.include_protocol
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.CacheKeyPolicy.included_cookie_names
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.CacheKeyPolicy.included_header_names
	...
	Either specify includedQueryParameters or excludedQueryParameters, not both. '&' and '=' will be percent encoded and not treated as delimiters. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.CacheKeyPolicy.included_query_parameters
...
type EdgecacheserviceCdnPolicy struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.add_signatures
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.cache_key_policy
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.cache_mode
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.client_ttl
	...
	A duration in seconds terminated by 's'. Example: "3s". */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.default_ttl
	...
	A duration in seconds terminated by 's'. Example: "3s". */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.max_ttl
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.negative_caching
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.negative_caching_policy
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.signed_request_maximum_expiration_ttl
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.signed_request_mode
...
type EdgecacheserviceCorsPolicy struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CorsPolicy.allow_credentials
	AllowCredentials *bool `json:"allowCredentials,omitempty"`

	/* Specifies the content for the Access-Control-Allow-Headers response header. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CorsPolicy.allow_headers
	AllowHeaders []string `json:"allowHeaders,omitempty"`

	/* Specifies the content for the Access-Control-Allow-Methods response header. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CorsPolicy.allow_methods
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CorsPolicy.allow_origins
	AllowOrigins []string `json:"allowOrigins,omitempty"`

	/* If true, specifies the CORS policy is disabled. The default value is false, which indicates that the CORS policy is in effect. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CorsPolicy.disabled
	Disabled *bool `json:"disabled,omitempty"`

	/* Specifies the content for the Access-Control-Allow-Headers response header. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CorsPolicy.expose_headers
	...
	A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s". */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CorsPolicy.max_age
...
type EdgecacheserviceHeaderAction struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.request_header_to_add
	RequestHeaderToAdd []EdgecacheserviceRequestHeaderToAdd `json:"requestHeaderToAdd,omitempty"`

	/* A list of header names for headers that need to be removed from the request prior to forwarding the request to the origin. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.request_header_to_remove
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.response_header_to_add
	ResponseHeaderToAdd []EdgecacheserviceResponseHeaderToAdd `json:"responseHeaderToAdd,omitempty"`

	/* A list of header names for headers that need to be removed from the request prior to forwarding the request to the origin. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.response_header_to_remove
...
type EdgecacheserviceHeaderMatch struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.HeaderMatch.exact_match
	ExactMatch *string `json:"exactMatch,omitempty"`

	/* The header name to match on. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.HeaderMatch.header_name
	HeaderName string `json:"headerName"`

	/* If set to false (default), the headerMatch is considered a match if the match criteria above are met.
	If set to true, the headerMatch is considered a match if the match criteria above are NOT met. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.HeaderMatch.invert_match
	InvertMatch *bool `json:"invertMatch,omitempty"`

	/* The value of the header must start with the contents of prefixMatch. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.HeaderMatch.prefix_match
	PrefixMatch *string `json:"prefixMatch,omitempty"`

	/* A header with the contents of headerName must exist. The match takes place whether or not the request's header has a value. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.HeaderMatch.present_match
	PresentMatch *bool `json:"presentMatch,omitempty"`

	/* The value of the header must end with the contents of suffixMatch. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.HeaderMatch.suffix_match
...
type EdgecacheserviceHostRule struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.HostRule.description
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.HostRule.hosts
	Hosts []string `json:"hosts"`

	/* The name of the pathMatcher associated with this hostRule. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.HostRule.path_matcher
...
type EdgecacheserviceMatchRule struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.full_path_match
	FullPathMatch *string `json:"fullPathMatch,omitempty"`

	/* Specifies a list of header match criteria, all of which must match corresponding headers in the request. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.header_match
	HeaderMatch []EdgecacheserviceHeaderMatch `json:"headerMatch,omitempty"`

	/* Specifies that prefixMatch and fullPathMatch matches are case sensitive. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.ignore_case
	...
	captures in total. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.path_template_match
	PathTemplateMatch *string `json:"pathTemplateMatch,omitempty"`

	/* For satisfying the matchRule condition, the request's path must begin with the specified prefixMatch. prefixMatch must begin with a /. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.prefix_match
	PrefixMatch *string `json:"prefixMatch,omitempty"`

	/* Specifies a list of query parameter match criteria, all of which must match corresponding query parameters in the request. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.query_parameter_match
...
type EdgecacheservicePathMatcher struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.PathMatcher.description
	Description *string `json:"description,omitempty"`

	/* The name to which this PathMatcher is referred by the HostRule. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.PathMatcher.name
	Name string `json:"name"`

	/* The routeRules to match against. routeRules support advanced routing behaviour, and can match on paths, headers and query parameters, as well as status codes and HTTP methods. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.PathMatcher.route_rule
...
type EdgecacheserviceQueryParameterMatch struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.QueryParameterMatch.exact_match
	ExactMatch *string `json:"exactMatch,omitempty"`

	/* The name of the query parameter to match. The query parameter must exist in the request, in the absence of which the request match fails. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.QueryParameterMatch.name
	Name string `json:"name"`

	/* Specifies that the queryParameterMatch matches if the request contains the query parameter, irrespective of whether the parameter has a value or not. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.RouteMatch.QueryParameterMatch.present_match
	PresentMatch *bool `json:"presentMatch,omitempty"`
}

type EdgecacheserviceRequestHeaderToAdd struct {
	/* The name of the header to add. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.HeaderOptions.header_name
	HeaderName string `json:"headerName"`

	/* The value of the header to add. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.HeaderOptions.header_value
	HeaderValue string `json:"headerValue"`

	/* Whether to replace all existing headers with the same name. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.HeaderOptions.replace
	Replace *bool `json:"replace,omitempty"`
}

type EdgecacheserviceRequestHeaderToRemove struct {
	/* The name of the header to remove. */
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.HeaderAction.header_name
	HeaderName string `json:"headerName"`
}
...
type EdgecacheserviceRouteAction struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.cdn_policy
	CdnPolicy *EdgecacheserviceCdnPolicy `json:"cdnPolicy,omitempty"`

	/* CORSPolicy defines Cross-Origin-Resource-Sharing configuration, including which CORS response headers will be set. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.cors_policy
	CorsPolicy *EdgecacheserviceCorsPolicy `json:"corsPolicy,omitempty"`

	/* The URL rewrite configuration for requests that match this route. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.url_rewrite
...
type EdgecacheserviceRouteRule struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.description
	Description *string `json:"description,omitempty"`

	/* The header actions, including adding & removing headers, for requests that match this route. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.header_action
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.match_rules
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.priority
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.RouteRule.route_action
...
type EdgecacheserviceRouting struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.host_rules
	...
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRule.path_matchers
...
type EdgecacheserviceSignedTokenOptions struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.SignedTokenOptions.allowed_signature_algorithms
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.CDNPolicy.SignedTokenOptions.token_query_parameter
	TokenQueryParameter *string `json:"tokenQueryParameter,omitempty"`
}
...
type EdgecacheserviceUrlRedirect struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRedirect.host_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRedirect.https_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRedirect.path_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRedirect.prefix_redirect
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRedirect.redirect_response_code
	RedirectResponseCode *string `json:"redirectResponseCode,omitempty"`

	/* If set to true, any accompanying query portion of the original URL is removed prior to redirecting the request. If set to false, the query portion of the original URL is retained. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRedirect.strip_query
...
type EdgecacheserviceUrlRewrite struct {
	...
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRewrite.host_rewrite
	HostRewrite *string `json:"hostRewrite,omitempty"`

	/* Prior to forwarding the request to the selected origin, the matching portion of the request's path is replaced by pathPrefixRewrite. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRewrite.path_prefix_rewrite
	...
	specified. */
	// +optional
	// +kcc:proto:field=google.cloud.networkservices.v1.EdgeCacheRouteAction.UrlRewrite.path_template_rewrite
