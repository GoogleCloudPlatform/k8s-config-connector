...
type NetworkServicesLBRouteExtensionStatus struct {
	...
	// A unique specifier for the NetworkServicesLBRouteExtension resource in Google Cloud.
...
// NetworkServicesLBRouteExtensionObservedState is the state of the NetworkServicesLBRouteExtension resource as most recently observed in Google Cloud.
