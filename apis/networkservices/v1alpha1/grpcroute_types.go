...
type NetworkservicesGrpcRouteSpec struct {
	// The NetworkservicesGrpcRoute name. If not given, the metadata.name will be used.
...
type NetworkservicesGrpcRouteStatus struct {
	...
	// A unique specifier for the NetworkservicesGrpcRoute resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *NetworkservicesGrpcRouteObservedState `json:"observedState,omitempty"`
}

// NetworkservicesGrpcRouteObservedState is the state of the NetworkservicesGrpcRoute resource as most recently observed in GCP.
// +kcc:proto=google.cloud.networkservices.v1.GrpcRoute
type NetworkservicesGrpcRouteObservedState struct {
}
