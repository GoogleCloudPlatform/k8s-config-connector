...
var NetworkservicesHttpRouteGVK = GroupVersion.WithKind("NetworkservicesHttpRoute")
...
type NetworkservicesHttpRouteSpec struct {
	// The NetworkservicesHttpRoute name. If not given, the metadata.name will be used.
...
type NetworkservicesHttpRouteStatus struct {
	...
	// A unique specifier for the NetworkservicesHttpRoute resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *NetworkservicesHttpRouteObservedState `json:"observedState,omitempty"`
}

// NetworkservicesHttpRouteObservedState is the state of the NetworkservicesHttpRoute resource as most recently observed in GCP.
// +kcc:proto=google.cloud.networkservices.v1.HttpRoute
type NetworkservicesHttpRouteObservedState struct {
}
...
// NetworkservicesHttpRoute is the Schema for the NetworkservicesHttpRoute API
