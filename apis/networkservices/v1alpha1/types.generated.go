...
// +kcc:proto=google.cloud.networkservices.v1beta1.EndpointMatcher
type EndpointMatcher struct {
	// The matcher is based on node metadata presented by xDS clients.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointMatcher.metadata_label_matcher
	MetadataLabelMatcher *EndpointMatcher_MetadataLabelMatcher `json:"metadataLabelMatcher,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher
type EndpointMatcher_MetadataLabelMatcher struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.metadata_label_match_criteria
	...
	//  matches any client).
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.metadata_labels
	MetadataLabels []EndpointMatcher_MetadataLabelMatcher_MetadataLabels `json:"metadataLabels,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabels
type EndpointMatcher_MetadataLabelMatcher_MetadataLabels struct {
	// Required. Label name presented as key in xDS Node Metadata.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabels.label_name
	LabelName *string `json:"labelName,omitempty"`

	// Required. Label value presented as value corresponding to the above
	//  key, in xDS Node Metadata.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabels.label_value
	LabelValue *string `json:"labelValue,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1beta1.EndpointPolicy
type EndpointPolicy struct {
	// Required. Name of the EndpointPolicy resource. It matches pattern
	//  `projects/{project}/locations/global/endpointPolicies/{endpoint_policy}`.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.name
	Name *string `json:"name,omitempty"`

	// Optional. Set of label tags associated with the EndpointPolicy resource.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.labels
	Labels map[string]string `json:"labels,omitempty"`

	// Required. The type of endpoint policy. This is primarily used to validate
	//  the configuration.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.type
	...
	//  endpoint.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.authorization_policy
	...
	//  applied.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.endpoint_matcher
	...
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.traffic_port_selector
	TrafficPortSelector *TrafficPortSelector `json:"trafficPortSelector,omitempty"`

	// Optional. A free-text description of the resource. Max length 1024
	//  characters.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.description
	...
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.server_tls_policy
	...
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.client_tls_policy
	ClientTlsPolicy *string `json:"clientTlsPolicy,omitempty"`
}

// +kcc:proto=google.cloud.networkservices.v1beta1.TrafficPortSelector
type TrafficPortSelector struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.TrafficPortSelector.ports
...
type EndpointPolicyObservedState struct {
	...
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The timestamp when the resource was updated.
	// +kcc:proto:field=google.cloud.networkservices.v1beta1.EndpointPolicy.update_time
