...
go run -mod=readonly golang.org/x/tools/cmd/goimports@v0.29.0 -w pkg/controller/direct/networkservices/
go run -mod=readonly golang.org/x/tools/cmd/goimports@v0.29.0 -w apis/networkservices/v1alpha1/
