...
var NetworkservicesTlsRouteGVK = GroupVersion.WithKind("NetworkservicesTlsRoute")
...
type NetworkservicesTlsRouteSpec struct {
	// The NetworkservicesTlsRoute name. If not given, the metadata.name will be used.
	ResourceID *string `json:"resourceID,omitempty"`
}

// NetworkservicesTlsRouteStatus defines the config connector machine state of NetworkservicesTlsRoute
type NetworkservicesTlsRouteStatus struct {
	...
	// A unique specifier for the NetworkservicesTlsRoute resource in GCP.
	ExternalRef *string `json:"externalRef,omitempty"`

	// ObservedState is the state of the resource as most recently observed in GCP.
	ObservedState *NetworkservicesTlsRouteObservedState `json:"observedState,omitempty"`
}

// NetworkservicesTlsRouteObservedState is the state of the NetworkservicesTlsRoute resource as most recently observed in GCP.
// +kcc:proto=google.cloud.networkservices.v1.TlsRoute
type NetworkservicesTlsRouteObservedState struct {
}
...
// NetworkservicesTlsRoute is the Schema for the NetworkservicesTlsRoute API
