...
rm -f ${REPO_ROOT}/apis/networkservices/v1beta1/grpcroute_types.go
...
go run -mod=readonly golang.org/x/tools/cmd/goimports@${GOLANG_X_TOOLS_VERSION} -w apis/networkservices/v1beta1/
