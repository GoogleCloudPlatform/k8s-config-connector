...
type ServiceConfig struct {
	...
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.name
	Name *string `json:"name,omitempty"`

	// The product title for this service.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.title
	Title *string `json:"title,omitempty"`

	// A list of API interfaces exported by this service. Contains only the names,
	//  versions, and method names of the interfaces.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.apis
	Apis []API `json:"apis,omitempty"`

	// Additional API documentation. Contains only the summary and the
	//  documentation URL.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.documentation
	Documentation *Documentation `json:"documentation,omitempty"`

	// Quota configuration.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.quota
	Quota *Quota `json:"quota,omitempty"`

	// Auth configuration. Contains only the OAuth rules.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.authentication
	Authentication *Authentication `json:"authentication,omitempty"`

	// Configuration controlling usage of this service.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.usage
	Usage *Usage `json:"usage,omitempty"`

	// Configuration for network endpoints. Contains only the names and aliases
	//  of the endpoints.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.endpoints
	Endpoints []Endpoint `json:"endpoints,omitempty"`

	// Defines the monitored resources used by this service. This is required
	//  by the [Service.monitoring][google.api.Service.monitoring] and
	//  [Service.logging][google.api.Service.logging] configurations.
	// +kcc:proto:field=google.api.serviceusage.v1beta1.ServiceConfig.monitored_resources
