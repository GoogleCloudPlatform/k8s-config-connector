...
// +kcc:proto=google.cloud.domains.v1.ContactSettings
type ContactSettings struct {
	// Required. Privacy setting for the contacts associated with the `Registration`.
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.privacy
	...
	//  suspension.*
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.registrant_contact
	RegistrantContact *ContactSettings_Contact `json:"registrantContact,omitempty"`

	// Required. The administrative contact for the `Registration`.
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.admin_contact
	AdminContact *ContactSettings_Contact `json:"adminContact,omitempty"`

	// Required. The technical contact for the `Registration`.
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.technical_contact
	TechnicalContact *ContactSettings_Contact `json:"technicalContact,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.ContactSettings.Contact
type ContactSettings_Contact struct {
	// Required. Postal address of the contact.
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.Contact.postal_address
	PostalAddress *PostalAddress `json:"postalAddress,omitempty"`

	// Required. Email address of the contact.
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.Contact.email
	Email *string `json:"email,omitempty"`

	// Required. Phone number of the contact in international format. For example,
	//  `"+1-800-555-0123"`.
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.Contact.phone_number
	PhoneNumber *string `json:"phoneNumber,omitempty"`

	// Fax number of the contact in international format. For example,
	//  `"+1-800-555-0123"`.
	// +kcc:proto:field=google.cloud.domains.v1.ContactSettings.Contact.fax_number
	FaxNumber *string `json:"faxNumber,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.DnsSettings
type DnsSettings struct {
	// An arbitrary DNS provider identified by its name servers.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.custom_dns
	CustomDns *DnsSettings_CustomDns `json:"customDns,omitempty"`

	// The free DNS zone provided by
	//  [Google Domains](https://domains.google/).
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.google_domains_dns
	GoogleDomainsDns *DnsSettings_GoogleDomainsDns `json:"googleDomainsDns,omitempty"`

	// The list of glue records for this `Registration`. Commonly empty.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.glue_records
	GlueRecords []DnsSettings_GlueRecord `json:"glueRecords,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.DnsSettings.CustomDns
type DnsSettings_CustomDns struct {
	...
	//  Punycode format.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.CustomDns.name_servers
	...
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.CustomDns.ds_records
	DsRecords []DnsSettings_DsRecord `json:"dsRecords,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.DnsSettings.DsRecord
type DnsSettings_DsRecord struct {
	// The key tag of the record. Must be set in range 0 -- 65535.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.DsRecord.key_tag
	KeyTag *int32 `json:"keyTag,omitempty"`

	// The algorithm used to generate the referenced DNSKEY.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.DsRecord.algorithm
	Algorithm *string `json:"algorithm,omitempty"`

	// The hash function used to generate the digest of the referenced DNSKEY.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.DsRecord.digest_type
	DigestType *string `json:"digestType,omitempty"`

	// The digest generated from the referenced DNSKEY.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.DsRecord.digest
	Digest *string `json:"digest,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.DnsSettings.GlueRecord
type DnsSettings_GlueRecord struct {
	// Required. Domain name of the host in Punycode format.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.GlueRecord.host_name
	HostName *string `json:"hostName,omitempty"`

	// List of IPv4 addresses corresponding to this host in the standard decimal
	//  format (e.g. `198.51.100.1`). At least one of `ipv4_address` and
	//  `ipv6_address` must be set.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.GlueRecord.ipv4_addresses
	Ipv4Addresses []string `json:"ipv4Addresses,omitempty"`

	// List of IPv6 addresses corresponding to this host in the standard
	//  hexadecimal format (e.g. `2001:db8::`). At least one of
	//  `ipv4_address` and `ipv6_address` must be set.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.GlueRecord.ipv6_addresses
	Ipv6Addresses []string `json:"ipv6Addresses,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.DnsSettings.GoogleDomainsDns
type DnsSettings_GoogleDomainsDns struct {

	// Required. The state of DS records for this domain. Used to enable or disable
	//  automatic DNSSEC.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.GoogleDomainsDns.ds_state
	DsState *string `json:"dsState,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.ManagementSettings
type ManagementSettings struct {

	// Controls whether the domain can be transferred to another registrar.
	// +kcc:proto:field=google.cloud.domains.v1.ManagementSettings.transfer_lock_state
	TransferLockState *string `json:"transferLockState,omitempty"`
}

// +kcc:proto=google.cloud.domains.v1.Registration
type Registration struct {

	// Required. Immutable. The domain name. Unicode domain names must be expressed in Punycode format.
	// +kcc:proto:field=google.cloud.domains.v1.Registration.domain_name
	DomainName *string `json:"domainName,omitempty"`

	// Set of labels associated with the `Registration`.
	// +kcc:proto:field=google.cloud.domains.v1.Registration.labels
	...
	//  method.
	// +kcc:proto:field=google.cloud.domains.v1.Registration.management_settings
	...
	// +kcc:proto:field=google.cloud.domains.v1.Registration.dns_settings
	...
	// +kcc:proto:field=google.cloud.domains.v1.Registration.contact_settings
...
type DnsSettings_GoogleDomainsDnsObservedState struct {
	...
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.GoogleDomainsDns.name_servers
	NameServers []string `json:"nameServers,omitempty"`

	// Output only. The list of DS records published for this domain. The list is
	//  automatically populated when `ds_state` is `DS_RECORDS_PUBLISHED`,
	//  otherwise it remains empty.
	// +kcc:proto:field=google.cloud.domains.v1.DnsSettings.GoogleDomainsDns.ds_records
	DsRecords []DnsSettings_DsRecord `json:"dsRecords,omitempty"`
}
...
type ManagementSettingsObservedState struct {
	...
	// +kcc:proto:field=google.cloud.domains.v1.ManagementSettings.renewal_method
...
type RegistrationObservedState struct {
	...
	// +kcc:proto:field=google.cloud.domains.v1.Registration.name
	Name *string `json:"name,omitempty"`

	// Output only. The creation timestamp of the `Registration` resource.
	// +kcc:proto:field=google.cloud.domains.v1.Registration.create_time
	CreateTime *string `json:"createTime,omitempty"`

	// Output only. The expiration timestamp of the `Registration`.
	// +kcc:proto:field=google.cloud.domains.v1.Registration.expire_time
	ExpireTime *string `json:"expireTime,omitempty"`

	// Output only. The state of the `Registration`
	// +kcc:proto:field=google.cloud.domains.v1.Registration.state
	State *string `json:"state,omitempty"`

	// Output only. The set of issues with the `Registration` that require attention.
	// +kcc:proto:field=google.cloud.domains.v1.Registration.issues
	...
	//  email they receive.
	// +kcc:proto:field=google.cloud.domains.v1.Registration.pending_contact_settings
	...
	// +kcc:proto:field=google.cloud.domains.v1.Registration.supported_privacy
