...
type APIHubAttributeSpec struct {
	...
	// +kubebuilder:validation:Required
	// +kubebuilder:validation:Enum=SCOPE_UNSPECIFIED;API;VERSION;SPEC;API_OPERATION;DEPLOYMENT;DEPENDENCY;DEFINITION;EXTERNAL_API;PLUGIN
	// +kcc:proto:field=google.cloud.apihub.v1.Attribute.scope
	Scope *string `json:"scope"`

	// Required. The type of the data of the attribute.
	// +kubebuilder:validation:Required
	// +kubebuilder:validation:Enum=DATA_TYPE_UNSPECIFIED;ENUM;JSON;STRING
