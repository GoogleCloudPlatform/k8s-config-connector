...
type APIHubAPIStatus struct {
	...
	// A unique specifier for the APIHubAPI resource in Google Cloud.
...
// APIHubAPIObservedState is the state of the APIHubAPI resource as most recently observed in Google Cloud.
