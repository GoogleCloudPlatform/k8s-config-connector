...
type APIHubRuntimeProjectAttachmentStatus struct {
	...
	// A unique specifier for the APIHubRuntimeProjectAttachment resource in Google Cloud.
...
// APIHubRuntimeProjectAttachmentObservedState is the state of the APIHubRuntimeProjectAttachment resource as most recently observed in Google Cloud.
...
// +kubebuilder:resource:categories=gcp,shortName=gcpapihubruntimeprojectattachment;gcpapihubruntimeprojectattachments
