...
// See https://docs.cloud.google.com/apigee/docs/reference/apis/apihub/rest/v1/projects.locations.curations for reference to the underlying resource schema.
