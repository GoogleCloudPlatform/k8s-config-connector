...
| AutoMLDataset | automl | [#9212](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9212) | [#9168](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9168) | - | 2 | MERGED |
...
| BigLakeCatalog | biglake | [#9454](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9454) | [#9615](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9615) | [#4340](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/4340) | 3 | CLOSED |
| BigQueryAnalyticsHubDataExchange | analyticshub | [#8471](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/8471) | [#9371](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9371) | - | 2 | OPEN |
...
| CESApp | ces | [#9100](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9100) | - | - | 1 | OPEN |
...
| CloudTasksQueue | cloudtasks | [#4023](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/4023) | - | - | 1 | MERGED |
...
| NetworkSecurityAddressGroup | networksecurity | [#8755](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/8755) | [#4719](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/4719) | [#4711](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/4711) | 3 | OPEN |
...
| NetworkSecuritySACRealm | networksecurity | [#9054](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9054) | [#9680](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9680) | - | 2 | MERGED |
...
| VertexAIDataset | vertexai | [#7991](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/7991) | [#9687](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/9687) | [#1282](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/1282) | 3 | MERGED |
...
| VertexAIEndpoint | vertexai | [#7994](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/7994) | - | [#1665](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/1665) | 3 | MERGED |
...
| VertexAIIndex | aiplatform | [#8421](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/8421) | - | [#1525](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/1525) | 3 | CLOSED |
...
| BigLakeLock | biglake | - | - | - | - | PLANNED |
| EventarcGoogleApiSource | eventarc | [#10274](https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/10274) | - | - | 1 | OPEN |
| FilestoreBackup | filestore | - | - | - | - | PLANNED |
| FinancialServicesInstance | financialservices | - | - | - | - | PLANNED |
| GDCHardwareManagementHardware | gdchardwaremanagement | - | - | - | - | PLANNED |
| GeminiDataAnalyticsConversation | geminidataanalytics | - | - | - | - | PLANNED |
| GKEBackupBackupChannel | gkebackup | - | - | - | - | PLANNED |
| GKEHubFleet | gkehub | - | - | - | - | PLANNED |
| GKEMulticloudAttachedCluster | gkemulticloud | - | - | - | - | PLANNED |
| GrafeasNote | grafeas | - | - | - | - | PLANNED |
| GSuiteAddonsDeployment | gsuiteaddons | - | - | - | - | PLANNED |
| HypercomputeClusterCluster | hypercomputecluster | - | - | - | - | PLANNED |
| IamAccessPolicy | iam | - | - | - | - | PLANNED |
| CloudTalentSolutionCompany | cloudtalentsolution | - | - | - | - | PLANNED |
| LicenseManagerConfiguration | licensemanager | - | - | - | - | PLANNED |
| LiveStreamAsset | livestream | - | - | - | - | PLANNED |
| ManagedKafkaConnectCluster | managedkafka | - | - | - | - | PLANNED |
| MapManagementMapConfig | mapmanagement | - | - | - | - | PLANNED |
| MapsPlatformDatasetsDataset | mapsplatformdatasets | - | - | - | - | PLANNED |
| MarketingPlatformAdminAnalyticsAccountLink | marketingplatformadmin | - | - | - | - | PLANNED |
| MigrationCenterGroup | migrationcenter | - | - | - | - | PLANNED |
| NetworkConnectivityMulticloudDataTransferConfig | networkconnectivity | - | - | - | - | PLANNED |
| NetworkManagementVpcFlowLogsConfig | networkmanagement | - | - | - | - | PLANNED |
| NetworkServicesAuthzExtension | networkservices | - | - | - | - | PLANNED |
| OracleDatabaseAutonomousDatabase | oracledatabase | - | - | - | - | PLANNED |
| ParallelstoreInstance | parallelstore | - | - | - | - | PLANNED |
| RapidMigrationAssessmentCollector | rapidmigrationassessment | - | - | - | - | PLANNED |
| SaasServiceMgmtRelease | saasservicemgmt | - | - | - | - | PLANNED |
| SQLAdminBackup | sql | - | - | - | - | PLANNED |
| StorageBatchOperationsJob | storage | - | - | - | - | PLANNED |
| StorageInsightsDatasetConfig | storageinsights | - | - | - | - | PLANNED |
| TelcoAutomationEdgeSlm | telcoautomation | - | - | - | - | PLANNED |
| TestingDeviceSession | testing | - | - | - | - | PLANNED |
| TPUQueuedResource | tpu | - | - | - | - | PLANNED |
| TranscoderJob | transcoder | - | - | - | - | PLANNED |
| TranslateAdaptiveMtDataset | translate | - | - | - | - | PLANNED |
| VectorSearchCollection | vectorsearch | - | - | - | - | PLANNED |
| VideoStitcherCdnKey | videostitcher | - | - | - | - | PLANNED |
| VisionProduct | vision | - | - | - | - | PLANNED |
| VisionAIApplication | visionai | - | - | - | - | PLANNED |
| VMMigrationGroup | vmmigration | - | - | - | - | PLANNED |
| VMwareEnginePrivateConnection | vmwareengine | - | - | - | - | PLANNED |
| WebSecurityScannerScanConfig | websecurityscanner | - | - | - | - | PLANNED |
| WorkloadManagerEvaluation | workloadmanager | - | - | - | - | PLANNED |
