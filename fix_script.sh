...
head -n 172 pkg/controller/direct/networkmanagement/connectivitytest_fuzzer.go > temp.go
cat tail_replacement.txt >> temp.go
mv temp.go pkg/controller/direct/networkmanagement/connectivitytest_fuzzer.go
