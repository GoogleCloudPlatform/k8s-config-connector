...
You can then run the fuzz-test with `dev/ci/presubmits/tests-fuzzers`.  We want the test to pass, but likely it will identify some fields that are not correctly mapped in the fuzz-test.
