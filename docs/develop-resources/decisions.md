...
| Server Generated ID | Use `status.externalRef` for server-generated IDs. For migrated resources, continue writing to `spec.resourceID` for compatibility if status into spec is set to merge. | 2025-12-03 | Accepted | [Link](../ai/server-generated-id.md) |
