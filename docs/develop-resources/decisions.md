...
| Change Cookies | Use `cnrm.cloud.google.com/last-changed-cookie` annotation to store hashes for stateful reconciliation in Direct controllers. | 2026-02-19 | Current | [Link](../design-decisions/change-cookies.md) |
