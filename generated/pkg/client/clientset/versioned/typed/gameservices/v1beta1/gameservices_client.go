...
type GameservicesV1beta1Interface interface {
	RESTClient() rest.Interface
	GameServicesRealmsGetter
}
...
func (c *GameservicesV1beta1Client) GameServicesRealms(namespace string) GameServicesRealmInterface {
	return newGameServicesRealms(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*GameservicesV1beta1Client, error) {
	...
	return &GameservicesV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new GameservicesV1beta1Client for the given config and
...
func New(c rest.Interface) *GameservicesV1beta1Client {
	return &GameservicesV1beta1Client{c}
}
