...
var iamserviceaccountkeysResource = schema.GroupVersionResource{Group: "iam.cnrm.cloud.google.com", Version: "v1beta1", Resource: "iamserviceaccountkeys"}

var iamserviceaccountkeysKind = schema.GroupVersionKind{Group: "iam.cnrm.cloud.google.com", Version: "v1beta1", Kind: "IAMServiceAccountKey"}
...
func (c *FakeIAMServiceAccountKeys) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(iamserviceaccountkeysResource, c.ns, name), &v1beta1.IAMServiceAccountKey{})
