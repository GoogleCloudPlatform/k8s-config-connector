...
var bigquerytablesResource = schema.GroupVersionResource{Group: "bigquery.cnrm.cloud.google.com", Version: "v1beta1", Resource: "bigquerytables"}

var bigquerytablesKind = schema.GroupVersionKind{Group: "bigquery.cnrm.cloud.google.com", Version: "v1beta1", Kind: "BigQueryTable"}
...
func (c *FakeBigQueryTables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.BigQueryTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(bigquerytablesResource, c.ns, name), &v1beta1.BigQueryTable{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.BigQueryTable), err
}
...
func (c *FakeBigQueryTables) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BigQueryTableList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(bigquerytablesResource, bigquerytablesKind, c.ns, opts), &v1beta1.BigQueryTableList{})
	...
	list := &v1beta1.BigQueryTableList{ListMeta: obj.(*v1beta1.BigQueryTableList).ListMeta}
	for _, item := range obj.(*v1beta1.BigQueryTableList).Items {
...
func (c *FakeBigQueryTables) Create(ctx context.Context, bigQueryTable *v1beta1.BigQueryTable, opts v1.CreateOptions) (result *v1beta1.BigQueryTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(bigquerytablesResource, c.ns, bigQueryTable), &v1beta1.BigQueryTable{})
...
func (c *FakeBigQueryTables) Update(ctx context.Context, bigQueryTable *v1beta1.BigQueryTable, opts v1.UpdateOptions) (result *v1beta1.BigQueryTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(bigquerytablesResource, c.ns, bigQueryTable), &v1beta1.BigQueryTable{})
...
func (c *FakeBigQueryTables) UpdateStatus(ctx context.Context, bigQueryTable *v1beta1.BigQueryTable, opts v1.UpdateOptions) (*v1beta1.BigQueryTable, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(bigquerytablesResource, "status", c.ns, bigQueryTable), &v1beta1.BigQueryTable{})
...
func (c *FakeBigQueryTables) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(bigquerytablesResource, c.ns, name), &v1beta1.BigQueryTable{})
...
func (c *FakeBigQueryTables) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.BigQueryTableList{})
	return err
}
...
func (c *FakeBigQueryTables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.BigQueryTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(bigquerytablesResource, c.ns, name, pt, data, subresources...), &v1beta1.BigQueryTable{})
