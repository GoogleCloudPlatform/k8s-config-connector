...
import (
	v1beta1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/apis/serviceusage/v1beta1"
...
func NewForConfig(c *rest.Config) (*ServiceusageV1beta1Client, error) {
	...
	return &ServiceusageV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new ServiceusageV1beta1Client for the given config and
...
func New(c rest.Interface) *ServiceusageV1beta1Client {
	return &ServiceusageV1beta1Client{c}
}
