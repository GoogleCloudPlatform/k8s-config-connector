...
var computetargethttpsproxiesResource = schema.GroupVersionResource{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Resource: "computetargethttpsproxies"}

var computetargethttpsproxiesKind = schema.GroupVersionKind{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Kind: "ComputeTargetHTTPSProxy"}
...
func (c *FakeComputeTargetHTTPSProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(computetargethttpsproxiesResource, c.ns, name), &v1beta1.ComputeTargetHTTPSProxy{})
