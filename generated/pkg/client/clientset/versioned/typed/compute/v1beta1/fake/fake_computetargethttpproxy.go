...
var computetargethttpproxiesResource = schema.GroupVersionResource{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Resource: "computetargethttpproxies"}

var computetargethttpproxiesKind = schema.GroupVersionKind{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Kind: "ComputeTargetHTTPProxy"}
...
func (c *FakeComputeTargetHTTPProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(computetargethttpproxiesResource, c.ns, name), &v1beta1.ComputeTargetHTTPProxy{})
