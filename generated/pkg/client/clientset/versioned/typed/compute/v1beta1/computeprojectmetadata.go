...
func newComputeProjectMetadatas(c *ComputeV1beta1Client, namespace string) *computeProjectMetadatas {
...
func (c *computeProjectMetadatas) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeProjectMetadata, err error) {
	result = &v1beta1.ComputeProjectMetadata{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeProjectMetadatas) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeProjectMetadataList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeProjectMetadataList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeprojectmetadatas").
...
func (c *computeProjectMetadatas) Create(ctx context.Context, computeProjectMetadata *v1beta1.ComputeProjectMetadata, opts v1.CreateOptions) (result *v1beta1.ComputeProjectMetadata, err error) {
	result = &v1beta1.ComputeProjectMetadata{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeprojectmetadatas").
...
func (c *computeProjectMetadatas) Update(ctx context.Context, computeProjectMetadata *v1beta1.ComputeProjectMetadata, opts v1.UpdateOptions) (result *v1beta1.ComputeProjectMetadata, err error) {
	result = &v1beta1.ComputeProjectMetadata{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeprojectmetadatas").
...
func (c *computeProjectMetadatas) UpdateStatus(ctx context.Context, computeProjectMetadata *v1beta1.ComputeProjectMetadata, opts v1.UpdateOptions) (result *v1beta1.ComputeProjectMetadata, err error) {
	result = &v1beta1.ComputeProjectMetadata{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeprojectmetadatas").
...
func (c *computeProjectMetadatas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeProjectMetadata, err error) {
	result = &v1beta1.ComputeProjectMetadata{}
