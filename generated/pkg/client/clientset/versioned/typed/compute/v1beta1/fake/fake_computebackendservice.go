...
var computebackendservicesResource = schema.GroupVersionResource{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Resource: "computebackendservices"}

var computebackendservicesKind = schema.GroupVersionKind{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Kind: "ComputeBackendService"}
...
func (c *FakeComputeBackendServices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(computebackendservicesResource, c.ns, name), &v1beta1.ComputeBackendService{})
