...
type VertexaipersistentresourceDnsPeeringConfigs struct {
...
type VertexaipersistentresourcePscInterfaceConfig struct {
	/* Optional. DNS peering configurations. */
	// +optional
	DnsPeeringConfigs []VertexaipersistentresourceDnsPeeringConfigs `json:"dnsPeeringConfigs,omitempty"`
...
type VertexAIPersistentResourceSpec struct {
	...
	// +optional
	PscInterfaceConfig *VertexaipersistentresourcePscInterfaceConfig `json:"pscInterfaceConfig,omitempty"`
	...
	// +optional
	ResourcePools []VertexaipersistentresourceResourcePools `json:"resourcePools,omitempty"`
...
type VertexaipersistentresourceObservedStateStatus struct {
	...
	// +optional
	ResourcePools []VertexaipersistentresourceResourcePoolsStatus `json:"resourcePools,omitempty"`
...
type VertexaipersistentresourceResourcePoolsStatus struct {
