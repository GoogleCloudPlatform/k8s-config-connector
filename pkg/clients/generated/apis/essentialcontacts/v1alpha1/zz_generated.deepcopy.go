...
func (in *ContactObservedStateStatus) DeepCopyInto(out *ContactObservedStateStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContactObservedStateStatus.
func (in *ContactObservedStateStatus) DeepCopy() *ContactObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(ContactObservedStateStatus)
	in.DeepCopyInto(out)
	return out
}
