...
func (in *HmackeyObservedStateStatus) DeepCopyInto(out *HmackeyObservedStateStatus) {
	*out = *in
	if in.AccessId != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HmackeyObservedStateStatus.
func (in *HmackeyObservedStateStatus) DeepCopy() *HmackeyObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(HmackeyObservedStateStatus)
	in.DeepCopyInto(out)
	return out
}
