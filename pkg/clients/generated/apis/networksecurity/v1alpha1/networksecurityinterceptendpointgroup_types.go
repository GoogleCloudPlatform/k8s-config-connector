...
type InterceptendpointgroupAssociationsStatus struct {
...
type InterceptendpointgroupConnectedDeploymentGroupStatus struct {
	/* Output only. The list of locations where the deployment group is present. */
	// +optional
	Locations []InterceptendpointgroupLocationsStatus `json:"locations,omitempty"`
...
type InterceptendpointgroupLocationsStatus struct {
...
type InterceptendpointgroupObservedStateStatus struct {
	/* Output only. List of associations to this endpoint group. */
	// +optional
	Associations []InterceptendpointgroupAssociationsStatus `json:"associations,omitempty"`

	/* Output only. Details about the connected deployment group to this endpoint group. */
	// +optional
	ConnectedDeploymentGroup *InterceptendpointgroupConnectedDeploymentGroupStatus `json:"connectedDeploymentGroup,omitempty"`
...
// NetworkSecurityInterceptEndpointGroup is the Schema for the networksecurity API
