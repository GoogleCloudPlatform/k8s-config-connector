...
type MirroringdeploymentgroupConnectedEndpointGroupsStatus struct {
	/* Output only. The connected endpoint group's resource name, for example: `projects/123456789/locations/global/mirroringEndpointGroups/my-eg`. */
	// +optional
	Name *string `json:"name,omitempty"`
}

type MirroringdeploymentgroupLocationsStatus struct {
...
type MirroringdeploymentgroupNestedDeploymentsStatus struct {
...
type MirroringdeploymentgroupObservedStateStatus struct {
	/* Output only. The list of endpoint groups that are connected to this resource. */
	// +optional
	ConnectedEndpointGroups []MirroringdeploymentgroupConnectedEndpointGroupsStatus `json:"connectedEndpointGroups,omitempty"`
	...
	// +optional
	Locations []MirroringdeploymentgroupLocationsStatus `json:"locations,omitempty"`

	/* Output only. The list of Mirroring Deployments that belong to this group. */
	// +optional
	NestedDeployments []MirroringdeploymentgroupNestedDeploymentsStatus `json:"nestedDeployments,omitempty"`

	/* Output only. The current state of the resource does not match the user's intended state, and the system is working to reconcile them. This is part of the normal operation (e.g. adding a new deployment to the group) */
	// +optional
...
type NetworkSecurityMirroringDeploymentGroupStatus struct {
	/* Conditions represent the latest available observations of the
	   NetworkSecurityMirroringDeploymentGroup's current state. */
	...
	// +optional
	ObservedState *MirroringdeploymentgroupObservedStateStatus `json:"observedState,omitempty"`
}
...
// NetworkSecurityMirroringDeploymentGroup is the Schema for the networksecurity API
