...
type UrllistObservedStateStatus struct {
	...
	/* Optional. A checksum computed by the server based on the value of other fields, which may be sent on update and delete requests to ensure the client has an up-to-date value before proceeding. */
	// +optional
