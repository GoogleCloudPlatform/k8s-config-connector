...
type NetworkSecurityDNSThreatDetectorSpec struct {
	...
	/* Optional. The list of VPC networks to exclude from DNS threat detection. If empty, all networks in the project are included. */
	// +optional
	ExcludedNetworkRefs []k8sv1alpha1.ResourceRef `json:"excludedNetworkRefs,omitempty"`
...
type DnsthreatdetectorObservedStateStatus struct {
...
type NetworkSecurityDNSThreatDetectorStatus struct {
	/* Conditions represent the latest available observations of the
	   NetworkSecurityDNSThreatDetector's current state. */
	...
	// +optional
	ObservedState *DnsthreatdetectorObservedStateStatus `json:"observedState,omitempty"`
}
...
// NetworkSecurityDNSThreatDetector is the Schema for the networksecurity API
