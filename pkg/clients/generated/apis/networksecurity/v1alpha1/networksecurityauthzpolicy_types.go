...
type AuthzpolicyHeaderSet struct {
	...
	// +optional
	Headers []AuthzpolicyHeaders `json:"headers,omitempty"`
}
...
type AuthzpolicyIamServiceAccount struct {
	/* The input string must have the substring specified here.
	Note: empty contains match is not allowed, please use regex instead.
...
type AuthzpolicyPrincipals struct {
	...
	// +optional
	Principal *AuthzpolicyPrincipal `json:"principal,omitempty"`
...
type AuthzpolicyResources struct {
	...
	// +optional
	IamServiceAccount *AuthzpolicyIamServiceAccount `json:"iamServiceAccount,omitempty"`
