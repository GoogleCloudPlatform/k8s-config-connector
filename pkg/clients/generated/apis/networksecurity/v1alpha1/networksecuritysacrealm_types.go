...
type SacrealmObservedStateStatus struct {
	...
	// +optional
	PairingKey *SacrealmPairingKeyStatus `json:"pairingKey,omitempty"`
...
type SacrealmPairingKeyStatus struct {
...
// NetworkSecuritySACRealm is the Schema for the networksecurity API
