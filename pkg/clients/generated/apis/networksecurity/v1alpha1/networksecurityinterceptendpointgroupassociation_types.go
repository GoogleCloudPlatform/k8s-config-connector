...
type NetworkSecurityInterceptEndpointGroupAssociationSpec struct {
	...
	InterceptEndpointGroupRef v1alpha1.ResourceRef `json:"interceptEndpointGroupRef"`
...
type InterceptendpointgroupassociationLocationsDetailsStatus struct {
...
type InterceptendpointgroupassociationLocationsStatus struct {
	/* Output only. The cloud location, e.g. "us-central1-a" or "asia-south1". */
	// +optional
	Location *string `json:"location,omitempty"`
...
type InterceptendpointgroupassociationObservedStateStatus struct {
	...
	// +optional
	Locations []InterceptendpointgroupassociationLocationsStatus `json:"locations,omitempty"`
	...
	// +optional
	LocationsDetails []InterceptendpointgroupassociationLocationsDetailsStatus `json:"locationsDetails,omitempty"`
...
type NetworkSecurityInterceptEndpointGroupAssociationStatus struct {
	/* Conditions represent the latest available observations of the
	   NetworkSecurityInterceptEndpointGroupAssociation's current state. */
	...
	// +optional
	ObservedState *InterceptendpointgroupassociationObservedStateStatus `json:"observedState,omitempty"`
}
...
// NetworkSecurityInterceptEndpointGroupAssociation is the Schema for the networksecurity API
