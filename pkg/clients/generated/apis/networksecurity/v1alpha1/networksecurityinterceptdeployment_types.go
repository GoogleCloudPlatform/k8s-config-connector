...
type InterceptdeploymentObservedStateStatus struct {
...
type NetworkSecurityInterceptDeploymentStatus struct {
	...
	/* A unique specifier for the NetworkSecurityInterceptDeployment resource in Google Cloud. */
	// +optional
	...
	// +optional
	ObservedState *InterceptdeploymentObservedStateStatus `json:"observedState,omitempty"`
}
...
// NetworkSecurityInterceptDeployment is the Schema for the networksecurity API
