...
type EntityreconciliationjobBigqueryInputConfigs struct {
	...
	BigqueryTableRef v1alpha1.ResourceRef `json:"bigqueryTableRef"`
...
type EntityreconciliationjobInputConfig struct {
	...
	BigqueryInputConfigs []EntityreconciliationjobBigqueryInputConfigs `json:"bigqueryInputConfigs"`
	...
	// +optional
	PreviousResultBigqueryTableRef *v1alpha1.ResourceRef `json:"previousResultBigqueryTableRef,omitempty"`
}
...
type EntityreconciliationjobOutputConfig struct {
	...
	BigqueryDatasetRef v1alpha1.ResourceRef `json:"bigqueryDatasetRef"`
}
