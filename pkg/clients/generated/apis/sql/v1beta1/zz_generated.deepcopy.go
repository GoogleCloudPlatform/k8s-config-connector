...
func (in *SQLUserSpec) DeepCopyInto(out *SQLUserSpec) {
	*out = *in
	...
	if in.SqlServerUserDetails != nil {
		...
		*out = new(UserSqlServerUserDetails)
		(*in).DeepCopyInto(*out)
	}
	if in.Type != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserSqlServerUserDetails) DeepCopyInto(out *UserSqlServerUserDetails) {
	*out = *in
	if in.Disabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserSqlServerUserDetails.
func (in *UserSqlServerUserDetails) DeepCopy() *UserSqlServerUserDetails {
	if in == nil {
		return nil
	}
	out := new(UserSqlServerUserDetails)
