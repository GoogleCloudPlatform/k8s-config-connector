...
type CcinsightsqascorecardObservedStateStatus struct {
...
type CCInsightsQaScorecardStatus struct {
	/* Conditions represent the latest available observations of the
	   CCInsightsQaScorecard's current state. */
	...
	// +optional
	ObservedState *CcinsightsqascorecardObservedStateStatus `json:"observedState,omitempty"`
}
...
// CCInsightsQaScorecard is the Schema for the contactcenterinsights API
