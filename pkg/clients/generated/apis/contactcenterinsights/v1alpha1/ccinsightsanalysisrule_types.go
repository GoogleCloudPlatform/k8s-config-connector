...
type CCInsightsAnalysisRuleSpec struct {
	...
	/* Percentage of conversations that we should apply this analysis setting automatically, between [0, 1]. For example, 0.1 means 10%. Conversations are sampled in a deterministic way. */
	// +optional
