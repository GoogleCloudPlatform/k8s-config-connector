...
type CloudSupportSupportEventSubscriptionSpec struct {
	...
	PubSubTopicRef v1alpha1.ResourceRef `json:"pubSubTopicRef"`
...
type SupporteventsubscriptionObservedStateStatus struct {
...
type CloudSupportSupportEventSubscriptionStatus struct {
	/* Conditions represent the latest available observations of the
	   CloudSupportSupportEventSubscription's current state. */
	...
	// +optional
	ObservedState *SupporteventsubscriptionObservedStateStatus `json:"observedState,omitempty"`
}
...
// CloudSupportSupportEventSubscription is the Schema for the cloudsupport API
