...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AgentpoolObservedStateStatus) DeepCopyInto(out *AgentpoolObservedStateStatus) {
	*out = *in
	if in.State != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AgentpoolObservedStateStatus.
func (in *AgentpoolObservedStateStatus) DeepCopy() *AgentpoolObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(AgentpoolObservedStateStatus)
	in.DeepCopyInto(out)
	return out
}
