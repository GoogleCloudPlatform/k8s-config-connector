...
type LinkObservedStateStatus struct {
	/* this field is just a string, but its an object(string) https://github.com/googleapis/googleapis/blob/master/google/logging/v2/logging_config.proto#L1063 */
	// +optional
	...
	/* the lifecycle state might be something more complicated this is an ENUM, should be safe to use a string */
	// +optional
