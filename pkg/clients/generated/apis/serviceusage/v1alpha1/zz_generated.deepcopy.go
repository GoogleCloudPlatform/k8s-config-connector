...
func (in *ConsumerquotaoverrideObservedStateStatus) DeepCopyInto(out *ConsumerquotaoverrideObservedStateStatus) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConsumerquotaoverrideObservedStateStatus.
func (in *ConsumerquotaoverrideObservedStateStatus) DeepCopy() *ConsumerquotaoverrideObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(ConsumerquotaoverrideObservedStateStatus)
	in.DeepCopyInto(out)
	return out
}
