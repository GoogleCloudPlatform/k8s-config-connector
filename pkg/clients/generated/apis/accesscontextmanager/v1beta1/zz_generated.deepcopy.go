...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceperimeterAccessLevels) DeepCopyInto(out *ServiceperimeterAccessLevels) {
	*out = *in
	if in.External != nil {
		in, out := &in.External, &out.External
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceperimeterAccessLevels.
func (in *ServiceperimeterAccessLevels) DeepCopy() *ServiceperimeterAccessLevels {
	if in == nil {
		return nil
	}
	out := new(ServiceperimeterAccessLevels)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceperimeterSpec) DeepCopyInto(out *ServiceperimeterSpec) {
	*out = *in
	if in.AccessLevels != nil {
		...
		*out = make([]ServiceperimeterAccessLevels, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
