...
type APIHubExternalAPISpec struct {
	...
	// +optional
	AttributeRefs []ExternalapiAttributeRefs `json:"attributeRefs,omitempty"`
	...
	// +optional
	Documentation *ExternalapiDocumentation `json:"documentation,omitempty"`
...
type ExternalapiObservedStateStatus struct {
...
// APIHubExternalAPI is the Schema for the apihub API
