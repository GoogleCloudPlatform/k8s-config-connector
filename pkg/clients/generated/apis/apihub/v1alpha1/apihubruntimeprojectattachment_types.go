...
type APIHubRuntimeProjectAttachmentSpec struct {
	...
	RuntimeProjectRef v1alpha1.ResourceRef `json:"runtimeProjectRef"`
}

type RuntimeprojectattachmentObservedStateStatus struct {
...
type APIHubRuntimeProjectAttachmentStatus struct {
	/* Conditions represent the latest available observations of the
	   APIHubRuntimeProjectAttachment's current state. */
	...
	// +optional
	ObservedState *RuntimeprojectattachmentObservedStateStatus `json:"observedState,omitempty"`
}
...
// APIHubRuntimeProjectAttachment is the Schema for the apihub API
