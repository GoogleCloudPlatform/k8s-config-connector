...
type DependencyAttributes struct {
	...
	// +optional
	EnumValues *DependencyEnumValues `json:"enumValues,omitempty"`

	/* The attribute values associated with a resource in case attribute data type is JSON. */
	// +optional
	JsonValues *DependencyJsonValues `json:"jsonValues,omitempty"`
...
type APIHubDependencySpec struct {
	...
	// +optional
	Attributes map[string]DependencyAttributes `json:"attributes,omitempty"`
...
type DependencyObservedStateStatus struct {
	...
	// +optional
	Supplier *DependencySupplierStatus `json:"supplier,omitempty"`
...
type DependencySupplierStatus struct {
	/* Output only. Display name of the entity. */
	// +optional
	DisplayName *string `json:"displayName,omitempty"`
}
