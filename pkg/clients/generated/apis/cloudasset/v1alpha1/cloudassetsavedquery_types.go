...
type SavedqueryFullResourceName struct {
...
type SavedqueryResourceSelector struct {
	...
	FullResourceName SavedqueryFullResourceName `json:"fullResourceName"`
}
...
type CloudAssetSavedQuerySpec struct {
	/* The query content. */
	Content SavedqueryContent `json:"content"`
...
type CloudAssetSavedQueryStatus struct {
	/* Conditions represent the latest available observations of the
	   CloudAssetSavedQuery's current state. */
...
// CloudAssetSavedQuery is the Schema for the cloudasset API
