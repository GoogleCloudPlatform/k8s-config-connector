...
type DeviceBrowserProfiles struct {
	...
	// +optional
	ChromeBrowserInfo *DeviceChromeBrowserInfo `json:"chromeBrowserInfo,omitempty"`
...
type CloudIdentityDeviceSpec struct {
	...
	// +optional
	BrowserProfiles []DeviceBrowserProfiles `json:"browserProfiles,omitempty"`
...
type DeviceConflictsStatus struct {
	/* Output only. The scope at which this lower-priority policy is set (USER or MACHINE). */
	// +optional
	Scope *string `json:"scope,omitempty"`
...
type DevicePoliciesStatus struct {
	/* Output only. A list of other policy values for the same policy name that were not applied due to lower precedence. This field is empty if there were no conflicts. */
	// +optional
	Conflicts []DeviceConflictsStatus `json:"conflicts,omitempty"`
