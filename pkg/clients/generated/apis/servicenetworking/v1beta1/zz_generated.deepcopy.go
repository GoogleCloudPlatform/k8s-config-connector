...
func (in *ConnectionReservedPeeringRanges) DeepCopyInto(out *ConnectionReservedPeeringRanges) {
	*out = *in
	if in.External != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConnectionReservedPeeringRanges.
func (in *ConnectionReservedPeeringRanges) DeepCopy() *ConnectionReservedPeeringRanges {
	if in == nil {
		return nil
	}
	out := new(ConnectionReservedPeeringRanges)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServiceNetworkingConnectionSpec) DeepCopyInto(out *ServiceNetworkingConnectionSpec) {
	*out = *in
	...
	if in.ReservedPeeringRanges != nil {
		...
		*out = make([]ConnectionReservedPeeringRanges, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
