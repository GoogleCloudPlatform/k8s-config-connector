...
type LockObservedStateStatus struct {
...
type BigLakeLockStatus struct {
	...
	// +optional
	ObservedState *LockObservedStateStatus `json:"observedState,omitempty"`
}
...
// BigLakeLock is the Schema for the biglake API
