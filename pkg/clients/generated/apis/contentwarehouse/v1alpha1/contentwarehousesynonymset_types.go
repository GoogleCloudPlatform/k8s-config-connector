...
type SynonymsetSynonyms struct {
...
type ContentWarehouseSynonymSetSpec struct {
	...
	// +optional
	Synonyms []SynonymsetSynonyms `json:"synonyms,omitempty"`
}

type SynonymsetObservedStateStatus struct {
}

type ContentWarehouseSynonymSetStatus struct {
	/* Conditions represent the latest available observations of the
	   ContentWarehouseSynonymSet's current state. */
	...
	// +optional
	ObservedState *SynonymsetObservedStateStatus `json:"observedState,omitempty"`
}
...
// ContentWarehouseSynonymSet is the Schema for the contentwarehouse API
