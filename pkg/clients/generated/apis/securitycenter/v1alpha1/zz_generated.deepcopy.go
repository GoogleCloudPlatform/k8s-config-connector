...
func (in *NotificationconfigObservedStateStatus) DeepCopyInto(out *NotificationconfigObservedStateStatus) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NotificationconfigObservedStateStatus.
func (in *NotificationconfigObservedStateStatus) DeepCopy() *NotificationconfigObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(NotificationconfigObservedStateStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecurityCenterSourceStatus) DeepCopyInto(out *SecurityCenterSourceStatus) {
	*out = *in
	...
	if in.ObservedState != nil {
		in, out := &in.ObservedState, &out.ObservedState
		*out = new(SourceObservedStateStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SourceObservedStateStatus) DeepCopyInto(out *SourceObservedStateStatus) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SourceObservedStateStatus.
func (in *SourceObservedStateStatus) DeepCopy() *SourceObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(SourceObservedStateStatus)
