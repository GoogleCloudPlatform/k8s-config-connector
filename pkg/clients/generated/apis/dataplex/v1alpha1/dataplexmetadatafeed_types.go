...
type DataplexMetadataFeedSpec struct {
	...
	Scope MetadatafeedScope `json:"scope"`
}
...
type MetadatafeedObservedStateStatus struct {
	...
	/* Output only. System generated globally unique ID for the feed. This ID will be different if the feed is deleted and re-created with the same name. */
	// +optional
