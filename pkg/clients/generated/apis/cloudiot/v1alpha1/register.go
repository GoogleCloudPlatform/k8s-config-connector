...
// Package v1alpha1 contains API Schema definitions for the cloudiot v1alpha1 API group.
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/pkg/apis/cloudiot
// +k8s:defaulter-gen=TypeMeta
// +groupName=cloudiot.cnrm.cloud.google.com
package v1alpha1
