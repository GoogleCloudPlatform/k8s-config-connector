...
func (in *GuestpolicyAssignment) DeepCopyInto(out *GuestpolicyAssignment) {
	*out = *in
	...
	if in.Instances != nil {
		...
		*out = make([]GuestpolicyInstances, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GuestpolicyInstances) DeepCopyInto(out *GuestpolicyInstances) {
	*out = *in
	if in.External != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GuestpolicyInstances.
func (in *GuestpolicyInstances) DeepCopy() *GuestpolicyInstances {
	if in == nil {
		return nil
	}
	out := new(GuestpolicyInstances)
	in.DeepCopyInto(out)
	return out
}
