...
type EventthreatdetectioncustommoduleObservedStateStatus struct {
...
type SecurityCenterManagementEventThreatDetectionCustomModuleStatus struct {
	/* Conditions represent the latest available observations of the
	   SecurityCenterManagementEventThreatDetectionCustomModule's current state. */
	...
	// +optional
	ObservedState *EventthreatdetectioncustommoduleObservedStateStatus `json:"observedState,omitempty"`
}
...
// SecurityCenterManagementEventThreatDetectionCustomModule is the Schema for the securitycentermanagement API
