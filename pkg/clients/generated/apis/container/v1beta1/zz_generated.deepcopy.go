...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterTpuConfig) DeepCopyInto(out *ClusterTpuConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterTpuConfig.
func (in *ClusterTpuConfig) DeepCopy() *ClusterTpuConfig {
	if in == nil {
		return nil
	}
	out := new(ClusterTpuConfig)
	in.DeepCopyInto(out)
	return out
}
