...
// Package v1alpha1 contains API Schema definitions for the discoveryengine v1alpha1 API group.
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/pkg/apis/discoveryengine
...
var (
	...
	DiscoveryEngineControlGVK = schema.GroupVersionKind{
		Group:   SchemeGroupVersion.Group,
		Version: SchemeGroupVersion.Version,
		Kind:    reflect.TypeOf(DiscoveryEngineControl{}).Name(),
	}

	DiscoveryEngineConversationGVK = schema.GroupVersionKind{
		Group:   SchemeGroupVersion.Group,
		Version: SchemeGroupVersion.Version,
		Kind:    reflect.TypeOf(DiscoveryEngineConversation{}).Name(),
	}
