...
type SessionCodeExecutionResultStatus struct {
...
type SessionContentStatus struct {
	/* Result of executing an ExecutableCode. */
	// +optional
	CodeExecutionResult *SessionCodeExecutionResultStatus `json:"codeExecutionResult,omitempty"`

	/* Code generated by the model that is meant to be executed. */
	// +optional
	ExecutableCode *SessionExecutableCodeStatus `json:"executableCode,omitempty"`

	/* A file, e.g., an audio summary. */
	// +optional
	File *SessionFileStatus `json:"file,omitempty"`

	/* Inline binary data. */
	// +optional
	InlineData *SessionInlineDataStatus `json:"inlineData,omitempty"`
...
type SessionDetailedAssistAnswerStatus struct {
	...
	// +optional
	Replies []SessionRepliesStatus `json:"replies,omitempty"`
...
type SessionExecutableCodeStatus struct {
	/* Required. The code content. Currently only supports Python. */
	// +optional
	Code *string `json:"code,omitempty"`
}

type SessionFileStatus struct {
...
type SessionGroundedContentStatus struct {
	/* The content. */
	// +optional
	Content *SessionContentStatus `json:"content,omitempty"`

	/* Metadata for grounding based on text sources. */
	// +optional
	TextGroundingMetadata *SessionTextGroundingMetadataStatus `json:"textGroundingMetadata,omitempty"`
}
...
type SessionInlineDataStatus struct {
	/* Required. Raw bytes. */
	// +optional
...
type SessionReferencesStatus struct {
	...
	/* Document metadata. */
	// +optional
	DocumentMetadata *SessionDocumentMetadataStatus `json:"documentMetadata,omitempty"`
}

type SessionRepliesStatus struct {
	/* Possibly grounded response text or media from the assistant. */
	// +optional
	GroundedContent *SessionGroundedContentStatus `json:"groundedContent,omitempty"`
}
...
type SessionSegmentsStatus struct {
...
type SessionTextGroundingMetadataStatus struct {
	...
	// +optional
	Segments []SessionSegmentsStatus `json:"segments,omitempty"`
}
...
type SessionTurnsStatus struct {
	...
	/* Output only. In [ConversationalSearchService.GetSession][google.cloud.discoveryengine.v1.ConversationalSearchService.GetSession] API, if [GetSessionRequest.include_answer_details][google.cloud.discoveryengine.v1.GetSessionRequest.include_answer_details] is set to true, this field will be populated when getting assistant session. */
	// +optional
	DetailedAssistAnswer *SessionDetailedAssistAnswerStatus `json:"detailedAssistAnswer,omitempty"`
