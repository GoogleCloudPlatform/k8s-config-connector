...
type JobPubsubDestination struct {
	/* Optional. The Pub/Sub topic to publish job completion notification to. For example: `projects/{project}/topics/{topic}`. */
	// +optional
...
type JobSecretManagerKeySource struct {
	/* Required. The Secret Version containing the encryption key in the following format: `projects/{project}/secrets/{secret_id}/versions/{version_number}` Note that only numbered versions are supported. Aliases like "latest" are not supported. */
	// +optional
	SecretVersionRef *v1alpha1.ResourceRef `json:"secretVersionRef,omitempty"`
}
