...
// Package v1alpha1 contains API Schema definitions for the bigtable v1alpha1 API group.
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "bigtable.cnrm.cloud.google.com", Version: "v1alpha1"}
