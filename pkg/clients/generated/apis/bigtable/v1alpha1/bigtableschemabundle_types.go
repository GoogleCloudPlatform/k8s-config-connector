...
type SchemabundleProtoSchema struct {
	/* Optional. The protobuf schema descriptor. The schema descriptor must be a file descriptor set, which can be generated using `protoc --descriptor_set_out=myschema.fd myschema.proto`. The file descriptor set must be base64 encoded. */
...
type BigtableSchemaBundleSpec struct {
	...
	ProtoSchema SchemabundleProtoSchema `json:"protoSchema"`
...
type SchemabundleObservedStateStatus struct {
...
type BigtableSchemaBundleStatus struct {
	/* Conditions represent the latest available observations of the
	   BigtableSchemaBundle's current state. */
	...
	// +optional
	ObservedState *SchemabundleObservedStateStatus `json:"observedState,omitempty"`
}
...
// BigtableSchemaBundle is the Schema for the bigtable API
