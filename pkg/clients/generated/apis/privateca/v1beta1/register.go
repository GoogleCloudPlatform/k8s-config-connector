...
// Package v1beta1 contains API Schema definitions for the privateca v1beta1 API group.
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/pkg/apis/privateca
...
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(SchemeGroupVersion,
		...
		&PrivateCACertificateList{},
		&PrivateCACertificateAuthority{},
		&PrivateCACertificateAuthorityList{},
		&PrivateCACertificateTemplate{},
		&PrivateCACertificateTemplateList{},
	)
