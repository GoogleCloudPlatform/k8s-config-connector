...
type FeaturestoreentitytypefeatureObservedStateStatus struct {
...
type VertexAIFeaturestoreEntityTypeFeatureStatus struct {
	...
	// +optional
	ObservedState *FeaturestoreentitytypefeatureObservedStateStatus `json:"observedState,omitempty"`
}
