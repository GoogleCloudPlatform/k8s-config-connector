...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterGcsSource) DeepCopyInto(out *ClusterGcsSource) {
	*out = *in
	if in.Uris != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterGcsSource.
func (in *ClusterGcsSource) DeepCopy() *ClusterGcsSource {
	if in == nil {
		return nil
	}
	out := new(ClusterGcsSource)
	in.DeepCopyInto(out)
	return out
}
