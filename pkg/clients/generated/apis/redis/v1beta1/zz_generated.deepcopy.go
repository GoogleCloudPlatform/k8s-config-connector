...
func (in *ClusterConnectionsStatus) DeepCopyInto(out *ClusterConnectionsStatus) {
	*out = *in
	...
	if in.PscConnection != nil {
		...
		*out = new(ClusterPscConnectionStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterPscConnectionStatus) DeepCopyInto(out *ClusterPscConnectionStatus) {
	*out = *in
	if in.Address != nil {
		in, out := &in.Address, &out.Address
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterPscConnectionStatus.
func (in *ClusterPscConnectionStatus) DeepCopy() *ClusterPscConnectionStatus {
	if in == nil {
		return nil
	}
	out := new(ClusterPscConnectionStatus)
