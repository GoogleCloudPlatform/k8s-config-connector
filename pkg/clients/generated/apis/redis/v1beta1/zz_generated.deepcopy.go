...
func (in *InstanceObservedStateStatus) DeepCopyInto(out *InstanceObservedStateStatus) {
	*out = *in
	...
	if in.PersistenceConfig != nil {
		...
		*out = new(InstancePersistenceConfigStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstancePersistenceConfigStatus) DeepCopyInto(out *InstancePersistenceConfigStatus) {
	*out = *in
	if in.RdbNextSnapshotTime != nil {
		in, out := &in.RdbNextSnapshotTime, &out.RdbNextSnapshotTime
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstancePersistenceConfigStatus.
func (in *InstancePersistenceConfigStatus) DeepCopy() *InstancePersistenceConfigStatus {
	if in == nil {
		return nil
	}
	out := new(InstancePersistenceConfigStatus)
