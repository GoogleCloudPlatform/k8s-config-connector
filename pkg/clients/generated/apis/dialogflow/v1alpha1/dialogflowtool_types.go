...
type ToolApiKeyConfig struct {
	...
	// +optional
	SecretVersionForAPIKeyRef *v1alpha1.ResourceRef `json:"secretVersionForAPIKeyRef,omitempty"`
}
...
type ToolBearerTokenConfig struct {
	...
	// +optional
	SecretVersionForTokenRef *v1alpha1.ResourceRef `json:"secretVersionForTokenRef,omitempty"`
...
type ToolOauthConfig struct {
	...
	// +optional
	SecretVersionForClientSecretRef *v1alpha1.ResourceRef `json:"secretVersionForClientSecretRef,omitempty"`
...
type ToolServiceDirectoryConfig struct {
	/* Required. The name of [Service Directory](https://cloud.google.com/service-directory) service. Format: `projects/<ProjectID>/locations/<LocationID>/namespaces/<NamespaceID>/services/<ServiceID>`. `LocationID` of the service directory must be the same as the location of the tool. */
	// +optional
