...
type KnowledgebaseObservedStateStatus struct {
...
type DialogflowKnowledgeBaseStatus struct {
	/* Conditions represent the latest available observations of the
	   DialogflowKnowledgeBase's current state. */
	...
	// +optional
	ObservedState *KnowledgebaseObservedStateStatus `json:"observedState,omitempty"`
}
...
// DialogflowKnowledgeBase is the Schema for the dialogflow API
