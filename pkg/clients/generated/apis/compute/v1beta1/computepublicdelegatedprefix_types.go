...
type ComputePublicDelegatedPrefixSpec struct {
	/* AllocatablePrefixes: The list of sub-prefixes that are delegated IPv4 sub-prefixes. The length of the delegated sub-prefixes must be /64. */
	// +optional
	...
	// +optional
	ParentPrefixRef *v1alpha1.ResourceRef `json:"parentPrefixRef,omitempty"`
...
type PublicdelegatedprefixObservedStateStatus struct {
}

type ComputePublicDelegatedPrefixStatus struct {
	/* Conditions represent the latest available observations of the
	   ComputePublicDelegatedPrefix's current state. */
	...
	// +optional
	ObservedState *PublicdelegatedprefixObservedStateStatus `json:"observedState,omitempty"`
}
...
// ComputePublicDelegatedPrefix is the Schema for the compute API
