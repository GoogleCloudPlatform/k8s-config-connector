...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DicomstoreObservedStateStatus) DeepCopyInto(out *DicomstoreObservedStateStatus) {
	*out = *in
	if in.SelfLink != nil {
		in, out := &in.SelfLink, &out.SelfLink
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DicomstoreObservedStateStatus.
func (in *DicomstoreObservedStateStatus) DeepCopy() *DicomstoreObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(DicomstoreObservedStateStatus)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FhirstoreObservedStateStatus) DeepCopyInto(out *FhirstoreObservedStateStatus) {
	*out = *in
	if in.SelfLink != nil {
		in, out := &in.SelfLink, &out.SelfLink
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FhirstoreObservedStateStatus.
func (in *FhirstoreObservedStateStatus) DeepCopy() *FhirstoreObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(FhirstoreObservedStateStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HealthcareHL7V2StoreStatus) DeepCopyInto(out *HealthcareHL7V2StoreStatus) {
	*out = *in
	...
	if in.ObservedState != nil {
		in, out := &in.ObservedState, &out.ObservedState
		*out = new(Hl7v2storeObservedStateStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Hl7v2storeObservedStateStatus) DeepCopyInto(out *Hl7v2storeObservedStateStatus) {
	*out = *in
	if in.SelfLink != nil {
		in, out := &in.SelfLink, &out.SelfLink
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Hl7v2storeObservedStateStatus.
func (in *Hl7v2storeObservedStateStatus) DeepCopy() *Hl7v2storeObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(Hl7v2storeObservedStateStatus)
