...
func (in *WorkstationclusterConditionsStatus) DeepCopyInto(out *WorkstationclusterConditionsStatus) {
	*out = *in
	if in.Code != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkstationclusterConditionsStatus.
func (in *WorkstationclusterConditionsStatus) DeepCopy() *WorkstationclusterConditionsStatus {
	if in == nil {
		return nil
	}
	out := new(WorkstationclusterConditionsStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkstationclusterObservedStateStatus) DeepCopyInto(out *WorkstationclusterObservedStateStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]WorkstationclusterConditionsStatus, len(*in))
		for i := range *in {
