...
type LbedgeextensionExtensionChains struct {
	...
	Extensions []LbedgeextensionExtensions `json:"extensions"`

	/* Required. Conditions under which this chain is invoked for a request. */
	MatchCondition LbedgeextensionMatchCondition `json:"matchCondition"`

	/* Required. The name for this extension chain. The name is logged as part of the HTTP request logs. The name must conform with RFC-1034, is restricted to lower-cased letters, numbers and hyphens, and can have a maximum length of 63 characters. Additionally, the first character must be a letter and the last a letter or a number. */
	Name string `json:"name"`
}

type LbedgeextensionExtensions struct {
...
type LbedgeextensionMatchCondition struct {
...
type NetworkServicesLBEdgeExtensionSpec struct {
	...
	ExtensionChains []LbedgeextensionExtensionChains `json:"extensionChains"`
...
type LbedgeextensionObservedStateStatus struct {
...
type NetworkServicesLBEdgeExtensionStatus struct {
	/* Conditions represent the latest available observations of the
	   NetworkServicesLBEdgeExtension's current state. */
	...
	// +optional
	ObservedState *LbedgeextensionObservedStateStatus `json:"observedState,omitempty"`
}
...
// NetworkServicesLBEdgeExtension is the Schema for the networkservices API
