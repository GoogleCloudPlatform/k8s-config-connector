...
type LbrouteextensionExtensionChains struct {
	...
	Extensions []LbrouteextensionExtensions `json:"extensions"`

	/* Required. Conditions under which this chain is invoked for a request. */
	MatchCondition LbrouteextensionMatchCondition `json:"matchCondition"`

	/* Required. The name for this extension chain. The name is logged as part of the HTTP request logs. The name must conform with RFC-1034, is restricted to lower-cased letters, numbers and hyphens, and can have a maximum length of 63 characters. Additionally, the first character must be a letter and the last a letter or a number. */
	Name string `json:"name"`
}

type LbrouteextensionExtensions struct {
...
type LbrouteextensionObservedStateStatus struct {
...
type NetworkServicesLBRouteExtensionStatus struct {
	...
	// +optional
	ObservedState *LbrouteextensionObservedStateStatus `json:"observedState,omitempty"`
}
...
// NetworkServicesLBRouteExtension is the Schema for the networkservices API
