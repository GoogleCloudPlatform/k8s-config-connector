...
func (in *ContainerAnalysisNoteSpec) DeepCopyInto(out *ContainerAnalysisNoteSpec) {
	*out = *in
	...
	if in.RelatedNoteNames != nil {
		...
		*out = make([]NoteRelatedNoteNames, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NoteRelatedNoteNames) DeepCopyInto(out *NoteRelatedNoteNames) {
	*out = *in
	if in.External != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NoteRelatedNoteNames.
func (in *NoteRelatedNoteNames) DeepCopy() *NoteRelatedNoteNames {
	if in == nil {
		return nil
	}
	out := new(NoteRelatedNoteNames)
	in.DeepCopyInto(out)
	return out
}
