...
type BindingAuthProviderBinding struct {
	...
	AuthProviderRef v1alpha1.ResourceRef `json:"authProviderRef"`
...
type AgentRegistryBindingSpec struct {
	...
	// +optional
	AuthProviderBinding *BindingAuthProviderBinding `json:"authProviderBinding,omitempty"`
...
type BindingObservedStateStatus struct {
...
type AgentRegistryBindingStatus struct {
	/* Conditions represent the latest available observations of the
	   AgentRegistryBinding's current state. */
	...
	// +optional
	ObservedState *BindingObservedStateStatus `json:"observedState,omitempty"`
}
...
// AgentRegistryBinding is the Schema for the agentregistry API
