...
type ArtifactRegistryVPCSCConfigSpec struct {
	...
	/* The VPC SC policy for project and location. Possible values: "VPCSC_POLICY_UNSPECIFIED" - the VPS SC policy is not defined. "DENY" - repository will block the requests to the Upstreams for the Remote Repositories if the resource is in the perimeter. "ALLOW" - repository will allow the requests to the Upstreams for the Remote Repositories if the resource is in the perimeter. */
	// +optional
	VpcscPolicy *string `json:"vpcscPolicy,omitempty"`
}

type VpcscconfigObservedStateStatus struct {
}

type ArtifactRegistryVPCSCConfigStatus struct {
	/* Conditions represent the latest available observations of the
	   ArtifactRegistryVPCSCConfig's current state. */
	...
	// +optional
	ObservedState *VpcscconfigObservedStateStatus `json:"observedState,omitempty"`
}
...
// ArtifactRegistryVPCSCConfig is the Schema for the artifactregistry API
