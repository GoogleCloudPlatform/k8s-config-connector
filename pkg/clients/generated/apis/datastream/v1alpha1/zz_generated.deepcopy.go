...
func (in *DatastreamStreamStatus) DeepCopyInto(out *DatastreamStreamStatus) {
	*out = *in
	...
	if in.ObservedState != nil {
		in, out := &in.ObservedState, &out.ObservedState
		*out = new(StreamObservedStateStatus)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StreamObservedStateStatus) DeepCopyInto(out *StreamObservedStateStatus) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StreamObservedStateStatus.
func (in *StreamObservedStateStatus) DeepCopy() *StreamObservedStateStatus {
	if in == nil {
		return nil
	}
	out := new(StreamObservedStateStatus)
