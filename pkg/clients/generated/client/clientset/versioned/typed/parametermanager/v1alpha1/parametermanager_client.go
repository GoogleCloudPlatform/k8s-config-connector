...
type ParametermanagerV1alpha1Client struct {
	restClient rest.Interface
}
...
// NewForConfigAndClient creates a new ParametermanagerV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ParametermanagerV1alpha1Client, error) {
	...
	return &ParametermanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ParametermanagerV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ParametermanagerV1alpha1Client {
...
// New creates a new ParametermanagerV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *ParametermanagerV1alpha1Client {
...
func (c *ParametermanagerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
