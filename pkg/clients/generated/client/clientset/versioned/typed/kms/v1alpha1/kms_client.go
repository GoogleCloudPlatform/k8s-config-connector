...
func (c *KmsV1alpha1Client) KMSKeyHandles(namespace string) KMSKeyHandleInterface {
...
// NewForConfigAndClient creates a new KmsV1alpha1Client for the given config and http client.
