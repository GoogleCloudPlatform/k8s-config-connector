...
var apigatewayapisResource = schema.GroupVersionResource{Group: "apigateway.cnrm.cloud.google.com", Version: "v1alpha1", Resource: "apigatewayapis"}

var apigatewayapisKind = schema.GroupVersionKind{Group: "apigateway.cnrm.cloud.google.com", Version: "v1alpha1", Kind: "APIGatewayAPI"}
...
func (c *FakeAPIGatewayAPIs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.APIGatewayAPI, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(apigatewayapisResource, c.ns, name), &v1alpha1.APIGatewayAPI{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.APIGatewayAPI), err
}
...
func (c *FakeAPIGatewayAPIs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.APIGatewayAPIList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(apigatewayapisResource, apigatewayapisKind, c.ns, opts), &v1alpha1.APIGatewayAPIList{})
	...
	list := &v1alpha1.APIGatewayAPIList{ListMeta: obj.(*v1alpha1.APIGatewayAPIList).ListMeta}
	for _, item := range obj.(*v1alpha1.APIGatewayAPIList).Items {
...
func (c *FakeAPIGatewayAPIs) Create(ctx context.Context, aPIGatewayAPI *v1alpha1.APIGatewayAPI, opts v1.CreateOptions) (result *v1alpha1.APIGatewayAPI, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(apigatewayapisResource, c.ns, aPIGatewayAPI), &v1alpha1.APIGatewayAPI{})
...
func (c *FakeAPIGatewayAPIs) Update(ctx context.Context, aPIGatewayAPI *v1alpha1.APIGatewayAPI, opts v1.UpdateOptions) (result *v1alpha1.APIGatewayAPI, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(apigatewayapisResource, c.ns, aPIGatewayAPI), &v1alpha1.APIGatewayAPI{})
...
func (c *FakeAPIGatewayAPIs) UpdateStatus(ctx context.Context, aPIGatewayAPI *v1alpha1.APIGatewayAPI, opts v1.UpdateOptions) (*v1alpha1.APIGatewayAPI, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(apigatewayapisResource, "status", c.ns, aPIGatewayAPI), &v1alpha1.APIGatewayAPI{})
...
func (c *FakeAPIGatewayAPIs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(apigatewayapisResource, c.ns, name, opts), &v1alpha1.APIGatewayAPI{})
...
func (c *FakeAPIGatewayAPIs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.APIGatewayAPIList{})
	return err
}
...
func (c *FakeAPIGatewayAPIs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.APIGatewayAPI, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(apigatewayapisResource, c.ns, name, pt, data, subresources...), &v1alpha1.APIGatewayAPI{})
