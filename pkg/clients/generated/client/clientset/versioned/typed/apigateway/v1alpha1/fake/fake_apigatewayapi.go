...
var apigatewayapisResource = v1alpha1.SchemeGroupVersion.WithResource("apigatewayapis")

var apigatewayapisKind = v1alpha1.SchemeGroupVersion.WithKind("APIGatewayAPI")
