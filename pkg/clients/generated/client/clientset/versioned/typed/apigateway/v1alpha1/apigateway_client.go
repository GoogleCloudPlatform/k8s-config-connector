...
func (c *ApigatewayV1alpha1Client) APIGatewayAPIConfigs(namespace string) APIGatewayAPIConfigInterface {
	return newAPIGatewayAPIConfigs(c, namespace)
}

func (c *ApigatewayV1alpha1Client) APIGatewayGateways(namespace string) APIGatewayGatewayInterface {
	return newAPIGatewayGateways(c, namespace)
}
...
// NewForConfigAndClient creates a new ApigatewayV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ApigatewayV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := apigatewayv1alpha1.SchemeGroupVersion
