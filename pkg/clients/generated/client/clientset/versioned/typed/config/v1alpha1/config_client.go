...
type ConfigV1alpha1Interface interface {
	...
	InfraManagerDeploymentsGetter
}

// ConfigV1alpha1Client is used to interact with features provided by the config.cnrm.cloud.google.com group.
type ConfigV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ConfigV1alpha1Client) InfraManagerDeployments(namespace string) InfraManagerDeploymentInterface {
	return newInfraManagerDeployments(c, namespace)
}
