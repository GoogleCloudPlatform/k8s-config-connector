...
func (c *FakeConfigV1alpha1) InfraManagerDeployments(namespace string) v1alpha1.InfraManagerDeploymentInterface {
	return newFakeInfraManagerDeployments(c, namespace)
}
