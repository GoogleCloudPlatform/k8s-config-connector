...
// LoggingV1alpha1Client is used to interact with features provided by the logging.cnrm.cloud.google.com group.
type LoggingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *LoggingV1alpha1Client) LoggingLinks(namespace string) LoggingLinkInterface {
