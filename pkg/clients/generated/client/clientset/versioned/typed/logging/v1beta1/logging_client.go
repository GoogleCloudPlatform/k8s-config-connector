...
func (c *LoggingV1beta1Client) LoggingLinks(namespace string) LoggingLinkInterface {
	return newLoggingLinks(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) {
	gv := loggingv1beta1.SchemeGroupVersion
