...
func (c *dataCatalogPolicyTags) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DataCatalogPolicyTag, err error) {
	result = &v1beta1.DataCatalogPolicyTag{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dataCatalogPolicyTags) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DataCatalogPolicyTagList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DataCatalogPolicyTagList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("datacatalogpolicytags").
...
func (c *dataCatalogPolicyTags) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataCatalogPolicyTags) Create(ctx context.Context, dataCatalogPolicyTag *v1beta1.DataCatalogPolicyTag, opts v1.CreateOptions) (result *v1beta1.DataCatalogPolicyTag, err error) {
	result = &v1beta1.DataCatalogPolicyTag{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("datacatalogpolicytags").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataCatalogPolicyTag).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dataCatalogPolicyTags) Update(ctx context.Context, dataCatalogPolicyTag *v1beta1.DataCatalogPolicyTag, opts v1.UpdateOptions) (result *v1beta1.DataCatalogPolicyTag, err error) {
	result = &v1beta1.DataCatalogPolicyTag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datacatalogpolicytags").
		Name(dataCatalogPolicyTag.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dataCatalogPolicyTag).
		Do(ctx).
		Into(result)
...
func (c *dataCatalogPolicyTags) UpdateStatus(ctx context.Context, dataCatalogPolicyTag *v1beta1.DataCatalogPolicyTag, opts v1.UpdateOptions) (result *v1beta1.DataCatalogPolicyTag, err error) {
	result = &v1beta1.DataCatalogPolicyTag{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("datacatalogpolicytags").
...
func (c *dataCatalogPolicyTags) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataCatalogPolicyTags) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataCatalogPolicyTags) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DataCatalogPolicyTag, err error) {
	result = &v1beta1.DataCatalogPolicyTag{}
