...
type DatacatalogV1alpha1Interface interface {
	RESTClient() rest.Interface
	DataCatalogEntriesGetter
	DataCatalogEntryGroupsGetter
	DataCatalogTagsGetter
	DataCatalogTagTemplatesGetter
}
...
// NewForConfigAndClient creates a new DatacatalogV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DatacatalogV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &DatacatalogV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DatacatalogV1alpha1Client for the given config and
...
func New(c rest.Interface) *DatacatalogV1alpha1Client {
	return &DatacatalogV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := datacatalogv1alpha1.SchemeGroupVersion
