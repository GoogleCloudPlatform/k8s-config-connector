...
func (c *DatacatalogV1beta1Client) DataCatalogTaxonomies(namespace string) DataCatalogTaxonomyInterface {
	return newDataCatalogTaxonomies(c, namespace)
}

// NewForConfig creates a new DatacatalogV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new DatacatalogV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DatacatalogV1beta1Client, error) {
	...
	return &DatacatalogV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new DatacatalogV1beta1Client for the given config and
...
func New(c rest.Interface) *DatacatalogV1beta1Client {
	return &DatacatalogV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := datacatalogv1beta1.SchemeGroupVersion
