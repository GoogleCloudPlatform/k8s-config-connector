...
var dnspoliciesResource = schema.GroupVersionResource{Group: "dns.cnrm.cloud.google.com", Version: "v1beta1", Resource: "dnspolicies"}

var dnspoliciesKind = schema.GroupVersionKind{Group: "dns.cnrm.cloud.google.com", Version: "v1beta1", Kind: "DNSPolicy"}
...
func (c *FakeDNSPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DNSPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(dnspoliciesResource, c.ns, name), &v1beta1.DNSPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.DNSPolicy), err
}
...
func (c *FakeDNSPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DNSPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(dnspoliciesResource, dnspoliciesKind, c.ns, opts), &v1beta1.DNSPolicyList{})
	...
	list := &v1beta1.DNSPolicyList{ListMeta: obj.(*v1beta1.DNSPolicyList).ListMeta}
	for _, item := range obj.(*v1beta1.DNSPolicyList).Items {
...
func (c *FakeDNSPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(dnspoliciesResource, c.ns, opts))
...
func (c *FakeDNSPolicies) Create(ctx context.Context, dNSPolicy *v1beta1.DNSPolicy, opts v1.CreateOptions) (result *v1beta1.DNSPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(dnspoliciesResource, c.ns, dNSPolicy), &v1beta1.DNSPolicy{})
...
func (c *FakeDNSPolicies) Update(ctx context.Context, dNSPolicy *v1beta1.DNSPolicy, opts v1.UpdateOptions) (result *v1beta1.DNSPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(dnspoliciesResource, c.ns, dNSPolicy), &v1beta1.DNSPolicy{})
...
func (c *FakeDNSPolicies) UpdateStatus(ctx context.Context, dNSPolicy *v1beta1.DNSPolicy, opts v1.UpdateOptions) (*v1beta1.DNSPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(dnspoliciesResource, "status", c.ns, dNSPolicy), &v1beta1.DNSPolicy{})
...
func (c *FakeDNSPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(dnspoliciesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.DNSPolicyList{})
	return err
}
...
func (c *FakeDNSPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DNSPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(dnspoliciesResource, c.ns, name, pt, data, subresources...), &v1beta1.DNSPolicy{})
