...
func (c *FakeCloudbuildV1alpha1) CloudBuildConnections(namespace string) v1alpha1.CloudBuildConnectionInterface {
	return newFakeCloudBuildConnections(c, namespace)
}
