...
// NewForConfigAndClient creates a new CloudbuildV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CloudbuildV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &CloudbuildV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new CloudbuildV1beta1Client for the given config and
...
func New(c rest.Interface) *CloudbuildV1beta1Client {
	return &CloudbuildV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := cloudbuildv1beta1.SchemeGroupVersion
