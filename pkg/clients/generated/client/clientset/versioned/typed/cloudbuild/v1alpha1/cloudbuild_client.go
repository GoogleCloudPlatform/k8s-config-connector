...
type CloudbuildV1alpha1Interface interface {
	...
	CloudBuildConnectionsGetter
}

// CloudbuildV1alpha1Client is used to interact with features provided by the cloudbuild.cnrm.cloud.google.com group.
type CloudbuildV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CloudbuildV1alpha1Client) CloudBuildConnections(namespace string) CloudBuildConnectionInterface {
	return newCloudBuildConnections(c, namespace)
}
...
// NewForConfigAndClient creates a new CloudbuildV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CloudbuildV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := cloudbuildv1alpha1.SchemeGroupVersion
