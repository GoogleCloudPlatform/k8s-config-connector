...
func (c *FirebasehostingV1alpha1Client) FirebaseHostingChannels(namespace string) FirebaseHostingChannelInterface {
	return newFirebaseHostingChannels(c, namespace)
}

func (c *FirebasehostingV1alpha1Client) FirebaseHostingSites(namespace string) FirebaseHostingSiteInterface {
	return newFirebaseHostingSites(c, namespace)
}

// NewForConfig creates a new FirebasehostingV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new FirebasehostingV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FirebasehostingV1alpha1Client, error) {
	...
	return &FirebasehostingV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FirebasehostingV1alpha1Client for the given config and
...
func New(c rest.Interface) *FirebasehostingV1alpha1Client {
	return &FirebasehostingV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := firebasehostingv1alpha1.SchemeGroupVersion
...
func (c *FirebasehostingV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
