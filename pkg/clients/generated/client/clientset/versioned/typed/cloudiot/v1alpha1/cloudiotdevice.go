...
// CloudIOTDevicesGetter has a method to return a CloudIOTDeviceInterface.
...
// cloudIOTDevices implements CloudIOTDeviceInterface
type cloudIOTDevices struct {
	client rest.Interface
	ns     string
}

// newCloudIOTDevices returns a CloudIOTDevices
func newCloudIOTDevices(c *CloudiotV1alpha1Client, namespace string) *cloudIOTDevices {
	return &cloudIOTDevices{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cloudIOTDevices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.CloudIOTDevice, err error) {
	result = &v1alpha1.CloudIOTDevice{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *cloudIOTDevices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CloudIOTDeviceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.CloudIOTDeviceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cloudiotdevices").
...
func (c *cloudIOTDevices) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudIOTDevices) Create(ctx context.Context, cloudIOTDevice *v1alpha1.CloudIOTDevice, opts v1.CreateOptions) (result *v1alpha1.CloudIOTDevice, err error) {
	result = &v1alpha1.CloudIOTDevice{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudiotdevices").
...
func (c *cloudIOTDevices) Update(ctx context.Context, cloudIOTDevice *v1alpha1.CloudIOTDevice, opts v1.UpdateOptions) (result *v1alpha1.CloudIOTDevice, err error) {
	result = &v1alpha1.CloudIOTDevice{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudiotdevices").
...
func (c *cloudIOTDevices) UpdateStatus(ctx context.Context, cloudIOTDevice *v1alpha1.CloudIOTDevice, opts v1.UpdateOptions) (result *v1alpha1.CloudIOTDevice, err error) {
	result = &v1alpha1.CloudIOTDevice{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudiotdevices").
...
func (c *cloudIOTDevices) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudIOTDevices) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudIOTDevices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.CloudIOTDevice, err error) {
	result = &v1alpha1.CloudIOTDevice{}
