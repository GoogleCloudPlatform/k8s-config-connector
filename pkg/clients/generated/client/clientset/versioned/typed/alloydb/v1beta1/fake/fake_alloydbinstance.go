...
var alloydbinstancesKind = schema.GroupVersionKind{Group: "alloydb.cnrm.cloud.google.com", Version: "v1beta1", Kind: "AlloyDBInstance"}
...
func (c *FakeAlloyDBInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.AlloyDBInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(alloydbinstancesResource, c.ns, name), &v1beta1.AlloyDBInstance{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.AlloyDBInstance), err
}

// List takes label and field selectors, and returns the list of AlloyDBInstances that match those selectors.
func (c *FakeAlloyDBInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.AlloyDBInstanceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(alloydbinstancesResource, alloydbinstancesKind, c.ns, opts), &v1beta1.AlloyDBInstanceList{})
	...
	list := &v1beta1.AlloyDBInstanceList{ListMeta: obj.(*v1beta1.AlloyDBInstanceList).ListMeta}
	for _, item := range obj.(*v1beta1.AlloyDBInstanceList).Items {
...
func (c *FakeAlloyDBInstances) Create(ctx context.Context, alloyDBInstance *v1beta1.AlloyDBInstance, opts v1.CreateOptions) (result *v1beta1.AlloyDBInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(alloydbinstancesResource, c.ns, alloyDBInstance), &v1beta1.AlloyDBInstance{})
...
func (c *FakeAlloyDBInstances) Update(ctx context.Context, alloyDBInstance *v1beta1.AlloyDBInstance, opts v1.UpdateOptions) (result *v1beta1.AlloyDBInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(alloydbinstancesResource, c.ns, alloyDBInstance), &v1beta1.AlloyDBInstance{})
...
func (c *FakeAlloyDBInstances) UpdateStatus(ctx context.Context, alloyDBInstance *v1beta1.AlloyDBInstance, opts v1.UpdateOptions) (*v1beta1.AlloyDBInstance, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(alloydbinstancesResource, "status", c.ns, alloyDBInstance), &v1beta1.AlloyDBInstance{})
...
func (c *FakeAlloyDBInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(alloydbinstancesResource, c.ns, name, opts), &v1beta1.AlloyDBInstance{})
...
func (c *FakeAlloyDBInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.AlloyDBInstanceList{})
	return err
}
...
func (c *FakeAlloyDBInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.AlloyDBInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(alloydbinstancesResource, c.ns, name, pt, data, subresources...), &v1beta1.AlloyDBInstance{})
