...
func NewForConfig(c *rest.Config) (*AccesscontextmanagerV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new AccesscontextmanagerV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AccesscontextmanagerV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &AccesscontextmanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AccesscontextmanagerV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *AccesscontextmanagerV1alpha1Client {
...
// New creates a new AccesscontextmanagerV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *AccesscontextmanagerV1alpha1Client {
	return &AccesscontextmanagerV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := accesscontextmanagerv1alpha1.SchemeGroupVersion
...
func (c *AccesscontextmanagerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
