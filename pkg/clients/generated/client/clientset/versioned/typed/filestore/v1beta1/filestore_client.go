...
func (c *FilestoreV1beta1Client) FilestoreBackups(namespace string) FilestoreBackupInterface {
	return newFilestoreBackups(c, namespace)
}
...
// NewForConfig creates a new FilestoreV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new FilestoreV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FilestoreV1beta1Client, error) {
	...
	return &FilestoreV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new FilestoreV1beta1Client for the given config and
...
func New(c rest.Interface) *FilestoreV1beta1Client {
	return &FilestoreV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := filestorev1beta1.SchemeGroupVersion
