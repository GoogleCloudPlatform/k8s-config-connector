...
type DatastreamV1alpha1Interface interface {
...
func (c *DatastreamV1alpha1Client) DatastreamConnectionProfiles(namespace string) DatastreamConnectionProfileInterface {
	return newDatastreamConnectionProfiles(c, namespace)
}
...
func (c *DatastreamV1alpha1Client) DatastreamStreams(namespace string) DatastreamStreamInterface {
	return newDatastreamStreams(c, namespace)
}

// NewForConfig creates a new DatastreamV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new DatastreamV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DatastreamV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &DatastreamV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DatastreamV1alpha1Client for the given config and
...
func New(c rest.Interface) *DatastreamV1alpha1Client {
	return &DatastreamV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := datastreamv1alpha1.SchemeGroupVersion
