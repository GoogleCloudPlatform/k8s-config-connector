...
// FirebaseWebAppsGetter has a method to return a FirebaseWebAppInterface.
...
// firebaseWebApps implements FirebaseWebAppInterface
type firebaseWebApps struct {
	client rest.Interface
	ns     string
}

// newFirebaseWebApps returns a FirebaseWebApps
func newFirebaseWebApps(c *FirebaseV1alpha1Client, namespace string) *firebaseWebApps {
	return &firebaseWebApps{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *firebaseWebApps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.FirebaseWebApp, err error) {
	result = &v1alpha1.FirebaseWebApp{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *firebaseWebApps) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.FirebaseWebAppList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.FirebaseWebAppList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("firebasewebapps").
...
func (c *firebaseWebApps) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *firebaseWebApps) Create(ctx context.Context, firebaseWebApp *v1alpha1.FirebaseWebApp, opts v1.CreateOptions) (result *v1alpha1.FirebaseWebApp, err error) {
	result = &v1alpha1.FirebaseWebApp{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("firebasewebapps").
...
func (c *firebaseWebApps) Update(ctx context.Context, firebaseWebApp *v1alpha1.FirebaseWebApp, opts v1.UpdateOptions) (result *v1alpha1.FirebaseWebApp, err error) {
	result = &v1alpha1.FirebaseWebApp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firebasewebapps").
		Name(firebaseWebApp.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(firebaseWebApp).
		Do(ctx).
		Into(result)
...
func (c *firebaseWebApps) UpdateStatus(ctx context.Context, firebaseWebApp *v1alpha1.FirebaseWebApp, opts v1.UpdateOptions) (result *v1alpha1.FirebaseWebApp, err error) {
	result = &v1alpha1.FirebaseWebApp{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("firebasewebapps").
...
func (c *firebaseWebApps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *firebaseWebApps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *firebaseWebApps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.FirebaseWebApp, err error) {
	result = &v1alpha1.FirebaseWebApp{}
