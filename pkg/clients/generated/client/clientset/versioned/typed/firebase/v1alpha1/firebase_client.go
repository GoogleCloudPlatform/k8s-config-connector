...
type FirebaseV1alpha1Interface interface {
	RESTClient() rest.Interface
	FirebaseAndroidAppsGetter
	FirebaseProjectsGetter
	FirebaseWebAppsGetter
}
...
func (c *FirebaseV1alpha1Client) FirebaseAndroidApps(namespace string) FirebaseAndroidAppInterface {
	return newFirebaseAndroidApps(c, namespace)
}

func (c *FirebaseV1alpha1Client) FirebaseProjects(namespace string) FirebaseProjectInterface {
	return newFirebaseProjects(c, namespace)
}

func (c *FirebaseV1alpha1Client) FirebaseWebApps(namespace string) FirebaseWebAppInterface {
	return newFirebaseWebApps(c, namespace)
}

// NewForConfig creates a new FirebaseV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new FirebaseV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FirebaseV1alpha1Client, error) {
	...
	return &FirebaseV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new FirebaseV1alpha1Client for the given config and
...
func New(c rest.Interface) *FirebaseV1alpha1Client {
	return &FirebaseV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := firebasev1alpha1.SchemeGroupVersion
