...
func (c *DiscoveryengineV1alpha1Client) DiscoveryEngineControls(namespace string) DiscoveryEngineControlInterface {
	return newDiscoveryEngineControls(c, namespace)
}
...
func (c *DiscoveryengineV1alpha1Client) DiscoveryEngineDataStores(namespace string) DiscoveryEngineDataStoreInterface {
	return newDiscoveryEngineDataStores(c, namespace)
}

func (c *DiscoveryengineV1alpha1Client) DiscoveryEngineDataStoreTargetSites(namespace string) DiscoveryEngineDataStoreTargetSiteInterface {
	return newDiscoveryEngineDataStoreTargetSites(c, namespace)
}

func (c *DiscoveryengineV1alpha1Client) DiscoveryEngineEngines(namespace string) DiscoveryEngineEngineInterface {
	return newDiscoveryEngineEngines(c, namespace)
}

func (c *DiscoveryengineV1alpha1Client) DiscoveryEngineIdentityMappingStores(namespace string) DiscoveryEngineIdentityMappingStoreInterface {
	return newDiscoveryEngineIdentityMappingStores(c, namespace)
}

func (c *DiscoveryengineV1alpha1Client) DiscoveryEngineLicenseConfigs(namespace string) DiscoveryEngineLicenseConfigInterface {
...
func (c *DiscoveryengineV1alpha1Client) DiscoveryEngineServingConfigs(namespace string) DiscoveryEngineServingConfigInterface {
	return newDiscoveryEngineServingConfigs(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*DiscoveryengineV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new DiscoveryengineV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DiscoveryengineV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &DiscoveryengineV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DiscoveryengineV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *DiscoveryengineV1alpha1Client {
...
// New creates a new DiscoveryengineV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *DiscoveryengineV1alpha1Client {
	return &DiscoveryengineV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := discoveryenginev1alpha1.SchemeGroupVersion
...
func (c *DiscoveryengineV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
