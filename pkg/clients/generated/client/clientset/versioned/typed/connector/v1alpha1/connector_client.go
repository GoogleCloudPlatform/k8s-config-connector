...
import (
	...
	v1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/apis/connector/v1alpha1"
	"github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/client/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type ConnectorV1alpha1Interface interface {
	RESTClient() rest.Interface
}

// ConnectorV1alpha1Client is used to interact with features provided by the connector group.
...
// NewForConfigAndClient creates a new ConnectorV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ConnectorV1alpha1Client, error) {
	...
	return &ConnectorV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ConnectorV1alpha1Client for the given config and
...
func New(c rest.Interface) *ConnectorV1alpha1Client {
	return &ConnectorV1alpha1Client{c}
}
