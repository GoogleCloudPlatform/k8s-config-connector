...
type NetappV1alpha1Interface interface {
	...
	NetAppBackupPoliciesGetter
	NetAppBackupVaultsGetter
}

// NetappV1alpha1Client is used to interact with features provided by the netapp.cnrm.cloud.google.com group.
type NetappV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetappV1alpha1Client) NetAppBackupPolicies(namespace string) NetAppBackupPolicyInterface {
	return newNetAppBackupPolicies(c, namespace)
}

func (c *NetappV1alpha1Client) NetAppBackupVaults(namespace string) NetAppBackupVaultInterface {
	return newNetAppBackupVaults(c, namespace)
}
...
// NewForConfigAndClient creates a new NetappV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NetappV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := netappv1alpha1.SchemeGroupVersion
