...
func (c *PrivatecaV1beta1Client) PrivateCACertificates(namespace string) PrivateCACertificateInterface {
	return newPrivateCACertificates(c, namespace)
}
...
func (c *PrivatecaV1beta1Client) PrivateCACertificateTemplates(namespace string) PrivateCACertificateTemplateInterface {
	return newPrivateCACertificateTemplates(c, namespace)
}

// NewForConfig creates a new PrivatecaV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new PrivatecaV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*PrivatecaV1beta1Client, error) {
	...
	return &PrivatecaV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new PrivatecaV1beta1Client for the given config and
...
func New(c rest.Interface) *PrivatecaV1beta1Client {
	return &PrivatecaV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := privatecav1beta1.SchemeGroupVersion
