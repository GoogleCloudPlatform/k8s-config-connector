...
var privatecacertificatetemplatesResource = v1beta1.SchemeGroupVersion.WithResource("privatecacertificatetemplates")

var privatecacertificatetemplatesKind = v1beta1.SchemeGroupVersion.WithKind("PrivateCACertificateTemplate")
