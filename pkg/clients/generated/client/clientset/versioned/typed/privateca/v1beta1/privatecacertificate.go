...
// PrivateCACertificatesGetter has a method to return a PrivateCACertificateInterface.
...
// privateCACertificates implements PrivateCACertificateInterface
type privateCACertificates struct {
	client rest.Interface
	ns     string
}

// newPrivateCACertificates returns a PrivateCACertificates
func newPrivateCACertificates(c *PrivatecaV1beta1Client, namespace string) *privateCACertificates {
	return &privateCACertificates{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *privateCACertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PrivateCACertificate, err error) {
	result = &v1beta1.PrivateCACertificate{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("privatecacertificates").
		Name(name).
...
func (c *privateCACertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PrivateCACertificateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.PrivateCACertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("privatecacertificates").
...
func (c *privateCACertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *privateCACertificates) Create(ctx context.Context, privateCACertificate *v1beta1.PrivateCACertificate, opts v1.CreateOptions) (result *v1beta1.PrivateCACertificate, err error) {
	result = &v1beta1.PrivateCACertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("privatecacertificates").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateCACertificate).
		Do(ctx).
		Into(result)
	return
}
...
func (c *privateCACertificates) Update(ctx context.Context, privateCACertificate *v1beta1.PrivateCACertificate, opts v1.UpdateOptions) (result *v1beta1.PrivateCACertificate, err error) {
	result = &v1beta1.PrivateCACertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatecacertificates").
		Name(privateCACertificate.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateCACertificate).
		Do(ctx).
		Into(result)
...
func (c *privateCACertificates) UpdateStatus(ctx context.Context, privateCACertificate *v1beta1.PrivateCACertificate, opts v1.UpdateOptions) (result *v1beta1.PrivateCACertificate, err error) {
	result = &v1beta1.PrivateCACertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatecacertificates").
...
func (c *privateCACertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *privateCACertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *privateCACertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PrivateCACertificate, err error) {
	result = &v1beta1.PrivateCACertificate{}
