...
func (c *privateCACAPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.PrivateCACAPool, err error) {
	result = &v1beta1.PrivateCACAPool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("privatecacapools").
		Name(name).
...
func (c *privateCACAPools) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.PrivateCACAPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.PrivateCACAPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("privatecacapools").
...
func (c *privateCACAPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *privateCACAPools) Create(ctx context.Context, privateCACAPool *v1beta1.PrivateCACAPool, opts v1.CreateOptions) (result *v1beta1.PrivateCACAPool, err error) {
	result = &v1beta1.PrivateCACAPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("privatecacapools").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateCACAPool).
		Do(ctx).
		Into(result)
	return
}
...
func (c *privateCACAPools) Update(ctx context.Context, privateCACAPool *v1beta1.PrivateCACAPool, opts v1.UpdateOptions) (result *v1beta1.PrivateCACAPool, err error) {
	result = &v1beta1.PrivateCACAPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatecacapools").
		Name(privateCACAPool.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(privateCACAPool).
		Do(ctx).
		Into(result)
...
func (c *privateCACAPools) UpdateStatus(ctx context.Context, privateCACAPool *v1beta1.PrivateCACAPool, opts v1.UpdateOptions) (result *v1beta1.PrivateCACAPool, err error) {
	result = &v1beta1.PrivateCACAPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("privatecacapools").
...
func (c *privateCACAPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *privateCACAPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *privateCACAPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.PrivateCACAPool, err error) {
	result = &v1beta1.PrivateCACAPool{}
