...
type ApphubV1alpha1Interface interface {
...
type ApphubV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ApphubV1alpha1Client) AppHubDiscoveredServices(namespace string) AppHubDiscoveredServiceInterface {
	return newAppHubDiscoveredServices(c, namespace)
}
...
// NewForConfigAndClient creates a new ApphubV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ApphubV1alpha1Client, error) {
	...
	return &ApphubV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ApphubV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ApphubV1alpha1Client {
...
// New creates a new ApphubV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *ApphubV1alpha1Client {
...
func (c *ApphubV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
