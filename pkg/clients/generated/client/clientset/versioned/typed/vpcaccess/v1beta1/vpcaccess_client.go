...
func (c *VpcaccessV1beta1Client) VPCAccessConnectors(namespace string) VPCAccessConnectorInterface {
	return newVPCAccessConnectors(c, namespace)
}

// NewForConfig creates a new VpcaccessV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new VpcaccessV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*VpcaccessV1beta1Client, error) {
	...
	return &VpcaccessV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new VpcaccessV1beta1Client for the given config and
...
func New(c rest.Interface) *VpcaccessV1beta1Client {
	return &VpcaccessV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := vpcaccessv1beta1.SchemeGroupVersion
