...
func (c *FakeVertexAIFeaturestoreEntityTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VertexAIFeaturestoreEntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(vertexaifeaturestoreentitytypesResource, c.ns, name), &v1alpha1.VertexAIFeaturestoreEntityType{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.VertexAIFeaturestoreEntityType), err
}
...
func (c *FakeVertexAIFeaturestoreEntityTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VertexAIFeaturestoreEntityTypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(vertexaifeaturestoreentitytypesResource, vertexaifeaturestoreentitytypesKind, c.ns, opts), &v1alpha1.VertexAIFeaturestoreEntityTypeList{})
	...
	list := &v1alpha1.VertexAIFeaturestoreEntityTypeList{ListMeta: obj.(*v1alpha1.VertexAIFeaturestoreEntityTypeList).ListMeta}
	for _, item := range obj.(*v1alpha1.VertexAIFeaturestoreEntityTypeList).Items {
...
func (c *FakeVertexAIFeaturestoreEntityTypes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(vertexaifeaturestoreentitytypesResource, c.ns, opts))
...
func (c *FakeVertexAIFeaturestoreEntityTypes) Create(ctx context.Context, vertexAIFeaturestoreEntityType *v1alpha1.VertexAIFeaturestoreEntityType, opts v1.CreateOptions) (result *v1alpha1.VertexAIFeaturestoreEntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(vertexaifeaturestoreentitytypesResource, c.ns, vertexAIFeaturestoreEntityType), &v1alpha1.VertexAIFeaturestoreEntityType{})
...
func (c *FakeVertexAIFeaturestoreEntityTypes) Update(ctx context.Context, vertexAIFeaturestoreEntityType *v1alpha1.VertexAIFeaturestoreEntityType, opts v1.UpdateOptions) (result *v1alpha1.VertexAIFeaturestoreEntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(vertexaifeaturestoreentitytypesResource, c.ns, vertexAIFeaturestoreEntityType), &v1alpha1.VertexAIFeaturestoreEntityType{})
...
func (c *FakeVertexAIFeaturestoreEntityTypes) UpdateStatus(ctx context.Context, vertexAIFeaturestoreEntityType *v1alpha1.VertexAIFeaturestoreEntityType, opts v1.UpdateOptions) (*v1alpha1.VertexAIFeaturestoreEntityType, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(vertexaifeaturestoreentitytypesResource, "status", c.ns, vertexAIFeaturestoreEntityType), &v1alpha1.VertexAIFeaturestoreEntityType{})
...
func (c *FakeVertexAIFeaturestoreEntityTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(vertexaifeaturestoreentitytypesResource, c.ns, name, opts), &v1alpha1.VertexAIFeaturestoreEntityType{})
...
func (c *FakeVertexAIFeaturestoreEntityTypes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(vertexaifeaturestoreentitytypesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.VertexAIFeaturestoreEntityTypeList{})
	return err
}
...
func (c *FakeVertexAIFeaturestoreEntityTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VertexAIFeaturestoreEntityType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(vertexaifeaturestoreentitytypesResource, c.ns, name, pt, data, subresources...), &v1alpha1.VertexAIFeaturestoreEntityType{})
