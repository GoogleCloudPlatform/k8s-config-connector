...
func newVertexAIIndexEndpoints(c *VertexaiV1alpha1Client, namespace string) *vertexAIIndexEndpoints {
...
func (c *vertexAIIndexEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VertexAIIndexEndpoint, err error) {
	result = &v1alpha1.VertexAIIndexEndpoint{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vertexAIIndexEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VertexAIIndexEndpointList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VertexAIIndexEndpointList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vertexaiindexendpoints").
...
func (c *vertexAIIndexEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vertexAIIndexEndpoints) Create(ctx context.Context, vertexAIIndexEndpoint *v1alpha1.VertexAIIndexEndpoint, opts v1.CreateOptions) (result *v1alpha1.VertexAIIndexEndpoint, err error) {
	result = &v1alpha1.VertexAIIndexEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vertexaiindexendpoints").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vertexAIIndexEndpoint).
		Do(ctx).
		Into(result)
	return
}
...
func (c *vertexAIIndexEndpoints) Update(ctx context.Context, vertexAIIndexEndpoint *v1alpha1.VertexAIIndexEndpoint, opts v1.UpdateOptions) (result *v1alpha1.VertexAIIndexEndpoint, err error) {
	result = &v1alpha1.VertexAIIndexEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vertexaiindexendpoints").
		Name(vertexAIIndexEndpoint.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vertexAIIndexEndpoint).
		Do(ctx).
		Into(result)
...
func (c *vertexAIIndexEndpoints) UpdateStatus(ctx context.Context, vertexAIIndexEndpoint *v1alpha1.VertexAIIndexEndpoint, opts v1.UpdateOptions) (result *v1alpha1.VertexAIIndexEndpoint, err error) {
	result = &v1alpha1.VertexAIIndexEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vertexaiindexendpoints").
...
func (c *vertexAIIndexEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vertexAIIndexEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vertexAIIndexEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VertexAIIndexEndpoint, err error) {
	result = &v1alpha1.VertexAIIndexEndpoint{}
