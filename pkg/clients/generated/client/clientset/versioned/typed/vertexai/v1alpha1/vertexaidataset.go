...
func newVertexAIDatasets(c *VertexaiV1alpha1Client, namespace string) *vertexAIDatasets {
...
func (c *vertexAIDatasets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VertexAIDataset, err error) {
	result = &v1alpha1.VertexAIDataset{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vertexAIDatasets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VertexAIDatasetList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VertexAIDatasetList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vertexaidatasets").
...
func (c *vertexAIDatasets) Create(ctx context.Context, vertexAIDataset *v1alpha1.VertexAIDataset, opts v1.CreateOptions) (result *v1alpha1.VertexAIDataset, err error) {
	result = &v1alpha1.VertexAIDataset{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vertexaidatasets").
...
func (c *vertexAIDatasets) Update(ctx context.Context, vertexAIDataset *v1alpha1.VertexAIDataset, opts v1.UpdateOptions) (result *v1alpha1.VertexAIDataset, err error) {
	result = &v1alpha1.VertexAIDataset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vertexaidatasets").
...
func (c *vertexAIDatasets) UpdateStatus(ctx context.Context, vertexAIDataset *v1alpha1.VertexAIDataset, opts v1.UpdateOptions) (result *v1alpha1.VertexAIDataset, err error) {
	result = &v1alpha1.VertexAIDataset{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vertexaidatasets").
...
func (c *vertexAIDatasets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VertexAIDataset, err error) {
	result = &v1alpha1.VertexAIDataset{}
