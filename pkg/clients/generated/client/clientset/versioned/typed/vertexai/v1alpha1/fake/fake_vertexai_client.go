...
func (c *FakeVertexaiV1alpha1) VertexAIReasoningEngines(namespace string) v1alpha1.VertexAIReasoningEngineInterface {
	return newFakeVertexAIReasoningEngines(c, namespace)
}
