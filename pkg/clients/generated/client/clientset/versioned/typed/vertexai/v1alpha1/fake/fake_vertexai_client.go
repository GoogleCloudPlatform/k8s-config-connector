...
func (c *FakeVertexaiV1alpha1) VertexAIOnlineEvaluators(namespace string) v1alpha1.VertexAIOnlineEvaluatorInterface {
	return newFakeVertexAIOnlineEvaluators(c, namespace)
}
