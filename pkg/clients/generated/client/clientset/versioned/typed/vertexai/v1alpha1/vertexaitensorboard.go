...
func (c *vertexAITensorboards) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VertexAITensorboard, err error) {
	result = &v1alpha1.VertexAITensorboard{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vertexaitensorboards").
		Name(name).
...
func (c *vertexAITensorboards) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VertexAITensorboardList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.VertexAITensorboardList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vertexaitensorboards").
...
func (c *vertexAITensorboards) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vertexAITensorboards) Create(ctx context.Context, vertexAITensorboard *v1alpha1.VertexAITensorboard, opts v1.CreateOptions) (result *v1alpha1.VertexAITensorboard, err error) {
	result = &v1alpha1.VertexAITensorboard{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vertexaitensorboards").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vertexAITensorboard).
		Do(ctx).
		Into(result)
	return
}
...
func (c *vertexAITensorboards) Update(ctx context.Context, vertexAITensorboard *v1alpha1.VertexAITensorboard, opts v1.UpdateOptions) (result *v1alpha1.VertexAITensorboard, err error) {
	result = &v1alpha1.VertexAITensorboard{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vertexaitensorboards").
		Name(vertexAITensorboard.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vertexAITensorboard).
		Do(ctx).
		Into(result)
...
func (c *vertexAITensorboards) UpdateStatus(ctx context.Context, vertexAITensorboard *v1alpha1.VertexAITensorboard, opts v1.UpdateOptions) (result *v1alpha1.VertexAITensorboard, err error) {
	result = &v1alpha1.VertexAITensorboard{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vertexaitensorboards").
...
func (c *vertexAITensorboards) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vertexAITensorboards) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vertexAITensorboards) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VertexAITensorboard, err error) {
	result = &v1alpha1.VertexAITensorboard{}
