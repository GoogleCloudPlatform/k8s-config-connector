...
type VertexaiV1alpha1Interface interface {
	...
	VertexAINotebookExecutionJobsGetter
...
func (c *VertexaiV1alpha1Client) VertexAIFeaturestoreEntityTypeFeatures(namespace string) VertexAIFeaturestoreEntityTypeFeatureInterface {
	return newVertexAIFeaturestoreEntityTypeFeatures(c, namespace)
}
...
func (c *VertexaiV1alpha1Client) VertexAINotebookExecutionJobs(namespace string) VertexAINotebookExecutionJobInterface {
	return newVertexAINotebookExecutionJobs(c, namespace)
}
...
// NewForConfigAndClient creates a new VertexaiV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*VertexaiV1alpha1Client, error) {
	...
	return &VertexaiV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new VertexaiV1alpha1Client for the given config and
...
func New(c rest.Interface) *VertexaiV1alpha1Client {
