...
// NewForConfig creates a new SpannerV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new SpannerV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SpannerV1beta1Client, error) {
	...
	return &SpannerV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new SpannerV1beta1Client for the given config and
...
func New(c rest.Interface) *SpannerV1beta1Client {
	return &SpannerV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := spannerv1beta1.SchemeGroupVersion
