...
func (c *beyondCorpAppGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.BeyondCorpAppGateway, err error) {
	result = &v1alpha1.BeyondCorpAppGateway{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *beyondCorpAppGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.BeyondCorpAppGatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.BeyondCorpAppGatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("beyondcorpappgateways").
...
func (c *beyondCorpAppGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *beyondCorpAppGateways) Create(ctx context.Context, beyondCorpAppGateway *v1alpha1.BeyondCorpAppGateway, opts v1.CreateOptions) (result *v1alpha1.BeyondCorpAppGateway, err error) {
	result = &v1alpha1.BeyondCorpAppGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("beyondcorpappgateways").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(beyondCorpAppGateway).
		Do(ctx).
		Into(result)
	return
}
...
func (c *beyondCorpAppGateways) Update(ctx context.Context, beyondCorpAppGateway *v1alpha1.BeyondCorpAppGateway, opts v1.UpdateOptions) (result *v1alpha1.BeyondCorpAppGateway, err error) {
	result = &v1alpha1.BeyondCorpAppGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("beyondcorpappgateways").
		Name(beyondCorpAppGateway.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(beyondCorpAppGateway).
		Do(ctx).
		Into(result)
...
func (c *beyondCorpAppGateways) UpdateStatus(ctx context.Context, beyondCorpAppGateway *v1alpha1.BeyondCorpAppGateway, opts v1.UpdateOptions) (result *v1alpha1.BeyondCorpAppGateway, err error) {
	result = &v1alpha1.BeyondCorpAppGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("beyondcorpappgateways").
...
func (c *beyondCorpAppGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *beyondCorpAppGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *beyondCorpAppGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.BeyondCorpAppGateway, err error) {
	result = &v1alpha1.BeyondCorpAppGateway{}
