...
type BeyondcorpV1alpha1Interface interface {
...
// NewForConfigAndClient creates a new BeyondcorpV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BeyondcorpV1alpha1Client, error) {
	...
	return &BeyondcorpV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new BeyondcorpV1alpha1Client for the given config and
...
func New(c rest.Interface) *BeyondcorpV1alpha1Client {
