...
type ServicedirectoryV1beta1Interface interface {
	...
	ServiceDirectoryEndpointsGetter
...
func (c *ServicedirectoryV1beta1Client) ServiceDirectoryEndpoints(namespace string) ServiceDirectoryEndpointInterface {
	return newServiceDirectoryEndpoints(c, namespace)
}
...
// NewForConfigAndClient creates a new ServicedirectoryV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ServicedirectoryV1beta1Client, error) {
	...
	return &ServicedirectoryV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new ServicedirectoryV1beta1Client for the given config and
...
func New(c rest.Interface) *ServicedirectoryV1beta1Client {
	return &ServicedirectoryV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := servicedirectoryv1beta1.SchemeGroupVersion
