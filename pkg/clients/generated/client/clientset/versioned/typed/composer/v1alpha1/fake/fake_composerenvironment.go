...
import (
	...
	v1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/apis/composer/v1alpha1"
...
var composerenvironmentsResource = schema.GroupVersionResource{Group: "composer.cnrm.cloud.google.com", Version: "v1alpha1", Resource: "composerenvironments"}

var composerenvironmentsKind = schema.GroupVersionKind{Group: "composer.cnrm.cloud.google.com", Version: "v1alpha1", Kind: "ComposerEnvironment"}
...
func (c *FakeComposerEnvironments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComposerEnvironment, err error) {
	...
	return obj.(*v1alpha1.ComposerEnvironment), err
}

// List takes label and field selectors, and returns the list of ComposerEnvironments that match those selectors.
func (c *FakeComposerEnvironments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComposerEnvironmentList, err error) {
	obj, err := c.Fake.
	...
	list := &v1alpha1.ComposerEnvironmentList{ListMeta: obj.(*v1alpha1.ComposerEnvironmentList).ListMeta}
	for _, item := range obj.(*v1alpha1.ComposerEnvironmentList).Items {
...
func (c *FakeComposerEnvironments) UpdateStatus(ctx context.Context, composerEnvironment *v1alpha1.ComposerEnvironment, opts v1.UpdateOptions) (*v1alpha1.ComposerEnvironment, error) {
	obj, err := c.Fake.
...
func (c *FakeComposerEnvironments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(composerenvironmentsResource, c.ns, name, opts), &v1alpha1.ComposerEnvironment{})
