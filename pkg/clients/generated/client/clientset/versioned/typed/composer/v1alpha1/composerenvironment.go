...
func newComposerEnvironments(c *ComposerV1alpha1Client, namespace string) *composerEnvironments {
...
func (c *composerEnvironments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComposerEnvironment, err error) {
...
func (c *composerEnvironments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComposerEnvironmentList, err error) {
...
func (c *composerEnvironments) Create(ctx context.Context, composerEnvironment *v1alpha1.ComposerEnvironment, opts v1.CreateOptions) (result *v1alpha1.ComposerEnvironment, err error) {
	result = &v1alpha1.ComposerEnvironment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("composerenvironments").
...
func (c *composerEnvironments) Update(ctx context.Context, composerEnvironment *v1alpha1.ComposerEnvironment, opts v1.UpdateOptions) (result *v1alpha1.ComposerEnvironment, err error) {
	result = &v1alpha1.ComposerEnvironment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("composerenvironments").
...
func (c *composerEnvironments) UpdateStatus(ctx context.Context, composerEnvironment *v1alpha1.ComposerEnvironment, opts v1.UpdateOptions) (result *v1alpha1.ComposerEnvironment, err error) {
	result = &v1alpha1.ComposerEnvironment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("composerenvironments").
...
func (c *composerEnvironments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComposerEnvironment, err error) {
	result = &v1alpha1.ComposerEnvironment{}
