...
func (c *dialogflowCXWebhooks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DialogflowCXWebhook, err error) {
	result = &v1alpha1.DialogflowCXWebhook{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dialogflowCXWebhooks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DialogflowCXWebhookList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DialogflowCXWebhookList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dialogflowcxwebhooks").
...
func (c *dialogflowCXWebhooks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dialogflowCXWebhooks) Create(ctx context.Context, dialogflowCXWebhook *v1alpha1.DialogflowCXWebhook, opts v1.CreateOptions) (result *v1alpha1.DialogflowCXWebhook, err error) {
	result = &v1alpha1.DialogflowCXWebhook{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dialogflowcxwebhooks").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dialogflowCXWebhook).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dialogflowCXWebhooks) Update(ctx context.Context, dialogflowCXWebhook *v1alpha1.DialogflowCXWebhook, opts v1.UpdateOptions) (result *v1alpha1.DialogflowCXWebhook, err error) {
	result = &v1alpha1.DialogflowCXWebhook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dialogflowcxwebhooks").
		Name(dialogflowCXWebhook.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dialogflowCXWebhook).
		Do(ctx).
		Into(result)
...
func (c *dialogflowCXWebhooks) UpdateStatus(ctx context.Context, dialogflowCXWebhook *v1alpha1.DialogflowCXWebhook, opts v1.UpdateOptions) (result *v1alpha1.DialogflowCXWebhook, err error) {
	result = &v1alpha1.DialogflowCXWebhook{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dialogflowcxwebhooks").
...
func (c *dialogflowCXWebhooks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dialogflowCXWebhooks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dialogflowCXWebhooks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DialogflowCXWebhook, err error) {
	result = &v1alpha1.DialogflowCXWebhook{}
