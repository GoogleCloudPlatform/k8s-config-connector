...
func (c *dialogflowCXIntents) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DialogflowCXIntent, err error) {
	result = &v1alpha1.DialogflowCXIntent{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dialogflowCXIntents) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DialogflowCXIntentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DialogflowCXIntentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dialogflowcxintents").
...
func (c *dialogflowCXIntents) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dialogflowCXIntents) Create(ctx context.Context, dialogflowCXIntent *v1alpha1.DialogflowCXIntent, opts v1.CreateOptions) (result *v1alpha1.DialogflowCXIntent, err error) {
	result = &v1alpha1.DialogflowCXIntent{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dialogflowcxintents").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dialogflowCXIntent).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dialogflowCXIntents) Update(ctx context.Context, dialogflowCXIntent *v1alpha1.DialogflowCXIntent, opts v1.UpdateOptions) (result *v1alpha1.DialogflowCXIntent, err error) {
	result = &v1alpha1.DialogflowCXIntent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dialogflowcxintents").
		Name(dialogflowCXIntent.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dialogflowCXIntent).
		Do(ctx).
		Into(result)
...
func (c *dialogflowCXIntents) UpdateStatus(ctx context.Context, dialogflowCXIntent *v1alpha1.DialogflowCXIntent, opts v1.UpdateOptions) (result *v1alpha1.DialogflowCXIntent, err error) {
	result = &v1alpha1.DialogflowCXIntent{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dialogflowcxintents").
...
func (c *dialogflowCXIntents) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dialogflowCXIntents) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dialogflowCXIntents) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DialogflowCXIntent, err error) {
	result = &v1alpha1.DialogflowCXIntent{}
