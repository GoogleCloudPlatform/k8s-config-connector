...
// DialogflowCXFlowsGetter has a method to return a DialogflowCXFlowInterface.
...
// dialogflowCXFlows implements DialogflowCXFlowInterface
type dialogflowCXFlows struct {
	client rest.Interface
	ns     string
}

// newDialogflowCXFlows returns a DialogflowCXFlows
func newDialogflowCXFlows(c *DialogflowcxV1alpha1Client, namespace string) *dialogflowCXFlows {
	return &dialogflowCXFlows{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *dialogflowCXFlows) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DialogflowCXFlow, err error) {
	result = &v1alpha1.DialogflowCXFlow{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dialogflowcxflows").
		Name(name).
...
func (c *dialogflowCXFlows) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DialogflowCXFlowList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.DialogflowCXFlowList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dialogflowcxflows").
...
func (c *dialogflowCXFlows) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dialogflowCXFlows) Create(ctx context.Context, dialogflowCXFlow *v1alpha1.DialogflowCXFlow, opts v1.CreateOptions) (result *v1alpha1.DialogflowCXFlow, err error) {
	result = &v1alpha1.DialogflowCXFlow{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dialogflowcxflows").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dialogflowCXFlow).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dialogflowCXFlows) Update(ctx context.Context, dialogflowCXFlow *v1alpha1.DialogflowCXFlow, opts v1.UpdateOptions) (result *v1alpha1.DialogflowCXFlow, err error) {
	result = &v1alpha1.DialogflowCXFlow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dialogflowcxflows").
		Name(dialogflowCXFlow.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dialogflowCXFlow).
		Do(ctx).
		Into(result)
...
func (c *dialogflowCXFlows) UpdateStatus(ctx context.Context, dialogflowCXFlow *v1alpha1.DialogflowCXFlow, opts v1.UpdateOptions) (result *v1alpha1.DialogflowCXFlow, err error) {
	result = &v1alpha1.DialogflowCXFlow{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dialogflowcxflows").
...
func (c *dialogflowCXFlows) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dialogflowCXFlows) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dialogflowCXFlows) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DialogflowCXFlow, err error) {
	result = &v1alpha1.DialogflowCXFlow{}
