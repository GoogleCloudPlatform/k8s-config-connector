...
type AiplatformV1alpha1Interface interface {
	...
	VertexAIHyperparameterTuningJobsGetter
...
func (c *AiplatformV1alpha1Client) VertexAIHyperparameterTuningJobs(namespace string) VertexAIHyperparameterTuningJobInterface {
	return newVertexAIHyperparameterTuningJobs(c, namespace)
}
...
// NewForConfigAndClient creates a new AiplatformV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AiplatformV1alpha1Client, error) {
	...
	return &AiplatformV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new AiplatformV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *AiplatformV1alpha1Client {
...
// New creates a new AiplatformV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *AiplatformV1alpha1Client {
...
func (c *AiplatformV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
