...
import (
	v1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/client/clientset/versioned/typed/aiplatform/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeAiplatformV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeAiplatformV1alpha1) VertexAIExtensions(namespace string) v1alpha1.VertexAIExtensionInterface {
	return newFakeVertexAIExtensions(c, namespace)
}
...
func (c *FakeAiplatformV1alpha1) VertexAINotebookRuntimes(namespace string) v1alpha1.VertexAINotebookRuntimeInterface {
	return newFakeVertexAINotebookRuntimes(c, namespace)
}
