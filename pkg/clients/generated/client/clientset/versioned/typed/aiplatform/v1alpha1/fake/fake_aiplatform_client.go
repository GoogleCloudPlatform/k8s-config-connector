...
func (c *FakeAiplatformV1alpha1) AIPlatformPersistentResources(namespace string) v1alpha1.AIPlatformPersistentResourceInterface {
	return newFakeAIPlatformPersistentResources(c, namespace)
}
