...
func (c *ClouddeployV1alpha1Client) CloudDeployCustomTargetTypes(namespace string) CloudDeployCustomTargetTypeInterface {
	return newCloudDeployCustomTargetTypes(c, namespace)
}
...
// NewForConfig creates a new ClouddeployV1alpha1Client for the given config.
// NewForConfig is equivalent to NewForConfigAndClient(c, httpClient),
// where httpClient was generated with rest.HTTPClientFor(c).
func NewForConfig(c *rest.Config) (*ClouddeployV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new ClouddeployV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ClouddeployV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &ClouddeployV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ClouddeployV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ClouddeployV1alpha1Client {
...
// New creates a new ClouddeployV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *ClouddeployV1alpha1Client {
	return &ClouddeployV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := clouddeployv1alpha1.SchemeGroupVersion
...
func (c *ClouddeployV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
