...
type WorkflowsV1alpha1Interface interface {
	...
	WorkflowsWorkflowsGetter
}

// WorkflowsV1alpha1Client is used to interact with features provided by the workflows.cnrm.cloud.google.com group.
type WorkflowsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *WorkflowsV1alpha1Client) WorkflowsWorkflows(namespace string) WorkflowsWorkflowInterface {
	return newWorkflowsWorkflows(c, namespace)
}
...
// NewForConfigAndClient creates a new WorkflowsV1alpha1Client for the given config and http client.
...
func setConfigDefaults(config *rest.Config) {
	gv := workflowsv1alpha1.SchemeGroupVersion
