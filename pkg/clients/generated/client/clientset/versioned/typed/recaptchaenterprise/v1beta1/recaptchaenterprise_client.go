...
type RecaptchaenterpriseV1beta1Interface interface {
	RESTClient() rest.Interface
	RecaptchaEnterpriseKeysGetter
}
...
func (c *RecaptchaenterpriseV1beta1Client) RecaptchaEnterpriseKeys(namespace string) RecaptchaEnterpriseKeyInterface {
	return newRecaptchaEnterpriseKeys(c, namespace)
}
...
// NewForConfigAndClient creates a new RecaptchaenterpriseV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*RecaptchaenterpriseV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &RecaptchaenterpriseV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new RecaptchaenterpriseV1beta1Client for the given config and
...
func New(c rest.Interface) *RecaptchaenterpriseV1beta1Client {
	return &RecaptchaenterpriseV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := recaptchaenterprisev1beta1.SchemeGroupVersion
