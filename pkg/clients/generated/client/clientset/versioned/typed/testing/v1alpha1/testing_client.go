...
type TestingV1alpha1Interface interface {
	...
	TestingDeviceSessionsGetter
}

// TestingV1alpha1Client is used to interact with features provided by the testing.cnrm.cloud.google.com group.
type TestingV1alpha1Client struct {
	restClient rest.Interface
}

func (c *TestingV1alpha1Client) TestingDeviceSessions(namespace string) TestingDeviceSessionInterface {
	return newTestingDeviceSessions(c, namespace)
}
...
// NewForConfigAndClient creates a new TestingV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TestingV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := testingv1alpha1.SchemeGroupVersion
