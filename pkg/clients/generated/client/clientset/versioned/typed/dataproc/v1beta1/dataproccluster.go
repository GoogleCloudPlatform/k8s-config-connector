...
func (c *dataprocClusters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DataprocCluster, err error) {
	result = &v1beta1.DataprocCluster{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dataprocClusters) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DataprocClusterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DataprocClusterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dataprocclusters").
...
func (c *dataprocClusters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dataprocClusters) Create(ctx context.Context, dataprocCluster *v1beta1.DataprocCluster, opts v1.CreateOptions) (result *v1beta1.DataprocCluster, err error) {
	result = &v1beta1.DataprocCluster{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dataprocclusters").
...
func (c *dataprocClusters) Update(ctx context.Context, dataprocCluster *v1beta1.DataprocCluster, opts v1.UpdateOptions) (result *v1beta1.DataprocCluster, err error) {
	result = &v1beta1.DataprocCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataprocclusters").
...
func (c *dataprocClusters) UpdateStatus(ctx context.Context, dataprocCluster *v1beta1.DataprocCluster, opts v1.UpdateOptions) (result *v1beta1.DataprocCluster, err error) {
	result = &v1beta1.DataprocCluster{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dataprocclusters").
...
func (c *dataprocClusters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dataprocClusters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dataprocClusters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DataprocCluster, err error) {
	result = &v1beta1.DataprocCluster{}
