...
type DataprocV1beta1Interface interface {
	RESTClient() rest.Interface
	DataprocAutoscalingPoliciesGetter
	DataprocClustersGetter
	DataprocWorkflowTemplatesGetter
}
...
func (c *DataprocV1beta1Client) DataprocAutoscalingPolicies(namespace string) DataprocAutoscalingPolicyInterface {
	return newDataprocAutoscalingPolicies(c, namespace)
}
...
func (c *DataprocV1beta1Client) DataprocWorkflowTemplates(namespace string) DataprocWorkflowTemplateInterface {
	return newDataprocWorkflowTemplates(c, namespace)
}
...
// NewForConfigAndClient creates a new DataprocV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DataprocV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &DataprocV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new DataprocV1beta1Client for the given config and
...
func New(c rest.Interface) *DataprocV1beta1Client {
	return &DataprocV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := dataprocv1beta1.SchemeGroupVersion
