...
func (c *DataprocV1alpha1Client) DataprocBatches(namespace string) DataprocBatchInterface {
	return newDataprocBatches(c, namespace)
}

func (c *DataprocV1alpha1Client) DataprocJobs(namespace string) DataprocJobInterface {
	return newDataprocJobs(c, namespace)
}

func (c *DataprocV1alpha1Client) DataprocNodeGroups(namespace string) DataprocNodeGroupInterface {
	return newDataprocNodeGroups(c, namespace)
}
...
// NewForConfigAndClient creates a new DataprocV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DataprocV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := dataprocv1alpha1.SchemeGroupVersion
