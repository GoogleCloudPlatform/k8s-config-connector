...
// NewForConfigAndClient creates a new FirestoreV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*FirestoreV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &FirestoreV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new FirestoreV1beta1Client for the given config and
...
func New(c rest.Interface) *FirestoreV1beta1Client {
	return &FirestoreV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := firestorev1beta1.SchemeGroupVersion
