...
func (c *ManagedkafkaV1alpha1Client) ManagedKafkaConsumerGroups(namespace string) ManagedKafkaConsumerGroupInterface {
	return newManagedKafkaConsumerGroups(c, namespace)
}

// NewForConfig creates a new ManagedkafkaV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new ManagedkafkaV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ManagedkafkaV1alpha1Client, error) {
	...
	return &ManagedkafkaV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new ManagedkafkaV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *ManagedkafkaV1alpha1Client {
...
// New creates a new ManagedkafkaV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *ManagedkafkaV1alpha1Client {
...
func (c *ManagedkafkaV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
