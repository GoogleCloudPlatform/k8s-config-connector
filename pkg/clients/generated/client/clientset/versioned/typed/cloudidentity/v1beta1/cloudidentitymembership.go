...
// CloudIdentityMembershipsGetter has a method to return a CloudIdentityMembershipInterface.
...
// cloudIdentityMemberships implements CloudIdentityMembershipInterface
type cloudIdentityMemberships struct {
	client rest.Interface
	ns     string
}

// newCloudIdentityMemberships returns a CloudIdentityMemberships
func newCloudIdentityMemberships(c *CloudidentityV1beta1Client, namespace string) *cloudIdentityMemberships {
	return &cloudIdentityMemberships{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *cloudIdentityMemberships) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.CloudIdentityMembership, err error) {
	result = &v1beta1.CloudIdentityMembership{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cloudidentitymemberships").
		Name(name).
...
func (c *cloudIdentityMemberships) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.CloudIdentityMembershipList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.CloudIdentityMembershipList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cloudidentitymemberships").
...
func (c *cloudIdentityMemberships) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *cloudIdentityMemberships) Create(ctx context.Context, cloudIdentityMembership *v1beta1.CloudIdentityMembership, opts v1.CreateOptions) (result *v1beta1.CloudIdentityMembership, err error) {
	result = &v1beta1.CloudIdentityMembership{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cloudidentitymemberships").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cloudIdentityMembership).
		Do(ctx).
		Into(result)
	return
}
...
func (c *cloudIdentityMemberships) Update(ctx context.Context, cloudIdentityMembership *v1beta1.CloudIdentityMembership, opts v1.UpdateOptions) (result *v1beta1.CloudIdentityMembership, err error) {
	result = &v1beta1.CloudIdentityMembership{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudidentitymemberships").
		Name(cloudIdentityMembership.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(cloudIdentityMembership).
		Do(ctx).
		Into(result)
...
func (c *cloudIdentityMemberships) UpdateStatus(ctx context.Context, cloudIdentityMembership *v1beta1.CloudIdentityMembership, opts v1.UpdateOptions) (result *v1beta1.CloudIdentityMembership, err error) {
	result = &v1beta1.CloudIdentityMembership{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cloudidentitymemberships").
...
func (c *cloudIdentityMemberships) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *cloudIdentityMemberships) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *cloudIdentityMemberships) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.CloudIdentityMembership, err error) {
	result = &v1beta1.CloudIdentityMembership{}
