...
func (c *CloudidentityV1beta1Client) CloudIdentityDevices(namespace string) CloudIdentityDeviceInterface {
...
// NewForConfigAndClient creates a new CloudidentityV1beta1Client for the given config and http client.
...
func setConfigDefaults(config *rest.Config) {
	gv := cloudidentityv1beta1.SchemeGroupVersion
