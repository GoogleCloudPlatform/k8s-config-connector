...
var orgpolicycustomconstraintsResource = v1alpha1.SchemeGroupVersion.WithResource("orgpolicycustomconstraints")

var orgpolicycustomconstraintsKind = v1alpha1.SchemeGroupVersion.WithKind("OrgPolicyCustomConstraint")
