...
// NewForConfigAndClient creates a new StoragetransferV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*StoragetransferV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &StoragetransferV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new StoragetransferV1beta1Client for the given config and
...
func New(c rest.Interface) *StoragetransferV1beta1Client {
	return &StoragetransferV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := storagetransferv1beta1.SchemeGroupVersion
...
func (c *StoragetransferV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
