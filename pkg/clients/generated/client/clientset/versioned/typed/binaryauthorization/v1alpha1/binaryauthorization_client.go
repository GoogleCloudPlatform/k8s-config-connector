...
type BinaryauthorizationV1alpha1Interface interface {
	...
	BinaryAuthorizationPlatformPoliciesGetter
}

// BinaryauthorizationV1alpha1Client is used to interact with features provided by the binaryauthorization.cnrm.cloud.google.com group.
type BinaryauthorizationV1alpha1Client struct {
	restClient rest.Interface
}

func (c *BinaryauthorizationV1alpha1Client) BinaryAuthorizationPlatformPolicies(namespace string) BinaryAuthorizationPlatformPolicyInterface {
	return newBinaryAuthorizationPlatformPolicies(c, namespace)
}
...
// NewForConfigAndClient creates a new BinaryauthorizationV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BinaryauthorizationV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := binaryauthorizationv1alpha1.SchemeGroupVersion
