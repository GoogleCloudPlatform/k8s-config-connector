...
func (c *iAMAccessBoundaryPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMAccessBoundaryPolicy, err error) {
	result = &v1beta1.IAMAccessBoundaryPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamaccessboundarypolicies").
		Name(name).
...
func (c *iAMAccessBoundaryPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMAccessBoundaryPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMAccessBoundaryPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamaccessboundarypolicies").
...
func (c *iAMAccessBoundaryPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iAMAccessBoundaryPolicies) Create(ctx context.Context, iAMAccessBoundaryPolicy *v1beta1.IAMAccessBoundaryPolicy, opts v1.CreateOptions) (result *v1beta1.IAMAccessBoundaryPolicy, err error) {
	result = &v1beta1.IAMAccessBoundaryPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamaccessboundarypolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMAccessBoundaryPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *iAMAccessBoundaryPolicies) Update(ctx context.Context, iAMAccessBoundaryPolicy *v1beta1.IAMAccessBoundaryPolicy, opts v1.UpdateOptions) (result *v1beta1.IAMAccessBoundaryPolicy, err error) {
	result = &v1beta1.IAMAccessBoundaryPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccessboundarypolicies").
		Name(iAMAccessBoundaryPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMAccessBoundaryPolicy).
		Do(ctx).
		Into(result)
...
func (c *iAMAccessBoundaryPolicies) UpdateStatus(ctx context.Context, iAMAccessBoundaryPolicy *v1beta1.IAMAccessBoundaryPolicy, opts v1.UpdateOptions) (result *v1beta1.IAMAccessBoundaryPolicy, err error) {
	result = &v1beta1.IAMAccessBoundaryPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamaccessboundarypolicies").
...
func (c *iAMAccessBoundaryPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iAMAccessBoundaryPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iAMAccessBoundaryPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMAccessBoundaryPolicy, err error) {
	result = &v1beta1.IAMAccessBoundaryPolicy{}
