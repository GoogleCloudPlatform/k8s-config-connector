...
var iamauditconfigsResource = v1beta1.SchemeGroupVersion.WithResource("iamauditconfigs")

var iamauditconfigsKind = v1beta1.SchemeGroupVersion.WithKind("IAMAuditConfig")
