...
func (c *iAMAuditConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMAuditConfig, err error) {
	result = &v1beta1.IAMAuditConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *iAMAuditConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMAuditConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMAuditConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamauditconfigs").
...
func (c *iAMAuditConfigs) Create(ctx context.Context, iAMAuditConfig *v1beta1.IAMAuditConfig, opts v1.CreateOptions) (result *v1beta1.IAMAuditConfig, err error) {
	result = &v1beta1.IAMAuditConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamauditconfigs").
...
func (c *iAMAuditConfigs) Update(ctx context.Context, iAMAuditConfig *v1beta1.IAMAuditConfig, opts v1.UpdateOptions) (result *v1beta1.IAMAuditConfig, err error) {
	result = &v1beta1.IAMAuditConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamauditconfigs").
...
func (c *iAMAuditConfigs) UpdateStatus(ctx context.Context, iAMAuditConfig *v1beta1.IAMAuditConfig, opts v1.UpdateOptions) (result *v1beta1.IAMAuditConfig, err error) {
	result = &v1beta1.IAMAuditConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamauditconfigs").
...
func (c *iAMAuditConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMAuditConfig, err error) {
	result = &v1beta1.IAMAuditConfig{}
