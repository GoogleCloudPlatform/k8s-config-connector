...
func (c *iAMPartialPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMPartialPolicy, err error) {
	result = &v1beta1.IAMPartialPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iampartialpolicies").
		Name(name).
...
func (c *iAMPartialPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMPartialPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMPartialPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iampartialpolicies").
...
func (c *iAMPartialPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iAMPartialPolicies) Create(ctx context.Context, iAMPartialPolicy *v1beta1.IAMPartialPolicy, opts v1.CreateOptions) (result *v1beta1.IAMPartialPolicy, err error) {
	result = &v1beta1.IAMPartialPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iampartialpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMPartialPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *iAMPartialPolicies) Update(ctx context.Context, iAMPartialPolicy *v1beta1.IAMPartialPolicy, opts v1.UpdateOptions) (result *v1beta1.IAMPartialPolicy, err error) {
	result = &v1beta1.IAMPartialPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iampartialpolicies").
		Name(iAMPartialPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMPartialPolicy).
		Do(ctx).
		Into(result)
...
func (c *iAMPartialPolicies) UpdateStatus(ctx context.Context, iAMPartialPolicy *v1beta1.IAMPartialPolicy, opts v1.UpdateOptions) (result *v1beta1.IAMPartialPolicy, err error) {
	result = &v1beta1.IAMPartialPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iampartialpolicies").
...
func (c *iAMPartialPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iAMPartialPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iAMPartialPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMPartialPolicy, err error) {
	result = &v1beta1.IAMPartialPolicy{}
