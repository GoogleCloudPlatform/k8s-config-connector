...
func (c *iAMServiceAccounts) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMServiceAccount, err error) {
	result = &v1beta1.IAMServiceAccount{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *iAMServiceAccounts) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMServiceAccountList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMServiceAccountList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamserviceaccounts").
...
func (c *iAMServiceAccounts) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iAMServiceAccounts) Create(ctx context.Context, iAMServiceAccount *v1beta1.IAMServiceAccount, opts v1.CreateOptions) (result *v1beta1.IAMServiceAccount, err error) {
	result = &v1beta1.IAMServiceAccount{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamserviceaccounts").
...
func (c *iAMServiceAccounts) Update(ctx context.Context, iAMServiceAccount *v1beta1.IAMServiceAccount, opts v1.UpdateOptions) (result *v1beta1.IAMServiceAccount, err error) {
	result = &v1beta1.IAMServiceAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamserviceaccounts").
...
func (c *iAMServiceAccounts) UpdateStatus(ctx context.Context, iAMServiceAccount *v1beta1.IAMServiceAccount, opts v1.UpdateOptions) (result *v1beta1.IAMServiceAccount, err error) {
	result = &v1beta1.IAMServiceAccount{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamserviceaccounts").
...
func (c *iAMServiceAccounts) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iAMServiceAccounts) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iAMServiceAccounts) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMServiceAccount, err error) {
	result = &v1beta1.IAMServiceAccount{}
