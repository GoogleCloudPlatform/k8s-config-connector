...
// IAMWorkloadIdentityPoolsGetter has a method to return a IAMWorkloadIdentityPoolInterface.
...
// iAMWorkloadIdentityPools implements IAMWorkloadIdentityPoolInterface
type iAMWorkloadIdentityPools struct {
	client rest.Interface
	ns     string
}

// newIAMWorkloadIdentityPools returns a IAMWorkloadIdentityPools
func newIAMWorkloadIdentityPools(c *IamV1beta1Client, namespace string) *iAMWorkloadIdentityPools {
	return &iAMWorkloadIdentityPools{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *iAMWorkloadIdentityPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMWorkloadIdentityPool, err error) {
	result = &v1beta1.IAMWorkloadIdentityPool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamworkloadidentitypools").
		Name(name).
...
func (c *iAMWorkloadIdentityPools) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMWorkloadIdentityPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMWorkloadIdentityPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamworkloadidentitypools").
...
func (c *iAMWorkloadIdentityPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iAMWorkloadIdentityPools) Create(ctx context.Context, iAMWorkloadIdentityPool *v1beta1.IAMWorkloadIdentityPool, opts v1.CreateOptions) (result *v1beta1.IAMWorkloadIdentityPool, err error) {
	result = &v1beta1.IAMWorkloadIdentityPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamworkloadidentitypools").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMWorkloadIdentityPool).
		Do(ctx).
		Into(result)
	return
}
...
func (c *iAMWorkloadIdentityPools) Update(ctx context.Context, iAMWorkloadIdentityPool *v1beta1.IAMWorkloadIdentityPool, opts v1.UpdateOptions) (result *v1beta1.IAMWorkloadIdentityPool, err error) {
	result = &v1beta1.IAMWorkloadIdentityPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamworkloadidentitypools").
		Name(iAMWorkloadIdentityPool.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMWorkloadIdentityPool).
		Do(ctx).
		Into(result)
...
func (c *iAMWorkloadIdentityPools) UpdateStatus(ctx context.Context, iAMWorkloadIdentityPool *v1beta1.IAMWorkloadIdentityPool, opts v1.UpdateOptions) (result *v1beta1.IAMWorkloadIdentityPool, err error) {
	result = &v1beta1.IAMWorkloadIdentityPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamworkloadidentitypools").
...
func (c *iAMWorkloadIdentityPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iAMWorkloadIdentityPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iAMWorkloadIdentityPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMWorkloadIdentityPool, err error) {
	result = &v1beta1.IAMWorkloadIdentityPool{}
