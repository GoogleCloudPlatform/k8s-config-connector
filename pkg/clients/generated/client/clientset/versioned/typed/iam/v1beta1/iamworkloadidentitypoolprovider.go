...
func (c *iAMWorkloadIdentityPoolProviders) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMWorkloadIdentityPoolProvider, err error) {
	result = &v1beta1.IAMWorkloadIdentityPoolProvider{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamworkloadidentitypoolproviders").
		Name(name).
...
func (c *iAMWorkloadIdentityPoolProviders) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMWorkloadIdentityPoolProviderList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMWorkloadIdentityPoolProviderList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamworkloadidentitypoolproviders").
...
func (c *iAMWorkloadIdentityPoolProviders) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iAMWorkloadIdentityPoolProviders) Create(ctx context.Context, iAMWorkloadIdentityPoolProvider *v1beta1.IAMWorkloadIdentityPoolProvider, opts v1.CreateOptions) (result *v1beta1.IAMWorkloadIdentityPoolProvider, err error) {
	result = &v1beta1.IAMWorkloadIdentityPoolProvider{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamworkloadidentitypoolproviders").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMWorkloadIdentityPoolProvider).
		Do(ctx).
		Into(result)
	return
}
...
func (c *iAMWorkloadIdentityPoolProviders) Update(ctx context.Context, iAMWorkloadIdentityPoolProvider *v1beta1.IAMWorkloadIdentityPoolProvider, opts v1.UpdateOptions) (result *v1beta1.IAMWorkloadIdentityPoolProvider, err error) {
	result = &v1beta1.IAMWorkloadIdentityPoolProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamworkloadidentitypoolproviders").
		Name(iAMWorkloadIdentityPoolProvider.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMWorkloadIdentityPoolProvider).
		Do(ctx).
		Into(result)
...
func (c *iAMWorkloadIdentityPoolProviders) UpdateStatus(ctx context.Context, iAMWorkloadIdentityPoolProvider *v1beta1.IAMWorkloadIdentityPoolProvider, opts v1.UpdateOptions) (result *v1beta1.IAMWorkloadIdentityPoolProvider, err error) {
	result = &v1beta1.IAMWorkloadIdentityPoolProvider{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamworkloadidentitypoolproviders").
...
func (c *iAMWorkloadIdentityPoolProviders) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iAMWorkloadIdentityPoolProviders) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iAMWorkloadIdentityPoolProviders) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMWorkloadIdentityPoolProvider, err error) {
	result = &v1beta1.IAMWorkloadIdentityPoolProvider{}
