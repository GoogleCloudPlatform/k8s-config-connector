...
func (c *iAMWorkforcePools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMWorkforcePool, err error) {
	result = &v1beta1.IAMWorkforcePool{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamworkforcepools").
		Name(name).
...
func (c *iAMWorkforcePools) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMWorkforcePoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMWorkforcePoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamworkforcepools").
...
func (c *iAMWorkforcePools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *iAMWorkforcePools) Create(ctx context.Context, iAMWorkforcePool *v1beta1.IAMWorkforcePool, opts v1.CreateOptions) (result *v1beta1.IAMWorkforcePool, err error) {
	result = &v1beta1.IAMWorkforcePool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamworkforcepools").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMWorkforcePool).
		Do(ctx).
		Into(result)
	return
}
...
func (c *iAMWorkforcePools) Update(ctx context.Context, iAMWorkforcePool *v1beta1.IAMWorkforcePool, opts v1.UpdateOptions) (result *v1beta1.IAMWorkforcePool, err error) {
	result = &v1beta1.IAMWorkforcePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamworkforcepools").
		Name(iAMWorkforcePool.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(iAMWorkforcePool).
		Do(ctx).
		Into(result)
...
func (c *iAMWorkforcePools) UpdateStatus(ctx context.Context, iAMWorkforcePool *v1beta1.IAMWorkforcePool, opts v1.UpdateOptions) (result *v1beta1.IAMWorkforcePool, err error) {
	result = &v1beta1.IAMWorkforcePool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamworkforcepools").
...
func (c *iAMWorkforcePools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *iAMWorkforcePools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *iAMWorkforcePools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMWorkforcePool, err error) {
	result = &v1beta1.IAMWorkforcePool{}
