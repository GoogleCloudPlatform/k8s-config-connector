...
import (
	v1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/client/clientset/versioned/typed/dataplex/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeDataplexV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeDataplexV1alpha1) DataplexMetadataFeeds(namespace string) v1alpha1.DataplexMetadataFeedInterface {
	return newFakeDataplexMetadataFeeds(c, namespace)
}
...
func (c *FakeDataplexV1alpha1) RESTClient() rest.Interface {
