...
func (c *DataplexV1alpha1Client) DataplexMetadataFeeds(namespace string) DataplexMetadataFeedInterface {
	return newDataplexMetadataFeeds(c, namespace)
}

func (c *DataplexV1alpha1Client) DataplexTasks(namespace string) DataplexTaskInterface {
	return newDataplexTasks(c, namespace)
}

func (c *DataplexV1alpha1Client) DataplexZones(namespace string) DataplexZoneInterface {
	return newDataplexZones(c, namespace)
}

// NewForConfig creates a new DataplexV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new DataplexV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DataplexV1alpha1Client, error) {
	...
	return &DataplexV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new DataplexV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *DataplexV1alpha1Client {
...
// New creates a new DataplexV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *DataplexV1alpha1Client {
...
func (c *DataplexV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
