...
// NewForConfigAndClient creates a new GkehubV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*GkehubV1alpha1Client, error) {
	...
	return &GkehubV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new GkehubV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *GkehubV1alpha1Client {
...
// New creates a new GkehubV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *GkehubV1alpha1Client {
...
func (c *GkehubV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
