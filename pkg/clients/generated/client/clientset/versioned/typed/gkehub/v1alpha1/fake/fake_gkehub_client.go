...
import (
	v1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/client/clientset/versioned/typed/gkehub/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeGkehubV1alpha1 struct {
	*testing.Fake
}

func (c *FakeGkehubV1alpha1) GKEHubFleets(namespace string) v1alpha1.GKEHubFleetInterface {
	return newFakeGKEHubFleets(c, namespace)
}
