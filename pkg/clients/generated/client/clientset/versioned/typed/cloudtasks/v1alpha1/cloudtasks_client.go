...
// NewForConfigAndClient creates a new CloudtasksV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CloudtasksV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &CloudtasksV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CloudtasksV1alpha1Client for the given config and
...
func New(c rest.Interface) *CloudtasksV1alpha1Client {
	return &CloudtasksV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := cloudtasksv1alpha1.SchemeGroupVersion
