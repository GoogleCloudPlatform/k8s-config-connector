...
func (c *computeInterconnectAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeInterconnectAttachment, err error) {
	result = &v1beta1.ComputeInterconnectAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeInterconnectAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeInterconnectAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeInterconnectAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeinterconnectattachments").
...
func (c *computeInterconnectAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeInterconnectAttachments) Create(ctx context.Context, computeInterconnectAttachment *v1beta1.ComputeInterconnectAttachment, opts v1.CreateOptions) (result *v1beta1.ComputeInterconnectAttachment, err error) {
	result = &v1beta1.ComputeInterconnectAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeinterconnectattachments").
...
func (c *computeInterconnectAttachments) Update(ctx context.Context, computeInterconnectAttachment *v1beta1.ComputeInterconnectAttachment, opts v1.UpdateOptions) (result *v1beta1.ComputeInterconnectAttachment, err error) {
	result = &v1beta1.ComputeInterconnectAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinterconnectattachments").
...
func (c *computeInterconnectAttachments) UpdateStatus(ctx context.Context, computeInterconnectAttachment *v1beta1.ComputeInterconnectAttachment, opts v1.UpdateOptions) (result *v1beta1.ComputeInterconnectAttachment, err error) {
	result = &v1beta1.ComputeInterconnectAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinterconnectattachments").
...
func (c *computeInterconnectAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeInterconnectAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeInterconnectAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeInterconnectAttachment, err error) {
	result = &v1beta1.ComputeInterconnectAttachment{}
