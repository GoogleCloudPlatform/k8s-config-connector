...
func newComputeRouterInterfaces(c *ComputeV1beta1Client, namespace string) *computeRouterInterfaces {
...
func (c *computeRouterInterfaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeRouterInterface, err error) {
	result = &v1beta1.ComputeRouterInterface{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeRouterInterfaces) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeRouterInterfaceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeRouterInterfaceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computerouterinterfaces").
...
func (c *computeRouterInterfaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeRouterInterfaces) Create(ctx context.Context, computeRouterInterface *v1beta1.ComputeRouterInterface, opts v1.CreateOptions) (result *v1beta1.ComputeRouterInterface, err error) {
	result = &v1beta1.ComputeRouterInterface{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computerouterinterfaces").
...
func (c *computeRouterInterfaces) Update(ctx context.Context, computeRouterInterface *v1beta1.ComputeRouterInterface, opts v1.UpdateOptions) (result *v1beta1.ComputeRouterInterface, err error) {
	result = &v1beta1.ComputeRouterInterface{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouterinterfaces").
...
func (c *computeRouterInterfaces) UpdateStatus(ctx context.Context, computeRouterInterface *v1beta1.ComputeRouterInterface, opts v1.UpdateOptions) (result *v1beta1.ComputeRouterInterface, err error) {
	result = &v1beta1.ComputeRouterInterface{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouterinterfaces").
...
func (c *computeRouterInterfaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeRouterInterfaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeRouterInterfaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeRouterInterface, err error) {
	result = &v1beta1.ComputeRouterInterface{}
