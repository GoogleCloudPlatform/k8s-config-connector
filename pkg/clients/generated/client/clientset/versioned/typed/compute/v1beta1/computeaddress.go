...
func (c *computeAddresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeAddress, err error) {
	result = &v1beta1.ComputeAddress{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeAddresses) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeAddressList, err error) {
...
func (c *computeAddresses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeAddresses) Create(ctx context.Context, computeAddress *v1beta1.ComputeAddress, opts v1.CreateOptions) (result *v1beta1.ComputeAddress, err error) {
	result = &v1beta1.ComputeAddress{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeaddresses").
...
func (c *computeAddresses) Update(ctx context.Context, computeAddress *v1beta1.ComputeAddress, opts v1.UpdateOptions) (result *v1beta1.ComputeAddress, err error) {
	result = &v1beta1.ComputeAddress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeaddresses").
...
func (c *computeAddresses) UpdateStatus(ctx context.Context, computeAddress *v1beta1.ComputeAddress, opts v1.UpdateOptions) (result *v1beta1.ComputeAddress, err error) {
	result = &v1beta1.ComputeAddress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeaddresses").
...
func (c *computeAddresses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeAddresses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeAddresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeAddress, err error) {
	result = &v1beta1.ComputeAddress{}
