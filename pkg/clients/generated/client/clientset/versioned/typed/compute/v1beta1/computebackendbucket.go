...
func newComputeBackendBuckets(c *ComputeV1beta1Client, namespace string) *computeBackendBuckets {
...
func (c *computeBackendBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeBackendBucket, err error) {
	result = &v1beta1.ComputeBackendBucket{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeBackendBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeBackendBucketList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeBackendBucketList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computebackendbuckets").
...
func (c *computeBackendBuckets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeBackendBuckets) Create(ctx context.Context, computeBackendBucket *v1beta1.ComputeBackendBucket, opts v1.CreateOptions) (result *v1beta1.ComputeBackendBucket, err error) {
	result = &v1beta1.ComputeBackendBucket{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computebackendbuckets").
...
func (c *computeBackendBuckets) Update(ctx context.Context, computeBackendBucket *v1beta1.ComputeBackendBucket, opts v1.UpdateOptions) (result *v1beta1.ComputeBackendBucket, err error) {
	result = &v1beta1.ComputeBackendBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computebackendbuckets").
...
func (c *computeBackendBuckets) UpdateStatus(ctx context.Context, computeBackendBucket *v1beta1.ComputeBackendBucket, opts v1.UpdateOptions) (result *v1beta1.ComputeBackendBucket, err error) {
	result = &v1beta1.ComputeBackendBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computebackendbuckets").
...
func (c *computeBackendBuckets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeBackendBuckets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeBackendBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeBackendBucket, err error) {
	result = &v1beta1.ComputeBackendBucket{}
