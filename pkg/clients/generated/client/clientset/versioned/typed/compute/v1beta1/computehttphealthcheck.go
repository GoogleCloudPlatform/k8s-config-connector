...
func (c *computeHTTPHealthChecks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeHTTPHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPHealthCheck{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeHTTPHealthChecks) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeHTTPHealthCheckList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeHTTPHealthCheckList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computehttphealthchecks").
...
func (c *computeHTTPHealthChecks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeHTTPHealthChecks) Create(ctx context.Context, computeHTTPHealthCheck *v1beta1.ComputeHTTPHealthCheck, opts v1.CreateOptions) (result *v1beta1.ComputeHTTPHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPHealthCheck{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computehttphealthchecks").
...
func (c *computeHTTPHealthChecks) Update(ctx context.Context, computeHTTPHealthCheck *v1beta1.ComputeHTTPHealthCheck, opts v1.UpdateOptions) (result *v1beta1.ComputeHTTPHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehttphealthchecks").
...
func (c *computeHTTPHealthChecks) UpdateStatus(ctx context.Context, computeHTTPHealthCheck *v1beta1.ComputeHTTPHealthCheck, opts v1.UpdateOptions) (result *v1beta1.ComputeHTTPHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehttphealthchecks").
...
func (c *computeHTTPHealthChecks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeHTTPHealthChecks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeHTTPHealthChecks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeHTTPHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPHealthCheck{}
