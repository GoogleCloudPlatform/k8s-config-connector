...
func (c *computeSharedVPCServiceProjects) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeSharedVPCServiceProject, err error) {
	result = &v1beta1.ComputeSharedVPCServiceProject{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeSharedVPCServiceProjects) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeSharedVPCServiceProjectList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeSharedVPCServiceProjectList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computesharedvpcserviceprojects").
...
func (c *computeSharedVPCServiceProjects) Create(ctx context.Context, computeSharedVPCServiceProject *v1beta1.ComputeSharedVPCServiceProject, opts v1.CreateOptions) (result *v1beta1.ComputeSharedVPCServiceProject, err error) {
	result = &v1beta1.ComputeSharedVPCServiceProject{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computesharedvpcserviceprojects").
...
func (c *computeSharedVPCServiceProjects) Update(ctx context.Context, computeSharedVPCServiceProject *v1beta1.ComputeSharedVPCServiceProject, opts v1.UpdateOptions) (result *v1beta1.ComputeSharedVPCServiceProject, err error) {
	result = &v1beta1.ComputeSharedVPCServiceProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesharedvpcserviceprojects").
...
func (c *computeSharedVPCServiceProjects) UpdateStatus(ctx context.Context, computeSharedVPCServiceProject *v1beta1.ComputeSharedVPCServiceProject, opts v1.UpdateOptions) (result *v1beta1.ComputeSharedVPCServiceProject, err error) {
	result = &v1beta1.ComputeSharedVPCServiceProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesharedvpcserviceprojects").
...
func (c *computeSharedVPCServiceProjects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeSharedVPCServiceProject, err error) {
	result = &v1beta1.ComputeSharedVPCServiceProject{}
