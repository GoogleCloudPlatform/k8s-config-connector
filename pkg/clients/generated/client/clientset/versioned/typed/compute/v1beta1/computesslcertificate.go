...
func (c *computeSSLCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeSSLCertificate, err error) {
	result = &v1beta1.ComputeSSLCertificate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeSSLCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeSSLCertificateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeSSLCertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computesslcertificates").
...
func (c *computeSSLCertificates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeSSLCertificates) Create(ctx context.Context, computeSSLCertificate *v1beta1.ComputeSSLCertificate, opts v1.CreateOptions) (result *v1beta1.ComputeSSLCertificate, err error) {
	result = &v1beta1.ComputeSSLCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computesslcertificates").
...
func (c *computeSSLCertificates) Update(ctx context.Context, computeSSLCertificate *v1beta1.ComputeSSLCertificate, opts v1.UpdateOptions) (result *v1beta1.ComputeSSLCertificate, err error) {
	result = &v1beta1.ComputeSSLCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesslcertificates").
...
func (c *computeSSLCertificates) UpdateStatus(ctx context.Context, computeSSLCertificate *v1beta1.ComputeSSLCertificate, opts v1.UpdateOptions) (result *v1beta1.ComputeSSLCertificate, err error) {
	result = &v1beta1.ComputeSSLCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesslcertificates").
...
func (c *computeSSLCertificates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeSSLCertificates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeSSLCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeSSLCertificate, err error) {
	result = &v1beta1.ComputeSSLCertificate{}
