...
func (c *computeGlobalNetworkEndpoints) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeGlobalNetworkEndpoint, err error) {
	result = &v1alpha1.ComputeGlobalNetworkEndpoint{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeglobalnetworkendpoints").
		Name(name).
...
func (c *computeGlobalNetworkEndpoints) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeGlobalNetworkEndpointList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ComputeGlobalNetworkEndpointList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeglobalnetworkendpoints").
...
func (c *computeGlobalNetworkEndpoints) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeGlobalNetworkEndpoints) Create(ctx context.Context, computeGlobalNetworkEndpoint *v1alpha1.ComputeGlobalNetworkEndpoint, opts v1.CreateOptions) (result *v1alpha1.ComputeGlobalNetworkEndpoint, err error) {
	result = &v1alpha1.ComputeGlobalNetworkEndpoint{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeglobalnetworkendpoints").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeGlobalNetworkEndpoint).
		Do(ctx).
		Into(result)
	return
}
...
func (c *computeGlobalNetworkEndpoints) Update(ctx context.Context, computeGlobalNetworkEndpoint *v1alpha1.ComputeGlobalNetworkEndpoint, opts v1.UpdateOptions) (result *v1alpha1.ComputeGlobalNetworkEndpoint, err error) {
	result = &v1alpha1.ComputeGlobalNetworkEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeglobalnetworkendpoints").
		Name(computeGlobalNetworkEndpoint.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeGlobalNetworkEndpoint).
		Do(ctx).
		Into(result)
...
func (c *computeGlobalNetworkEndpoints) UpdateStatus(ctx context.Context, computeGlobalNetworkEndpoint *v1alpha1.ComputeGlobalNetworkEndpoint, opts v1.UpdateOptions) (result *v1alpha1.ComputeGlobalNetworkEndpoint, err error) {
	result = &v1alpha1.ComputeGlobalNetworkEndpoint{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeglobalnetworkendpoints").
...
func (c *computeGlobalNetworkEndpoints) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeGlobalNetworkEndpoints) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeGlobalNetworkEndpoints) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeGlobalNetworkEndpoint, err error) {
	result = &v1alpha1.ComputeGlobalNetworkEndpoint{}
