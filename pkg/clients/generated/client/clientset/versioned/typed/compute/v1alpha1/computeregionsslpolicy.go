...
func (c *computeRegionSSLPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeRegionSSLPolicy, err error) {
	result = &v1alpha1.ComputeRegionSSLPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeRegionSSLPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeRegionSSLPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ComputeRegionSSLPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeregionsslpolicies").
...
func (c *computeRegionSSLPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeRegionSSLPolicies) Create(ctx context.Context, computeRegionSSLPolicy *v1alpha1.ComputeRegionSSLPolicy, opts v1.CreateOptions) (result *v1alpha1.ComputeRegionSSLPolicy, err error) {
	result = &v1alpha1.ComputeRegionSSLPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeregionsslpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeRegionSSLPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *computeRegionSSLPolicies) Update(ctx context.Context, computeRegionSSLPolicy *v1alpha1.ComputeRegionSSLPolicy, opts v1.UpdateOptions) (result *v1alpha1.ComputeRegionSSLPolicy, err error) {
	result = &v1alpha1.ComputeRegionSSLPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeregionsslpolicies").
...
func (c *computeRegionSSLPolicies) UpdateStatus(ctx context.Context, computeRegionSSLPolicy *v1alpha1.ComputeRegionSSLPolicy, opts v1.UpdateOptions) (result *v1alpha1.ComputeRegionSSLPolicy, err error) {
	result = &v1alpha1.ComputeRegionSSLPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeregionsslpolicies").
...
func (c *computeRegionSSLPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeRegionSSLPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeRegionSSLPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeRegionSSLPolicy, err error) {
	result = &v1alpha1.ComputeRegionSSLPolicy{}
