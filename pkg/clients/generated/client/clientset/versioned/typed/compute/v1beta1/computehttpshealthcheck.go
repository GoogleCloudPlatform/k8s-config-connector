...
func (c *computeHTTPSHealthChecks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeHTTPSHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPSHealthCheck{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeHTTPSHealthChecks) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeHTTPSHealthCheckList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeHTTPSHealthCheckList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computehttpshealthchecks").
...
func (c *computeHTTPSHealthChecks) Create(ctx context.Context, computeHTTPSHealthCheck *v1beta1.ComputeHTTPSHealthCheck, opts v1.CreateOptions) (result *v1beta1.ComputeHTTPSHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPSHealthCheck{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computehttpshealthchecks").
...
func (c *computeHTTPSHealthChecks) Update(ctx context.Context, computeHTTPSHealthCheck *v1beta1.ComputeHTTPSHealthCheck, opts v1.UpdateOptions) (result *v1beta1.ComputeHTTPSHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPSHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehttpshealthchecks").
...
func (c *computeHTTPSHealthChecks) UpdateStatus(ctx context.Context, computeHTTPSHealthCheck *v1beta1.ComputeHTTPSHealthCheck, opts v1.UpdateOptions) (result *v1beta1.ComputeHTTPSHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPSHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehttpshealthchecks").
...
func (c *computeHTTPSHealthChecks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeHTTPSHealthCheck, err error) {
	result = &v1beta1.ComputeHTTPSHealthCheck{}
