...
func newComputeNodeTemplates(c *ComputeV1beta1Client, namespace string) *computeNodeTemplates {
...
func (c *computeNodeTemplates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeNodeTemplate, err error) {
	result = &v1beta1.ComputeNodeTemplate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeNodeTemplates) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeNodeTemplateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeNodeTemplateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computenodetemplates").
...
func (c *computeNodeTemplates) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeNodeTemplates) Create(ctx context.Context, computeNodeTemplate *v1beta1.ComputeNodeTemplate, opts v1.CreateOptions) (result *v1beta1.ComputeNodeTemplate, err error) {
	result = &v1beta1.ComputeNodeTemplate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computenodetemplates").
...
func (c *computeNodeTemplates) Update(ctx context.Context, computeNodeTemplate *v1beta1.ComputeNodeTemplate, opts v1.UpdateOptions) (result *v1beta1.ComputeNodeTemplate, err error) {
	result = &v1beta1.ComputeNodeTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodetemplates").
...
func (c *computeNodeTemplates) UpdateStatus(ctx context.Context, computeNodeTemplate *v1beta1.ComputeNodeTemplate, opts v1.UpdateOptions) (result *v1beta1.ComputeNodeTemplate, err error) {
	result = &v1beta1.ComputeNodeTemplate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodetemplates").
...
func (c *computeNodeTemplates) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeNodeTemplates) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeNodeTemplates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeNodeTemplate, err error) {
	result = &v1beta1.ComputeNodeTemplate{}
