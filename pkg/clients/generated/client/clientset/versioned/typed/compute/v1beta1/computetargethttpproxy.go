...
func (c *computeTargetHTTPProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeTargetHTTPProxy, err error) {
	result = &v1beta1.ComputeTargetHTTPProxy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeTargetHTTPProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeTargetHTTPProxyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeTargetHTTPProxyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computetargethttpproxies").
...
func (c *computeTargetHTTPProxies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeTargetHTTPProxies) Create(ctx context.Context, computeTargetHTTPProxy *v1beta1.ComputeTargetHTTPProxy, opts v1.CreateOptions) (result *v1beta1.ComputeTargetHTTPProxy, err error) {
	result = &v1beta1.ComputeTargetHTTPProxy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargethttpproxies").
...
func (c *computeTargetHTTPProxies) Update(ctx context.Context, computeTargetHTTPProxy *v1beta1.ComputeTargetHTTPProxy, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetHTTPProxy, err error) {
	result = &v1beta1.ComputeTargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargethttpproxies").
...
func (c *computeTargetHTTPProxies) UpdateStatus(ctx context.Context, computeTargetHTTPProxy *v1beta1.ComputeTargetHTTPProxy, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetHTTPProxy, err error) {
	result = &v1beta1.ComputeTargetHTTPProxy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargethttpproxies").
...
func (c *computeTargetHTTPProxies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeTargetHTTPProxies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeTargetHTTPProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeTargetHTTPProxy, err error) {
	result = &v1beta1.ComputeTargetHTTPProxy{}
