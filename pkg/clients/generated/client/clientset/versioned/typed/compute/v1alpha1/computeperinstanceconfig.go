...
func (c *computePerInstanceConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputePerInstanceConfig, err error) {
	result = &v1alpha1.ComputePerInstanceConfig{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeperinstanceconfigs").
		Name(name).
...
func (c *computePerInstanceConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputePerInstanceConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ComputePerInstanceConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeperinstanceconfigs").
...
func (c *computePerInstanceConfigs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computePerInstanceConfigs) Create(ctx context.Context, computePerInstanceConfig *v1alpha1.ComputePerInstanceConfig, opts v1.CreateOptions) (result *v1alpha1.ComputePerInstanceConfig, err error) {
	result = &v1alpha1.ComputePerInstanceConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeperinstanceconfigs").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computePerInstanceConfig).
		Do(ctx).
		Into(result)
	return
}
...
func (c *computePerInstanceConfigs) Update(ctx context.Context, computePerInstanceConfig *v1alpha1.ComputePerInstanceConfig, opts v1.UpdateOptions) (result *v1alpha1.ComputePerInstanceConfig, err error) {
	result = &v1alpha1.ComputePerInstanceConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeperinstanceconfigs").
		Name(computePerInstanceConfig.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computePerInstanceConfig).
		Do(ctx).
		Into(result)
...
func (c *computePerInstanceConfigs) UpdateStatus(ctx context.Context, computePerInstanceConfig *v1alpha1.ComputePerInstanceConfig, opts v1.UpdateOptions) (result *v1alpha1.ComputePerInstanceConfig, err error) {
	result = &v1alpha1.ComputePerInstanceConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeperinstanceconfigs").
...
func (c *computePerInstanceConfigs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computePerInstanceConfigs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computePerInstanceConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputePerInstanceConfig, err error) {
	result = &v1alpha1.ComputePerInstanceConfig{}
