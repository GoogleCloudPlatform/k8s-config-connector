...
func (c *computeRouters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeRouter, err error) {
	result = &v1beta1.ComputeRouter{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeRouters) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeRouterList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeRouterList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computerouters").
...
func (c *computeRouters) Create(ctx context.Context, computeRouter *v1beta1.ComputeRouter, opts v1.CreateOptions) (result *v1beta1.ComputeRouter, err error) {
	result = &v1beta1.ComputeRouter{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computerouters").
...
func (c *computeRouters) Update(ctx context.Context, computeRouter *v1beta1.ComputeRouter, opts v1.UpdateOptions) (result *v1beta1.ComputeRouter, err error) {
	result = &v1beta1.ComputeRouter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouters").
...
func (c *computeRouters) UpdateStatus(ctx context.Context, computeRouter *v1beta1.ComputeRouter, opts v1.UpdateOptions) (result *v1beta1.ComputeRouter, err error) {
	result = &v1beta1.ComputeRouter{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computerouters").
...
func (c *computeRouters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeRouter, err error) {
	result = &v1beta1.ComputeRouter{}
