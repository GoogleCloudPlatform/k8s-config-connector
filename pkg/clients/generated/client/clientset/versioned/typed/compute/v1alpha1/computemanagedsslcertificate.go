...
func newComputeManagedSSLCertificates(c *ComputeV1alpha1Client, namespace string) *computeManagedSSLCertificates {
...
func (c *computeManagedSSLCertificates) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ComputeManagedSSLCertificate, err error) {
	result = &v1alpha1.ComputeManagedSSLCertificate{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeManagedSSLCertificates) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ComputeManagedSSLCertificateList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ComputeManagedSSLCertificateList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computemanagedsslcertificates").
...
func (c *computeManagedSSLCertificates) Create(ctx context.Context, computeManagedSSLCertificate *v1alpha1.ComputeManagedSSLCertificate, opts v1.CreateOptions) (result *v1alpha1.ComputeManagedSSLCertificate, err error) {
	result = &v1alpha1.ComputeManagedSSLCertificate{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computemanagedsslcertificates").
...
func (c *computeManagedSSLCertificates) Update(ctx context.Context, computeManagedSSLCertificate *v1alpha1.ComputeManagedSSLCertificate, opts v1.UpdateOptions) (result *v1alpha1.ComputeManagedSSLCertificate, err error) {
	result = &v1alpha1.ComputeManagedSSLCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computemanagedsslcertificates").
...
func (c *computeManagedSSLCertificates) UpdateStatus(ctx context.Context, computeManagedSSLCertificate *v1alpha1.ComputeManagedSSLCertificate, opts v1.UpdateOptions) (result *v1alpha1.ComputeManagedSSLCertificate, err error) {
	result = &v1alpha1.ComputeManagedSSLCertificate{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computemanagedsslcertificates").
...
func (c *computeManagedSSLCertificates) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ComputeManagedSSLCertificate, err error) {
	result = &v1alpha1.ComputeManagedSSLCertificate{}
