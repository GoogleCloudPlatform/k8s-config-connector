...
func newComputeSnapshots(c *ComputeV1beta1Client, namespace string) *computeSnapshots {
...
func (c *computeSnapshots) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeSnapshot, err error) {
	result = &v1beta1.ComputeSnapshot{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeSnapshots) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeSnapshotList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeSnapshotList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computesnapshots").
...
func (c *computeSnapshots) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeSnapshots) Create(ctx context.Context, computeSnapshot *v1beta1.ComputeSnapshot, opts v1.CreateOptions) (result *v1beta1.ComputeSnapshot, err error) {
	result = &v1beta1.ComputeSnapshot{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computesnapshots").
...
func (c *computeSnapshots) Update(ctx context.Context, computeSnapshot *v1beta1.ComputeSnapshot, opts v1.UpdateOptions) (result *v1beta1.ComputeSnapshot, err error) {
	result = &v1beta1.ComputeSnapshot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesnapshots").
...
func (c *computeSnapshots) UpdateStatus(ctx context.Context, computeSnapshot *v1beta1.ComputeSnapshot, opts v1.UpdateOptions) (result *v1beta1.ComputeSnapshot, err error) {
	result = &v1beta1.ComputeSnapshot{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesnapshots").
...
func (c *computeSnapshots) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeSnapshots) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeSnapshots) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeSnapshot, err error) {
	result = &v1beta1.ComputeSnapshot{}
