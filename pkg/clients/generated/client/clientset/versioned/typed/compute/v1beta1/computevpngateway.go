...
func newComputeVPNGateways(c *ComputeV1beta1Client, namespace string) *computeVPNGateways {
...
func (c *computeVPNGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeVPNGateway, err error) {
	result = &v1beta1.ComputeVPNGateway{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeVPNGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeVPNGatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeVPNGatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computevpngateways").
...
func (c *computeVPNGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeVPNGateways) Create(ctx context.Context, computeVPNGateway *v1beta1.ComputeVPNGateway, opts v1.CreateOptions) (result *v1beta1.ComputeVPNGateway, err error) {
	result = &v1beta1.ComputeVPNGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computevpngateways").
...
func (c *computeVPNGateways) Update(ctx context.Context, computeVPNGateway *v1beta1.ComputeVPNGateway, opts v1.UpdateOptions) (result *v1beta1.ComputeVPNGateway, err error) {
	result = &v1beta1.ComputeVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computevpngateways").
...
func (c *computeVPNGateways) UpdateStatus(ctx context.Context, computeVPNGateway *v1beta1.ComputeVPNGateway, opts v1.UpdateOptions) (result *v1beta1.ComputeVPNGateway, err error) {
	result = &v1beta1.ComputeVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computevpngateways").
...
func (c *computeVPNGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeVPNGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeVPNGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeVPNGateway, err error) {
	result = &v1beta1.ComputeVPNGateway{}
