...
func (c *FakeComputeV1alpha1) ComputeRegionTargetTCPProxies(namespace string) v1alpha1.ComputeRegionTargetTCPProxyInterface {
	return &FakeComputeRegionTargetTCPProxies{c, namespace}
}
