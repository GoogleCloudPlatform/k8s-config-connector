...
func (c *computeInstanceGroupManagers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeInstanceGroupManager, err error) {
	result = &v1beta1.ComputeInstanceGroupManager{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeInstanceGroupManagers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeInstanceGroupManagerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeInstanceGroupManagerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeinstancegroupmanagers").
...
func (c *computeInstanceGroupManagers) Create(ctx context.Context, computeInstanceGroupManager *v1beta1.ComputeInstanceGroupManager, opts v1.CreateOptions) (result *v1beta1.ComputeInstanceGroupManager, err error) {
	result = &v1beta1.ComputeInstanceGroupManager{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeinstancegroupmanagers").
...
func (c *computeInstanceGroupManagers) Update(ctx context.Context, computeInstanceGroupManager *v1beta1.ComputeInstanceGroupManager, opts v1.UpdateOptions) (result *v1beta1.ComputeInstanceGroupManager, err error) {
	result = &v1beta1.ComputeInstanceGroupManager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstancegroupmanagers").
...
func (c *computeInstanceGroupManagers) UpdateStatus(ctx context.Context, computeInstanceGroupManager *v1beta1.ComputeInstanceGroupManager, opts v1.UpdateOptions) (result *v1beta1.ComputeInstanceGroupManager, err error) {
	result = &v1beta1.ComputeInstanceGroupManager{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeinstancegroupmanagers").
...
func (c *computeInstanceGroupManagers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeInstanceGroupManager, err error) {
	result = &v1beta1.ComputeInstanceGroupManager{}
