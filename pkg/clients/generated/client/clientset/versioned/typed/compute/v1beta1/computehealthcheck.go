...
func (c *computeHealthChecks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeHealthCheck, err error) {
	result = &v1beta1.ComputeHealthCheck{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeHealthChecks) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeHealthCheckList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeHealthCheckList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computehealthchecks").
...
func (c *computeHealthChecks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeHealthChecks) Create(ctx context.Context, computeHealthCheck *v1beta1.ComputeHealthCheck, opts v1.CreateOptions) (result *v1beta1.ComputeHealthCheck, err error) {
	result = &v1beta1.ComputeHealthCheck{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computehealthchecks").
...
func (c *computeHealthChecks) Update(ctx context.Context, computeHealthCheck *v1beta1.ComputeHealthCheck, opts v1.UpdateOptions) (result *v1beta1.ComputeHealthCheck, err error) {
	result = &v1beta1.ComputeHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehealthchecks").
...
func (c *computeHealthChecks) UpdateStatus(ctx context.Context, computeHealthCheck *v1beta1.ComputeHealthCheck, opts v1.UpdateOptions) (result *v1beta1.ComputeHealthCheck, err error) {
	result = &v1beta1.ComputeHealthCheck{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computehealthchecks").
...
func (c *computeHealthChecks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeHealthChecks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeHealthChecks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeHealthCheck, err error) {
	result = &v1beta1.ComputeHealthCheck{}
