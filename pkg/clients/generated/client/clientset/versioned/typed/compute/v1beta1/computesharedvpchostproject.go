...
func (c *computeSharedVPCHostProjects) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeSharedVPCHostProject, err error) {
	result = &v1beta1.ComputeSharedVPCHostProject{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeSharedVPCHostProjects) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeSharedVPCHostProjectList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeSharedVPCHostProjectList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computesharedvpchostprojects").
...
func (c *computeSharedVPCHostProjects) Create(ctx context.Context, computeSharedVPCHostProject *v1beta1.ComputeSharedVPCHostProject, opts v1.CreateOptions) (result *v1beta1.ComputeSharedVPCHostProject, err error) {
	result = &v1beta1.ComputeSharedVPCHostProject{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computesharedvpchostprojects").
...
func (c *computeSharedVPCHostProjects) Update(ctx context.Context, computeSharedVPCHostProject *v1beta1.ComputeSharedVPCHostProject, opts v1.UpdateOptions) (result *v1beta1.ComputeSharedVPCHostProject, err error) {
	result = &v1beta1.ComputeSharedVPCHostProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesharedvpchostprojects").
...
func (c *computeSharedVPCHostProjects) UpdateStatus(ctx context.Context, computeSharedVPCHostProject *v1beta1.ComputeSharedVPCHostProject, opts v1.UpdateOptions) (result *v1beta1.ComputeSharedVPCHostProject, err error) {
	result = &v1beta1.ComputeSharedVPCHostProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computesharedvpchostprojects").
...
func (c *computeSharedVPCHostProjects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeSharedVPCHostProject, err error) {
	result = &v1beta1.ComputeSharedVPCHostProject{}
