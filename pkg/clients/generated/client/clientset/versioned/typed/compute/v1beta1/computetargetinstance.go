...
// ComputeTargetInstancesGetter has a method to return a ComputeTargetInstanceInterface.
...
// computeTargetInstances implements ComputeTargetInstanceInterface
type computeTargetInstances struct {
	client rest.Interface
	ns     string
}

// newComputeTargetInstances returns a ComputeTargetInstances
func newComputeTargetInstances(c *ComputeV1beta1Client, namespace string) *computeTargetInstances {
	return &computeTargetInstances{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *computeTargetInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeTargetInstance, err error) {
	result = &v1beta1.ComputeTargetInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeTargetInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeTargetInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeTargetInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computetargetinstances").
...
func (c *computeTargetInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeTargetInstances) Create(ctx context.Context, computeTargetInstance *v1beta1.ComputeTargetInstance, opts v1.CreateOptions) (result *v1beta1.ComputeTargetInstance, err error) {
	result = &v1beta1.ComputeTargetInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargetinstances").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeTargetInstance).
		Do(ctx).
		Into(result)
	return
}
...
func (c *computeTargetInstances) Update(ctx context.Context, computeTargetInstance *v1beta1.ComputeTargetInstance, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetInstance, err error) {
	result = &v1beta1.ComputeTargetInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetinstances").
		Name(computeTargetInstance.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeTargetInstance).
		Do(ctx).
		Into(result)
...
func (c *computeTargetInstances) UpdateStatus(ctx context.Context, computeTargetInstance *v1beta1.ComputeTargetInstance, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetInstance, err error) {
	result = &v1beta1.ComputeTargetInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetinstances").
...
func (c *computeTargetInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeTargetInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeTargetInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeTargetInstance, err error) {
	result = &v1beta1.ComputeTargetInstance{}
