...
func newComputeTargetPools(c *ComputeV1beta1Client, namespace string) *computeTargetPools {
...
func (c *computeTargetPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeTargetPool, err error) {
	result = &v1beta1.ComputeTargetPool{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeTargetPools) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeTargetPoolList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeTargetPoolList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computetargetpools").
...
func (c *computeTargetPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeTargetPools) Create(ctx context.Context, computeTargetPool *v1beta1.ComputeTargetPool, opts v1.CreateOptions) (result *v1beta1.ComputeTargetPool, err error) {
	result = &v1beta1.ComputeTargetPool{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargetpools").
...
func (c *computeTargetPools) Update(ctx context.Context, computeTargetPool *v1beta1.ComputeTargetPool, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetPool, err error) {
	result = &v1beta1.ComputeTargetPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetpools").
...
func (c *computeTargetPools) UpdateStatus(ctx context.Context, computeTargetPool *v1beta1.ComputeTargetPool, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetPool, err error) {
	result = &v1beta1.ComputeTargetPool{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetpools").
...
func (c *computeTargetPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeTargetPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeTargetPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeTargetPool, err error) {
	result = &v1beta1.ComputeTargetPool{}
