...
func (c *FakeComputeURLMaps) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(computeurlmapsResource, c.ns, name), &v1beta1.ComputeURLMap{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.ComputeURLMap), err
}
...
func (c *FakeComputeURLMaps) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeURLMapList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(computeurlmapsResource, computeurlmapsKind, c.ns, opts), &v1beta1.ComputeURLMapList{})
	...
	list := &v1beta1.ComputeURLMapList{ListMeta: obj.(*v1beta1.ComputeURLMapList).ListMeta}
	for _, item := range obj.(*v1beta1.ComputeURLMapList).Items {
...
func (c *FakeComputeURLMaps) Create(ctx context.Context, computeURLMap *v1beta1.ComputeURLMap, opts v1.CreateOptions) (result *v1beta1.ComputeURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(computeurlmapsResource, c.ns, computeURLMap), &v1beta1.ComputeURLMap{})
...
func (c *FakeComputeURLMaps) Update(ctx context.Context, computeURLMap *v1beta1.ComputeURLMap, opts v1.UpdateOptions) (result *v1beta1.ComputeURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(computeurlmapsResource, c.ns, computeURLMap), &v1beta1.ComputeURLMap{})
...
func (c *FakeComputeURLMaps) UpdateStatus(ctx context.Context, computeURLMap *v1beta1.ComputeURLMap, opts v1.UpdateOptions) (*v1beta1.ComputeURLMap, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(computeurlmapsResource, "status", c.ns, computeURLMap), &v1beta1.ComputeURLMap{})
...
func (c *FakeComputeURLMaps) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(computeurlmapsResource, c.ns, name, opts), &v1beta1.ComputeURLMap{})
...
func (c *FakeComputeURLMaps) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1beta1.ComputeURLMapList{})
	return err
}
...
func (c *FakeComputeURLMaps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeURLMap, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(computeurlmapsResource, c.ns, name, pt, data, subresources...), &v1beta1.ComputeURLMap{})
