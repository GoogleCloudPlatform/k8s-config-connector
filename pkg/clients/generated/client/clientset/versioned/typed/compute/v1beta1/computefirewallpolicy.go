...
// ComputeFirewallPoliciesGetter has a method to return a ComputeFirewallPolicyInterface.
...
// computeFirewallPolicies implements ComputeFirewallPolicyInterface
type computeFirewallPolicies struct {
	client rest.Interface
	ns     string
}

// newComputeFirewallPolicies returns a ComputeFirewallPolicies
func newComputeFirewallPolicies(c *ComputeV1beta1Client, namespace string) *computeFirewallPolicies {
	return &computeFirewallPolicies{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *computeFirewallPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeFirewallPolicy, err error) {
	result = &v1beta1.ComputeFirewallPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeFirewallPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeFirewallPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeFirewallPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computefirewallpolicies").
...
func (c *computeFirewallPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeFirewallPolicies) Create(ctx context.Context, computeFirewallPolicy *v1beta1.ComputeFirewallPolicy, opts v1.CreateOptions) (result *v1beta1.ComputeFirewallPolicy, err error) {
	result = &v1beta1.ComputeFirewallPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computefirewallpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeFirewallPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *computeFirewallPolicies) Update(ctx context.Context, computeFirewallPolicy *v1beta1.ComputeFirewallPolicy, opts v1.UpdateOptions) (result *v1beta1.ComputeFirewallPolicy, err error) {
	result = &v1beta1.ComputeFirewallPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computefirewallpolicies").
		Name(computeFirewallPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeFirewallPolicy).
		Do(ctx).
		Into(result)
...
func (c *computeFirewallPolicies) UpdateStatus(ctx context.Context, computeFirewallPolicy *v1beta1.ComputeFirewallPolicy, opts v1.UpdateOptions) (result *v1beta1.ComputeFirewallPolicy, err error) {
	result = &v1beta1.ComputeFirewallPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computefirewallpolicies").
...
func (c *computeFirewallPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeFirewallPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeFirewallPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeFirewallPolicy, err error) {
	result = &v1beta1.ComputeFirewallPolicy{}
