...
func (c *computeTargetVPNGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeTargetVPNGateway, err error) {
	result = &v1beta1.ComputeTargetVPNGateway{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeTargetVPNGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeTargetVPNGatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeTargetVPNGatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computetargetvpngateways").
...
func (c *computeTargetVPNGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeTargetVPNGateways) Create(ctx context.Context, computeTargetVPNGateway *v1beta1.ComputeTargetVPNGateway, opts v1.CreateOptions) (result *v1beta1.ComputeTargetVPNGateway, err error) {
	result = &v1beta1.ComputeTargetVPNGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computetargetvpngateways").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeTargetVPNGateway).
		Do(ctx).
		Into(result)
	return
}
...
func (c *computeTargetVPNGateways) Update(ctx context.Context, computeTargetVPNGateway *v1beta1.ComputeTargetVPNGateway, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetVPNGateway, err error) {
	result = &v1beta1.ComputeTargetVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetvpngateways").
		Name(computeTargetVPNGateway.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeTargetVPNGateway).
		Do(ctx).
		Into(result)
...
func (c *computeTargetVPNGateways) UpdateStatus(ctx context.Context, computeTargetVPNGateway *v1beta1.ComputeTargetVPNGateway, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetVPNGateway, err error) {
	result = &v1beta1.ComputeTargetVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computetargetvpngateways").
...
func (c *computeTargetVPNGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeTargetVPNGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeTargetVPNGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeTargetVPNGateway, err error) {
	result = &v1beta1.ComputeTargetVPNGateway{}
