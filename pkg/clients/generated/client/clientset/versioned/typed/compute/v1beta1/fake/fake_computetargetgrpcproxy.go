...
var computetargetgrpcproxiesResource = v1beta1.SchemeGroupVersion.WithResource("computetargetgrpcproxies")

var computetargetgrpcproxiesKind = v1beta1.SchemeGroupVersion.WithKind("ComputeTargetGRPCProxy")
