...
func newAppEngineStandardAppVersions(c *AppengineV1alpha1Client, namespace string) *appEngineStandardAppVersions {
...
func (c *appEngineStandardAppVersions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppEngineStandardAppVersion, err error) {
...
func (c *appEngineStandardAppVersions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppEngineStandardAppVersionList, err error) {
...
func (c *appEngineStandardAppVersions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appEngineStandardAppVersions) Create(ctx context.Context, appEngineStandardAppVersion *v1alpha1.AppEngineStandardAppVersion, opts v1.CreateOptions) (result *v1alpha1.AppEngineStandardAppVersion, err error) {
	result = &v1alpha1.AppEngineStandardAppVersion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("appenginestandardappversions").
...
func (c *appEngineStandardAppVersions) Update(ctx context.Context, appEngineStandardAppVersion *v1alpha1.AppEngineStandardAppVersion, opts v1.UpdateOptions) (result *v1alpha1.AppEngineStandardAppVersion, err error) {
	result = &v1alpha1.AppEngineStandardAppVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appenginestandardappversions").
...
func (c *appEngineStandardAppVersions) UpdateStatus(ctx context.Context, appEngineStandardAppVersion *v1alpha1.AppEngineStandardAppVersion, opts v1.UpdateOptions) (result *v1alpha1.AppEngineStandardAppVersion, err error) {
	result = &v1alpha1.AppEngineStandardAppVersion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appenginestandardappversions").
...
func (c *appEngineStandardAppVersions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *appEngineStandardAppVersions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *appEngineStandardAppVersions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppEngineStandardAppVersion, err error) {
	result = &v1alpha1.AppEngineStandardAppVersion{}
