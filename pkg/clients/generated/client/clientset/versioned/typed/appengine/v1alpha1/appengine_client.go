...
type AppengineV1alpha1Interface interface {
	...
	AppEngineFlexibleAppVersionsGetter
	AppEngineServiceSplitTrafficsGetter
...
// NewForConfigAndClient creates a new AppengineV1alpha1Client for the given config and http client.
...
func setConfigDefaults(config *rest.Config) {
	gv := appenginev1alpha1.SchemeGroupVersion
