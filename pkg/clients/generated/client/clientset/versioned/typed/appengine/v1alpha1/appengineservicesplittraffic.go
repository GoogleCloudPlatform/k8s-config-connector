...
func (c *appEngineServiceSplitTraffics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.AppEngineServiceSplitTraffic, err error) {
	result = &v1alpha1.AppEngineServiceSplitTraffic{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *appEngineServiceSplitTraffics) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.AppEngineServiceSplitTrafficList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.AppEngineServiceSplitTrafficList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("appengineservicesplittraffics").
...
func (c *appEngineServiceSplitTraffics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *appEngineServiceSplitTraffics) Create(ctx context.Context, appEngineServiceSplitTraffic *v1alpha1.AppEngineServiceSplitTraffic, opts v1.CreateOptions) (result *v1alpha1.AppEngineServiceSplitTraffic, err error) {
	result = &v1alpha1.AppEngineServiceSplitTraffic{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("appengineservicesplittraffics").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(appEngineServiceSplitTraffic).
		Do(ctx).
		Into(result)
	return
}
...
func (c *appEngineServiceSplitTraffics) Update(ctx context.Context, appEngineServiceSplitTraffic *v1alpha1.AppEngineServiceSplitTraffic, opts v1.UpdateOptions) (result *v1alpha1.AppEngineServiceSplitTraffic, err error) {
	result = &v1alpha1.AppEngineServiceSplitTraffic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appengineservicesplittraffics").
		Name(appEngineServiceSplitTraffic.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(appEngineServiceSplitTraffic).
		Do(ctx).
		Into(result)
...
func (c *appEngineServiceSplitTraffics) UpdateStatus(ctx context.Context, appEngineServiceSplitTraffic *v1alpha1.AppEngineServiceSplitTraffic, opts v1.UpdateOptions) (result *v1alpha1.AppEngineServiceSplitTraffic, err error) {
	result = &v1alpha1.AppEngineServiceSplitTraffic{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("appengineservicesplittraffics").
...
func (c *appEngineServiceSplitTraffics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *appEngineServiceSplitTraffics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *appEngineServiceSplitTraffics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.AppEngineServiceSplitTraffic, err error) {
	result = &v1alpha1.AppEngineServiceSplitTraffic{}
