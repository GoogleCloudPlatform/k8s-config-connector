...
func (c *bigtableInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.BigtableInstance, err error) {
	result = &v1beta1.BigtableInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *bigtableInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BigtableInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.BigtableInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("bigtableinstances").
...
func (c *bigtableInstances) Create(ctx context.Context, bigtableInstance *v1beta1.BigtableInstance, opts v1.CreateOptions) (result *v1beta1.BigtableInstance, err error) {
	result = &v1beta1.BigtableInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("bigtableinstances").
...
func (c *bigtableInstances) Update(ctx context.Context, bigtableInstance *v1beta1.BigtableInstance, opts v1.UpdateOptions) (result *v1beta1.BigtableInstance, err error) {
	result = &v1beta1.BigtableInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bigtableinstances").
...
func (c *bigtableInstances) UpdateStatus(ctx context.Context, bigtableInstance *v1beta1.BigtableInstance, opts v1.UpdateOptions) (result *v1beta1.BigtableInstance, err error) {
	result = &v1beta1.BigtableInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("bigtableinstances").
...
func (c *bigtableInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.BigtableInstance, err error) {
	result = &v1beta1.BigtableInstance{}
