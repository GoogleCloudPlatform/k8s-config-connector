...
type BigtableV1beta1Interface interface {
...
// NewForConfigAndClient creates a new BigtableV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BigtableV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &BigtableV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new BigtableV1beta1Client for the given config and
...
func New(c rest.Interface) *BigtableV1beta1Client {
	return &BigtableV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := bigtablev1beta1.SchemeGroupVersion
