...
var bigtabletablesResource = schema.GroupVersionResource{Group: "bigtable.cnrm.cloud.google.com", Version: "v1beta1", Resource: "bigtabletables"}

var bigtabletablesKind = schema.GroupVersionKind{Group: "bigtable.cnrm.cloud.google.com", Version: "v1beta1", Kind: "BigtableTable"}
...
func (c *FakeBigtableTables) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.BigtableTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(bigtabletablesResource, c.ns, name), &v1beta1.BigtableTable{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.BigtableTable), err
}
...
func (c *FakeBigtableTables) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.BigtableTableList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(bigtabletablesResource, bigtabletablesKind, c.ns, opts), &v1beta1.BigtableTableList{})
	...
	list := &v1beta1.BigtableTableList{ListMeta: obj.(*v1beta1.BigtableTableList).ListMeta}
	for _, item := range obj.(*v1beta1.BigtableTableList).Items {
...
func (c *FakeBigtableTables) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeBigtableTables) Create(ctx context.Context, bigtableTable *v1beta1.BigtableTable, opts v1.CreateOptions) (result *v1beta1.BigtableTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(bigtabletablesResource, c.ns, bigtableTable), &v1beta1.BigtableTable{})
...
func (c *FakeBigtableTables) Update(ctx context.Context, bigtableTable *v1beta1.BigtableTable, opts v1.UpdateOptions) (result *v1beta1.BigtableTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(bigtabletablesResource, c.ns, bigtableTable), &v1beta1.BigtableTable{})
...
func (c *FakeBigtableTables) UpdateStatus(ctx context.Context, bigtableTable *v1beta1.BigtableTable, opts v1.UpdateOptions) (*v1beta1.BigtableTable, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(bigtabletablesResource, "status", c.ns, bigtableTable), &v1beta1.BigtableTable{})
...
func (c *FakeBigtableTables) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(bigtabletablesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.BigtableTableList{})
	return err
}
...
func (c *FakeBigtableTables) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.BigtableTable, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(bigtabletablesResource, c.ns, name, pt, data, subresources...), &v1beta1.BigtableTable{})
