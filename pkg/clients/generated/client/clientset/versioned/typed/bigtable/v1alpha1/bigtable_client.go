...
type BigtableV1alpha1Interface interface {
	...
	BigtableAuthorizedViewsGetter
	BigtableBackupsGetter
...
func (c *BigtableV1alpha1Client) BigtableAuthorizedViews(namespace string) BigtableAuthorizedViewInterface {
	return newBigtableAuthorizedViews(c, namespace)
}

func (c *BigtableV1alpha1Client) BigtableBackups(namespace string) BigtableBackupInterface {
	return newBigtableBackups(c, namespace)
}

func (c *BigtableV1alpha1Client) BigtableClusters(namespace string) BigtableClusterInterface {
	return newBigtableClusters(c, namespace)
}

func (c *BigtableV1alpha1Client) BigtableLogicalViews(namespace string) BigtableLogicalViewInterface {
	return newBigtableLogicalViews(c, namespace)
}
...
// NewForConfigAndClient creates a new BigtableV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*BigtableV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := bigtablev1alpha1.SchemeGroupVersion
