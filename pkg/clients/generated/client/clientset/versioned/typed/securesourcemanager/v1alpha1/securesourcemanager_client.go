...
type SecuresourcemanagerV1alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*SecuresourcemanagerV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new SecuresourcemanagerV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SecuresourcemanagerV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &SecuresourcemanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SecuresourcemanagerV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *SecuresourcemanagerV1alpha1Client {
...
// New creates a new SecuresourcemanagerV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *SecuresourcemanagerV1alpha1Client {
	return &SecuresourcemanagerV1alpha1Client{c}
}
...
func (c *SecuresourcemanagerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
