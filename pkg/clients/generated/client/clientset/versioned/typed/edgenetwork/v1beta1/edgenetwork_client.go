...
// NewForConfigAndClient creates a new EdgenetworkV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*EdgenetworkV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &EdgenetworkV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new EdgenetworkV1beta1Client for the given config and
...
func New(c rest.Interface) *EdgenetworkV1beta1Client {
	return &EdgenetworkV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := edgenetworkv1beta1.SchemeGroupVersion
