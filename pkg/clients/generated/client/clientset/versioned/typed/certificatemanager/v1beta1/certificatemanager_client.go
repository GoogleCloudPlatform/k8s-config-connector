...
type CertificatemanagerV1beta1Interface interface {
...
// NewForConfig creates a new CertificatemanagerV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new CertificatemanagerV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CertificatemanagerV1beta1Client, error) {
	...
	return &CertificatemanagerV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new CertificatemanagerV1beta1Client for the given config and
...
func New(c rest.Interface) *CertificatemanagerV1beta1Client {
	return &CertificatemanagerV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := certificatemanagerv1beta1.SchemeGroupVersion
