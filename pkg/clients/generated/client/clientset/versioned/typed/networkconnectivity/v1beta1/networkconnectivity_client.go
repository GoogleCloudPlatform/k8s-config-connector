...
func NewForConfig(c *rest.Config) (*NetworkconnectivityV1beta1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new NetworkconnectivityV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NetworkconnectivityV1beta1Client, error) {
	...
	return &NetworkconnectivityV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new NetworkconnectivityV1beta1Client for the given config and
...
func New(c rest.Interface) *NetworkconnectivityV1beta1Client {
	return &NetworkconnectivityV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := networkconnectivityv1beta1.SchemeGroupVersion
...
func (c *NetworkconnectivityV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
