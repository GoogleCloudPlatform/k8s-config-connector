...
func (c *storageBucketAccessControls) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.StorageBucketAccessControl, err error) {
...
func (c *storageBucketAccessControls) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.StorageBucketAccessControlList, err error) {
...
func (c *storageBucketAccessControls) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *storageBucketAccessControls) Create(ctx context.Context, storageBucketAccessControl *v1beta1.StorageBucketAccessControl, opts v1.CreateOptions) (result *v1beta1.StorageBucketAccessControl, err error) {
	result = &v1beta1.StorageBucketAccessControl{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagebucketaccesscontrols").
...
func (c *storageBucketAccessControls) Update(ctx context.Context, storageBucketAccessControl *v1beta1.StorageBucketAccessControl, opts v1.UpdateOptions) (result *v1beta1.StorageBucketAccessControl, err error) {
	result = &v1beta1.StorageBucketAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketaccesscontrols").
...
func (c *storageBucketAccessControls) UpdateStatus(ctx context.Context, storageBucketAccessControl *v1beta1.StorageBucketAccessControl, opts v1.UpdateOptions) (result *v1beta1.StorageBucketAccessControl, err error) {
	result = &v1beta1.StorageBucketAccessControl{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebucketaccesscontrols").
...
func (c *storageBucketAccessControls) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *storageBucketAccessControls) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *storageBucketAccessControls) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.StorageBucketAccessControl, err error) {
	result = &v1beta1.StorageBucketAccessControl{}
