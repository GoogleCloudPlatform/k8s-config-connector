...
func (c *monitoringMonitoredProjects) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.MonitoringMonitoredProject, err error) {
	result = &v1beta1.MonitoringMonitoredProject{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("monitoringmonitoredprojects").
		Name(name).
...
func (c *monitoringMonitoredProjects) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.MonitoringMonitoredProjectList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.MonitoringMonitoredProjectList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("monitoringmonitoredprojects").
...
func (c *monitoringMonitoredProjects) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitoringMonitoredProjects) Create(ctx context.Context, monitoringMonitoredProject *v1beta1.MonitoringMonitoredProject, opts v1.CreateOptions) (result *v1beta1.MonitoringMonitoredProject, err error) {
	result = &v1beta1.MonitoringMonitoredProject{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitoringmonitoredprojects").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(monitoringMonitoredProject).
		Do(ctx).
		Into(result)
	return
}
...
func (c *monitoringMonitoredProjects) Update(ctx context.Context, monitoringMonitoredProject *v1beta1.MonitoringMonitoredProject, opts v1.UpdateOptions) (result *v1beta1.MonitoringMonitoredProject, err error) {
	result = &v1beta1.MonitoringMonitoredProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringmonitoredprojects").
...
func (c *monitoringMonitoredProjects) UpdateStatus(ctx context.Context, monitoringMonitoredProject *v1beta1.MonitoringMonitoredProject, opts v1.UpdateOptions) (result *v1beta1.MonitoringMonitoredProject, err error) {
	result = &v1beta1.MonitoringMonitoredProject{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringmonitoredprojects").
...
func (c *monitoringMonitoredProjects) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitoringMonitoredProjects) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitoringMonitoredProjects) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.MonitoringMonitoredProject, err error) {
	result = &v1beta1.MonitoringMonitoredProject{}
