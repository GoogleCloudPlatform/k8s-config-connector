...
func (c *monitoringAlertPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.MonitoringAlertPolicy, err error) {
	result = &v1beta1.MonitoringAlertPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *monitoringAlertPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.MonitoringAlertPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.MonitoringAlertPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("monitoringalertpolicies").
...
func (c *monitoringAlertPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitoringAlertPolicies) Create(ctx context.Context, monitoringAlertPolicy *v1beta1.MonitoringAlertPolicy, opts v1.CreateOptions) (result *v1beta1.MonitoringAlertPolicy, err error) {
	result = &v1beta1.MonitoringAlertPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitoringalertpolicies").
...
func (c *monitoringAlertPolicies) Update(ctx context.Context, monitoringAlertPolicy *v1beta1.MonitoringAlertPolicy, opts v1.UpdateOptions) (result *v1beta1.MonitoringAlertPolicy, err error) {
	result = &v1beta1.MonitoringAlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringalertpolicies").
...
func (c *monitoringAlertPolicies) UpdateStatus(ctx context.Context, monitoringAlertPolicy *v1beta1.MonitoringAlertPolicy, opts v1.UpdateOptions) (result *v1beta1.MonitoringAlertPolicy, err error) {
	result = &v1beta1.MonitoringAlertPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringalertpolicies").
...
func (c *monitoringAlertPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitoringAlertPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitoringAlertPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.MonitoringAlertPolicy, err error) {
	result = &v1beta1.MonitoringAlertPolicy{}
