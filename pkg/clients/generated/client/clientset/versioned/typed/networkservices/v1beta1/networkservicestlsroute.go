...
// NetworkServicesTLSRoutesGetter has a method to return a NetworkServicesTLSRouteInterface.
...
// networkServicesTLSRoutes implements NetworkServicesTLSRouteInterface
type networkServicesTLSRoutes struct {
	client rest.Interface
	ns     string
}

// newNetworkServicesTLSRoutes returns a NetworkServicesTLSRoutes
func newNetworkServicesTLSRoutes(c *NetworkservicesV1beta1Client, namespace string) *networkServicesTLSRoutes {
	return &networkServicesTLSRoutes{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *networkServicesTLSRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NetworkServicesTLSRoute, err error) {
	result = &v1beta1.NetworkServicesTLSRoute{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkservicestlsroutes").
		Name(name).
...
func (c *networkServicesTLSRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NetworkServicesTLSRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.NetworkServicesTLSRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkservicestlsroutes").
...
func (c *networkServicesTLSRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkServicesTLSRoutes) Create(ctx context.Context, networkServicesTLSRoute *v1beta1.NetworkServicesTLSRoute, opts v1.CreateOptions) (result *v1beta1.NetworkServicesTLSRoute, err error) {
	result = &v1beta1.NetworkServicesTLSRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkservicestlsroutes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesTLSRoute).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkServicesTLSRoutes) Update(ctx context.Context, networkServicesTLSRoute *v1beta1.NetworkServicesTLSRoute, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesTLSRoute, err error) {
	result = &v1beta1.NetworkServicesTLSRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicestlsroutes").
		Name(networkServicesTLSRoute.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesTLSRoute).
		Do(ctx).
		Into(result)
...
func (c *networkServicesTLSRoutes) UpdateStatus(ctx context.Context, networkServicesTLSRoute *v1beta1.NetworkServicesTLSRoute, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesTLSRoute, err error) {
	result = &v1beta1.NetworkServicesTLSRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicestlsroutes").
...
func (c *networkServicesTLSRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkServicesTLSRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkServicesTLSRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NetworkServicesTLSRoute, err error) {
	result = &v1beta1.NetworkServicesTLSRoute{}
