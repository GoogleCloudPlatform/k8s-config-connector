...
type NetworkservicesV1alpha1Interface interface {
	...
	NetworkServicesLBEdgeExtensionsGetter
...
func (c *NetworkservicesV1alpha1Client) NetworkServicesEdgeCacheKeysets(namespace string) NetworkServicesEdgeCacheKeysetInterface {
	return newNetworkServicesEdgeCacheKeysets(c, namespace)
}

func (c *NetworkservicesV1alpha1Client) NetworkServicesEdgeCacheOrigins(namespace string) NetworkServicesEdgeCacheOriginInterface {
	return newNetworkServicesEdgeCacheOrigins(c, namespace)
}
...
func (c *NetworkservicesV1alpha1Client) NetworkServicesLBEdgeExtensions(namespace string) NetworkServicesLBEdgeExtensionInterface {
	return newNetworkServicesLBEdgeExtensions(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*NetworkservicesV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new NetworkservicesV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NetworkservicesV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &NetworkservicesV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NetworkservicesV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *NetworkservicesV1alpha1Client {
...
// New creates a new NetworkservicesV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *NetworkservicesV1alpha1Client {
	return &NetworkservicesV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := networkservicesv1alpha1.SchemeGroupVersion
...
func (c *NetworkservicesV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
