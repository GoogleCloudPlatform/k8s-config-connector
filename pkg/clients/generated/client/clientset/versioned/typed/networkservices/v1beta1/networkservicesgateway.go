...
func (c *networkServicesGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NetworkServicesGateway, err error) {
	result = &v1beta1.NetworkServicesGateway{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkServicesGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NetworkServicesGatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.NetworkServicesGatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkservicesgateways").
...
func (c *networkServicesGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkServicesGateways) Create(ctx context.Context, networkServicesGateway *v1beta1.NetworkServicesGateway, opts v1.CreateOptions) (result *v1beta1.NetworkServicesGateway, err error) {
	result = &v1beta1.NetworkServicesGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkservicesgateways").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesGateway).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkServicesGateways) Update(ctx context.Context, networkServicesGateway *v1beta1.NetworkServicesGateway, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesGateway, err error) {
	result = &v1beta1.NetworkServicesGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicesgateways").
		Name(networkServicesGateway.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesGateway).
		Do(ctx).
		Into(result)
...
func (c *networkServicesGateways) UpdateStatus(ctx context.Context, networkServicesGateway *v1beta1.NetworkServicesGateway, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesGateway, err error) {
	result = &v1beta1.NetworkServicesGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicesgateways").
...
func (c *networkServicesGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkServicesGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkServicesGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NetworkServicesGateway, err error) {
	result = &v1beta1.NetworkServicesGateway{}
