...
func (c *networkServicesEndpointPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NetworkServicesEndpointPolicy, err error) {
	result = &v1beta1.NetworkServicesEndpointPolicy{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *networkServicesEndpointPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NetworkServicesEndpointPolicyList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.NetworkServicesEndpointPolicyList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkservicesendpointpolicies").
...
func (c *networkServicesEndpointPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkServicesEndpointPolicies) Create(ctx context.Context, networkServicesEndpointPolicy *v1beta1.NetworkServicesEndpointPolicy, opts v1.CreateOptions) (result *v1beta1.NetworkServicesEndpointPolicy, err error) {
	result = &v1beta1.NetworkServicesEndpointPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkservicesendpointpolicies").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesEndpointPolicy).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkServicesEndpointPolicies) Update(ctx context.Context, networkServicesEndpointPolicy *v1beta1.NetworkServicesEndpointPolicy, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesEndpointPolicy, err error) {
	result = &v1beta1.NetworkServicesEndpointPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicesendpointpolicies").
		Name(networkServicesEndpointPolicy.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesEndpointPolicy).
		Do(ctx).
		Into(result)
...
func (c *networkServicesEndpointPolicies) UpdateStatus(ctx context.Context, networkServicesEndpointPolicy *v1beta1.NetworkServicesEndpointPolicy, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesEndpointPolicy, err error) {
	result = &v1beta1.NetworkServicesEndpointPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicesendpointpolicies").
...
func (c *networkServicesEndpointPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkServicesEndpointPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NetworkServicesEndpointPolicy, err error) {
	result = &v1beta1.NetworkServicesEndpointPolicy{}
