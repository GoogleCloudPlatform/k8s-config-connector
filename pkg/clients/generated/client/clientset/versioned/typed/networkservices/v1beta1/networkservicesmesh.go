...
func (c *networkServicesMeshes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NetworkServicesMesh, err error) {
	result = &v1beta1.NetworkServicesMesh{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkservicesmeshes").
		Name(name).
...
func (c *networkServicesMeshes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NetworkServicesMeshList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.NetworkServicesMeshList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("networkservicesmeshes").
...
func (c *networkServicesMeshes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *networkServicesMeshes) Create(ctx context.Context, networkServicesMesh *v1beta1.NetworkServicesMesh, opts v1.CreateOptions) (result *v1beta1.NetworkServicesMesh, err error) {
	result = &v1beta1.NetworkServicesMesh{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("networkservicesmeshes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesMesh).
		Do(ctx).
		Into(result)
	return
}
...
func (c *networkServicesMeshes) Update(ctx context.Context, networkServicesMesh *v1beta1.NetworkServicesMesh, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesMesh, err error) {
	result = &v1beta1.NetworkServicesMesh{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicesmeshes").
		Name(networkServicesMesh.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(networkServicesMesh).
		Do(ctx).
		Into(result)
...
func (c *networkServicesMeshes) UpdateStatus(ctx context.Context, networkServicesMesh *v1beta1.NetworkServicesMesh, opts v1.UpdateOptions) (result *v1beta1.NetworkServicesMesh, err error) {
	result = &v1beta1.NetworkServicesMesh{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("networkservicesmeshes").
...
func (c *networkServicesMeshes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *networkServicesMeshes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *networkServicesMeshes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.NetworkServicesMesh, err error) {
	result = &v1beta1.NetworkServicesMesh{}
