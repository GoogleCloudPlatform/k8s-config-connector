...
func (c *TagsV1beta1Client) TagsTagBindings(namespace string) TagsTagBindingInterface {
	return newTagsTagBindings(c, namespace)
}

func (c *TagsV1beta1Client) TagsTagKeys(namespace string) TagsTagKeyInterface {
	return newTagsTagKeys(c, namespace)
}

func (c *TagsV1beta1Client) TagsTagValues(namespace string) TagsTagValueInterface {
	return newTagsTagValues(c, namespace)
}

// NewForConfig creates a new TagsV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new TagsV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TagsV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &TagsV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new TagsV1beta1Client for the given config and
...
func New(c rest.Interface) *TagsV1beta1Client {
	return &TagsV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := tagsv1beta1.SchemeGroupVersion
