...
var tagstagvaluesResource = schema.GroupVersionResource{Group: "tags.cnrm.cloud.google.com", Version: "v1beta1", Resource: "tagstagvalues"}

var tagstagvaluesKind = schema.GroupVersionKind{Group: "tags.cnrm.cloud.google.com", Version: "v1beta1", Kind: "TagsTagValue"}
...
func (c *FakeTagsTagValues) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.TagsTagValue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(tagstagvaluesResource, c.ns, name), &v1beta1.TagsTagValue{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.TagsTagValue), err
}
...
func (c *FakeTagsTagValues) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.TagsTagValueList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(tagstagvaluesResource, tagstagvaluesKind, c.ns, opts), &v1beta1.TagsTagValueList{})
	...
	list := &v1beta1.TagsTagValueList{ListMeta: obj.(*v1beta1.TagsTagValueList).ListMeta}
	for _, item := range obj.(*v1beta1.TagsTagValueList).Items {
...
func (c *FakeTagsTagValues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(tagstagvaluesResource, c.ns, opts))
...
func (c *FakeTagsTagValues) Create(ctx context.Context, tagsTagValue *v1beta1.TagsTagValue, opts v1.CreateOptions) (result *v1beta1.TagsTagValue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(tagstagvaluesResource, c.ns, tagsTagValue), &v1beta1.TagsTagValue{})
...
func (c *FakeTagsTagValues) Update(ctx context.Context, tagsTagValue *v1beta1.TagsTagValue, opts v1.UpdateOptions) (result *v1beta1.TagsTagValue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(tagstagvaluesResource, c.ns, tagsTagValue), &v1beta1.TagsTagValue{})
...
func (c *FakeTagsTagValues) UpdateStatus(ctx context.Context, tagsTagValue *v1beta1.TagsTagValue, opts v1.UpdateOptions) (*v1beta1.TagsTagValue, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(tagstagvaluesResource, "status", c.ns, tagsTagValue), &v1beta1.TagsTagValue{})
...
func (c *FakeTagsTagValues) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(tagstagvaluesResource, c.ns, name, opts), &v1beta1.TagsTagValue{})
...
func (c *FakeTagsTagValues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(tagstagvaluesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.TagsTagValueList{})
	return err
}
...
func (c *FakeTagsTagValues) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.TagsTagValue, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(tagstagvaluesResource, c.ns, name, pt, data, subresources...), &v1beta1.TagsTagValue{})
