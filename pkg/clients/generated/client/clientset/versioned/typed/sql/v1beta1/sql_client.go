...
type SqlV1beta1Interface interface {
...
// NewForConfig creates a new SqlV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new SqlV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SqlV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &SqlV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new SqlV1beta1Client for the given config and
...
func New(c rest.Interface) *SqlV1beta1Client {
	return &SqlV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := sqlv1beta1.SchemeGroupVersion
