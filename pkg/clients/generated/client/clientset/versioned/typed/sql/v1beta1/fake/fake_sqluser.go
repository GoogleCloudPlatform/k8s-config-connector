...
var sqlusersResource = v1beta1.SchemeGroupVersion.WithResource("sqlusers")

var sqlusersKind = v1beta1.SchemeGroupVersion.WithKind("SQLUser")
...
func (c *FakeSQLUsers) UpdateStatus(ctx context.Context, sQLUser *v1beta1.SQLUser, opts v1.UpdateOptions) (*v1beta1.SQLUser, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(sqlusersResource, "status", c.ns, sQLUser), &v1beta1.SQLUser{})
