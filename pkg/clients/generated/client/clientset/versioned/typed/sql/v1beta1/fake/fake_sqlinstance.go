...
var sqlinstancesResource = schema.GroupVersionResource{Group: "sql.cnrm.cloud.google.com", Version: "v1beta1", Resource: "sqlinstances"}

var sqlinstancesKind = schema.GroupVersionKind{Group: "sql.cnrm.cloud.google.com", Version: "v1beta1", Kind: "SQLInstance"}
...
func (c *FakeSQLInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.SQLInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(sqlinstancesResource, c.ns, name), &v1beta1.SQLInstance{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.SQLInstance), err
}
...
func (c *FakeSQLInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.SQLInstanceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(sqlinstancesResource, sqlinstancesKind, c.ns, opts), &v1beta1.SQLInstanceList{})
	...
	list := &v1beta1.SQLInstanceList{ListMeta: obj.(*v1beta1.SQLInstanceList).ListMeta}
	for _, item := range obj.(*v1beta1.SQLInstanceList).Items {
...
func (c *FakeSQLInstances) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSQLInstances) Create(ctx context.Context, sQLInstance *v1beta1.SQLInstance, opts v1.CreateOptions) (result *v1beta1.SQLInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(sqlinstancesResource, c.ns, sQLInstance), &v1beta1.SQLInstance{})
...
func (c *FakeSQLInstances) Update(ctx context.Context, sQLInstance *v1beta1.SQLInstance, opts v1.UpdateOptions) (result *v1beta1.SQLInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(sqlinstancesResource, c.ns, sQLInstance), &v1beta1.SQLInstance{})
...
func (c *FakeSQLInstances) UpdateStatus(ctx context.Context, sQLInstance *v1beta1.SQLInstance, opts v1.UpdateOptions) (*v1beta1.SQLInstance, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(sqlinstancesResource, "status", c.ns, sQLInstance), &v1beta1.SQLInstance{})
...
func (c *FakeSQLInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sqlinstancesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.SQLInstanceList{})
	return err
}
...
func (c *FakeSQLInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.SQLInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(sqlinstancesResource, c.ns, name, pt, data, subresources...), &v1beta1.SQLInstance{})
