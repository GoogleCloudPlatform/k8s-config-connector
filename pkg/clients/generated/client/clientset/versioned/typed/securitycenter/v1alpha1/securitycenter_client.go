...
func (c *SecuritycenterV1alpha1Client) SecurityCenterNotificationConfigs(namespace string) SecurityCenterNotificationConfigInterface {
	return newSecurityCenterNotificationConfigs(c, namespace)
}

func (c *SecuritycenterV1alpha1Client) SecurityCenterSources(namespace string) SecurityCenterSourceInterface {
	return newSecurityCenterSources(c, namespace)
}

// NewForConfig creates a new SecuritycenterV1alpha1Client for the given config.
...
// NewForConfigAndClient creates a new SecuritycenterV1alpha1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*SecuritycenterV1alpha1Client, error) {
	...
	return &SecuritycenterV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SecuritycenterV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *SecuritycenterV1alpha1Client {
...
// New creates a new SecuritycenterV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *SecuritycenterV1alpha1Client {
...
func (c *SecuritycenterV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
