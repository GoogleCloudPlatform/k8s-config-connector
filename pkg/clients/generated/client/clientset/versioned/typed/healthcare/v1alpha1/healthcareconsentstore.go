...
// HealthcareConsentStoresGetter has a method to return a HealthcareConsentStoreInterface.
...
// healthcareConsentStores implements HealthcareConsentStoreInterface
type healthcareConsentStores struct {
	client rest.Interface
	ns     string
}

// newHealthcareConsentStores returns a HealthcareConsentStores
func newHealthcareConsentStores(c *HealthcareV1alpha1Client, namespace string) *healthcareConsentStores {
	return &healthcareConsentStores{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *healthcareConsentStores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.HealthcareConsentStore, err error) {
	result = &v1alpha1.HealthcareConsentStore{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("healthcareconsentstores").
		Name(name).
...
func (c *healthcareConsentStores) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.HealthcareConsentStoreList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.HealthcareConsentStoreList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("healthcareconsentstores").
...
func (c *healthcareConsentStores) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *healthcareConsentStores) Create(ctx context.Context, healthcareConsentStore *v1alpha1.HealthcareConsentStore, opts v1.CreateOptions) (result *v1alpha1.HealthcareConsentStore, err error) {
	result = &v1alpha1.HealthcareConsentStore{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("healthcareconsentstores").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(healthcareConsentStore).
		Do(ctx).
		Into(result)
	return
}
...
func (c *healthcareConsentStores) Update(ctx context.Context, healthcareConsentStore *v1alpha1.HealthcareConsentStore, opts v1.UpdateOptions) (result *v1alpha1.HealthcareConsentStore, err error) {
	result = &v1alpha1.HealthcareConsentStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthcareconsentstores").
		Name(healthcareConsentStore.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(healthcareConsentStore).
		Do(ctx).
		Into(result)
...
func (c *healthcareConsentStores) UpdateStatus(ctx context.Context, healthcareConsentStore *v1alpha1.HealthcareConsentStore, opts v1.UpdateOptions) (result *v1alpha1.HealthcareConsentStore, err error) {
	result = &v1alpha1.HealthcareConsentStore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("healthcareconsentstores").
...
func (c *healthcareConsentStores) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *healthcareConsentStores) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *healthcareConsentStores) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.HealthcareConsentStore, err error) {
	result = &v1alpha1.HealthcareConsentStore{}
