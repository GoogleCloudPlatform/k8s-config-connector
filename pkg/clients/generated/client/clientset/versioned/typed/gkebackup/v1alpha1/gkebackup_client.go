...
type GkebackupV1alpha1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*GkebackupV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new GkebackupV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*GkebackupV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &GkebackupV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new GkebackupV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *GkebackupV1alpha1Client {
...
// New creates a new GkebackupV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *GkebackupV1alpha1Client {
	return &GkebackupV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := gkebackupv1alpha1.SchemeGroupVersion
...
func (c *GkebackupV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
