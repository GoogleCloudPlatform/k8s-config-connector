...
type CloudsecuritycomplianceV1alpha1Client struct {
	restClient rest.Interface
}
...
func (c *CloudsecuritycomplianceV1alpha1Client) CloudSecurityFrameworks(namespace string) CloudSecurityFrameworkInterface {
	return newCloudSecurityFrameworks(c, namespace)
}

// NewForConfig creates a new CloudsecuritycomplianceV1alpha1Client for the given config.
// NewForConfig is equivalent to NewForConfigAndClient(c, httpClient),
// where httpClient was generated with rest.HTTPClientFor(c).
func NewForConfig(c *rest.Config) (*CloudsecuritycomplianceV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new CloudsecuritycomplianceV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*CloudsecuritycomplianceV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &CloudsecuritycomplianceV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new CloudsecuritycomplianceV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *CloudsecuritycomplianceV1alpha1Client {
...
// New creates a new CloudsecuritycomplianceV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *CloudsecuritycomplianceV1alpha1Client {
	return &CloudsecuritycomplianceV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := cloudsecuritycompliancev1alpha1.SchemeGroupVersion
...
func (c *CloudsecuritycomplianceV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
