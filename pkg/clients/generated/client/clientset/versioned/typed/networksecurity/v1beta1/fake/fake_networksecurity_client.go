...
import (
	v1beta1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/client/clientset/versioned/typed/networksecurity/v1beta1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeNetworksecurityV1beta1 struct {
	*testing.Fake
}

func (c *FakeNetworksecurityV1beta1) NetworkSecurityAddressGroups(namespace string) v1beta1.NetworkSecurityAddressGroupInterface {
	return &FakeNetworkSecurityAddressGroups{c, namespace}
}
...
func (c *FakeNetworksecurityV1beta1) RESTClient() rest.Interface {
