...
type NetworksecurityV1alpha1Interface interface {
	...
	NetworkSecurityMirroringEndpointGroupAssociationsGetter
...
func (c *NetworksecurityV1alpha1Client) NetworkSecurityMirroringEndpointGroupAssociations(namespace string) NetworkSecurityMirroringEndpointGroupAssociationInterface {
	return newNetworkSecurityMirroringEndpointGroupAssociations(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*NetworksecurityV1alpha1Client, error) {
	config := *c
...
// NewForConfigAndClient creates a new NetworksecurityV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NetworksecurityV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &NetworksecurityV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NetworksecurityV1alpha1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *NetworksecurityV1alpha1Client {
...
// New creates a new NetworksecurityV1alpha1Client for the given RESTClient.
func New(c rest.Interface) *NetworksecurityV1alpha1Client {
	return &NetworksecurityV1alpha1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := networksecurityv1alpha1.SchemeGroupVersion
...
func (c *NetworksecurityV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
