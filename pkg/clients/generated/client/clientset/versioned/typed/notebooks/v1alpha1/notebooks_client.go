...
func (c *NotebooksV1alpha1Client) NotebookInstanceV2s(namespace string) NotebookInstanceV2Interface {
	return newNotebookInstanceV2s(c, namespace)
}

func (c *NotebooksV1alpha1Client) NotebooksEnvironments(namespace string) NotebooksEnvironmentInterface {
	return newNotebooksEnvironments(c, namespace)
}
...
// NewForConfigAndClient creates a new NotebooksV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NotebooksV1alpha1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := notebooksv1alpha1.SchemeGroupVersion
