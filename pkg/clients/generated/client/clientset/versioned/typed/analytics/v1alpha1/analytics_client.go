...
type AnalyticsV1alpha1Interface interface {
	...
	AnalyticsAccountsGetter
}

// AnalyticsV1alpha1Client is used to interact with features provided by the analytics.cnrm.cloud.google.com group.
type AnalyticsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *AnalyticsV1alpha1Client) AnalyticsAccounts(namespace string) AnalyticsAccountInterface {
	return newAnalyticsAccounts(c, namespace)
}
