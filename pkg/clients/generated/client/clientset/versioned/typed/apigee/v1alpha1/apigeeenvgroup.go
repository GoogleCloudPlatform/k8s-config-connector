...
func newApigeeEnvgroups(c *ApigeeV1alpha1Client, namespace string) *apigeeEnvgroups {
...
func (c *apigeeEnvgroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeEnvgroup, err error) {
	result = &v1alpha1.ApigeeEnvgroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apigeeEnvgroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeEnvgroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApigeeEnvgroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apigeeenvgroups").
...
func (c *apigeeEnvgroups) Create(ctx context.Context, apigeeEnvgroup *v1alpha1.ApigeeEnvgroup, opts v1.CreateOptions) (result *v1alpha1.ApigeeEnvgroup, err error) {
	result = &v1alpha1.ApigeeEnvgroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigeeenvgroups").
...
func (c *apigeeEnvgroups) Update(ctx context.Context, apigeeEnvgroup *v1alpha1.ApigeeEnvgroup, opts v1.UpdateOptions) (result *v1alpha1.ApigeeEnvgroup, err error) {
	result = &v1alpha1.ApigeeEnvgroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeenvgroups").
...
func (c *apigeeEnvgroups) UpdateStatus(ctx context.Context, apigeeEnvgroup *v1alpha1.ApigeeEnvgroup, opts v1.UpdateOptions) (result *v1alpha1.ApigeeEnvgroup, err error) {
	result = &v1alpha1.ApigeeEnvgroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeenvgroups").
...
func (c *apigeeEnvgroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeEnvgroup, err error) {
	result = &v1alpha1.ApigeeEnvgroup{}
