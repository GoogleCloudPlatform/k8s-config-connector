...
func (c *apigeeNATAddresses) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeNATAddress, err error) {
	result = &v1alpha1.ApigeeNATAddress{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apigeeNATAddresses) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeNATAddressList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApigeeNATAddressList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apigeenataddresses").
...
func (c *apigeeNATAddresses) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apigeeNATAddresses) Create(ctx context.Context, apigeeNATAddress *v1alpha1.ApigeeNATAddress, opts v1.CreateOptions) (result *v1alpha1.ApigeeNATAddress, err error) {
	result = &v1alpha1.ApigeeNATAddress{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigeenataddresses").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apigeeNATAddress).
		Do(ctx).
		Into(result)
	return
}
...
func (c *apigeeNATAddresses) Update(ctx context.Context, apigeeNATAddress *v1alpha1.ApigeeNATAddress, opts v1.UpdateOptions) (result *v1alpha1.ApigeeNATAddress, err error) {
	result = &v1alpha1.ApigeeNATAddress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeenataddresses").
		Name(apigeeNATAddress.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apigeeNATAddress).
		Do(ctx).
		Into(result)
...
func (c *apigeeNATAddresses) UpdateStatus(ctx context.Context, apigeeNATAddress *v1alpha1.ApigeeNATAddress, opts v1.UpdateOptions) (result *v1alpha1.ApigeeNATAddress, err error) {
	result = &v1alpha1.ApigeeNATAddress{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeenataddresses").
...
func (c *apigeeNATAddresses) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apigeeNATAddresses) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apigeeNATAddresses) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeNATAddress, err error) {
	result = &v1alpha1.ApigeeNATAddress{}
