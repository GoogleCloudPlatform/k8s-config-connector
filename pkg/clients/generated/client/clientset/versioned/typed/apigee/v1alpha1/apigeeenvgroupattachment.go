...
func newApigeeEnvgroupAttachments(c *ApigeeV1alpha1Client, namespace string) *apigeeEnvgroupAttachments {
...
func (c *apigeeEnvgroupAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeEnvgroupAttachment, err error) {
	result = &v1alpha1.ApigeeEnvgroupAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apigeeEnvgroupAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeEnvgroupAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApigeeEnvgroupAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apigeeenvgroupattachments").
...
func (c *apigeeEnvgroupAttachments) Create(ctx context.Context, apigeeEnvgroupAttachment *v1alpha1.ApigeeEnvgroupAttachment, opts v1.CreateOptions) (result *v1alpha1.ApigeeEnvgroupAttachment, err error) {
	result = &v1alpha1.ApigeeEnvgroupAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigeeenvgroupattachments").
...
func (c *apigeeEnvgroupAttachments) Update(ctx context.Context, apigeeEnvgroupAttachment *v1alpha1.ApigeeEnvgroupAttachment, opts v1.UpdateOptions) (result *v1alpha1.ApigeeEnvgroupAttachment, err error) {
	result = &v1alpha1.ApigeeEnvgroupAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeenvgroupattachments").
...
func (c *apigeeEnvgroupAttachments) UpdateStatus(ctx context.Context, apigeeEnvgroupAttachment *v1alpha1.ApigeeEnvgroupAttachment, opts v1.UpdateOptions) (result *v1alpha1.ApigeeEnvgroupAttachment, err error) {
	result = &v1alpha1.ApigeeEnvgroupAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeenvgroupattachments").
...
func (c *apigeeEnvgroupAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeEnvgroupAttachment, err error) {
	result = &v1alpha1.ApigeeEnvgroupAttachment{}
