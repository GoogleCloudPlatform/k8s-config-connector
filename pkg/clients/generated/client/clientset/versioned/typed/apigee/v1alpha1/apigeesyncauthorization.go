...
func (c *apigeeSyncAuthorizations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeSyncAuthorization, err error) {
	result = &v1alpha1.ApigeeSyncAuthorization{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apigeeSyncAuthorizations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeSyncAuthorizationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApigeeSyncAuthorizationList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apigeesyncauthorizations").
...
func (c *apigeeSyncAuthorizations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *apigeeSyncAuthorizations) Create(ctx context.Context, apigeeSyncAuthorization *v1alpha1.ApigeeSyncAuthorization, opts v1.CreateOptions) (result *v1alpha1.ApigeeSyncAuthorization, err error) {
	result = &v1alpha1.ApigeeSyncAuthorization{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigeesyncauthorizations").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apigeeSyncAuthorization).
		Do(ctx).
		Into(result)
	return
}
...
func (c *apigeeSyncAuthorizations) Update(ctx context.Context, apigeeSyncAuthorization *v1alpha1.ApigeeSyncAuthorization, opts v1.UpdateOptions) (result *v1alpha1.ApigeeSyncAuthorization, err error) {
	result = &v1alpha1.ApigeeSyncAuthorization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeesyncauthorizations").
		Name(apigeeSyncAuthorization.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(apigeeSyncAuthorization).
		Do(ctx).
		Into(result)
...
func (c *apigeeSyncAuthorizations) UpdateStatus(ctx context.Context, apigeeSyncAuthorization *v1alpha1.ApigeeSyncAuthorization, opts v1.UpdateOptions) (result *v1alpha1.ApigeeSyncAuthorization, err error) {
	result = &v1alpha1.ApigeeSyncAuthorization{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeesyncauthorizations").
...
func (c *apigeeSyncAuthorizations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *apigeeSyncAuthorizations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *apigeeSyncAuthorizations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeSyncAuthorization, err error) {
	result = &v1alpha1.ApigeeSyncAuthorization{}
