...
func newApigeeInstanceAttachments(c *ApigeeV1alpha1Client, namespace string) *apigeeInstanceAttachments {
...
func (c *apigeeInstanceAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeInstanceAttachment, err error) {
	result = &v1alpha1.ApigeeInstanceAttachment{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apigeeInstanceAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeInstanceAttachmentList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApigeeInstanceAttachmentList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apigeeinstanceattachments").
...
func (c *apigeeInstanceAttachments) Create(ctx context.Context, apigeeInstanceAttachment *v1alpha1.ApigeeInstanceAttachment, opts v1.CreateOptions) (result *v1alpha1.ApigeeInstanceAttachment, err error) {
	result = &v1alpha1.ApigeeInstanceAttachment{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigeeinstanceattachments").
...
func (c *apigeeInstanceAttachments) Update(ctx context.Context, apigeeInstanceAttachment *v1alpha1.ApigeeInstanceAttachment, opts v1.UpdateOptions) (result *v1alpha1.ApigeeInstanceAttachment, err error) {
	result = &v1alpha1.ApigeeInstanceAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeinstanceattachments").
...
func (c *apigeeInstanceAttachments) UpdateStatus(ctx context.Context, apigeeInstanceAttachment *v1alpha1.ApigeeInstanceAttachment, opts v1.UpdateOptions) (result *v1alpha1.ApigeeInstanceAttachment, err error) {
	result = &v1alpha1.ApigeeInstanceAttachment{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeinstanceattachments").
...
func (c *apigeeInstanceAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeInstanceAttachment, err error) {
	result = &v1alpha1.ApigeeInstanceAttachment{}
