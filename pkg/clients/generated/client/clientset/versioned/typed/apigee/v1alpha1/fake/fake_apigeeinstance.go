...
func (c *FakeApigeeInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(apigeeinstancesResource, c.ns, name), &v1alpha1.ApigeeInstance{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApigeeInstance), err
}

// List takes label and field selectors, and returns the list of ApigeeInstances that match those selectors.
func (c *FakeApigeeInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeInstanceList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(apigeeinstancesResource, apigeeinstancesKind, c.ns, opts), &v1alpha1.ApigeeInstanceList{})
	...
	list := &v1alpha1.ApigeeInstanceList{ListMeta: obj.(*v1alpha1.ApigeeInstanceList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApigeeInstanceList).Items {
...
func (c *FakeApigeeInstances) Create(ctx context.Context, apigeeInstance *v1alpha1.ApigeeInstance, opts v1.CreateOptions) (result *v1alpha1.ApigeeInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(apigeeinstancesResource, c.ns, apigeeInstance), &v1alpha1.ApigeeInstance{})
...
func (c *FakeApigeeInstances) Update(ctx context.Context, apigeeInstance *v1alpha1.ApigeeInstance, opts v1.UpdateOptions) (result *v1alpha1.ApigeeInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(apigeeinstancesResource, c.ns, apigeeInstance), &v1alpha1.ApigeeInstance{})
...
func (c *FakeApigeeInstances) UpdateStatus(ctx context.Context, apigeeInstance *v1alpha1.ApigeeInstance, opts v1.UpdateOptions) (*v1alpha1.ApigeeInstance, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(apigeeinstancesResource, "status", c.ns, apigeeInstance), &v1alpha1.ApigeeInstance{})
...
func (c *FakeApigeeInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(apigeeinstancesResource, c.ns, name, opts), &v1alpha1.ApigeeInstance{})
...
func (c *FakeApigeeInstances) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.ApigeeInstanceList{})
	return err
}
...
func (c *FakeApigeeInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeInstance, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(apigeeinstancesResource, c.ns, name, pt, data, subresources...), &v1alpha1.ApigeeInstance{})
