...
var apigeeenvgroupsResource = v1alpha1.SchemeGroupVersion.WithResource("apigeeenvgroups")

var apigeeenvgroupsKind = v1alpha1.SchemeGroupVersion.WithKind("ApigeeEnvgroup")
