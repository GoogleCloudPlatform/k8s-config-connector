...
var apigeeenvgroupsResource = schema.GroupVersionResource{Group: "apigee.cnrm.cloud.google.com", Version: "v1alpha1", Resource: "apigeeenvgroups"}

var apigeeenvgroupsKind = schema.GroupVersionKind{Group: "apigee.cnrm.cloud.google.com", Version: "v1alpha1", Kind: "ApigeeEnvgroup"}
...
func (c *FakeApigeeEnvgroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeEnvgroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(apigeeenvgroupsResource, c.ns, name), &v1alpha1.ApigeeEnvgroup{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.ApigeeEnvgroup), err
}

// List takes label and field selectors, and returns the list of ApigeeEnvgroups that match those selectors.
func (c *FakeApigeeEnvgroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeEnvgroupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(apigeeenvgroupsResource, apigeeenvgroupsKind, c.ns, opts), &v1alpha1.ApigeeEnvgroupList{})
	...
	list := &v1alpha1.ApigeeEnvgroupList{ListMeta: obj.(*v1alpha1.ApigeeEnvgroupList).ListMeta}
	for _, item := range obj.(*v1alpha1.ApigeeEnvgroupList).Items {
...
func (c *FakeApigeeEnvgroups) Create(ctx context.Context, apigeeEnvgroup *v1alpha1.ApigeeEnvgroup, opts v1.CreateOptions) (result *v1alpha1.ApigeeEnvgroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(apigeeenvgroupsResource, c.ns, apigeeEnvgroup), &v1alpha1.ApigeeEnvgroup{})
...
func (c *FakeApigeeEnvgroups) Update(ctx context.Context, apigeeEnvgroup *v1alpha1.ApigeeEnvgroup, opts v1.UpdateOptions) (result *v1alpha1.ApigeeEnvgroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(apigeeenvgroupsResource, c.ns, apigeeEnvgroup), &v1alpha1.ApigeeEnvgroup{})
...
func (c *FakeApigeeEnvgroups) UpdateStatus(ctx context.Context, apigeeEnvgroup *v1alpha1.ApigeeEnvgroup, opts v1.UpdateOptions) (*v1alpha1.ApigeeEnvgroup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(apigeeenvgroupsResource, "status", c.ns, apigeeEnvgroup), &v1alpha1.ApigeeEnvgroup{})
...
func (c *FakeApigeeEnvgroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(apigeeenvgroupsResource, c.ns, name, opts), &v1alpha1.ApigeeEnvgroup{})
...
func (c *FakeApigeeEnvgroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.ApigeeEnvgroupList{})
	return err
}
...
func (c *FakeApigeeEnvgroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeEnvgroup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(apigeeenvgroupsResource, c.ns, name, pt, data, subresources...), &v1alpha1.ApigeeEnvgroup{})
