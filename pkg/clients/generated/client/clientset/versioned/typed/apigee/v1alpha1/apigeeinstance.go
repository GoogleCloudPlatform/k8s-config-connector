...
func newApigeeInstances(c *ApigeeV1alpha1Client, namespace string) *apigeeInstances {
...
func (c *apigeeInstances) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ApigeeInstance, err error) {
	result = &v1alpha1.ApigeeInstance{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *apigeeInstances) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ApigeeInstanceList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.ApigeeInstanceList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("apigeeinstances").
...
func (c *apigeeInstances) Create(ctx context.Context, apigeeInstance *v1alpha1.ApigeeInstance, opts v1.CreateOptions) (result *v1alpha1.ApigeeInstance, err error) {
	result = &v1alpha1.ApigeeInstance{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("apigeeinstances").
...
func (c *apigeeInstances) Update(ctx context.Context, apigeeInstance *v1alpha1.ApigeeInstance, opts v1.UpdateOptions) (result *v1alpha1.ApigeeInstance, err error) {
	result = &v1alpha1.ApigeeInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeinstances").
...
func (c *apigeeInstances) UpdateStatus(ctx context.Context, apigeeInstance *v1alpha1.ApigeeInstance, opts v1.UpdateOptions) (result *v1alpha1.ApigeeInstance, err error) {
	result = &v1alpha1.ApigeeInstance{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("apigeeinstances").
...
func (c *apigeeInstances) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ApigeeInstance, err error) {
	result = &v1alpha1.ApigeeInstance{}
