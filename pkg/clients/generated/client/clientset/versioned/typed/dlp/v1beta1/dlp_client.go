...
func (c *DlpV1beta1Client) DLPStoredInfoTypes(namespace string) DLPStoredInfoTypeInterface {
	return newDLPStoredInfoTypes(c, namespace)
}

// NewForConfig creates a new DlpV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new DlpV1beta1Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DlpV1beta1Client, error) {
	...
	return &DlpV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new DlpV1beta1Client for the given config and
...
func New(c rest.Interface) *DlpV1beta1Client {
	return &DlpV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := dlpv1beta1.SchemeGroupVersion
