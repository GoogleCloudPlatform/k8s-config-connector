...
func (c *dLPStoredInfoTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DLPStoredInfoType, err error) {
	result = &v1beta1.DLPStoredInfoType{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dLPStoredInfoTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DLPStoredInfoTypeList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DLPStoredInfoTypeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dlpstoredinfotypes").
...
func (c *dLPStoredInfoTypes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dLPStoredInfoTypes) Create(ctx context.Context, dLPStoredInfoType *v1beta1.DLPStoredInfoType, opts v1.CreateOptions) (result *v1beta1.DLPStoredInfoType, err error) {
	result = &v1beta1.DLPStoredInfoType{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dlpstoredinfotypes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dLPStoredInfoType).
		Do(ctx).
		Into(result)
	return
}
...
func (c *dLPStoredInfoTypes) Update(ctx context.Context, dLPStoredInfoType *v1beta1.DLPStoredInfoType, opts v1.UpdateOptions) (result *v1beta1.DLPStoredInfoType, err error) {
	result = &v1beta1.DLPStoredInfoType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dlpstoredinfotypes").
		Name(dLPStoredInfoType.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dLPStoredInfoType).
		Do(ctx).
		Into(result)
...
func (c *dLPStoredInfoTypes) UpdateStatus(ctx context.Context, dLPStoredInfoType *v1beta1.DLPStoredInfoType, opts v1.UpdateOptions) (result *v1beta1.DLPStoredInfoType, err error) {
	result = &v1beta1.DLPStoredInfoType{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dlpstoredinfotypes").
...
func (c *dLPStoredInfoTypes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dLPStoredInfoTypes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dLPStoredInfoTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DLPStoredInfoType, err error) {
	result = &v1beta1.DLPStoredInfoType{}
