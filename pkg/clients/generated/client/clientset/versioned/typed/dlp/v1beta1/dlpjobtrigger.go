...
func (c *dLPJobTriggers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DLPJobTrigger, err error) {
	result = &v1beta1.DLPJobTrigger{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dLPJobTriggers) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DLPJobTriggerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DLPJobTriggerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dlpjobtriggers").
...
func (c *dLPJobTriggers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *dLPJobTriggers) Create(ctx context.Context, dLPJobTrigger *v1beta1.DLPJobTrigger, opts v1.CreateOptions) (result *v1beta1.DLPJobTrigger, err error) {
	result = &v1beta1.DLPJobTrigger{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dlpjobtriggers").
...
func (c *dLPJobTriggers) Update(ctx context.Context, dLPJobTrigger *v1beta1.DLPJobTrigger, opts v1.UpdateOptions) (result *v1beta1.DLPJobTrigger, err error) {
	result = &v1beta1.DLPJobTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dlpjobtriggers").
		Name(dLPJobTrigger.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(dLPJobTrigger).
		Do(ctx).
		Into(result)
...
func (c *dLPJobTriggers) UpdateStatus(ctx context.Context, dLPJobTrigger *v1beta1.DLPJobTrigger, opts v1.UpdateOptions) (result *v1beta1.DLPJobTrigger, err error) {
	result = &v1beta1.DLPJobTrigger{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dlpjobtriggers").
...
func (c *dLPJobTriggers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *dLPJobTriggers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *dLPJobTriggers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DLPJobTrigger, err error) {
	result = &v1beta1.DLPJobTrigger{}
