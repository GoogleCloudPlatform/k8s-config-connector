...
import (
	v1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/clients/generated/client/clientset/versioned/typed/dlp/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeDlpV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeDlpV1alpha1) RESTClient() rest.Interface {
