...
type ContainerV1beta1Interface interface {
...
// NewForConfigAndClient creates a new ContainerV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ContainerV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &ContainerV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new ContainerV1beta1Client for the given config and
...
func New(c rest.Interface) *ContainerV1beta1Client {
	return &ContainerV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := containerv1beta1.SchemeGroupVersion
