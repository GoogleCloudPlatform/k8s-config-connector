...
func (c *mLEngineModels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.MLEngineModel, err error) {
	result = &v1alpha1.MLEngineModel{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *mLEngineModels) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.MLEngineModelList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.MLEngineModelList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("mlenginemodels").
...
func (c *mLEngineModels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *mLEngineModels) Create(ctx context.Context, mLEngineModel *v1alpha1.MLEngineModel, opts v1.CreateOptions) (result *v1alpha1.MLEngineModel, err error) {
	result = &v1alpha1.MLEngineModel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("mlenginemodels").
...
func (c *mLEngineModels) Update(ctx context.Context, mLEngineModel *v1alpha1.MLEngineModel, opts v1.UpdateOptions) (result *v1alpha1.MLEngineModel, err error) {
	result = &v1alpha1.MLEngineModel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mlenginemodels").
		Name(mLEngineModel.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(mLEngineModel).
		Do(ctx).
		Into(result)
...
func (c *mLEngineModels) UpdateStatus(ctx context.Context, mLEngineModel *v1alpha1.MLEngineModel, opts v1.UpdateOptions) (result *v1alpha1.MLEngineModel, err error) {
	result = &v1alpha1.MLEngineModel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("mlenginemodels").
...
func (c *mLEngineModels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *mLEngineModels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *mLEngineModels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.MLEngineModel, err error) {
	result = &v1alpha1.MLEngineModel{}
