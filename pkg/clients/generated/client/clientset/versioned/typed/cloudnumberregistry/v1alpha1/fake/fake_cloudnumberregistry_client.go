...
func (c *FakeCloudnumberregistryV1alpha1) CloudNumberRegistryIpamAdminScopes(namespace string) v1alpha1.CloudNumberRegistryIpamAdminScopeInterface {
	return newFakeCloudNumberRegistryIpamAdminScopes(c, namespace)
}
