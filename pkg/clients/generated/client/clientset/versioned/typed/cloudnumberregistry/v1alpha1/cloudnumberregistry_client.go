...
type CloudnumberregistryV1alpha1Interface interface {
	...
	CloudNumberRegistryIpamAdminScopesGetter
...
func (c *CloudnumberregistryV1alpha1Client) CloudNumberRegistryIpamAdminScopes(namespace string) CloudNumberRegistryIpamAdminScopeInterface {
	return newCloudNumberRegistryIpamAdminScopes(c, namespace)
}
