...
// NewForConfigAndClient creates a new ServiceusageV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*ServiceusageV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
...
func setConfigDefaults(config *rest.Config) {
	gv := serviceusagev1beta1.SchemeGroupVersion
