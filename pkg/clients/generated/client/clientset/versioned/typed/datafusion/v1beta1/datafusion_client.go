...
type DatafusionV1beta1Interface interface {
	RESTClient() rest.Interface
	DataFusionInstancesGetter
}
...
func (c *DatafusionV1beta1Client) DataFusionInstances(namespace string) DataFusionInstanceInterface {
	return newDataFusionInstances(c, namespace)
}

// NewForConfig creates a new DatafusionV1beta1Client for the given config.
...
// NewForConfigAndClient creates a new DatafusionV1beta1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DatafusionV1beta1Client, error) {
	config := *c
	setConfigDefaults(&config)
	...
	return &DatafusionV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new DatafusionV1beta1Client for the given config and
...
func New(c rest.Interface) *DatafusionV1beta1Client {
	return &DatafusionV1beta1Client{c}
}

func setConfigDefaults(config *rest.Config) {
	gv := datafusionv1beta1.SchemeGroupVersion
