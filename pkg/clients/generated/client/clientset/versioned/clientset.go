...
type Interface interface {
	...
	ConfigdeploymentV1alpha1() configdeploymentv1alpha1.ConfigdeploymentV1alpha1Interface
	...
	MapmanagementV1alpha1() mapmanagementv1alpha1.MapmanagementV1alpha1Interface
	MapsplatformdatasetsV1alpha1() mapsplatformdatasetsv1alpha1.MapsplatformdatasetsV1alpha1Interface
	...
	RapidmigrationassessmentV1alpha1() rapidmigrationassessmentv1alpha1.RapidmigrationassessmentV1alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	configdeploymentV1alpha1         *configdeploymentv1alpha1.ConfigdeploymentV1alpha1Client
	...
	mapmanagementV1alpha1            *mapmanagementv1alpha1.MapmanagementV1alpha1Client
	mapsplatformdatasetsV1alpha1     *mapsplatformdatasetsv1alpha1.MapsplatformdatasetsV1alpha1Client
	...
	rapidmigrationassessmentV1alpha1 *rapidmigrationassessmentv1alpha1.RapidmigrationassessmentV1alpha1Client
...
func (c *Clientset) ConfigdeploymentV1alpha1() configdeploymentv1alpha1.ConfigdeploymentV1alpha1Interface {
	return c.configdeploymentV1alpha1
}
...
func (c *Clientset) DatamigrationV1alpha1() datamigrationv1alpha1.DatamigrationV1alpha1Interface {
	return c.datamigrationV1alpha1
}
...
func (c *Clientset) MapmanagementV1alpha1() mapmanagementv1alpha1.MapmanagementV1alpha1Interface {
	return c.mapmanagementV1alpha1
}
...
func (c *Clientset) MapsplatformdatasetsV1alpha1() mapsplatformdatasetsv1alpha1.MapsplatformdatasetsV1alpha1Interface {
	return c.mapsplatformdatasetsV1alpha1
}
...
func (c *Clientset) RapidmigrationassessmentV1alpha1() rapidmigrationassessmentv1alpha1.RapidmigrationassessmentV1alpha1Interface {
	return c.rapidmigrationassessmentV1alpha1
}
...
func (c *Clientset) WorkloadmanagerV1alpha1() workloadmanagerv1alpha1.WorkloadmanagerV1alpha1Interface {
	return c.workloadmanagerV1alpha1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.configdeploymentV1alpha1, err = configdeploymentv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	...
	cs.grafeasV1alpha1, err = grafeasv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	...
	cs.mapmanagementV1alpha1, err = mapmanagementv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	cs.mapsplatformdatasetsV1alpha1, err = mapsplatformdatasetsv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	...
	cs.rapidmigrationassessmentV1alpha1, err = rapidmigrationassessmentv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	...
	cs.videostitcherV1alpha1, err = videostitcherv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	...
	cs.visionaiV1alpha1, err = visionaiv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	...
	cs.workloadmanagerV1alpha1, err = workloadmanagerv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.configdeploymentV1alpha1 = configdeploymentv1alpha1.New(c)
	...
	cs.mapmanagementV1alpha1 = mapmanagementv1alpha1.New(c)
	cs.mapsplatformdatasetsV1alpha1 = mapsplatformdatasetsv1alpha1.New(c)
	...
	cs.rapidmigrationassessmentV1alpha1 = rapidmigrationassessmentv1alpha1.New(c)
