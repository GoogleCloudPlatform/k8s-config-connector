...
var localSchemeBuilder = runtime.SchemeBuilder{
	...
	accesscontextmanagerk8sv1alpha1.AddToScheme,
	aiplatformk8sv1alpha1.AddToScheme,
	alloydbv1beta1.AddToScheme,
	analyticsk8sv1alpha1.AddToScheme,
	apigatewayk8sv1alpha1.AddToScheme,
	apigatewayv1beta1.AddToScheme,
	apigeek8sv1alpha1.AddToScheme,
	apigeev1beta1.AddToScheme,
	apikeysk8sv1alpha1.AddToScheme,
	appenginek8sv1alpha1.AddToScheme,
	apphubk8sv1alpha1.AddToScheme,
	apphubv1beta1.AddToScheme,
	artifactregistryv1beta1.AddToScheme,
	assetv1beta1.AddToScheme,
	assuredworkloadsk8sv1alpha1.AddToScheme,
	backupdrk8sv1alpha1.AddToScheme,
	backupdrv1beta1.AddToScheme,
	batchk8sv1alpha1.AddToScheme,
	beyondcorpk8sv1alpha1.AddToScheme,
	bigqueryk8sv1alpha1.AddToScheme,
	bigqueryv1beta1.AddToScheme,
	bigqueryanalyticshubv1beta1.AddToScheme,
	bigquerybiglakek8sv1alpha1.AddToScheme,
	bigquerybiglakev1beta1.AddToScheme,
	bigqueryconnectionv1beta1.AddToScheme,
	bigquerydatapolicyk8sv1alpha1.AddToScheme,
	bigquerydatatransferv1beta1.AddToScheme,
	bigqueryreservationk8sv1alpha1.AddToScheme,
	bigqueryreservationv1beta1.AddToScheme,
	bigtablek8sv1alpha1.AddToScheme,
	bigtablev1beta1.AddToScheme,
	billingk8sv1alpha1.AddToScheme,
	billingbudgetsv1beta1.AddToScheme,
	binaryauthorizationv1beta1.AddToScheme,
	certificatemanagerk8sv1alpha1.AddToScheme,
	certificatemanagerv1beta1.AddToScheme,
	cloudassetk8sv1alpha1.AddToScheme,
	cloudbuildv1beta1.AddToScheme,
	clouddeployk8sv1alpha1.AddToScheme,
	clouddeployv1beta1.AddToScheme,
	clouddmsk8sv1alpha1.AddToScheme,
	cloudfunctionsv1beta1.AddToScheme,
	cloudfunctions2k8sv1alpha1.AddToScheme,
	cloudidentityv1beta1.AddToScheme,
	cloudidsv1beta1.AddToScheme,
	cloudiotk8sv1alpha1.AddToScheme,
	cloudquotav1beta1.AddToScheme,
	cloudschedulerv1beta1.AddToScheme,
	cloudtasksk8sv1alpha1.AddToScheme,
	colabk8sv1alpha1.AddToScheme,
	composerv1beta1.AddToScheme,
	computek8sv1alpha1.AddToScheme,
	computev1beta1.AddToScheme,
	configcontrollerv1beta1.AddToScheme,
	configdeliveryk8sv1alpha1.AddToScheme,
	containerv1beta1.AddToScheme,
	containeranalysisk8sv1alpha1.AddToScheme,
	containeranalysisv1beta1.AddToScheme,
	containerattachedv1beta1.AddToScheme,
	datacatalogk8sv1alpha1.AddToScheme,
	datacatalogv1beta1.AddToScheme,
	dataflowv1beta1.AddToScheme,
	dataformv1beta1.AddToScheme,
	datafusionv1beta1.AddToScheme,
	dataplexk8sv1alpha1.AddToScheme,
	dataprock8sv1alpha1.AddToScheme,
	dataprocv1beta1.AddToScheme,
	datastorek8sv1alpha1.AddToScheme,
	datastreamk8sv1alpha1.AddToScheme,
	deploymentmanagerk8sv1alpha1.AddToScheme,
	dialogflowk8sv1alpha1.AddToScheme,
	dialogflowcxk8sv1alpha1.AddToScheme,
	discoveryenginek8sv1alpha1.AddToScheme,
	dlpv1beta1.AddToScheme,
	dnsk8sv1alpha1.AddToScheme,
	dnsv1beta1.AddToScheme,
	documentaik8sv1alpha1.AddToScheme,
	documentaiv1beta1.AddToScheme,
	edgecontainerk8sv1alpha1.AddToScheme,
	edgecontainerv1beta1.AddToScheme,
	edgenetworkv1beta1.AddToScheme,
	essentialcontactsv1beta1.AddToScheme,
	eventarck8sv1alpha1.AddToScheme,
	eventarcv1beta1.AddToScheme,
	filestorek8sv1alpha1.AddToScheme,
	filestorev1beta1.AddToScheme,
	firebasek8sv1alpha1.AddToScheme,
	firebasedatabasek8sv1alpha1.AddToScheme,
	firebasehostingk8sv1alpha1.AddToScheme,
	firebasestoragek8sv1alpha1.AddToScheme,
	firestorek8sv1alpha1.AddToScheme,
	firestorev1beta1.AddToScheme,
	gkebackupk8sv1alpha1.AddToScheme,
	gkehubk8sv1alpha1.AddToScheme,
	gkehubv1beta1.AddToScheme,
	healthcarek8sv1alpha1.AddToScheme,
	iamk8sv1alpha1.AddToScheme,
	iamv1beta1.AddToScheme,
	iapv1beta1.AddToScheme,
	identityplatformk8sv1alpha1.AddToScheme,
	identityplatformv1beta1.AddToScheme,
	k8sv1alpha1.AddToScheme,
	kmsk8sv1alpha1.AddToScheme,
	kmsv1beta1.AddToScheme,
	loggingv1beta1.AddToScheme,
	managedkafkak8sv1alpha1.AddToScheme,
	managedkafkav1beta1.AddToScheme,
	memcachev1beta1.AddToScheme,
	memorystorek8sv1alpha1.AddToScheme,
	memorystorev1beta1.AddToScheme,
	metastorek8sv1alpha1.AddToScheme,
	metastorev1beta1.AddToScheme,
	mlenginek8sv1alpha1.AddToScheme,
	monitoringv1beta1.AddToScheme,
	netappk8sv1alpha1.AddToScheme,
	networkconnectivityk8sv1alpha1.AddToScheme,
	networkconnectivityv1beta1.AddToScheme,
	networkmanagementk8sv1alpha1.AddToScheme,
	networksecurityv1beta1.AddToScheme,
	networkservicesk8sv1alpha1.AddToScheme,
	networkservicesv1beta1.AddToScheme,
	notebooksk8sv1alpha1.AddToScheme,
	notebooksv1beta1.AddToScheme,
	orgpolicyk8sv1alpha1.AddToScheme,
	orgpolicyv1beta1.AddToScheme,
	osconfigk8sv1alpha1.AddToScheme,
	osconfigv1beta1.AddToScheme,
	oslogink8sv1alpha1.AddToScheme,
	parametermanagerk8sv1alpha1.AddToScheme,
	privatecav1beta1.AddToScheme,
	privilegedaccessmanagerv1beta1.AddToScheme,
	pubsubv1beta1.AddToScheme,
	pubsublitek8sv1alpha1.AddToScheme,
	pubsublitev1beta1.AddToScheme,
	recaptchaenterprisek8sv1alpha1.AddToScheme,
	...
	securitycenterk8sv1alpha1.AddToScheme,
	servicedirectoryv1beta1.AddToScheme,
	servicenetworkingk8sv1alpha1.AddToScheme,
	servicenetworkingv1beta1.AddToScheme,
	serviceusagek8sv1alpha1.AddToScheme,
	serviceusagev1beta1.AddToScheme,
	sourcerepov1beta1.AddToScheme,
	spannerk8sv1alpha1.AddToScheme,
	spannerv1beta1.AddToScheme,
	speechv1beta1.AddToScheme,
	sqlv1beta1.AddToScheme,
	storagek8sv1alpha1.AddToScheme,
	storagev1beta1.AddToScheme,
	storagetransferk8sv1alpha1.AddToScheme,
	storagetransferv1beta1.AddToScheme,
	tagsv1beta1.AddToScheme,
	tpuk8sv1alpha1.AddToScheme,
	vertexaik8sv1alpha1.AddToScheme,
	vertexaiv1beta1.AddToScheme,
	vmwareenginek8sv1alpha1.AddToScheme,
	vmwareenginev1beta1.AddToScheme,
	vpcaccessv1beta1.AddToScheme,
	workflowexecutionsk8sv1alpha1.AddToScheme,
	workflowsk8sv1alpha1.AddToScheme,
