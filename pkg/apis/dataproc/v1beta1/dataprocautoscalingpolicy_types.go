...
type AutoscalingpolicyBasicAlgorithm struct {
	...
	YarnConfig AutoscalingpolicyYarnConfig `json:"yarnConfig,omitempty"`
}
...
type DataprocAutoscalingPolicySpec struct {
	/*  */
	BasicAlgorithm AutoscalingpolicyBasicAlgorithm `json:"basicAlgorithm,omitempty"`
	...
	WorkerConfig AutoscalingpolicyWorkerConfig `json:"workerConfig,omitempty"`
}
