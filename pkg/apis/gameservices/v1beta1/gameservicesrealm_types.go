...
// GameServicesRealm is the Schema for the gameservices API
// +k8s:openapi-gen=true
type GameServicesRealm struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   GameServicesRealmSpec   `json:"spec,omitempty"`
	Status GameServicesRealmStatus `json:"status,omitempty"`
}
...
func init() {
	SchemeBuilder.Register(&GameServicesRealm{}, &GameServicesRealmList{})
}
