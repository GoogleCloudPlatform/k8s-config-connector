...
// Package v1beta1 contains API Schema definitions for the networkservices v1beta1 API group.
// +k8s:openapi-gen=true
// +k8s:deepcopy-gen=package,register
// +k8s:conversion-gen=github.com/GoogleCloudPlatform/k8s-config-connector/pkg/apis/networkservices
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "networkservices.cnrm.cloud.google.com", Version: "v1beta1"}
