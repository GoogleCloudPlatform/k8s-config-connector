...
func file_google_cloud_batch_v1alpha_task_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_google_cloud_batch_v1alpha_task_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_task_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_batch_v1alpha_task_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*Runnable_Container_)(nil),
		(*Runnable_Script_)(nil),
		(*Runnable_Barrier_)(nil),
	}
	file_google_cloud_batch_v1alpha_task_proto_msgTypes[11].OneofWrappers = []interface{}{
