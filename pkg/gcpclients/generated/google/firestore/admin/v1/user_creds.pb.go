...
var file_google_firestore_admin_v1_user_creds_proto_goTypes = []interface{}{
...
func file_google_firestore_admin_v1_user_creds_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_firestore_admin_v1_user_creds_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_firestore_admin_v1_user_creds_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_firestore_admin_v1_user_creds_proto_msgTypes[0].OneofWrappers = []interface{}{
