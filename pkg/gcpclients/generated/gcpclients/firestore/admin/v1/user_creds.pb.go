...
// 	protoc        v3.12.4
// source: gcpclients/firestore/admin/v1/user_creds.proto
...
func (UserCreds_State) Descriptor() protoreflect.EnumDescriptor {
	return file_gcpclients_firestore_admin_v1_user_creds_proto_enumTypes[0].Descriptor()
}

func (UserCreds_State) Type() protoreflect.EnumType {
	return &file_gcpclients_firestore_admin_v1_user_creds_proto_enumTypes[0]
}
...
func (UserCreds_State) EnumDescriptor() ([]byte, []int) {
	return file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescGZIP(), []int{0, 0}
}
...
type UserCreds struct {
	...
	// ENABLED on creation.
	State UserCreds_State `protobuf:"varint,4,opt,name=state,proto3,enum=gcpclients.firestore.admin.v1.UserCreds_State" json:"state,omitempty"`
...
func (x *UserCreds) Reset() {
	*x = UserCreds{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gcpclients_firestore_admin_v1_user_creds_proto_msgTypes[0]
...
func (*UserCreds) Descriptor() ([]byte, []int) {
	return file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescGZIP(), []int{0}
}
...
func (x *UserCreds_ResourceIdentity) Reset() {
	*x = UserCreds_ResourceIdentity{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gcpclients_firestore_admin_v1_user_creds_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var File_gcpclients_firestore_admin_v1_user_creds_proto protoreflect.FileDescriptor

var file_gcpclients_firestore_admin_v1_user_creds_proto_rawDesc = []byte{
	0x0a, 0x2e, 0x67, 0x63, 0x70, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x2f, 0x66, 0x69, 0x72,
	0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x76, 0x31, 0x2f,
	0x75, 0x73, 0x65, 0x72, 0x5f, 0x63, 0x72, 0x65, 0x64, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x1d, 0x67, 0x63, 0x70, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x73, 0x2e, 0x66, 0x69, 0x72,
	0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x76, 0x31, 0x1a,
	...
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x05, 0x0a,
	0x09, 0x55, 0x73, 0x65, 0x72, 0x43, 0x72, 0x65, 0x64, 0x73, 0x12, 0x17, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x67, 0x63, 0x70, 0x63, 0x6c, 0x69, 0x65,
	...
	0x74, 0x65, 0x12, 0x2c, 0x0a, 0x0f, 0x73, 0x65, 0x63, 0x75, 0x72, 0x65, 0x5f, 0x70, 0x61, 0x73,
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x42, 0x03, 0xe0, 0x41, 0x03,
	0x52, 0x0e, 0x73, 0x65, 0x63, 0x75, 0x72, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	0x12, 0x68, 0x0a, 0x11, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x65,
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x67, 0x63,
	...
	0x42, 0xe1, 0x01, 0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2e, 0x67, 0x63, 0x70, 0x63, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x73, 0x2e, 0x66, 0x69, 0x72, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x61, 0x64,
	0x6d, 0x69, 0x6e, 0x2e, 0x76, 0x31, 0x42, 0x0e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x72, 0x65, 0x64,
	0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x39, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x2e,
...
var (
	file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescOnce sync.Once
	file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescData = file_gcpclients_firestore_admin_v1_user_creds_proto_rawDesc
)

func file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescGZIP() []byte {
	file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescOnce.Do(func() {
		file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescData = protoimpl.X.CompressGZIP(file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescData)
	})
	return file_gcpclients_firestore_admin_v1_user_creds_proto_rawDescData
}

var file_gcpclients_firestore_admin_v1_user_creds_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_gcpclients_firestore_admin_v1_user_creds_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_gcpclients_firestore_admin_v1_user_creds_proto_goTypes = []interface{}{
	(UserCreds_State)(0),               // 0: gcpclients.firestore.admin.v1.UserCreds.State
	(*UserCreds)(nil),                  // 1: gcpclients.firestore.admin.v1.UserCreds
	(*UserCreds_ResourceIdentity)(nil), // 2: gcpclients.firestore.admin.v1.UserCreds.ResourceIdentity
	(*timestamp.Timestamp)(nil),        // 3: google.protobuf.Timestamp
}
var file_gcpclients_firestore_admin_v1_user_creds_proto_depIdxs = []int32{
	3, // 0: gcpclients.firestore.admin.v1.UserCreds.create_time:type_name -> google.protobuf.Timestamp
	3, // 1: gcpclients.firestore.admin.v1.UserCreds.update_time:type_name -> google.protobuf.Timestamp
	0, // 2: gcpclients.firestore.admin.v1.UserCreds.state:type_name -> gcpclients.firestore.admin.v1.UserCreds.State
	2, // 3: gcpclients.firestore.admin.v1.UserCreds.resource_identity:type_name -> gcpclients.firestore.admin.v1.UserCreds.ResourceIdentity
...
func init() { file_gcpclients_firestore_admin_v1_user_creds_proto_init() }
func file_gcpclients_firestore_admin_v1_user_creds_proto_init() {
	if File_gcpclients_firestore_admin_v1_user_creds_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_gcpclients_firestore_admin_v1_user_creds_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_gcpclients_firestore_admin_v1_user_creds_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	file_gcpclients_firestore_admin_v1_user_creds_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_gcpclients_firestore_admin_v1_user_creds_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_gcpclients_firestore_admin_v1_user_creds_proto_goTypes,
		DependencyIndexes: file_gcpclients_firestore_admin_v1_user_creds_proto_depIdxs,
		EnumInfos:         file_gcpclients_firestore_admin_v1_user_creds_proto_enumTypes,
		MessageInfos:      file_gcpclients_firestore_admin_v1_user_creds_proto_msgTypes,
	}.Build()
	File_gcpclients_firestore_admin_v1_user_creds_proto = out.File
	file_gcpclients_firestore_admin_v1_user_creds_proto_rawDesc = nil
	file_gcpclients_firestore_admin_v1_user_creds_proto_goTypes = nil
	file_gcpclients_firestore_admin_v1_user_creds_proto_depIdxs = nil
}
