...
// - protoc             v3.12.4
// source: gcpclients/cloud/sql/v1beta4/cloud_sql_tiers.proto
...
func (c *sqlTiersServiceClient) List(ctx context.Context, in *SqlTiersListRequest, opts ...grpc.CallOption) (*TiersListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gcpclients.cloud.sql.v1beta4.SqlTiersService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SqlTiersService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gcpclients.cloud.sql.v1beta4.SqlTiersService/List",
	}
...
var SqlTiersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gcpclients.cloud.sql.v1beta4.SqlTiersService",
	...
	Metadata: "gcpclients/cloud/sql/v1beta4/cloud_sql_tiers.proto",
}
