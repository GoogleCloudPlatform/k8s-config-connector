...
func init() {
	resourceContextMap["cloudidentitygroupbasic-direct"] = ResourceContext{
		ResourceKind: "CloudIdentityGroup",
		// direct resource with server-generated id
		SkipDriftDetection: true,
	}
	resourceContextMap["cloudidentitygroupfull-direct"] = ResourceContext{
		ResourceKind: "CloudIdentityGroup",
		// direct resource with server-generated id
		SkipDriftDetection: true,
	}
