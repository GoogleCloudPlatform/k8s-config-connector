...
func (rc ResourceContext) SupportsLabels(t *testing.T, smLoader *servicemappingloader.ServiceMappingLoader, u *unstructured.Unstructured) bool {
...
func (rc ResourceContext) Create(ctx context.Context, t *testing.T, u *unstructured.Unstructured, provider *tfschema.Provider, c client.Client, smLoader *servicemappingloader.ServiceMappingLoader, config *mmdcl.Config, dclConverter *dclconversion.Converter) (*unstructured.Unstructured, error) {
	rt, err := testreconciler.ReconcilerTypeForObject(t, u)
	if err != nil {
		panic(fmt.Errorf("error getting reconciler type: %w", err))
	}
...
func (rc ResourceContext) Get(ctx context.Context, t *testing.T, u *unstructured.Unstructured, provider *tfschema.Provider, c client.Client, smLoader *servicemappingloader.ServiceMappingLoader, cfg *mmdcl.Config, dclConverter *dclconversion.Converter, httpClient *http.Client) (*unstructured.Unstructured, error) {
	rt, err := testreconciler.ReconcilerTypeForObject(t, u)
	if err != nil {
		panic(fmt.Errorf("error getting reconciler type: %w", err))
	}
...
func (rc ResourceContext) Delete(ctx context.Context, t *testing.T, u *unstructured.Unstructured, provider *tfschema.Provider, c client.Client, smLoader *servicemappingloader.ServiceMappingLoader, cfg *mmdcl.Config, dclConverter *dclconversion.Converter, httpClient *http.Client) error {
	rt, err := testreconciler.ReconcilerTypeForObject(t, u)
	if err != nil {
		panic(fmt.Errorf("error getting reconciler type: %w", err))
	}
