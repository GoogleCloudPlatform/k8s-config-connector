...
// +generated:mapper
// krm.group: transcoder.cnrm.cloud.google.com
// krm.version: v1alpha1
// proto.service: google.cloud.video.transcoder.v1
...
func Input_FromProto(mapCtx *direct.MapContext, in *pb.Input) *krm.Input {
	...
	out.Attributes = InputAttributes_FromProto(mapCtx, in.GetAttributes())
	return out
}
func Input_ToProto(mapCtx *direct.MapContext, in *krm.Input) *pb.Input {
	...
	out.Attributes = InputAttributes_ToProto(mapCtx, in.Attributes)
	return out
}
func InputAttributes_FromProto(mapCtx *direct.MapContext, in *pb.InputAttributes) *krm.InputAttributes {
	if in == nil {
		return nil
	}
	out := &krm.InputAttributes{}
	out.TrackDefinitions = direct.Slice_FromProto(mapCtx, in.TrackDefinitions, TrackDefinition_FromProto)
	return out
}
func InputAttributes_ToProto(mapCtx *direct.MapContext, in *krm.InputAttributes) *pb.InputAttributes {
	if in == nil {
		return nil
	}
	out := &pb.InputAttributes{}
	out.TrackDefinitions = direct.Slice_ToProto(mapCtx, in.TrackDefinitions, TrackDefinition_ToProto)
	return out
}
func InputAttributesObservedState_FromProto(mapCtx *direct.MapContext, in *pb.InputAttributes) *krm.InputAttributesObservedState {
	if in == nil {
		return nil
	}
	out := &krm.InputAttributesObservedState{}
	out.TrackDefinitions = direct.Slice_FromProto(mapCtx, in.TrackDefinitions, TrackDefinitionObservedState_FromProto)
	return out
}
func InputAttributesObservedState_ToProto(mapCtx *direct.MapContext, in *krm.InputAttributesObservedState) *pb.InputAttributes {
	if in == nil {
		return nil
	}
	out := &pb.InputAttributes{}
	out.TrackDefinitions = direct.Slice_ToProto(mapCtx, in.TrackDefinitions, TrackDefinitionObservedState_ToProto)
	return out
}
func InputObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Input) *krm.InputObservedState {
	...
	out.Attributes = InputAttributesObservedState_FromProto(mapCtx, in.GetAttributes())
	return out
}
func InputObservedState_ToProto(mapCtx *direct.MapContext, in *krm.InputObservedState) *pb.Input {
	...
	// MISSING: URI
	// MISSING: PreprocessingConfig
	out.Attributes = InputAttributesObservedState_ToProto(mapCtx, in.Attributes)
	return out
}
...
func JobConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.JobConfig) *krm.JobConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krm.JobConfigObservedState{}
	out.Inputs = direct.Slice_FromProto(mapCtx, in.Inputs, InputObservedState_FromProto)
	// MISSING: EditList
...
func JobConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krm.JobConfigObservedState) *pb.JobConfig {
	if in == nil {
		return nil
	}
	out := &pb.JobConfig{}
	out.Inputs = direct.Slice_ToProto(mapCtx, in.Inputs, InputObservedState_ToProto)
	// MISSING: EditList
	// MISSING: ElementaryStreams
	// MISSING: MuxStreams
	// MISSING: Manifests
...
func MuxStream_FromProto(mapCtx *direct.MapContext, in *pb.MuxStream) *krm.MuxStream {
	...
	out.Fmp4 = MuxStream_Fmp4Config_FromProto(mapCtx, in.GetFmp4())
	return out
}
func MuxStream_ToProto(mapCtx *direct.MapContext, in *krm.MuxStream) *pb.MuxStream {
	...
	if oneof := MuxStream_Fmp4Config_ToProto(mapCtx, in.Fmp4); oneof != nil {
		out.ContainerConfig = &pb.MuxStream_Fmp4{Fmp4: oneof}
	}
	return out
}
func MuxStream_Fmp4Config_FromProto(mapCtx *direct.MapContext, in *pb.MuxStream_Fmp4Config) *krm.MuxStream_Fmp4Config {
	if in == nil {
		return nil
	}
	out := &krm.MuxStream_Fmp4Config{}
	out.CodecTag = direct.LazyPtr(in.GetCodecTag())
	return out
}
func MuxStream_Fmp4Config_ToProto(mapCtx *direct.MapContext, in *krm.MuxStream_Fmp4Config) *pb.MuxStream_Fmp4Config {
	if in == nil {
		return nil
	}
	out := &pb.MuxStream_Fmp4Config{}
	out.CodecTag = direct.ValueOf(in.CodecTag)
	return out
}
...
func SpriteSheet_TotalCount_ToProto(mapCtx *direct.MapContext, in *int32) *pb.SpriteSheet_TotalCount {
	if in == nil {
		return nil
	}
	return &pb.SpriteSheet_TotalCount{TotalCount: *in}
}
...
func TrackDefinition_FromProto(mapCtx *direct.MapContext, in *pb.TrackDefinition) *krm.TrackDefinition {
	if in == nil {
		return nil
	}
	out := &krm.TrackDefinition{}
	out.InputTrack = in.InputTrack
	out.Languages = in.Languages
	out.DetectLanguages = direct.LazyPtr(in.GetDetectLanguages())
	// MISSING: DetectedLanguages
	return out
}
func TrackDefinition_ToProto(mapCtx *direct.MapContext, in *krm.TrackDefinition) *pb.TrackDefinition {
	if in == nil {
		return nil
	}
	out := &pb.TrackDefinition{}
	out.InputTrack = in.InputTrack
	out.Languages = in.Languages
	out.DetectLanguages = direct.ValueOf(in.DetectLanguages)
	// MISSING: DetectedLanguages
	return out
}
func TrackDefinitionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.TrackDefinition) *krm.TrackDefinitionObservedState {
	if in == nil {
		return nil
	}
	out := &krm.TrackDefinitionObservedState{}
	// MISSING: InputTrack
	// MISSING: Languages
	// MISSING: DetectLanguages
	out.DetectedLanguages = in.DetectedLanguages
	return out
}
func TrackDefinitionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.TrackDefinitionObservedState) *pb.TrackDefinition {
	if in == nil {
		return nil
	}
	out := &pb.TrackDefinition{}
...
func TranscoderJobObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Job) *krm.TranscoderJobObservedState {
	if in == nil {
		return nil
	}
	out := &krm.TranscoderJobObservedState{}
	// MISSING: Name
	out.Config = JobConfigObservedState_FromProto(mapCtx, in.GetConfig())
...
func TranscoderJobObservedState_ToProto(mapCtx *direct.MapContext, in *krm.TranscoderJobObservedState) *pb.Job {
	if in == nil {
		return nil
	}
	out := &pb.Job{}
	// MISSING: Name
	if oneof := JobConfigObservedState_ToProto(mapCtx, in.Config); oneof != nil {
...
func TranscoderJobSpec_FromProto(mapCtx *direct.MapContext, in *pb.Job) *krm.TranscoderJobSpec {
	if in == nil {
		return nil
	}
	out := &krm.TranscoderJobSpec{}
	// MISSING: Name
	...
	out.FillContentGaps = direct.LazyPtr(in.GetFillContentGaps())
	return out
}
func TranscoderJobSpec_ToProto(mapCtx *direct.MapContext, in *krm.TranscoderJobSpec) *pb.Job {
	if in == nil {
		return nil
	}
	out := &pb.Job{}
	...
	if oneof := TranscoderJobSpec_TemplateId_ToProto(mapCtx, in.TemplateID); oneof != nil {
		out.JobConfig = oneof
	}
	...
	out.FillContentGaps = direct.ValueOf(in.FillContentGaps)
	return out
}
func TranscoderJobSpec_TemplateId_ToProto(mapCtx *direct.MapContext, in *string) *pb.Job_TemplateId {
	if in == nil {
		return nil
	}
	return &pb.Job_TemplateId{TemplateId: *in}
}
...
func VideoStream_H264CodecSettings_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_H264CodecSettings) *krm.VideoStream_H264CodecSettings {
	...
	out.FrameRateConversionStrategy = direct.Enum_FromProto(mapCtx, in.GetFrameRateConversionStrategy())
	out.BitrateBps = direct.LazyPtr(in.GetBitrateBps())
	...
	out.Sdr = VideoStream_H264ColorFormatSdr_FromProto(mapCtx, in.GetSdr())
	out.Hlg = VideoStream_H264ColorFormatHlg_FromProto(mapCtx, in.GetHlg())
	return out
}
func VideoStream_H264CodecSettings_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_H264CodecSettings) *pb.VideoStream_H264CodecSettings {
	...
	out.FrameRateConversionStrategy = direct.Enum_ToProto[pb.VideoStream_FrameRateConversionStrategy](mapCtx, in.FrameRateConversionStrategy)
	out.BitrateBps = direct.ValueOf(in.BitrateBps)
	...
	if oneof := VideoStream_H264ColorFormatSdr_ToProto(mapCtx, in.Sdr); oneof != nil {
		out.ColorFormat = &pb.VideoStream_H264CodecSettings_Sdr{Sdr: oneof}
	}
	if oneof := VideoStream_H264ColorFormatHlg_ToProto(mapCtx, in.Hlg); oneof != nil {
		out.ColorFormat = &pb.VideoStream_H264CodecSettings_Hlg{Hlg: oneof}
	}
	return out
}
func VideoStream_H264CodecSettings_GopFrameCount_ToProto(mapCtx *direct.MapContext, in *int32) *pb.VideoStream_H264CodecSettings_GopFrameCount {
	if in == nil {
		return nil
	}
	return &pb.VideoStream_H264CodecSettings_GopFrameCount{GopFrameCount: *in}
}
func VideoStream_H264ColorFormatHlg_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_H264ColorFormatHLG) *krm.VideoStream_H264ColorFormatHlg {
	if in == nil {
		return nil
	}
	out := &krm.VideoStream_H264ColorFormatHlg{}
	return out
}
func VideoStream_H264ColorFormatHlg_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_H264ColorFormatHlg) *pb.VideoStream_H264ColorFormatHLG {
	if in == nil {
		return nil
	}
	out := &pb.VideoStream_H264ColorFormatHLG{}
	return out
}
func VideoStream_H264ColorFormatSdr_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_H264ColorFormatSDR) *krm.VideoStream_H264ColorFormatSdr {
	if in == nil {
		return nil
	}
	out := &krm.VideoStream_H264ColorFormatSdr{}
	return out
}
func VideoStream_H264ColorFormatSdr_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_H264ColorFormatSdr) *pb.VideoStream_H264ColorFormatSDR {
	if in == nil {
		return nil
	}
	out := &pb.VideoStream_H264ColorFormatSDR{}
	return out
}
func VideoStream_H265CodecSettings_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_H265CodecSettings) *krm.VideoStream_H265CodecSettings {
	...
	out.Tune = direct.LazyPtr(in.GetTune())
	out.Preset = direct.LazyPtr(in.GetPreset())
	out.Sdr = VideoStream_H265ColorFormatSdr_FromProto(mapCtx, in.GetSdr())
	out.Hlg = VideoStream_H265ColorFormatHlg_FromProto(mapCtx, in.GetHlg())
	out.Hdr10 = VideoStream_H265ColorFormatHdr10_FromProto(mapCtx, in.GetHdr10())
	return out
}
func VideoStream_H265CodecSettings_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_H265CodecSettings) *pb.VideoStream_H265CodecSettings {
	...
	out.Tune = direct.ValueOf(in.Tune)
	out.Preset = direct.ValueOf(in.Preset)
	if oneof := VideoStream_H265ColorFormatSdr_ToProto(mapCtx, in.Sdr); oneof != nil {
		out.ColorFormat = &pb.VideoStream_H265CodecSettings_Sdr{Sdr: oneof}
	}
	if oneof := VideoStream_H265ColorFormatHlg_ToProto(mapCtx, in.Hlg); oneof != nil {
		out.ColorFormat = &pb.VideoStream_H265CodecSettings_Hlg{Hlg: oneof}
	}
	if oneof := VideoStream_H265ColorFormatHdr10_ToProto(mapCtx, in.Hdr10); oneof != nil {
		out.ColorFormat = &pb.VideoStream_H265CodecSettings_Hdr10{Hdr10: oneof}
	}
	return out
}
func VideoStream_H265CodecSettings_GopFrameCount_ToProto(mapCtx *direct.MapContext, in *int32) *pb.VideoStream_H265CodecSettings_GopFrameCount {
	if in == nil {
		return nil
	}
	return &pb.VideoStream_H265CodecSettings_GopFrameCount{GopFrameCount: *in}
}
func VideoStream_H265ColorFormatHdr10_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_H265ColorFormatHDR10) *krm.VideoStream_H265ColorFormatHdr10 {
	if in == nil {
		return nil
	}
	out := &krm.VideoStream_H265ColorFormatHdr10{}
	return out
}
func VideoStream_H265ColorFormatHdr10_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_H265ColorFormatHdr10) *pb.VideoStream_H265ColorFormatHDR10 {
	if in == nil {
		return nil
	}
	out := &pb.VideoStream_H265ColorFormatHDR10{}
	return out
}
func VideoStream_H265ColorFormatHlg_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_H265ColorFormatHLG) *krm.VideoStream_H265ColorFormatHlg {
	if in == nil {
		return nil
	}
	out := &krm.VideoStream_H265ColorFormatHlg{}
	return out
}
func VideoStream_H265ColorFormatHlg_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_H265ColorFormatHlg) *pb.VideoStream_H265ColorFormatHLG {
	if in == nil {
		return nil
	}
	out := &pb.VideoStream_H265ColorFormatHLG{}
	return out
}
func VideoStream_H265ColorFormatSdr_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_H265ColorFormatSDR) *krm.VideoStream_H265ColorFormatSdr {
	if in == nil {
		return nil
	}
	out := &krm.VideoStream_H265ColorFormatSdr{}
	return out
}
func VideoStream_H265ColorFormatSdr_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_H265ColorFormatSdr) *pb.VideoStream_H265ColorFormatSDR {
	if in == nil {
		return nil
	}
	out := &pb.VideoStream_H265ColorFormatSDR{}
	return out
}
func VideoStream_Vp9CodecSettings_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_Vp9CodecSettings) *krm.VideoStream_Vp9CodecSettings {
	...
	out.GopDuration = direct.StringDuration_FromProto(mapCtx, in.GetGopDuration())
	out.Profile = direct.LazyPtr(in.GetProfile())
	out.Sdr = VideoStream_Vp9ColorFormatSdr_FromProto(mapCtx, in.GetSdr())
	out.Hlg = VideoStream_Vp9ColorFormatHlg_FromProto(mapCtx, in.GetHlg())
	return out
}
func VideoStream_Vp9CodecSettings_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_Vp9CodecSettings) *pb.VideoStream_Vp9CodecSettings {
	...
	out.Profile = direct.ValueOf(in.Profile)
	if oneof := VideoStream_Vp9ColorFormatSdr_ToProto(mapCtx, in.Sdr); oneof != nil {
		out.ColorFormat = &pb.VideoStream_Vp9CodecSettings_Sdr{Sdr: oneof}
	}
	if oneof := VideoStream_Vp9ColorFormatHlg_ToProto(mapCtx, in.Hlg); oneof != nil {
		out.ColorFormat = &pb.VideoStream_Vp9CodecSettings_Hlg{Hlg: oneof}
	}
	return out
}
func VideoStream_Vp9CodecSettings_GopFrameCount_ToProto(mapCtx *direct.MapContext, in *int32) *pb.VideoStream_Vp9CodecSettings_GopFrameCount {
	if in == nil {
		return nil
	}
	return &pb.VideoStream_Vp9CodecSettings_GopFrameCount{GopFrameCount: *in}
}
func VideoStream_Vp9ColorFormatHlg_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_Vp9ColorFormatHLG) *krm.VideoStream_Vp9ColorFormatHlg {
	if in == nil {
		return nil
	}
	out := &krm.VideoStream_Vp9ColorFormatHlg{}
	return out
}
func VideoStream_Vp9ColorFormatHlg_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_Vp9ColorFormatHlg) *pb.VideoStream_Vp9ColorFormatHLG {
	if in == nil {
		return nil
	}
	out := &pb.VideoStream_Vp9ColorFormatHLG{}
	return out
}
func VideoStream_Vp9ColorFormatSdr_FromProto(mapCtx *direct.MapContext, in *pb.VideoStream_Vp9ColorFormatSDR) *krm.VideoStream_Vp9ColorFormatSdr {
	if in == nil {
		return nil
	}
	out := &krm.VideoStream_Vp9ColorFormatSdr{}
	return out
}
func VideoStream_Vp9ColorFormatSdr_ToProto(mapCtx *direct.MapContext, in *krm.VideoStream_Vp9ColorFormatSdr) *pb.VideoStream_Vp9ColorFormatSDR {
	if in == nil {
		return nil
	}
	out := &pb.VideoStream_Vp9ColorFormatSDR{}
	return out
}
