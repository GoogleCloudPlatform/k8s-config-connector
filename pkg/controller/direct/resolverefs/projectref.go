...
func AsProjectRef(in *v1alpha1.ResourceRef) *v1beta1.ProjectRef {
	if in == nil {
		return nil
	}
	return &v1beta1.ProjectRef{
...
func ResolveProjectRef(ctx context.Context, reader client.Reader, src client.Object, ref *v1beta1.ProjectRef) (*Project, error) {
	if ref == nil {
		return nil, nil
	}
