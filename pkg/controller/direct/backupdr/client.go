...
import (
	...
	api "cloud.google.com/go/backupdr/apiv1"
...
func (m *gcpClient) newBackupDRClient(ctx context.Context) (*api.Client, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("building backupdr client: %w", err)
	}
	return client, err
}
