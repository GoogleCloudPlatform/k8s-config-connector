...
func BackupDRBackupPlanAssociationSpec_Resource_v1beta1_FromProto(mapCtx *direct.MapContext, resource string, resourceType string) *krm.Resource {
	if resource == "" {
		return nil
	}
	out := &krm.Resource{}
	...
	if resourceType == krm.ResourceType_SQLInstance {
		out.SQLInstanceRef = &refs.SQLInstanceRef{External: resource}
	}
	return out
}
...
func BackupDRBackupPlanAssociationSpec_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.BackupPlanAssociation) *krm.BackupDRBackupPlanAssociationSpec {
	...
	out.Resource = BackupDRBackupPlanAssociationSpec_Resource_v1beta1_FromProto(mapCtx, in.GetResource(), in.GetResourceType())
	if in.GetBackupPlan() != "" {
...
func BackupDRBackupPlanAssociationSpec_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.BackupDRBackupPlanAssociationSpec) *pb.BackupPlanAssociation {
	...
	out.Resource = BackupDRBackupPlanAssociationSpec_Resource_v1beta1_ToProto(mapCtx, in.Resource)
