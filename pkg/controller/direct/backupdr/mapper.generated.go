...
func BackupDRBackupPlanAssociationObservedState_FromProto(mapCtx *direct.MapContext, in *pb.BackupPlanAssociation) *krmv1alpha1.BackupDRBackupPlanAssociationObservedState {
	if in == nil {
		return nil
	}
...
func BackupDRBackupPlanAssociationObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.BackupDRBackupPlanAssociationObservedState) *pb.BackupPlanAssociation {
	if in == nil {
		return nil
	}
...
func BackupDRBackupPlanObservedState_FromProto(mapCtx *direct.MapContext, in *pb.BackupPlan) *krmv1beta1.BackupDRBackupPlanObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1beta1.BackupDRBackupPlanObservedState{}
	// MISSING: Name
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
	out.UpdateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetUpdateTime())
	out.State = direct.Enum_FromProto(mapCtx, in.GetState())
...
func BackupDRBackupPlanObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.BackupDRBackupPlanObservedState) *pb.BackupPlan {
	if in == nil {
		return nil
	}
	out := &pb.BackupPlan{}
...
func BackupDRBackupVaultSpec_FromProto(mapCtx *direct.MapContext, in *pb.BackupVault) *krmv1alpha1.BackupDRBackupVaultSpec {
	if in == nil {
		return nil
	}
...
func BackupDRManagementServerSpec_FromProto(mapCtx *direct.MapContext, in *pb.ManagementServer) *krmv1alpha1.BackupDRManagementServerSpec {
	if in == nil {
		return nil
	}
...
func BackupDRManagementServerSpec_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.BackupDRManagementServerSpec) *pb.ManagementServer {
	if in == nil {
		return nil
	}
...
func BackupRule_FromProto(mapCtx *direct.MapContext, in *pb.BackupRule) *krmv1beta1.BackupRule {
	if in == nil {
		return nil
	}
...
func BackupRule_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.BackupRule) *pb.BackupRule {
	if in == nil {
		return nil
	}
	out := &pb.BackupRule{}
...
func BackupWindow_FromProto(mapCtx *direct.MapContext, in *pb.BackupWindow) *krmv1beta1.BackupWindow {
	if in == nil {
		return nil
	}
...
func BackupWindow_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.BackupWindow) *pb.BackupWindow {
	if in == nil {
		return nil
	}
	out := &pb.BackupWindow{}
...
func RuleConfigInfo_FromProto(mapCtx *direct.MapContext, in *pb.RuleConfigInfo) *krmv1alpha1.RuleConfigInfo {
	if in == nil {
		return nil
	}
...
func RuleConfigInfo_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.RuleConfigInfo) *pb.RuleConfigInfo {
	if in == nil {
		return nil
	}
...
func RuleConfigInfoObservedState_FromProto(mapCtx *direct.MapContext, in *pb.RuleConfigInfo) *krmv1alpha1.RuleConfigInfoObservedState {
	if in == nil {
		return nil
	}
...
func RuleConfigInfoObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.RuleConfigInfoObservedState) *pb.RuleConfigInfo {
	if in == nil {
		return nil
	}
	out := &pb.RuleConfigInfo{}
...
func StandardSchedule_FromProto(mapCtx *direct.MapContext, in *pb.StandardSchedule) *krmv1beta1.StandardSchedule {
	if in == nil {
		return nil
	}
...
func WeekDayOfMonth_FromProto(mapCtx *direct.MapContext, in *pb.WeekDayOfMonth) *krmv1beta1.WeekDayOfMonth {
	if in == nil {
		return nil
	}
...
func WorkforceIdentityBasedManagementURI_FromProto(mapCtx *direct.MapContext, in *pb.WorkforceIdentityBasedManagementURI) *krmv1alpha1.WorkforceIdentityBasedManagementURI {
	if in == nil {
		return nil
	}
...
func WorkforceIdentityBasedManagementURI_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.WorkforceIdentityBasedManagementURI) *pb.WorkforceIdentityBasedManagementURI {
	if in == nil {
		return nil
	}
...
func WorkforceIdentityBasedManagementURIObservedState_FromProto(mapCtx *direct.MapContext, in *pb.WorkforceIdentityBasedManagementURI) *krmv1alpha1.WorkforceIdentityBasedManagementURIObservedState {
	if in == nil {
		return nil
	}
...
func WorkforceIdentityBasedManagementURIObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.WorkforceIdentityBasedManagementURIObservedState) *pb.WorkforceIdentityBasedManagementURI {
	if in == nil {
		return nil
	}
	out := &pb.WorkforceIdentityBasedManagementURI{}
