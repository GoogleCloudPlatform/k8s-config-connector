...
func (a *BackupPlanAdapter) Find(ctx context.Context) (bool, error) {
	...
	req := &backupdrpb.GetBackupPlanRequest{Name: a.id}
...
func (a *BackupPlanAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	desiredPb := BackupdrBackupPlanSpec_ToProto(mapCtx, &a.desired.DeepCopy().Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	status := &krm.BackupdrBackupPlanStatus{}
	status.ObservedState = BackupdrBackupPlanObservedState_FromProto(mapCtx, updated)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	return updateOp.UpdateStatus(ctx, status, nil)
...
func (a *BackupPlanAdapter) Delete(ctx context.Context, deleteOp *directbase.DeleteOperation) (bool, error) {
	...
	req := &backupdrpb.DeleteBackupPlanRequest{Name: a.id.String()}
