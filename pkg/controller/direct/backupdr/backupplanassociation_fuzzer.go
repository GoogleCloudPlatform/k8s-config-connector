...
func backupDRBackupPlanAssociationFuzzer() fuzztesting.KRMFuzzer {
	f := fuzztesting.NewKRMTypedFuzzer(&pb.BackupPlanAssociation{},
		BackupDRBackupPlanAssociationSpec_v1alpha1_FromProto, BackupDRBackupPlanAssociationSpec_v1alpha1_ToProto,
		BackupDRBackupPlanAssociationObservedState_v1alpha1_FromProto, BackupDRBackupPlanAssociationObservedState_v1alpha1_ToProto,
	)
