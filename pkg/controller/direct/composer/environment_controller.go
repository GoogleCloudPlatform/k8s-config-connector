...
func (a *EnvironmentAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	fmt.Printf("maqiuyu... desiredPb:\n%+v\n", test.PrettyPrintJSON(desiredPb))
	fmt.Printf("maqiuyu... actual:\n%+v\n\n\n\n", test.PrettyPrintJSON(a.actual))
	populateDefaultsForEnvironment(desiredPb, a.actual)
	fmt.Printf("maqiuyu... desired after defaulting!!!!!!!!\n%+v\n", test.PrettyPrintJSON(desiredPb))
