...
import (
	...
	api "cloud.google.com/go/storage/control/apiv2"
...
func (m *gcpClient) newStorageControlClient(ctx context.Context) (*api.StorageControlClient, error) {
	opts, err := m.config.GRPCClientOptions()
	if err != nil {
		return nil, err
	}
	client, err := api.NewStorageControlClient(ctx, opts...)
	if err != nil {
