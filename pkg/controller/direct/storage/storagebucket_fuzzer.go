...
func StorageBucketFuzzer() fuzztesting.KRMFuzzer {
	...
	// Unimplemented / Not Yet Triaged / Ignored fields in Bucket proto
	...
	f.Unimplemented_NotYetTriaged(".project_number")
	...
	// Unimplemented nested fields in Bucket retention_policy
	f.Unimplemented_NotYetTriaged(".retention_policy.effective_time")

	// Unimplemented nested fields in Bucket autoclass
	f.Unimplemented_NotYetTriaged(".autoclass.toggle_time")
	f.Unimplemented_NotYetTriaged(".autoclass.terminal_storage_class")
