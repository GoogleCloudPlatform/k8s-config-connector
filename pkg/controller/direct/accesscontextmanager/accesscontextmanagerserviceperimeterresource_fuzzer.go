...
// +tool:fuzz-gen
// proto.message: google.identity.accesscontextmanager.v1.ServicePerimeterResource
...
func init() {
	fuzztesting.RegisterKRMFuzzer_NoProto(fuzzAccessContextManagerServicePerimeterResource())
}
