...
func DataplexMetadataFeedSpec_FromProto(mapCtx *direct.MapContext, in *pb.MetadataFeed) *krm.DataplexMetadataFeedSpec {
	...
	out.Scope = MetadataFeedScope_FromProto(mapCtx, in.GetScope())
	out.Filters = MetadataFeedFilters_FromProto(mapCtx, in.GetFilters())
...
func DataplexMetadataFeedSpec_ToProto(mapCtx *direct.MapContext, in *krm.DataplexMetadataFeedSpec) *pb.MetadataFeed {
	...
	out := &pb.MetadataFeed{}
	out.Scope = MetadataFeedScope_ToProto(mapCtx, in.Scope)
	out.Filters = MetadataFeedFilters_ToProto(mapCtx, in.Filters)
	out.Labels = in.Labels
