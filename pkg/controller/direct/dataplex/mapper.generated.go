...
func DataProductAccessApprovalConfig_FromProto(mapCtx *direct.MapContext, in *pb.DataProduct_AccessApprovalConfig) *krm.DataProductAccessApprovalConfig {
	if in == nil {
		return nil
	}
	out := &krm.DataProductAccessApprovalConfig{}
	out.ApproverEmails = in.ApproverEmails
	return out
}
func DataProductAccessApprovalConfig_ToProto(mapCtx *direct.MapContext, in *krm.DataProductAccessApprovalConfig) *pb.DataProduct_AccessApprovalConfig {
	if in == nil {
		return nil
	}
...
func DataplexDataProductSpec_FromProto(mapCtx *direct.MapContext, in *pb.DataProduct) *krm.DataplexDataProductSpec {
	...
	// MISSING: AccessGroups
	out.AccessApprovalConfig = DataProductAccessApprovalConfig_FromProto(mapCtx, in.GetAccessApprovalConfig())
	return out
}
func DataplexDataProductSpec_ToProto(mapCtx *direct.MapContext, in *krm.DataplexDataProductSpec) *pb.DataProduct {
	...
	out.OwnerEmails = in.OwnerEmails
	// MISSING: AccessGroups
	out.AccessApprovalConfig = DataProductAccessApprovalConfig_ToProto(mapCtx, in.AccessApprovalConfig)
	return out
}
