...
func DataScanJob_FromProto(mapCtx *direct.MapContext, in *pb.DataScanJob) *krm.DataScanJob {
	if in == nil {
		return nil
	}
	out := &krm.DataScanJob{}
...
func DataScanJob_ToProto(mapCtx *direct.MapContext, in *krm.DataScanJob) *pb.DataScanJob {
	if in == nil {
		return nil
	}
	out := &pb.DataScanJob{}
...
func DataScanJobObservedState_FromProto(mapCtx *direct.MapContext, in *pb.DataScanJob) *krm.DataScanJobObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DataScanJobObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
...
func DataScanJobObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DataScanJobObservedState) *pb.DataScanJob {
	if in == nil {
		return nil
	}
	out := &pb.DataScanJob{}
	...
	out.State = direct.Enum_ToProto[pb.DataScanJob_State](mapCtx, in.State)
	out.Message = direct.ValueOf(in.Message)
	...
	if oneof := DataQualitySpec_ToProto(mapCtx, in.DataQualitySpec); oneof != nil {
		out.Spec = &pb.DataScanJob_DataQualitySpec{DataQualitySpec: oneof}
	}
	if oneof := DataProfileSpec_ToProto(mapCtx, in.DataProfileSpec); oneof != nil {
		out.Spec = &pb.DataScanJob_DataProfileSpec{DataProfileSpec: oneof}
	}
	if oneof := DataDiscoverySpec_ToProto(mapCtx, in.DataDiscoverySpec); oneof != nil {
		out.Spec = &pb.DataScanJob_DataDiscoverySpec{DataDiscoverySpec: oneof}
	}
	if oneof := DataQualityResult_ToProto(mapCtx, in.DataQualityResult); oneof != nil {
		out.Result = &pb.DataScanJob_DataQualityResult{DataQualityResult: oneof}
	}
	if oneof := DataProfileResult_ToProto(mapCtx, in.DataProfileResult); oneof != nil {
		out.Result = &pb.DataScanJob_DataProfileResult{DataProfileResult: oneof}
	}
	if oneof := DataDiscoveryResult_ToProto(mapCtx, in.DataDiscoveryResult); oneof != nil {
		out.Result = &pb.DataScanJob_DataDiscoveryResult{DataDiscoveryResult: oneof}
	}
	return out
}
func DataplexDataScanJobObservedState_FromProto(mapCtx *direct.MapContext, in *pb.DataScanJob) *krm.DataplexDataScanJobObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DataplexDataScanJobObservedState{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: CreateTime
	// MISSING: StartTime
...
func DataplexDataScanJobObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DataplexDataScanJobObservedState) *pb.DataScanJob {
	if in == nil {
		return nil
	}
	out := &pb.DataScanJob{}
...
func DataplexDataScanJobSpec_FromProto(mapCtx *direct.MapContext, in *pb.DataScanJob) *krm.DataplexDataScanJobSpec {
	if in == nil {
		return nil
	}
	out := &krm.DataplexDataScanJobSpec{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: CreateTime
	// MISSING: StartTime
...
func DataplexDataScanJobSpec_ToProto(mapCtx *direct.MapContext, in *krm.DataplexDataScanJobSpec) *pb.DataScanJob {
	if in == nil {
		return nil
	}
	out := &pb.DataScanJob{}
