...
func JobTemplate_FromProto(mapCtx *direct.MapContext, in *pb.JobTemplate) *krm.JobTemplate {
	if in == nil {
		return nil
	}
	out := &krm.JobTemplate{}
...
func JobTemplate_ToProto(mapCtx *direct.MapContext, in *krm.JobTemplate) *pb.JobTemplate {
	if in == nil {
		return nil
	}
	out := &pb.JobTemplate{}
	out.Name = direct.ValueOf(in.Name)
	out.Config = JobConfig_ToProto(mapCtx, in.Config)
	out.Labels = in.Labels
	return out
}
...
func VideoJobTemplateObservedState_FromProto(mapCtx *direct.MapContext, in *pb.JobTemplate) *krm.VideoJobTemplateObservedState {
	if in == nil {
		return nil
	}
	out := &krm.VideoJobTemplateObservedState{}
	// MISSING: Name
	// MISSING: Config
	// MISSING: Labels
	return out
}
func VideoJobTemplateObservedState_ToProto(mapCtx *direct.MapContext, in *krm.VideoJobTemplateObservedState) *pb.JobTemplate {
	if in == nil {
		return nil
	}
	out := &pb.JobTemplate{}
...
func VideoJobTemplateSpec_FromProto(mapCtx *direct.MapContext, in *pb.JobTemplate) *krm.VideoJobTemplateSpec {
	if in == nil {
		return nil
	}
	out := &krm.VideoJobTemplateSpec{}
	// MISSING: Name
	// MISSING: Config
	// MISSING: Labels
	return out
}
func VideoJobTemplateSpec_ToProto(mapCtx *direct.MapContext, in *krm.VideoJobTemplateSpec) *pb.JobTemplate {
	if in == nil {
		return nil
	}
	out := &pb.JobTemplate{}
