...
func DocumentAIObservedState_FromProto(mapCtx *direct.MapContext, in *pb.ProcessorVersion) *krm.DocumentAIObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DocumentAIObservedState{}
	// MISSING: Name
	// MISSING: DisplayName
...
func DocumentAIObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DocumentAIObservedState) *pb.ProcessorVersion {
	if in == nil {
		return nil
	}
...
func DocumentAISpec_FromProto(mapCtx *direct.MapContext, in *pb.ProcessorVersion) *krm.DocumentAISpec {
	if in == nil {
		return nil
	}
	out := &krm.DocumentAISpec{}
	// MISSING: Name
	// MISSING: DisplayName
	// MISSING: DocumentSchema
	// MISSING: State
...
func DocumentAISpec_ToProto(mapCtx *direct.MapContext, in *krm.DocumentAISpec) *pb.ProcessorVersion {
	if in == nil {
		return nil
	}
	out := &pb.ProcessorVersion{}
