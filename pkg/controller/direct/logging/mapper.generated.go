...
func LogBucket_FromProto(mapCtx *direct.MapContext, in *pb.LogBucket) *krm.LogBucket {
	if in == nil {
		return nil
	}
	out := &krm.LogBucket{}
	...
	out.IndexConfigs = direct.Slice_FromProto(mapCtx, in.IndexConfigs, IndexConfig_FromProto)
	out.CmekSettings = CmekSettings_FromProto(mapCtx, in.GetCmekSettings())
	return out
}
func LogBucket_ToProto(mapCtx *direct.MapContext, in *krm.LogBucket) *pb.LogBucket {
	if in == nil {
		return nil
	}
	out := &pb.LogBucket{}
	...
	out.RestrictedFields = in.RestrictedFields
	out.IndexConfigs = direct.Slice_ToProto(mapCtx, in.IndexConfigs, IndexConfig_ToProto)
	out.CmekSettings = CmekSettings_ToProto(mapCtx, in.CmekSettings)
	return out
}
func LogBucketObservedState_FromProto(mapCtx *direct.MapContext, in *pb.LogBucket) *krm.LogBucketObservedState {
	if in == nil {
		return nil
	}
	out := &krm.LogBucketObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
	// MISSING: Description
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
	...
	out.IndexConfigs = direct.Slice_FromProto(mapCtx, in.IndexConfigs, IndexConfigObservedState_FromProto)
	out.CmekSettings = CmekSettingsObservedState_FromProto(mapCtx, in.GetCmekSettings())
	return out
}
func LogBucketObservedState_ToProto(mapCtx *direct.MapContext, in *krm.LogBucketObservedState) *pb.LogBucket {
	if in == nil {
		return nil
	}
	out := &pb.LogBucket{}
	...
	// MISSING: AnalyticsEnabled
	// MISSING: RestrictedFields
	out.IndexConfigs = direct.Slice_ToProto(mapCtx, in.IndexConfigs, IndexConfigObservedState_ToProto)
	out.CmekSettings = CmekSettingsObservedState_ToProto(mapCtx, in.CmekSettings)
	return out
}
