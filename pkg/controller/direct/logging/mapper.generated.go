...
func LinkObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Link) *krm.LinkObservedState {
	if in == nil {
		return nil
	}
	out := &krm.LinkObservedState{}
	// MISSING: Name
	// MISSING: Description
...
func LinkObservedState_ToProto(mapCtx *direct.MapContext, in *krm.LinkObservedState) *pb.Link {
	if in == nil {
		return nil
	}
	out := &pb.Link{}
