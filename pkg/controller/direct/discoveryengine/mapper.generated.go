...
func DiscoveryengineCustomTuningModelObservedState_FromProto(mapCtx *direct.MapContext, in *pb.CustomTuningModel) *krm.DiscoveryengineCustomTuningModelObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineCustomTuningModelObservedState{}
	// MISSING: Name
	// MISSING: DisplayName
	// MISSING: ModelVersion
	// MISSING: ModelState
	// MISSING: CreateTime
	// MISSING: TrainingStartTime
	// MISSING: Metrics
	// MISSING: ErrorMessage
	return out
}
func DiscoveryengineCustomTuningModelObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineCustomTuningModelObservedState) *pb.CustomTuningModel {
	if in == nil {
		return nil
	}
	out := &pb.CustomTuningModel{}
...
func DiscoveryengineCustomTuningModelSpec_FromProto(mapCtx *direct.MapContext, in *pb.CustomTuningModel) *krm.DiscoveryengineCustomTuningModelSpec {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineCustomTuningModelSpec{}
	// MISSING: Name
	// MISSING: DisplayName
	// MISSING: ModelVersion
	// MISSING: ModelState
...
func DiscoveryengineCustomTuningModelSpec_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineCustomTuningModelSpec) *pb.CustomTuningModel {
	if in == nil {
		return nil
	}
	out := &pb.CustomTuningModel{}
