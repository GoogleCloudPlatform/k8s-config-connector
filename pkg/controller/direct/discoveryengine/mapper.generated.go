...
func DiscoveryengineProjectObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Project) *krm.DiscoveryengineProjectObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineProjectObservedState{}
	// MISSING: Name
	// MISSING: CreateTime
...
func DiscoveryengineProjectObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineProjectObservedState) *pb.Project {
	if in == nil {
		return nil
	}
	out := &pb.Project{}
...
func DiscoveryengineProjectSpec_FromProto(mapCtx *direct.MapContext, in *pb.Project) *krm.DiscoveryengineProjectSpec {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineProjectSpec{}
	// MISSING: Name
	// MISSING: CreateTime
	// MISSING: ProvisionCompletionTime
	// MISSING: ServiceTermsMap
...
func DiscoveryengineProjectSpec_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineProjectSpec) *pb.Project {
	if in == nil {
		return nil
	}
	out := &pb.Project{}
