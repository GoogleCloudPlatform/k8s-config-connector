...
func DiscoveryengineSchemaObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Schema) *krm.DiscoveryengineSchemaObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineSchemaObservedState{}
	// MISSING: StructSchema
	// MISSING: JsonSchema
	// MISSING: Name
	return out
}
func DiscoveryengineSchemaObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineSchemaObservedState) *pb.Schema {
	if in == nil {
		return nil
	}
	out := &pb.Schema{}
...
func DiscoveryengineSchemaSpec_FromProto(mapCtx *direct.MapContext, in *pb.Schema) *krm.DiscoveryengineSchemaSpec {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineSchemaSpec{}
	// MISSING: StructSchema
	// MISSING: JsonSchema
	// MISSING: Name
	return out
}
func DiscoveryengineSchemaSpec_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineSchemaSpec) *pb.Schema {
	if in == nil {
		return nil
	}
	out := &pb.Schema{}
