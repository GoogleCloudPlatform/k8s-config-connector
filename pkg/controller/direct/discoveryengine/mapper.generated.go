...
func DiscoveryengineAnswerObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Answer) *krm.DiscoveryengineAnswerObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineAnswerObservedState{}
	// MISSING: Name
	// MISSING: State
	// MISSING: AnswerText
	// MISSING: Citations
...
func DiscoveryengineAnswerObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineAnswerObservedState) *pb.Answer {
	if in == nil {
		return nil
	}
	out := &pb.Answer{}
...
func DiscoveryengineAnswerSpec_FromProto(mapCtx *direct.MapContext, in *pb.Answer) *krm.DiscoveryengineAnswerSpec {
	if in == nil {
		return nil
	}
	out := &krm.DiscoveryengineAnswerSpec{}
	// MISSING: Name
	// MISSING: State
	// MISSING: AnswerText
	// MISSING: Citations
...
func DiscoveryengineAnswerSpec_ToProto(mapCtx *direct.MapContext, in *krm.DiscoveryengineAnswerSpec) *pb.Answer {
	if in == nil {
		return nil
	}
	out := &pb.Answer{}
