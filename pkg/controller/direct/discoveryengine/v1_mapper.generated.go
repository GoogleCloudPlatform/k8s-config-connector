...
func Answer_Reference_ChunkInfo_DocumentMetadata_FromProto(mapCtx *direct.MapContext, in *pb.Answer_Reference_ChunkInfo_DocumentMetadata) *krm.Answer_Reference_ChunkInfo_DocumentMetadata {
	...
	out.StructData = direct.ValueOf(direct.Struct_FromProto(mapCtx, in.GetStructData()))
	return out
}
...
func SearchResponse_Summary_Citation_FromProto(mapCtx *direct.MapContext, in *pb.SearchResponse_Summary_Citation) *krm.SearchResponse_Summary_Citation {
	if in == nil {
		return nil
	}
	out := &krm.SearchResponse_Summary_Citation{}
	out.StartIndex = direct.LazyPtr(in.GetStartIndex())
	out.EndIndex = direct.LazyPtr(in.GetEndIndex())
	out.Sources = direct.Slice_FromProto(mapCtx, in.Sources, SearchResponse_Summary_CitationSource_FromProto)
	return out
}
func SearchResponse_Summary_Citation_ToProto(mapCtx *direct.MapContext, in *krm.SearchResponse_Summary_Citation) *pb.SearchResponse_Summary_Citation {
	if in == nil {
		return nil
	}
	out := &pb.SearchResponse_Summary_Citation{}
	out.StartIndex = direct.ValueOf(in.StartIndex)
	out.EndIndex = direct.ValueOf(in.EndIndex)
	out.Sources = direct.Slice_ToProto(mapCtx, in.Sources, SearchResponse_Summary_CitationSource_ToProto)
	return out
}
func SearchResponse_Summary_CitationMetadata_FromProto(mapCtx *direct.MapContext, in *pb.SearchResponse_Summary_CitationMetadata) *krm.SearchResponse_Summary_CitationMetadata {
	if in == nil {
		return nil
	}
	out := &krm.SearchResponse_Summary_CitationMetadata{}
	out.Citations = direct.Slice_FromProto(mapCtx, in.Citations, SearchResponse_Summary_Citation_FromProto)
	return out
}
func SearchResponse_Summary_CitationMetadata_ToProto(mapCtx *direct.MapContext, in *krm.SearchResponse_Summary_CitationMetadata) *pb.SearchResponse_Summary_CitationMetadata {
	if in == nil {
		return nil
	}
	out := &pb.SearchResponse_Summary_CitationMetadata{}
	out.Citations = direct.Slice_ToProto(mapCtx, in.Citations, SearchResponse_Summary_Citation_ToProto)
	return out
}
func SearchResponse_Summary_CitationSource_FromProto(mapCtx *direct.MapContext, in *pb.SearchResponse_Summary_CitationSource) *krm.SearchResponse_Summary_CitationSource {
	if in == nil {
		return nil
	}
	out := &krm.SearchResponse_Summary_CitationSource{}
	out.ReferenceIndex = direct.LazyPtr(in.GetReferenceIndex())
	return out
}
func SearchResponse_Summary_CitationSource_ToProto(mapCtx *direct.MapContext, in *krm.SearchResponse_Summary_CitationSource) *pb.SearchResponse_Summary_CitationSource {
	if in == nil {
		return nil
	}
	out := &pb.SearchResponse_Summary_CitationSource{}
	out.ReferenceIndex = direct.ValueOf(in.ReferenceIndex)
	return out
}
func SearchResponse_Summary_Reference_FromProto(mapCtx *direct.MapContext, in *pb.SearchResponse_Summary_Reference) *krm.SearchResponse_Summary_Reference {
	if in == nil {
		return nil
	}
	out := &krm.SearchResponse_Summary_Reference{}
	out.Title = direct.LazyPtr(in.GetTitle())
	out.Document = direct.LazyPtr(in.GetDocument())
	out.URI = direct.LazyPtr(in.GetUri())
	out.ChunkContents = direct.Slice_FromProto(mapCtx, in.ChunkContents, SearchResponse_Summary_Reference_ChunkContent_FromProto)
	return out
}
func SearchResponse_Summary_Reference_ToProto(mapCtx *direct.MapContext, in *krm.SearchResponse_Summary_Reference) *pb.SearchResponse_Summary_Reference {
	if in == nil {
		return nil
	}
	out := &pb.SearchResponse_Summary_Reference{}
	out.Title = direct.ValueOf(in.Title)
	out.Document = direct.ValueOf(in.Document)
	out.Uri = direct.ValueOf(in.URI)
	out.ChunkContents = direct.Slice_ToProto(mapCtx, in.ChunkContents, SearchResponse_Summary_Reference_ChunkContent_ToProto)
	return out
}
func SearchResponse_Summary_Reference_ChunkContent_FromProto(mapCtx *direct.MapContext, in *pb.SearchResponse_Summary_Reference_ChunkContent) *krm.SearchResponse_Summary_Reference_ChunkContent {
	if in == nil {
		return nil
	}
	out := &krm.SearchResponse_Summary_Reference_ChunkContent{}
	out.Content = direct.LazyPtr(in.GetContent())
	out.PageIdentifier = direct.LazyPtr(in.GetPageIdentifier())
	return out
}
func SearchResponse_Summary_Reference_ChunkContent_ToProto(mapCtx *direct.MapContext, in *krm.SearchResponse_Summary_Reference_ChunkContent) *pb.SearchResponse_Summary_Reference_ChunkContent {
	if in == nil {
		return nil
	}
	out := &pb.SearchResponse_Summary_Reference_ChunkContent{}
	out.Content = direct.ValueOf(in.Content)
	out.PageIdentifier = direct.ValueOf(in.PageIdentifier)
	return out
}
func SearchResponse_Summary_SafetyAttributes_FromProto(mapCtx *direct.MapContext, in *pb.SearchResponse_Summary_SafetyAttributes) *krm.SearchResponse_Summary_SafetyAttributes {
	if in == nil {
		return nil
	}
	out := &krm.SearchResponse_Summary_SafetyAttributes{}
	out.Categories = in.Categories
	out.Scores = in.Scores
	return out
}
func SearchResponse_Summary_SafetyAttributes_ToProto(mapCtx *direct.MapContext, in *krm.SearchResponse_Summary_SafetyAttributes) *pb.SearchResponse_Summary_SafetyAttributes {
	if in == nil {
		return nil
	}
	out := &pb.SearchResponse_Summary_SafetyAttributes{}
	out.Categories = in.Categories
	out.Scores = in.Scores
	return out
}
func SearchResponse_Summary_SummaryWithMetadata_FromProto(mapCtx *direct.MapContext, in *pb.SearchResponse_Summary_SummaryWithMetadata) *krm.SearchResponse_Summary_SummaryWithMetadata {
	if in == nil {
		return nil
	}
	out := &krm.SearchResponse_Summary_SummaryWithMetadata{}
	out.Summary = direct.LazyPtr(in.GetSummary())
	out.CitationMetadata = SearchResponse_Summary_CitationMetadata_FromProto(mapCtx, in.GetCitationMetadata())
	out.References = direct.Slice_FromProto(mapCtx, in.References, SearchResponse_Summary_Reference_FromProto)
	return out
}
func SearchResponse_Summary_SummaryWithMetadata_ToProto(mapCtx *direct.MapContext, in *krm.SearchResponse_Summary_SummaryWithMetadata) *pb.SearchResponse_Summary_SummaryWithMetadata {
	if in == nil {
		return nil
	}
	out := &pb.SearchResponse_Summary_SummaryWithMetadata{}
	out.Summary = direct.ValueOf(in.Summary)
	out.CitationMetadata = SearchResponse_Summary_CitationMetadata_ToProto(mapCtx, in.CitationMetadata)
	out.References = direct.Slice_ToProto(mapCtx, in.References, SearchResponse_Summary_Reference_ToProto)
	return out
}
