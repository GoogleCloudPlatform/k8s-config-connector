...
func servingConfigFuzzer() fuzztesting.KRMFuzzer {
	f := fuzztesting.NewKRMTypedFuzzer(&discoveryenginepb.ServingConfig{},
	...
	// Fluently declare spec and status fields
	...
	// Use highly descriptive helper methods for unhandled or unimplemented fields
