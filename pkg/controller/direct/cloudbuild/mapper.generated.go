...
func CloudbuildBuildObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Build) *krm.CloudbuildBuildObservedState {
	if in == nil {
		return nil
	}
	out := &krm.CloudbuildBuildObservedState{}
	// MISSING: Name
	// MISSING: ID
	// MISSING: ProjectID
	// MISSING: Status
...
func CloudbuildBuildObservedState_ToProto(mapCtx *direct.MapContext, in *krm.CloudbuildBuildObservedState) *pb.Build {
	if in == nil {
		return nil
	}
	out := &pb.Build{}
...
func CloudbuildBuildSpec_FromProto(mapCtx *direct.MapContext, in *pb.Build) *krm.CloudbuildBuildSpec {
	if in == nil {
		return nil
	}
	out := &krm.CloudbuildBuildSpec{}
	// MISSING: Name
	// MISSING: ID
	// MISSING: ProjectID
	// MISSING: Status
...
func CloudbuildBuildSpec_ToProto(mapCtx *direct.MapContext, in *krm.CloudbuildBuildSpec) *pb.Build {
	if in == nil {
		return nil
	}
	out := &pb.Build{}
