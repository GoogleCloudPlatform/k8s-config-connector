...
func CloudBuildTriggerSpec_ToProto(mapCtx *direct.MapContext, in *krm.CloudBuildTriggerSpec) *pb.BuildTrigger {
	...
	if oneof := CloudBuildTriggerSpec_Autodetect_ToProto(mapCtx, in.Autodetect); oneof != nil {
...
func CloudBuildTriggerSpec_Autodetect_ToProto(mapCtx *direct.MapContext, in *bool) *pb.BuildTrigger_Autodetect {
	if in == nil {
		return nil
	}
	return &pb.BuildTrigger_Autodetect{Autodetect: *in}
}
...
func PrivatePoolV1Config_PrivateServiceConnect_FromProto(mapCtx *direct.MapContext, in *pb.PrivatePoolV1Config_PrivateServiceConnect) *krm.PrivatePoolV1Config_PrivateServiceConnect {
	if in == nil {
		return nil
	}
	out := &krm.PrivatePoolV1Config_PrivateServiceConnect{}
	out.NetworkAttachment = direct.LazyPtr(in.GetNetworkAttachment())
	out.PublicIPAddressDisabled = direct.LazyPtr(in.GetPublicIpAddressDisabled())
	out.RouteAllTraffic = direct.LazyPtr(in.GetRouteAllTraffic())
	return out
}
func PrivatePoolV1Config_PrivateServiceConnect_ToProto(mapCtx *direct.MapContext, in *krm.PrivatePoolV1Config_PrivateServiceConnect) *pb.PrivatePoolV1Config_PrivateServiceConnect {
	if in == nil {
		return nil
	}
	out := &pb.PrivatePoolV1Config_PrivateServiceConnect{}
