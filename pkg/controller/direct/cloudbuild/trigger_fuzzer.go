...
func cloudbuildTriggerFuzzer() fuzztesting.KRMFuzzer {
	...
	f.Unimplemented_NotYetTriaged(".build.source")
	f.Unimplemented_NotYetTriaged(".build.available_secrets")
	f.Unimplemented_NotYetTriaged(".build.secrets")
	f.Unimplemented_NotYetTriaged(".build.options")
	...
	f.Unimplemented_NotYetTriaged(".build.artifacts")
