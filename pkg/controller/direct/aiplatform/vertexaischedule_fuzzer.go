...
func vertexAIScheduleFuzzer() fuzztesting.KRMFuzzer {
	...
	// Unimplemented or complex fields
	...
	// CreatePipelineJobRequest contains some output-only and arg-only fields that do not map to KRM spec
	...
	// PipelineJob runtime config fields that are not supported/mapped in KRM spec
