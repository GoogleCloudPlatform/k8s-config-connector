...
func aiplatformModelFuzzer() fuzztesting.KRMFuzzer {
	...
	f.UnimplementedFields.Insert(".explanation_spec.parameters.output_indices.values[].struct_value.fields[].string_value")
	f.UnimplementedFields.Insert(".explanation_spec.parameters.output_indices")
	f.UnimplementedFields.Insert(".explanation_spec.metadata.outputs[].index_display_name_mapping.list_value")
	f.UnimplementedFields.Insert(".explanation_spec.metadata.inputs[].encoded_baselines")
	f.UnimplementedFields.Insert(".explanation_spec.metadata.inputs")
	f.UnimplementedFields.Insert(".explanation_spec.metadata.outputs")
	f.UnimplementedFields.Insert(".explanation_spec.parameters.examples")
	f.UnimplementedFields.Insert(".explanation_spec.metadata.outputs[].index_display_name_mapping")
	f.UnimplementedFields.Insert(".container_spec.health_probe")
	f.UnimplementedFields.Insert(".container_spec.startup_probe")
	f.UnimplementedFields.Insert(".container_spec.ports")
	f.UnimplementedFields.Insert(".container_spec.grpc_ports")
	f.UnimplementedFields.Insert(".explanation_spec.metadata.inputs[].encoded_baselines[].list_value")
	...
	f.UnimplementedFields.Insert(".explanation_spec.parameters.examples.example_gcs_source.gcs_source")
	...
	f.UnimplementedFields.Insert(".container_spec.startup_probe.tcp_socket.host")
	...
	f.UnimplementedFields.Insert(".container_spec.health_probe.tcp_socket.port")
	f.UnimplementedFields.Insert(".container_spec.startup_probe.tcp_socket.port")
	...
	f.UnimplementedFields.Insert(".container_spec.health_probe.tcp_socket.port")
	f.UnimplementedFields.Insert(".container_spec.health_probe.tcp_socket.host")
	f.UnimplementedFields.Insert(".container_spec.health_probe.grpc.port")
