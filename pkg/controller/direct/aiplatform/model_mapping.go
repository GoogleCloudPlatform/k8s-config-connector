...
// Deprecated: Value is now represented directly as apiextensionsv1.JSON.
...
func Value_FromProto(mapCtx *direct.MapContext, in *structpb.Value) *krm.Value {
	...
	case *structpb.Value_NumberValue:
		out.NumberValue = direct.LazyPtr(kind.NumberValue)
	case *structpb.Value_StringValue:
		out.StringValue = direct.LazyPtr(kind.StringValue)
	case *structpb.Value_BoolValue:
		out.BoolValue = direct.LazyPtr(kind.BoolValue)
	case *structpb.Value_StructValue:
		if val := direct.Struct_FromProto(mapCtx, kind.StructValue); val != nil {
			out.StructValue = *val
		}
	}
	return out
...
func Value_ToProto(mapCtx *direct.MapContext, in *krm.Value) *structpb.Value {
	...
	out := &structpb.Value{}
	if in.NullValue != nil {
		val := structpb.NullValue_value[*in.NullValue]
		out.Kind = &structpb.Value_NullValue{NullValue: structpb.NullValue(val)}
		...
		out.Kind = &structpb.Value_StructValue{StructValue: direct.Struct_ToProto(mapCtx, &in.StructValue)}
	}
	return out
}
...
func ExplanationMetadata_InputMetadata_FromProto(mapCtx *direct.MapContext, in *pb.ExplanationMetadata_InputMetadata) *krm.ExplanationMetadata_InputMetadata {
	...
	out.InputBaselines = direct.Slice_FromProto(mapCtx, in.InputBaselines, direct.JSON_FromProto)
	out.EncodedBaselines = direct.Slice_FromProto(mapCtx, in.EncodedBaselines, direct.JSON_FromProto)
	return out
}
...
func ExplanationMetadata_InputMetadata_ToProto(mapCtx *direct.MapContext, in *krm.ExplanationMetadata_InputMetadata) *pb.ExplanationMetadata_InputMetadata {
	...
	out.InputBaselines = direct.Slice_ToProto(mapCtx, in.InputBaselines, direct.JSON_ToProto)
	out.EncodedBaselines = direct.Slice_ToProto(mapCtx, in.EncodedBaselines, direct.JSON_ToProto)
	return out
}
...
func ExplanationMetadata_OutputMetadata_FromProto(mapCtx *direct.MapContext, in *pb.ExplanationMetadata_OutputMetadata) *krm.ExplanationMetadata_OutputMetadata {
	...
	if val := IndexDisplayNameMapping_FromProto(mapCtx, in.GetIndexDisplayNameMapping()); val != nil {
		out.IndexDisplayNameMapping = *val
	}
...
func IndexDisplayNameMapping_FromProto(mapCtx *direct.MapContext, in *structpb.Value) *apiextensionsv1.JSON {
	return direct.JSON_FromProto(mapCtx, in)
}
...
func IndexDisplayNameMapping_ToProto(mapCtx *direct.MapContext, in *apiextensionsv1.JSON) *pb.ExplanationMetadata_OutputMetadata_IndexDisplayNameMapping {
	...
	val := direct.JSON_ToProto(mapCtx, in)
	if val == nil {
		return nil
	}
