...
func AIPlatformModelSpec_FromProto(mapCtx *direct.MapContext, in *pb.Model) *krm.AIPlatformModelSpec {
	...
	out.Metadata = direct.JSON_FromProto(mapCtx, in.GetMetadata())
...
func ExplanationMetadata_OutputMetadata_FromProto(mapCtx *direct.MapContext, in *pb.ExplanationMetadata_OutputMetadata) *krm.ExplanationMetadata_OutputMetadata {
	...
	out.IndexDisplayNameMapping = direct.ValueOf(IndexDisplayNameMapping_FromProto(mapCtx, in.GetIndexDisplayNameMapping()))
...
func IndexDisplayNameMapping_FromProto(mapCtx *direct.MapContext, in *structpb.Value) *apiextensionsv1.JSON {
	...
	out := direct.JSON_FromProto(mapCtx, in)
	return out
}
