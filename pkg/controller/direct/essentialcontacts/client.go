...
import (
	...
	api "cloud.google.com/go/essentialcontacts/apiv1"
...
func (m *gcpClient) newEssentialContactsClient(ctx context.Context) (*api.Client, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("building essentialcontacts client: %w", err)
	}
	return client, err
}
