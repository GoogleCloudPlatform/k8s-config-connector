...
func (a *RouteAdapter) Find(ctx context.Context) (bool, error) {
	...
	req := &datastreampb.GetRouteRequest{Name: a.id}
...
func (a *RouteAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	desiredPb := DatastreamRouteSpec_ToProto(mapCtx, &a.desired.DeepCopy().Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	req := &datastreampb.UpdateRouteRequest{
		Name:       a.id.External,
	...
	status := &krm.DatastreamRouteStatus{}
	status.ObservedState = DatastreamRouteObservedState_FromProto(mapCtx, updated)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	return updateOp.UpdateStatus(ctx, status, nil)
...
func (a *RouteAdapter) Delete(ctx context.Context, deleteOp *directbase.DeleteOperation) (bool, error) {
	...
	req := &datastreampb.DeleteRouteRequest{Name: a.id.String()}
