...
func NetworkManagementConnectivityTestFuzzer() fuzztesting.KRMFuzzer {
	...
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].gke_network_policy_skipped.reason")

	f.Unimplemented_NotYetTriaged(".reachability_details.error.details")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.error.details")
	f.Unimplemented_NotYetTriaged(".probing_details.error.details")
	f.Unimplemented_NotYetTriaged(".reachability_details.error")
	f.Unimplemented_NotYetTriaged(".return_reachability_details.error")
	f.Unimplemented_NotYetTriaged(".probing_details.error")
	f.Unimplemented_NotYetTriaged(".destination.dms_private_connection")
	f.Unimplemented_NotYetTriaged(".source.dms_private_connection")
	f.Unimplemented_NotYetTriaged(".source.cloud_run_job")
	f.Unimplemented_NotYetTriaged(".destination.cloud_run_job")
	...
	f.Unimplemented_NotYetTriaged(".reachability_details.traces[].steps[].cloud_run_job.location")
	...
	f.Unimplemented_NotYetTriaged(".return_reachability_details.traces[].steps[].cloud_run_job.location")
	return f
}
