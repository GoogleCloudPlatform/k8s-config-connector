...
func (a *connectivityTestAdapter) normalizeReferenceFields(ctx context.Context) error {
	...
	if obj.Spec.Source != nil {
		...
		if obj.Spec.Source.ComputeNetworkRef != nil {
			if _, err := obj.Spec.Source.ComputeNetworkRef.NormalizedExternal(ctx, a.reader, obj.GetNamespace()); err != nil {
				return err
			}
		}
	...
	if obj.Spec.Destination != nil {
		...
		if obj.Spec.Destination.ComputeNetworkRef != nil {
			if _, err := obj.Spec.Destination.ComputeNetworkRef.NormalizedExternal(ctx, a.reader, obj.GetNamespace()); err != nil {
				return err
			}
		}
