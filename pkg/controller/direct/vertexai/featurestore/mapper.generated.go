...
func ActiveLearningConfig_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.ActiveLearningConfig) *krm.ActiveLearningConfig {
	if in == nil {
		return nil
	}
...
func ActiveLearningConfig_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krm.ActiveLearningConfig) *pb.ActiveLearningConfig {
	if in == nil {
		return nil
	}
...
func SampleConfig_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.SampleConfig) *krm.SampleConfig {
	if in == nil {
		return nil
	}
...
func SampleConfig_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krm.SampleConfig) *pb.SampleConfig {
	if in == nil {
		return nil
	}
	out := &pb.SampleConfig{}
...
func TrainingConfig_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.TrainingConfig) *krm.TrainingConfig {
	if in == nil {
		return nil
	}
...
func TrainingConfig_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krm.TrainingConfig) *pb.TrainingConfig {
	if in == nil {
		return nil
	}
