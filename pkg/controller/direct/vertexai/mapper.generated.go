...
func ColabImage_FromProto(mapCtx *direct.MapContext, in *pb.ColabImage) *krmcolabv1alpha1.ColabImage {
	if in == nil {
		return nil
	}
...
func ColabImage_ToProto(mapCtx *direct.MapContext, in *krmcolabv1alpha1.ColabImage) *pb.ColabImage {
	if in == nil {
		return nil
	}
	out := &pb.ColabImage{}
...
func ColabImageObservedState_FromProto(mapCtx *direct.MapContext, in *pb.ColabImage) *krmcolabv1alpha1.ColabImageObservedState {
	if in == nil {
		return nil
	}
...
func ColabImageObservedState_ToProto(mapCtx *direct.MapContext, in *krmcolabv1alpha1.ColabImageObservedState) *pb.ColabImage {
	if in == nil {
		return nil
	}
	out := &pb.ColabImage{}
...
func EnvVar_FromProto(mapCtx *direct.MapContext, in *pb.EnvVar) *krmcolabv1alpha1.EnvVar {
	if in == nil {
		return nil
	}
...
func EnvVar_ToProto(mapCtx *direct.MapContext, in *krmcolabv1alpha1.EnvVar) *pb.EnvVar {
	if in == nil {
		return nil
	}
	out := &pb.EnvVar{}
...
func NotebookSoftwareConfig_FromProto(mapCtx *direct.MapContext, in *pb.NotebookSoftwareConfig) *krmcolabv1alpha1.NotebookSoftwareConfig {
	if in == nil {
		return nil
	}
	out := &krmcolabv1alpha1.NotebookSoftwareConfig{}
	out.ColabImage = ColabImage_FromProto(mapCtx, in.GetColabImage())
...
func NotebookSoftwareConfig_ToProto(mapCtx *direct.MapContext, in *krmcolabv1alpha1.NotebookSoftwareConfig) *pb.NotebookSoftwareConfig {
	if in == nil {
		return nil
	}
	out := &pb.NotebookSoftwareConfig{}
	if oneof := ColabImage_ToProto(mapCtx, in.ColabImage); oneof != nil {
...
func NotebookSoftwareConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.NotebookSoftwareConfig) *krmcolabv1alpha1.NotebookSoftwareConfigObservedState {
	if in == nil {
		return nil
	}
...
func NotebookSoftwareConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmcolabv1alpha1.NotebookSoftwareConfigObservedState) *pb.NotebookSoftwareConfig {
	if in == nil {
		return nil
	}
	out := &pb.NotebookSoftwareConfig{}
...
func PostStartupScriptConfig_FromProto(mapCtx *direct.MapContext, in *pb.PostStartupScriptConfig) *krmcolabv1alpha1.PostStartupScriptConfig {
	if in == nil {
		return nil
	}
...
func PostStartupScriptConfig_ToProto(mapCtx *direct.MapContext, in *krmcolabv1alpha1.PostStartupScriptConfig) *pb.PostStartupScriptConfig {
	if in == nil {
		return nil
	}
