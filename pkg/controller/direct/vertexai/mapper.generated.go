...
func NasJobOutputObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasJobOutput) *krmvertexaiv1alpha1.NasJobOutputObservedState {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasJobOutputObservedState{}
	out.MultiTrialJobOutput = NasJobOutput_MultiTrialJobOutputObservedState_v1alpha1_FromProto(mapCtx, in.GetMultiTrialJobOutput())
	return out
}
func NasJobOutputObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasJobOutputObservedState) *pb.NasJobOutput {
	if in == nil {
		return nil
	}
	out := &pb.NasJobOutput{}
	if oneof := NasJobOutput_MultiTrialJobOutputObservedState_v1alpha1_ToProto(mapCtx, in.MultiTrialJobOutput); oneof != nil {
		out.Output = &pb.NasJobOutput_MultiTrialJobOutput_{MultiTrialJobOutput: oneof}
	}
	return out
}
func NasJobOutput_MultiTrialJobOutputObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasJobOutput_MultiTrialJobOutput) *krmvertexaiv1alpha1.NasJobOutput_MultiTrialJobOutputObservedState {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasJobOutput_MultiTrialJobOutputObservedState{}
	out.SearchTrials = direct.Slice_FromProto(mapCtx, in.SearchTrials, NasTrialObservedState_v1alpha1_FromProto)
	out.TrainTrials = direct.Slice_FromProto(mapCtx, in.TrainTrials, NasTrialObservedState_v1alpha1_FromProto)
	return out
}
func NasJobOutput_MultiTrialJobOutputObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasJobOutput_MultiTrialJobOutputObservedState) *pb.NasJobOutput_MultiTrialJobOutput {
	if in == nil {
		return nil
	}
	out := &pb.NasJobOutput_MultiTrialJobOutput{}
	out.SearchTrials = direct.Slice_ToProto(mapCtx, in.SearchTrials, NasTrialObservedState_v1alpha1_ToProto)
	out.TrainTrials = direct.Slice_ToProto(mapCtx, in.TrainTrials, NasTrialObservedState_v1alpha1_ToProto)
	return out
}
func NasJobSpec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasJobSpec) *krmvertexaiv1alpha1.NasJobSpec {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasJobSpec{}
	out.MultiTrialAlgorithmSpec = NasJobSpec_MultiTrialAlgorithmSpec_v1alpha1_FromProto(mapCtx, in.GetMultiTrialAlgorithmSpec())
	out.ResumeNasJobID = direct.LazyPtr(in.GetResumeNasJobId())
	out.SearchSpaceSpec = direct.LazyPtr(in.GetSearchSpaceSpec())
	return out
}
func NasJobSpec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasJobSpec) *pb.NasJobSpec {
	if in == nil {
		return nil
	}
	out := &pb.NasJobSpec{}
	if oneof := NasJobSpec_MultiTrialAlgorithmSpec_v1alpha1_ToProto(mapCtx, in.MultiTrialAlgorithmSpec); oneof != nil {
...
func NasJobSpec_MultiTrialAlgorithmSpec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasJobSpec_MultiTrialAlgorithmSpec) *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec{}
	out.MultiTrialAlgorithm = direct.Enum_FromProto(mapCtx, in.GetMultiTrialAlgorithm())
	out.Metric = NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec_v1alpha1_FromProto(mapCtx, in.GetMetric())
	out.SearchTrialSpec = NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec_v1alpha1_FromProto(mapCtx, in.GetSearchTrialSpec())
	out.TrainTrialSpec = NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec_v1alpha1_FromProto(mapCtx, in.GetTrainTrialSpec())
	return out
}
func NasJobSpec_MultiTrialAlgorithmSpec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec) *pb.NasJobSpec_MultiTrialAlgorithmSpec {
	if in == nil {
		return nil
	}
	...
	out.Metric = NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec_v1alpha1_ToProto(mapCtx, in.Metric)
	out.SearchTrialSpec = NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec_v1alpha1_ToProto(mapCtx, in.SearchTrialSpec)
	out.TrainTrialSpec = NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec_v1alpha1_ToProto(mapCtx, in.TrainTrialSpec)
	return out
}
func NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec) *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec{}
	out.MetricID = direct.LazyPtr(in.GetMetricId())
	out.Goal = direct.Enum_FromProto(mapCtx, in.GetGoal())
	return out
}
func NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec) *pb.NasJobSpec_MultiTrialAlgorithmSpec_MetricSpec {
	if in == nil {
		return nil
	}
...
func NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec) *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec{}
	out.SearchTrialJobSpec = CustomJobSpec_v1alpha1_FromProto(mapCtx, in.GetSearchTrialJobSpec())
...
func NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec) *pb.NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec {
	if in == nil {
		return nil
	}
	out := &pb.NasJobSpec_MultiTrialAlgorithmSpec_SearchTrialSpec{}
	out.SearchTrialJobSpec = CustomJobSpec_v1alpha1_ToProto(mapCtx, in.SearchTrialJobSpec)
...
func NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec) *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec{}
	out.TrainTrialJobSpec = CustomJobSpec_v1alpha1_FromProto(mapCtx, in.GetTrainTrialJobSpec())
	out.MaxParallelTrialCount = direct.LazyPtr(in.GetMaxParallelTrialCount())
	out.Frequency = direct.LazyPtr(in.GetFrequency())
	return out
}
func NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec) *pb.NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec {
	if in == nil {
		return nil
	}
	out := &pb.NasJobSpec_MultiTrialAlgorithmSpec_TrainTrialSpec{}
	out.TrainTrialJobSpec = CustomJobSpec_v1alpha1_ToProto(mapCtx, in.TrainTrialJobSpec)
	out.MaxParallelTrialCount = direct.ValueOf(in.MaxParallelTrialCount)
	out.Frequency = direct.ValueOf(in.Frequency)
	return out
}
func NasTrialObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NasTrial) *krmvertexaiv1alpha1.NasTrialObservedState {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.NasTrialObservedState{}
...
func NasTrialObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.NasTrialObservedState) *pb.NasTrial {
	if in == nil {
		return nil
	}
	out := &pb.NasTrial{}
