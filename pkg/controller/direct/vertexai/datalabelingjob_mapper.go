...
func VertexAIDataLabelingJobSpec_FromProto(mapCtx *direct.MapContext, in *pb.DataLabelingJob) *krm.VertexAIDataLabelingJobSpec {
	...
	out.Datasets = VertexAIDataLabelingJobSpec_Datasets_FromProto(mapCtx, in.GetDatasets())
...
func VertexAIDataLabelingJobSpec_ToProto(mapCtx *direct.MapContext, in *krm.VertexAIDataLabelingJobSpec) *pb.DataLabelingJob {
	...
	out.Datasets = VertexAIDataLabelingJobSpec_Datasets_ToProto(mapCtx, in.Datasets)
...
func VertexAIDataLabelingJobSpec_Datasets_FromProto(mapCtx *direct.MapContext, in []string) []refsv1beta1.VertexAIDatasetRef {
	if in == nil {
		return nil
	}
...
func VertexAIDataLabelingJobSpec_Datasets_ToProto(mapCtx *direct.MapContext, in []refsv1beta1.VertexAIDatasetRef) []string {
	if in == nil {
		return nil
	}
