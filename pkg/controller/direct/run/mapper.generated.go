...
func Job_FromProto(mapCtx *direct.MapContext, in *pb.Job) *krm.Job {
	...
	// MISSING: Conditions
	// MISSING: ExecutionCount
	// MISSING: LatestCreatedExecution
	// MISSING: Reconciling
	// MISSING: SatisfiesPzs
	out.StartExecutionToken = direct.LazyPtr(in.GetStartExecutionToken())
	out.RunExecutionToken = direct.LazyPtr(in.GetRunExecutionToken())
	// MISSING: Etag
	return out
}
func Job_ToProto(mapCtx *direct.MapContext, in *krm.Job) *pb.Job {
	...
	// MISSING: Reconciling
	// MISSING: SatisfiesPzs
	if oneof := Job_StartExecutionToken_ToProto(mapCtx, in.StartExecutionToken); oneof != nil {
		out.CreateExecution = oneof
	}
	if oneof := Job_RunExecutionToken_ToProto(mapCtx, in.RunExecutionToken); oneof != nil {
		out.CreateExecution = oneof
	}
	// MISSING: Etag
	return out
...
func JobObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Job) *krm.JobObservedState {
	...
	out.LatestCreatedExecution = ExecutionReference_FromProto(mapCtx, in.GetLatestCreatedExecution())
...
func JobObservedState_ToProto(mapCtx *direct.MapContext, in *krm.JobObservedState) *pb.Job {
	...
	out.LatestCreatedExecution = ExecutionReference_ToProto(mapCtx, in.LatestCreatedExecution)
