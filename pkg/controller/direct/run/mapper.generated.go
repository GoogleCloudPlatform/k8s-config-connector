...
func Execution_FromProto(mapCtx *direct.MapContext, in *pb.Execution) *krm.Execution {
	...
	// MISSING: RunningCount
	// MISSING: SucceededCount
	// MISSING: FailedCount
	// MISSING: CancelledCount
	// MISSING: RetriedCount
	// MISSING: LogURI
...
func ExecutionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Execution) *krm.ExecutionObservedState {
	...
	out.RunningCount = direct.LazyPtr(in.GetRunningCount())
	out.SucceededCount = direct.LazyPtr(in.GetSucceededCount())
	out.FailedCount = direct.LazyPtr(in.GetFailedCount())
	out.CancelledCount = direct.LazyPtr(in.GetCancelledCount())
	out.RetriedCount = direct.LazyPtr(in.GetRetriedCount())
...
func ExecutionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.ExecutionObservedState) *pb.Execution {
	...
	out.RunningCount = direct.ValueOf(in.RunningCount)
	out.SucceededCount = direct.ValueOf(in.SucceededCount)
	out.FailedCount = direct.ValueOf(in.FailedCount)
	out.CancelledCount = direct.ValueOf(in.CancelledCount)
	out.RetriedCount = direct.ValueOf(in.RetriedCount)
...
func RunExecutionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Execution) *krm.RunExecutionObservedState {
	if in == nil {
		return nil
	}
	out := &krm.RunExecutionObservedState{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: Generation
	// MISSING: Labels
...
func RunExecutionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.RunExecutionObservedState) *pb.Execution {
	if in == nil {
		return nil
	}
	out := &pb.Execution{}
...
func RunExecutionSpec_FromProto(mapCtx *direct.MapContext, in *pb.Execution) *krm.RunExecutionSpec {
	if in == nil {
		return nil
	}
	out := &krm.RunExecutionSpec{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: Generation
	// MISSING: Labels
...
func RunExecutionSpec_ToProto(mapCtx *direct.MapContext, in *krm.RunExecutionSpec) *pb.Execution {
	if in == nil {
		return nil
	}
	out := &pb.Execution{}
