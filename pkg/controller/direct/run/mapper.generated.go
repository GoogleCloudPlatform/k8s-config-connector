...
func RevisionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Revision) *krm.RevisionObservedState {
	...
	out.ScalingStatus = RevisionScalingStatus_FromProto(mapCtx, in.GetScalingStatus())
...
func RevisionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.RevisionObservedState) *pb.Revision {
	...
	// MISSING: SessionAffinity
	out.ScalingStatus = RevisionScalingStatus_ToProto(mapCtx, in.ScalingStatus)
	// MISSING: NodeSelector
...
func RevisionScalingStatus_FromProto(mapCtx *direct.MapContext, in *pb.RevisionScalingStatus) *krm.RevisionScalingStatus {
	if in == nil {
		return nil
	}
	out := &krm.RevisionScalingStatus{}
	out.DesiredMinInstanceCount = direct.LazyPtr(in.GetDesiredMinInstanceCount())
	return out
}
func RevisionScalingStatus_ToProto(mapCtx *direct.MapContext, in *krm.RevisionScalingStatus) *pb.RevisionScalingStatus {
	if in == nil {
		return nil
	}
	out := &pb.RevisionScalingStatus{}
	out.DesiredMinInstanceCount = direct.ValueOf(in.DesiredMinInstanceCount)
	return out
}
func RunRevisionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Revision) *krm.RunRevisionObservedState {
	if in == nil {
		return nil
	}
	out := &krm.RunRevisionObservedState{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: Generation
	// MISSING: Labels
...
func RunRevisionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.RunRevisionObservedState) *pb.Revision {
	if in == nil {
		return nil
	}
	out := &pb.Revision{}
...
func RunRevisionSpec_FromProto(mapCtx *direct.MapContext, in *pb.Revision) *krm.RunRevisionSpec {
	if in == nil {
		return nil
	}
	out := &krm.RunRevisionSpec{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: Generation
	// MISSING: Labels
...
func RunRevisionSpec_ToProto(mapCtx *direct.MapContext, in *krm.RunRevisionSpec) *pb.Revision {
	if in == nil {
		return nil
	}
	out := &pb.Revision{}
