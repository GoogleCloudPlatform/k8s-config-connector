...
func runJobFuzzer() fuzztesting.KRMFuzzer {
	...
	f.Unimplemented_NotYetTriaged(".template.template.containers[].build_info")
	f.Unimplemented_NotYetTriaged(".template.template.containers[].depends_on")
	f.Unimplemented_NotYetTriaged(".template.template.containers[].resources.startup_cpu_boost")
	f.Unimplemented_NotYetTriaged(".template.template.containers[].resources.cpu_idle")
	f.Unimplemented_NotYetTriaged(".template.template.containers[].startup_probe.grpc")
	...
	f.Unimplemented_NotYetTriaged(".template.template.containers[].readiness_probe.grpc")
	f.Unimplemented_NotYetTriaged(".template.template.containers[].readiness_probe.http_get")
	f.Unimplemented_NotYetTriaged(".template.template.containers[].readiness_probe.http_get.port")
	f.Unimplemented_NotYetTriaged(".template.template.containers[].startup_probe.http_get.port")
