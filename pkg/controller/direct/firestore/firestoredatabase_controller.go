...
func (a *Adapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	resource.Name = a.id.firestoredatabase
...
func (a *Adapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	if !reflect.DeepEqual(resource.Type, a.actual.Type) {
		// todo: is this mutable?
		newDb.Type = resource.Type
	...
	if !reflect.DeepEqual(resource.AppEngineIntegrationMode, a.actual.AppEngineIntegrationMode) {
		// todo: is this mutable?
		newDb.AppEngineIntegrationMode = resource.AppEngineIntegrationMode
	...
	if err != nil {
		return fmt.Errorf("updating FirestoreDatabase %s: %w", a.id.FullyQualifiedName(), err)
	}
