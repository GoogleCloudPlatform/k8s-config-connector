...
func FirestoreDatabaseBackupScheduleObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.BackupSchedule) *krmfirestorev1alpha1.FirestoreDatabaseBackupScheduleObservedState {
	if in == nil {
		return nil
	}
	out := &krmfirestorev1alpha1.FirestoreDatabaseBackupScheduleObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
	out.UpdateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetUpdateTime())
	return out
}
func FirestoreDatabaseBackupScheduleObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmfirestorev1alpha1.FirestoreDatabaseBackupScheduleObservedState) *pb.BackupSchedule {
	if in == nil {
		return nil
	}
...
func FirestoreDatabaseBackupScheduleSpec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.BackupSchedule) *krmfirestorev1alpha1.FirestoreDatabaseBackupScheduleSpec {
	if in == nil {
		return nil
	}
	out := &krmfirestorev1alpha1.FirestoreDatabaseBackupScheduleSpec{}
...
func FirestoreDatabaseBackupScheduleSpec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmfirestorev1alpha1.FirestoreDatabaseBackupScheduleSpec) *pb.BackupSchedule {
	if in == nil {
		return nil
	}
	out := &pb.BackupSchedule{}
