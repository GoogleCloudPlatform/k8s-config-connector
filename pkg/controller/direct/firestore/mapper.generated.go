...
func Field_TTLConfig_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.Field_TtlConfig) *krm.Field_TTLConfig {
	if in == nil {
		return nil
	}
...
func Field_TTLConfig_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krm.Field_TTLConfig) *pb.Field_TtlConfig {
	if in == nil {
		return nil
	}
...
func Index_IndexField_VectorConfig_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.Index_IndexField_VectorConfig) *krmfirestorev1beta1.Index_IndexField_VectorConfig {
	if in == nil {
		return nil
	}
	out := &krmfirestorev1beta1.Index_IndexField_VectorConfig{}
	out.Dimension = direct.LazyPtr(in.GetDimension())
	out.Flat = Index_IndexField_VectorConfig_FlatIndex_v1beta1_FromProto(mapCtx, in.GetFlat())
	return out
}
func Index_IndexField_VectorConfig_v1beta1_ToProto(mapCtx *direct.MapContext, in *krmfirestorev1beta1.Index_IndexField_VectorConfig) *pb.Index_IndexField_VectorConfig {
	if in == nil {
		return nil
	}
	out := &pb.Index_IndexField_VectorConfig{}
...
func Index_IndexField_VectorConfig_FlatIndex_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.Index_IndexField_VectorConfig_FlatIndex) *krmfirestorev1beta1.Index_IndexField_VectorConfig_FlatIndex {
	if in == nil {
		return nil
	}
	out := &krmfirestorev1beta1.Index_IndexField_VectorConfig_FlatIndex{}
	return out
}
func Index_IndexField_VectorConfig_FlatIndex_v1beta1_ToProto(mapCtx *direct.MapContext, in *krmfirestorev1beta1.Index_IndexField_VectorConfig_FlatIndex) *pb.Index_IndexField_VectorConfig_FlatIndex {
	if in == nil {
		return nil
	}
	out := &pb.Index_IndexField_VectorConfig_FlatIndex{}
