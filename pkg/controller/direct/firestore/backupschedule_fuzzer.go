...
func backupScheduleFuzzer() fuzztesting.KRMFuzzer {
	f := fuzztesting.NewKRMTypedFuzzer(&pb.BackupSchedule{},
		FirestoreDatabaseBackupScheduleSpec_v1alpha1_FromProto, FirestoreDatabaseBackupScheduleSpec_v1alpha1_ToProto,
		FirestoreDatabaseBackupScheduleObservedState_v1alpha1_FromProto, FirestoreDatabaseBackupScheduleObservedState_v1alpha1_ToProto,
	)
