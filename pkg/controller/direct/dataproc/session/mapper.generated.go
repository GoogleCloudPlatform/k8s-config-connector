...
func BasicAutoscalingAlgorithm_FromProto(mapCtx *direct.MapContext, in *pb.BasicAutoscalingAlgorithm) *krmdataprocv1beta1.BasicAutoscalingAlgorithm {
	if in == nil {
		return nil
	}
...
func BasicAutoscalingAlgorithm_ToProto(mapCtx *direct.MapContext, in *krmdataprocv1beta1.BasicAutoscalingAlgorithm) *pb.BasicAutoscalingAlgorithm {
	if in == nil {
		return nil
	}
...
func BasicYarnAutoscalingConfig_FromProto(mapCtx *direct.MapContext, in *pb.BasicYarnAutoscalingConfig) *krmdataprocv1beta1.BasicYarnAutoscalingConfig {
	if in == nil {
		return nil
	}
...
func BasicYarnAutoscalingConfig_ToProto(mapCtx *direct.MapContext, in *krmdataprocv1beta1.BasicYarnAutoscalingConfig) *pb.BasicYarnAutoscalingConfig {
	if in == nil {
		return nil
	}
...
func DataprocAutoscalingPolicySpec_FromProto(mapCtx *direct.MapContext, in *pb.AutoscalingPolicy) *krmdataprocv1beta1.DataprocAutoscalingPolicySpec {
	if in == nil {
		return nil
	}
...
func DataprocAutoscalingPolicySpec_ToProto(mapCtx *direct.MapContext, in *krmdataprocv1beta1.DataprocAutoscalingPolicySpec) *pb.AutoscalingPolicy {
	if in == nil {
		return nil
	}
...
func DataprocSessionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Session) *krm.DataprocSessionObservedState {
	...
	out.StateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetStateTime())
	out.Creator = direct.LazyPtr(in.GetCreator())
	out.StateHistory = direct.Slice_FromProto(mapCtx, in.StateHistory, Session_SessionStateHistoryObservedState_FromProto)
	return out
}
func DataprocSessionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DataprocSessionObservedState) *pb.Session {
	...
	out.StateTime = direct.StringTimestamp_ToProto(mapCtx, in.StateTime)
	out.Creator = direct.ValueOf(in.Creator)
	out.StateHistory = direct.Slice_ToProto(mapCtx, in.StateHistory, Session_SessionStateHistoryObservedState_ToProto)
	return out
}
...
func InstanceFlexibilityPolicyObservedState_FromProto(mapCtx *direct.MapContext, in *pb.InstanceFlexibilityPolicy) *krm.InstanceFlexibilityPolicyObservedState {
	...
	out.InstanceSelectionResults = direct.Slice_FromProto(mapCtx, in.InstanceSelectionResults, InstanceFlexibilityPolicy_InstanceSelectionResultObservedState_FromProto)
	return out
}
func InstanceFlexibilityPolicyObservedState_ToProto(mapCtx *direct.MapContext, in *krm.InstanceFlexibilityPolicyObservedState) *pb.InstanceFlexibilityPolicy {
	...
	// MISSING: ProvisioningModelMix
	// MISSING: InstanceSelectionList
	out.InstanceSelectionResults = direct.Slice_ToProto(mapCtx, in.InstanceSelectionResults, InstanceFlexibilityPolicy_InstanceSelectionResultObservedState_ToProto)
	return out
}
...
func InstanceGroupAutoscalingPolicyConfig_FromProto(mapCtx *direct.MapContext, in *pb.InstanceGroupAutoscalingPolicyConfig) *krmdataprocv1beta1.InstanceGroupAutoscalingPolicyConfig {
	if in == nil {
		return nil
	}
...
func InstanceGroupAutoscalingPolicyConfig_ToProto(mapCtx *direct.MapContext, in *krmdataprocv1beta1.InstanceGroupAutoscalingPolicyConfig) *pb.InstanceGroupAutoscalingPolicyConfig {
	if in == nil {
		return nil
	}
...
func InstanceGroupConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.InstanceGroupConfig) *krm.InstanceGroupConfigObservedState {
	...
	out.ManagedGroupConfig = ManagedGroupConfigObservedState_FromProto(mapCtx, in.GetManagedGroupConfig())
...
func InstanceGroupConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krm.InstanceGroupConfigObservedState) *pb.InstanceGroupConfig {
	...
	// MISSING: Preemptibility
	out.ManagedGroupConfig = ManagedGroupConfigObservedState_ToProto(mapCtx, in.ManagedGroupConfig)
	// MISSING: Accelerators
	// MISSING: MinCPUPlatform
	// MISSING: MinNumInstances
...
func SecondaryInstanceGroupAutoscalingPolicyConfig_FromProto(mapCtx *direct.MapContext, in *pb.InstanceGroupAutoscalingPolicyConfig) *krmdataprocv1beta1.SecondaryInstanceGroupAutoscalingPolicyConfig {
	if in == nil {
		return nil
	}
...
func SecondaryInstanceGroupAutoscalingPolicyConfig_ToProto(mapCtx *direct.MapContext, in *krmdataprocv1beta1.SecondaryInstanceGroupAutoscalingPolicyConfig) *pb.InstanceGroupAutoscalingPolicyConfig {
	if in == nil {
		return nil
	}
	out := &pb.InstanceGroupAutoscalingPolicyConfig{}
