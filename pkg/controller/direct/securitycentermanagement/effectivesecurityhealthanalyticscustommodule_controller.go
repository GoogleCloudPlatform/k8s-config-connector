...
func init() {
	registry.RegisterModel(krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleGVK, NewEffectiveSecurityHealthAnalyticsCustomModuleModel)
}
...
func (m *modelEffectiveSecurityHealthAnalyticsCustomModule) AdapterForObject(ctx context.Context, reader client.Reader, u *unstructured.Unstructured) (directbase.Adapter, error) {
	obj := &krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModule{}
...
type EffectiveSecurityHealthAnalyticsCustomModuleAdapter struct {
	...
	desired   *krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModule
	actual    *securitycentermanagementpb.EffectiveSecurityHealthAnalyticsCustomModule
}
...
func (a *EffectiveSecurityHealthAnalyticsCustomModuleAdapter) Find(ctx context.Context) (bool, error) {
	...
	req := &securitycentermanagementpb.GetEffectiveSecurityHealthAnalyticsCustomModuleRequest{Name: a.id}
...
func (a *EffectiveSecurityHealthAnalyticsCustomModuleAdapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	resource := SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleSpec_ToProto(mapCtx, &desired.Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}

	// TODO(contributor): Complete the gcp "CREATE" or "INSERT" request.
	req := &securitycentermanagementpb.CreateEffectiveSecurityHealthAnalyticsCustomModuleRequest{
	...
	status := &krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleStatus{}
	status.ObservedState = SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleObservedState_FromProto(mapCtx, created)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
...
func (a *EffectiveSecurityHealthAnalyticsCustomModuleAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	desiredPb := SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleSpec_ToProto(mapCtx, &a.desired.DeepCopy().Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	if len(paths) == 0 {
		...
		status := &krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleStatus{}
		status.ObservedState = SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleObservedState_FromProto(mapCtx, a.actual)
		if mapCtx.Err() != nil {
			return mapCtx.Err()
		}
	...
	req := &securitycentermanagementpb.UpdateEffectiveSecurityHealthAnalyticsCustomModuleRequest{
		Name:       a.id.External,
	...
	status := &krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleStatus{}
	status.ObservedState = SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleObservedState_FromProto(mapCtx, updated)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	return updateOp.UpdateStatus(ctx, status, nil)
...
func (a *EffectiveSecurityHealthAnalyticsCustomModuleAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	obj := &krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModule{}
	mapCtx := &direct.MapContext{}
	obj.Spec = direct.ValueOf(SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleSpec_FromProto(mapCtx, a.actual))
	if mapCtx.Err() != nil {
	...
	u.SetGroupVersionKind(krm.SecuritycentermanagementEffectiveSecurityHealthAnalyticsCustomModuleGVK)
...
func (a *EffectiveSecurityHealthAnalyticsCustomModuleAdapter) Delete(ctx context.Context, deleteOp *directbase.DeleteOperation) (bool, error) {
	...
	req := &securitycentermanagementpb.DeleteEffectiveSecurityHealthAnalyticsCustomModuleRequest{Name: a.id.String()}
