...
import (
	...
	api "cloud.google.com/go/deploy/apiv1"
...
func (m *gcpClient) newCloudDeployClient(ctx context.Context) (*api.Client, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("building clouddeploy client: %w", err)
	}
	return client, err
}
