...
func DatabaseMigrationConnectionProfileObservedState_FromProto(mapCtx *direct.MapContext, in *pb.ConnectionProfile) *krm.DatabaseMigrationConnectionProfileObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DatabaseMigrationConnectionProfileObservedState{}
	// MISSING: Name
...
func DatabaseMigrationConnectionProfileObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DatabaseMigrationConnectionProfileObservedState) *pb.ConnectionProfile {
	if in == nil {
		return nil
	}
...
func DatabaseMigrationConnectionProfileSpec_FromProto(mapCtx *direct.MapContext, in *pb.ConnectionProfile) *krm.DatabaseMigrationConnectionProfileSpec {
	if in == nil {
		return nil
	}
	out := &krm.DatabaseMigrationConnectionProfileSpec{}
	// MISSING: Name
	out.Labels = in.Labels
...
func DatabaseMigrationConnectionProfileSpec_ToProto(mapCtx *direct.MapContext, in *krm.DatabaseMigrationConnectionProfileSpec) *pb.ConnectionProfile {
	if in == nil {
		return nil
	}
	out := &pb.ConnectionProfile{}
...
func DatabaseMigrationMigrationJobObservedState_FromProto(mapCtx *direct.MapContext, in *pb.MigrationJob) *krm.DatabaseMigrationMigrationJobObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DatabaseMigrationMigrationJobObservedState{}
	// MISSING: Name
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
	out.UpdateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetUpdateTime())
	out.State = direct.Enum_FromProto(mapCtx, in.GetState())
...
func DatabaseMigrationMigrationJobObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DatabaseMigrationMigrationJobObservedState) *pb.MigrationJob {
	if in == nil {
		return nil
	}
	out := &pb.MigrationJob{}
...
func DatabaseMigrationMigrationJobSpec_FromProto(mapCtx *direct.MapContext, in *pb.MigrationJob) *krm.DatabaseMigrationMigrationJobSpec {
	if in == nil {
		return nil
	}
	out := &krm.DatabaseMigrationMigrationJobSpec{}
	// MISSING: Name
	out.Labels = in.Labels
	out.DisplayName = direct.LazyPtr(in.GetDisplayName())
	...
	if in.GetSource() != "" {
		out.SourceRef = &krm.DatabaseMigrationConnectionProfileRef{External: in.GetSource()}
	}
	if in.GetDestination() != "" {
		out.DestinationRef = &krm.DatabaseMigrationConnectionProfileRef{External: in.GetDestination()}
	}
...
func DatabaseMigrationMigrationJobSpec_ToProto(mapCtx *direct.MapContext, in *krm.DatabaseMigrationMigrationJobSpec) *pb.MigrationJob {
	if in == nil {
		return nil
	}
	out := &pb.MigrationJob{}
...
func PrivateConnectivity_FromProto(mapCtx *direct.MapContext, in *pb.PrivateConnectivity) *krm.PrivateConnectivity {
	...
	if in.GetPrivateConnection() != "" {
		out.PrivateConnectionRef = &krm.DatabaseMigrationPrivateConnectionRef{External: in.GetPrivateConnection()}
	}
	return out
}
