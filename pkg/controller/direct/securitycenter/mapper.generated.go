...
func AttackExposureObservedState_FromProto(mapCtx *direct.MapContext, in *pb.AttackExposure) *krm.AttackExposureObservedState {
	if in == nil {
		return nil
	}
	out := &krm.AttackExposureObservedState{}
	// MISSING: Score
	// MISSING: LatestCalculationTime
	// MISSING: AttackExposureResult
	out.State = direct.Enum_FromProto(mapCtx, in.GetState())
	// MISSING: ExposedHighValueResourcesCount
	// MISSING: ExposedMediumValueResourcesCount
	// MISSING: ExposedLowValueResourcesCount
	return out
}
func AttackExposureObservedState_ToProto(mapCtx *direct.MapContext, in *krm.AttackExposureObservedState) *pb.AttackExposure {
	if in == nil {
		return nil
	}
	out := &pb.AttackExposure{}
...
func FindingObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Finding) *krm.FindingObservedState {
	...
	// MISSING: Kubernetes
	// MISSING: Database
	out.AttackExposure = AttackExposureObservedState_FromProto(mapCtx, in.GetAttackExposure())
	// MISSING: Files
...
func FindingObservedState_ToProto(mapCtx *direct.MapContext, in *krm.FindingObservedState) *pb.Finding {
	...
	// MISSING: Kubernetes
	// MISSING: Database
	out.AttackExposure = AttackExposureObservedState_ToProto(mapCtx, in.AttackExposure)
	// MISSING: Files
	// MISSING: CloudDlpInspection
	// MISSING: CloudDlpDataProfile
	// MISSING: KernelRootkit
