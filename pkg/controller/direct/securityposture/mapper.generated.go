...
func PostureTemplate_FromProto(mapCtx *direct.MapContext, in *pb.PostureTemplate) *krm.PostureTemplate {
	if in == nil {
		return nil
	}
	out := &krm.PostureTemplate{}
	// MISSING: Name
	// MISSING: RevisionID
	// MISSING: Description
	// MISSING: State
...
func PostureTemplate_ToProto(mapCtx *direct.MapContext, in *krm.PostureTemplate) *pb.PostureTemplate {
	if in == nil {
		return nil
	}
	out := &pb.PostureTemplate{}
	// MISSING: Name
	// MISSING: RevisionID
	// MISSING: Description
	// MISSING: State
...
func PostureTemplateObservedState_FromProto(mapCtx *direct.MapContext, in *pb.PostureTemplate) *krm.PostureTemplateObservedState {
	if in == nil {
		return nil
	}
	out := &krm.PostureTemplateObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
...
func PostureTemplateObservedState_ToProto(mapCtx *direct.MapContext, in *krm.PostureTemplateObservedState) *pb.PostureTemplate {
	if in == nil {
		return nil
	}
	out := &pb.PostureTemplate{}
	...
	out.Description = direct.ValueOf(in.Description)
	out.State = direct.Enum_ToProto[pb.PostureTemplate_State](mapCtx, in.State)
...
func SecurityposturePostureTemplateObservedState_FromProto(mapCtx *direct.MapContext, in *pb.PostureTemplate) *krm.SecurityposturePostureTemplateObservedState {
	if in == nil {
		return nil
	}
	out := &krm.SecurityposturePostureTemplateObservedState{}
	// MISSING: Name
	// MISSING: RevisionID
	// MISSING: Description
	// MISSING: State
...
func SecurityposturePostureTemplateObservedState_ToProto(mapCtx *direct.MapContext, in *krm.SecurityposturePostureTemplateObservedState) *pb.PostureTemplate {
	if in == nil {
		return nil
	}
	out := &pb.PostureTemplate{}
...
func SecurityposturePostureTemplateSpec_FromProto(mapCtx *direct.MapContext, in *pb.PostureTemplate) *krm.SecurityposturePostureTemplateSpec {
	if in == nil {
		return nil
	}
	out := &krm.SecurityposturePostureTemplateSpec{}
	// MISSING: Name
	// MISSING: RevisionID
	// MISSING: Description
	// MISSING: State
...
func SecurityposturePostureTemplateSpec_ToProto(mapCtx *direct.MapContext, in *krm.SecurityposturePostureTemplateSpec) *pb.PostureTemplate {
	if in == nil {
		return nil
	}
	out := &pb.PostureTemplate{}
