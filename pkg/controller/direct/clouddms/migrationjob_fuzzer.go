...
func dmsMigrationJobFuzzer() fuzztesting.KRMFuzzer {
	...
	f.Unimplemented_NotYetTriaged(".create_time.nanos")
	f.Unimplemented_NotYetTriaged(".create_time.seconds")
	...
	f.Unimplemented_NotYetTriaged(".dump_flags.dump_flags[].name")
	f.Unimplemented_NotYetTriaged(".dump_flags.dump_flags[].value")
	f.Unimplemented_NotYetTriaged(".dump_path")
	f.Unimplemented_NotYetTriaged(".duration")
	f.Unimplemented_NotYetTriaged(".duration.nanos")
	f.Unimplemented_NotYetTriaged(".duration.seconds")
	f.Unimplemented_NotYetTriaged(".end_time")
	f.Unimplemented_NotYetTriaged(".end_time.nanos")
	f.Unimplemented_NotYetTriaged(".end_time.seconds")
	f.Unimplemented_NotYetTriaged(".error")
	f.Unimplemented_NotYetTriaged(".error.code")
	...
	f.Unimplemented_NotYetTriaged(".error.message")
	...
	f.Unimplemented_NotYetTriaged(".update_time.nanos")
