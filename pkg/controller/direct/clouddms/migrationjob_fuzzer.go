...
func dmsMigrationJobFuzzer() fuzztesting.KRMFuzzer {
	...
	f.SpecFields.Insert(".dump_path")
	f.SpecFields.Insert(".dump_flags")
	f.SpecFields.Insert(".static_ip_connectivity")
	f.SpecFields.Insert(".source_database")
	f.SpecFields.Insert(".destination_database")
	f.SpecFields.Insert(".filter")
	f.SpecFields.Insert(".cmek_key_name")
	f.SpecFields.Insert(".performance_config")
	f.SpecFields.Insert(".vpc_peering_connectivity")
	f.SpecFields.Insert(".reverse_ssh_connectivity")
