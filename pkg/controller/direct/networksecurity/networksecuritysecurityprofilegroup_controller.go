...
func (m *securityProfileGroupModel) AdapterForObject(ctx context.Context, op *directbase.AdapterForObjectOperation) (directbase.Adapter, error) {
	...
	if obj.Spec.ThreatPreventionProfileRef != nil {
		desired.ThreatPreventionProfile = obj.Spec.ThreatPreventionProfileRef.External
	}
	if obj.Spec.CustomMirroringProfileRef != nil {
		desired.CustomMirroringProfile = obj.Spec.CustomMirroringProfileRef.External
	}
	if obj.Spec.CustomInterceptProfileRef != nil {
		desired.CustomInterceptProfile = obj.Spec.CustomInterceptProfileRef.External
	}
	if obj.Spec.URLFilteringProfileRef != nil {
		desired.UrlFilteringProfile = obj.Spec.URLFilteringProfileRef.External
	}
...
func (a *securityProfileGroupAdapter) Find(ctx context.Context) (bool, error) {
	...
	if err != nil {
		...
		return false, fmt.Errorf("getting SecurityProfileGroup %q: %w", a.id, err)
	}
...
func compareSecurityProfileGroup(ctx context.Context, actual, desired *pb.SecurityProfileGroup) (*structuredreporting.Diff, *fieldmaskpb.FieldMask, error) {
	...
	maskedActual.ThreatPreventionProfile = actual.ThreatPreventionProfile
	maskedActual.CustomMirroringProfile = actual.CustomMirroringProfile
	maskedActual.CustomInterceptProfile = actual.CustomInterceptProfile
	maskedActual.UrlFilteringProfile = actual.UrlFilteringProfile
