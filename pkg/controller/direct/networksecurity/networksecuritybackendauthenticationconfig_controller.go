...
func NewBackendAuthenticationConfigModel(ctx context.Context, config *config.ControllerConfig) (directbase.Model, error) {
	return &backendAuthenticationConfigModel{config: *config}, nil
}

var _ directbase.Model = &backendAuthenticationConfigModel{}

type backendAuthenticationConfigModel struct {
	config config.ControllerConfig
}

func (m *backendAuthenticationConfigModel) client(ctx context.Context) (pb.NetworkSecurityClient, longrunningpb.OperationsClient, error) {
...
func (m *backendAuthenticationConfigModel) AdapterForObject(ctx context.Context, op *directbase.AdapterForObjectOperation) (directbase.Adapter, error) {
	...
	desired := NetworkSecurityBackendAuthenticationConfigSpec_v1alpha1_ToProto(mapCtx, &obj.Spec)
	if mapCtx.Err() != nil {
		return nil, mapCtx.Err()
	}

	desired.Name = id.(*krm.NetworkSecurityBackendAuthenticationConfigIdentity).String()
...
func (m *backendAuthenticationConfigModel) AdapterForURL(ctx context.Context, url string) (directbase.Adapter, error) {
	return nil, nil
}
...
type backendAuthenticationConfigAdapter struct {
	...
	desired          *pb.BackendAuthenticationConfig
...
func (a *backendAuthenticationConfigAdapter) Find(ctx context.Context) (bool, error) {
	...
	req := &pb.GetBackendAuthenticationConfigRequest{Name: a.id.String()}
	actual, err := a.gcpClient.GetBackendAuthenticationConfig(ctx, req)
	if err != nil {
...
func (a *backendAuthenticationConfigAdapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	req := &pb.CreateBackendAuthenticationConfigRequest{
		Parent:                        a.id.ParentString(),
		BackendAuthenticationConfigId: a.id.BackendAuthenticationConfig,
		BackendAuthenticationConfig:   a.desired,
	}

	op, err := a.gcpClient.CreateBackendAuthenticationConfig(ctx, req)
	if err != nil {
	...
	getReq := &pb.GetBackendAuthenticationConfigRequest{Name: a.id.String()}
	latest, err := a.gcpClient.GetBackendAuthenticationConfig(ctx, getReq)
	if err != nil {
		return fmt.Errorf("getting BackendAuthenticationConfig after creation: %w", err)
	}
...
func (a *backendAuthenticationConfigAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	diffs, updateMask, err := compareBackendAuthenticationConfig(ctx, a.actual, a.desired)
	if err != nil {
		return err
	}
	...
	req := &pb.UpdateBackendAuthenticationConfigRequest{
		UpdateMask:                  updateMask,
		BackendAuthenticationConfig: a.desired,
	}
	req.BackendAuthenticationConfig.Name = a.id.String()

	op, err := a.gcpClient.UpdateBackendAuthenticationConfig(ctx, req)
	if err != nil {
	...
	latest, err := a.gcpClient.GetBackendAuthenticationConfig(ctx, getReq)
	if err != nil {
		return fmt.Errorf("getting BackendAuthenticationConfig after update: %w", err)
	}
...
func compareBackendAuthenticationConfig(ctx context.Context, actual, desired *pb.BackendAuthenticationConfig) (*structuredreporting.Diff, *fieldmaskpb.FieldMask, error) {
	mapCtx := &direct.MapContext{}
	spec := NetworkSecurityBackendAuthenticationConfigSpec_v1alpha1_FromProto(mapCtx, actual)
	if mapCtx.Err() != nil {
		return nil, nil, mapCtx.Err()
	}
	maskedActual := NetworkSecurityBackendAuthenticationConfigSpec_v1alpha1_ToProto(mapCtx, spec)
	if mapCtx.Err() != nil {
		return nil, nil, mapCtx.Err()
	}
...
func (a *backendAuthenticationConfigAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	obj := &krm.NetworkSecurityBackendAuthenticationConfig{}
	mapCtx := &direct.MapContext{}
	obj.Spec = direct.ValueOf(NetworkSecurityBackendAuthenticationConfigSpec_v1alpha1_FromProto(mapCtx, a.actual))
	if mapCtx.Err() != nil {
		return nil, mapCtx.Err()
	}
	...
	u.SetName(a.id.BackendAuthenticationConfig)
...
func (a *backendAuthenticationConfigAdapter) Delete(ctx context.Context, deleteOp *directbase.DeleteOperation) (bool, error) {
	...
	req := &pb.DeleteBackendAuthenticationConfigRequest{Name: a.id.String()}
	op, err := a.gcpClient.DeleteBackendAuthenticationConfig(ctx, req)
	if err != nil {
		if direct.IsNotFound(err) {
...
func (a *backendAuthenticationConfigAdapter) updateStatus(ctx context.Context, op directbase.Operation, latest *pb.BackendAuthenticationConfig) error {
	mapCtx := &direct.MapContext{}
	status := &krm.NetworkSecurityBackendAuthenticationConfigStatus{}
	status.ObservedState = NetworkSecurityBackendAuthenticationConfigObservedState_v1alpha1_FromProto(mapCtx, latest)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
...
func (a *backendAuthenticationConfigAdapter) waitForOperation(ctx context.Context, op *longrunningpb.Operation) error {
	for {
