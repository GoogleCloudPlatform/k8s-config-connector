...
func DialogflowTestCaseResultObservedState_FromProto(mapCtx *direct.MapContext, in *pb.TestCaseResult) *krm.DialogflowTestCaseResultObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DialogflowTestCaseResultObservedState{}
	// MISSING: Name
	// MISSING: Environment
	// MISSING: ConversationTurns
	// MISSING: TestResult
	// MISSING: TestTime
	return out
}
func DialogflowTestCaseResultObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DialogflowTestCaseResultObservedState) *pb.TestCaseResult {
	if in == nil {
		return nil
	}
...
func DialogflowTestCaseResultSpec_FromProto(mapCtx *direct.MapContext, in *pb.TestCaseResult) *krm.DialogflowTestCaseResultSpec {
	if in == nil {
		return nil
	}
	out := &krm.DialogflowTestCaseResultSpec{}
	// MISSING: Name
	// MISSING: Environment
	// MISSING: ConversationTurns
	// MISSING: TestResult
...
func DialogflowTestCaseResultSpec_ToProto(mapCtx *direct.MapContext, in *krm.DialogflowTestCaseResultSpec) *pb.TestCaseResult {
	if in == nil {
		return nil
	}
	out := &pb.TestCaseResult{}
...
func TestCaseResultObservedState_FromProto(mapCtx *direct.MapContext, in *pb.TestCaseResult) *krm.TestCaseResultObservedState {
	if in == nil {
		return nil
	}
	out := &krm.TestCaseResultObservedState{}
	// MISSING: Name
	// MISSING: Environment
	out.ConversationTurns = direct.Slice_FromProto(mapCtx, in.ConversationTurns, ConversationTurnObservedState_FromProto)
	// MISSING: TestResult
	// MISSING: TestTime
	return out
}
func TestCaseResultObservedState_ToProto(mapCtx *direct.MapContext, in *krm.TestCaseResultObservedState) *pb.TestCaseResult {
	if in == nil {
		return nil
	}
	out := &pb.TestCaseResult{}
	// MISSING: Name
	// MISSING: Environment
	out.ConversationTurns = direct.Slice_ToProto(mapCtx, in.ConversationTurns, ConversationTurnObservedState_ToProto)
	// MISSING: TestResult
	// MISSING: TestTime
	return out
}
