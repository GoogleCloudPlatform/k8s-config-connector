...
func (m *model) client(ctx context.Context) (*gcp.GeneratorsClient, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("building Generators client: %w", err)
	}
...
func (a *Adapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	// Do NOT set Name field on Generator payload, as GCP requires it to be empty during creation
...
func (a *Adapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	// Use tags.DiffForTopLevelFields (referred to as common.DiffForTopLevelFields) over recursive comparison
	...
	if diffs.HasDiff() {
		...
		// Ensure Name is set correctly in desired for update operation
...
func compareGenerator(ctx context.Context, actual, desired *pb.Generator) (*structuredreporting.Diff, *fieldmaskpb.FieldMask, error) {
	...
	populateDefaults := func(obj *pb.Generator) {
		// No defaults currently specified, but pattern remains clean
	}
