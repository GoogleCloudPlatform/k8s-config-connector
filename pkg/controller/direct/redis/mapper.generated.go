...
func RedisCertificateAuthorityObservedState_FromProto(mapCtx *direct.MapContext, in *pb.CertificateAuthority) *krm.RedisCertificateAuthorityObservedState {
	if in == nil {
		return nil
	}
	out := &krm.RedisCertificateAuthorityObservedState{}
	// MISSING: ManagedServerCa
	// MISSING: Name
	return out
}
func RedisCertificateAuthorityObservedState_ToProto(mapCtx *direct.MapContext, in *krm.RedisCertificateAuthorityObservedState) *pb.CertificateAuthority {
	if in == nil {
		return nil
	}
	out := &pb.CertificateAuthority{}
...
func RedisCertificateAuthoritySpec_FromProto(mapCtx *direct.MapContext, in *pb.CertificateAuthority) *krm.RedisCertificateAuthoritySpec {
	if in == nil {
		return nil
	}
	out := &krm.RedisCertificateAuthoritySpec{}
	// MISSING: ManagedServerCa
	// MISSING: Name
	return out
}
func RedisCertificateAuthoritySpec_ToProto(mapCtx *direct.MapContext, in *krm.RedisCertificateAuthoritySpec) *pb.CertificateAuthority {
	if in == nil {
		return nil
	}
	out := &pb.CertificateAuthority{}
...
func RedisClusterObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Cluster) *krm.RedisClusterObservedState {
	...
	// (near miss): "PreciseSizeGB" vs "PreciseSizeGb"
	return out
}
