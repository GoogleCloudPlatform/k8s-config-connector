...
func workstationConfigFuzzer() fuzztesting.KRMFuzzer {
	...
	f.UnimplementedFields.Insert(".disable_tcp_connections")
	f.UnimplementedFields.Insert(".grant_workstation_admin_role_on_create")
	f.UnimplementedFields.Insert(".persistent_directories[].gce_pd.max_size_gb")
	f.UnimplementedFields.Insert(".persistent_directories[].gce_pd.archive_timeout")
	f.UnimplementedFields.Insert(".persistent_directories[].gce_hd")
	f.UnimplementedFields.Insert(".ephemeral_directories")
	f.UnimplementedFields.Insert(".host.gce_instance.vm_tags")
	f.UnimplementedFields.Insert(".allowed_ports")
	f.UnimplementedFields.Insert(".allowed_ports[].first")
	f.UnimplementedFields.Insert(".max_usable_workstations")
	f.UnimplementedFields.Insert(".enable_audit_agent")
	f.UnimplementedFields.Insert(".host.gce_instance.instance_metadata")
	f.UnimplementedFields.Insert(".host.gce_instance.startup_script_uri")
	f.UnimplementedFields.Insert(".host.gce_instance.accelerators")
	f.UnimplementedFields.Insert(".host.gce_instance.boost_configs")
	f.UnimplementedFields.Insert(".host.gce_instance.disable_ssh")
