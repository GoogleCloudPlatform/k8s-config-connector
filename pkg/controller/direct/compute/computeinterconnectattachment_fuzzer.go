...
func computeInterconnectAttachmentFuzzer() fuzztesting.KRMFuzzer {
	...
	f.Unimplemented_NotYetTriaged(".candidate_cloud_router_ip_address")
	f.Unimplemented_NotYetTriaged(".candidate_cloud_router_ipv6_address")
	f.Unimplemented_NotYetTriaged(".candidate_customer_router_ip_address")
	f.Unimplemented_NotYetTriaged(".candidate_customer_router_ipv6_address")
	...
	f.Unimplemented_NotYetTriaged(".l2_forwarding")
