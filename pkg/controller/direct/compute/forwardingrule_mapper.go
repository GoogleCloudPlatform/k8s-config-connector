...
func FilterLabels_FromProto(mapCtx *direct.MapContext, in *pb.MetadataFilterLabelMatch) *krm.MetadataFilterLabelMatch {
	if in == nil {
		return nil
	}
...
func FilterLabels_ToProto(mapCtx *direct.MapContext, in *krm.MetadataFilterLabelMatch) *pb.MetadataFilterLabelMatch {
	if in == nil {
		return nil
	}
...
func MetadataFilter_FromProto(mapCtx *direct.MapContext, in *pb.MetadataFilter) *krm.MetadataFilter {
	...
	out.FilterLabels = direct.Slice_FromProto(mapCtx, in.FilterLabels, FilterLabels_FromProto)
...
func MetadataFilter_ToProto(mapCtx *direct.MapContext, in *krm.MetadataFilter) *pb.MetadataFilter {
	...
	out.FilterLabels = direct.Slice_ToProto(mapCtx, in.FilterLabels, FilterLabels_ToProto)
