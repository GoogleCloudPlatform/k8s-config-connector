...
func (m *gcpClient) newNetworkAttachmentsClient(ctx context.Context) (*api.NetworkAttachmentsClient, error) {
	opts, err := m.config.RESTClientOptions()
	if err != nil {
		return nil, err
	}
	client, err := api.NewNetworkAttachmentsRESTClient(ctx, opts...)
	if err != nil {
