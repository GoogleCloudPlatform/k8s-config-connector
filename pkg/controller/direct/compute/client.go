...
func (m *gcpClient) newGlobalUrlMapsClient(ctx context.Context) (*compute.UrlMapsClient, error) {
	opts, err := m.config.RESTClientOptions()
	if err != nil {
		return nil, err
	}
	...
	if err != nil {
		return nil, fmt.Errorf("building global compute UrlMaps client: %w", err)
...
func (m *gcpClient) newRegionUrlMapsClient(ctx context.Context) (*compute.RegionUrlMapsClient, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("building regional compute UrlMaps client: %w", err)
