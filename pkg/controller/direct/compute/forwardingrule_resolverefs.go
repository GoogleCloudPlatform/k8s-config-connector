...
// todo: Use NormalizeExternal to resolve refs
// https://github.com/GoogleCloudPlatform/k8s-config-connector/pull/5201
func ResolveComputeNetworkForForwardingRule(ctx context.Context, reader client.Reader, src client.Object, ref *refs.ComputeNetworkRef) (*refs.ComputeNetworkRef, error) {
	if ref == nil {
		return nil, nil
	}
...
func resolveForwardingRuleRefs(ctx context.Context, reader client.Reader, obj *krm.ComputeForwardingRule) error {
	...
	if obj.Spec.NetworkRef != nil {
		networkRef, err := ResolveComputeNetworkForForwardingRule(ctx, reader, obj, obj.Spec.NetworkRef)
		if err != nil {
			return err
