...
func computeRouteFuzzer() fuzztesting.KRMFuzzer {
	...
	// - nextHopILBRef                      -> .next_hop_ilb
	// - nextHopInstanceRef                 -> .next_hop_instance
	// - nextHopIP                          -> .next_hop_ip
	// - nextHopVPNTunnelRef                -> .next_hop_vpn_tunnel
	// - priority                           -> .priority
	// - tags                               -> .tags
	...
	f.FilterStatus = func(in *pb.Route) {
		in.Description = nil
		in.DestRange = nil
		in.Network = nil
		in.NextHopGateway = nil
		in.NextHopIlb = nil
		in.NextHopInstance = nil
		in.NextHopIp = nil
		in.NextHopVpnTunnel = nil
		in.Priority = nil
		in.Tags = nil
		in.Name = nil
		in.Id = nil
		in.Kind = nil
		in.NextHopInterconnectAttachment = nil
	}
