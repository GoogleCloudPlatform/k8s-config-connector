...
func init() {
	fuzztesting.RegisterKRMSpecFuzzer(computeBackendServiceSignedURLKeyFuzzer())
}

func computeBackendServiceSignedURLKeyFuzzer() fuzztesting.KRMFuzzer {
	...
	// Spec fields
	f.SpecField(".key_value")

	// Unimplemented fields
	f.Unimplemented_Identity(".key_name")
