...
func ComputeRegionNetworkEndpointGroupObservedState_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.NetworkEndpointGroup) *krm.ComputeRegionNetworkEndpointGroupObservedState {
	if in == nil {
		return nil
	}
	out := &krm.ComputeRegionNetworkEndpointGroupObservedState{}
	// MISSING: Annotations
	// MISSING: AppEngine
	// MISSING: CreationTimestamp
	// MISSING: DefaultPort
...
func ComputeRegionNetworkEndpointGroupObservedState_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.ComputeRegionNetworkEndpointGroupObservedState) *pb.NetworkEndpointGroup {
	if in == nil {
		return nil
	}
...
func ComputeRegionNetworkEndpointGroupSpec_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.NetworkEndpointGroup) *krm.ComputeRegionNetworkEndpointGroupSpec {
	...
	// MISSING: Annotations
	// MISSING: AppEngine
	out.CloudFunction = NetworkEndpointGroupCloudFunction_v1beta1_FromProto(mapCtx, in.GetCloudFunction())
	out.CloudRun = NetworkEndpointGroupCloudRun_v1beta1_FromProto(mapCtx, in.GetCloudRun())
	// MISSING: CreationTimestamp
	// MISSING: DefaultPort
	out.Description = in.Description
	// MISSING: ID
...
func ComputeRegionNetworkEndpointGroupSpec_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.ComputeRegionNetworkEndpointGroupSpec) *pb.NetworkEndpointGroup {
	...
	// MISSING: Annotations
	// MISSING: AppEngine
	out.CloudFunction = NetworkEndpointGroupCloudFunction_v1beta1_ToProto(mapCtx, in.CloudFunction)
	out.CloudRun = NetworkEndpointGroupCloudRun_v1beta1_ToProto(mapCtx, in.CloudRun)
	// MISSING: CreationTimestamp
	// MISSING: DefaultPort
	out.Description = in.Description
	// MISSING: ID
...
func NetworkEndpointGroupCloudFunction_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.NetworkEndpointGroupCloudFunction) *krm.NetworkEndpointGroupCloudFunction {
	...
	if in.GetFunction() != "" {
		out.FunctionRef = &refsv1beta1.CloudFunctionsFunctionRef{External: in.GetFunction()}
	}
...
func NetworkEndpointGroupCloudRun_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.NetworkEndpointGroupCloudRun) *krm.NetworkEndpointGroupCloudRun {
	...
	if in.GetService() != "" {
		out.ServiceRef = &refsv1beta1.RunServiceRef{External: in.GetService()}
	}
	out.Tag = in.Tag
	out.URLMask = in.UrlMask
	return out
