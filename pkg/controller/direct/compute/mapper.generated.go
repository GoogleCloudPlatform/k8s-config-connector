...
*/
func ComputeGlobalNetworkEndpointObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.NetworkEndpoint) *krmcomputev1alpha1.ComputeGlobalNetworkEndpointObservedState {
	if in == nil {
		return nil
	}
	out := &krmcomputev1alpha1.ComputeGlobalNetworkEndpointObservedState{}
	// MISSING: Annotations
...
func ComputeGlobalNetworkEndpointObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmcomputev1alpha1.ComputeGlobalNetworkEndpointObservedState) *pb.NetworkEndpoint {
	if in == nil {
		return nil
	}
