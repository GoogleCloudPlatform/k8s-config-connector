...
*/
func ComputeRouteObservedState_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.Route) *krm.ComputeRouteObservedState {
	if in == nil {
		return nil
	}
	out := &krm.ComputeRouteObservedState{}
	// MISSING: AsPaths
	// MISSING: CreationTimestamp
	// MISSING: ID
	// MISSING: Kind
...
func ComputeRouteObservedState_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.ComputeRouteObservedState) *pb.Route {
	if in == nil {
		return nil
	}
	out := &pb.Route{}
