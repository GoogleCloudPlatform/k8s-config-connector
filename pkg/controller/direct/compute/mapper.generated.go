...
func AllocationAggregateReservation_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.AllocationAggregateReservation) *krm.AllocationAggregateReservation {
	if in == nil {
		return nil
	}
	out := &krm.AllocationAggregateReservation{}
	out.InUseResources = direct.Slice_FromProto(mapCtx, in.InUseResources, AllocationAggregateReservationReservedResourceInfo_computepb_v1beta1_FromProto)
	out.ReservedResources = direct.Slice_FromProto(mapCtx, in.ReservedResources, AllocationAggregateReservationReservedResourceInfo_computepb_v1beta1_FromProto)
	out.VMFamily = in.VmFamily
	out.WorkloadType = in.WorkloadType
	return out
}
func AllocationAggregateReservation_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.AllocationAggregateReservation) *computepb.AllocationAggregateReservation {
	if in == nil {
		return nil
	}
	out := &computepb.AllocationAggregateReservation{}
	out.InUseResources = direct.Slice_ToProto(mapCtx, in.InUseResources, AllocationAggregateReservationReservedResourceInfo_computepb_v1beta1_ToProto)
	out.ReservedResources = direct.Slice_ToProto(mapCtx, in.ReservedResources, AllocationAggregateReservationReservedResourceInfo_computepb_v1beta1_ToProto)
	out.VmFamily = in.VMFamily
	out.WorkloadType = in.WorkloadType
	return out
}
func AllocationAggregateReservationReservedResourceInfo_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.AllocationAggregateReservationReservedResourceInfo) *krm.AllocationAggregateReservationReservedResourceInfo {
	if in == nil {
		return nil
	}
	out := &krm.AllocationAggregateReservationReservedResourceInfo{}
	out.Accelerator = AllocationAggregateReservationReservedResourceInfoAccelerator_computepb_v1beta1_FromProto(mapCtx, in.GetAccelerator())
	return out
}
func AllocationAggregateReservationReservedResourceInfo_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.AllocationAggregateReservationReservedResourceInfo) *computepb.AllocationAggregateReservationReservedResourceInfo {
	if in == nil {
		return nil
	}
	out := &computepb.AllocationAggregateReservationReservedResourceInfo{}
	out.Accelerator = AllocationAggregateReservationReservedResourceInfoAccelerator_computepb_v1beta1_ToProto(mapCtx, in.Accelerator)
	return out
}
func AllocationAggregateReservationReservedResourceInfoAccelerator_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.AllocationAggregateReservationReservedResourceInfoAccelerator) *krm.AllocationAggregateReservationReservedResourceInfoAccelerator {
	if in == nil {
		return nil
	}
...
func AllocationAggregateReservationReservedResourceInfoAccelerator_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.AllocationAggregateReservationReservedResourceInfoAccelerator) *computepb.AllocationAggregateReservationReservedResourceInfoAccelerator {
	if in == nil {
		return nil
	}
...
func AllocationSpecificSkuAllocationAllocatedInstancePropertiesReservedDisk_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDisk) *krm.AllocationSpecificSkuAllocationAllocatedInstancePropertiesReservedDisk {
	if in == nil {
		return nil
	}
...
func AllocationSpecificSkuAllocationAllocatedInstancePropertiesReservedDisk_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.AllocationSpecificSkuAllocationAllocatedInstancePropertiesReservedDisk) *computepb.AllocationSpecificSKUAllocationAllocatedInstancePropertiesReservedDisk {
	if in == nil {
		return nil
	}
...
func AllocationSpecificSkuAllocationReservedInstanceProperties_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.AllocationSpecificSKUAllocationReservedInstanceProperties) *krm.AllocationSpecificSkuAllocationReservedInstanceProperties {
	if in == nil {
		return nil
	}
	out := &krm.AllocationSpecificSkuAllocationReservedInstanceProperties{}
	out.GuestAccelerators = direct.Slice_FromProto(mapCtx, in.GuestAccelerators, AcceleratorConfig_computepb_v1beta1_FromProto)
	out.LocalSsds = direct.Slice_FromProto(mapCtx, in.LocalSsds, AllocationSpecificSkuAllocationAllocatedInstancePropertiesReservedDisk_computepb_v1beta1_FromProto)
...
func AllocationSpecificSkuAllocationReservedInstanceProperties_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.AllocationSpecificSkuAllocationReservedInstanceProperties) *computepb.AllocationSpecificSKUAllocationReservedInstanceProperties {
	if in == nil {
		return nil
	}
	out := &computepb.AllocationSpecificSKUAllocationReservedInstanceProperties{}
	out.GuestAccelerators = direct.Slice_ToProto(mapCtx, in.GuestAccelerators, AcceleratorConfig_computepb_v1beta1_ToProto)
	out.LocalSsds = direct.Slice_ToProto(mapCtx, in.LocalSsds, AllocationSpecificSkuAllocationAllocatedInstancePropertiesReservedDisk_computepb_v1beta1_ToProto)
	out.LocationHint = in.LocationHint
	out.MachineType = in.MachineType
	out.MaintenanceFreezeDurationHours = in.MaintenanceFreezeDurationHours
	out.MaintenanceInterval = in.MaintenanceInterval
...
func ComputeFutureReservationSpec_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservation) *krm.ComputeFutureReservationSpec {
	if in == nil {
		return nil
	}
	out := &krm.ComputeFutureReservationSpec{}
	out.AggregateReservation = AllocationAggregateReservation_computepb_v1beta1_FromProto(mapCtx, in.GetAggregateReservation())
	out.AutoCreatedReservationsDeleteTime = in.AutoCreatedReservationsDeleteTime
	out.AutoCreatedReservationsDuration = Duration_computepb_v1beta1_FromProto(mapCtx, in.GetAutoCreatedReservationsDuration())
	out.AutoDeleteAutoCreatedReservations = in.AutoDeleteAutoCreatedReservations
	out.CommitmentInfo = FutureReservationCommitmentInfo_computepb_v1beta1_FromProto(mapCtx, in.GetCommitmentInfo())
	...
	out.ShareSettings = ShareSettings_computepb_v1beta1_FromProto(mapCtx, in.GetShareSettings())
	out.SpecificReservationRequired = in.SpecificReservationRequired
	out.SpecificSkuProperties = FutureReservationSpecificSkuProperties_computepb_v1beta1_FromProto(mapCtx, in.GetSpecificSkuProperties())
	// MISSING: Status
	out.TimeWindow = FutureReservationTimeWindow_computepb_v1beta1_FromProto(mapCtx, in.GetTimeWindow())
	return out
}
func ComputeFutureReservationSpec_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.ComputeFutureReservationSpec) *computepb.FutureReservation {
	if in == nil {
		return nil
	}
	out := &computepb.FutureReservation{}
	out.AggregateReservation = AllocationAggregateReservation_computepb_v1beta1_ToProto(mapCtx, in.AggregateReservation)
	out.AutoCreatedReservationsDeleteTime = in.AutoCreatedReservationsDeleteTime
	out.AutoCreatedReservationsDuration = Duration_computepb_v1beta1_ToProto(mapCtx, in.AutoCreatedReservationsDuration)
	out.AutoDeleteAutoCreatedReservations = in.AutoDeleteAutoCreatedReservations
	out.CommitmentInfo = FutureReservationCommitmentInfo_computepb_v1beta1_ToProto(mapCtx, in.CommitmentInfo)
	out.DeploymentType = in.DeploymentType
	out.Description = in.Description
	out.EnableEmergentMaintenance = in.EnableEmergentMaintenance
	out.Name = in.Name
	...
	out.ReservationName = in.ReservationName
	out.SchedulingType = in.SchedulingType
	out.ShareSettings = ShareSettings_computepb_v1beta1_ToProto(mapCtx, in.ShareSettings)
	out.SpecificReservationRequired = in.SpecificReservationRequired
	out.SpecificSkuProperties = FutureReservationSpecificSkuProperties_computepb_v1beta1_ToProto(mapCtx, in.SpecificSkuProperties)
	// MISSING: Status
	out.TimeWindow = FutureReservationTimeWindow_computepb_v1beta1_ToProto(mapCtx, in.TimeWindow)
	return out
}
...
func Duration_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.Duration) *krm.Duration {
	if in == nil {
		return nil
	}
	out := &krm.Duration{}
...
func Duration_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.Duration) *computepb.Duration {
	if in == nil {
		return nil
	}
...
func FutureReservationCommitmentInfo_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationCommitmentInfo) *krm.FutureReservationCommitmentInfo {
	if in == nil {
		return nil
	}
...
func FutureReservationCommitmentInfo_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationCommitmentInfo) *computepb.FutureReservationCommitmentInfo {
	if in == nil {
		return nil
	}
...
func FutureReservationSpecificSkuProperties_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationSpecificSKUProperties) *krm.FutureReservationSpecificSkuProperties {
	if in == nil {
		return nil
	}
	out := &krm.FutureReservationSpecificSkuProperties{}
	out.InstanceProperties = AllocationSpecificSkuAllocationReservedInstanceProperties_computepb_v1beta1_FromProto(mapCtx, in.GetInstanceProperties())
	out.SourceInstanceTemplate = in.SourceInstanceTemplate
	out.TotalCount = in.TotalCount
	return out
}
func FutureReservationSpecificSkuProperties_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationSpecificSkuProperties) *computepb.FutureReservationSpecificSKUProperties {
	if in == nil {
		return nil
	}
	out := &computepb.FutureReservationSpecificSKUProperties{}
	out.InstanceProperties = AllocationSpecificSkuAllocationReservedInstanceProperties_computepb_v1beta1_ToProto(mapCtx, in.InstanceProperties)
	out.SourceInstanceTemplate = in.SourceInstanceTemplate
	out.TotalCount = in.TotalCount
	return out
}
func FutureReservationStatus_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationStatus) *krm.FutureReservationStatus {
	if in == nil {
		return nil
	}
	...
	out.ExistingMatchingUsageInfo = FutureReservationStatusExistingMatchingUsageInfo_computepb_v1beta1_FromProto(mapCtx, in.GetExistingMatchingUsageInfo())
	out.FulfilledCount = in.FulfilledCount
	out.LastKnownGoodState = FutureReservationStatusLastKnownGoodState_computepb_v1beta1_FromProto(mapCtx, in.GetLastKnownGoodState())
	out.LockTime = in.LockTime
	out.ProcurementStatus = in.ProcurementStatus
	out.SpecificSkuProperties = FutureReservationStatusSpecificSkuProperties_computepb_v1beta1_FromProto(mapCtx, in.GetSpecificSkuProperties())
	return out
}
func FutureReservationStatus_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationStatus) *computepb.FutureReservationStatus {
	if in == nil {
		return nil
	}
	...
	out.AmendmentStatus = in.AmendmentStatus
	out.AutoCreatedReservations = in.AutoCreatedReservations
	out.ExistingMatchingUsageInfo = FutureReservationStatusExistingMatchingUsageInfo_computepb_v1beta1_ToProto(mapCtx, in.ExistingMatchingUsageInfo)
	out.FulfilledCount = in.FulfilledCount
	out.LastKnownGoodState = FutureReservationStatusLastKnownGoodState_computepb_v1beta1_ToProto(mapCtx, in.LastKnownGoodState)
	out.LockTime = in.LockTime
	out.ProcurementStatus = in.ProcurementStatus
	out.SpecificSkuProperties = FutureReservationStatusSpecificSkuProperties_computepb_v1beta1_ToProto(mapCtx, in.SpecificSkuProperties)
	return out
}
func FutureReservationStatusExistingMatchingUsageInfo_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationStatusExistingMatchingUsageInfo) *krm.FutureReservationStatusExistingMatchingUsageInfo {
	if in == nil {
		return nil
	}
...
func FutureReservationStatusExistingMatchingUsageInfo_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationStatusExistingMatchingUsageInfo) *computepb.FutureReservationStatusExistingMatchingUsageInfo {
	if in == nil {
		return nil
	}
...
func FutureReservationStatusLastKnownGoodState_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationStatusLastKnownGoodState) *krm.FutureReservationStatusLastKnownGoodState {
	if in == nil {
		return nil
	}
	...
	out.Description = in.Description
	out.ExistingMatchingUsageInfo = FutureReservationStatusExistingMatchingUsageInfo_computepb_v1beta1_FromProto(mapCtx, in.GetExistingMatchingUsageInfo())
	out.FutureReservationSpecs = FutureReservationStatusLastKnownGoodStateFutureReservationSpecs_computepb_v1beta1_FromProto(mapCtx, in.GetFutureReservationSpecs())
	out.LockTime = in.LockTime
	out.NamePrefix = in.NamePrefix
	out.ProcurementStatus = in.ProcurementStatus
	return out
}
func FutureReservationStatusLastKnownGoodState_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationStatusLastKnownGoodState) *computepb.FutureReservationStatusLastKnownGoodState {
	if in == nil {
		return nil
	}
	...
	out.Description = in.Description
	out.ExistingMatchingUsageInfo = FutureReservationStatusExistingMatchingUsageInfo_computepb_v1beta1_ToProto(mapCtx, in.ExistingMatchingUsageInfo)
	out.FutureReservationSpecs = FutureReservationStatusLastKnownGoodStateFutureReservationSpecs_computepb_v1beta1_ToProto(mapCtx, in.FutureReservationSpecs)
	out.LockTime = in.LockTime
	out.NamePrefix = in.NamePrefix
	out.ProcurementStatus = in.ProcurementStatus
	return out
}
func FutureReservationStatusLastKnownGoodStateFutureReservationSpecs_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationStatusLastKnownGoodStateFutureReservationSpecs) *krm.FutureReservationStatusLastKnownGoodStateFutureReservationSpecs {
	if in == nil {
		return nil
	}
...
func FutureReservationStatusLastKnownGoodStateFutureReservationSpecs_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationStatusLastKnownGoodStateFutureReservationSpecs) *computepb.FutureReservationStatusLastKnownGoodStateFutureReservationSpecs {
	if in == nil {
		return nil
	}
...
func FutureReservationStatusSpecificSkuProperties_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationStatusSpecificSKUProperties) *krm.FutureReservationStatusSpecificSkuProperties {
	if in == nil {
		return nil
	}
...
func FutureReservationStatusSpecificSkuProperties_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationStatusSpecificSkuProperties) *computepb.FutureReservationStatusSpecificSKUProperties {
	if in == nil {
		return nil
	}
...
func FutureReservationTimeWindow_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.FutureReservationTimeWindow) *krm.FutureReservationTimeWindow {
	if in == nil {
		return nil
	}
	out := &krm.FutureReservationTimeWindow{}
	out.Duration = Duration_computepb_v1beta1_FromProto(mapCtx, in.GetDuration())
	out.EndTime = in.EndTime
	out.StartTime = in.StartTime
	return out
}
func FutureReservationTimeWindow_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.FutureReservationTimeWindow) *computepb.FutureReservationTimeWindow {
	if in == nil {
		return nil
	}
	out := &computepb.FutureReservationTimeWindow{}
	out.Duration = Duration_computepb_v1beta1_ToProto(mapCtx, in.Duration)
	out.EndTime = in.EndTime
	out.StartTime = in.StartTime
	return out
}
...
func ShareSettings_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.ShareSettings) *krm.ShareSettings {
	if in == nil {
		return nil
	}
...
func ShareSettings_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.ShareSettings) *computepb.ShareSettings {
	if in == nil {
		return nil
	}
...
func ShareSettingsProjectConfig_computepb_v1beta1_FromProto(mapCtx *direct.MapContext, in *computepb.ShareSettingsProjectConfig) *krm.ShareSettingsProjectConfig {
	if in == nil {
		return nil
	}
...
func ShareSettingsProjectConfig_computepb_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.ShareSettingsProjectConfig) *computepb.ShareSettingsProjectConfig {
	if in == nil {
		return nil
	}
