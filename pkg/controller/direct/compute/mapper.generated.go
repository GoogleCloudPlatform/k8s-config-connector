...
func ComputeNetworkAttachmentSpec_FromProto(mapCtx *direct.MapContext, in *pb.NetworkAttachment) *krm.ComputeNetworkAttachmentSpec {
	...
	out.Subnetworks = ComputeNetworkAttachmentSpec_Subnetworks_FromProto(mapCtx, in.Subnetworks)
	return out
}
func ComputeNetworkAttachmentSpec_ToProto(mapCtx *direct.MapContext, in *krm.ComputeNetworkAttachmentSpec) *pb.NetworkAttachment {
	...
	out.Subnetworks = ComputeNetworkAttachmentSpec_Subnetworks_ToProto(mapCtx, in.Subnetworks)
	return out
}
...
func NetworkAttachment_FromProto(mapCtx *direct.MapContext, in *pb.NetworkAttachment) *krm.NetworkAttachment {
	if in == nil {
		return nil
	}
	out := &krm.NetworkAttachment{}
	out.ConnectionEndpoints = direct.Slice_FromProto(mapCtx, in.ConnectionEndpoints, NetworkAttachmentConnectedEndpoint_FromProto)
	out.ConnectionPreference = in.ConnectionPreference
	out.CreationTimestamp = in.CreationTimestamp
	out.Description = in.Description
...
func NetworkAttachment_ToProto(mapCtx *direct.MapContext, in *krm.NetworkAttachment) *pb.NetworkAttachment {
	if in == nil {
		return nil
	}
	out := &pb.NetworkAttachment{}
