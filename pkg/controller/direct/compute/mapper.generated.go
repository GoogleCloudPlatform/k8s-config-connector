...
*/
func ComputeHealthCheckObservedState_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.HealthCheck) *krm.ComputeHealthCheckObservedState {
	if in == nil {
		return nil
	}
	out := &krm.ComputeHealthCheckObservedState{}
	// MISSING: CreationTimestamp
