...
func computeHTTPSHealthCheckFuzzer() fuzztesting.KRMFuzzer {
	...
	// - checkIntervalSec maps to .check_interval_sec
	// - description maps to .description
	// - healthyThreshold maps to .healthy_threshold
	// - timeoutSec maps to .timeout_sec
	// - unhealthyThreshold maps to .unhealthy_threshold
	// - host, port, requestPath map to nested fields inside .https_health_check (.https_health_check.host, .https_health_check.port, .https_health_check.request_path)
