...
func (a *FutureReservationAdapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	resource := ComputeFutureReservationSpec_computepb_v1beta1_ToProto(mapCtx, &desired.Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	status.ObservedState = ComputeFutureReservationObservedState_computepb_v1beta1_FromProto(mapCtx, created)
...
func (a *FutureReservationAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	status := &krm.ComputeFutureReservationStatus{}
	status.ObservedState = ComputeFutureReservationObservedState_computepb_v1beta1_FromProto(mapCtx, updated)
	status.ExternalRef = direct.LazyPtr(a.id.String())
...
func (a *FutureReservationAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	obj := &krm.ComputeFutureReservation{}
	mapCtx := &direct.MapContext{}
	obj.Spec = direct.ValueOf(ComputeFutureReservationSpec_computepb_v1beta1_FromProto(mapCtx, a.actual))
	if mapCtx.Err() != nil {
