...
func init() {
	registry.RegisterModel(krm.CloudcontrolspartnerViolationGVK, NewViolationModel)
}
...
func (m *modelViolation) AdapterForObject(ctx context.Context, reader client.Reader, u *unstructured.Unstructured) (directbase.Adapter, error) {
	obj := &krm.CloudcontrolspartnerViolation{}
...
type ViolationAdapter struct {
	...
	desired   *krm.CloudcontrolspartnerViolation
	actual    *cloudcontrolspartnerpb.Violation
}
...
func (a *ViolationAdapter) Find(ctx context.Context) (bool, error) {
	...
	req := &cloudcontrolspartnerpb.GetViolationRequest{Name: a.id}
...
func (a *ViolationAdapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	resource := CloudcontrolspartnerViolationSpec_ToProto(mapCtx, &desired.Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}

	// TODO(contributor): Complete the gcp "CREATE" or "INSERT" request.
	req := &cloudcontrolspartnerpb.CreateViolationRequest{
	...
	status := &krm.CloudcontrolspartnerViolationStatus{}
	status.ObservedState = CloudcontrolspartnerViolationObservedState_FromProto(mapCtx, created)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
...
func (a *ViolationAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	desiredPb := CloudcontrolspartnerViolationSpec_ToProto(mapCtx, &a.desired.DeepCopy().Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	if len(paths) == 0 {
		...
		status := &krm.CloudcontrolspartnerViolationStatus{}
		status.ObservedState = CloudcontrolspartnerViolationObservedState_FromProto(mapCtx, a.actual)
		if mapCtx.Err() != nil {
			return mapCtx.Err()
		}
	...
	req := &cloudcontrolspartnerpb.UpdateViolationRequest{
		Name:       a.id.External,
	...
	status := &krm.CloudcontrolspartnerViolationStatus{}
	status.ObservedState = CloudcontrolspartnerViolationObservedState_FromProto(mapCtx, updated)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	return updateOp.UpdateStatus(ctx, status, nil)
...
func (a *ViolationAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	obj := &krm.CloudcontrolspartnerViolation{}
	mapCtx := &direct.MapContext{}
	obj.Spec = direct.ValueOf(CloudcontrolspartnerViolationSpec_FromProto(mapCtx, a.actual))
	if mapCtx.Err() != nil {
	...
	u.SetGroupVersionKind(krm.CloudcontrolspartnerViolationGVK)
...
func (a *ViolationAdapter) Delete(ctx context.Context, deleteOp *directbase.DeleteOperation) (bool, error) {
	...
	req := &cloudcontrolspartnerpb.DeleteViolationRequest{Name: a.id.String()}
