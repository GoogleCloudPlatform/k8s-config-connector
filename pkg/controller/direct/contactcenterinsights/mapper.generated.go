...
func ContactcenterinsightsConversationObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Conversation) *krm.ContactcenterinsightsConversationObservedState {
	if in == nil {
		return nil
	}
	out := &krm.ContactcenterinsightsConversationObservedState{}
...
func ContactcenterinsightsConversationObservedState_ToProto(mapCtx *direct.MapContext, in *krm.ContactcenterinsightsConversationObservedState) *pb.Conversation {
	if in == nil {
		return nil
	}
	out := &pb.Conversation{}
...
func ContactcenterinsightsConversationSpec_FromProto(mapCtx *direct.MapContext, in *pb.Conversation) *krm.ContactcenterinsightsConversationSpec {
	if in == nil {
		return nil
	}
	out := &krm.ContactcenterinsightsConversationSpec{}
	// MISSING: CallMetadata
	// MISSING: ExpireTime
	// MISSING: Ttl
	// MISSING: Name
...
func ContactcenterinsightsConversationSpec_ToProto(mapCtx *direct.MapContext, in *krm.ContactcenterinsightsConversationSpec) *pb.Conversation {
	if in == nil {
		return nil
	}
	out := &pb.Conversation{}
