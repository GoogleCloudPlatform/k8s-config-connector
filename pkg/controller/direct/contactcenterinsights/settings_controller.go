...
func init() {
	registry.RegisterModel(krm.ContactcenterinsightsSettingsGVK, NewSettingsModel)
}
...
func (m *modelSettings) AdapterForObject(ctx context.Context, reader client.Reader, u *unstructured.Unstructured) (directbase.Adapter, error) {
	obj := &krm.ContactcenterinsightsSettings{}
...
type SettingsAdapter struct {
	...
	desired   *krm.ContactcenterinsightsSettings
	actual    *contactcenterinsightspb.Settings
}
...
func (a *SettingsAdapter) Find(ctx context.Context) (bool, error) {
	...
	req := &contactcenterinsightspb.GetSettingsRequest{Name: a.id}
...
func (a *SettingsAdapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	resource := ContactcenterinsightsSettingsSpec_ToProto(mapCtx, &desired.Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}

	// TODO(contributor): Complete the gcp "CREATE" or "INSERT" request.
	req := &contactcenterinsightspb.CreateSettingsRequest{
	...
	status := &krm.ContactcenterinsightsSettingsStatus{}
	status.ObservedState = ContactcenterinsightsSettingsObservedState_FromProto(mapCtx, created)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
...
func (a *SettingsAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	desiredPb := ContactcenterinsightsSettingsSpec_ToProto(mapCtx, &a.desired.DeepCopy().Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	if len(paths) == 0 {
		...
		status := &krm.ContactcenterinsightsSettingsStatus{}
		status.ObservedState = ContactcenterinsightsSettingsObservedState_FromProto(mapCtx, a.actual)
		if mapCtx.Err() != nil {
			return mapCtx.Err()
		}
	...
	status := &krm.ContactcenterinsightsSettingsStatus{}
	status.ObservedState = ContactcenterinsightsSettingsObservedState_FromProto(mapCtx, updated)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	return updateOp.UpdateStatus(ctx, status, nil)
...
func (a *SettingsAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	obj := &krm.ContactcenterinsightsSettings{}
	mapCtx := &direct.MapContext{}
	obj.Spec = direct.ValueOf(ContactcenterinsightsSettingsSpec_FromProto(mapCtx, a.actual))
	if mapCtx.Err() != nil {
	...
	u.SetGroupVersionKind(krm.ContactcenterinsightsSettingsGVK)
...
func (a *SettingsAdapter) Delete(ctx context.Context, deleteOp *directbase.DeleteOperation) (bool, error) {
	...
	req := &contactcenterinsightspb.DeleteSettingsRequest{Name: a.id.String()}
