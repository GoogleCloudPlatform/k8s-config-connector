...
func (a *adapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	mapCtx := &direct.MapContext{}
	actualSpec := CCInsightsQAScorecardSpec_FromProto(mapCtx, a.actual)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	maskedActual := CCInsightsQAScorecardSpec_ToProto(mapCtx, actualSpec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
...
func (a *adapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	mapCtx := &direct.MapContext{}
	spec := CCInsightsQAScorecardSpec_FromProto(mapCtx, a.actual)
	if mapCtx.Err() != nil {
		return nil, mapCtx.Err()
	}
