...
func KeyRingObservedState_FromProto(mapCtx *direct.MapContext, in *pb.KeyRing) *krm.KeyRingObservedState {
	if in == nil {
		return nil
	}
	out := &krm.KeyRingObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
	return out
}
func KeyRingObservedState_ToProto(mapCtx *direct.MapContext, in *krm.KeyRingObservedState) *pb.KeyRing {
	if in == nil {
		return nil
	}
	out := &pb.KeyRing{}
...
func KmsKeyRingObservedState_FromProto(mapCtx *direct.MapContext, in *pb.KeyRing) *krm.KmsKeyRingObservedState {
	if in == nil {
		return nil
	}
	out := &krm.KmsKeyRingObservedState{}
	// MISSING: Name
	// MISSING: CreateTime
	return out
}
func KmsKeyRingObservedState_ToProto(mapCtx *direct.MapContext, in *krm.KmsKeyRingObservedState) *pb.KeyRing {
	if in == nil {
		return nil
	}
	out := &pb.KeyRing{}
