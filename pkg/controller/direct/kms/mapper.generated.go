...
func KmsPublicKeyObservedState_FromProto(mapCtx *direct.MapContext, in *pb.PublicKey) *krm.KmsPublicKeyObservedState {
	if in == nil {
		return nil
	}
	out := &krm.KmsPublicKeyObservedState{}
	// MISSING: Pem
	// MISSING: Algorithm
	// MISSING: PemCrc32c
	// MISSING: Name
...
func KmsPublicKeyObservedState_ToProto(mapCtx *direct.MapContext, in *krm.KmsPublicKeyObservedState) *pb.PublicKey {
	if in == nil {
		return nil
	}
	out := &pb.PublicKey{}
...
func KmsPublicKeySpec_FromProto(mapCtx *direct.MapContext, in *pb.PublicKey) *krm.KmsPublicKeySpec {
	if in == nil {
		return nil
	}
	out := &krm.KmsPublicKeySpec{}
	// MISSING: Pem
	// MISSING: Algorithm
	// MISSING: PemCrc32c
	// MISSING: Name
...
func KmsPublicKeySpec_ToProto(mapCtx *direct.MapContext, in *krm.KmsPublicKeySpec) *pb.PublicKey {
	if in == nil {
		return nil
	}
	out := &pb.PublicKey{}
