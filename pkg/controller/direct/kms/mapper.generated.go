...
func KmsCryptoKeyVersionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.CryptoKeyVersion) *krm.KmsCryptoKeyVersionObservedState {
	if in == nil {
		return nil
	}
	out := &krm.KmsCryptoKeyVersionObservedState{}
	// MISSING: Name
	// MISSING: State
...
func KmsCryptoKeyVersionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.KmsCryptoKeyVersionObservedState) *pb.CryptoKeyVersion {
	if in == nil {
		return nil
	}
	out := &pb.CryptoKeyVersion{}
...
func KmsCryptoKeyVersionSpec_FromProto(mapCtx *direct.MapContext, in *pb.CryptoKeyVersion) *krm.KmsCryptoKeyVersionSpec {
	if in == nil {
		return nil
	}
	out := &krm.KmsCryptoKeyVersionSpec{}
	// MISSING: Name
	// MISSING: State
	// MISSING: ProtectionLevel
	// MISSING: Algorithm
...
func KmsCryptoKeyVersionSpec_ToProto(mapCtx *direct.MapContext, in *krm.KmsCryptoKeyVersionSpec) *pb.CryptoKeyVersion {
	if in == nil {
		return nil
	}
	out := &pb.CryptoKeyVersion{}
