...
func CryptoKeyObservedState_FromProto(mapCtx *direct.MapContext, in *pb.CryptoKey) *krm.CryptoKeyObservedState {
	if in == nil {
		return nil
	}
	out := &krm.CryptoKeyObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
	out.Primary = CryptoKeyVersion_FromProto(mapCtx, in.GetPrimary())
	// MISSING: Purpose
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
...
func CryptoKeyObservedState_ToProto(mapCtx *direct.MapContext, in *krm.CryptoKeyObservedState) *pb.CryptoKey {
	if in == nil {
		return nil
	}
	out := &pb.CryptoKey{}
