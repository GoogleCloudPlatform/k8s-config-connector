...
func CryptoKeyVersion_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.CryptoKeyVersion) *krm.CryptoKeyVersion {
	if in == nil {
		return nil
	}
	...
	out.ExternalProtectionLevelOptions = ExternalProtectionLevelOptions_v1beta1_FromProto(mapCtx, in.GetExternalProtectionLevelOptions())
	// MISSING: ReimportEligible
	return out
}
func CryptoKeyVersion_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.CryptoKeyVersion) *pb.CryptoKeyVersion {
	if in == nil {
		return nil
	}
	...
	// MISSING: GenerationFailureReason
	// MISSING: ExternalDestructionFailureReason
	out.ExternalProtectionLevelOptions = ExternalProtectionLevelOptions_v1beta1_ToProto(mapCtx, in.ExternalProtectionLevelOptions)
	// MISSING: ReimportEligible
	return out
}
func CryptoKeyVersionObservedState_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.CryptoKeyVersion) *krm.CryptoKeyVersionObservedState {
	if in == nil {
		return nil
	}
	...
	out.Attestation = KeyOperationAttestation_v1beta1_FromProto(mapCtx, in.GetAttestation())
...
func CryptoKeyVersionObservedState_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.CryptoKeyVersionObservedState) *pb.CryptoKeyVersion {
	if in == nil {
		return nil
	}
	out := &pb.CryptoKeyVersion{}
	...
	out.Attestation = KeyOperationAttestation_v1beta1_ToProto(mapCtx, in.Attestation)
...
func ExternalProtectionLevelOptions_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.ExternalProtectionLevelOptions) *krm.ExternalProtectionLevelOptions {
	if in == nil {
		return nil
	}
...
func ExternalProtectionLevelOptions_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.ExternalProtectionLevelOptions) *pb.ExternalProtectionLevelOptions {
	if in == nil {
		return nil
	}
...
func KeyAccessJustificationsPolicy_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.KeyAccessJustificationsPolicy) *krm.KeyAccessJustificationsPolicy {
	if in == nil {
		return nil
	}
...
func KeyAccessJustificationsPolicy_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.KeyAccessJustificationsPolicy) *pb.KeyAccessJustificationsPolicy {
	if in == nil {
		return nil
	}
...
func KeyOperationAttestation_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.KeyOperationAttestation) *krm.KeyOperationAttestation {
	if in == nil {
		return nil
	}
...
func KeyOperationAttestation_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.KeyOperationAttestation) *pb.KeyOperationAttestation {
	if in == nil {
		return nil
	}
	out := &pb.KeyOperationAttestation{}
