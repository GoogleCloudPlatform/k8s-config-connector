...
func EkmConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.EkmConfig) *krm.EkmConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krm.EkmConfigObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
	// MISSING: DefaultEkmConnection
	return out
}
func EkmConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krm.EkmConfigObservedState) *pb.EkmConfig {
	if in == nil {
		return nil
	}
	out := &pb.EkmConfig{}
...
func KmsEkmConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.EkmConfig) *krm.KmsEkmConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krm.KmsEkmConfigObservedState{}
	// MISSING: Name
	// MISSING: DefaultEkmConnection
	return out
}
func KmsEkmConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krm.KmsEkmConfigObservedState) *pb.EkmConfig {
	if in == nil {
		return nil
	}
	out := &pb.EkmConfig{}
...
func KmsEkmConfigSpec_FromProto(mapCtx *direct.MapContext, in *pb.EkmConfig) *krm.KmsEkmConfigSpec {
	if in == nil {
		return nil
	}
	out := &krm.KmsEkmConfigSpec{}
	// MISSING: Name
	// MISSING: DefaultEkmConnection
	return out
}
func KmsEkmConfigSpec_ToProto(mapCtx *direct.MapContext, in *krm.KmsEkmConfigSpec) *pb.EkmConfig {
	if in == nil {
		return nil
	}
	out := &pb.EkmConfig{}
