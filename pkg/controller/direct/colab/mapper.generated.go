...
func ColabImage_FromProto(mapCtx *direct.MapContext, in *pb.ColabImage) *krm.ColabImage {
	if in == nil {
		return nil
	}
	out := &krm.ColabImage{}
...
func ColabImage_ToProto(mapCtx *direct.MapContext, in *krm.ColabImage) *pb.ColabImage {
	if in == nil {
		return nil
	}
	out := &pb.ColabImage{}
...
/* found existing non-generated mapping function "EncryptionSpec_FromProto", skipping
func EncryptionSpec_FromProto(mapCtx *direct.MapContext, in *pb.EncryptionSpec) *krmvertexaiv1alpha1.EncryptionSpec {
	if in == nil {
		return nil
	}
...
/* found existing non-generated mapping function "EncryptionSpec_ToProto", skipping
func EncryptionSpec_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.EncryptionSpec) *pb.EncryptionSpec {
	if in == nil {
		return nil
	}
	out := &pb.EncryptionSpec{}
...
func Featurestore_OnlineServingConfig_FromProto(mapCtx *direct.MapContext, in *pb.Featurestore_OnlineServingConfig) *krmvertexaiv1alpha1.Featurestore_OnlineServingConfig {
	if in == nil {
		return nil
	}
...
func Featurestore_OnlineServingConfig_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.Featurestore_OnlineServingConfig) *pb.Featurestore_OnlineServingConfig {
	if in == nil {
		return nil
	}
...
func Featurestore_OnlineServingConfig_Scaling_FromProto(mapCtx *direct.MapContext, in *pb.Featurestore_OnlineServingConfig_Scaling) *krmvertexaiv1alpha1.Featurestore_OnlineServingConfig_Scaling {
	if in == nil {
		return nil
	}
...
func Featurestore_OnlineServingConfig_Scaling_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.Featurestore_OnlineServingConfig_Scaling) *pb.Featurestore_OnlineServingConfig_Scaling {
	if in == nil {
		return nil
	}
...
func MetadataStore_FromProto(mapCtx *direct.MapContext, in *pb.MetadataStore) *krmvertexaiv1alpha1.MetadataStore {
	if in == nil {
		return nil
	}
	out := &krmvertexaiv1alpha1.MetadataStore{}
	// MISSING: Name
	// MISSING: CreateTime
	// MISSING: UpdateTime
	out.EncryptionSpec = EncryptionSpec_FromProto(mapCtx, in.GetEncryptionSpec())
...
func MetadataStore_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.MetadataStore) *pb.MetadataStore {
	if in == nil {
		return nil
	}
...
func MetadataStore_DataplexConfig_FromProto(mapCtx *direct.MapContext, in *pb.MetadataStore_DataplexConfig) *krmvertexaiv1alpha1.MetadataStore_DataplexConfig {
	if in == nil {
		return nil
	}
...
func MetadataStore_DataplexConfig_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.MetadataStore_DataplexConfig) *pb.MetadataStore_DataplexConfig {
	if in == nil {
		return nil
	}
...
func MetadataStore_MetadataStoreState_FromProto(mapCtx *direct.MapContext, in *pb.MetadataStore_MetadataStoreState) *krmvertexaiv1alpha1.MetadataStore_MetadataStoreState {
	if in == nil {
		return nil
	}
...
func MetadataStore_MetadataStoreState_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.MetadataStore_MetadataStoreState) *pb.MetadataStore_MetadataStoreState {
	if in == nil {
		return nil
	}
...
func NotebookSoftwareConfig_FromProto(mapCtx *direct.MapContext, in *pb.NotebookSoftwareConfig) *krm.NotebookSoftwareConfig {
	if in == nil {
		return nil
	}
	out := &krm.NotebookSoftwareConfig{}
...
func NotebookSoftwareConfig_ToProto(mapCtx *direct.MapContext, in *krm.NotebookSoftwareConfig) *pb.NotebookSoftwareConfig {
	if in == nil {
		return nil
	}
...
func VertexAIFeaturestoreObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Featurestore) *krmvertexaiv1alpha1.VertexAIFeaturestoreObservedState {
	if in == nil {
		return nil
	}
...
func VertexAIFeaturestoreObservedState_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.VertexAIFeaturestoreObservedState) *pb.Featurestore {
	if in == nil {
		return nil
	}
	out := &pb.Featurestore{}
...
func VertexAIFeaturestoreSpec_FromProto(mapCtx *direct.MapContext, in *pb.Featurestore) *krmvertexaiv1alpha1.VertexAIFeaturestoreSpec {
	if in == nil {
		return nil
	}
...
func VertexAIFeaturestoreSpec_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.VertexAIFeaturestoreSpec) *pb.Featurestore {
	if in == nil {
		return nil
	}
	out := &pb.Featurestore{}
...
func VertexAIMetadataStoreObservedState_FromProto(mapCtx *direct.MapContext, in *pb.MetadataStore) *krmvertexaiv1alpha1.VertexAIMetadataStoreObservedState {
	if in == nil {
		return nil
	}
...
func VertexAIMetadataStoreObservedState_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.VertexAIMetadataStoreObservedState) *pb.MetadataStore {
	if in == nil {
		return nil
	}
	out := &pb.MetadataStore{}
...
func VertexAIMetadataStoreSpec_FromProto(mapCtx *direct.MapContext, in *pb.MetadataStore) *krmvertexaiv1alpha1.VertexAIMetadataStoreSpec {
	if in == nil {
		return nil
	}
...
func VertexAIMetadataStoreSpec_ToProto(mapCtx *direct.MapContext, in *krmvertexaiv1alpha1.VertexAIMetadataStoreSpec) *pb.MetadataStore {
	if in == nil {
		return nil
	}
	out := &pb.MetadataStore{}
