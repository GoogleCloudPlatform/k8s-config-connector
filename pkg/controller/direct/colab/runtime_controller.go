...
func resolveRuntimeReferences(ctx context.Context, reader client.Reader, obj *krm.ColabRuntime) error {
...
func (a *runtimeAdapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	if err := resolveRuntimeReferences(ctx, a.reader, a.desired); err != nil {
