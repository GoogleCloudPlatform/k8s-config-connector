...
func IAPSettingsObservedState_FromProto(mapCtx *direct.MapContext, in *pb.IapSettings) *krm.IAPSettingsObservedState {
	...
	// MISSING: Name
	out.AccessSettings = AccessSettingsObservedState_FromProto(mapCtx, in.GetAccessSettings())
	return out
}
func IAPSettingsObservedState_ToProto(mapCtx *direct.MapContext, in *krm.IAPSettingsObservedState) *pb.IapSettings {
	...
	out := &pb.IapSettings{}
	// MISSING: Name
	out.AccessSettings = AccessSettingsObservedState_ToProto(mapCtx, in.AccessSettings)
	return out
}
