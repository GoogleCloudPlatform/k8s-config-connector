...
func AttributePropagationSettings_FromProto(mapCtx *direct.MapContext, in *pb.AttributePropagationSettings) *krm.AttributePropagationSettings {
	...
	out.OutputCredentials = AttributePropagationSettings_OutputCredentials_FromProto(mapCtx, in.OutputCredentials)
	out.Enable = in.Enable
	return out
}
func AttributePropagationSettings_OutputCredentials_FromProto(mapCtx *direct.MapContext, in []pb.AttributePropagationSettings_OutputCredentials) []string {
	if in == nil {
		return nil
	}
	var outSlice []string
	for _, inItem := range in {
		outItem := direct.Enum_FromProto(mapCtx, inItem)
...
func AttributePropagationSettings_ToProto(mapCtx *direct.MapContext, in *krm.AttributePropagationSettings) *pb.AttributePropagationSettings {
	...
	out.Expression = in.Expression
	out.OutputCredentials = AttributePropagationSettings_OutputCredentials_ToProto(mapCtx, in.OutputCredentials)
	out.Enable = in.Enable
	return out
}
func AttributePropagationSettings_OutputCredentials_ToProto(mapCtx *direct.MapContext, in []string) []pb.AttributePropagationSettings_OutputCredentials {
	if in == nil {
		return nil
	}
	var outSlice []pb.AttributePropagationSettings_OutputCredentials
	for _, inItem := range in {
		outItem := direct.Enum_ToProto[pb.AttributePropagationSettings_OutputCredentials](mapCtx, &inItem)
		outSlice = append(outSlice, outItem)
	}
	return outSlice
}
...
func IAPSettingsObservedState_FromProto(mapCtx *direct.MapContext, in *pb.IapSettings) *krm.IAPSettingsObservedState {
	if in == nil {
		return nil
	}
	out := &krm.IAPSettingsObservedState{}
	return out
}
func IAPSettingsObservedState_ToProto(mapCtx *direct.MapContext, in *krm.IAPSettingsObservedState) *pb.IapSettings {
	if in == nil {
		return nil
	}
	out := &pb.IapSettings{}
...
func ReauthSettings_FromProto(mapCtx *direct.MapContext, in *pb.ReauthSettings) *krm.ReauthSettings {
	...
	out.MaxAge = direct.Duration_FromProto(mapCtx, in.GetMaxAge())
...
func ReauthSettings_ToProto(mapCtx *direct.MapContext, in *krm.ReauthSettings) *pb.ReauthSettings {
	...
	out.MaxAge = direct.Duration_ToProto(mapCtx, in.MaxAge)
