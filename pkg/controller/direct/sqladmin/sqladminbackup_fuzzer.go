...
// +tool:fuzz-gen
// proto.message: google.cloud.sql.v1.BackupRun
...
func init() {
	fuzztesting.RegisterKRMFuzzer(sqlAdminBackupFuzzer())
}
...
func sqlAdminBackupFuzzer() fuzztesting.KRMFuzzer {
	...
	// Unimplemented / Missing fields in KRM
	...
	f.Unimplemented_NotYetTriaged(".disk_encryption_configuration.kind")
