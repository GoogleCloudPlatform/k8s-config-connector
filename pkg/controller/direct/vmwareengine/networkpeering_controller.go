...
func (m *networkPeeringModel) AdapterForObject(ctx context.Context, op *directbase.AdapterForObjectOperation) (directbase.Adapter, error) {
...
func (a *networkPeeringAdapter) normalizeReferenceFields(ctx context.Context) error {
	...
	if obj.Spec.PeerNetwork != nil {
		if obj.Spec.PeerNetwork.ComputeNetworkRef != nil {
			if err := obj.Spec.PeerNetwork.ComputeNetworkRef.Normalize(ctx, a.reader, obj.GetNamespace()); err != nil {
				return err
			}
		}
