...
func VmwareengineVmwareEngineNetworkObservedState_FromProto(mapCtx *direct.MapContext, in *pb.VmwareEngineNetwork) *krm.VmwareengineVmwareEngineNetworkObservedState {
	if in == nil {
		return nil
	}
	out := &krm.VmwareengineVmwareEngineNetworkObservedState{}
	// MISSING: Name
	// MISSING: CreateTime
	// MISSING: UpdateTime
	// MISSING: Description
...
func VmwareengineVmwareEngineNetworkObservedState_ToProto(mapCtx *direct.MapContext, in *krm.VmwareengineVmwareEngineNetworkObservedState) *pb.VmwareEngineNetwork {
	if in == nil {
		return nil
	}
	out := &pb.VmwareEngineNetwork{}
...
func VmwareengineVmwareEngineNetworkSpec_FromProto(mapCtx *direct.MapContext, in *pb.VmwareEngineNetwork) *krm.VmwareengineVmwareEngineNetworkSpec {
	if in == nil {
		return nil
	}
	out := &krm.VmwareengineVmwareEngineNetworkSpec{}
	// MISSING: Name
	// MISSING: CreateTime
	// MISSING: UpdateTime
	// MISSING: Description
...
func VmwareengineVmwareEngineNetworkSpec_ToProto(mapCtx *direct.MapContext, in *krm.VmwareengineVmwareEngineNetworkSpec) *pb.VmwareEngineNetwork {
	if in == nil {
		return nil
	}
	out := &pb.VmwareEngineNetwork{}
