...
func AuthorizedView_FamilySubsets_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.AuthorizedView_FamilySubsets) *krm.AuthorizedView_FamilySubsets {
	if in == nil {
		return nil
	}
...
func AuthorizedView_FamilySubsets_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.AuthorizedView_FamilySubsets) *pb.AuthorizedView_FamilySubsets {
	if in == nil {
		return nil
	}
	out := &pb.AuthorizedView_FamilySubsets{}
...
func BigtableAuthorizedViewObservedState_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.AuthorizedView) *krm.BigtableAuthorizedViewObservedState {
	if in == nil {
		return nil
	}
...
func BigtableAuthorizedViewObservedState_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.BigtableAuthorizedViewObservedState) *pb.AuthorizedView {
	if in == nil {
		return nil
	}
	out := &pb.AuthorizedView{}
...
func BigtableAuthorizedViewSpec_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.AuthorizedView) *krm.BigtableAuthorizedViewSpec {
	if in == nil {
		return nil
	}
	out := &krm.BigtableAuthorizedViewSpec{}
	// MISSING: Name
	out.SubsetView = AuthorizedView_SubsetView_v1beta1_FromProto(mapCtx, in.GetSubsetView())
	// MISSING: Etag
	out.DeletionProtection = direct.LazyPtr(in.GetDeletionProtection())
	return out
}
func BigtableAuthorizedViewSpec_v1beta1_ToProto(mapCtx *direct.MapContext, in *krm.BigtableAuthorizedViewSpec) *pb.AuthorizedView {
	if in == nil {
		return nil
	}
	out := &pb.AuthorizedView{}
	// MISSING: Name
	if oneof := AuthorizedView_SubsetView_v1beta1_ToProto(mapCtx, in.SubsetView); oneof != nil {
		out.AuthorizedView = &pb.AuthorizedView_SubsetView_{SubsetView: oneof}
	}
	// MISSING: Etag
	out.DeletionProtection = direct.ValueOf(in.DeletionProtection)
