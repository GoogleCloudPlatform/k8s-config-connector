...
func BigtableSchemaBundleObservedState_FromProto(mapCtx *direct.MapContext, in *pb.SchemaBundle) *krm.BigtableSchemaBundleObservedState {
	if in == nil {
		return nil
	}
...
func BigtableSchemaBundleObservedState_ToProto(mapCtx *direct.MapContext, in *krm.BigtableSchemaBundleObservedState) *pb.SchemaBundle {
	if in == nil {
		return nil
	}
	out := &pb.SchemaBundle{}
...
func BigtableSchemaBundleSpec_FromProto(mapCtx *direct.MapContext, in *pb.SchemaBundle) *krm.BigtableSchemaBundleSpec {
	...
	// MISSING: Name
	out.ProtoSchema = ProtoSchema_FromProto(mapCtx, in.GetProtoSchema())
	return out
}
func BigtableSchemaBundleSpec_ToProto(mapCtx *direct.MapContext, in *krm.BigtableSchemaBundleSpec) *pb.SchemaBundle {
	...
	out := &pb.SchemaBundle{}
	// MISSING: Name
	if oneof := ProtoSchema_ToProto(mapCtx, in.ProtoSchema); oneof != nil {
...
func ProtoSchema_FromProto(mapCtx *direct.MapContext, in *pb.ProtoSchema) *krm.ProtoSchema {
	if in == nil {
		return nil
	}
	out := &krm.ProtoSchema{}
	// MISSING: ProtoDescriptors
	return out
}
func ProtoSchema_ToProto(mapCtx *direct.MapContext, in *krm.ProtoSchema) *pb.ProtoSchema {
	if in == nil {
		return nil
	}
	out := &pb.ProtoSchema{}
