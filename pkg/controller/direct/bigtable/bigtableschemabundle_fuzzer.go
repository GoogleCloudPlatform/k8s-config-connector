...
func BigtableSchemaBundleFuzzer() fuzztesting.KRMFuzzer {
	f := fuzztesting.NewKRMTypedSpecFuzzer(&pb.SchemaBundle{},
		BigtableSchemaBundleSpec_v1alpha1_FromProto, BigtableSchemaBundleSpec_v1alpha1_ToProto,
	)

	f.SpecField(".proto_schema")
	f.SpecField(".proto_schema.proto_descriptors")
