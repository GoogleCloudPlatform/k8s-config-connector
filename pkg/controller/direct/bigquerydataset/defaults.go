...
const (
	// defaultLocation           = "US"
	defaultMaxTimeTravelHours = "168" // 7 days (in hours)
)

func ApplyBigqueryDatasetGCPDefaults(mapCtx *direct.MapContext, in *krm.BigQueryDatasetSpec, out *bigquery.DatasetMetadata) {
	if in == nil {
		return
	}
	...
	if in.IsCaseInsensitive == nil {
		out.IsCaseInsensitive = bool(false)
	}
}
