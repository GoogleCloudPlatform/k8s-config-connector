...
func (x *ResourceAllowance) GetCreateTime() *timestamp.Timestamp {
	if x != nil {
		return x.CreateTime
	}
	return nil
...
var file_google_cloud_batch_v1alpha_resource_allowance_proto_goTypes = []interface{}{
...
func file_google_cloud_batch_v1alpha_resource_allowance_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*ResourceAllowance_UsageResourceAllowance)(nil),
	}
	file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[5].OneofWrappers = []interface{}{
		(*UsageResourceAllowanceSpec_Limit_CalendarPeriod)(nil),
	}
	file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_google_cloud_batch_v1alpha_resource_allowance_proto_msgTypes[7].OneofWrappers = []interface{}{}
	type x struct{}
