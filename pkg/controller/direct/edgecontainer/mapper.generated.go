...
import (
	...
	krmcommonparent "github.com/GoogleCloudPlatform/k8s-config-connector/apis/common/parent"
...
func Fleet_FromProto(mapCtx *direct.MapContext, in *pb.Fleet) *krm.Fleet {
	...
	out := &krm.Fleet{}
	if in.GetProject() != "" {
		out.ProjectRef = &krmcommonparent.ProjectRef{External: in.GetProject()}
	}
