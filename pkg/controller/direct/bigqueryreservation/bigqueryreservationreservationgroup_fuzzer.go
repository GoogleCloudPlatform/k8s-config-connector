...
func BigQueryReservationReservationGroupFuzzer() fuzztesting.KRMFuzzer {
	f := fuzztesting.NewKRMTypedFuzzer(&pb.ReservationGroup{},
		...
		BigQueryReservationReservationGroupStatus_v1alpha1_FromProto, BigQueryReservationReservationGroupStatus_v1alpha1_ToProto,
	)

	f.SpecField(".parent_group")

	f.StatusField(".creation_time")
...
func init() {
	fuzztesting.RegisterKRMSpecFuzzer(BigQueryReservationReservationGroupFuzzer())
}
