...
func MandateTransaction_FromProto(mapCtx *direct.MapContext, in *pb.MandateTransaction) *krm.MandateTransaction {
	if in == nil {
		return nil
	}
	out := &krm.MandateTransaction{}
	out.Name = direct.LazyPtr(in.GetName())
	out.TransactionInfo = TransactionInfo_FromProto(mapCtx, in.GetTransactionInfo())
	// MISSING: UniqueMandateNumber
	// MISSING: Payer
	// MISSING: Payee
	// MISSING: RecurrencePattern
	// MISSING: RecurrenceRuleType
	// MISSING: RecurrenceRuleValue
	// MISSING: StartDate
	// MISSING: EndDate
	// MISSING: Revokable
	// MISSING: Amount
	// MISSING: AmountRule
	// MISSING: ApprovalReference
	// MISSING: BlockFunds
	// MISSING: MandateName
	return out
}
func MandateTransaction_ToProto(mapCtx *direct.MapContext, in *krm.MandateTransaction) *pb.MandateTransaction {
	if in == nil {
		return nil
	}
	out := &pb.MandateTransaction{}
	out.Name = direct.ValueOf(in.Name)
	out.TransactionInfo = TransactionInfo_ToProto(mapCtx, in.TransactionInfo)
	// MISSING: UniqueMandateNumber
	// MISSING: Payer
	// MISSING: Payee
	// MISSING: RecurrencePattern
...
func MandateTransactionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.MandateTransaction) *krm.MandateTransactionObservedState {
	if in == nil {
		return nil
	}
	out := &krm.MandateTransactionObservedState{}
	// MISSING: Name
	out.TransactionInfo = TransactionInfoObservedState_FromProto(mapCtx, in.GetTransactionInfo())
	out.UniqueMandateNumber = direct.LazyPtr(in.GetUniqueMandateNumber())
	out.Payer = SettlementParticipant_FromProto(mapCtx, in.GetPayer())
	out.Payee = SettlementParticipant_FromProto(mapCtx, in.GetPayee())
	out.RecurrencePattern = direct.Enum_FromProto(mapCtx, in.GetRecurrencePattern())
	out.RecurrenceRuleType = direct.Enum_FromProto(mapCtx, in.GetRecurrenceRuleType())
	out.RecurrenceRuleValue = direct.LazyPtr(in.GetRecurrenceRuleValue())
	out.StartDate = Date_FromProto(mapCtx, in.GetStartDate())
	out.EndDate = Date_FromProto(mapCtx, in.GetEndDate())
	out.Revokable = direct.LazyPtr(in.GetRevokable())
	out.Amount = direct.LazyPtr(in.GetAmount())
	out.AmountRule = direct.Enum_FromProto(mapCtx, in.GetAmountRule())
	out.ApprovalReference = direct.LazyPtr(in.GetApprovalReference())
	out.BlockFunds = direct.LazyPtr(in.GetBlockFunds())
	out.MandateName = direct.LazyPtr(in.GetMandateName())
	return out
}
func MandateTransactionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.MandateTransactionObservedState) *pb.MandateTransaction {
	if in == nil {
		return nil
	}
	out := &pb.MandateTransaction{}
	// MISSING: Name
	out.TransactionInfo = TransactionInfoObservedState_ToProto(mapCtx, in.TransactionInfo)
	out.UniqueMandateNumber = direct.ValueOf(in.UniqueMandateNumber)
	out.Payer = SettlementParticipant_ToProto(mapCtx, in.Payer)
	out.Payee = SettlementParticipant_ToProto(mapCtx, in.Payee)
	out.RecurrencePattern = direct.Enum_ToProto[pb.MandateTransaction_RecurrencePatternType](mapCtx, in.RecurrencePattern)
	out.RecurrenceRuleType = direct.Enum_ToProto[pb.MandateTransaction_RecurrenceRuleType](mapCtx, in.RecurrenceRuleType)
	out.RecurrenceRuleValue = direct.ValueOf(in.RecurrenceRuleValue)
	out.StartDate = Date_ToProto(mapCtx, in.StartDate)
	out.EndDate = Date_ToProto(mapCtx, in.EndDate)
	out.Revokable = direct.ValueOf(in.Revokable)
	out.Amount = direct.ValueOf(in.Amount)
	out.AmountRule = direct.Enum_ToProto[pb.MandateTransaction_AmountRuleType](mapCtx, in.AmountRule)
	out.ApprovalReference = direct.ValueOf(in.ApprovalReference)
	out.BlockFunds = direct.ValueOf(in.BlockFunds)
	out.MandateName = direct.ValueOf(in.MandateName)
	return out
}
...
func PaymentgatewayMandateTransactionObservedState_FromProto(mapCtx *direct.MapContext, in *pb.MandateTransaction) *krm.PaymentgatewayMandateTransactionObservedState {
	if in == nil {
		return nil
	}
	out := &krm.PaymentgatewayMandateTransactionObservedState{}
	// MISSING: Name
...
func PaymentgatewayMandateTransactionObservedState_ToProto(mapCtx *direct.MapContext, in *krm.PaymentgatewayMandateTransactionObservedState) *pb.MandateTransaction {
	if in == nil {
		return nil
	}
	out := &pb.MandateTransaction{}
...
func PaymentgatewayMandateTransactionSpec_FromProto(mapCtx *direct.MapContext, in *pb.MandateTransaction) *krm.PaymentgatewayMandateTransactionSpec {
	if in == nil {
		return nil
	}
	out := &krm.PaymentgatewayMandateTransactionSpec{}
	// MISSING: Name
	// MISSING: TransactionInfo
	// MISSING: UniqueMandateNumber
	// MISSING: Payer
...
func PaymentgatewayMandateTransactionSpec_ToProto(mapCtx *direct.MapContext, in *krm.PaymentgatewayMandateTransactionSpec) *pb.MandateTransaction {
	if in == nil {
		return nil
	}
	out := &pb.MandateTransaction{}
