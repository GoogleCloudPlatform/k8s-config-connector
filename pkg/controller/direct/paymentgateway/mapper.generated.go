...
func PaymentgatewayComplaintObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Complaint) *krm.PaymentgatewayComplaintObservedState {
	if in == nil {
		return nil
	}
	out := &krm.PaymentgatewayComplaintObservedState{}
	// MISSING: Name
	// MISSING: RaiseComplaintAdjustment
	// MISSING: Details
	// MISSING: Response
...
func PaymentgatewayComplaintObservedState_ToProto(mapCtx *direct.MapContext, in *krm.PaymentgatewayComplaintObservedState) *pb.Complaint {
	if in == nil {
		return nil
	}
	out := &pb.Complaint{}
...
func PaymentgatewayComplaintSpec_FromProto(mapCtx *direct.MapContext, in *pb.Complaint) *krm.PaymentgatewayComplaintSpec {
	if in == nil {
		return nil
	}
	out := &krm.PaymentgatewayComplaintSpec{}
	// MISSING: Name
	// MISSING: RaiseComplaintAdjustment
	// MISSING: Details
	// MISSING: Response
...
func PaymentgatewayComplaintSpec_ToProto(mapCtx *direct.MapContext, in *krm.PaymentgatewayComplaintSpec) *pb.Complaint {
	if in == nil {
		return nil
	}
	out := &pb.Complaint{}
