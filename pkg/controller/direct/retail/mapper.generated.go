...
func RetailProductObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Product) *krm.RetailProductObservedState {
	if in == nil {
		return nil
	}
	out := &krm.RetailProductObservedState{}
	// MISSING: ExpireTime
	// MISSING: Ttl
	// MISSING: Name
	// MISSING: ID
...
func RetailProductObservedState_ToProto(mapCtx *direct.MapContext, in *krm.RetailProductObservedState) *pb.Product {
	if in == nil {
		return nil
	}
	out := &pb.Product{}
...
func RetailProductSpec_FromProto(mapCtx *direct.MapContext, in *pb.Product) *krm.RetailProductSpec {
	if in == nil {
		return nil
	}
	out := &krm.RetailProductSpec{}
	// MISSING: ExpireTime
	// MISSING: Ttl
	// MISSING: Name
	// MISSING: ID
...
func RetailProductSpec_ToProto(mapCtx *direct.MapContext, in *krm.RetailProductSpec) *pb.Product {
	if in == nil {
		return nil
	}
	out := &pb.Product{}
