...
func AttachedPlatformVersionInfo_FromProto(mapCtx *direct.MapContext, in *pb.AttachedPlatformVersionInfo) *krm.AttachedPlatformVersionInfo {
	if in == nil {
		return nil
	}
	out := &krm.AttachedPlatformVersionInfo{}
	out.Version = direct.LazyPtr(in.GetVersion())
	return out
}
func AttachedPlatformVersionInfo_ToProto(mapCtx *direct.MapContext, in *krm.AttachedPlatformVersionInfo) *pb.AttachedPlatformVersionInfo {
	if in == nil {
		return nil
	}
	out := &pb.AttachedPlatformVersionInfo{}
...
func AttachedServerConfig_FromProto(mapCtx *direct.MapContext, in *pb.AttachedServerConfig) *krm.AttachedServerConfig {
	if in == nil {
		return nil
	}
	out := &krm.AttachedServerConfig{}
	out.Name = direct.LazyPtr(in.GetName())
	out.ValidVersions = direct.Slice_FromProto(mapCtx, in.ValidVersions, AttachedPlatformVersionInfo_FromProto)
	return out
}
func AttachedServerConfig_ToProto(mapCtx *direct.MapContext, in *krm.AttachedServerConfig) *pb.AttachedServerConfig {
	if in == nil {
		return nil
	}
	out := &pb.AttachedServerConfig{}
	out.Name = direct.ValueOf(in.Name)
	out.ValidVersions = direct.Slice_ToProto(mapCtx, in.ValidVersions, AttachedPlatformVersionInfo_ToProto)
	return out
}
...
func GkemulticloudAttachedServerConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.AttachedServerConfig) *krm.GkemulticloudAttachedServerConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krm.GkemulticloudAttachedServerConfigObservedState{}
	// MISSING: Name
	// MISSING: ValidVersions
	return out
}
func GkemulticloudAttachedServerConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krm.GkemulticloudAttachedServerConfigObservedState) *pb.AttachedServerConfig {
	if in == nil {
		return nil
	}
	out := &pb.AttachedServerConfig{}
...
func GkemulticloudAttachedServerConfigSpec_FromProto(mapCtx *direct.MapContext, in *pb.AttachedServerConfig) *krm.GkemulticloudAttachedServerConfigSpec {
	if in == nil {
		return nil
	}
	out := &krm.GkemulticloudAttachedServerConfigSpec{}
	// MISSING: Name
	// MISSING: ValidVersions
	return out
}
func GkemulticloudAttachedServerConfigSpec_ToProto(mapCtx *direct.MapContext, in *krm.GkemulticloudAttachedServerConfigSpec) *pb.AttachedServerConfig {
	if in == nil {
		return nil
	}
	out := &pb.AttachedServerConfig{}
