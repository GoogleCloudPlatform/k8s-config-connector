...
func AwsK8sVersionInfo_FromProto(mapCtx *direct.MapContext, in *pb.AwsK8sVersionInfo) *krm.AwsK8sVersionInfo {
	if in == nil {
		return nil
	}
	out := &krm.AwsK8sVersionInfo{}
...
func AwsK8sVersionInfo_ToProto(mapCtx *direct.MapContext, in *krm.AwsK8sVersionInfo) *pb.AwsK8sVersionInfo {
	if in == nil {
		return nil
	}
	out := &pb.AwsK8sVersionInfo{}
...
func AwsServerConfig_FromProto(mapCtx *direct.MapContext, in *pb.AwsServerConfig) *krm.AwsServerConfig {
	if in == nil {
		return nil
	}
	out := &krm.AwsServerConfig{}
	out.Name = direct.LazyPtr(in.GetName())
	out.ValidVersions = direct.Slice_FromProto(mapCtx, in.ValidVersions, AwsK8sVersionInfo_FromProto)
	out.SupportedAwsRegions = in.SupportedAwsRegions
	return out
}
func AwsServerConfig_ToProto(mapCtx *direct.MapContext, in *krm.AwsServerConfig) *pb.AwsServerConfig {
	if in == nil {
		return nil
	}
	out := &pb.AwsServerConfig{}
	out.Name = direct.ValueOf(in.Name)
	out.ValidVersions = direct.Slice_ToProto(mapCtx, in.ValidVersions, AwsK8sVersionInfo_ToProto)
	out.SupportedAwsRegions = in.SupportedAwsRegions
	return out
}
...
func GkemulticloudAwsServerConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.AwsServerConfig) *krm.GkemulticloudAwsServerConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krm.GkemulticloudAwsServerConfigObservedState{}
	// MISSING: Name
	// MISSING: ValidVersions
	// MISSING: SupportedAwsRegions
	return out
}
func GkemulticloudAwsServerConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krm.GkemulticloudAwsServerConfigObservedState) *pb.AwsServerConfig {
	if in == nil {
		return nil
	}
	out := &pb.AwsServerConfig{}
...
func GkemulticloudAwsServerConfigSpec_FromProto(mapCtx *direct.MapContext, in *pb.AwsServerConfig) *krm.GkemulticloudAwsServerConfigSpec {
	if in == nil {
		return nil
	}
	out := &krm.GkemulticloudAwsServerConfigSpec{}
	// MISSING: Name
	// MISSING: ValidVersions
	// MISSING: SupportedAwsRegions
	return out
}
func GkemulticloudAwsServerConfigSpec_ToProto(mapCtx *direct.MapContext, in *krm.GkemulticloudAwsServerConfigSpec) *pb.AwsServerConfig {
	if in == nil {
		return nil
	}
	out := &pb.AwsServerConfig{}
