...
import (
	...
	iamRef "github.com/GoogleCloudPlatform/k8s-config-connector/apis/iam/v1beta1"
...
func WorkloadIdentityConfig_FromProto(mapCtx *direct.MapContext, in *pb.WorkloadIdentityConfig) *krm.WorkloadIdentityConfig {
	...
	out.WorkloadIdentityPoolRef = &iamRef.WorkloadIdentityPoolRef{
		External: in.GetWorkloadPool(),
	}
...
func WorkloadIdentityConfig_ToProto(mapCtx *direct.MapContext, in *krm.WorkloadIdentityConfig) *pb.WorkloadIdentityConfig {
	...
	if in.WorkloadIdentityPoolRef != nil {
		out.WorkloadPool = in.WorkloadIdentityPoolRef.External
	}
