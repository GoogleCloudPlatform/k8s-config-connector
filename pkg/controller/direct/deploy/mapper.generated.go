...
func BuildArtifact_FromProto(mapCtx *direct.MapContext, in *pb.BuildArtifact) *krm.BuildArtifact {
	if in == nil {
		return nil
	}
	out := &krm.BuildArtifact{}
	out.Image = direct.LazyPtr(in.GetImage())
	out.Tag = direct.LazyPtr(in.GetTag())
	return out
}
func BuildArtifact_ToProto(mapCtx *direct.MapContext, in *krm.BuildArtifact) *pb.BuildArtifact {
	if in == nil {
		return nil
	}
	out := &pb.BuildArtifact{}
...
func DeployReleaseObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Release) *krm.DeployReleaseObservedState {
	if in == nil {
		return nil
	}
	out := &krm.DeployReleaseObservedState{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: Description
	// MISSING: Annotations
	...
	// MISSING: Abandoned
	// MISSING: CreateTime
	// MISSING: RenderStartTime
	// MISSING: RenderEndTime
	// MISSING: SkaffoldConfigURI
	// MISSING: SkaffoldConfigPath
	// MISSING: BuildArtifacts
	// MISSING: DeliveryPipelineSnapshot
	// MISSING: TargetSnapshots
	// MISSING: CustomTargetTypeSnapshots
	// MISSING: RenderState
	// MISSING: Etag
	// MISSING: SkaffoldVersion
	// MISSING: TargetArtifacts
	// MISSING: TargetRenders
	// MISSING: Condition
	// MISSING: DeployParameters
	return out
}
func DeployReleaseObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DeployReleaseObservedState) *pb.Release {
	if in == nil {
		return nil
	}
	out := &pb.Release{}
...
func DeployReleaseSpec_FromProto(mapCtx *direct.MapContext, in *pb.Release) *krm.DeployReleaseSpec {
	if in == nil {
		return nil
	}
	out := &krm.DeployReleaseSpec{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: Description
	// MISSING: Annotations
...
func DeployReleaseSpec_ToProto(mapCtx *direct.MapContext, in *krm.DeployReleaseSpec) *pb.Release {
	if in == nil {
		return nil
	}
	out := &pb.Release{}
...
func Release_FromProto(mapCtx *direct.MapContext, in *pb.Release) *krm.Release {
	if in == nil {
		return nil
	}
	out := &krm.Release{}
	...
	// MISSING: RenderStartTime
	// MISSING: RenderEndTime
	out.SkaffoldConfigURI = direct.LazyPtr(in.GetSkaffoldConfigUri())
	out.SkaffoldConfigPath = direct.LazyPtr(in.GetSkaffoldConfigPath())
	out.BuildArtifacts = direct.Slice_FromProto(mapCtx, in.BuildArtifacts, BuildArtifact_FromProto)
	// MISSING: DeliveryPipelineSnapshot
	// MISSING: TargetSnapshots
	// MISSING: CustomTargetTypeSnapshots
	// MISSING: RenderState
	out.Etag = direct.LazyPtr(in.GetEtag())
	out.SkaffoldVersion = direct.LazyPtr(in.GetSkaffoldVersion())
	// MISSING: TargetArtifacts
	// MISSING: TargetRenders
	// MISSING: Condition
...
func Release_ToProto(mapCtx *direct.MapContext, in *krm.Release) *pb.Release {
	if in == nil {
		return nil
	}
	out := &pb.Release{}
	...
	// MISSING: RenderStartTime
	// MISSING: RenderEndTime
	out.SkaffoldConfigUri = direct.ValueOf(in.SkaffoldConfigURI)
	out.SkaffoldConfigPath = direct.ValueOf(in.SkaffoldConfigPath)
	out.BuildArtifacts = direct.Slice_ToProto(mapCtx, in.BuildArtifacts, BuildArtifact_ToProto)
	// MISSING: DeliveryPipelineSnapshot
	// MISSING: TargetSnapshots
	// MISSING: CustomTargetTypeSnapshots
	// MISSING: RenderState
	out.Etag = direct.ValueOf(in.Etag)
	out.SkaffoldVersion = direct.ValueOf(in.SkaffoldVersion)
	// MISSING: TargetArtifacts
	// MISSING: TargetRenders
	// MISSING: Condition
	out.DeployParameters = in.DeployParameters
...
func ReleaseObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Release) *krm.ReleaseObservedState {
	if in == nil {
		return nil
	}
	out := &krm.ReleaseObservedState{}
	// MISSING: Name
	out.Uid = direct.LazyPtr(in.GetUid())
	// MISSING: Description
	// MISSING: Annotations
	// MISSING: Labels
	out.Abandoned = direct.LazyPtr(in.GetAbandoned())
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
	out.RenderStartTime = direct.StringTimestamp_FromProto(mapCtx, in.GetRenderStartTime())
	out.RenderEndTime = direct.StringTimestamp_FromProto(mapCtx, in.GetRenderEndTime())
	// MISSING: SkaffoldConfigURI
	// MISSING: SkaffoldConfigPath
	// MISSING: BuildArtifacts
	out.DeliveryPipelineSnapshot = DeliveryPipeline_FromProto(mapCtx, in.GetDeliveryPipelineSnapshot())
	out.TargetSnapshots = direct.Slice_FromProto(mapCtx, in.TargetSnapshots, Target_FromProto)
	out.CustomTargetTypeSnapshots = direct.Slice_FromProto(mapCtx, in.CustomTargetTypeSnapshots, CustomTargetType_FromProto)
	out.RenderState = direct.Enum_FromProto(mapCtx, in.GetRenderState())
	// MISSING: Etag
	// MISSING: SkaffoldVersion
	// MISSING: TargetArtifacts
	// MISSING: TargetRenders
	out.Condition = Release_ReleaseCondition_FromProto(mapCtx, in.GetCondition())
	// MISSING: DeployParameters
	return out
}
func ReleaseObservedState_ToProto(mapCtx *direct.MapContext, in *krm.ReleaseObservedState) *pb.Release {
	if in == nil {
		return nil
	}
	out := &pb.Release{}
	...
	// MISSING: Annotations
	// MISSING: Labels
	out.Abandoned = direct.ValueOf(in.Abandoned)
	out.CreateTime = direct.StringTimestamp_ToProto(mapCtx, in.CreateTime)
	out.RenderStartTime = direct.StringTimestamp_ToProto(mapCtx, in.RenderStartTime)
	out.RenderEndTime = direct.StringTimestamp_ToProto(mapCtx, in.RenderEndTime)
	// MISSING: SkaffoldConfigURI
	// MISSING: SkaffoldConfigPath
	// MISSING: BuildArtifacts
	out.DeliveryPipelineSnapshot = DeliveryPipeline_ToProto(mapCtx, in.DeliveryPipelineSnapshot)
	out.TargetSnapshots = direct.Slice_ToProto(mapCtx, in.TargetSnapshots, Target_ToProto)
	out.CustomTargetTypeSnapshots = direct.Slice_ToProto(mapCtx, in.CustomTargetTypeSnapshots, CustomTargetType_ToProto)
	out.RenderState = direct.Enum_ToProto[pb.Release_RenderState](mapCtx, in.RenderState)
	// MISSING: Etag
	// MISSING: SkaffoldVersion
	// MISSING: TargetArtifacts
	// MISSING: TargetRenders
	out.Condition = Release_ReleaseCondition_ToProto(mapCtx, in.Condition)
	// MISSING: DeployParameters
	return out
}
func Release_ReleaseCondition_FromProto(mapCtx *direct.MapContext, in *pb.Release_ReleaseCondition) *krm.Release_ReleaseCondition {
	if in == nil {
		return nil
	}
	out := &krm.Release_ReleaseCondition{}
	out.ReleaseReadyCondition = Release_ReleaseReadyCondition_FromProto(mapCtx, in.GetReleaseReadyCondition())
	out.SkaffoldSupportedCondition = Release_SkaffoldSupportedCondition_FromProto(mapCtx, in.GetSkaffoldSupportedCondition())
	return out
}
func Release_ReleaseCondition_ToProto(mapCtx *direct.MapContext, in *krm.Release_ReleaseCondition) *pb.Release_ReleaseCondition {
	if in == nil {
		return nil
	}
	out := &pb.Release_ReleaseCondition{}
	out.ReleaseReadyCondition = Release_ReleaseReadyCondition_ToProto(mapCtx, in.ReleaseReadyCondition)
	out.SkaffoldSupportedCondition = Release_SkaffoldSupportedCondition_ToProto(mapCtx, in.SkaffoldSupportedCondition)
	return out
}
func Release_ReleaseReadyCondition_FromProto(mapCtx *direct.MapContext, in *pb.Release_ReleaseReadyCondition) *krm.Release_ReleaseReadyCondition {
	if in == nil {
		return nil
	}
	out := &krm.Release_ReleaseReadyCondition{}
	out.Status = direct.LazyPtr(in.GetStatus())
	return out
}
func Release_ReleaseReadyCondition_ToProto(mapCtx *direct.MapContext, in *krm.Release_ReleaseReadyCondition) *pb.Release_ReleaseReadyCondition {
	if in == nil {
		return nil
	}
	out := &pb.Release_ReleaseReadyCondition{}
	out.Status = direct.ValueOf(in.Status)
	return out
}
func Release_SkaffoldSupportedCondition_FromProto(mapCtx *direct.MapContext, in *pb.Release_SkaffoldSupportedCondition) *krm.Release_SkaffoldSupportedCondition {
	if in == nil {
		return nil
	}
	out := &krm.Release_SkaffoldSupportedCondition{}
	out.Status = direct.LazyPtr(in.GetStatus())
	out.SkaffoldSupportState = direct.Enum_FromProto(mapCtx, in.GetSkaffoldSupportState())
...
func Release_SkaffoldSupportedCondition_ToProto(mapCtx *direct.MapContext, in *krm.Release_SkaffoldSupportedCondition) *pb.Release_SkaffoldSupportedCondition {
	if in == nil {
		return nil
	}
	out := &pb.Release_SkaffoldSupportedCondition{}
	out.Status = direct.ValueOf(in.Status)
	out.SkaffoldSupportState = direct.Enum_ToProto[pb.SkaffoldSupportState](mapCtx, in.SkaffoldSupportState)
...
func Release_TargetRender_FromProto(mapCtx *direct.MapContext, in *pb.Release_TargetRender) *krm.Release_TargetRender {
	if in == nil {
		return nil
	}
	out := &krm.Release_TargetRender{}
	// MISSING: RenderingBuild
	// MISSING: RenderingState
	// MISSING: Metadata
	// MISSING: FailureCause
	// MISSING: FailureMessage
	return out
}
func Release_TargetRender_ToProto(mapCtx *direct.MapContext, in *krm.Release_TargetRender) *pb.Release_TargetRender {
	if in == nil {
		return nil
	}
	out := &pb.Release_TargetRender{}
	// MISSING: RenderingBuild
	// MISSING: RenderingState
	// MISSING: Metadata
	// MISSING: FailureCause
...
func TargetArtifact_FromProto(mapCtx *direct.MapContext, in *pb.TargetArtifact) *krm.TargetArtifact {
	if in == nil {
		return nil
	}
	out := &krm.TargetArtifact{}
	// MISSING: ArtifactURI
	// MISSING: SkaffoldConfigPath
	// MISSING: ManifestPath
	// MISSING: PhaseArtifacts
	return out
}
func TargetArtifact_ToProto(mapCtx *direct.MapContext, in *krm.TargetArtifact) *pb.TargetArtifact {
	if in == nil {
		return nil
	}
	out := &pb.TargetArtifact{}
	// MISSING: ArtifactURI
	// MISSING: SkaffoldConfigPath
	// MISSING: ManifestPath
	// MISSING: PhaseArtifacts
...
func TargetArtifact_PhaseArtifact_FromProto(mapCtx *direct.MapContext, in *pb.TargetArtifact_PhaseArtifact) *krm.TargetArtifact_PhaseArtifact {
	if in == nil {
		return nil
	}
	out := &krm.TargetArtifact_PhaseArtifact{}
	// MISSING: SkaffoldConfigPath
	// MISSING: ManifestPath
	// MISSING: JobManifestsPath
	return out
}
func TargetArtifact_PhaseArtifact_ToProto(mapCtx *direct.MapContext, in *krm.TargetArtifact_PhaseArtifact) *pb.TargetArtifact_PhaseArtifact {
	if in == nil {
		return nil
	}
	out := &pb.TargetArtifact_PhaseArtifact{}
	// MISSING: SkaffoldConfigPath
	// MISSING: ManifestPath
	// MISSING: JobManifestsPath
	return out
