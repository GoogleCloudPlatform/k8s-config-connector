...
import (
	...
	api "cloud.google.com/go/eventarc/apiv1"
...
func (m *gcpClient) newEventarcClient(ctx context.Context) (*api.Client, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("building eventarc client: %w", err)
	}
	return client, err
}
