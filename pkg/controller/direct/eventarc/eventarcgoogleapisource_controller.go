...
func (a *googleApiSourceAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	allowedPaths.Insert("logging_config")
	...
	var updated *pb.GoogleApiSource
...
func (a *googleApiSourceAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	obj := &krm.EventarcGoogleAPISource{}
	mapCtx := &direct.MapContext{}
	obj.Spec = *EventarcGoogleAPISourceSpec_FromProto(mapCtx, a.actual)
	if mapCtx.Err() != nil {
	...
	u.SetName(a.id.Google_api_source)
...
func (a *googleApiSourceAdapter) normalizeReferenceFields(ctx context.Context) error {
	obj := a.desired
