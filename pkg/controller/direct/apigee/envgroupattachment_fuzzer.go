...
func init() {
	fuzztesting.RegisterKRMFuzzer_NoProto(envgroupAttachmentFuzzer())
}

func envgroupAttachmentFuzzer() fuzztesting.KRMFuzzer_NoProto {
	f := fuzztesting.NewKRMTypedFuzzer_NoProto(&api.GoogleCloudApigeeV1EnvironmentGroupAttachment{},
		ApigeeEnvgroupAttachmentSpec_FromAPI, ApigeeEnvgroupAttachmentSpec_ToAPI,
		ApigeeEnvgroupAttachmentObservedState_FromAPI, ApigeeEnvgroupAttachmentObservedState_ToAPI,
	)
