...
func ApigeeEndpointAttachmentObservedState_FromProto(mapCtx *direct.MapContext, in *api.GoogleCloudApigeeV1EndpointAttachment) *krm.ApigeeEndpointAttachmentObservedState {
	if in == nil {
		return nil
	}
...
func ApigeeEndpointAttachmentObservedState_ToProto(mapCtx *direct.MapContext, in *krm.ApigeeEndpointAttachmentObservedState) *api.GoogleCloudApigeeV1EndpointAttachment {
	if in == nil {
		return nil
	}
...
func ApigeeEndpointAttachmentSpec_FromProto(mapCtx *direct.MapContext, in *api.GoogleCloudApigeeV1EndpointAttachment) *krm.ApigeeEndpointAttachmentSpec {
	if in == nil {
		return nil
	}
...
func ApigeeEndpointAttachmentSpec_ToProto(mapCtx *direct.MapContext, in *krm.ApigeeEndpointAttachmentSpec, name string) *api.GoogleCloudApigeeV1EndpointAttachment {
	if in == nil {
		return nil
	}
	out := &api.GoogleCloudApigeeV1EndpointAttachment{}
