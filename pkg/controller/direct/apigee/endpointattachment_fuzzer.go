...
func init() {
	fuzztesting.RegisterKRMFuzzer_NoProto(ApigeeEndpointAttachmentFuzzer())
}

func ApigeeEndpointAttachmentFuzzer() fuzztesting.KRMFuzzer_NoProto {
