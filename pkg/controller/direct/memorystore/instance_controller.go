...
func init() {
	registry.RegisterModel(memorystorerefs.MemorystoreInstanceGVK, NewInstanceModel)
}
...
func (m *modelInstance) AdapterForObject(ctx context.Context, op *directbase.AdapterForObjectOperation) (directbase.Adapter, error) {
	...
	return &InstanceAdapter{
		id:        id.(*memorystorerefs.MemorystoreInstanceIdentity),
		gcpClient: gcpClient,
		desired:   desired,
	}, nil
}
...
type InstanceAdapter struct {
	id        *memorystorerefs.MemorystoreInstanceIdentity
...
func (a *InstanceAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	u.SetGroupVersionKind(memorystorerefs.MemorystoreInstanceGVK)
