...
func memorystoreInstanceFuzzer() fuzztesting.KRMFuzzer {
	...
	f.UnimplementedFields.Insert(".cross_instance_replication_config.update_time")
	...
	f.SpecFields.Insert(".cross_instance_replication_config.instance_role")
	f.SpecFields.Insert(".cross_instance_replication_config.primary_instance")
	f.StatusFields.Insert(".cross_instance_replication_config.primary_instance")
	f.StatusFields.Insert(".cross_instance_replication_config.secondary_instances")
	f.StatusFields.Insert(".cross_instance_replication_config.membership")
