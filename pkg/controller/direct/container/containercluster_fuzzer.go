...
func containerClusterFuzzer() fuzztesting.KRMFuzzer {
	...
	f.Unimplemented_NotYetTriaged(".node_config.kubelet_config.image_gc_high_threshold_percent")
	f.Unimplemented_NotYetTriaged(".node_config.kubelet_config.image_gc_low_threshold_percent")
	f.Unimplemented_NotYetTriaged(".node_config.kubelet_config.image_maximum_gc_age")
	f.Unimplemented_NotYetTriaged(".node_config.kubelet_config.image_minimum_gc_age")
