...
func OSConfigOSPolicyAssignmentStatus_FromProto(mapCtx *direct.MapContext, in *pb.OSPolicyAssignment) *krm.OSConfigOSPolicyAssignmentStatus {
	if in == nil {
		return nil
	}
	out := &krm.OSConfigOSPolicyAssignmentStatus{}
	// MISSING: Name
	// MISSING: Description
	// MISSING: OSPolicies
...
func OSConfigOSPolicyAssignmentStatus_ToProto(mapCtx *direct.MapContext, in *krm.OSConfigOSPolicyAssignmentStatus) *pb.OSPolicyAssignment {
	if in == nil {
		return nil
	}
	out := &pb.OSPolicyAssignment{}
