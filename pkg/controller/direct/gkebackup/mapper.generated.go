...
func GKEBackupBackupChannelSpec_FromProto(mapCtx *direct.MapContext, in *pb.BackupChannel) *krm.GKEBackupBackupChannelSpec {
	if in == nil {
		return nil
	}
...
func GKEBackupBackupChannelSpec_ToProto(mapCtx *direct.MapContext, in *krm.GKEBackupBackupChannelSpec) *pb.BackupChannel {
	if in == nil {
		return nil
	}
	out := &pb.BackupChannel{}
