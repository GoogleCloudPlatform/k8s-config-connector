...
func GkebackupRestoreObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Restore) *krm.GkebackupRestoreObservedState {
	if in == nil {
		return nil
	}
	out := &krm.GkebackupRestoreObservedState{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: CreateTime
	// MISSING: UpdateTime
	...
	// MISSING: ResourcesRestoredCount
	// MISSING: ResourcesExcludedCount
	// MISSING: ResourcesFailedCount
	// MISSING: VolumesRestoredCount
	// MISSING: Etag
	// MISSING: Filter
	// MISSING: VolumeDataRestorePolicyOverrides
	return out
}
func GkebackupRestoreObservedState_ToProto(mapCtx *direct.MapContext, in *krm.GkebackupRestoreObservedState) *pb.Restore {
	if in == nil {
		return nil
	}
	out := &pb.Restore{}
...
func GkebackupRestoreSpec_FromProto(mapCtx *direct.MapContext, in *pb.Restore) *krm.GkebackupRestoreSpec {
	if in == nil {
		return nil
	}
	out := &krm.GkebackupRestoreSpec{}
	// MISSING: Name
	// MISSING: Uid
	// MISSING: CreateTime
	// MISSING: UpdateTime
...
func ResourceSelector_FromProto(mapCtx *direct.MapContext, in *pb.ResourceSelector) *krm.ResourceSelector {
	if in == nil {
		return nil
	}
	out := &krm.ResourceSelector{}
...
func ResourceSelector_ToProto(mapCtx *direct.MapContext, in *krm.ResourceSelector) *pb.ResourceSelector {
	if in == nil {
		return nil
	}
...
func Restore_Filter_ToProto(mapCtx *direct.MapContext, in *krm.Restore_Filter) *pb.Restore_Filter {
	if in == nil {
		return nil
	}
...
func VolumeDataRestorePolicyOverride_FromProto(mapCtx *direct.MapContext, in *pb.VolumeDataRestorePolicyOverride) *krm.VolumeDataRestorePolicyOverride {
	if in == nil {
		return nil
	}
	out := &krm.VolumeDataRestorePolicyOverride{}
	out.Policy = direct.Enum_FromProto(mapCtx, in.GetPolicy())
	out.SelectedPvcs = NamespacedNames_FromProto(mapCtx, in.GetSelectedPvcs())
	return out
}
func VolumeDataRestorePolicyOverride_ToProto(mapCtx *direct.MapContext, in *krm.VolumeDataRestorePolicyOverride) *pb.VolumeDataRestorePolicyOverride {
	if in == nil {
		return nil
	}
