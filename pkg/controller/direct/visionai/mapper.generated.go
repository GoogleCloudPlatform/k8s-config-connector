...
func Application_FromProto(mapCtx *direct.MapContext, in *pb.Application) *krm.Application {
	...
	out.ApplicationConfigs = ApplicationConfigs_FromProto(mapCtx, in.GetApplicationConfigs())
	// MISSING: RuntimeInfo
	// MISSING: State
	out.BillingMode = direct.Enum_FromProto(mapCtx, in.GetBillingMode())
	return out
}
func Application_ToProto(mapCtx *direct.MapContext, in *krm.Application) *pb.Application {
	...
	out.ApplicationConfigs = ApplicationConfigs_ToProto(mapCtx, in.ApplicationConfigs)
	// MISSING: RuntimeInfo
	// MISSING: State
	out.BillingMode = direct.Enum_ToProto[pb.Application_BillingMode](mapCtx, in.BillingMode)
	return out
}
...
func ApplicationObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Application) *krm.ApplicationObservedState {
	...
	// MISSING: DisplayName
	// MISSING: Description
	// MISSING: ApplicationConfigs
	out.RuntimeInfo = Application_ApplicationRuntimeInfo_FromProto(mapCtx, in.GetRuntimeInfo())
...
func ApplicationObservedState_ToProto(mapCtx *direct.MapContext, in *krm.ApplicationObservedState) *pb.Application {
	...
	// MISSING: Description
	// MISSING: ApplicationConfigs
	out.RuntimeInfo = Application_ApplicationRuntimeInfo_ToProto(mapCtx, in.RuntimeInfo)
	out.State = direct.Enum_ToProto[pb.Application_State](mapCtx, in.State)
	// MISSING: BillingMode
	return out
}
func Application_ApplicationRuntimeInfo_FromProto(mapCtx *direct.MapContext, in *pb.Application_ApplicationRuntimeInfo) *krm.Application_ApplicationRuntimeInfo {
	if in == nil {
		return nil
	}
	out := &krm.Application_ApplicationRuntimeInfo{}
	out.DeployTime = direct.StringTimestamp_FromProto(mapCtx, in.GetDeployTime())
	out.GlobalOutputResources = direct.Slice_FromProto(mapCtx, in.GlobalOutputResources, Application_ApplicationRuntimeInfo_GlobalOutputResource_FromProto)
	out.MonitoringConfig = Application_ApplicationRuntimeInfo_MonitoringConfig_FromProto(mapCtx, in.GetMonitoringConfig())
	return out
}
func Application_ApplicationRuntimeInfo_ToProto(mapCtx *direct.MapContext, in *krm.Application_ApplicationRuntimeInfo) *pb.Application_ApplicationRuntimeInfo {
	if in == nil {
		return nil
	}
	out := &pb.Application_ApplicationRuntimeInfo{}
	out.DeployTime = direct.StringTimestamp_ToProto(mapCtx, in.DeployTime)
	out.GlobalOutputResources = direct.Slice_ToProto(mapCtx, in.GlobalOutputResources, Application_ApplicationRuntimeInfo_GlobalOutputResource_ToProto)
	out.MonitoringConfig = Application_ApplicationRuntimeInfo_MonitoringConfig_ToProto(mapCtx, in.MonitoringConfig)
	return out
}
func Application_ApplicationRuntimeInfo_GlobalOutputResource_FromProto(mapCtx *direct.MapContext, in *pb.Application_ApplicationRuntimeInfo_GlobalOutputResource) *krm.Application_ApplicationRuntimeInfo_GlobalOutputResource {
	if in == nil {
		return nil
	}
	out := &krm.Application_ApplicationRuntimeInfo_GlobalOutputResource{}
	out.OutputResource = direct.LazyPtr(in.GetOutputResource())
	out.ProducerNode = direct.LazyPtr(in.GetProducerNode())
	out.Key = direct.LazyPtr(in.GetKey())
	return out
}
func Application_ApplicationRuntimeInfo_GlobalOutputResource_ToProto(mapCtx *direct.MapContext, in *krm.Application_ApplicationRuntimeInfo_GlobalOutputResource) *pb.Application_ApplicationRuntimeInfo_GlobalOutputResource {
	if in == nil {
		return nil
	}
	out := &pb.Application_ApplicationRuntimeInfo_GlobalOutputResource{}
	out.OutputResource = direct.ValueOf(in.OutputResource)
	out.ProducerNode = direct.ValueOf(in.ProducerNode)
	out.Key = direct.ValueOf(in.Key)
	return out
}
func Application_ApplicationRuntimeInfo_MonitoringConfig_FromProto(mapCtx *direct.MapContext, in *pb.Application_ApplicationRuntimeInfo_MonitoringConfig) *krm.Application_ApplicationRuntimeInfo_MonitoringConfig {
	if in == nil {
		return nil
	}
	out := &krm.Application_ApplicationRuntimeInfo_MonitoringConfig{}
	out.Enabled = direct.LazyPtr(in.GetEnabled())
	return out
}
func Application_ApplicationRuntimeInfo_MonitoringConfig_ToProto(mapCtx *direct.MapContext, in *krm.Application_ApplicationRuntimeInfo_MonitoringConfig) *pb.Application_ApplicationRuntimeInfo_MonitoringConfig {
	if in == nil {
		return nil
	}
	out := &pb.Application_ApplicationRuntimeInfo_MonitoringConfig{}
...
func VisionaiApplicationObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Application) *krm.VisionaiApplicationObservedState {
	if in == nil {
		return nil
	}
	out := &krm.VisionaiApplicationObservedState{}
	// MISSING: Name
	// MISSING: CreateTime
	// MISSING: UpdateTime
	// MISSING: Labels
...
func VisionaiApplicationObservedState_ToProto(mapCtx *direct.MapContext, in *krm.VisionaiApplicationObservedState) *pb.Application {
	if in == nil {
		return nil
	}
	out := &pb.Application{}
...
func VisionaiApplicationSpec_FromProto(mapCtx *direct.MapContext, in *pb.Application) *krm.VisionaiApplicationSpec {
	if in == nil {
		return nil
	}
	out := &krm.VisionaiApplicationSpec{}
	// MISSING: Name
	// MISSING: CreateTime
	// MISSING: UpdateTime
	// MISSING: Labels
...
func VisionaiApplicationSpec_ToProto(mapCtx *direct.MapContext, in *krm.VisionaiApplicationSpec) *pb.Application {
	if in == nil {
		return nil
	}
	out := &pb.Application{}
