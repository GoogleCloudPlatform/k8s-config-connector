...
type ExecutionAdapter struct {
	...
	desired   *krm.NotebooksExecution
	actual    *notebookspb.Execution
}
...
func (a *ExecutionAdapter) Find(ctx context.Context) (bool, error) {
	...
	req := &notebookspb.GetExecutionRequest{Name: a.id}
...
func (a *ExecutionAdapter) Create(ctx context.Context, createOp *directbase.CreateOperation) error {
	...
	resource := NotebooksExecutionSpec_ToProto(mapCtx, &desired.Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	status.ObservedState = NotebooksExecutionObservedState_FromProto(mapCtx, created)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
...
func (a *ExecutionAdapter) Update(ctx context.Context, updateOp *directbase.UpdateOperation) error {
	...
	desiredPb := NotebooksExecutionSpec_ToProto(mapCtx, &a.desired.DeepCopy().Spec)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	...
	if len(paths) == 0 {
		...
		status := &krm.NotebooksExecutionStatus{}
		status.ObservedState = NotebooksExecutionObservedState_FromProto(mapCtx, a.actual)
		if mapCtx.Err() != nil {
			return mapCtx.Err()
		}
	...
	req := &notebookspb.UpdateExecutionRequest{
		Name:       a.id.External,
	...
	status := &krm.NotebooksExecutionStatus{}
	status.ObservedState = NotebooksExecutionObservedState_FromProto(mapCtx, updated)
	if mapCtx.Err() != nil {
		return mapCtx.Err()
	}
	return updateOp.UpdateStatus(ctx, status, nil)
...
func (a *ExecutionAdapter) Export(ctx context.Context) (*unstructured.Unstructured, error) {
	...
	obj := &krm.NotebooksExecution{}
	mapCtx := &direct.MapContext{}
	obj.Spec = direct.ValueOf(NotebooksExecutionSpec_FromProto(mapCtx, a.actual))
	if mapCtx.Err() != nil {
...
func (a *ExecutionAdapter) Delete(ctx context.Context, deleteOp *directbase.DeleteOperation) (bool, error) {
	...
	req := &notebookspb.DeleteExecutionRequest{Name: a.id.String()}
