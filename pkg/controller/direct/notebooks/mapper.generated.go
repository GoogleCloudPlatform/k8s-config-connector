...
func NotebookInstanceV2ObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.Instance) *krmnotebooksv1alpha1.NotebookInstanceV2ObservedState {
	...
	out.GCESetup = NotebookInstanceV2_GCESetupObservedState_v1alpha1_FromProto(mapCtx, in.GetGceSetup())
	out.ProxyURI = direct.LazyPtr(in.GetProxyUri())
	out.Creator = direct.LazyPtr(in.GetCreator())
	out.State = direct.Enum_FromProto(mapCtx, in.GetState())
	out.UpgradeHistory = direct.Slice_FromProto(mapCtx, in.UpgradeHistory, NotebookInstanceV2_UpgradeHistoryEntryObservedState_v1alpha1_FromProto)
...
func NotebookInstanceV2ObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2ObservedState) *notebookspb.Instance {
	...
	if oneof := NotebookInstanceV2_GCESetupObservedState_v1alpha1_ToProto(mapCtx, in.GCESetup); oneof != nil {
	...
	out.UpgradeHistory = direct.Slice_ToProto(mapCtx, in.UpgradeHistory, NotebookInstanceV2_UpgradeHistoryEntryObservedState_v1alpha1_ToProto)
...
func NotebookInstanceV2Spec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.Instance) *krmnotebooksv1alpha1.NotebookInstanceV2Spec {
	...
	out.GCESetup = NotebookInstanceV2_GCESetup_v1alpha1_FromProto(mapCtx, in.GetGceSetup())
	out.InstanceOwners = in.InstanceOwners
...
func NotebookInstanceV2Spec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2Spec) *notebookspb.Instance {
	...
	out := &notebookspb.Instance{}
	if oneof := NotebookInstanceV2_GCESetup_v1alpha1_ToProto(mapCtx, in.GCESetup); oneof != nil {
		out.Infrastructure = &notebookspb.Instance_GceSetup{GceSetup: oneof}
	}
	out.InstanceOwners = in.InstanceOwners
...
func NotebookInstanceV2_AcceleratorConfig_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.AcceleratorConfig) *krmnotebooksv1alpha1.NotebookInstanceV2_AcceleratorConfig {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_AcceleratorConfig{}
	out.Type = direct.Enum_FromProto(mapCtx, in.GetType())
	out.CoreCount = direct.LazyPtr(in.GetCoreCount())
	return out
}
func NotebookInstanceV2_AcceleratorConfig_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_AcceleratorConfig) *notebookspb.AcceleratorConfig {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_BootDisk_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.BootDisk) *krmnotebooksv1alpha1.NotebookInstanceV2_BootDisk {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_BootDisk{}
	out.DiskSizeGB = direct.LazyPtr(in.GetDiskSizeGb())
...
func NotebookInstanceV2_BootDisk_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_BootDisk) *notebookspb.BootDisk {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_ContainerImage_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.ContainerImage) *krmnotebooksv1alpha1.NotebookInstanceV2_ContainerImage {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_ContainerImage{}
	out.Repository = direct.LazyPtr(in.GetRepository())
	out.Tag = direct.LazyPtr(in.GetTag())
	return out
}
func NotebookInstanceV2_ContainerImage_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_ContainerImage) *notebookspb.ContainerImage {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_DataDisk_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.DataDisk) *krmnotebooksv1alpha1.NotebookInstanceV2_DataDisk {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_DataDisk{}
	out.DiskSizeGB = direct.LazyPtr(in.GetDiskSizeGb())
	out.DiskType = direct.Enum_FromProto(mapCtx, in.GetDiskType())
	out.DiskEncryption = direct.Enum_FromProto(mapCtx, in.GetDiskEncryption())
	if in.GetKmsKey() != "" {
...
func NotebookInstanceV2_DataDisk_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_DataDisk) *notebookspb.DataDisk {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_GCESetup_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.GceSetup) *krmnotebooksv1alpha1.NotebookInstanceV2_GCESetup {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_GCESetup{}
	out.MachineType = direct.LazyPtr(in.GetMachineType())
	out.AcceleratorConfigs = direct.Slice_FromProto(mapCtx, in.AcceleratorConfigs, NotebookInstanceV2_AcceleratorConfig_v1alpha1_FromProto)
	out.ServiceAccounts = direct.Slice_FromProto(mapCtx, in.ServiceAccounts, NotebookInstanceV2_ServiceAccount_v1alpha1_FromProto)
	out.VMImage = NotebookInstanceV2_VMImage_v1alpha1_FromProto(mapCtx, in.GetVmImage())
	out.ContainerImage = NotebookInstanceV2_ContainerImage_v1alpha1_FromProto(mapCtx, in.GetContainerImage())
	out.BootDisk = NotebookInstanceV2_BootDisk_v1alpha1_FromProto(mapCtx, in.GetBootDisk())
	out.DataDisks = direct.Slice_FromProto(mapCtx, in.DataDisks, NotebookInstanceV2_DataDisk_v1alpha1_FromProto)
	out.ShieldedInstanceConfig = NotebookInstanceV2_ShieldedInstanceConfig_v1alpha1_FromProto(mapCtx, in.GetShieldedInstanceConfig())
	out.NetworkInterfaces = direct.Slice_FromProto(mapCtx, in.NetworkInterfaces, NotebookInstanceV2_NetworkInterface_v1alpha1_FromProto)
	out.DisablePublicIP = direct.LazyPtr(in.GetDisablePublicIp())
	out.Tags = in.Tags
	out.Metadata = in.Metadata
	out.EnableIPForwarding = direct.LazyPtr(in.GetEnableIpForwarding())
	out.GpuDriverConfig = NotebookInstanceV2_GPUDriverConfig_v1alpha1_FromProto(mapCtx, in.GetGpuDriverConfig())
	return out
}
func NotebookInstanceV2_GCESetup_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_GCESetup) *notebookspb.GceSetup {
	if in == nil {
		return nil
	}
	out := &notebookspb.GceSetup{}
	out.MachineType = direct.ValueOf(in.MachineType)
	out.AcceleratorConfigs = direct.Slice_ToProto(mapCtx, in.AcceleratorConfigs, NotebookInstanceV2_AcceleratorConfig_v1alpha1_ToProto)
	out.ServiceAccounts = direct.Slice_ToProto(mapCtx, in.ServiceAccounts, NotebookInstanceV2_ServiceAccount_v1alpha1_ToProto)
	if oneof := NotebookInstanceV2_VMImage_v1alpha1_ToProto(mapCtx, in.VMImage); oneof != nil {
		out.Image = &notebookspb.GceSetup_VmImage{VmImage: oneof}
	}
	if oneof := NotebookInstanceV2_ContainerImage_v1alpha1_ToProto(mapCtx, in.ContainerImage); oneof != nil {
		out.Image = &notebookspb.GceSetup_ContainerImage{ContainerImage: oneof}
	}
	out.BootDisk = NotebookInstanceV2_BootDisk_v1alpha1_ToProto(mapCtx, in.BootDisk)
	out.DataDisks = direct.Slice_ToProto(mapCtx, in.DataDisks, NotebookInstanceV2_DataDisk_v1alpha1_ToProto)
	out.ShieldedInstanceConfig = NotebookInstanceV2_ShieldedInstanceConfig_v1alpha1_ToProto(mapCtx, in.ShieldedInstanceConfig)
	out.NetworkInterfaces = direct.Slice_ToProto(mapCtx, in.NetworkInterfaces, NotebookInstanceV2_NetworkInterface_v1alpha1_ToProto)
	out.DisablePublicIp = direct.ValueOf(in.DisablePublicIP)
	out.Tags = in.Tags
	out.Metadata = in.Metadata
	out.EnableIpForwarding = direct.ValueOf(in.EnableIPForwarding)
	out.GpuDriverConfig = NotebookInstanceV2_GPUDriverConfig_v1alpha1_ToProto(mapCtx, in.GpuDriverConfig)
	return out
}
func NotebookInstanceV2_GCESetupObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.GceSetup) *krmnotebooksv1alpha1.NotebookInstanceV2_GCESetupObservedState {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_GCESetupObservedState{}
	// MISSING: MachineType
	// MISSING: AcceleratorConfigs
	out.ServiceAccounts = direct.Slice_FromProto(mapCtx, in.ServiceAccounts, NotebookInstanceV2_ServiceAccountObservedState_v1alpha1_FromProto)
	// MISSING: VMImage
...
func NotebookInstanceV2_GCESetupObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_GCESetupObservedState) *notebookspb.GceSetup {
	if in == nil {
		return nil
	}
	out := &notebookspb.GceSetup{}
	// MISSING: MachineType
	// MISSING: AcceleratorConfigs
	out.ServiceAccounts = direct.Slice_ToProto(mapCtx, in.ServiceAccounts, NotebookInstanceV2_ServiceAccountObservedState_v1alpha1_ToProto)
	// MISSING: VMImage
	// MISSING: ContainerImage
	// MISSING: BootDisk
	// MISSING: DataDisks
...
func NotebookInstanceV2_GPUDriverConfig_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.GPUDriverConfig) *krmnotebooksv1alpha1.NotebookInstanceV2_GPUDriverConfig {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_GPUDriverConfig{}
	out.EnableGpuDriver = direct.LazyPtr(in.GetEnableGpuDriver())
	out.CustomGpuDriverPath = direct.LazyPtr(in.GetCustomGpuDriverPath())
	return out
}
func NotebookInstanceV2_GPUDriverConfig_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_GPUDriverConfig) *notebookspb.GPUDriverConfig {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_NetworkInterface_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.NetworkInterface) *krmnotebooksv1alpha1.NotebookInstanceV2_NetworkInterface {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_NetworkInterface{}
	if in.GetNetwork() != "" {
		out.NetworkRef = &krmcomputerefs.ComputeNetworkRef{External: in.GetNetwork()}
	}
	if in.GetSubnet() != "" {
...
func NotebookInstanceV2_NetworkInterface_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_NetworkInterface) *notebookspb.NetworkInterface {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_ServiceAccount_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.ServiceAccount) *krmnotebooksv1alpha1.NotebookInstanceV2_ServiceAccount {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_ServiceAccount{}
	// MISSING: Email
	// MISSING: Scopes
	return out
}
func NotebookInstanceV2_ServiceAccount_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_ServiceAccount) *notebookspb.ServiceAccount {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_ServiceAccountObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.ServiceAccount) *krmnotebooksv1alpha1.NotebookInstanceV2_ServiceAccountObservedState {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_ServiceAccountObservedState{}
	// MISSING: Email
	out.Scopes = in.Scopes
	return out
}
func NotebookInstanceV2_ServiceAccountObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_ServiceAccountObservedState) *notebookspb.ServiceAccount {
	if in == nil {
		return nil
	}
	out := &notebookspb.ServiceAccount{}
...
func NotebookInstanceV2_ShieldedInstanceConfig_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.ShieldedInstanceConfig) *krmnotebooksv1alpha1.NotebookInstanceV2_ShieldedInstanceConfig {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_ShieldedInstanceConfig{}
	out.EnableSecureBoot = direct.LazyPtr(in.GetEnableSecureBoot())
	out.EnableVTPM = direct.LazyPtr(in.GetEnableVtpm())
	out.EnableIntegrityMonitoring = direct.LazyPtr(in.GetEnableIntegrityMonitoring())
	return out
}
func NotebookInstanceV2_ShieldedInstanceConfig_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_ShieldedInstanceConfig) *notebookspb.ShieldedInstanceConfig {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_UpgradeHistoryEntryObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.UpgradeHistoryEntry) *krmnotebooksv1alpha1.NotebookInstanceV2_UpgradeHistoryEntryObservedState {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_UpgradeHistoryEntryObservedState{}
	out.Snapshot = direct.LazyPtr(in.GetSnapshot())
	out.VMImage = direct.LazyPtr(in.GetVmImage())
	out.ContainerImage = direct.LazyPtr(in.GetContainerImage())
	out.Framework = direct.LazyPtr(in.GetFramework())
...
func NotebookInstanceV2_UpgradeHistoryEntryObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_UpgradeHistoryEntryObservedState) *notebookspb.UpgradeHistoryEntry {
	if in == nil {
		return nil
	}
...
func NotebookInstanceV2_VMImage_v1alpha1_FromProto(mapCtx *direct.MapContext, in *notebookspb.VmImage) *krmnotebooksv1alpha1.NotebookInstanceV2_VMImage {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebookInstanceV2_VMImage{}
	out.Project = direct.LazyPtr(in.GetProject())
	out.Name = direct.LazyPtr(in.GetName())
	out.Family = direct.LazyPtr(in.GetFamily())
	return out
}
func NotebookInstanceV2_VMImage_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebookInstanceV2_VMImage) *notebookspb.VmImage {
	if in == nil {
		return nil
	}
	out := &notebookspb.VmImage{}
	out.Project = direct.ValueOf(in.Project)
	if oneof := NotebookInstanceV2_VMImage_Name_ToProto(mapCtx, in.Name); oneof != nil {
		out.Image = oneof
	}
	if oneof := NotebookInstanceV2_VMImage_Family_ToProto(mapCtx, in.Family); oneof != nil {
		out.Image = oneof
	}
	return out
}
func NotebookInstanceV2_VMImage_Name_ToProto(mapCtx *direct.MapContext, in *string) *notebookspb.VmImage_Name {
	if in == nil {
		return nil
	}
	return &notebookspb.VmImage_Name{Name: *in}
}
func NotebookInstanceV2_VMImage_Family_ToProto(mapCtx *direct.MapContext, in *string) *notebookspb.VmImage_Family {
	if in == nil {
		return nil
	}
