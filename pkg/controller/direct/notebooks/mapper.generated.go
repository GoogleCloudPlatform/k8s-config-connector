...
func NotebooksScheduleObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Schedule) *krm.NotebooksScheduleObservedState {
	if in == nil {
		return nil
	}
	out := &krm.NotebooksScheduleObservedState{}
	// MISSING: Name
	// MISSING: DisplayName
	// MISSING: Description
	// MISSING: State
...
func NotebooksScheduleObservedState_ToProto(mapCtx *direct.MapContext, in *krm.NotebooksScheduleObservedState) *pb.Schedule {
	if in == nil {
		return nil
	}
	out := &pb.Schedule{}
...
func NotebooksScheduleSpec_FromProto(mapCtx *direct.MapContext, in *pb.Schedule) *krm.NotebooksScheduleSpec {
	if in == nil {
		return nil
	}
	out := &krm.NotebooksScheduleSpec{}
	// MISSING: Name
	// MISSING: DisplayName
	// MISSING: Description
	// MISSING: State
...
func NotebooksScheduleSpec_ToProto(mapCtx *direct.MapContext, in *krm.NotebooksScheduleSpec) *pb.Schedule {
	if in == nil {
		return nil
	}
	out := &pb.Schedule{}
...
func ScheduleObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Schedule) *krm.ScheduleObservedState {
	if in == nil {
		return nil
	}
	out := &krm.ScheduleObservedState{}
	out.Name = direct.LazyPtr(in.GetName())
	out.DisplayName = direct.LazyPtr(in.GetDisplayName())
	// MISSING: Description
	// MISSING: State
	...
	out.UpdateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetUpdateTime())
	// MISSING: ExecutionTemplate
	out.RecentExecutions = direct.Slice_FromProto(mapCtx, in.RecentExecutions, Execution_FromProto)
	return out
}
func ScheduleObservedState_ToProto(mapCtx *direct.MapContext, in *krm.ScheduleObservedState) *pb.Schedule {
	if in == nil {
		return nil
	}
	out := &pb.Schedule{}
	...
	out.UpdateTime = direct.StringTimestamp_ToProto(mapCtx, in.UpdateTime)
	// MISSING: ExecutionTemplate
	out.RecentExecutions = direct.Slice_ToProto(mapCtx, in.RecentExecutions, Execution_ToProto)
	return out
}
