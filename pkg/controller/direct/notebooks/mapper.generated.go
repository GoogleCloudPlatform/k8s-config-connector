...
func NotebooksRuntimeObservedState_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.Runtime) *krmnotebooksv1alpha1.NotebooksRuntimeObservedState {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebooksRuntimeObservedState{}
	// MISSING: Name
...
func NotebooksRuntimeObservedState_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebooksRuntimeObservedState) *pb.Runtime {
	if in == nil {
		return nil
	}
	out := &pb.Runtime{}
...
func NotebooksRuntimeSpec_v1alpha1_FromProto(mapCtx *direct.MapContext, in *pb.Runtime) *krmnotebooksv1alpha1.NotebooksRuntimeSpec {
	if in == nil {
		return nil
	}
	out := &krmnotebooksv1alpha1.NotebooksRuntimeSpec{}
	// MISSING: Name
...
func NotebooksRuntimeSpec_v1alpha1_ToProto(mapCtx *direct.MapContext, in *krmnotebooksv1alpha1.NotebooksRuntimeSpec) *pb.Runtime {
	if in == nil {
		return nil
	}
	out := &pb.Runtime{}
