...
func notebookInstanceV2Fuzzer() fuzztesting.KRMFuzzer {
	f := fuzztesting.NewKRMTypedFuzzer(&pb.Instance{},
		NotebookInstanceV2Spec_FromProto, NotebookInstanceV2Spec_ToProto,
		NotebookInstanceV2ObservedState_FromProto, NotebookInstanceV2ObservedState_ToProto,
	)

	f.Unimplemented_Identity(".name") // special field
	f.Unimplemented_Identity(".id")   // not mapped directly
	f.Unimplemented_NotYetTriaged(".gce_setup.service_accounts[].scopes")
