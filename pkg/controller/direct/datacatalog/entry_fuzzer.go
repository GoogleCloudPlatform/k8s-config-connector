...
func dataCatalogEntryFuzzer() fuzztesting.KRMFuzzer {
	...
	f.StatusFields.Insert(".integrated_system")
	...
	f.UnimplementedFields.Insert(".system_spec") // deprecated oneof
	f.UnimplementedFields.Insert(".type_spec")   // deprecated oneof
	return f
}
