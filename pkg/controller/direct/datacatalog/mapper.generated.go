...
func DataCatalogPolicyTagObservedState_FromProto(mapCtx *direct.MapContext, in *pb.PolicyTag) *krmdatacatalogv1beta1.DataCatalogPolicyTagObservedState {
	if in == nil {
		return nil
	}
...
func DataCatalogPolicyTagObservedState_ToProto(mapCtx *direct.MapContext, in *krmdatacatalogv1beta1.DataCatalogPolicyTagObservedState) *pb.PolicyTag {
	if in == nil {
		return nil
	}
	out := &pb.PolicyTag{}
...
func DataCatalogPolicyTagSpec_FromProto(mapCtx *direct.MapContext, in *pb.PolicyTag) *krmdatacatalogv1beta1.DataCatalogPolicyTagSpec {
	if in == nil {
		return nil
	}
...
func DataCatalogPolicyTagSpec_ToProto(mapCtx *direct.MapContext, in *krmdatacatalogv1beta1.DataCatalogPolicyTagSpec) *pb.PolicyTag {
	if in == nil {
		return nil
	}
	out := &pb.PolicyTag{}
...
func DataCatalogTaxonomyObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Taxonomy) *krmdatacatalogv1beta1.DataCatalogTaxonomyObservedState {
	if in == nil {
		return nil
	}
...
found existing non-generated mapping function "DataCatalogTaxonomyObservedState_ToProto", skipping
	...
	func DataCatalogTaxonomyObservedState_ToProto(mapCtx *direct.MapContext, in *krmdatacatalogv1beta1.DataCatalogTaxonomyObservedState) *pb.Taxonomy {
		if in == nil {
			return nil
		}
		out := &pb.Taxonomy{}
...
func TaxonomySystemTimestamps_FromProto(mapCtx *direct.MapContext, in *pb.SystemTimestamps) *krmdatacatalogv1beta1.TaxonomySystemTimestamps {
	if in == nil {
		return nil
	}
...
func TaxonomySystemTimestamps_ToProto(mapCtx *direct.MapContext, in *krmdatacatalogv1beta1.TaxonomySystemTimestamps) *pb.SystemTimestamps {
	if in == nil {
		return nil
	}
	out := &pb.SystemTimestamps{}
...
func Taxonomy_Service_FromProto(mapCtx *direct.MapContext, in *pb.Taxonomy_Service) *krmdatacatalogv1beta1.Taxonomy_Service {
	if in == nil {
		return nil
	}
...
found existing non-generated mapping function "Taxonomy_Service_ToProto", skipping
	...
	func Taxonomy_Service_ToProto(mapCtx *direct.MapContext, in *krmdatacatalogv1beta1.Taxonomy_Service) *pb.Taxonomy_Service {
		if in == nil {
			return nil
		}
