...
func DataCatalogEntryObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Entry) *krm.DataCatalogEntryObservedState {
	...
	// MISSING: SQLDatabaseSystemSpec
	// MISSING: LookerSystemSpec
	// MISSING: CloudBigtableSystemSpec
	...
	// MISSING: DataSourceConnectionSpec
	// MISSING: RoutineSpec
	// MISSING: DatasetSpec
	// MISSING: FilesetSpec
	// MISSING: ServiceSpec
	...
	out.PersonalDetails = PersonalDetailsObservedState_FromProto(mapCtx, in.GetPersonalDetails())
	return out
}
func DataCatalogEntryObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DataCatalogEntryObservedState) *pb.Entry {
	...
	out.PersonalDetails = PersonalDetailsObservedState_ToProto(mapCtx, in.PersonalDetails)
	return out
}
...
func Entry_FromProto(mapCtx *direct.MapContext, in *pb.Entry) *krm.Entry {
	...
	// MISSING: BigqueryTableSpec
	// MISSING: BigqueryDateShardedSpec
...
func PersonalDetailsObservedState_FromProto(mapCtx *direct.MapContext, in *pb.PersonalDetails) *krm.PersonalDetailsObservedState {
	if in == nil {
		return nil
	}
	out := &krm.PersonalDetailsObservedState{}
	out.Starred = direct.LazyPtr(in.GetStarred())
	out.StarTime = direct.StringTimestamp_FromProto(mapCtx, in.GetStarTime())
	return out
}
func PersonalDetailsObservedState_ToProto(mapCtx *direct.MapContext, in *krm.PersonalDetailsObservedState) *pb.PersonalDetails {
	if in == nil {
		return nil
	}
	out := &pb.PersonalDetails{}
