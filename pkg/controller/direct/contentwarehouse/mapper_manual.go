...
func PropertyDefinition_SchemaSource_FromProto(mapCtx *direct.MapContext, in any) any {
	return nil
}

func PropertyDefinition_SchemaSource_ToProto(mapCtx *direct.MapContext, in any) any {
	return nil
}
