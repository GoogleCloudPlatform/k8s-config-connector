...
func AppHubApplicationObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Application) *krmapphubv1alpha1.AppHubApplicationObservedState {
	if in == nil {
		return nil
	}
	out := &krmapphubv1alpha1.AppHubApplicationObservedState{}
	// MISSING: Name
...
func AppHubApplicationObservedState_ToProto(mapCtx *direct.MapContext, in *krmapphubv1alpha1.AppHubApplicationObservedState) *pb.Application {
	if in == nil {
		return nil
	}
	out := &pb.Application{}
...
func AppHubApplicationSpec_FromProto(mapCtx *direct.MapContext, in *pb.Application) *krmapphubv1alpha1.AppHubApplicationSpec {
	if in == nil {
		return nil
	}
	out := &krmapphubv1alpha1.AppHubApplicationSpec{}
	// MISSING: Name
...
func AppHubApplicationSpec_ToProto(mapCtx *direct.MapContext, in *krmapphubv1alpha1.AppHubApplicationSpec) *pb.Application {
	if in == nil {
		return nil
	}
	out := &pb.Application{}
...
func Attributes_FromProto(mapCtx *direct.MapContext, in *pb.Attributes) *krmapphubv1alpha1.Attributes {
	if in == nil {
		return nil
	}
...
func Attributes_ToProto(mapCtx *direct.MapContext, in *krmapphubv1alpha1.Attributes) *pb.Attributes {
	if in == nil {
		return nil
	}
	out := &pb.Attributes{}
...
func ContactInfo_FromProto(mapCtx *direct.MapContext, in *pb.ContactInfo) *krmapphubv1alpha1.ContactInfo {
	if in == nil {
		return nil
	}
...
func ContactInfo_ToProto(mapCtx *direct.MapContext, in *krmapphubv1alpha1.ContactInfo) *pb.ContactInfo {
	if in == nil {
		return nil
	}
	out := &pb.ContactInfo{}
...
func Criticality_FromProto(mapCtx *direct.MapContext, in *pb.Criticality) *krmapphubv1alpha1.Criticality {
	if in == nil {
		return nil
	}
...
func Criticality_ToProto(mapCtx *direct.MapContext, in *krmapphubv1alpha1.Criticality) *pb.Criticality {
	if in == nil {
		return nil
	}
	out := &pb.Criticality{}
...
func Environment_FromProto(mapCtx *direct.MapContext, in *pb.Environment) *krmapphubv1alpha1.Environment {
	if in == nil {
		return nil
	}
...
func Environment_ToProto(mapCtx *direct.MapContext, in *krmapphubv1alpha1.Environment) *pb.Environment {
	if in == nil {
		return nil
	}
	out := &pb.Environment{}
...
func Scope_FromProto(mapCtx *direct.MapContext, in *pb.Scope) *krmapphubv1alpha1.Scope {
	if in == nil {
		return nil
	}
	out := &krmapphubv1alpha1.Scope{}
	out.Type = direct.Enum_FromProto(mapCtx, in.GetType())
	return out
}
*/
...
func Scope_ToProto(mapCtx *direct.MapContext, in *krmapphubv1alpha1.Scope) *pb.Scope {
	if in == nil {
		return nil
	}
	out := &pb.Scope{}
