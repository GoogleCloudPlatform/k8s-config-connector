...
func BigQueryInputConfig_FromProto(mapCtx *direct.MapContext, in *pb.BigQueryInputConfig) *krm.BigQueryInputConfig {
	...
	if in.GetBigqueryTable() != "" {
		out.BigqueryTableRef = &krmbigqueryv1beta1.BigQueryTableRef{External: in.GetBigqueryTable()}
	}
...
func BigQueryInputConfig_ToProto(mapCtx *direct.MapContext, in *krm.BigQueryInputConfig) *pb.BigQueryInputConfig {
	...
	if in.BigqueryTableRef != nil {
		out.BigqueryTable = in.BigqueryTableRef.External
	}
...
func InputConfig_FromProto(mapCtx *direct.MapContext, in *pb.InputConfig) *krm.InputConfig {
	...
	if in.GetPreviousResultBigqueryTable() != "" {
		out.PreviousResultBigqueryTableRef = &krmbigqueryv1beta1.BigQueryTableRef{External: in.GetPreviousResultBigqueryTable()}
	}
	return out
}
func InputConfig_ToProto(mapCtx *direct.MapContext, in *krm.InputConfig) *pb.InputConfig {
	...
	if in.PreviousResultBigqueryTableRef != nil {
		out.PreviousResultBigqueryTable = in.PreviousResultBigqueryTableRef.External
	}
	return out
}
func OutputConfig_FromProto(mapCtx *direct.MapContext, in *pb.OutputConfig) *krm.OutputConfig {
	...
	if in.GetBigqueryDataset() != "" {
		out.BigqueryDatasetRef = &krmbigqueryv1beta1.DatasetRef{External: in.GetBigqueryDataset()}
	}
	return out
}
func OutputConfig_ToProto(mapCtx *direct.MapContext, in *krm.OutputConfig) *pb.OutputConfig {
	...
	if in.BigqueryDatasetRef != nil {
		out.BigqueryDataset = in.BigqueryDatasetRef.External
	}
	return out
}
