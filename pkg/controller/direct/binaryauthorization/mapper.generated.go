...
func AdmissionRule_FromProto(mapCtx *direct.MapContext, in *pb.AdmissionRule) *krmv1beta1.AdmissionRule {
	if in == nil {
		return nil
	}
	out := &krmv1beta1.AdmissionRule{}
...
func AdmissionRule_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.AdmissionRule) *pb.AdmissionRule {
	if in == nil {
		return nil
	}
...
func AdmissionWhitelistPattern_FromProto(mapCtx *direct.MapContext, in *pb.AdmissionWhitelistPattern) *krmv1beta1.AdmissionWhitelistPattern {
	if in == nil {
		return nil
	}
	out := &krmv1beta1.AdmissionWhitelistPattern{}
	out.NamePattern = direct.LazyPtr(in.GetNamePattern())
	return out
}
func AdmissionWhitelistPattern_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.AdmissionWhitelistPattern) *pb.AdmissionWhitelistPattern {
	if in == nil {
		return nil
	}
