...
func AttestorPublicKey_FromProto(mapCtx *direct.MapContext, in *pb.AttestorPublicKey) *krmv1beta1.AttestorPublicKey {
	if in == nil {
		return nil
	}
	out := &krmv1beta1.AttestorPublicKey{}
...
func AttestorPublicKey_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.AttestorPublicKey) *pb.AttestorPublicKey {
	if in == nil {
		return nil
	}
...
func BinaryAuthorizationAttestorSpec_FromProto(mapCtx *direct.MapContext, in *pb.Attestor) *krmv1beta1.BinaryAuthorizationAttestorSpec {
	if in == nil {
		return nil
	}
	out := &krmv1beta1.BinaryAuthorizationAttestorSpec{}
	// MISSING: Name
...
func BinaryAuthorizationAttestorSpec_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.BinaryAuthorizationAttestorSpec) *pb.Attestor {
	if in == nil {
		return nil
	}
	out := &pb.Attestor{}
...
func BinaryAuthorizationAttestorStatus_FromProto(mapCtx *direct.MapContext, in *pb.Attestor) *krmv1beta1.BinaryAuthorizationAttestorStatus {
	if in == nil {
		return nil
	}
	out := &krmv1beta1.BinaryAuthorizationAttestorStatus{}
	// MISSING: Name
	// MISSING: Description
	out.UserOwnedGrafeasNote = UserOwnedGrafeasNoteStatus_FromProto(mapCtx, in.GetUserOwnedGrafeasNote())
	out.UpdateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetUpdateTime())
	return out
}
func BinaryAuthorizationAttestorStatus_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.BinaryAuthorizationAttestorStatus) *pb.Attestor {
	if in == nil {
		return nil
	}
	out := &pb.Attestor{}
	// MISSING: Name
	// MISSING: Description
	if oneof := UserOwnedGrafeasNoteStatus_ToProto(mapCtx, in.UserOwnedGrafeasNote); oneof != nil {
		out.AttestorType = &pb.Attestor_UserOwnedGrafeasNote{UserOwnedGrafeasNote: oneof}
	}
	out.UpdateTime = direct.StringTimestamp_ToProto(mapCtx, in.UpdateTime)
	return out
}
func PkixPublicKey_v1beta1_FromProto(mapCtx *direct.MapContext, in *pb.PkixPublicKey) *krmv1beta1.PkixPublicKey {
	if in == nil {
		return nil
	}
	out := &krmv1beta1.PkixPublicKey{}
...
func PkixPublicKey_v1beta1_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.PkixPublicKey) *pb.PkixPublicKey {
	if in == nil {
		return nil
	}
...
func UserOwnedGrafeasNoteStatus_FromProto(mapCtx *direct.MapContext, in *pb.UserOwnedGrafeasNote) *krmv1beta1.UserOwnedGrafeasNoteStatus {
	...
	out := &krmv1beta1.UserOwnedGrafeasNoteStatus{}
	// MISSING: NoteReference
	// MISSING: PublicKeys
	out.DelegationServiceAccountEmail = direct.LazyPtr(in.GetDelegationServiceAccountEmail())
	return out
}
func UserOwnedGrafeasNoteStatus_ToProto(mapCtx *direct.MapContext, in *krmv1beta1.UserOwnedGrafeasNoteStatus) *pb.UserOwnedGrafeasNote {
	if in == nil {
		return nil
	}
	out := &pb.UserOwnedGrafeasNote{}
