...
func SQLInstanceKRMToGCPInstance(in *krm.SQLInstance) (*api.DatabaseInstance, error) {
	...
	if in.Spec.EncryptionKMSCryptoKeyRef != nil {
		out.DiskEncryptionConfiguration = &api.DiskEncryptionConfiguration{
			...
			KmsKeyName: in.Spec.EncryptionKMSCryptoKeyRef.Name,
		}
	}
	...
	if in.Spec.MasterInstanceRef != nil {
		out.MasterInstanceName = in.Spec.MasterInstanceRef.Name
	}
	...
	if in.Spec.ReplicaConfiguration != nil {
		...
		if in.Spec.ReplicaConfiguration.Password != nil {
			replicaConfiguration.MysqlReplicaConfiguration.Password = *in.Spec.ReplicaConfiguration.Password.Value
		}
	...
	if in.Spec.RootPassword != nil && in.Spec.RootPassword.Value != nil {
		out.RootPassword = *in.Spec.RootPassword.Value
	}
	...
	if in.Spec.Settings.IpConfiguration != nil {
		...
		if in.Spec.Settings.IpConfiguration.PrivateNetworkRef != nil {
			out.Settings.IpConfiguration.PrivateNetwork = in.Spec.Settings.IpConfiguration.PrivateNetworkRef.Name
		}
	...
	if in.Spec.Settings.SqlServerAuditConfig != nil {
		...
		if in.Spec.Settings.SqlServerAuditConfig.BucketRef != nil {
			// todo: required
			out.Settings.SqlServerAuditConfig.Bucket = in.Spec.Settings.SqlServerAuditConfig.BucketRef.Name
		}
