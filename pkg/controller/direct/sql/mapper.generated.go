...
func DatabaseInstanceObservedState_FromProto(mapCtx *direct.MapContext, in *pb.DatabaseInstance) *krm.DatabaseInstanceObservedState {
	...
	// MISSING: Tags
	// MISSING: NodeCount
	out.Nodes = direct.Slice_FromProto(mapCtx, in.Nodes, DatabaseInstance_PoolNodeConfigObservedState_FromProto)
	out.DNSNames = direct.Slice_FromProto(mapCtx, in.DnsNames, DNSNameMappingObservedState_FromProto)
	return out
}
func DatabaseInstanceObservedState_ToProto(mapCtx *direct.MapContext, in *krm.DatabaseInstanceObservedState) *pb.DatabaseInstance {
	...
	// MISSING: Tags
	// MISSING: NodeCount
	out.Nodes = direct.Slice_ToProto(mapCtx, in.Nodes, DatabaseInstance_PoolNodeConfigObservedState_ToProto)
...
func DatabaseInstance_PoolNodeConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.DatabaseInstance_PoolNodeConfig) *krm.DatabaseInstance_PoolNodeConfigObservedState {
	...
	out.DNSNames = direct.Slice_FromProto(mapCtx, in.DnsNames, DNSNameMappingObservedState_FromProto)
	out.PSCServiceAttachmentLink = in.PscServiceAttachmentLink
	out.PSCAutoConnections = direct.Slice_FromProto(mapCtx, in.PscAutoConnections, PSCAutoConnectionConfigObservedState_FromProto)
	return out
}
...
func IPConfigurationObservedState_FromProto(mapCtx *direct.MapContext, in *pb.IpConfiguration) *krm.IPConfigurationObservedState {
	...
	// MISSING: CustomSubjectAlternativeNames
	// MISSING: ServerCAPool
	// MISSING: ServerCertificateRotationMode
	return out
}
...
func PSCAutoConnectionConfig_FromProto(mapCtx *direct.MapContext, in *pb.PscAutoConnectionConfig) *krm.PSCAutoConnectionConfig {
	...
	// MISSING: ServiceConnectionPolicy
	// MISSING: ServiceConnectionPolicyCreationResult
	// MISSING: InstanceAutoDNSStatus
	// MISSING: WriteEndpointAutoDNSStatus
	return out
}
...
func PSCAutoConnectionConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.PscAutoConnectionConfig) *krm.PSCAutoConnectionConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krm.PSCAutoConnectionConfigObservedState{}
	out.ConsumerProject = direct.LazyPtr(in.GetConsumerProject())
	out.ConsumerNetwork = direct.LazyPtr(in.GetConsumerNetwork())
	out.IPAddress = in.IpAddress
	out.Status = in.Status
	...
	out.InstanceAutoDNSStatus = direct.Enum_FromProto(mapCtx, in.GetInstanceAutoDnsStatus())
	out.WriteEndpointAutoDNSStatus = direct.Enum_FromProto(mapCtx, in.GetWriteEndpointAutoDnsStatus())
	return out
}
func PSCAutoConnectionConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krm.PSCAutoConnectionConfigObservedState) *pb.PscAutoConnectionConfig {
	if in == nil {
		return nil
	}
	out := &pb.PscAutoConnectionConfig{}
	...
	out.ServiceConnectionPolicy = in.ServiceConnectionPolicy
	out.ServiceConnectionPolicyCreationResult = in.ServiceConnectionPolicyCreationResult
	if oneof := PSCAutoConnectionConfigObservedState_InstanceAutoDnsStatus_ToProto(mapCtx, in.InstanceAutoDNSStatus); oneof != nil {
		out.InstanceAutoDnsStatus = oneof
	}
	if oneof := PSCAutoConnectionConfigObservedState_WriteEndpointAutoDnsStatus_ToProto(mapCtx, in.WriteEndpointAutoDNSStatus); oneof != nil {
		out.WriteEndpointAutoDnsStatus = oneof
	}
	return out
}
func PSCConfig_FromProto(mapCtx *direct.MapContext, in *pb.PscConfig) *krm.PSCConfig {
	...
	out.PSCAutoDNSEnabled = in.PscAutoDnsEnabled
	out.PSCWriteEndpointDNSEnabled = in.PscWriteEndpointDnsEnabled
	out.PSCAutoConnectionPolicyEnabled = in.PscAutoConnectionPolicyEnabled
	return out
}
...
func PSCConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.PscConfig) *krm.PSCConfigObservedState {
	...
	out.PSCAutoConnections = direct.Slice_FromProto(mapCtx, in.PscAutoConnections, PSCAutoConnectionConfigObservedState_FromProto)
	// MISSING: NetworkAttachmentURI
	// MISSING: PSCAutoDNSEnabled
	// MISSING: PSCWriteEndpointDNSEnabled
	// MISSING: PSCAutoConnectionPolicyEnabled
	return out
}
...
func PerformanceCaptureConfig_FromProto(mapCtx *direct.MapContext, in *pb.PerformanceCaptureConfig) *krm.PerformanceCaptureConfig {
	...
	out.CPUUtilizationThresholdPercent = in.CpuUtilizationThresholdPercent
	out.MemoryUsageThresholdPercent = in.MemoryUsageThresholdPercent
	out.TransactionLockWaitThresholdCount = in.TransactionLockWaitThresholdCount
	out.SemaphoreWaitThresholdCount = in.SemaphoreWaitThresholdCount
	...
	out.TransactionKillType = direct.Enum_FromProto(mapCtx, in.GetTransactionKillType())
	return out
}
func PerformanceCaptureConfig_ToProto(mapCtx *direct.MapContext, in *krm.PerformanceCaptureConfig) *pb.PerformanceCaptureConfig {
	...
	out.TransactionKillThresholdSeconds = in.TransactionKillThresholdSeconds
	out.TransactionKillExcludedUserHosts = in.TransactionKillExcludedUserHosts
	if oneof := PerformanceCaptureConfig_TransactionKillType_ToProto(mapCtx, in.TransactionKillType); oneof != nil {
		out.TransactionKillType = oneof
	}
	return out
}
...
func Settings_FromProto(mapCtx *direct.MapContext, in *pb.Settings) *krm.Settings {
	...
	out.AcceleratedReplicaMode = direct.BoolValue_FromProto(mapCtx, in.GetAcceleratedReplicaMode())
...
func SettingsObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Settings) *krm.SettingsObservedState {
	...
	// MISSING: AcceleratedReplicaMode
