...
func ApplySQLInstanceGCPDefaults(in *krm.SQLInstance, out *api.DatabaseInstance, actual *api.DatabaseInstance, statefulFields map[string]*StatefulField) {
	...
	for _, field := range statefulFields {
