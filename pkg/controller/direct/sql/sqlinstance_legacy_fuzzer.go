...
func sqlInstanceLegacyFuzzer() fuzztesting.KRMFuzzer_NoProto {
	...
	f.Unimplemented_NotYetTriaged(".nodes[].psc_auto_connections[].service_connection_policy")
	f.Unimplemented_NotYetTriaged(".nodes[].psc_auto_connections[].service_connection_policy_creation_result")
	f.Unimplemented_NotYetTriaged(".nodes[].psc_auto_connections[].instance_auto_dns_status")
	f.Unimplemented_NotYetTriaged(".nodes[].psc_auto_connections[].write_endpoint_auto_dns_status")
	...
	f.Unimplemented_NotYetTriaged(".GeminiConfig")
	...
	f.Unimplemented_NotYetTriaged(".Settings.BackupConfiguration.ReplicationLogArchivingEnabled")
	...
	f.Unimplemented_NotYetTriaged(".Settings.PasswordValidationPolicy.DisallowCompromisedCredentials")
