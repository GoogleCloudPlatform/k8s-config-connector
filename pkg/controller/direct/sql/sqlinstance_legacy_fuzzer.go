...
func sqlInstanceLegacyFuzzer() fuzztesting.KRMFuzzer_NoProto {
	...
	f.SpecField(".Settings.IpConfiguration.CustomSubjectAlternativeNames")
	...
	f.SpecField(".Settings.IpConfiguration.ServerCaMode")
	f.SpecField(".Settings.IpConfiguration.ServerCaPool")
