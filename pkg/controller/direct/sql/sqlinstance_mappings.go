...
func SQLInstanceKRMToGCP(in *krm.SQLInstance, actual *api.DatabaseInstance, statefulFields map[string]*StatefulField) (*api.DatabaseInstance, error) {
	if in == nil {
	...
	// Here be dragons.
	ApplySQLInstanceGCPDefaults(in, out, actual, statefulFields)
