...
type gkeHubClient struct {
	...
	membershipBindingClient *gkehubv1.ProjectsLocationsMembershipsBindingsService
...
func (m *gcpClient) newGkeHubClient(ctx context.Context) (*gkeHubClient, error) {
	...
	return &gkeHubClient{
		...
		membershipBindingClient: gkehubv1.NewProjectsLocationsMembershipsBindingsService(v1Service),
