...
func (a *gkeHubScopeAdapter) updateStatus(ctx context.Context, op directbase.Operation) error {
	status := &krm.GKEHubScopeStatus{}
	mapCtx := &direct.MapContext{}
...
func (a *gkeHubScopeAdapter) apiToKrmObservedState(mapCtx *direct.MapContext) *krm.GKEHubScopeObservedState {
	if a.actual == nil {
		return nil
	}
	out := &krm.GKEHubScopeObservedState{}
	...
	if a.actual.State != nil {
		out.State = &krm.ScopeStateStatus{
