...
func GKEHubScopeStatus_FromAPI(mapCtx *direct.MapContext, in *gkehubapi.Scope) *krm.GKEHubScopeStatus {
	if in == nil {
		return nil
	}
...
func ScopeLifecycleStateStatus_FromAPI(mapCtx *direct.MapContext, in *gkehubapi.ScopeLifecycleState) *krm.ScopeLifecycleStateStatus {
	if in == nil {
		return nil
	}
