...
func (a *gkeHubMembershipBindingAdapter) updateStatus(ctx context.Context, op directbase.Operation) error {
	status := &krm.GKEHubMembershipBindingStatus{}
	mapCtx := &direct.MapContext{}
...
func (a *gkeHubMembershipBindingAdapter) apiToKrmObservedState(mapCtx *direct.MapContext) *krm.GKEHubMembershipBindingObservedState {
	if a.actual == nil {
		return nil
	}
	...
	if a.actual.State != nil {
		out.State = &krm.MembershipBindingStateStatus{
