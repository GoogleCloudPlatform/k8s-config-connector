...
func FloorSetting_FromProto(mapCtx *direct.MapContext, in *pb.FloorSetting) *krm.FloorSetting {
	if in == nil {
		return nil
	}
	out := &krm.FloorSetting{}
	out.Name = direct.LazyPtr(in.GetName())
	// MISSING: CreateTime
	// MISSING: UpdateTime
	out.FilterConfig = FilterConfig_FromProto(mapCtx, in.GetFilterConfig())
	out.EnableFloorSettingEnforcement = direct.LazyPtr(in.GetEnableFloorSettingEnforcement())
	return out
}
func FloorSetting_ToProto(mapCtx *direct.MapContext, in *krm.FloorSetting) *pb.FloorSetting {
	if in == nil {
		return nil
	}
	out := &pb.FloorSetting{}
	...
	out.EnableFloorSettingEnforcement = direct.ValueOf(in.EnableFloorSettingEnforcement)
	return out
}
func FloorSettingObservedState_FromProto(mapCtx *direct.MapContext, in *pb.FloorSetting) *krm.FloorSettingObservedState {
	if in == nil {
		return nil
	}
	out := &krm.FloorSettingObservedState{}
	// MISSING: Name
	out.CreateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetCreateTime())
	out.UpdateTime = direct.StringTimestamp_FromProto(mapCtx, in.GetUpdateTime())
	// MISSING: FilterConfig
	// MISSING: EnableFloorSettingEnforcement
	return out
}
func FloorSettingObservedState_ToProto(mapCtx *direct.MapContext, in *krm.FloorSettingObservedState) *pb.FloorSetting {
	if in == nil {
		return nil
	}
	out := &pb.FloorSetting{}
