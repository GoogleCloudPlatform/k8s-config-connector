...
import (
	...
	krmv1alpha1 "github.com/GoogleCloudPlatform/k8s-config-connector/apis/alloydb/v1alpha1"
	krmv1beta1 "github.com/GoogleCloudPlatform/k8s-config-connector/apis/alloydb/v1beta1"
	refsv1beta1 "github.com/GoogleCloudPlatform/k8s-config-connector/apis/refs/v1beta1"
	"github.com/GoogleCloudPlatform/k8s-config-connector/pkg/controller/direct"
)

func AlloyDBClusterObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Cluster) *krmv1alpha1.AlloyDBClusterObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.AlloyDBClusterObservedState{}
...
func AlloyDBClusterObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.AlloyDBClusterObservedState) *pb.Cluster {
	if in == nil {
		return nil
	}
	out := &pb.Cluster{}
...
func AlloyDBClusterSpec_FromProto(mapCtx *direct.MapContext, in *pb.Cluster) *krmv1alpha1.AlloyDBClusterSpec {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.AlloyDBClusterSpec{}
	// MISSING: BackupSource
	// MISSING: MigrationSource
	// MISSING: CloudsqlBackupRunSource
	// MISSING: Name
...
func AlloyDBClusterSpec_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.AlloyDBClusterSpec) *pb.Cluster {
	if in == nil {
		return nil
	}
	out := &pb.Cluster{}
...
func AutomatedBackupPolicy_FromProto(mapCtx *direct.MapContext, in *pb.AutomatedBackupPolicy) *krmv1alpha1.AutomatedBackupPolicy {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.AutomatedBackupPolicy{}
...
func AutomatedBackupPolicy_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.AutomatedBackupPolicy) *pb.AutomatedBackupPolicy {
	if in == nil {
		return nil
	}
...
func AutomatedBackupPolicy_QuantityBasedRetention_FromProto(mapCtx *direct.MapContext, in *pb.AutomatedBackupPolicy_QuantityBasedRetention) *krmv1alpha1.AutomatedBackupPolicy_QuantityBasedRetention {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.AutomatedBackupPolicy_QuantityBasedRetention{}
	out.Count = direct.LazyPtr(in.GetCount())
	return out
}
func AutomatedBackupPolicy_QuantityBasedRetention_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.AutomatedBackupPolicy_QuantityBasedRetention) *pb.AutomatedBackupPolicy_QuantityBasedRetention {
	if in == nil {
		return nil
	}
...
func AutomatedBackupPolicy_TimeBasedRetention_FromProto(mapCtx *direct.MapContext, in *pb.AutomatedBackupPolicy_TimeBasedRetention) *krmv1alpha1.AutomatedBackupPolicy_TimeBasedRetention {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.AutomatedBackupPolicy_TimeBasedRetention{}
	out.RetentionPeriod = direct.StringDuration_FromProto(mapCtx, in.GetRetentionPeriod())
	return out
}
func AutomatedBackupPolicy_TimeBasedRetention_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.AutomatedBackupPolicy_TimeBasedRetention) *pb.AutomatedBackupPolicy_TimeBasedRetention {
	if in == nil {
		return nil
	}
...
func BackupSource_FromProto(mapCtx *direct.MapContext, in *pb.BackupSource) *krmv1alpha1.BackupSource {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.BackupSource{}
	// MISSING: BackupUid
	if in.GetBackupName() != "" {
...
func BackupSource_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.BackupSource) *pb.BackupSource {
	if in == nil {
		return nil
	}
	out := &pb.BackupSource{}
...
func BackupSourceObservedState_FromProto(mapCtx *direct.MapContext, in *pb.BackupSource) *krmv1alpha1.BackupSourceObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.BackupSourceObservedState{}
	// MISSING: BackupUid
	out.BackupName = direct.LazyPtr(in.GetBackupName())
	return out
}
func BackupSourceObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.BackupSourceObservedState) *pb.BackupSource {
	if in == nil {
		return nil
	}
	out := &pb.BackupSource{}
...
func CloudSQLBackupRunSource_FromProto(mapCtx *direct.MapContext, in *pb.CloudSQLBackupRunSource) *krmv1alpha1.CloudSQLBackupRunSource {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.CloudSQLBackupRunSource{}
...
func CloudSQLBackupRunSource_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.CloudSQLBackupRunSource) *pb.CloudSQLBackupRunSource {
	if in == nil {
		return nil
	}
...
func Cluster_NetworkConfig_FromProto(mapCtx *direct.MapContext, in *pb.Cluster_NetworkConfig) *krmv1alpha1.Cluster_NetworkConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Cluster_NetworkConfig{}
	if in.GetNetwork() != "" {
		out.NetworkRef = &refsv1beta1.ComputeNetworkRef{External: in.GetNetwork()}
	}
...
func Cluster_NetworkConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Cluster_NetworkConfig) *pb.Cluster_NetworkConfig {
	if in == nil {
		return nil
	}
...
func Cluster_PSCConfig_FromProto(mapCtx *direct.MapContext, in *pb.Cluster_PscConfig) *krmv1alpha1.Cluster_PSCConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Cluster_PSCConfig{}
	out.PSCEnabled = direct.LazyPtr(in.GetPscEnabled())
	// MISSING: ServiceOwnedProjectNumber
	return out
}
func Cluster_PSCConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Cluster_PSCConfig) *pb.Cluster_PscConfig {
	if in == nil {
		return nil
	}
...
func Cluster_PSCConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Cluster_PscConfig) *krmv1alpha1.Cluster_PSCConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Cluster_PSCConfigObservedState{}
	// MISSING: PSCEnabled
	out.ServiceOwnedProjectNumber = direct.LazyPtr(in.GetServiceOwnedProjectNumber())
	return out
}
func Cluster_PSCConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Cluster_PSCConfigObservedState) *pb.Cluster_PscConfig {
	if in == nil {
		return nil
	}
	out := &pb.Cluster_PscConfig{}
...
func Cluster_PrimaryConfig_FromProto(mapCtx *direct.MapContext, in *pb.Cluster_PrimaryConfig) *krmv1alpha1.Cluster_PrimaryConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Cluster_PrimaryConfig{}
	// MISSING: SecondaryClusterNames
	return out
}
func Cluster_PrimaryConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Cluster_PrimaryConfig) *pb.Cluster_PrimaryConfig {
	if in == nil {
		return nil
	}
...
func Cluster_PrimaryConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Cluster_PrimaryConfig) *krmv1alpha1.Cluster_PrimaryConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Cluster_PrimaryConfigObservedState{}
	out.SecondaryClusterNames = in.SecondaryClusterNames
	return out
}
func Cluster_PrimaryConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Cluster_PrimaryConfigObservedState) *pb.Cluster_PrimaryConfig {
	if in == nil {
		return nil
	}
	out := &pb.Cluster_PrimaryConfig{}
...
func ContinuousBackupConfig_FromProto(mapCtx *direct.MapContext, in *pb.ContinuousBackupConfig) *krmv1alpha1.ContinuousBackupConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.ContinuousBackupConfig{}
	out.Enabled = in.Enabled
	out.RecoveryWindowDays = direct.LazyPtr(in.GetRecoveryWindowDays())
	out.EncryptionConfig = EncryptionConfig_FromProto(mapCtx, in.GetEncryptionConfig())
	return out
}
func ContinuousBackupConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.ContinuousBackupConfig) *pb.ContinuousBackupConfig {
	if in == nil {
		return nil
	}
...
func EncryptionInfo_FromProto(mapCtx *direct.MapContext, in *pb.EncryptionInfo) *krmv1alpha1.EncryptionInfo {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.EncryptionInfo{}
	// MISSING: EncryptionType
	// MISSING: KMSKeyVersions
	return out
}
func EncryptionInfo_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.EncryptionInfo) *pb.EncryptionInfo {
	if in == nil {
		return nil
	}
...
func EncryptionInfoObservedState_FromProto(mapCtx *direct.MapContext, in *pb.EncryptionInfo) *krmv1alpha1.EncryptionInfoObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.EncryptionInfoObservedState{}
	out.EncryptionType = direct.Enum_FromProto(mapCtx, in.GetEncryptionType())
	out.KMSKeyVersions = in.KmsKeyVersions
	return out
}
func EncryptionInfoObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.EncryptionInfoObservedState) *pb.EncryptionInfo {
	if in == nil {
		return nil
	}
	out := &pb.EncryptionInfo{}
...
func GcaInstanceConfig_FromProto(mapCtx *direct.MapContext, in *pb.GCAInstanceConfig) *krmv1alpha1.GcaInstanceConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.GcaInstanceConfig{}
	// MISSING: GcaEntitlement
	return out
}
func GcaInstanceConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.GcaInstanceConfig) *pb.GCAInstanceConfig {
	if in == nil {
		return nil
	}
...
func GcaInstanceConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.GCAInstanceConfig) *krmv1alpha1.GcaInstanceConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.GcaInstanceConfigObservedState{}
	out.GcaEntitlement = direct.Enum_FromProto(mapCtx, in.GetGcaEntitlement())
	return out
}
func GcaInstanceConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.GcaInstanceConfigObservedState) *pb.GCAInstanceConfig {
	if in == nil {
		return nil
	}
	out := &pb.GCAInstanceConfig{}
...
func GeminiClusterConfig_FromProto(mapCtx *direct.MapContext, in *pb.GeminiClusterConfig) *krmv1alpha1.GeminiClusterConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.GeminiClusterConfig{}
	// MISSING: Entitled
	return out
}
func GeminiClusterConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.GeminiClusterConfig) *pb.GeminiClusterConfig {
	if in == nil {
		return nil
	}
...
func GeminiClusterConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.GeminiClusterConfig) *krmv1alpha1.GeminiClusterConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.GeminiClusterConfigObservedState{}
	out.Entitled = direct.LazyPtr(in.GetEntitled())
	return out
}
func GeminiClusterConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.GeminiClusterConfigObservedState) *pb.GeminiClusterConfig {
	if in == nil {
		return nil
	}
	out := &pb.GeminiClusterConfig{}
...
func GeminiInstanceConfig_FromProto(mapCtx *direct.MapContext, in *pb.GeminiInstanceConfig) *krmv1alpha1.GeminiInstanceConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.GeminiInstanceConfig{}
	// MISSING: Entitled
	return out
}
func GeminiInstanceConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.GeminiInstanceConfig) *pb.GeminiInstanceConfig {
	if in == nil {
		return nil
	}
...
func GeminiInstanceConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.GeminiInstanceConfig) *krmv1alpha1.GeminiInstanceConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.GeminiInstanceConfigObservedState{}
	out.Entitled = direct.LazyPtr(in.GetEntitled())
	return out
}
func GeminiInstanceConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.GeminiInstanceConfigObservedState) *pb.GeminiInstanceConfig {
	if in == nil {
		return nil
	}
	out := &pb.GeminiInstanceConfig{}
...
func Instance_ClientConnectionConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_ClientConnectionConfig) *krmv1alpha1.Instance_ClientConnectionConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_ClientConnectionConfig{}
	out.RequireConnectors = direct.LazyPtr(in.GetRequireConnectors())
	out.SSLConfig = SSLConfig_FromProto(mapCtx, in.GetSslConfig())
	return out
}
func Instance_ClientConnectionConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_ClientConnectionConfig) *pb.Instance_ClientConnectionConfig {
	if in == nil {
		return nil
	}
...
func Instance_InstanceNetworkConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_InstanceNetworkConfig) *krmv1alpha1.Instance_InstanceNetworkConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_InstanceNetworkConfig{}
...
func Instance_InstanceNetworkConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_InstanceNetworkConfig) *pb.Instance_InstanceNetworkConfig {
	if in == nil {
		return nil
	}
...
func Instance_InstanceNetworkConfig_AuthorizedNetwork_FromProto(mapCtx *direct.MapContext, in *pb.Instance_InstanceNetworkConfig_AuthorizedNetwork) *krmv1alpha1.Instance_InstanceNetworkConfig_AuthorizedNetwork {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_InstanceNetworkConfig_AuthorizedNetwork{}
	out.CIDRRange = direct.LazyPtr(in.GetCidrRange())
	return out
}
func Instance_InstanceNetworkConfig_AuthorizedNetwork_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_InstanceNetworkConfig_AuthorizedNetwork) *pb.Instance_InstanceNetworkConfig_AuthorizedNetwork {
	if in == nil {
		return nil
	}
...
func Instance_MachineConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_MachineConfig) *krmv1alpha1.Instance_MachineConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_MachineConfig{}
	out.CPUCount = direct.LazyPtr(in.GetCpuCount())
	out.MachineType = direct.LazyPtr(in.GetMachineType())
	return out
}
func Instance_MachineConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_MachineConfig) *pb.Instance_MachineConfig {
	if in == nil {
		return nil
	}
...
func Instance_Node_FromProto(mapCtx *direct.MapContext, in *pb.Instance_Node) *krmv1alpha1.Instance_Node {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_Node{}
	// MISSING: ZoneID
	// MISSING: ID
	// MISSING: IP
	// MISSING: State
...
func Instance_Node_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_Node) *pb.Instance_Node {
	if in == nil {
		return nil
	}
...
func Instance_NodeObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Instance_Node) *krmv1alpha1.Instance_NodeObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_NodeObservedState{}
...
func Instance_NodeObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_NodeObservedState) *pb.Instance_Node {
	if in == nil {
		return nil
	}
	out := &pb.Instance_Node{}
...
func Instance_ObservabilityInstanceConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_ObservabilityInstanceConfig) *krmv1alpha1.Instance_ObservabilityInstanceConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_ObservabilityInstanceConfig{}
	out.Enabled = in.Enabled
...
func Instance_ObservabilityInstanceConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_ObservabilityInstanceConfig) *pb.Instance_ObservabilityInstanceConfig {
	if in == nil {
		return nil
	}
...
func Instance_ObservabilityInstanceConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Instance_ObservabilityInstanceConfig) *krmv1alpha1.Instance_ObservabilityInstanceConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_ObservabilityInstanceConfigObservedState{}
	// MISSING: Enabled
...
func Instance_ObservabilityInstanceConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_ObservabilityInstanceConfigObservedState) *pb.Instance_ObservabilityInstanceConfig {
	if in == nil {
		return nil
	}
	out := &pb.Instance_ObservabilityInstanceConfig{}
...
func Instance_PSCAutoConnectionConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_PscAutoConnectionConfig) *krmv1alpha1.Instance_PSCAutoConnectionConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_PSCAutoConnectionConfig{}
...
func Instance_PSCAutoConnectionConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_PSCAutoConnectionConfig) *pb.Instance_PscAutoConnectionConfig {
	if in == nil {
		return nil
	}
...
func Instance_PSCAutoConnectionConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Instance_PscAutoConnectionConfig) *krmv1alpha1.Instance_PSCAutoConnectionConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_PSCAutoConnectionConfigObservedState{}
...
func Instance_PSCAutoConnectionConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_PSCAutoConnectionConfigObservedState) *pb.Instance_PscAutoConnectionConfig {
	if in == nil {
		return nil
	}
	out := &pb.Instance_PscAutoConnectionConfig{}
...
func Instance_PSCInstanceConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_PscInstanceConfig) *krmv1alpha1.Instance_PSCInstanceConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_PSCInstanceConfig{}
...
func Instance_PSCInstanceConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_PSCInstanceConfig) *pb.Instance_PscInstanceConfig {
	if in == nil {
		return nil
	}
...
func Instance_PSCInstanceConfigObservedState_FromProto(mapCtx *direct.MapContext, in *pb.Instance_PscInstanceConfig) *krmv1alpha1.Instance_PSCInstanceConfigObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_PSCInstanceConfigObservedState{}
...
func Instance_PSCInstanceConfigObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_PSCInstanceConfigObservedState) *pb.Instance_PscInstanceConfig {
	if in == nil {
		return nil
	}
	out := &pb.Instance_PscInstanceConfig{}
...
func Instance_PSCInterfaceConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_PscInterfaceConfig) *krmv1alpha1.Instance_PSCInterfaceConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_PSCInterfaceConfig{}
	out.NetworkAttachmentResource = direct.LazyPtr(in.GetNetworkAttachmentResource())
	return out
}
func Instance_PSCInterfaceConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_PSCInterfaceConfig) *pb.Instance_PscInterfaceConfig {
	if in == nil {
		return nil
	}
...
func Instance_QueryInsightsInstanceConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_QueryInsightsInstanceConfig) *krmv1alpha1.Instance_QueryInsightsInstanceConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_QueryInsightsInstanceConfig{}
	out.RecordApplicationTags = in.RecordApplicationTags
...
func Instance_QueryInsightsInstanceConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_QueryInsightsInstanceConfig) *pb.Instance_QueryInsightsInstanceConfig {
	if in == nil {
		return nil
	}
...
func Instance_ReadPoolConfig_FromProto(mapCtx *direct.MapContext, in *pb.Instance_ReadPoolConfig) *krmv1alpha1.Instance_ReadPoolConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_ReadPoolConfig{}
	out.NodeCount = direct.LazyPtr(in.GetNodeCount())
	return out
}
func Instance_ReadPoolConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_ReadPoolConfig) *pb.Instance_ReadPoolConfig {
	if in == nil {
		return nil
	}
...
func Instance_UpdatePolicy_FromProto(mapCtx *direct.MapContext, in *pb.Instance_UpdatePolicy) *krmv1alpha1.Instance_UpdatePolicy {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.Instance_UpdatePolicy{}
	out.Mode = direct.Enum_FromProto(mapCtx, in.GetMode())
	return out
}
func Instance_UpdatePolicy_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.Instance_UpdatePolicy) *pb.Instance_UpdatePolicy {
	if in == nil {
		return nil
	}
...
func MaintenanceSchedule_FromProto(mapCtx *direct.MapContext, in *pb.MaintenanceSchedule) *krmv1alpha1.MaintenanceSchedule {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.MaintenanceSchedule{}
	// MISSING: StartTime
	return out
}
func MaintenanceSchedule_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.MaintenanceSchedule) *pb.MaintenanceSchedule {
	if in == nil {
		return nil
	}
...
func MaintenanceScheduleObservedState_FromProto(mapCtx *direct.MapContext, in *pb.MaintenanceSchedule) *krmv1alpha1.MaintenanceScheduleObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.MaintenanceScheduleObservedState{}
	out.StartTime = direct.StringTimestamp_FromProto(mapCtx, in.GetStartTime())
	return out
}
func MaintenanceScheduleObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.MaintenanceScheduleObservedState) *pb.MaintenanceSchedule {
	if in == nil {
		return nil
	}
	out := &pb.MaintenanceSchedule{}
...
func MaintenanceUpdatePolicy_FromProto(mapCtx *direct.MapContext, in *pb.MaintenanceUpdatePolicy) *krmv1alpha1.MaintenanceUpdatePolicy {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.MaintenanceUpdatePolicy{}
...
func MaintenanceUpdatePolicy_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.MaintenanceUpdatePolicy) *pb.MaintenanceUpdatePolicy {
	if in == nil {
		return nil
	}
...
func MigrationSourceObservedState_FromProto(mapCtx *direct.MapContext, in *pb.MigrationSource) *krmv1alpha1.MigrationSourceObservedState {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.MigrationSourceObservedState{}
...
func MigrationSourceObservedState_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.MigrationSourceObservedState) *pb.MigrationSource {
	if in == nil {
		return nil
	}
...
func SSLConfig_FromProto(mapCtx *direct.MapContext, in *pb.SslConfig) *krmv1alpha1.SSLConfig {
	if in == nil {
		return nil
	}
	out := &krmv1alpha1.SSLConfig{}
	out.SSLMode = direct.Enum_FromProto(mapCtx, in.GetSslMode())
	out.CASource = direct.Enum_FromProto(mapCtx, in.GetCaSource())
	return out
}
func SSLConfig_ToProto(mapCtx *direct.MapContext, in *krmv1alpha1.SSLConfig) *pb.SslConfig {
	if in == nil {
		return nil
	}
	out := &pb.SslConfig{}
