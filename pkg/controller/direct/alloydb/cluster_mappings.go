...
func UserPasswordObservedState_FromProto(mapCtx *direct.MapContext, in *pb.UserPassword) *krm.UserPasswordObservedState {
	// UserPasswordObservedState is unreadable.
	return nil
}
func UserPasswordObservedState_ToProto(mapCtx *direct.MapContext, in *krm.UserPasswordObservedState) *pb.UserPassword {
	if in == nil {
		return nil
	}
	out := &pb.UserPassword{}
...
func UserPasswordObservedState_Password_ToProto(mapCtx *direct.MapContext, in *refsv1beta1secret.LegacyObservedState) string {
	if in == nil {
		return ""
	}
	return direct.ValueOf(in.Value)
