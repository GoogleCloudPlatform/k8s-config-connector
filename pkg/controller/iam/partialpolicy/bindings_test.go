...
func TestComputePartialPolicyWithMergedBindings(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			res, err := partialpolicy.ComputePartialPolicyWithMergedBindings(tc.partialPolicy, tc.livePolicy, &resolver)
			if err != nil {
...
func TestComputePartialPolicyWithRemainingBindings(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			t.Parallel()
			res := partialpolicy.ComputePartialPolicyWithRemainingBindings(tc.partialPolicy, tc.livePolicy)
