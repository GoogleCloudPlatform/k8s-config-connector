...
func TestRegisteredTemplatesMatchCAI(t *testing.T) {
	...
	ignoredTemplates := map[string]bool{
		...
		"//networksecurity.googleapis.com/organizations/{}/locations/{}/interceptDeployments/{}":               true,
		"//networksecurity.googleapis.com/organizations/{}/locations/{}/interceptEndpointGroups/{}":            true,
		"//networksecurity.googleapis.com/organizations/{}/locations/{}/interceptEndpointGroupAssociations/{}": true,
