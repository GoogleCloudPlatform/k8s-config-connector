...
func (cp *Provisioner) inject(cc *admissionregistrationv1beta1.WebhookClientConfig, objs []client.Object) error {
	if cc == nil {
		return nil
	}
	for i := range objs {
		...
		case *admissionregistrationv1beta1.MutatingWebhookConfiguration:
			injectForEachMutatingWebhook(cc, typed.Webhooks)
		case *admissionregistrationv1beta1.ValidatingWebhookConfiguration:
			injectForEachValidatingWebhook(cc, typed.Webhooks)
		default:
...
func injectForEachValidatingWebhook(
...
func injectForEachMutatingWebhook(
	cc *admissionregistrationv1beta1.WebhookClientConfig,
