...
func NewContainerAnnotationDefaulter(client client.Client, smLoader *servicemappingloader.ServiceMappingLoader, dclSchemaLoader dclschemaloader.DCLSchemaLoader, serviceMetadataLoader dclmetadata.ServiceMetadataLoader) k8s.Defaulter {
...
func (a *containerAnnotationHandler) Handle(ctx context.Context, req admission.Request) admission.Response {
	...
	changed, err := a.defaulter.ApplyDefaults(ctx, obj)
	if err != nil {
...
func (a *containerAnnotationDefaulter) ApplyDefaults(ctx context.Context, o client.Object) (bool, error) {
