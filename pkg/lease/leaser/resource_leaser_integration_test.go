...
func TestObtainAndReleaseResourceLease(t *testing.T) {
	...
	testFunc := func(t *testing.T, testContext testrunner.TestContext, systemContext testrunner.SystemContext) {
		...
		if err := systemContext.Manager.GetClient().Create(context.TODO(), u); err != nil {
		...
		if err := resourceLeaser.SoftObtain(context.TODO(), &krmResource1.Resource, liveLabels1); err != nil {
		...
		if err := resourceLeaser.SoftObtain(context.TODO(), &krmResource2.Resource, liveLabels2); err == nil {
		...
		if err := resourceLeaser.Release(context.TODO(), u); err != nil {
