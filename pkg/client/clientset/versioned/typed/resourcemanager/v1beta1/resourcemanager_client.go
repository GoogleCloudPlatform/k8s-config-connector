...
type ResourcemanagerV1beta1Interface interface {
	RESTClient() rest.Interface
	FoldersGetter
	ProjectsGetter
	ResourceManagerLiensGetter
	ResourceManagerPoliciesGetter
}
...
func (c *ResourcemanagerV1beta1Client) ResourceManagerPolicies(namespace string) ResourceManagerPolicyInterface {
	return newResourceManagerPolicies(c, namespace)
}
...
func NewForConfig(c *rest.Config) (*ResourcemanagerV1beta1Client, error) {
	...
	return &ResourcemanagerV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new ResourcemanagerV1beta1Client for the given config and
...
func New(c rest.Interface) *ResourcemanagerV1beta1Client {
	return &ResourcemanagerV1beta1Client{c}
}
