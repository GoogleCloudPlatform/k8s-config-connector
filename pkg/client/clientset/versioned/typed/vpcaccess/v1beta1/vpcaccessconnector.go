...
import (
	...
	v1beta1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/apis/vpcaccess/v1beta1"
...
func (c *vPCAccessConnectors) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VPCAccessConnector, err error) {
	result = &v1beta1.VPCAccessConnector{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vPCAccessConnectors) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VPCAccessConnectorList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.VPCAccessConnectorList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vpcaccessconnectors").
...
func (c *vPCAccessConnectors) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *vPCAccessConnectors) Create(ctx context.Context, vPCAccessConnector *v1beta1.VPCAccessConnector, opts v1.CreateOptions) (result *v1beta1.VPCAccessConnector, err error) {
	result = &v1beta1.VPCAccessConnector{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vpcaccessconnectors").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vPCAccessConnector).
		Do(ctx).
		Into(result)
	return
}
...
func (c *vPCAccessConnectors) Update(ctx context.Context, vPCAccessConnector *v1beta1.VPCAccessConnector, opts v1.UpdateOptions) (result *v1beta1.VPCAccessConnector, err error) {
	result = &v1beta1.VPCAccessConnector{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcaccessconnectors").
		Name(vPCAccessConnector.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(vPCAccessConnector).
		Do(ctx).
		Into(result)
...
func (c *vPCAccessConnectors) UpdateStatus(ctx context.Context, vPCAccessConnector *v1beta1.VPCAccessConnector, opts v1.UpdateOptions) (result *v1beta1.VPCAccessConnector, err error) {
	result = &v1beta1.VPCAccessConnector{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vpcaccessconnectors").
...
func (c *vPCAccessConnectors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *vPCAccessConnectors) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *vPCAccessConnectors) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VPCAccessConnector, err error) {
	result = &v1beta1.VPCAccessConnector{}
