...
// LoggingLogMetricsGetter has a method to return a LoggingLogMetricInterface.
...
// loggingLogMetrics implements LoggingLogMetricInterface
type loggingLogMetrics struct {
	client rest.Interface
	ns     string
}

// newLoggingLogMetrics returns a LoggingLogMetrics
func newLoggingLogMetrics(c *LoggingV1beta1Client, namespace string) *loggingLogMetrics {
...
func (c *loggingLogMetrics) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.LoggingLogMetric, err error) {
	result = &v1beta1.LoggingLogMetric{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logginglogmetrics").
		Name(name).
...
func (c *loggingLogMetrics) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.LoggingLogMetricList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.LoggingLogMetricList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logginglogmetrics").
...
func (c *loggingLogMetrics) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingLogMetrics) Create(ctx context.Context, loggingLogMetric *v1beta1.LoggingLogMetric, opts v1.CreateOptions) (result *v1beta1.LoggingLogMetric, err error) {
	result = &v1beta1.LoggingLogMetric{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logginglogmetrics").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(loggingLogMetric).
		Do(ctx).
		Into(result)
	return
}
...
func (c *loggingLogMetrics) Update(ctx context.Context, loggingLogMetric *v1beta1.LoggingLogMetric, opts v1.UpdateOptions) (result *v1beta1.LoggingLogMetric, err error) {
	result = &v1beta1.LoggingLogMetric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logginglogmetrics").
		Name(loggingLogMetric.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(loggingLogMetric).
		Do(ctx).
		Into(result)
...
func (c *loggingLogMetrics) UpdateStatus(ctx context.Context, loggingLogMetric *v1beta1.LoggingLogMetric, opts v1.UpdateOptions) (result *v1beta1.LoggingLogMetric, err error) {
	result = &v1beta1.LoggingLogMetric{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logginglogmetrics").
...
func (c *loggingLogMetrics) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *loggingLogMetrics) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *loggingLogMetrics) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.LoggingLogMetric, err error) {
	result = &v1beta1.LoggingLogMetric{}
