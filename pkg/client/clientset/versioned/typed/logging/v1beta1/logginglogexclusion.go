...
func (c *loggingLogExclusions) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.LoggingLogExclusion, err error) {
	result = &v1beta1.LoggingLogExclusion{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logginglogexclusions").
		Name(name).
...
func (c *loggingLogExclusions) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.LoggingLogExclusionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.LoggingLogExclusionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("logginglogexclusions").
...
func (c *loggingLogExclusions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *loggingLogExclusions) Create(ctx context.Context, loggingLogExclusion *v1beta1.LoggingLogExclusion, opts v1.CreateOptions) (result *v1beta1.LoggingLogExclusion, err error) {
	result = &v1beta1.LoggingLogExclusion{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("logginglogexclusions").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(loggingLogExclusion).
		Do(ctx).
		Into(result)
	return
}
...
func (c *loggingLogExclusions) Update(ctx context.Context, loggingLogExclusion *v1beta1.LoggingLogExclusion, opts v1.UpdateOptions) (result *v1beta1.LoggingLogExclusion, err error) {
	result = &v1beta1.LoggingLogExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logginglogexclusions").
		Name(loggingLogExclusion.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(loggingLogExclusion).
		Do(ctx).
		Into(result)
...
func (c *loggingLogExclusions) UpdateStatus(ctx context.Context, loggingLogExclusion *v1beta1.LoggingLogExclusion, opts v1.UpdateOptions) (result *v1beta1.LoggingLogExclusion, err error) {
	result = &v1beta1.LoggingLogExclusion{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("logginglogexclusions").
...
func (c *loggingLogExclusions) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *loggingLogExclusions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *loggingLogExclusions) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.LoggingLogExclusion, err error) {
	result = &v1beta1.LoggingLogExclusion{}
