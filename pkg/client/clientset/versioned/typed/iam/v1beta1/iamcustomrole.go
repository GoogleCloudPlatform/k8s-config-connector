...
func newIAMCustomRoles(c *IamV1beta1Client, namespace string) *iAMCustomRoles {
...
func (c *iAMCustomRoles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.IAMCustomRole, err error) {
	result = &v1beta1.IAMCustomRole{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *iAMCustomRoles) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.IAMCustomRoleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.IAMCustomRoleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iamcustomroles").
...
func (c *iAMCustomRoles) Create(ctx context.Context, iAMCustomRole *v1beta1.IAMCustomRole, opts v1.CreateOptions) (result *v1beta1.IAMCustomRole, err error) {
	result = &v1beta1.IAMCustomRole{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iamcustomroles").
...
func (c *iAMCustomRoles) Update(ctx context.Context, iAMCustomRole *v1beta1.IAMCustomRole, opts v1.UpdateOptions) (result *v1beta1.IAMCustomRole, err error) {
	result = &v1beta1.IAMCustomRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamcustomroles").
...
func (c *iAMCustomRoles) UpdateStatus(ctx context.Context, iAMCustomRole *v1beta1.IAMCustomRole, opts v1.UpdateOptions) (result *v1beta1.IAMCustomRole, err error) {
	result = &v1beta1.IAMCustomRole{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iamcustomroles").
...
func (c *iAMCustomRoles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.IAMCustomRole, err error) {
	result = &v1beta1.IAMCustomRole{}
