...
var networkservicesgrpcroutesResource = schema.GroupVersionResource{Group: "networkservices.cnrm.cloud.google.com", Version: "v1beta1", Resource: "networkservicesgrpcroutes"}

var networkservicesgrpcroutesKind = schema.GroupVersionKind{Group: "networkservices.cnrm.cloud.google.com", Version: "v1beta1", Kind: "NetworkServicesGRPCRoute"}
...
func (c *FakeNetworkServicesGRPCRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(networkservicesgrpcroutesResource, c.ns, name), &v1beta1.NetworkServicesGRPCRoute{})
