...
var networkservicesgatewaysResource = schema.GroupVersionResource{Group: "networkservices.cnrm.cloud.google.com", Version: "v1beta1", Resource: "networkservicesgateways"}

var networkservicesgatewaysKind = schema.GroupVersionKind{Group: "networkservices.cnrm.cloud.google.com", Version: "v1beta1", Kind: "NetworkServicesGateway"}
...
func (c *FakeNetworkServicesGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(networkservicesgatewaysResource, c.ns, name), &v1beta1.NetworkServicesGateway{})
