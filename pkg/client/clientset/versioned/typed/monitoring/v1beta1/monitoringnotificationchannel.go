...
func (c *monitoringNotificationChannels) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.MonitoringNotificationChannel, err error) {
	result = &v1beta1.MonitoringNotificationChannel{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
		Name(name).
...
func (c *monitoringNotificationChannels) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.MonitoringNotificationChannelList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.MonitoringNotificationChannelList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
...
func (c *monitoringNotificationChannels) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *monitoringNotificationChannels) Create(ctx context.Context, monitoringNotificationChannel *v1beta1.MonitoringNotificationChannel, opts v1.CreateOptions) (result *v1beta1.MonitoringNotificationChannel, err error) {
	result = &v1beta1.MonitoringNotificationChannel{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(monitoringNotificationChannel).
		Do(ctx).
		Into(result)
	return
}
...
func (c *monitoringNotificationChannels) Update(ctx context.Context, monitoringNotificationChannel *v1beta1.MonitoringNotificationChannel, opts v1.UpdateOptions) (result *v1beta1.MonitoringNotificationChannel, err error) {
	result = &v1beta1.MonitoringNotificationChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
		Name(monitoringNotificationChannel.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(monitoringNotificationChannel).
		Do(ctx).
		Into(result)
...
func (c *monitoringNotificationChannels) UpdateStatus(ctx context.Context, monitoringNotificationChannel *v1beta1.MonitoringNotificationChannel, opts v1.UpdateOptions) (result *v1beta1.MonitoringNotificationChannel, err error) {
	result = &v1beta1.MonitoringNotificationChannel{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringnotificationchannels").
...
func (c *monitoringNotificationChannels) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *monitoringNotificationChannels) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *monitoringNotificationChannels) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.MonitoringNotificationChannel, err error) {
	result = &v1beta1.MonitoringNotificationChannel{}
