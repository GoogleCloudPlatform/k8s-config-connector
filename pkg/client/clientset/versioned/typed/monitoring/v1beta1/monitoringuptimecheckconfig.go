...
func (c *monitoringUptimeCheckConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.MonitoringUptimeCheckConfig, err error) {
	result = &v1beta1.MonitoringUptimeCheckConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *monitoringUptimeCheckConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.MonitoringUptimeCheckConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.MonitoringUptimeCheckConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("monitoringuptimecheckconfigs").
...
func (c *monitoringUptimeCheckConfigs) Create(ctx context.Context, monitoringUptimeCheckConfig *v1beta1.MonitoringUptimeCheckConfig, opts v1.CreateOptions) (result *v1beta1.MonitoringUptimeCheckConfig, err error) {
	result = &v1beta1.MonitoringUptimeCheckConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("monitoringuptimecheckconfigs").
...
func (c *monitoringUptimeCheckConfigs) Update(ctx context.Context, monitoringUptimeCheckConfig *v1beta1.MonitoringUptimeCheckConfig, opts v1.UpdateOptions) (result *v1beta1.MonitoringUptimeCheckConfig, err error) {
	result = &v1beta1.MonitoringUptimeCheckConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringuptimecheckconfigs").
...
func (c *monitoringUptimeCheckConfigs) UpdateStatus(ctx context.Context, monitoringUptimeCheckConfig *v1beta1.MonitoringUptimeCheckConfig, opts v1.UpdateOptions) (result *v1beta1.MonitoringUptimeCheckConfig, err error) {
	result = &v1beta1.MonitoringUptimeCheckConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("monitoringuptimecheckconfigs").
...
func (c *monitoringUptimeCheckConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.MonitoringUptimeCheckConfig, err error) {
	result = &v1beta1.MonitoringUptimeCheckConfig{}
