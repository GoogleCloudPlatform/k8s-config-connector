...
import (
	...
	v1beta1 "github.com/GoogleCloudPlatform/k8s-config-connector/pkg/apis/binaryauthorization/v1beta1"
...
var binaryauthorizationattestorsResource = schema.GroupVersionResource{Group: "binaryauthorization.cnrm.cloud.google.com", Version: "v1beta1", Resource: "binaryauthorizationattestors"}

var binaryauthorizationattestorsKind = schema.GroupVersionKind{Group: "binaryauthorization.cnrm.cloud.google.com", Version: "v1beta1", Kind: "BinaryAuthorizationAttestor"}
...
func (c *FakeBinaryAuthorizationAttestors) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(binaryauthorizationattestorsResource, c.ns, name), &v1beta1.BinaryAuthorizationAttestor{})
