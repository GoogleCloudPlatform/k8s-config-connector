...
func (c *PubsubV1beta1Client) PubSubTopics(namespace string) PubSubTopicInterface {
...
func NewForConfig(c *rest.Config) (*PubsubV1beta1Client, error) {
	...
	return &PubsubV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new PubsubV1beta1Client for the given config and
...
func New(c rest.Interface) *PubsubV1beta1Client {
	return &PubsubV1beta1Client{c}
}
