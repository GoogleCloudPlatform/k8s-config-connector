...
// ComputeExternalVPNGatewaysGetter has a method to return a ComputeExternalVPNGatewayInterface.
...
// computeExternalVPNGateways implements ComputeExternalVPNGatewayInterface
type computeExternalVPNGateways struct {
	client rest.Interface
	ns     string
}

// newComputeExternalVPNGateways returns a ComputeExternalVPNGateways
func newComputeExternalVPNGateways(c *ComputeV1beta1Client, namespace string) *computeExternalVPNGateways {
	return &computeExternalVPNGateways{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *computeExternalVPNGateways) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeExternalVPNGateway, err error) {
	result = &v1beta1.ComputeExternalVPNGateway{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeExternalVPNGateways) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeExternalVPNGatewayList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeExternalVPNGatewayList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computeexternalvpngateways").
...
func (c *computeExternalVPNGateways) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeExternalVPNGateways) Create(ctx context.Context, computeExternalVPNGateway *v1beta1.ComputeExternalVPNGateway, opts v1.CreateOptions) (result *v1beta1.ComputeExternalVPNGateway, err error) {
	result = &v1beta1.ComputeExternalVPNGateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computeexternalvpngateways").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(computeExternalVPNGateway).
		Do(ctx).
		Into(result)
	return
}
...
func (c *computeExternalVPNGateways) Update(ctx context.Context, computeExternalVPNGateway *v1beta1.ComputeExternalVPNGateway, opts v1.UpdateOptions) (result *v1beta1.ComputeExternalVPNGateway, err error) {
	result = &v1beta1.ComputeExternalVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeexternalvpngateways").
...
func (c *computeExternalVPNGateways) UpdateStatus(ctx context.Context, computeExternalVPNGateway *v1beta1.ComputeExternalVPNGateway, opts v1.UpdateOptions) (result *v1beta1.ComputeExternalVPNGateway, err error) {
	result = &v1beta1.ComputeExternalVPNGateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computeexternalvpngateways").
...
func (c *computeExternalVPNGateways) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeExternalVPNGateways) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeExternalVPNGateways) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeExternalVPNGateway, err error) {
	result = &v1beta1.ComputeExternalVPNGateway{}
