...
var computeroutesResource = schema.GroupVersionResource{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Resource: "computeroutes"}

var computeroutesKind = schema.GroupVersionKind{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Kind: "ComputeRoute"}
...
func (c *FakeComputeRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(computeroutesResource, c.ns, name), &v1beta1.ComputeRoute{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.ComputeRoute), err
}
...
func (c *FakeComputeRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeRouteList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(computeroutesResource, computeroutesKind, c.ns, opts), &v1beta1.ComputeRouteList{})
	...
	list := &v1beta1.ComputeRouteList{ListMeta: obj.(*v1beta1.ComputeRouteList).ListMeta}
	for _, item := range obj.(*v1beta1.ComputeRouteList).Items {
...
func (c *FakeComputeRoutes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeComputeRoutes) Create(ctx context.Context, computeRoute *v1beta1.ComputeRoute, opts v1.CreateOptions) (result *v1beta1.ComputeRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(computeroutesResource, c.ns, computeRoute), &v1beta1.ComputeRoute{})
...
func (c *FakeComputeRoutes) Update(ctx context.Context, computeRoute *v1beta1.ComputeRoute, opts v1.UpdateOptions) (result *v1beta1.ComputeRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(computeroutesResource, c.ns, computeRoute), &v1beta1.ComputeRoute{})
...
func (c *FakeComputeRoutes) UpdateStatus(ctx context.Context, computeRoute *v1beta1.ComputeRoute, opts v1.UpdateOptions) (*v1beta1.ComputeRoute, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(computeroutesResource, "status", c.ns, computeRoute), &v1beta1.ComputeRoute{})
...
func (c *FakeComputeRoutes) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(computeroutesResource, c.ns, name), &v1beta1.ComputeRoute{})
...
func (c *FakeComputeRoutes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(computeroutesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.ComputeRouteList{})
	return err
}
...
func (c *FakeComputeRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeRoute, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(computeroutesResource, c.ns, name, pt, data, subresources...), &v1beta1.ComputeRoute{})
