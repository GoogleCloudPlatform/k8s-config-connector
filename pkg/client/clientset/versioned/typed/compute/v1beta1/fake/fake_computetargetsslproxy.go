...
var computetargetsslproxiesResource = schema.GroupVersionResource{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Resource: "computetargetsslproxies"}

var computetargetsslproxiesKind = schema.GroupVersionKind{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Kind: "ComputeTargetSSLProxy"}
...
func (c *FakeComputeTargetSSLProxies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeTargetSSLProxy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(computetargetsslproxiesResource, c.ns, name), &v1beta1.ComputeTargetSSLProxy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.ComputeTargetSSLProxy), err
}

// List takes label and field selectors, and returns the list of ComputeTargetSSLProxies that match those selectors.
func (c *FakeComputeTargetSSLProxies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeTargetSSLProxyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(computetargetsslproxiesResource, computetargetsslproxiesKind, c.ns, opts), &v1beta1.ComputeTargetSSLProxyList{})
	...
	list := &v1beta1.ComputeTargetSSLProxyList{ListMeta: obj.(*v1beta1.ComputeTargetSSLProxyList).ListMeta}
	for _, item := range obj.(*v1beta1.ComputeTargetSSLProxyList).Items {
...
func (c *FakeComputeTargetSSLProxies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeComputeTargetSSLProxies) Create(ctx context.Context, computeTargetSSLProxy *v1beta1.ComputeTargetSSLProxy, opts v1.CreateOptions) (result *v1beta1.ComputeTargetSSLProxy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(computetargetsslproxiesResource, c.ns, computeTargetSSLProxy), &v1beta1.ComputeTargetSSLProxy{})
...
func (c *FakeComputeTargetSSLProxies) Update(ctx context.Context, computeTargetSSLProxy *v1beta1.ComputeTargetSSLProxy, opts v1.UpdateOptions) (result *v1beta1.ComputeTargetSSLProxy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(computetargetsslproxiesResource, c.ns, computeTargetSSLProxy), &v1beta1.ComputeTargetSSLProxy{})
...
func (c *FakeComputeTargetSSLProxies) UpdateStatus(ctx context.Context, computeTargetSSLProxy *v1beta1.ComputeTargetSSLProxy, opts v1.UpdateOptions) (*v1beta1.ComputeTargetSSLProxy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(computetargetsslproxiesResource, "status", c.ns, computeTargetSSLProxy), &v1beta1.ComputeTargetSSLProxy{})
...
func (c *FakeComputeTargetSSLProxies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(computetargetsslproxiesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.ComputeTargetSSLProxyList{})
	return err
}
...
func (c *FakeComputeTargetSSLProxies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeTargetSSLProxy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(computetargetsslproxiesResource, c.ns, name, pt, data, subresources...), &v1beta1.ComputeTargetSSLProxy{})
