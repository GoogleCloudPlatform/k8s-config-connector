...
var computebackendbucketsResource = schema.GroupVersionResource{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Resource: "computebackendbuckets"}

var computebackendbucketsKind = schema.GroupVersionKind{Group: "compute.cnrm.cloud.google.com", Version: "v1beta1", Kind: "ComputeBackendBucket"}
...
func (c *FakeComputeBackendBuckets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeBackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(computebackendbucketsResource, c.ns, name), &v1beta1.ComputeBackendBucket{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1beta1.ComputeBackendBucket), err
}

// List takes label and field selectors, and returns the list of ComputeBackendBuckets that match those selectors.
func (c *FakeComputeBackendBuckets) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeBackendBucketList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(computebackendbucketsResource, computebackendbucketsKind, c.ns, opts), &v1beta1.ComputeBackendBucketList{})
	...
	list := &v1beta1.ComputeBackendBucketList{ListMeta: obj.(*v1beta1.ComputeBackendBucketList).ListMeta}
	for _, item := range obj.(*v1beta1.ComputeBackendBucketList).Items {
...
func (c *FakeComputeBackendBuckets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeComputeBackendBuckets) Create(ctx context.Context, computeBackendBucket *v1beta1.ComputeBackendBucket, opts v1.CreateOptions) (result *v1beta1.ComputeBackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(computebackendbucketsResource, c.ns, computeBackendBucket), &v1beta1.ComputeBackendBucket{})
...
func (c *FakeComputeBackendBuckets) Update(ctx context.Context, computeBackendBucket *v1beta1.ComputeBackendBucket, opts v1.UpdateOptions) (result *v1beta1.ComputeBackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(computebackendbucketsResource, c.ns, computeBackendBucket), &v1beta1.ComputeBackendBucket{})
...
func (c *FakeComputeBackendBuckets) UpdateStatus(ctx context.Context, computeBackendBucket *v1beta1.ComputeBackendBucket, opts v1.UpdateOptions) (*v1beta1.ComputeBackendBucket, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(computebackendbucketsResource, "status", c.ns, computeBackendBucket), &v1beta1.ComputeBackendBucket{})
...
func (c *FakeComputeBackendBuckets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(computebackendbucketsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1beta1.ComputeBackendBucketList{})
	return err
}
...
func (c *FakeComputeBackendBuckets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeBackendBucket, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(computebackendbucketsResource, c.ns, name, pt, data, subresources...), &v1beta1.ComputeBackendBucket{})
