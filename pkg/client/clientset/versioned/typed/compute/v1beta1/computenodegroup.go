...
func newComputeNodeGroups(c *ComputeV1beta1Client, namespace string) *computeNodeGroups {
...
func (c *computeNodeGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ComputeNodeGroup, err error) {
	result = &v1beta1.ComputeNodeGroup{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *computeNodeGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ComputeNodeGroupList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ComputeNodeGroupList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("computenodegroups").
...
func (c *computeNodeGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *computeNodeGroups) Create(ctx context.Context, computeNodeGroup *v1beta1.ComputeNodeGroup, opts v1.CreateOptions) (result *v1beta1.ComputeNodeGroup, err error) {
	result = &v1beta1.ComputeNodeGroup{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("computenodegroups").
...
func (c *computeNodeGroups) Update(ctx context.Context, computeNodeGroup *v1beta1.ComputeNodeGroup, opts v1.UpdateOptions) (result *v1beta1.ComputeNodeGroup, err error) {
	result = &v1beta1.ComputeNodeGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodegroups").
...
func (c *computeNodeGroups) UpdateStatus(ctx context.Context, computeNodeGroup *v1beta1.ComputeNodeGroup, opts v1.UpdateOptions) (result *v1beta1.ComputeNodeGroup, err error) {
	result = &v1beta1.ComputeNodeGroup{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("computenodegroups").
...
func (c *computeNodeGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *computeNodeGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *computeNodeGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ComputeNodeGroup, err error) {
	result = &v1beta1.ComputeNodeGroup{}
