...
var redisinstancesResource = schema.GroupVersionResource{Group: "redis.cnrm.cloud.google.com", Version: "v1beta1", Resource: "redisinstances"}

var redisinstancesKind = schema.GroupVersionKind{Group: "redis.cnrm.cloud.google.com", Version: "v1beta1", Kind: "RedisInstance"}
...
func (c *FakeRedisInstances) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(redisinstancesResource, c.ns, name), &v1beta1.RedisInstance{})
