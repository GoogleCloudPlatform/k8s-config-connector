...
type OsconfigV1beta1Client struct {
	restClient rest.Interface
}
...
func NewForConfig(c *rest.Config) (*OsconfigV1beta1Client, error) {
	config := *c
	...
	return &OsconfigV1beta1Client{client}, nil
}

// NewForConfigOrDie creates a new OsconfigV1beta1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *OsconfigV1beta1Client {
...
// New creates a new OsconfigV1beta1Client for the given RESTClient.
func New(c rest.Interface) *OsconfigV1beta1Client {
	return &OsconfigV1beta1Client{c}
}
...
func (c *OsconfigV1beta1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
