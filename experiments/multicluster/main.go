...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "e6bed2d5.cnrm.cloud.google.com",
	})
	if err != nil {
	...
	c := controllers.New(controllers.MultiClusterLeaseReconcilerConfig{
		Client:        mgr.GetClient(),
		Scheme:        mgr.GetScheme(),
		Log:           ctrl.Log.WithName("controllers").WithName("MultiClusterLease"),
		EventRecorder: mgr.GetEventRecorderFor("multiclusterlease-controller"),
	})
