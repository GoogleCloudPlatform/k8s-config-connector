...
func init() {
	resource.AddTestSweepers("BigqueryDatapolicyDataPolicy", &resource.Sweeper{
		Name: "BigqueryDatapolicyDataPolicy",
		F:    testSweepBigqueryDatapolicyDataPolicy,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepBigqueryDatapolicyDataPolicy(region string) error {
	resourceName := "BigqueryDatapolicyDataPolicy"
