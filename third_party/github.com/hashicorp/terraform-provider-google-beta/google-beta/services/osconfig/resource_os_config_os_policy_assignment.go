...
func resourceOsConfigOsPolicyAssignmentUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	old := &osconfig.OSPolicyAssignment{
		InstanceFilter:   expandOsConfigOsPolicyAssignmentInstanceFilter(tpgdclresource.OldValue(d.GetChange("instance_filter"))),
		Location:         dcl.String(tpgdclresource.OldValue(d.GetChange("location")).(string)),
		Name:             dcl.String(tpgdclresource.OldValue(d.GetChange("name")).(string)),
		OSPolicies:       expandOsConfigOsPolicyAssignmentOSPoliciesArray(tpgdclresource.OldValue(d.GetChange("os_policies"))),
		Rollout:          expandOsConfigOsPolicyAssignmentRollout(tpgdclresource.OldValue(d.GetChange("rollout"))),
		Description:      dcl.String(tpgdclresource.OldValue(d.GetChange("description")).(string)),
		Project:          dcl.StringOrNil(tpgdclresource.OldValue(d.GetChange("project")).(string)),
		SkipAwaitRollout: dcl.Bool(tpgdclresource.OldValue(d.GetChange("skip_await_rollout")).(bool)),
	}
...
func expandOsConfigOsPolicyAssignmentOSPoliciesResourceGroupsResourcesPkgMsi(o interface{}) *osconfig.OSPolicyAssignmentOSPoliciesResourceGroupsResourcesPkgMsi {
	...
	return &osconfig.OSPolicyAssignmentOSPoliciesResourceGroupsResourcesPkgMsi{
		...
		Properties: tpgdclresource.ExpandStringArray(obj["properties"]),
	}
}
...
func expandOsConfigOsPolicyAssignmentOSPoliciesResourceGroupsResourcesRepositoryApt(o interface{}) *osconfig.OSPolicyAssignmentOSPoliciesResourceGroupsResourcesRepositoryApt {
	...
	return &osconfig.OSPolicyAssignmentOSPoliciesResourceGroupsResourcesRepositoryApt{
		...
		Components:   tpgdclresource.ExpandStringArray(obj["components"]),
...
func expandOsConfigOsPolicyAssignmentOSPoliciesResourceGroupsResourcesRepositoryYum(o interface{}) *osconfig.OSPolicyAssignmentOSPoliciesResourceGroupsResourcesRepositoryYum {
	...
	return &osconfig.OSPolicyAssignmentOSPoliciesResourceGroupsResourcesRepositoryYum{
		...
		GpgKeys:     tpgdclresource.ExpandStringArray(obj["gpg_keys"]),
	}
}
