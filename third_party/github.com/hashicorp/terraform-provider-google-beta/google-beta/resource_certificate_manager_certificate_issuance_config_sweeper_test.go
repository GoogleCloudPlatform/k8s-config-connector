...
func init() {
	resource.AddTestSweepers("CertificateManagerCertificateIssuanceConfig", &resource.Sweeper{
		Name: "CertificateManagerCertificateIssuanceConfig",
		F:    testSweepCertificateManagerCertificateIssuanceConfig,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepCertificateManagerCertificateIssuanceConfig(region string) error {
