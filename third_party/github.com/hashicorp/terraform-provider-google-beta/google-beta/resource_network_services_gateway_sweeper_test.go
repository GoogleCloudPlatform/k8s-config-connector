...
func init() {
	resource.AddTestSweepers("NetworkServicesGateway", &resource.Sweeper{
		Name: "NetworkServicesGateway",
		F:    testSweepNetworkServicesGateway,
	})
}

// At the time of writing, the CI only passes us-central1 as the region
func testSweepNetworkServicesGateway(region string) error {
	resourceName := "NetworkServicesGateway"
