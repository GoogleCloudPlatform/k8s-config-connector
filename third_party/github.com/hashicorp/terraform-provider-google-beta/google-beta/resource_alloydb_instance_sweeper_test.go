...
func init() {
	resource.AddTestSweepers("AlloydbInstance", &resource.Sweeper{
		Name: "AlloydbInstance",
		F:    testSweepAlloydbInstance,
	})
}
...
func testSweepAlloydbInstance(region string) error {
	...
	listTemplate := strings.Split("https://alloydb.googleapis.com/v1beta/{{cluster}}/instances?instanceId={{instance_id}}", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://alloydb.googleapis.com/v1beta/{{cluster}}/instances/{{instance_id}}"
