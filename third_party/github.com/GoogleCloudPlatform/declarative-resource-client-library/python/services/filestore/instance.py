...
class Instance(object):
    ...
    def apply(self):
        ...
        request = instance_pb2.ApplyFilestoreInstanceRequest()
        ...
        response = stub.ApplyFilestoreInstance(request)
    ...
    def delete(self):
        stub = instance_pb2_grpc.FilestoreInstanceServiceStub(channel.Channel())
        request = instance_pb2.DeleteFilestoreInstanceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = instance_pb2.FilestoreInstance()
        if Primitive.to_proto(self.name):
...
class InstanceFileShares(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FilestoreInstanceFileShares()
...
class InstanceFileSharesNfsExportOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FilestoreInstanceFileSharesNfsExportOptions()
...
class InstanceNetworks(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FilestoreInstanceNetworks()
...
class InstanceStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceStateEnum.Value(
            "FilestoreInstanceStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceStateEnum.Name(resource)[
            len("FilestoreInstanceStateEnum") :
        ]
...
class InstanceTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceTierEnum.Value(
            "FilestoreInstanceTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceTierEnum.Name(resource)[
            len("FilestoreInstanceTierEnum") :
        ]
...
class InstanceFileSharesNfsExportOptionsAccessModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceFileSharesNfsExportOptionsAccessModeEnum.Value(
            "FilestoreInstanceFileSharesNfsExportOptionsAccessModeEnum%s" % resource
        )
...
class InstanceFileSharesNfsExportOptionsSquashModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceFileSharesNfsExportOptionsSquashModeEnum.Value(
            "FilestoreInstanceFileSharesNfsExportOptionsSquashModeEnum%s" % resource
        )
...
class InstanceNetworksModesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceNetworksModesEnum.Value(
            "FilestoreInstanceNetworksModesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FilestoreInstanceNetworksModesEnum.Name(resource)[
            len("FilestoreInstanceNetworksModesEnum") :
        ]
