...
class EnvironmentGroupAttachment(object):
    ...
    def apply(self):
        stub = environment_group_attachment_pb2_grpc.ApigeeBetaEnvironmentGroupAttachmentServiceStub(
            channel.Channel()
        )
        request = (
            environment_group_attachment_pb2.ApplyApigeeBetaEnvironmentGroupAttachmentRequest()
        )
        ...
        response = stub.ApplyApigeeBetaEnvironmentGroupAttachment(request)
    ...
    def delete(self):
        ...
        request = (
            environment_group_attachment_pb2.DeleteApigeeBetaEnvironmentGroupAttachmentRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApigeeBetaEnvironmentGroupAttachment(request)
    ...
    def list(self, envgroup, service_account_file=""):
        ...
        request = (
            environment_group_attachment_pb2.ListApigeeBetaEnvironmentGroupAttachmentRequest()
        )
        request.service_account_file = service_account_file
        request.Envgroup = envgroup

        return stub.ListApigeeBetaEnvironmentGroupAttachment(request).items

    def to_proto(self):
        resource = (
            environment_group_attachment_pb2.ApigeeBetaEnvironmentGroupAttachment()
        )
        if Primitive.to_proto(self.name):
