...
class EnvironmentGroup(object):
    ...
    def apply(self):
        stub = environment_group_pb2_grpc.ApigeeAlphaEnvironmentGroupServiceStub(
            channel.Channel()
        )
        request = environment_group_pb2.ApplyApigeeAlphaEnvironmentGroupRequest()
        ...
        response = stub.ApplyApigeeAlphaEnvironmentGroup(request)
    ...
    def delete(self):
        ...
        request = environment_group_pb2.DeleteApigeeAlphaEnvironmentGroupRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApigeeAlphaEnvironmentGroup(request)
    ...
    def list(self, apigeeOrganization, service_account_file=""):
        ...
        request = environment_group_pb2.ListApigeeAlphaEnvironmentGroupRequest()
        request.service_account_file = service_account_file
        request.ApigeeOrganization = apigeeOrganization

        return stub.ListApigeeAlphaEnvironmentGroup(request).items

    def to_proto(self):
        resource = environment_group_pb2.ApigeeAlphaEnvironmentGroup()
        if Primitive.to_proto(self.name):
...
class EnvironmentGroupStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return environment_group_pb2.ApigeeAlphaEnvironmentGroupStateEnum.Value(
            "ApigeeAlphaEnvironmentGroupStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return environment_group_pb2.ApigeeAlphaEnvironmentGroupStateEnum.Name(
            resource
        )[len("ApigeeAlphaEnvironmentGroupStateEnum") :]
