...
class Envgroup(object):
    ...
    def apply(self):
        stub = envgroup_pb2_grpc.ApigeeAlphaEnvgroupServiceStub(channel.Channel())
        request = envgroup_pb2.ApplyApigeeAlphaEnvgroupRequest()
        ...
        response = stub.ApplyApigeeAlphaEnvgroup(request)
    ...
    def list(self, apigeeOrganization, service_account_file=""):
        stub = envgroup_pb2_grpc.ApigeeAlphaEnvgroupServiceStub(channel.Channel())
        request = envgroup_pb2.ListApigeeAlphaEnvgroupRequest()
        request.service_account_file = service_account_file
        request.ApigeeOrganization = apigeeOrganization

        return stub.ListApigeeAlphaEnvgroup(request).items

    def to_proto(self):
        resource = envgroup_pb2.ApigeeAlphaEnvgroup()
        if Primitive.to_proto(self.name):
...
class EnvgroupStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return envgroup_pb2.ApigeeAlphaEnvgroupStateEnum.Value(
            "ApigeeAlphaEnvgroupStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return envgroup_pb2.ApigeeAlphaEnvgroupStateEnum.Name(resource)[
            len("ApigeeAlphaEnvgroupStateEnum") :
        ]
