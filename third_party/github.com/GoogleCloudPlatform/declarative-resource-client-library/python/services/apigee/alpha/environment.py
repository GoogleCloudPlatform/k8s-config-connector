...
class Environment(object):
    ...
    def apply(self):
        stub = environment_pb2_grpc.ApigeeAlphaEnvironmentServiceStub(channel.Channel())
        request = environment_pb2.ApplyApigeeAlphaEnvironmentRequest()
        ...
        response = stub.ApplyApigeeAlphaEnvironment(request)
    ...
    def delete(self):
        stub = environment_pb2_grpc.ApigeeAlphaEnvironmentServiceStub(channel.Channel())
        request = environment_pb2.DeleteApigeeAlphaEnvironmentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApigeeAlphaEnvironment(request)

    @classmethod
    def list(self, apigeeOrganization, service_account_file=""):
        stub = environment_pb2_grpc.ApigeeAlphaEnvironmentServiceStub(channel.Channel())
        request = environment_pb2.ListApigeeAlphaEnvironmentRequest()
        request.service_account_file = service_account_file
        request.ApigeeOrganization = apigeeOrganization

        return stub.ListApigeeAlphaEnvironment(request).items

    def to_proto(self):
        resource = environment_pb2.ApigeeAlphaEnvironment()
        if Primitive.to_proto(self.name):
...
class EnvironmentStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return environment_pb2.ApigeeAlphaEnvironmentStateEnum.Value(
            "ApigeeAlphaEnvironmentStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return environment_pb2.ApigeeAlphaEnvironmentStateEnum.Name(resource)[
            len("ApigeeAlphaEnvironmentStateEnum") :
        ]
