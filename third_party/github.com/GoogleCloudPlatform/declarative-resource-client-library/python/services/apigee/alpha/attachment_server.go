...
func ProtoToAttachment(p *alphapb.ApigeeAlphaAttachment) *alpha.Attachment {
	obj := &alpha.Attachment{
...
func AttachmentToProto(resource *alpha.Attachment) *alphapb.ApigeeAlphaAttachment {
	p := &alphapb.ApigeeAlphaAttachment{}
...
func (s *AttachmentServer) applyAttachment(ctx context.Context, c *alpha.Client, request *alphapb.ApplyApigeeAlphaAttachmentRequest) (*alphapb.ApigeeAlphaAttachment, error) {
...
// applyApigeeAlphaAttachment handles the gRPC request by passing it to the underlying Attachment Apply() method.
func (s *AttachmentServer) ApplyApigeeAlphaAttachment(ctx context.Context, request *alphapb.ApplyApigeeAlphaAttachmentRequest) (*alphapb.ApigeeAlphaAttachment, error) {
...
func (s *AttachmentServer) DeleteApigeeAlphaAttachment(ctx context.Context, request *alphapb.DeleteApigeeAlphaAttachmentRequest) (*emptypb.Empty, error) {
...
// ListApigeeAlphaAttachment handles the gRPC request by passing it to the underlying AttachmentList() method.
func (s *AttachmentServer) ListApigeeAlphaAttachment(ctx context.Context, request *alphapb.ListApigeeAlphaAttachmentRequest) (*alphapb.ListApigeeAlphaAttachmentResponse, error) {
	cl, err := createConfigAttachment(ctx, request.GetServiceAccountFile())
	if err != nil {
		return nil, err
	}
	...
	var protos []*alphapb.ApigeeAlphaAttachment
	for _, r := range resources.Items {
		rp := AttachmentToProto(r)
		protos = append(protos, rp)
	}
	p := &alphapb.ListApigeeAlphaAttachmentResponse{}
	p.SetItems(protos)
	return p, nil
}

func createConfigAttachment(ctx context.Context, service_account_file string) (*alpha.Client, error) {
