...
class EnvironmentGroupAttachment(object):
    ...
    def apply(self):
        stub = environment_group_attachment_pb2_grpc.ApigeeAlphaEnvironmentGroupAttachmentServiceStub(
            channel.Channel()
        )
        request = (
            environment_group_attachment_pb2.ApplyApigeeAlphaEnvironmentGroupAttachmentRequest()
        )
        ...
        response = stub.ApplyApigeeAlphaEnvironmentGroupAttachment(request)
    ...
    def delete(self):
        ...
        request = (
            environment_group_attachment_pb2.DeleteApigeeAlphaEnvironmentGroupAttachmentRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApigeeAlphaEnvironmentGroupAttachment(request)
    ...
    def list(self, envgroup, service_account_file=""):
        ...
        request = (
            environment_group_attachment_pb2.ListApigeeAlphaEnvironmentGroupAttachmentRequest()
        )
        request.service_account_file = service_account_file
        request.Envgroup = envgroup

        return stub.ListApigeeAlphaEnvironmentGroupAttachment(request).items

    def to_proto(self):
        resource = (
            environment_group_attachment_pb2.ApigeeAlphaEnvironmentGroupAttachment()
        )
        if Primitive.to_proto(self.name):
