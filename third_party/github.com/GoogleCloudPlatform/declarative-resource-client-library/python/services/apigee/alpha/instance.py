...
class Instance(object):
    ...
    def apply(self):
        stub = instance_pb2_grpc.ApigeeAlphaInstanceServiceStub(channel.Channel())
    ...
    def delete(self):
        stub = instance_pb2_grpc.ApigeeAlphaInstanceServiceStub(channel.Channel())
        request = instance_pb2.DeleteApigeeAlphaInstanceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApigeeAlphaInstance(request)

    @classmethod
    def list(self, apigeeOrganization, service_account_file=""):
        stub = instance_pb2_grpc.ApigeeAlphaInstanceServiceStub(channel.Channel())
        request = instance_pb2.ListApigeeAlphaInstanceRequest()
        request.service_account_file = service_account_file
        request.ApigeeOrganization = apigeeOrganization

        return stub.ListApigeeAlphaInstance(request).items

    def to_proto(self):
        resource = instance_pb2.ApigeeAlphaInstance()
        if Primitive.to_proto(self.name):
...
class InstancePeeringCidrRangeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ApigeeAlphaInstancePeeringCidrRangeEnum.Value(
            "ApigeeAlphaInstancePeeringCidrRangeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ApigeeAlphaInstancePeeringCidrRangeEnum.Name(resource)[
            len("ApigeeAlphaInstancePeeringCidrRangeEnum") :
        ]
...
class InstanceStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ApigeeAlphaInstanceStateEnum.Value(
            "ApigeeAlphaInstanceStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ApigeeAlphaInstanceStateEnum.Name(resource)[
            len("ApigeeAlphaInstanceStateEnum") :
        ]
