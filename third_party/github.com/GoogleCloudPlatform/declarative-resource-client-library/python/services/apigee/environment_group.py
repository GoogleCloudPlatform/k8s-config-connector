...
class EnvironmentGroup(object):
    ...
    def apply(self):
        stub = environment_group_pb2_grpc.ApigeeEnvironmentGroupServiceStub(
            channel.Channel()
        )
        request = environment_group_pb2.ApplyApigeeEnvironmentGroupRequest()
        ...
        response = stub.ApplyApigeeEnvironmentGroup(request)
    ...
    def delete(self):
        ...
        request = environment_group_pb2.DeleteApigeeEnvironmentGroupRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApigeeEnvironmentGroup(request)
    ...
    def list(self, apigeeOrganization, service_account_file=""):
        ...
        request = environment_group_pb2.ListApigeeEnvironmentGroupRequest()
        request.service_account_file = service_account_file
        request.ApigeeOrganization = apigeeOrganization

        return stub.ListApigeeEnvironmentGroup(request).items

    def to_proto(self):
        resource = environment_group_pb2.ApigeeEnvironmentGroup()
        if Primitive.to_proto(self.name):
...
class EnvironmentGroupStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return environment_group_pb2.ApigeeEnvironmentGroupStateEnum.Value(
            "ApigeeEnvironmentGroupStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return environment_group_pb2.ApigeeEnvironmentGroupStateEnum.Name(resource)[
            len("ApigeeEnvironmentGroupStateEnum") :
        ]
