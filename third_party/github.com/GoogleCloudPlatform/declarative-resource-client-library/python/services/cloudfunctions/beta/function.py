...
class Function(object):
    ...
    def apply(self):
        stub = function_pb2_grpc.CloudfunctionsBetaFunctionServiceStub(
            channel.Channel()
        )
        request = function_pb2.ApplyCloudfunctionsBetaFunctionRequest()
        ...
        response = stub.ApplyCloudfunctionsBetaFunction(request)
    ...
    def delete(self):
        ...
        request = function_pb2.DeleteCloudfunctionsBetaFunctionRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudfunctionsBetaFunction(request)
    ...
    def list(self, project, region, service_account_file=""):
        ...
        request = function_pb2.ListCloudfunctionsBetaFunctionRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Region = region

        return stub.ListCloudfunctionsBetaFunction(request).items

    def to_proto(self):
        resource = function_pb2.CloudfunctionsBetaFunction()
        if Primitive.to_proto(self.name):
...
class FunctionSourceRepository(object):
    ...
    def to_proto(self, resource):
        ...
        res = function_pb2.CloudfunctionsBetaFunctionSourceRepository()
...
class FunctionHttpsTrigger(object):
    ...
    def to_proto(self, resource):
        ...
        res = function_pb2.CloudfunctionsBetaFunctionHttpsTrigger()
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
...
class FunctionEventTrigger(object):
    ...
    def to_proto(self, resource):
        ...
        res = function_pb2.CloudfunctionsBetaFunctionEventTrigger()
...
class FunctionStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsBetaFunctionStatusEnum.Value(
            "CloudfunctionsBetaFunctionStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsBetaFunctionStatusEnum.Name(resource)[
            len("CloudfunctionsBetaFunctionStatusEnum") :
        ]
...
class FunctionIngressSettingsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsBetaFunctionIngressSettingsEnum.Value(
            "CloudfunctionsBetaFunctionIngressSettingsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return function_pb2.CloudfunctionsBetaFunctionIngressSettingsEnum.Name(
            resource
        )[len("CloudfunctionsBetaFunctionIngressSettingsEnum") :]
