...
class Dataset(object):
    ...
    def apply(self):
        stub = dataset_pb2_grpc.BigqueryDatasetServiceStub(channel.Channel())
        request = dataset_pb2.ApplyBigqueryDatasetRequest()
        ...
        response = stub.ApplyBigqueryDataset(request)
    ...
    def delete(self):
        stub = dataset_pb2_grpc.BigqueryDatasetServiceStub(channel.Channel())
        request = dataset_pb2.DeleteBigqueryDatasetRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        if DatasetDefaultEncryptionConfiguration.to_proto(
            ...
            request.resource.ClearField("default_encryption_configuration")
        response = stub.DeleteBigqueryDataset(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = dataset_pb2_grpc.BigqueryDatasetServiceStub(channel.Channel())
        request = dataset_pb2.ListBigqueryDatasetRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListBigqueryDataset(request).items

    def to_proto(self):
        resource = dataset_pb2.BigqueryDataset()
        if Primitive.to_proto(self.name):
...
class DatasetAccess(object):
    ...
    def to_proto(self, resource):
        ...
        res = dataset_pb2.BigqueryDatasetAccess()
...
class DatasetAccessView(object):
    ...
    def to_proto(self, resource):
        ...
        res = dataset_pb2.BigqueryDatasetAccessView()
...
class DatasetAccessRoutine(object):
    ...
    def to_proto(self, resource):
        ...
        res = dataset_pb2.BigqueryDatasetAccessRoutine()
        if Primitive.to_proto(resource.project_id):
            res.project_id = Primitive.to_proto(resource.project_id)
        if Primitive.to_proto(resource.dataset_id):
            res.dataset_id = Primitive.to_proto(resource.dataset_id)
...
class DatasetDefaultEncryptionConfiguration(object):
    ...
    def to_proto(self, resource):
        ...
        res = dataset_pb2.BigqueryDatasetDefaultEncryptionConfiguration()
