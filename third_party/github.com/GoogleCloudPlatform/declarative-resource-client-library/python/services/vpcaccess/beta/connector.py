...
class Connector(object):
    ...
    def apply(self):
        stub = connector_pb2_grpc.VpcaccessBetaConnectorServiceStub(channel.Channel())
        request = connector_pb2.ApplyVpcaccessBetaConnectorRequest()
        ...
        response = stub.ApplyVpcaccessBetaConnector(request)
    ...
    def list(self, project, location, service_account_file=""):
        stub = connector_pb2_grpc.VpcaccessBetaConnectorServiceStub(channel.Channel())
        request = connector_pb2.ListVpcaccessBetaConnectorRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVpcaccessBetaConnector(request).items

    def to_proto(self):
        resource = connector_pb2.VpcaccessBetaConnector()
        if Primitive.to_proto(self.name):
...
class ConnectorSubnet(object):
    ...
    def to_proto(self, resource):
        ...
        res = connector_pb2.VpcaccessBetaConnectorSubnet()
...
class ConnectorStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return connector_pb2.VpcaccessBetaConnectorStateEnum.Value(
            "VpcaccessBetaConnectorStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return connector_pb2.VpcaccessBetaConnectorStateEnum.Name(resource)[
            len("VpcaccessBetaConnectorStateEnum") :
        ]
