...
class NodePool(object):
    ...
    def apply(self):
        stub = node_pool_pb2_grpc.ContainerazureBetaNodePoolServiceStub(
            channel.Channel()
        )
        request = node_pool_pb2.ApplyContainerazureBetaNodePoolRequest()
        ...
        response = stub.ApplyContainerazureBetaNodePool(request)
    ...
    def delete(self):
        ...
        request = node_pool_pb2.DeleteContainerazureBetaNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteContainerazureBetaNodePool(request)
    ...
    def list(self, project, location, cluster, service_account_file=""):
        ...
        request = node_pool_pb2.ListContainerazureBetaNodePoolRequest()
        ...
        return stub.ListContainerazureBetaNodePool(request).items

    def to_proto(self):
        resource = node_pool_pb2.ContainerazureBetaNodePool()
        if Primitive.to_proto(self.name):
...
class NodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureBetaNodePoolConfig()
...
class NodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureBetaNodePoolConfigRootVolume()
...
class NodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureBetaNodePoolConfigSshConfig()
...
class NodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureBetaNodePoolAutoscaling()
...
class NodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureBetaNodePoolMaxPodsConstraint()
...
class NodePoolManagement(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureBetaNodePoolManagement()
...
class NodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerazureBetaNodePoolStateEnum.Value(
            "ContainerazureBetaNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerazureBetaNodePoolStateEnum.Name(resource)[
            len("ContainerazureBetaNodePoolStateEnum") :
        ]
