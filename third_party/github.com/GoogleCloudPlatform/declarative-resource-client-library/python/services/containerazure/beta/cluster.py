...
class Cluster(object):
    ...
    def apply(self):
        ...
        request = cluster_pb2.ApplyContainerazureBetaClusterRequest()
    ...
    def delete(self):
        stub = cluster_pb2_grpc.ContainerazureBetaClusterServiceStub(channel.Channel())
        request = cluster_pb2.DeleteContainerazureBetaClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def list(self, project, location, service_account_file=""):
        stub = cluster_pb2_grpc.ContainerazureBetaClusterServiceStub(channel.Channel())
        request = cluster_pb2.ListContainerazureBetaClusterRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListContainerazureBetaCluster(request).items

    def to_proto(self):
        resource = cluster_pb2.ContainerazureBetaCluster()
        if Primitive.to_proto(self.name):
...
class ClusterAzureServicesAuthentication(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterAzureServicesAuthentication()
...
class ClusterNetworking(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterNetworking()
...
class ClusterControlPlane(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterControlPlane()
...
class ClusterControlPlaneSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterControlPlaneSshConfig()
...
class ClusterControlPlaneRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterControlPlaneRootVolume()
...
class ClusterControlPlaneMainVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterControlPlaneMainVolume()
        if Primitive.to_proto(resource.size_gib):
            res.size_gib = Primitive.to_proto(resource.size_gib)
        return res
...
class ClusterControlPlaneDatabaseEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterControlPlaneDatabaseEncryption()
...
class ClusterControlPlaneProxyConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterControlPlaneProxyConfig()
...
class ClusterControlPlaneReplicaPlacements(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterControlPlaneReplicaPlacements()
        if Primitive.to_proto(resource.subnet_id):
            res.subnet_id = Primitive.to_proto(resource.subnet_id)
...
class ClusterAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterAuthorization()
...
class ClusterAuthorizationAdminUsers(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterAuthorizationAdminUsers()
...
class ClusterAuthorizationAdminGroups(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterAuthorizationAdminGroups()
...
class ClusterWorkloadIdentityConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterWorkloadIdentityConfig()
...
class ClusterFleet(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterFleet()
...
class ClusterLoggingConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterLoggingConfig()
...
class ClusterLoggingConfigComponentConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerazureBetaClusterLoggingConfigComponentConfig()
...
class ClusterStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return cluster_pb2.ContainerazureBetaClusterStateEnum.Value(
            "ContainerazureBetaClusterStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return cluster_pb2.ContainerazureBetaClusterStateEnum.Name(resource)[
            len("ContainerazureBetaClusterStateEnum") :
        ]
...
class ClusterLoggingConfigComponentConfigEnableComponentsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return cluster_pb2.ContainerazureBetaClusterLoggingConfigComponentConfigEnableComponentsEnum.Value(
            "ContainerazureBetaClusterLoggingConfigComponentConfigEnableComponentsEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return cluster_pb2.ContainerazureBetaClusterLoggingConfigComponentConfigEnableComponentsEnum.Name(
            resource
        )[
            len(
                "ContainerazureBetaClusterLoggingConfigComponentConfigEnableComponentsEnum"
            ) :
        ]
