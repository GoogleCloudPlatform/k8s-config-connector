...
class AzureNodePool(object):
    ...
    def apply(self):
        stub = azure_node_pool_pb2_grpc.ContainerazureAlphaAzureNodePoolServiceStub(
            channel.Channel()
        )
        request = azure_node_pool_pb2.ApplyContainerazureAlphaAzureNodePoolRequest()
        ...
        response = stub.ApplyContainerazureAlphaAzureNodePool(request)
    ...
    def delete(self):
        ...
        request = azure_node_pool_pb2.DeleteContainerazureAlphaAzureNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteContainerazureAlphaAzureNodePool(request)

    def list(self):
        stub = azure_node_pool_pb2_grpc.ContainerazureAlphaAzureNodePoolServiceStub(
            channel.Channel()
        )
        request = azure_node_pool_pb2.ListContainerazureAlphaAzureNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListContainerazureAlphaAzureNodePool(request).items

    def to_proto(self):
        resource = azure_node_pool_pb2.ContainerazureAlphaAzureNodePool()
        if Primitive.to_proto(self.name):
...
class AzureNodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.ContainerazureAlphaAzureNodePoolConfig()
...
class AzureNodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.ContainerazureAlphaAzureNodePoolConfigRootVolume()
...
class AzureNodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.ContainerazureAlphaAzureNodePoolConfigSshConfig()
...
class AzureNodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.ContainerazureAlphaAzureNodePoolAutoscaling()
...
class AzureNodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.ContainerazureAlphaAzureNodePoolMaxPodsConstraint()
...
class AzureNodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return azure_node_pool_pb2.ContainerazureAlphaAzureNodePoolStateEnum.Value(
            "ContainerazureAlphaAzureNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return azure_node_pool_pb2.ContainerazureAlphaAzureNodePoolStateEnum.Name(
            resource
        )[len("ContainerazureAlphaAzureNodePoolStateEnum") :]
