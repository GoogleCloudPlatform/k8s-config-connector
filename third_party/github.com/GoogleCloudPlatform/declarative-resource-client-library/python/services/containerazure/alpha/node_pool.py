...
class NodePool(object):
    ...
    def apply(self):
        stub = node_pool_pb2_grpc.ContainerazureAlphaNodePoolServiceStub(
            channel.Channel()
        )
        request = node_pool_pb2.ApplyContainerazureAlphaNodePoolRequest()
        ...
        response = stub.ApplyContainerazureAlphaNodePool(request)
    ...
    def delete(self):
        ...
        request = node_pool_pb2.DeleteContainerazureAlphaNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteContainerazureAlphaNodePool(request)
    ...
    def list(self, project, location, cluster, service_account_file=""):
        ...
        request = node_pool_pb2.ListContainerazureAlphaNodePoolRequest()
        ...
        return stub.ListContainerazureAlphaNodePool(request).items

    def to_proto(self):
        resource = node_pool_pb2.ContainerazureAlphaNodePool()
        if Primitive.to_proto(self.name):
...
class NodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureAlphaNodePoolConfig()
...
class NodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureAlphaNodePoolConfigRootVolume()
...
class NodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureAlphaNodePoolConfigSshConfig()
...
class NodePoolConfigProxyConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureAlphaNodePoolConfigProxyConfig()
...
class NodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureAlphaNodePoolAutoscaling()
...
class NodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureAlphaNodePoolMaxPodsConstraint()
...
class NodePoolManagement(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerazureAlphaNodePoolManagement()
...
class NodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerazureAlphaNodePoolStateEnum.Value(
            "ContainerazureAlphaNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerazureAlphaNodePoolStateEnum.Name(resource)[
            len("ContainerazureAlphaNodePoolStateEnum") :
        ]
