...
class WorkforcePoolProvider(object):
    ...
    def apply(self):
        stub = (
            workforce_pool_provider_pb2_grpc.IamAlphaWorkforcePoolProviderServiceStub(
                channel.Channel()
            )
        )
        request = (
            workforce_pool_provider_pb2.ApplyIamAlphaWorkforcePoolProviderRequest()
        )
        ...
        response = stub.ApplyIamAlphaWorkforcePoolProvider(request)
    ...
    def delete(self):
        ...
        request = (
            workforce_pool_provider_pb2.DeleteIamAlphaWorkforcePoolProviderRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteIamAlphaWorkforcePoolProvider(request)
    ...
    def list(self, location, workforcePool, service_account_file=""):
        ...
        request = workforce_pool_provider_pb2.ListIamAlphaWorkforcePoolProviderRequest()
        request.service_account_file = service_account_file
        request.Location = location

        request.WorkforcePool = workforcePool

        return stub.ListIamAlphaWorkforcePoolProvider(request).items

    def to_proto(self):
        resource = workforce_pool_provider_pb2.IamAlphaWorkforcePoolProvider()
        if Primitive.to_proto(self.name):
...
class WorkforcePoolProviderSaml(object):
    ...
    def to_proto(self, resource):
        ...
        res = workforce_pool_provider_pb2.IamAlphaWorkforcePoolProviderSaml()
...
class WorkforcePoolProviderOidc(object):
    ...
    def to_proto(self, resource):
        ...
        res = workforce_pool_provider_pb2.IamAlphaWorkforcePoolProviderOidc()
...
class WorkforcePoolProviderOidcClientSecret(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            workforce_pool_provider_pb2.IamAlphaWorkforcePoolProviderOidcClientSecret()
        )
...
class WorkforcePoolProviderOidcClientSecretValue(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            workforce_pool_provider_pb2.IamAlphaWorkforcePoolProviderOidcClientSecretValue()
        )
...
class WorkforcePoolProviderStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_provider_pb2.IamAlphaWorkforcePoolProviderStateEnum.Value(
            "IamAlphaWorkforcePoolProviderStateEnum%s" % resource
        )
