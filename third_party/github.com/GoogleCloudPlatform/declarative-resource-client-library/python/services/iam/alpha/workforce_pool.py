...
class WorkforcePool(object):
    ...
    def apply(self):
        stub = workforce_pool_pb2_grpc.IamAlphaWorkforcePoolServiceStub(
            channel.Channel()
        )
        request = workforce_pool_pb2.ApplyIamAlphaWorkforcePoolRequest()
        ...
        response = stub.ApplyIamAlphaWorkforcePool(request)
    ...
    def delete(self):
        ...
        request = workforce_pool_pb2.DeleteIamAlphaWorkforcePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteIamAlphaWorkforcePool(request)
    ...
    def list(self, location, parent, service_account_file=""):
        ...
        request = workforce_pool_pb2.ListIamAlphaWorkforcePoolRequest()
        request.service_account_file = service_account_file
        request.Location = location

        request.Parent = parent

        return stub.ListIamAlphaWorkforcePool(request).items
...
class WorkforcePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_pb2.IamAlphaWorkforcePoolStateEnum.Value(
            "IamAlphaWorkforcePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_pb2.IamAlphaWorkforcePoolStateEnum.Name(resource)[
            len("IamAlphaWorkforcePoolStateEnum") :
        ]
