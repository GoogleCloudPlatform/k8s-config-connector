...
class WorkloadIdentityPoolProvider(object):
    ...
    def apply(self):
        stub = workload_identity_pool_provider_pb2_grpc.IamAlphaWorkloadIdentityPoolProviderServiceStub(
            channel.Channel()
        )
        request = (
            workload_identity_pool_provider_pb2.ApplyIamAlphaWorkloadIdentityPoolProviderRequest()
        )
        ...
        response = stub.ApplyIamAlphaWorkloadIdentityPoolProvider(request)
    ...
    def delete(self):
        ...
        request = (
            workload_identity_pool_provider_pb2.DeleteIamAlphaWorkloadIdentityPoolProviderRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteIamAlphaWorkloadIdentityPoolProvider(request)
    ...
    def list(self, project, location, workloadIdentityPool, service_account_file=""):
        ...
        request = (
            workload_identity_pool_provider_pb2.ListIamAlphaWorkloadIdentityPoolProviderRequest()
        )
        ...
        return stub.ListIamAlphaWorkloadIdentityPoolProvider(request).items

    def to_proto(self):
        resource = (
            workload_identity_pool_provider_pb2.IamAlphaWorkloadIdentityPoolProvider()
        )
        if Primitive.to_proto(self.name):
...
class WorkloadIdentityPoolProviderAws(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            workload_identity_pool_provider_pb2.IamAlphaWorkloadIdentityPoolProviderAws()
        )
...
class WorkloadIdentityPoolProviderOidc(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            workload_identity_pool_provider_pb2.IamAlphaWorkloadIdentityPoolProviderOidc()
        )
...
class WorkloadIdentityPoolProviderStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workload_identity_pool_provider_pb2.IamAlphaWorkloadIdentityPoolProviderStateEnum.Value(
            "IamAlphaWorkloadIdentityPoolProviderStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workload_identity_pool_provider_pb2.IamAlphaWorkloadIdentityPoolProviderStateEnum.Name(
            resource
        )[
            len("IamAlphaWorkloadIdentityPoolProviderStateEnum") :
        ]
