...
class WorkforcePool(object):
    ...
    def apply(self):
        stub = workforce_pool_pb2_grpc.IamBetaWorkforcePoolServiceStub(
            channel.Channel()
        )
        ...
        response = stub.ApplyIamBetaWorkforcePool(request)
    ...
    def delete(self):
        ...
        request = workforce_pool_pb2.DeleteIamBetaWorkforcePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteIamBetaWorkforcePool(request)
    ...
    def list(self, location, parent, service_account_file=""):
        ...
        request = workforce_pool_pb2.ListIamBetaWorkforcePoolRequest()
        request.service_account_file = service_account_file
        request.Location = location

        request.Parent = parent

        return stub.ListIamBetaWorkforcePool(request).items
...
class WorkforcePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_pb2.IamBetaWorkforcePoolStateEnum.Value(
            "IamBetaWorkforcePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_pb2.IamBetaWorkforcePoolStateEnum.Name(resource)[
            len("IamBetaWorkforcePoolStateEnum") :
        ]
