...
class WorkloadIdentityPoolProvider(object):
    ...
    def apply(self):
        ...
        request = (
            workload_identity_pool_provider_pb2.ApplyIamBetaWorkloadIdentityPoolProviderRequest()
        )
        ...
        response = stub.ApplyIamBetaWorkloadIdentityPoolProvider(request)
    ...
    def delete(self):
        ...
        request = (
            workload_identity_pool_provider_pb2.DeleteIamBetaWorkloadIdentityPoolProviderRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = (
            workload_identity_pool_provider_pb2.IamBetaWorkloadIdentityPoolProvider()
        )
        if Primitive.to_proto(self.name):
...
class WorkloadIdentityPoolProviderAws(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            workload_identity_pool_provider_pb2.IamBetaWorkloadIdentityPoolProviderAws()
        )
...
class WorkloadIdentityPoolProviderOidc(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            workload_identity_pool_provider_pb2.IamBetaWorkloadIdentityPoolProviderOidc()
        )
...
class WorkloadIdentityPoolProviderStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workload_identity_pool_provider_pb2.IamBetaWorkloadIdentityPoolProviderStateEnum.Value(
            "IamBetaWorkloadIdentityPoolProviderStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workload_identity_pool_provider_pb2.IamBetaWorkloadIdentityPoolProviderStateEnum.Name(
            resource
        )[
            len("IamBetaWorkloadIdentityPoolProviderStateEnum") :
        ]
