...
class WorkforcePoolProvider(object):
    ...
    def apply(self):
        stub = workforce_pool_provider_pb2_grpc.IamBetaWorkforcePoolProviderServiceStub(
            channel.Channel()
        )
        request = workforce_pool_provider_pb2.ApplyIamBetaWorkforcePoolProviderRequest()
        ...
        response = stub.ApplyIamBetaWorkforcePoolProvider(request)
    ...
    def delete(self):
        ...
        request = (
            workforce_pool_provider_pb2.DeleteIamBetaWorkforcePoolProviderRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteIamBetaWorkforcePoolProvider(request)
    ...
    def list(self, location, workforcePool, service_account_file=""):
        ...
        request = workforce_pool_provider_pb2.ListIamBetaWorkforcePoolProviderRequest()
        request.service_account_file = service_account_file
        request.Location = location

        request.WorkforcePool = workforcePool

        return stub.ListIamBetaWorkforcePoolProvider(request).items

    def to_proto(self):
        resource = workforce_pool_provider_pb2.IamBetaWorkforcePoolProvider()
        if Primitive.to_proto(self.name):
...
class WorkforcePoolProviderSaml(object):
    ...
    def to_proto(self, resource):
        ...
        res = workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderSaml()
...
class WorkforcePoolProviderOidc(object):
    ...
    def to_proto(self, resource):
        ...
        res = workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidc()
...
class WorkforcePoolProviderOidcWebSsoConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidcWebSsoConfig()
...
class WorkforcePoolProviderOidcClientSecret(object):
    ...
    def to_proto(self, resource):
        ...
        res = workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidcClientSecret()
...
class WorkforcePoolProviderOidcClientSecretValue(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidcClientSecretValue()
        )
...
class WorkforcePoolProviderStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderStateEnum.Value(
            "IamBetaWorkforcePoolProviderStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderStateEnum.Name(
            resource
        )[len("IamBetaWorkforcePoolProviderStateEnum") :]
...
class WorkforcePoolProviderOidcWebSsoConfigResponseTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidcWebSsoConfigResponseTypeEnum.Value(
            "IamBetaWorkforcePoolProviderOidcWebSsoConfigResponseTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidcWebSsoConfigResponseTypeEnum.Name(
            resource
        )[
            len("IamBetaWorkforcePoolProviderOidcWebSsoConfigResponseTypeEnum") :
        ]
...
class WorkforcePoolProviderOidcWebSsoConfigAssertionClaimsBehaviorEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidcWebSsoConfigAssertionClaimsBehaviorEnum.Value(
            "IamBetaWorkforcePoolProviderOidcWebSsoConfigAssertionClaimsBehaviorEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workforce_pool_provider_pb2.IamBetaWorkforcePoolProviderOidcWebSsoConfigAssertionClaimsBehaviorEnum.Name(
            resource
        )[
            len(
                "IamBetaWorkforcePoolProviderOidcWebSsoConfigAssertionClaimsBehaviorEnum"
            ) :
        ]
