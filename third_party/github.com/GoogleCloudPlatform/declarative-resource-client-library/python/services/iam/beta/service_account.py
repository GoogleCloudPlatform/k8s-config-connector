...
class ServiceAccount(object):
    ...
    def apply(self):
        ...
        response = stub.ApplyIamBetaServiceAccount(request)
    ...
    def delete(self):
        ...
        request = service_account_pb2.DeleteIamBetaServiceAccountRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
...
class ServiceAccountActasResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = service_account_pb2.IamBetaServiceAccountActasResources()
...
class ServiceAccountActasResourcesResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = service_account_pb2.IamBetaServiceAccountActasResourcesResources()
