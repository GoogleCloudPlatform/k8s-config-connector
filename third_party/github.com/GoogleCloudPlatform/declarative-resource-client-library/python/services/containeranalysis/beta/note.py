...
class Note(object):
    ...
    def apply(self):
        ...
        request = note_pb2.ApplyContaineranalysisBetaNoteRequest()
        ...
        response = stub.ApplyContaineranalysisBetaNote(request)
    ...
    def delete(self):
        stub = note_pb2_grpc.ContaineranalysisBetaNoteServiceStub(channel.Channel())
        request = note_pb2.DeleteContaineranalysisBetaNoteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
...
class NoteRelatedUrl(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteRelatedUrl()
...
class NoteVulnerability(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteVulnerability()
...
class NoteVulnerabilityDetails(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteVulnerabilityDetails()
...
class NoteVulnerabilityDetailsAffectedVersionStart(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionStart()
        )
...
class NoteVulnerabilityDetailsAffectedVersionEnd(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionEnd()
        if Primitive.to_proto(resource.epoch):
            res.epoch = Primitive.to_proto(resource.epoch)
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class NoteVulnerabilityDetailsFixedVersion(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsFixedVersion()
        if Primitive.to_proto(resource.epoch):
            res.epoch = Primitive.to_proto(resource.epoch)
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class NoteVulnerabilityCvssV3(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3()
...
class NoteVulnerabilityWindowsDetails(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteVulnerabilityWindowsDetails()
...
class NoteVulnerabilityWindowsDetailsFixingKbs(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteVulnerabilityWindowsDetailsFixingKbs()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
...
class NoteBuild(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteBuild()
...
class NoteBuildSignature(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteBuildSignature()
...
class NoteImage(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteImage()
...
class NoteImageFingerprint(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteImageFingerprint()
...
class NotePackage(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNotePackage()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class NotePackageDistribution(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNotePackageDistribution()
        if Primitive.to_proto(resource.cpe_uri):
            res.cpe_uri = Primitive.to_proto(resource.cpe_uri)
...
class NotePackageDistributionLatestVersion(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNotePackageDistributionLatestVersion()
        if Primitive.to_proto(resource.epoch):
            res.epoch = Primitive.to_proto(resource.epoch)
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class NoteDiscovery(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteDiscovery()
...
class NoteDeployment(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteDeployment()
...
class NoteAttestation(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteAttestation()
...
class NoteAttestationHint(object):
    ...
    def to_proto(self, resource):
        ...
        res = note_pb2.ContaineranalysisBetaNoteAttestationHint()
...
class NoteVulnerabilitySeverityEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilitySeverityEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilitySeverityEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilitySeverityEnum.Name(
            resource
        )[len("ContaineranalysisBetaNoteVulnerabilitySeverityEnum") :]
...
class NoteVulnerabilityDetailsAffectedVersionStartKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionStartKindEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionStartKindEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionStartKindEnum.Name(
            resource
        )[
            len(
                "ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionStartKindEnum"
            ) :
        ]
...
class NoteVulnerabilityDetailsAffectedVersionEndKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionEndKindEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionEndKindEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionEndKindEnum.Name(
            resource
        )[
            len(
                "ContaineranalysisBetaNoteVulnerabilityDetailsAffectedVersionEndKindEnum"
            ) :
        ]
...
class NoteVulnerabilityDetailsFixedVersionKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsFixedVersionKindEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityDetailsFixedVersionKindEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityDetailsFixedVersionKindEnum.Name(
            resource
        )[
            len("ContaineranalysisBetaNoteVulnerabilityDetailsFixedVersionKindEnum") :
        ]
...
class NoteVulnerabilityCvssV3AttackVectorEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3AttackVectorEnum.Value(
                "ContaineranalysisBetaNoteVulnerabilityCvssV3AttackVectorEnum%s"
                % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3AttackVectorEnum.Name(
                resource
            )[len("ContaineranalysisBetaNoteVulnerabilityCvssV3AttackVectorEnum") :]
        )
...
class NoteVulnerabilityCvssV3AttackComplexityEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3AttackComplexityEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityCvssV3AttackComplexityEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3AttackComplexityEnum.Name(
            resource
        )[
            len("ContaineranalysisBetaNoteVulnerabilityCvssV3AttackComplexityEnum") :
        ]
...
class NoteVulnerabilityCvssV3PrivilegesRequiredEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3PrivilegesRequiredEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityCvssV3PrivilegesRequiredEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3PrivilegesRequiredEnum.Name(
            resource
        )[
            len("ContaineranalysisBetaNoteVulnerabilityCvssV3PrivilegesRequiredEnum") :
        ]
...
class NoteVulnerabilityCvssV3UserInteractionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3UserInteractionEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityCvssV3UserInteractionEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3UserInteractionEnum.Name(
            resource
        )[
            len("ContaineranalysisBetaNoteVulnerabilityCvssV3UserInteractionEnum") :
        ]
...
class NoteVulnerabilityCvssV3ScopeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3ScopeEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityCvssV3ScopeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3ScopeEnum.Name(
            resource
        )[len("ContaineranalysisBetaNoteVulnerabilityCvssV3ScopeEnum") :]
...
class NoteVulnerabilityCvssV3ConfidentialityImpactEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3ConfidentialityImpactEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityCvssV3ConfidentialityImpactEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3ConfidentialityImpactEnum.Name(
            resource
        )[
            len(
                "ContaineranalysisBetaNoteVulnerabilityCvssV3ConfidentialityImpactEnum"
            ) :
        ]
...
class NoteVulnerabilityCvssV3IntegrityImpactEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3IntegrityImpactEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityCvssV3IntegrityImpactEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3IntegrityImpactEnum.Name(
            resource
        )[
            len("ContaineranalysisBetaNoteVulnerabilityCvssV3IntegrityImpactEnum") :
        ]
...
class NoteVulnerabilityCvssV3AvailabilityImpactEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3AvailabilityImpactEnum.Value(
            "ContaineranalysisBetaNoteVulnerabilityCvssV3AvailabilityImpactEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteVulnerabilityCvssV3AvailabilityImpactEnum.Name(
            resource
        )[
            len("ContaineranalysisBetaNoteVulnerabilityCvssV3AvailabilityImpactEnum") :
        ]
...
class NoteBuildSignatureKeyTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteBuildSignatureKeyTypeEnum.Value(
            "ContaineranalysisBetaNoteBuildSignatureKeyTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteBuildSignatureKeyTypeEnum.Name(
            resource
        )[len("ContaineranalysisBetaNoteBuildSignatureKeyTypeEnum") :]
...
class NotePackageDistributionArchitectureEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            note_pb2.ContaineranalysisBetaNotePackageDistributionArchitectureEnum.Value(
                "ContaineranalysisBetaNotePackageDistributionArchitectureEnum%s"
                % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            note_pb2.ContaineranalysisBetaNotePackageDistributionArchitectureEnum.Name(
                resource
            )[len("ContaineranalysisBetaNotePackageDistributionArchitectureEnum") :]
        )
...
class NotePackageDistributionLatestVersionKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNotePackageDistributionLatestVersionKindEnum.Value(
            "ContaineranalysisBetaNotePackageDistributionLatestVersionKindEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNotePackageDistributionLatestVersionKindEnum.Name(
            resource
        )[
            len("ContaineranalysisBetaNotePackageDistributionLatestVersionKindEnum") :
        ]
...
class NoteDiscoveryAnalysisKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteDiscoveryAnalysisKindEnum.Value(
            "ContaineranalysisBetaNoteDiscoveryAnalysisKindEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return note_pb2.ContaineranalysisBetaNoteDiscoveryAnalysisKindEnum.Name(
            resource
        )[len("ContaineranalysisBetaNoteDiscoveryAnalysisKindEnum") :]
