...
class Endpoint(object):
    ...
    def apply(self):
        stub = endpoint_pb2_grpc.VertexaiEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ApplyVertexaiEndpointRequest()
        ...
        response = stub.ApplyVertexaiEndpoint(request)
    ...
    def delete(self):
        stub = endpoint_pb2_grpc.VertexaiEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.DeleteVertexaiEndpointRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiEndpoint(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = endpoint_pb2_grpc.VertexaiEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ListVertexaiEndpointRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexaiEndpoint(request).items

    def to_proto(self):
        resource = endpoint_pb2.VertexaiEndpoint()
        if Primitive.to_proto(self.name):
...
class EndpointDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiEndpointDeployedModels()
...
class EndpointDeployedModelsDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiEndpointDeployedModelsDedicatedResources()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiEndpointDeployedModelsDedicatedResourcesMachineSpec()
...
class EndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexaiEndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs()
        )
...
class EndpointDeployedModelsAutomaticResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiEndpointDeployedModelsAutomaticResources()
        if Primitive.to_proto(resource.min_replica_count):
            res.min_replica_count = Primitive.to_proto(resource.min_replica_count)
        if Primitive.to_proto(resource.max_replica_count):
            res.max_replica_count = Primitive.to_proto(resource.max_replica_count)
...
class EndpointDeployedModelsPrivateEndpoints(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiEndpointDeployedModelsPrivateEndpoints()
...
class EndpointEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiEndpointEncryptionSpec()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexaiEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Value(
            "VertexaiEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexaiEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Name(
            resource
        )[
            len(
                "VertexaiEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum"
            ) :
        ]
