...
class EndpointTrafficSplit(object):
    ...
    def apply(self):
        stub = endpoint_traffic_split_pb2_grpc.VertexaiEndpointTrafficSplitServiceStub(
            channel.Channel()
        )
        request = endpoint_traffic_split_pb2.ApplyVertexaiEndpointTrafficSplitRequest()
        ...
        response = stub.ApplyVertexaiEndpointTrafficSplit(request)
    ...
    def delete(self):
        ...
        request = endpoint_traffic_split_pb2.DeleteVertexaiEndpointTrafficSplitRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.endpoint):
            request.resource.endpoint = Primitive.to_proto(self.endpoint)
        ...
        response = stub.DeleteVertexaiEndpointTrafficSplit(request)
    ...
    def list(self, location, service_account_file=""):
        ...
        request = endpoint_traffic_split_pb2.ListVertexaiEndpointTrafficSplitRequest()
        request.service_account_file = service_account_file
        request.Location = location

        return stub.ListVertexaiEndpointTrafficSplit(request).items

    def to_proto(self):
        resource = endpoint_traffic_split_pb2.VertexaiEndpointTrafficSplit()
        if Primitive.to_proto(self.endpoint):
...
class EndpointTrafficSplitTrafficSplit(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_traffic_split_pb2.VertexaiEndpointTrafficSplitTrafficSplit()
