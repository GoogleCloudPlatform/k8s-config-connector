...
class MetadataStore(object):
    ...
    def apply(self):
        stub = metadata_store_pb2_grpc.VertexaiMetadataStoreServiceStub(
            channel.Channel()
        )
        request = metadata_store_pb2.ApplyVertexaiMetadataStoreRequest()
        ...
        response = stub.ApplyVertexaiMetadataStore(request)
    ...
    def delete(self):
        ...
        request = metadata_store_pb2.DeleteVertexaiMetadataStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiMetadataStore(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = metadata_store_pb2.ListVertexaiMetadataStoreRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexaiMetadataStore(request).items

    def to_proto(self):
        resource = metadata_store_pb2.VertexaiMetadataStore()
        if Primitive.to_proto(self.name):
...
class MetadataStoreEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexaiMetadataStoreEncryptionSpec()
...
class MetadataStoreState(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexaiMetadataStoreState()
