...
from google3.cloud.graphite.mmv2.services.google.vertex_ai import model_deployment_pb2
...
class ModelDeployment(object):
    ...
    def apply(self):
        stub = model_deployment_pb2_grpc.VertexaiBetaModelDeploymentServiceStub(
            channel.Channel()
        )
        request = model_deployment_pb2.ApplyVertexaiBetaModelDeploymentRequest()
        ...
        response = stub.ApplyVertexaiBetaModelDeployment(request)
    ...
    def delete(self):
        ...
        request = model_deployment_pb2.DeleteVertexaiBetaModelDeploymentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.model):
            request.resource.model = Primitive.to_proto(self.model)
        ...
        response = stub.DeleteVertexaiBetaModelDeployment(request)
    ...
    def list(self, project, location, endpoint, service_account_file=""):
        ...
        request = model_deployment_pb2.ListVertexaiBetaModelDeploymentRequest()
        ...
        return stub.ListVertexaiBetaModelDeployment(request).items

    def to_proto(self):
        resource = model_deployment_pb2.VertexaiBetaModelDeployment()
        if Primitive.to_proto(self.model):
...
class ModelDeploymentDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_deployment_pb2.VertexaiBetaModelDeploymentDedicatedResources()
...
class ModelDeploymentDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            model_deployment_pb2.VertexaiBetaModelDeploymentDedicatedResourcesMachineSpec()
        )
