...
class Model(object):
    ...
    def apply(self):
        stub = model_pb2_grpc.VertexaiBetaModelServiceStub(channel.Channel())
        request = model_pb2.ApplyVertexaiBetaModelRequest()
        ...
        response = stub.ApplyVertexaiBetaModel(request)
    ...
    def delete(self):
        stub = model_pb2_grpc.VertexaiBetaModelServiceStub(channel.Channel())
        request = model_pb2.DeleteVertexaiBetaModelRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiBetaModel(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = model_pb2_grpc.VertexaiBetaModelServiceStub(channel.Channel())
        request = model_pb2.ListVertexaiBetaModelRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexaiBetaModel(request).items

    def to_proto(self):
        resource = model_pb2.VertexaiBetaModel()
        if Primitive.to_proto(self.name):
...
class ModelSupportedExportFormats(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelSupportedExportFormats()
...
class ModelOriginalModelInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelOriginalModelInfo()
...
class ModelContainerSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelContainerSpec()
...
class ModelContainerSpecEnv(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelContainerSpecEnv()
...
class ModelContainerSpecPorts(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelContainerSpecPorts()
...
class ModelDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelDeployedModels()
...
class ModelEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelEncryptionSpec()
...
class ModelSupportedExportFormatsExportableContentsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexaiBetaModelSupportedExportFormatsExportableContentsEnum.Value(
            "VertexaiBetaModelSupportedExportFormatsExportableContentsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexaiBetaModelSupportedExportFormatsExportableContentsEnum.Name(
            resource
        )[
            len("VertexaiBetaModelSupportedExportFormatsExportableContentsEnum") :
        ]
...
class ModelSupportedDeploymentResourcesTypesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexaiBetaModelSupportedDeploymentResourcesTypesEnum.Value(
            "VertexaiBetaModelSupportedDeploymentResourcesTypesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexaiBetaModelSupportedDeploymentResourcesTypesEnum.Name(
            resource
        )[len("VertexaiBetaModelSupportedDeploymentResourcesTypesEnum") :]
