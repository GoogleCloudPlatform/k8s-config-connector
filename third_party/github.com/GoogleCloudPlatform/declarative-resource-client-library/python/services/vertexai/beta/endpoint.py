...
class Endpoint(object):
    ...
    def apply(self):
        stub = endpoint_pb2_grpc.VertexaiBetaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ApplyVertexaiBetaEndpointRequest()
        ...
        response = stub.ApplyVertexaiBetaEndpoint(request)
    ...
    def delete(self):
        stub = endpoint_pb2_grpc.VertexaiBetaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.DeleteVertexaiBetaEndpointRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiBetaEndpoint(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = endpoint_pb2_grpc.VertexaiBetaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ListVertexaiBetaEndpointRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexaiBetaEndpoint(request).items

    def to_proto(self):
        resource = endpoint_pb2.VertexaiBetaEndpoint()
        if Primitive.to_proto(self.name):
...
class EndpointDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiBetaEndpointDeployedModels()
...
class EndpointDeployedModelsDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiBetaEndpointDeployedModelsDedicatedResources()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexaiBetaEndpointDeployedModelsDedicatedResourcesMachineSpec()
        )
...
class EndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexaiBetaEndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs()
        )
...
class EndpointDeployedModelsAutomaticResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiBetaEndpointDeployedModelsAutomaticResources()
        if Primitive.to_proto(resource.min_replica_count):
            res.min_replica_count = Primitive.to_proto(resource.min_replica_count)
        if Primitive.to_proto(resource.max_replica_count):
            res.max_replica_count = Primitive.to_proto(resource.max_replica_count)
...
class EndpointDeployedModelsPrivateEndpoints(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiBetaEndpointDeployedModelsPrivateEndpoints()
...
class EndpointEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexaiBetaEndpointEncryptionSpec()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexaiBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Value(
            "VertexaiBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexaiBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Name(
            resource
        )[
            len(
                "VertexaiBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum"
            ) :
        ]
