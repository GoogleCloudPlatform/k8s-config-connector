...
class MetadataSchema(object):
    ...
    def apply(self):
        stub = metadata_schema_pb2_grpc.VertexaiMetadataSchemaServiceStub(
            channel.Channel()
        )
        request = metadata_schema_pb2.ApplyVertexaiMetadataSchemaRequest()
        ...
        response = stub.ApplyVertexaiMetadataSchema(request)
    ...
    def delete(self):
        ...
        request = metadata_schema_pb2.DeleteVertexaiMetadataSchemaRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexaiMetadataSchema(request)
    ...
    def list(self, project, location, metadataStore, service_account_file=""):
        ...
        request = metadata_schema_pb2.ListVertexaiMetadataSchemaRequest()
        ...
        return stub.ListVertexaiMetadataSchema(request).items

    def to_proto(self):
        resource = metadata_schema_pb2.VertexaiMetadataSchema()
        if Primitive.to_proto(self.name):
...
class MetadataSchemaSchemaTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexaiMetadataSchemaSchemaTypeEnum.Value(
            "VertexaiMetadataSchemaSchemaTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexaiMetadataSchemaSchemaTypeEnum.Name(resource)[
            len("VertexaiMetadataSchemaSchemaTypeEnum") :
        ]
