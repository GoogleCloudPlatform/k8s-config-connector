...
class ModelDeployment(object):
    ...
    def apply(self):
        stub = model_deployment_pb2_grpc.VertexaiModelDeploymentServiceStub(
            channel.Channel()
        )
        request = model_deployment_pb2.ApplyVertexaiModelDeploymentRequest()
        ...
        response = stub.ApplyVertexaiModelDeployment(request)
    ...
    def delete(self):
        ...
        request = model_deployment_pb2.DeleteVertexaiModelDeploymentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.model):
            request.resource.model = Primitive.to_proto(self.model)
        ...
        response = stub.DeleteVertexaiModelDeployment(request)
    ...
    def list(self, project, location, endpoint, service_account_file=""):
        ...
        request = model_deployment_pb2.ListVertexaiModelDeploymentRequest()
        ...
        return stub.ListVertexaiModelDeployment(request).items

    def to_proto(self):
        resource = model_deployment_pb2.VertexaiModelDeployment()
        if Primitive.to_proto(self.model):
...
class ModelDeploymentDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_deployment_pb2.VertexaiModelDeploymentDedicatedResources()
...
class ModelDeploymentDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            model_deployment_pb2.VertexaiModelDeploymentDedicatedResourcesMachineSpec()
        )
