...
class ModelDeployment(object):
    ...
    def apply(self):
        stub = model_deployment_pb2_grpc.VertexaiAlphaModelDeploymentServiceStub(
            channel.Channel()
        )
        request = model_deployment_pb2.ApplyVertexaiAlphaModelDeploymentRequest()
    ...
    def delete(self):
        ...
        request = model_deployment_pb2.DeleteVertexaiAlphaModelDeploymentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.model):
            request.resource.model = Primitive.to_proto(self.model)
        ...
        response = stub.DeleteVertexaiAlphaModelDeployment(request)
    ...
    def list(self, project, location, endpoint, service_account_file=""):
        ...
        request = model_deployment_pb2.ListVertexaiAlphaModelDeploymentRequest()
        ...
        return stub.ListVertexaiAlphaModelDeployment(request).items

    def to_proto(self):
        resource = model_deployment_pb2.VertexaiAlphaModelDeployment()
        if Primitive.to_proto(self.model):
...
class ModelDeploymentDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_deployment_pb2.VertexaiAlphaModelDeploymentDedicatedResources()
...
class ModelDeploymentDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            model_deployment_pb2.VertexaiAlphaModelDeploymentDedicatedResourcesMachineSpec()
        )
