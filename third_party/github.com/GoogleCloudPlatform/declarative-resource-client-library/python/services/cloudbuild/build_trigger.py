...
class BuildTrigger(object):
    ...
    def apply(self):
        ...
        request = build_trigger_pb2.ApplyCloudbuildBuildTriggerRequest()
        ...
        response = stub.ApplyCloudbuildBuildTrigger(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = build_trigger_pb2.ListCloudbuildBuildTriggerRequest()
...
class BuildTriggerTriggerTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerTriggerTemplate()
...
class BuildTriggerGithub(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerGithub()
...
class BuildTriggerGithubPullRequest(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerGithubPullRequest()
...
class BuildTriggerGithubPush(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerGithubPush()
        if Primitive.to_proto(resource.branch):
            res.branch = Primitive.to_proto(resource.branch)
...
class BuildTriggerBuild(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuild()
...
class BuildTriggerBuildSecrets(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildSecrets()
...
class BuildTriggerBuildSteps(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildSteps()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class BuildTriggerBuildStepsVolumes(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildStepsVolumes()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class BuildTriggerBuildStepsTiming(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildStepsTiming()
...
class BuildTriggerBuildStepsPullTiming(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildStepsPullTiming()
        if Primitive.to_proto(resource.start_time):
            res.start_time = Primitive.to_proto(resource.start_time)
        if Primitive.to_proto(resource.end_time):
            res.end_time = Primitive.to_proto(resource.end_time)
...
class BuildTriggerBuildSource(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildSource()
...
class BuildTriggerBuildSourceStorageSource(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildSourceStorageSource()
...
class BuildTriggerBuildSourceRepoSource(object):
    ...
    def to_proto(self, resource):
        ...
        res = build_trigger_pb2.CloudbuildBuildTriggerBuildSourceRepoSource()
        if Primitive.to_proto(resource.project_id):
            res.project_id = Primitive.to_proto(resource.project_id)
        if Primitive.to_proto(resource.repo_name):
            res.repo_name = Primitive.to_proto(resource.repo_name)
...
class BuildTriggerGithubPullRequestCommentControlEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return build_trigger_pb2.CloudbuildBuildTriggerGithubPullRequestCommentControlEnum.Value(
            "CloudbuildBuildTriggerGithubPullRequestCommentControlEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return build_trigger_pb2.CloudbuildBuildTriggerGithubPullRequestCommentControlEnum.Name(
            resource
        )[
            len("CloudbuildBuildTriggerGithubPullRequestCommentControlEnum") :
        ]
...
class BuildTriggerBuildStepsStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return build_trigger_pb2.CloudbuildBuildTriggerBuildStepsStatusEnum.Value(
            "CloudbuildBuildTriggerBuildStepsStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return build_trigger_pb2.CloudbuildBuildTriggerBuildStepsStatusEnum.Name(
            resource
        )[len("CloudbuildBuildTriggerBuildStepsStatusEnum") :]
