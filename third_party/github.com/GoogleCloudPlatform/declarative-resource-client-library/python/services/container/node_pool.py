...
class NodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolConfig()
...
class NodePoolConfigAccelerators(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolConfigAccelerators()
...
class NodePoolConfigTaints(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolConfigTaints()
...
class NodePoolConfigSandboxConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolConfigSandboxConfig()
...
class NodePoolConfigReservationAffinity(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolConfigReservationAffinity()
...
class NodePoolConfigShieldedInstanceConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolConfigShieldedInstanceConfig()
...
class NodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolAutoscaling()
...
class NodePoolManagement(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolManagement()
...
class NodePoolManagementUpgradeOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolManagementUpgradeOptions()
...
class NodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolMaxPodsConstraint()
...
class NodePoolConditions(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolConditions()
...
class NodePoolUpgradeSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerNodePoolUpgradeSettings()
...
class NodePoolConfigSandboxConfigTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerNodePoolConfigSandboxConfigTypeEnum.Value(
            "ContainerNodePoolConfigSandboxConfigTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerNodePoolConfigSandboxConfigTypeEnum.Name(
            resource
        )[len("ContainerNodePoolConfigSandboxConfigTypeEnum") :]
...
class NodePoolConfigReservationAffinityConsumeReservationTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerNodePoolConfigReservationAffinityConsumeReservationTypeEnum.Value(
            "ContainerNodePoolConfigReservationAffinityConsumeReservationTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerNodePoolConfigReservationAffinityConsumeReservationTypeEnum.Name(
            resource
        )[
            len(
                "ContainerNodePoolConfigReservationAffinityConsumeReservationTypeEnum"
            ) :
        ]
...
class NodePoolConditionsCodeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerNodePoolConditionsCodeEnum.Value(
            "ContainerNodePoolConditionsCodeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerNodePoolConditionsCodeEnum.Name(resource)[
            len("ContainerNodePoolConditionsCodeEnum") :
        ]
