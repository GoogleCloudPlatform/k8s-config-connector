...
class Group(object):
    ...
    def apply(self):
        stub = group_pb2_grpc.CloudidentityBetaGroupServiceStub(channel.Channel())
        request = group_pb2.ApplyCloudidentityBetaGroupRequest()
        ...
        response = stub.ApplyCloudidentityBetaGroup(request)
    ...
    def delete(self):
        stub = group_pb2_grpc.CloudidentityBetaGroupServiceStub(channel.Channel())
        request = group_pb2.DeleteCloudidentityBetaGroupRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def list(self, parent, service_account_file=""):
        stub = group_pb2_grpc.CloudidentityBetaGroupServiceStub(channel.Channel())
        request = group_pb2.ListCloudidentityBetaGroupRequest()
        request.service_account_file = service_account_file
        request.Parent = parent

        return stub.ListCloudidentityBetaGroup(request).items

    def to_proto(self):
        resource = group_pb2.CloudidentityBetaGroup()
        if Primitive.to_proto(self.name):
...
class GroupGroupKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityBetaGroupGroupKey()
...
class GroupAdditionalGroupKeys(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityBetaGroupAdditionalGroupKeys()
        if Primitive.to_proto(resource.id):
            res.id = Primitive.to_proto(resource.id)
        if Primitive.to_proto(resource.namespace):
            res.namespace = Primitive.to_proto(resource.namespace)
...
class GroupDynamicGroupMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityBetaGroupDynamicGroupMetadata()
...
class GroupDynamicGroupMetadataQueries(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityBetaGroupDynamicGroupMetadataQueries()
...
class GroupDynamicGroupMetadataStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityBetaGroupDynamicGroupMetadataStatus()
...
class GroupPosixGroups(object):
    ...
    def to_proto(self, resource):
        ...
        res = group_pb2.CloudidentityBetaGroupPosixGroups()
...
class GroupDynamicGroupMetadataQueriesResourceTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityBetaGroupDynamicGroupMetadataQueriesResourceTypeEnum.Value(
            "CloudidentityBetaGroupDynamicGroupMetadataQueriesResourceTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityBetaGroupDynamicGroupMetadataQueriesResourceTypeEnum.Name(
            resource
        )[
            len("CloudidentityBetaGroupDynamicGroupMetadataQueriesResourceTypeEnum") :
        ]
...
class GroupInitialGroupConfigEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityBetaGroupInitialGroupConfigEnum.Value(
            "CloudidentityBetaGroupInitialGroupConfigEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityBetaGroupInitialGroupConfigEnum.Name(resource)[
            len("CloudidentityBetaGroupInitialGroupConfigEnum") :
        ]
