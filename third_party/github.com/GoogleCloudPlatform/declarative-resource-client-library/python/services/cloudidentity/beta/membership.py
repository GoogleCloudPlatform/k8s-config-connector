...
class Membership(object):
    ...
    def apply(self):
        stub = membership_pb2_grpc.CloudidentityBetaMembershipServiceStub(
            channel.Channel()
        )
        request = membership_pb2.ApplyCloudidentityBetaMembershipRequest()
        ...
        response = stub.ApplyCloudidentityBetaMembership(request)
    ...
    def delete(self):
        ...
        request = membership_pb2.DeleteCloudidentityBetaMembershipRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudidentityBetaMembership(request)
    ...
    def list(self, group, service_account_file=""):
        ...
        request = membership_pb2.ListCloudidentityBetaMembershipRequest()
        request.service_account_file = service_account_file
        request.Group = group

        return stub.ListCloudidentityBetaMembership(request).items

    def to_proto(self):
        resource = membership_pb2.CloudidentityBetaMembership()
        if Primitive.to_proto(self.name):
...
class MembershipPreferredMemberKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.CloudidentityBetaMembershipPreferredMemberKey()
...
class MembershipRoles(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.CloudidentityBetaMembershipRoles()
...
class MembershipRolesExpiryDetail(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.CloudidentityBetaMembershipRolesExpiryDetail()
...
class MembershipRolesRestrictionEvaluations(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.CloudidentityBetaMembershipRolesRestrictionEvaluations()
...
class MembershipRolesRestrictionEvaluationsMemberRestrictionEvaluation(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            membership_pb2.CloudidentityBetaMembershipRolesRestrictionEvaluationsMemberRestrictionEvaluation()
        )
...
class MembershipMemberKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.CloudidentityBetaMembershipMemberKey()
        if Primitive.to_proto(resource.id):
            res.id = Primitive.to_proto(resource.id)
        if Primitive.to_proto(resource.namespace):
            res.namespace = Primitive.to_proto(resource.namespace)
...
class MembershipRolesRestrictionEvaluationsMemberRestrictionEvaluationStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return membership_pb2.CloudidentityBetaMembershipRolesRestrictionEvaluationsMemberRestrictionEvaluationStateEnum.Value(
            "CloudidentityBetaMembershipRolesRestrictionEvaluationsMemberRestrictionEvaluationStateEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return membership_pb2.CloudidentityBetaMembershipRolesRestrictionEvaluationsMemberRestrictionEvaluationStateEnum.Name(
            resource
        )[
            len(
                "CloudidentityBetaMembershipRolesRestrictionEvaluationsMemberRestrictionEvaluationStateEnum"
            ) :
        ]
...
class MembershipTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return membership_pb2.CloudidentityBetaMembershipTypeEnum.Value(
            "CloudidentityBetaMembershipTypeEnum%s" % resource
        )
