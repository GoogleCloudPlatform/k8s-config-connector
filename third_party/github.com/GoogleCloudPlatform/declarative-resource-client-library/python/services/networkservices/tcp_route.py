...
class TcpRoute(object):
    ...
    def apply(self):
        stub = tcp_route_pb2_grpc.NetworkservicesTcpRouteServiceStub(channel.Channel())
        request = tcp_route_pb2.ApplyNetworkservicesTcpRouteRequest()
        ...
        response = stub.ApplyNetworkservicesTcpRoute(request)
    ...
    def delete(self):
        stub = tcp_route_pb2_grpc.NetworkservicesTcpRouteServiceStub(channel.Channel())
        request = tcp_route_pb2.DeleteNetworkservicesTcpRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesTcpRoute(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = tcp_route_pb2_grpc.NetworkservicesTcpRouteServiceStub(channel.Channel())
        request = tcp_route_pb2.ListNetworkservicesTcpRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesTcpRoute(request).items

    def to_proto(self):
        resource = tcp_route_pb2.NetworkservicesTcpRoute()
        if Primitive.to_proto(self.name):
...
class TcpRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesTcpRouteRules()
...
class TcpRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesTcpRouteRulesMatches()
...
class TcpRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesTcpRouteRulesAction()
...
class TcpRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = tcp_route_pb2.NetworkservicesTcpRouteRulesActionDestinations()
