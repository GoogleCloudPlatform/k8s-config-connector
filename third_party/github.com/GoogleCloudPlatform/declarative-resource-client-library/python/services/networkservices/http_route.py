...
class HttpRoute(object):
    ...
    def apply(self):
        stub = http_route_pb2_grpc.NetworkservicesHttpRouteServiceStub(
            channel.Channel()
        )
        request = http_route_pb2.ApplyNetworkservicesHttpRouteRequest()
        ...
        response = stub.ApplyNetworkservicesHttpRoute(request)
    ...
    def delete(self):
        ...
        request = http_route_pb2.DeleteNetworkservicesHttpRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesHttpRoute(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = http_route_pb2.ListNetworkservicesHttpRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesHttpRoute(request).items

    def to_proto(self):
        resource = http_route_pb2.NetworkservicesHttpRoute()
        if Primitive.to_proto(self.name):
...
class HttpRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRules()
...
class HttpRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesMatches()
...
class HttpRouteRulesMatchesHeaders(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesMatchesHeaders()
...
class HttpRouteRulesMatchesHeadersRangeMatch(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesMatchesHeadersRangeMatch()
...
class HttpRouteRulesMatchesQueryParameters(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesMatchesQueryParameters()
...
class HttpRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesAction()
...
class HttpRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionDestinations()
...
class HttpRouteRulesActionRedirect(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionRedirect()
...
class HttpRouteRulesActionFaultInjectionPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionFaultInjectionPolicy()
...
class HttpRouteRulesActionFaultInjectionPolicyDelay(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesHttpRouteRulesActionFaultInjectionPolicyDelay()
        )
...
class HttpRouteRulesActionFaultInjectionPolicyAbort(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesHttpRouteRulesActionFaultInjectionPolicyAbort()
        )
...
class HttpRouteRulesActionRequestHeaderModifier(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionRequestHeaderModifier()
...
class HttpRouteRulesActionResponseHeaderModifier(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionResponseHeaderModifier()
        if Primitive.to_proto(resource.set):
            res.set = Primitive.to_proto(resource.set)
        if Primitive.to_proto(resource.add):
            res.add = Primitive.to_proto(resource.add)
...
class HttpRouteRulesActionUrlRewrite(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionUrlRewrite()
...
class HttpRouteRulesActionRetryPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionRetryPolicy()
...
class HttpRouteRulesActionRequestMirrorPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionRequestMirrorPolicy()
...
class HttpRouteRulesActionRequestMirrorPolicyDestination(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesHttpRouteRulesActionRequestMirrorPolicyDestination()
        )
        if Primitive.to_proto(resource.weight):
            res.weight = Primitive.to_proto(resource.weight)
        if Primitive.to_proto(resource.service_name):
...
class HttpRouteRulesActionCorsPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesHttpRouteRulesActionCorsPolicy()
...
class HttpRouteRulesActionRedirectResponseCodeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return http_route_pb2.NetworkservicesHttpRouteRulesActionRedirectResponseCodeEnum.Value(
            "NetworkservicesHttpRouteRulesActionRedirectResponseCodeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return http_route_pb2.NetworkservicesHttpRouteRulesActionRedirectResponseCodeEnum.Name(
            resource
        )[
            len("NetworkservicesHttpRouteRulesActionRedirectResponseCodeEnum") :
        ]
