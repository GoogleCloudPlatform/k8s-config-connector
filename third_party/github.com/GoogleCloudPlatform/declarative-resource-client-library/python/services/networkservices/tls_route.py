...
class TlsRoute(object):
    ...
    def apply(self):
        stub = tls_route_pb2_grpc.NetworkservicesTlsRouteServiceStub(channel.Channel())
        request = tls_route_pb2.ApplyNetworkservicesTlsRouteRequest()
        ...
        response = stub.ApplyNetworkservicesTlsRoute(request)
    ...
    def delete(self):
        stub = tls_route_pb2_grpc.NetworkservicesTlsRouteServiceStub(channel.Channel())
        request = tls_route_pb2.DeleteNetworkservicesTlsRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesTlsRoute(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = tls_route_pb2_grpc.NetworkservicesTlsRouteServiceStub(channel.Channel())
        request = tls_route_pb2.ListNetworkservicesTlsRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesTlsRoute(request).items

    def to_proto(self):
        resource = tls_route_pb2.NetworkservicesTlsRoute()
        if Primitive.to_proto(self.name):
...
class TlsRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesTlsRouteRules()
...
class TlsRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesTlsRouteRulesMatches()
...
class TlsRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesTlsRouteRulesAction()
...
class TlsRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesTlsRouteRulesActionDestinations()
