...
class GrpcRoute(object):
    ...
    def apply(self):
        stub = grpc_route_pb2_grpc.NetworkservicesGrpcRouteServiceStub(
            channel.Channel()
        )
        request = grpc_route_pb2.ApplyNetworkservicesGrpcRouteRequest()
        ...
        response = stub.ApplyNetworkservicesGrpcRoute(request)
    ...
    def delete(self):
        ...
        request = grpc_route_pb2.DeleteNetworkservicesGrpcRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesGrpcRoute(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = grpc_route_pb2.ListNetworkservicesGrpcRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesGrpcRoute(request).items

    def to_proto(self):
        resource = grpc_route_pb2.NetworkservicesGrpcRoute()
        if Primitive.to_proto(self.name):
...
class GrpcRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRules()
...
class GrpcRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRulesMatches()
...
class GrpcRouteRulesMatchesMethod(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRulesMatchesMethod()
...
class GrpcRouteRulesMatchesHeaders(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRulesMatchesHeaders()
...
class GrpcRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRulesAction()
...
class GrpcRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRulesActionDestinations()
...
class GrpcRouteRulesActionFaultInjectionPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRulesActionFaultInjectionPolicy()
...
class GrpcRouteRulesActionFaultInjectionPolicyDelay(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            grpc_route_pb2.NetworkservicesGrpcRouteRulesActionFaultInjectionPolicyDelay()
        )
...
class GrpcRouteRulesActionFaultInjectionPolicyAbort(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            grpc_route_pb2.NetworkservicesGrpcRouteRulesActionFaultInjectionPolicyAbort()
        )
...
class GrpcRouteRulesActionRetryPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesGrpcRouteRulesActionRetryPolicy()
...
class GrpcRouteRulesMatchesMethodTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return grpc_route_pb2.NetworkservicesGrpcRouteRulesMatchesMethodTypeEnum.Value(
            "NetworkservicesGrpcRouteRulesMatchesMethodTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return grpc_route_pb2.NetworkservicesGrpcRouteRulesMatchesMethodTypeEnum.Name(
            resource
        )[len("NetworkservicesGrpcRouteRulesMatchesMethodTypeEnum") :]
...
class GrpcRouteRulesMatchesHeadersTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return grpc_route_pb2.NetworkservicesGrpcRouteRulesMatchesHeadersTypeEnum.Value(
            "NetworkservicesGrpcRouteRulesMatchesHeadersTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return grpc_route_pb2.NetworkservicesGrpcRouteRulesMatchesHeadersTypeEnum.Name(
            resource
        )[len("NetworkservicesGrpcRouteRulesMatchesHeadersTypeEnum") :]
