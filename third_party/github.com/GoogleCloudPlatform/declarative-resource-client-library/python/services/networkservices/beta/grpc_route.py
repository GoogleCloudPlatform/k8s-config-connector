...
class GrpcRoute(object):
    ...
    def apply(self):
        stub = grpc_route_pb2_grpc.NetworkservicesBetaGrpcRouteServiceStub(
            channel.Channel()
        )
        request = grpc_route_pb2.ApplyNetworkservicesBetaGrpcRouteRequest()
        ...
        response = stub.ApplyNetworkservicesBetaGrpcRoute(request)
    ...
    def delete(self):
        ...
        request = grpc_route_pb2.DeleteNetworkservicesBetaGrpcRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesBetaGrpcRoute(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = grpc_route_pb2.ListNetworkservicesBetaGrpcRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesBetaGrpcRoute(request).items

    def to_proto(self):
        resource = grpc_route_pb2.NetworkservicesBetaGrpcRoute()
        if Primitive.to_proto(self.name):
...
class GrpcRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesBetaGrpcRouteRules()
...
class GrpcRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesMatches()
...
class GrpcRouteRulesMatchesMethod(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesMatchesMethod()
...
class GrpcRouteRulesMatchesHeaders(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesMatchesHeaders()
...
class GrpcRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesAction()
...
class GrpcRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesActionDestinations()
...
class GrpcRouteRulesActionFaultInjectionPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesActionFaultInjectionPolicy()
        )
...
class GrpcRouteRulesActionFaultInjectionPolicyDelay(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesActionFaultInjectionPolicyDelay()
        )
...
class GrpcRouteRulesActionFaultInjectionPolicyAbort(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesActionFaultInjectionPolicyAbort()
        )
...
class GrpcRouteRulesActionRetryPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesActionRetryPolicy()
...
class GrpcRouteRulesMatchesHeadersTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return grpc_route_pb2.NetworkservicesBetaGrpcRouteRulesMatchesHeadersTypeEnum.Value(
            "NetworkservicesBetaGrpcRouteRulesMatchesHeadersTypeEnum%s" % resource
        )
