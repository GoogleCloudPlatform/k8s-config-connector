...
class HttpRoute(object):
    ...
    def apply(self):
        stub = http_route_pb2_grpc.NetworkservicesBetaHttpRouteServiceStub(
            channel.Channel()
        )
        request = http_route_pb2.ApplyNetworkservicesBetaHttpRouteRequest()
        ...
        response = stub.ApplyNetworkservicesBetaHttpRoute(request)
    ...
    def delete(self):
        ...
        request = http_route_pb2.DeleteNetworkservicesBetaHttpRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesBetaHttpRoute(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = http_route_pb2.ListNetworkservicesBetaHttpRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesBetaHttpRoute(request).items

    def to_proto(self):
        resource = http_route_pb2.NetworkservicesBetaHttpRoute()
        if Primitive.to_proto(self.name):
...
class HttpRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRules()
...
class HttpRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesMatches()
...
class HttpRouteRulesMatchesHeaders(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesMatchesHeaders()
...
class HttpRouteRulesMatchesHeadersRangeMatch(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesMatchesHeadersRangeMatch()
...
class HttpRouteRulesMatchesQueryParameters(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesMatchesQueryParameters()
...
class HttpRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesAction()
...
class HttpRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesActionDestinations()
...
class HttpRouteRulesActionRedirect(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesActionRedirect()
...
class HttpRouteRulesActionFaultInjectionPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesBetaHttpRouteRulesActionFaultInjectionPolicy()
        )
...
class HttpRouteRulesActionFaultInjectionPolicyDelay(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesBetaHttpRouteRulesActionFaultInjectionPolicyDelay()
        )
...
class HttpRouteRulesActionFaultInjectionPolicyAbort(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesBetaHttpRouteRulesActionFaultInjectionPolicyAbort()
        )
...
class HttpRouteRulesActionRequestHeaderModifier(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesBetaHttpRouteRulesActionRequestHeaderModifier()
        )
...
class HttpRouteRulesActionResponseHeaderModifier(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesBetaHttpRouteRulesActionResponseHeaderModifier()
        )
        if Primitive.to_proto(resource.set):
            res.set = Primitive.to_proto(resource.set)
        if Primitive.to_proto(resource.add):
...
class HttpRouteRulesActionUrlRewrite(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesActionUrlRewrite()
...
class HttpRouteRulesActionRetryPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesActionRetryPolicy()
...
class HttpRouteRulesActionRequestMirrorPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesBetaHttpRouteRulesActionRequestMirrorPolicy()
        )
...
class HttpRouteRulesActionRequestMirrorPolicyDestination(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            http_route_pb2.NetworkservicesBetaHttpRouteRulesActionRequestMirrorPolicyDestination()
        )
        if Primitive.to_proto(resource.weight):
            res.weight = Primitive.to_proto(resource.weight)
        if Primitive.to_proto(resource.service_name):
...
class HttpRouteRulesActionCorsPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = http_route_pb2.NetworkservicesBetaHttpRouteRulesActionCorsPolicy()
...
class HttpRouteRulesActionRedirectResponseCodeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return http_route_pb2.NetworkservicesBetaHttpRouteRulesActionRedirectResponseCodeEnum.Value(
            "NetworkservicesBetaHttpRouteRulesActionRedirectResponseCodeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return http_route_pb2.NetworkservicesBetaHttpRouteRulesActionRedirectResponseCodeEnum.Name(
            resource
        )[
            len("NetworkservicesBetaHttpRouteRulesActionRedirectResponseCodeEnum") :
        ]
