...
class EndpointPolicy(object):
    ...
    def apply(self):
        ...
        request = endpoint_policy_pb2.ApplyNetworkservicesBetaEndpointPolicyRequest()
        ...
        response = stub.ApplyNetworkservicesBetaEndpointPolicy(request)
    ...
    def delete(self):
        ...
        request = endpoint_policy_pb2.DeleteNetworkservicesBetaEndpointPolicyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = endpoint_policy_pb2.NetworkservicesBetaEndpointPolicy()
        if Primitive.to_proto(self.name):
...
class EndpointPolicyEndpointMatcher(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyEndpointMatcher()
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcher(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyEndpointMatcherMetadataLabelMatcher()
        )
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabels(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabels()
        )
...
class EndpointPolicyTrafficPortSelector(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyTrafficPortSelector()
...
class EndpointPolicyTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyTypeEnum.Value(
            "NetworkservicesBetaEndpointPolicyTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyTypeEnum.Name(
            resource
        )[len("NetworkservicesBetaEndpointPolicyTypeEnum") :]
...
class EndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteriaEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteriaEnum.Value(
            "NetworkservicesBetaEndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteriaEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return endpoint_policy_pb2.NetworkservicesBetaEndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteriaEnum.Name(
            resource
        )[
            len(
                "NetworkservicesBetaEndpointPolicyEndpointMatcherMetadataLabelMatcherMetadataLabelMatchCriteriaEnum"
            ) :
        ]
