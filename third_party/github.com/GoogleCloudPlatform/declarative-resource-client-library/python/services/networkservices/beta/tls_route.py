...
class TlsRoute(object):
    ...
    def apply(self):
        stub = tls_route_pb2_grpc.NetworkservicesBetaTlsRouteServiceStub(
            channel.Channel()
        )
        request = tls_route_pb2.ApplyNetworkservicesBetaTlsRouteRequest()
        ...
        response = stub.ApplyNetworkservicesBetaTlsRoute(request)
    ...
    def delete(self):
        ...
        request = tls_route_pb2.DeleteNetworkservicesBetaTlsRouteRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworkservicesBetaTlsRoute(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = tls_route_pb2.ListNetworkservicesBetaTlsRouteRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworkservicesBetaTlsRoute(request).items

    def to_proto(self):
        resource = tls_route_pb2.NetworkservicesBetaTlsRoute()
        if Primitive.to_proto(self.name):
...
class TlsRouteRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesBetaTlsRouteRules()
...
class TlsRouteRulesMatches(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesBetaTlsRouteRulesMatches()
...
class TlsRouteRulesAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesBetaTlsRouteRulesAction()
...
class TlsRouteRulesActionDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = tls_route_pb2.NetworkservicesBetaTlsRouteRulesActionDestinations()
