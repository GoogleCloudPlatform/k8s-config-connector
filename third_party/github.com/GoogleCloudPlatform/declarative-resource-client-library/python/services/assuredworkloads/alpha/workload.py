...
class Workload(object):
    ...
    def apply(self):
        stub = workload_pb2_grpc.AssuredworkloadsAlphaWorkloadServiceStub(
            channel.Channel()
        )
        request = workload_pb2.ApplyAssuredworkloadsAlphaWorkloadRequest()
        ...
        response = stub.ApplyAssuredworkloadsAlphaWorkload(request)
    ...
    def delete(self):
        ...
        request = workload_pb2.DeleteAssuredworkloadsAlphaWorkloadRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteAssuredworkloadsAlphaWorkload(request)
    ...
    def list(self, organization, location, service_account_file=""):
        ...
        request = workload_pb2.ListAssuredworkloadsAlphaWorkloadRequest()
        request.service_account_file = service_account_file
        request.Organization = organization

        request.Location = location

        return stub.ListAssuredworkloadsAlphaWorkload(request).items

    def to_proto(self):
        resource = workload_pb2.AssuredworkloadsAlphaWorkload()
        if Primitive.to_proto(self.name):
...
class WorkloadResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = workload_pb2.AssuredworkloadsAlphaWorkloadResources()
...
class WorkloadKmsSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = workload_pb2.AssuredworkloadsAlphaWorkloadKmsSettings()
...
class WorkloadResourceSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = workload_pb2.AssuredworkloadsAlphaWorkloadResourceSettings()
        if Primitive.to_proto(resource.resource_id):
            res.resource_id = Primitive.to_proto(resource.resource_id)
...
class WorkloadResourcesResourceTypeEnum(object):
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsAlphaWorkloadResourcesResourceTypeEnum.Name(
            resource
        )[len("AssuredworkloadsAlphaWorkloadResourcesResourceTypeEnum") :]
...
class WorkloadComplianceRegimeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsAlphaWorkloadComplianceRegimeEnum.Value(
            "AssuredworkloadsAlphaWorkloadComplianceRegimeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsAlphaWorkloadComplianceRegimeEnum.Name(
            resource
        )[len("AssuredworkloadsAlphaWorkloadComplianceRegimeEnum") :]
...
class WorkloadResourceSettingsResourceTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsAlphaWorkloadResourceSettingsResourceTypeEnum.Value(
            "AssuredworkloadsAlphaWorkloadResourceSettingsResourceTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsAlphaWorkloadResourceSettingsResourceTypeEnum.Name(
            resource
        )[
