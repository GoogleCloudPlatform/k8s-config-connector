...
class Target(object):
    ...
    def apply(self):
        ...
        request = target_pb2.ApplyClouddeployBetaTargetRequest()
    ...
    def delete(self):
        stub = target_pb2_grpc.ClouddeployBetaTargetServiceStub(channel.Channel())
        request = target_pb2.DeleteClouddeployBetaTargetRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def list(self, project, location, service_account_file=""):
        stub = target_pb2_grpc.ClouddeployBetaTargetServiceStub(channel.Channel())
        request = target_pb2.ListClouddeployBetaTargetRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListClouddeployBetaTarget(request).items

    def to_proto(self):
        resource = target_pb2.ClouddeployBetaTarget()
        if Primitive.to_proto(self.name):
...
class TargetGke(object):
    ...
    def to_proto(self, resource):
        ...
        res = target_pb2.ClouddeployBetaTargetGke()
...
class TargetAnthosCluster(object):
    ...
    def to_proto(self, resource):
        ...
        res = target_pb2.ClouddeployBetaTargetAnthosCluster()
...
class TargetExecutionConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = target_pb2.ClouddeployBetaTargetExecutionConfigs()
...
class TargetRun(object):
    ...
    def to_proto(self, resource):
        ...
        res = target_pb2.ClouddeployBetaTargetRun()
...
class TargetMultiTarget(object):
    ...
    def to_proto(self, resource):
        ...
        res = target_pb2.ClouddeployBetaTargetMultiTarget()
...
class TargetExecutionConfigsUsagesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return target_pb2.ClouddeployBetaTargetExecutionConfigsUsagesEnum.Value(
            "ClouddeployBetaTargetExecutionConfigsUsagesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return target_pb2.ClouddeployBetaTargetExecutionConfigsUsagesEnum.Name(
            resource
        )[len("ClouddeployBetaTargetExecutionConfigsUsagesEnum") :]
