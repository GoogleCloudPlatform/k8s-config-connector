...
class DeliveryPipelineSerialPipelineStagesStrategy(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategy()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyStandard(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyStandard()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyStandardPredeploy(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyStandardPredeploy()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyStandardPostdeploy(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyStandardPostdeploy()
        )
        if Primitive.to_proto(resource.actions):
            res.actions.extend(Primitive.to_proto(resource.actions))
        return res
...
class DeliveryPipelineSerialPipelineStagesStrategyCanary(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanary()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfig()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigKubernetes(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigKubernetes()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigKubernetesGatewayServiceMesh(
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigKubernetesGatewayServiceMesh()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigKubernetesServiceNetworking(
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigKubernetesServiceNetworking()
        )
        if Primitive.to_proto(resource.service):
            res.service = Primitive.to_proto(resource.service)
        if Primitive.to_proto(resource.deployment):
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigCloudRun(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryRuntimeConfigCloudRun()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryCanaryDeployment(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryCanaryDeployment()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryCanaryDeploymentPredeploy(
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryCanaryDeploymentPredeploy()
        )
        if Primitive.to_proto(resource.actions):
            res.actions.extend(Primitive.to_proto(resource.actions))
        return res
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryCanaryDeploymentPostdeploy(
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryCanaryDeploymentPostdeploy()
        )
        if Primitive.to_proto(resource.actions):
            res.actions.extend(Primitive.to_proto(resource.actions))
        return res
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeployment(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeployment()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeploymentPhaseConfigs(
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeploymentPhaseConfigs()
        )
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeploymentPhaseConfigsPredeploy(
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeploymentPhaseConfigsPredeploy()
        )
        if Primitive.to_proto(resource.actions):
            res.actions.extend(Primitive.to_proto(resource.actions))
        return res
...
class DeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeploymentPhaseConfigsPostdeploy(
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesStrategyCanaryCustomCanaryDeploymentPhaseConfigsPostdeploy()
        )
        if Primitive.to_proto(resource.actions):
            res.actions.extend(Primitive.to_proto(resource.actions))
        return res
...
class DeliveryPipelineSerialPipelineStagesDeployParameters(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineSerialPipelineStagesDeployParameters()
        )
...
class DeliveryPipelineConditionTargetsTypeCondition(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            delivery_pipeline_pb2.ClouddeployAlphaDeliveryPipelineConditionTargetsTypeCondition()
        )
        if Primitive.to_proto(resource.status):
            res.status = Primitive.to_proto(resource.status)
