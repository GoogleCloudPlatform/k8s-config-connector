...
class Brand(object):
    ...
    def apply(self):
        ...
        request = brand_pb2.ApplyIapBetaBrandRequest()
        ...
        response = stub.ApplyIapBetaBrand(request)
    ...
    def delete(self):
        stub = brand_pb2_grpc.IapBetaBrandServiceStub(channel.Channel())
        request = brand_pb2.DeleteIapBetaBrandRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.application_title):
            request.resource.application_title = Primitive.to_proto(
                self.application_title
    ...
    def to_proto(self):
        resource = brand_pb2.IapBetaBrand()
        if Primitive.to_proto(self.application_title):
