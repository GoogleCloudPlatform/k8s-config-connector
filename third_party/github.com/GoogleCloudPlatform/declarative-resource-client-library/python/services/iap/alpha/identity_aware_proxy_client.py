...
class IdentityAwareProxyClient(object):
    ...
    def apply(self):
        ...
        request = (
            identity_aware_proxy_client_pb2.ApplyIapAlphaIdentityAwareProxyClientRequest()
        )
        ...
        response = stub.ApplyIapAlphaIdentityAwareProxyClient(request)
    ...
    def delete(self):
        ...
        request = (
            identity_aware_proxy_client_pb2.DeleteIapAlphaIdentityAwareProxyClientRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = identity_aware_proxy_client_pb2.IapAlphaIdentityAwareProxyClient()
        if Primitive.to_proto(self.name):
