...
class ManagedService(object):
    ...
    def delete(self):
        ...
        request = managed_service_pb2.DeleteServicemanagementManagedServiceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteServicemanagementManagedService(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = managed_service_pb2.ListServicemanagementManagedServiceRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListServicemanagementManagedService(request).items

    def to_proto(self):
        resource = managed_service_pb2.ServicemanagementManagedService()
        if Primitive.to_proto(self.name):
