...
class Membership(object):
    ...
    def apply(self):
        ...
        request = membership_pb2.ApplyGkehubAlphaMembershipRequest()
        ...
        response = stub.ApplyGkehubAlphaMembership(request)
    ...
    def delete(self):
        stub = membership_pb2_grpc.GkehubAlphaMembershipServiceStub(channel.Channel())
        request = membership_pb2.DeleteGkehubAlphaMembershipRequest()
        request.service_account_file = self.service_account_file
        if MembershipEndpoint.to_proto(self.endpoint):
            request.resource.endpoint.CopyFrom(
                MembershipEndpoint.to_proto(self.endpoint)
    ...
    def to_proto(self):
        resource = membership_pb2.GkehubAlphaMembership()
        if MembershipEndpoint.to_proto(self.endpoint):
...
class MembershipEndpoint(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.GkehubAlphaMembershipEndpoint()
...
class MembershipEndpointGkeCluster(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.GkehubAlphaMembershipEndpointGkeCluster()
...
class MembershipEndpointKubernetesMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.GkehubAlphaMembershipEndpointKubernetesMetadata()
...
class MembershipEndpointKubernetesResource(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.GkehubAlphaMembershipEndpointKubernetesResource()
...
class MembershipEndpointKubernetesResourceMembershipResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            membership_pb2.GkehubAlphaMembershipEndpointKubernetesResourceMembershipResources()
        )
...
class MembershipEndpointKubernetesResourceConnectResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            membership_pb2.GkehubAlphaMembershipEndpointKubernetesResourceConnectResources()
        )
        if Primitive.to_proto(resource.manifest):
            res.manifest = Primitive.to_proto(resource.manifest)
        if Primitive.to_proto(resource.cluster_scoped):
...
class MembershipEndpointKubernetesResourceResourceOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            membership_pb2.GkehubAlphaMembershipEndpointKubernetesResourceResourceOptions()
        )
...
class MembershipState(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.GkehubAlphaMembershipState()
...
class MembershipAuthority(object):
    ...
    def to_proto(self, resource):
        ...
        res = membership_pb2.GkehubAlphaMembershipAuthority()
...
class MembershipStateCodeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return membership_pb2.GkehubAlphaMembershipStateCodeEnum.Value(
            "GkehubAlphaMembershipStateCodeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return membership_pb2.GkehubAlphaMembershipStateCodeEnum.Name(resource)[
            len("GkehubAlphaMembershipStateCodeEnum") :
        ]
...
class MembershipInfrastructureTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return membership_pb2.GkehubAlphaMembershipInfrastructureTypeEnum.Value(
            "GkehubAlphaMembershipInfrastructureTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return membership_pb2.GkehubAlphaMembershipInfrastructureTypeEnum.Name(
            resource
        )[len("GkehubAlphaMembershipInfrastructureTypeEnum") :]
