...
class FhirStore(object):
    ...
    def apply(self):
        stub = fhir_store_pb2_grpc.HealthcareBetaFhirStoreServiceStub(channel.Channel())
        request = fhir_store_pb2.ApplyHealthcareBetaFhirStoreRequest()
        ...
        response = stub.ApplyHealthcareBetaFhirStore(request)
    ...
    def delete(self):
        stub = fhir_store_pb2_grpc.HealthcareBetaFhirStoreServiceStub(channel.Channel())
        request = fhir_store_pb2.DeleteHealthcareBetaFhirStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteHealthcareBetaFhirStore(request)

    @classmethod
    def list(self, project, location, dataset, service_account_file=""):
        stub = fhir_store_pb2_grpc.HealthcareBetaFhirStoreServiceStub(channel.Channel())
        request = fhir_store_pb2.ListHealthcareBetaFhirStoreRequest()
        ...
        return stub.ListHealthcareBetaFhirStore(request).items

    def to_proto(self):
        resource = fhir_store_pb2.HealthcareBetaFhirStore()
        if Primitive.to_proto(self.name):
...
class FhirStoreNotificationConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareBetaFhirStoreNotificationConfig()
...
class FhirStoreStreamConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareBetaFhirStoreStreamConfigs()
...
class FhirStoreStreamConfigsBigqueryDestination(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareBetaFhirStoreStreamConfigsBigqueryDestination()
...
class FhirStoreStreamConfigsBigqueryDestinationSchemaConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            fhir_store_pb2.HealthcareBetaFhirStoreStreamConfigsBigqueryDestinationSchemaConfig()
        )
...
class FhirStoreValidationConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = fhir_store_pb2.HealthcareBetaFhirStoreValidationConfig()
...
class FhirStoreVersionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareBetaFhirStoreVersionEnum.Value(
            "HealthcareBetaFhirStoreVersionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareBetaFhirStoreVersionEnum.Name(resource)[
            len("HealthcareBetaFhirStoreVersionEnum") :
        ]
...
class FhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareBetaFhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum.Value(
            "HealthcareBetaFhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareBetaFhirStoreStreamConfigsBigqueryDestinationSchemaConfigSchemaTypeEnum.Name(
            resource
        )[
            len(
...
class FhirStoreComplexDataTypeReferenceParsingEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareBetaFhirStoreComplexDataTypeReferenceParsingEnum.Value(
            "HealthcareBetaFhirStoreComplexDataTypeReferenceParsingEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return fhir_store_pb2.HealthcareBetaFhirStoreComplexDataTypeReferenceParsingEnum.Name(
            resource
        )[
            len("HealthcareBetaFhirStoreComplexDataTypeReferenceParsingEnum") :
        ]
