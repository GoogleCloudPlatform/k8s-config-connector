...
class DicomStore(object):
    ...
    def apply(self):
        stub = dicom_store_pb2_grpc.HealthcareBetaDicomStoreServiceStub(
            channel.Channel()
        )
        request = dicom_store_pb2.ApplyHealthcareBetaDicomStoreRequest()
        ...
        response = stub.ApplyHealthcareBetaDicomStore(request)
    ...
    def delete(self):
        ...
        request = dicom_store_pb2.DeleteHealthcareBetaDicomStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteHealthcareBetaDicomStore(request)
    ...
    def list(self, project, location, dataset, service_account_file=""):
        ...
        request = dicom_store_pb2.ListHealthcareBetaDicomStoreRequest()
        ...
        return stub.ListHealthcareBetaDicomStore(request).items

    def to_proto(self):
        resource = dicom_store_pb2.HealthcareBetaDicomStore()
        if Primitive.to_proto(self.name):
...
class DicomStoreNotificationConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = dicom_store_pb2.HealthcareBetaDicomStoreNotificationConfig()
