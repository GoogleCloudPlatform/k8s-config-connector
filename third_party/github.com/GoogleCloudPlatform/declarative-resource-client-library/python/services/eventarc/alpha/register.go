...
func RegisterServers(s *grpc.Server) {
	...
	sdkgrpc.RegisterEventarcAlphaChannelServiceServer(s, &ChannelServer{})
	sdkgrpc.RegisterEventarcAlphaGoogleChannelConfigServiceServer(s, &GoogleChannelConfigServer{})
}
