...
class AutoscalingPolicy(object):
    ...
    def apply(self):
        ...
        request = autoscaling_policy_pb2.ApplyDataprocBetaAutoscalingPolicyRequest()
        ...
        response = stub.ApplyDataprocBetaAutoscalingPolicy(request)
    ...
    def delete(self):
        ...
        request = autoscaling_policy_pb2.DeleteDataprocBetaAutoscalingPolicyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = autoscaling_policy_pb2.DataprocBetaAutoscalingPolicy()
        if Primitive.to_proto(self.name):
...
class AutoscalingPolicyBasicAlgorithm(object):
    ...
    def to_proto(self, resource):
        ...
        res = autoscaling_policy_pb2.DataprocBetaAutoscalingPolicyBasicAlgorithm()
...
class AutoscalingPolicyBasicAlgorithmYarnConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            autoscaling_policy_pb2.DataprocBetaAutoscalingPolicyBasicAlgorithmYarnConfig()
        )
...
class AutoscalingPolicyWorkerConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = autoscaling_policy_pb2.DataprocBetaAutoscalingPolicyWorkerConfig()
...
class AutoscalingPolicySecondaryWorkerConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            autoscaling_policy_pb2.DataprocBetaAutoscalingPolicySecondaryWorkerConfig()
        )
        if Primitive.to_proto(resource.min_instances):
            res.min_instances = Primitive.to_proto(resource.min_instances)
        if Primitive.to_proto(resource.max_instances):
