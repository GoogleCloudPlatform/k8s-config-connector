...
class Interconnect(object):
    ...
    def apply(self):
        stub = interconnect_pb2_grpc.ComputeAlphaInterconnectServiceStub(
            channel.Channel()
        )
        request = interconnect_pb2.ApplyComputeAlphaInterconnectRequest()
        ...
        response = stub.ApplyComputeAlphaInterconnect(request)
    ...
    def delete(self):
        ...
        request = interconnect_pb2.DeleteComputeAlphaInterconnectRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
        ...
        response = stub.DeleteComputeAlphaInterconnect(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = interconnect_pb2.ListComputeAlphaInterconnectRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListComputeAlphaInterconnect(request).items

    def to_proto(self):
        resource = interconnect_pb2.ComputeAlphaInterconnect()
        if Primitive.to_proto(self.description):
...
class InterconnectExpectedOutages(object):
    ...
    def to_proto(self, resource):
        ...
        res = interconnect_pb2.ComputeAlphaInterconnectExpectedOutages()
...
class InterconnectCircuitInfos(object):
    ...
    def to_proto(self, resource):
        ...
        res = interconnect_pb2.ComputeAlphaInterconnectCircuitInfos()
...
class InterconnectLinkTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectLinkTypeEnum.Value(
            "ComputeAlphaInterconnectLinkTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectLinkTypeEnum.Name(resource)[
            len("ComputeAlphaInterconnectLinkTypeEnum") :
        ]
...
class InterconnectInterconnectTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectInterconnectTypeEnum.Value(
            "ComputeAlphaInterconnectInterconnectTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectInterconnectTypeEnum.Name(
            resource
        )[len("ComputeAlphaInterconnectInterconnectTypeEnum") :]
...
class InterconnectOperationalStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectOperationalStatusEnum.Value(
            "ComputeAlphaInterconnectOperationalStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectOperationalStatusEnum.Name(
            resource
        )[len("ComputeAlphaInterconnectOperationalStatusEnum") :]
...
class InterconnectExpectedOutagesSourceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectExpectedOutagesSourceEnum.Value(
            "ComputeAlphaInterconnectExpectedOutagesSourceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectExpectedOutagesSourceEnum.Name(
            resource
        )[len("ComputeAlphaInterconnectExpectedOutagesSourceEnum") :]
...
class InterconnectExpectedOutagesStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectExpectedOutagesStateEnum.Value(
            "ComputeAlphaInterconnectExpectedOutagesStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectExpectedOutagesStateEnum.Name(
            resource
        )[len("ComputeAlphaInterconnectExpectedOutagesStateEnum") :]
...
class InterconnectExpectedOutagesIssueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectExpectedOutagesIssueTypeEnum.Value(
            "ComputeAlphaInterconnectExpectedOutagesIssueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectExpectedOutagesIssueTypeEnum.Name(
            resource
        )[
            len("ComputeAlphaInterconnectExpectedOutagesIssueTypeEnum") :
        ]
...
class InterconnectStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectStateEnum.Value(
            "ComputeAlphaInterconnectStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeAlphaInterconnectStateEnum.Name(resource)[
