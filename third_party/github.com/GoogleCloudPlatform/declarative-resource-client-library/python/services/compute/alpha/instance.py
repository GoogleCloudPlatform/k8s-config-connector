...
class Instance(object):
    ...
    def apply(self):
        stub = instance_pb2_grpc.ComputeAlphaInstanceServiceStub(channel.Channel())
        request = instance_pb2.ApplyComputeAlphaInstanceRequest()
        ...
        response = stub.ApplyComputeAlphaInstance(request)
    ...
    def delete(self):
        stub = instance_pb2_grpc.ComputeAlphaInstanceServiceStub(channel.Channel())
        request = instance_pb2.DeleteComputeAlphaInstanceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.can_ip_forward):
            request.resource.can_ip_forward = Primitive.to_proto(self.can_ip_forward)
        ...
        response = stub.DeleteComputeAlphaInstance(request)

    @classmethod
    def list(self, project, zone, service_account_file=""):
        stub = instance_pb2_grpc.ComputeAlphaInstanceServiceStub(channel.Channel())
        request = instance_pb2.ListComputeAlphaInstanceRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Zone = zone

        return stub.ListComputeAlphaInstance(request).items

    def to_proto(self):
        resource = instance_pb2.ComputeAlphaInstance()
        if Primitive.to_proto(self.can_ip_forward):
...
class InstanceDisks(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceDisks()
...
class InstanceDisksDiskEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceDisksDiskEncryptionKey()
...
class InstanceDisksInitializeParams(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceDisksInitializeParams()
...
class InstanceDisksInitializeParamsSourceImageEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_pb2.ComputeAlphaInstanceDisksInitializeParamsSourceImageEncryptionKey()
        )
        if Primitive.to_proto(resource.raw_key):
            res.raw_key = Primitive.to_proto(resource.raw_key)
        if Primitive.to_proto(resource.sha256):
...
class InstanceGuestAccelerators(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceGuestAccelerators()
...
class InstanceNetworkInterfaces(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceNetworkInterfaces()
...
class InstanceNetworkInterfacesAccessConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceNetworkInterfacesAccessConfigs()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class InstanceNetworkInterfacesIPv6AccessConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigs()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        if Primitive.to_proto(resource.nat_ip):
            res.nat_ip = Primitive.to_proto(resource.nat_ip)
...
class InstanceNetworkInterfacesAliasIPRanges(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceNetworkInterfacesAliasIPRanges()
...
class InstanceScheduling(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceScheduling()
...
class InstanceServiceAccounts(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceServiceAccounts()
...
class InstanceShieldedInstanceConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeAlphaInstanceShieldedInstanceConfig()
...
class InstanceDisksInterfaceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceDisksInterfaceEnum.Value(
            "ComputeAlphaInstanceDisksInterfaceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceDisksInterfaceEnum.Name(resource)[
            len("ComputeAlphaInstanceDisksInterfaceEnum") :
        ]
...
class InstanceDisksModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceDisksModeEnum.Value(
            "ComputeAlphaInstanceDisksModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceDisksModeEnum.Name(resource)[
            len("ComputeAlphaInstanceDisksModeEnum") :
        ]
...
class InstanceDisksTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceDisksTypeEnum.Value(
            "ComputeAlphaInstanceDisksTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceDisksTypeEnum.Name(resource)[
            len("ComputeAlphaInstanceDisksTypeEnum") :
        ]
...
class InstanceNetworkInterfacesAccessConfigsNetworkTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum.Value(
            "ComputeAlphaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum.Name(
            resource
        )[
            len("ComputeAlphaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum") :
        ]
...
class InstanceNetworkInterfacesAccessConfigsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesAccessConfigsTypeEnum.Value(
            "ComputeAlphaInstanceNetworkInterfacesAccessConfigsTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesAccessConfigsTypeEnum.Name(
            resource
        )[
            len("ComputeAlphaInstanceNetworkInterfacesAccessConfigsTypeEnum") :
        ]
...
class InstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum.Value(
            "ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum.Name(
            resource
        )[
            len(
                "ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum"
            ) :
        ]
...
class InstanceNetworkInterfacesIPv6AccessConfigsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum.Value(
            "ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum.Name(
            resource
        )[
            len("ComputeAlphaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum") :
        ]
...
class InstanceStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceStatusEnum.Value(
            "ComputeAlphaInstanceStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeAlphaInstanceStatusEnum.Name(resource)[
            len("ComputeAlphaInstanceStatusEnum") :
        ]
