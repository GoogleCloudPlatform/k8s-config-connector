...
class FirewallPolicyAssociation(object):
    ...
    def apply(self):
        stub = firewall_policy_association_pb2_grpc.ComputeAlphaFirewallPolicyAssociationServiceStub(
            channel.Channel()
        )
        request = (
            firewall_policy_association_pb2.ApplyComputeAlphaFirewallPolicyAssociationRequest()
        )
        ...
        response = stub.ApplyComputeAlphaFirewallPolicyAssociation(request)
    ...
    def delete(self):
        ...
        request = (
            firewall_policy_association_pb2.DeleteComputeAlphaFirewallPolicyAssociationRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeAlphaFirewallPolicyAssociation(request)
    ...
    def list(self, firewallPolicy, service_account_file=""):
        ...
        request = (
            firewall_policy_association_pb2.ListComputeAlphaFirewallPolicyAssociationRequest()
        )
        request.service_account_file = service_account_file
        request.FirewallPolicy = firewallPolicy

        return stub.ListComputeAlphaFirewallPolicyAssociation(request).items

    def to_proto(self):
        resource = (
            firewall_policy_association_pb2.ComputeAlphaFirewallPolicyAssociation()
        )
        if Primitive.to_proto(self.name):
