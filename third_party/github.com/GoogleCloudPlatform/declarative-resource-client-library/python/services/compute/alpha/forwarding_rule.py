...
class ForwardingRule(object):
    ...
    def apply(self):
        ...
        request = forwarding_rule_pb2.ApplyComputeAlphaForwardingRuleRequest()
    ...
    def delete(self):
        ...
        request = forwarding_rule_pb2.DeleteComputeAlphaForwardingRuleRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.labels):
            request.resource.labels = Primitive.to_proto(self.labels)
    ...
    def to_proto(self):
        resource = forwarding_rule_pb2.ComputeAlphaForwardingRule()
        if Primitive.to_proto(self.labels):
...
class ForwardingRuleMetadataFilter(object):
    ...
    def to_proto(self, resource):
        ...
        res = forwarding_rule_pb2.ComputeAlphaForwardingRuleMetadataFilter()
...
class ForwardingRuleMetadataFilterFilterLabel(object):
    ...
    def to_proto(self, resource):
        ...
        res = forwarding_rule_pb2.ComputeAlphaForwardingRuleMetadataFilterFilterLabel()
...
class ForwardingRuleServiceDirectoryRegistrations(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            forwarding_rule_pb2.ComputeAlphaForwardingRuleServiceDirectoryRegistrations()
        )
...
class ForwardingRuleIPProtocolEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleIPProtocolEnum.Value(
            "ComputeAlphaForwardingRuleIPProtocolEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleIPProtocolEnum.Name(
            resource
        )[len("ComputeAlphaForwardingRuleIPProtocolEnum") :]
...
class ForwardingRuleIPVersionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleIPVersionEnum.Value(
            "ComputeAlphaForwardingRuleIPVersionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleIPVersionEnum.Name(
            resource
        )[len("ComputeAlphaForwardingRuleIPVersionEnum") :]
...
class ForwardingRuleLoadBalancingSchemeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            forwarding_rule_pb2.ComputeAlphaForwardingRuleLoadBalancingSchemeEnum.Value(
                "ComputeAlphaForwardingRuleLoadBalancingSchemeEnum%s" % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            forwarding_rule_pb2.ComputeAlphaForwardingRuleLoadBalancingSchemeEnum.Name(
                resource
            )[len("ComputeAlphaForwardingRuleLoadBalancingSchemeEnum") :]
        )
...
class ForwardingRuleMetadataFilterFilterMatchCriteriaEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleMetadataFilterFilterMatchCriteriaEnum.Value(
            "ComputeAlphaForwardingRuleMetadataFilterFilterMatchCriteriaEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleMetadataFilterFilterMatchCriteriaEnum.Name(
            resource
        )[
            len("ComputeAlphaForwardingRuleMetadataFilterFilterMatchCriteriaEnum") :
        ]
...
class ForwardingRuleNetworkTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleNetworkTierEnum.Value(
            "ComputeAlphaForwardingRuleNetworkTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleNetworkTierEnum.Name(
            resource
        )[len("ComputeAlphaForwardingRuleNetworkTierEnum") :]
...
class ForwardingRulePscConnectionStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            forwarding_rule_pb2.ComputeAlphaForwardingRulePscConnectionStatusEnum.Value(
                "ComputeAlphaForwardingRulePscConnectionStatusEnum%s" % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            forwarding_rule_pb2.ComputeAlphaForwardingRulePscConnectionStatusEnum.Name(
                resource
            )[len("ComputeAlphaForwardingRulePscConnectionStatusEnum") :]
        )
