...
class PacketMirroring(object):
    ...
    def apply(self):
        ...
        request = packet_mirroring_pb2.ApplyComputeAlphaPacketMirroringRequest()
        ...
        response = stub.ApplyComputeAlphaPacketMirroring(request)
    ...
    def to_proto(self):
        resource = packet_mirroring_pb2.ComputeAlphaPacketMirroring()
        if Primitive.to_proto(self.name):
...
class PacketMirroringNetwork(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputeAlphaPacketMirroringNetwork()
...
class PacketMirroringCollectorIlb(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputeAlphaPacketMirroringCollectorIlb()
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
        if Primitive.to_proto(resource.canonical_url):
            res.canonical_url = Primitive.to_proto(resource.canonical_url)
...
class PacketMirroringMirroredResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputeAlphaPacketMirroringMirroredResources()
...
class PacketMirroringMirroredResourcesSubnetworks(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            packet_mirroring_pb2.ComputeAlphaPacketMirroringMirroredResourcesSubnetworks()
        )
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
        if Primitive.to_proto(resource.canonical_url):
...
class PacketMirroringMirroredResourcesInstances(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            packet_mirroring_pb2.ComputeAlphaPacketMirroringMirroredResourcesInstances()
        )
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
        if Primitive.to_proto(resource.canonical_url):
...
class PacketMirroringFilter(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputeAlphaPacketMirroringFilter()
...
class PacketMirroringFilterDirectionEnum(object):
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return packet_mirroring_pb2.ComputeAlphaPacketMirroringFilterDirectionEnum.Name(
            resource
        )[len("ComputeAlphaPacketMirroringFilterDirectionEnum") :]
...
class PacketMirroringEnableEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return packet_mirroring_pb2.ComputeAlphaPacketMirroringEnableEnum.Value(
            "ComputeAlphaPacketMirroringEnableEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return packet_mirroring_pb2.ComputeAlphaPacketMirroringEnableEnum.Name(
            resource
        )[len("ComputeAlphaPacketMirroringEnableEnum") :]
