...
class VpnGateway(object):
    ...
    def apply(self):
        ...
        request = vpn_gateway_pb2.ApplyComputeVpnGatewayRequest()
        ...
        response = stub.ApplyComputeVpnGateway(request)
    ...
    def list(self, project, region, service_account_file=""):
        stub = vpn_gateway_pb2_grpc.ComputeVpnGatewayServiceStub(channel.Channel())
        request = vpn_gateway_pb2.ListComputeVpnGatewayRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Region = region

        return stub.ListComputeVpnGateway(request).items
...
class VpnGatewayVpnInterface(object):
    ...
    def to_proto(self, resource):
        ...
        res = vpn_gateway_pb2.ComputeVpnGatewayVpnInterface()
