...
class ServiceAttachment(object):
    ...
    def apply(self):
        stub = service_attachment_pb2_grpc.ComputeBetaServiceAttachmentServiceStub(
            channel.Channel()
        )
        request = service_attachment_pb2.ApplyComputeBetaServiceAttachmentRequest()
        ...
        response = stub.ApplyComputeBetaServiceAttachment(request)
    ...
    def delete(self):
        ...
        request = service_attachment_pb2.DeleteComputeBetaServiceAttachmentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeBetaServiceAttachment(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = service_attachment_pb2.ListComputeBetaServiceAttachmentRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListComputeBetaServiceAttachment(request).items

    def to_proto(self):
        resource = service_attachment_pb2.ComputeBetaServiceAttachment()
        if Primitive.to_proto(self.name):
...
class ServiceAttachmentConnectedEndpoints(object):
    ...
    def to_proto(self, resource):
        ...
        res = service_attachment_pb2.ComputeBetaServiceAttachmentConnectedEndpoints()
...
class ServiceAttachmentConsumerAcceptLists(object):
    ...
    def to_proto(self, resource):
        ...
        res = service_attachment_pb2.ComputeBetaServiceAttachmentConsumerAcceptLists()
...
class ServiceAttachmentPscServiceAttachmentId(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_attachment_pb2.ComputeBetaServiceAttachmentPscServiceAttachmentId()
        )
...
class ServiceAttachmentConnectionPreferenceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeBetaServiceAttachmentConnectionPreferenceEnum.Value(
            "ComputeBetaServiceAttachmentConnectionPreferenceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeBetaServiceAttachmentConnectionPreferenceEnum.Name(
            resource
        )[
            len("ComputeBetaServiceAttachmentConnectionPreferenceEnum") :
        ]
...
class ServiceAttachmentConnectedEndpointsStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeBetaServiceAttachmentConnectedEndpointsStatusEnum.Value(
            "ComputeBetaServiceAttachmentConnectedEndpointsStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeBetaServiceAttachmentConnectedEndpointsStatusEnum.Name(
            resource
        )[
            len("ComputeBetaServiceAttachmentConnectedEndpointsStatusEnum") :
        ]
