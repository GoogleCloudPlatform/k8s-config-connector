...
class NetworkFirewallPolicyAssociation(object):
    ...
    def apply(self):
        stub = network_firewall_policy_association_pb2_grpc.ComputeBetaNetworkFirewallPolicyAssociationServiceStub(
            channel.Channel()
        )
        request = (
            network_firewall_policy_association_pb2.ApplyComputeBetaNetworkFirewallPolicyAssociationRequest()
        )
        ...
        response = stub.ApplyComputeBetaNetworkFirewallPolicyAssociation(request)
    ...
    def delete(self):
        ...
        request = (
            network_firewall_policy_association_pb2.DeleteComputeBetaNetworkFirewallPolicyAssociationRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeBetaNetworkFirewallPolicyAssociation(request)
    ...
    def list(self, project, location, firewallPolicy, service_account_file=""):
        ...
        request = (
            network_firewall_policy_association_pb2.ListComputeBetaNetworkFirewallPolicyAssociationRequest()
        )
        ...
        return stub.ListComputeBetaNetworkFirewallPolicyAssociation(request).items

    def to_proto(self):
        resource = (
            network_firewall_policy_association_pb2.ComputeBetaNetworkFirewallPolicyAssociation()
        )
        if Primitive.to_proto(self.name):
