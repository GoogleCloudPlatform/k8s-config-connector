...
class Instance(object):
    ...
    def apply(self):
        ...
        request = instance_pb2.ApplyComputeBetaInstanceRequest()
        ...
        response = stub.ApplyComputeBetaInstance(request)
    ...
    def list(self, project, zone, service_account_file=""):
        stub = instance_pb2_grpc.ComputeBetaInstanceServiceStub(channel.Channel())
        request = instance_pb2.ListComputeBetaInstanceRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Zone = zone

        return stub.ListComputeBetaInstance(request).items
...
class InstanceDisks(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceDisks()
...
class InstanceDisksDiskEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceDisksDiskEncryptionKey()
...
class InstanceDisksInitializeParams(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceDisksInitializeParams()
...
class InstanceDisksInitializeParamsSourceImageEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_pb2.ComputeBetaInstanceDisksInitializeParamsSourceImageEncryptionKey()
        )
        if Primitive.to_proto(resource.raw_key):
            res.raw_key = Primitive.to_proto(resource.raw_key)
        if Primitive.to_proto(resource.sha256):
...
class InstanceGuestAccelerators(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceGuestAccelerators()
...
class InstanceNetworkInterfaces(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceNetworkInterfaces()
...
class InstanceNetworkInterfacesAccessConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceNetworkInterfacesAccessConfigs()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class InstanceNetworkInterfacesIPv6AccessConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigs()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        if Primitive.to_proto(resource.nat_ip):
            res.nat_ip = Primitive.to_proto(resource.nat_ip)
...
class InstanceNetworkInterfacesAliasIPRanges(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceNetworkInterfacesAliasIPRanges()
...
class InstanceScheduling(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceScheduling()
...
class InstanceServiceAccounts(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceServiceAccounts()
...
class InstanceShieldedInstanceConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.ComputeBetaInstanceShieldedInstanceConfig()
...
class InstanceDisksInterfaceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceDisksInterfaceEnum.Value(
            "ComputeBetaInstanceDisksInterfaceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceDisksInterfaceEnum.Name(resource)[
            len("ComputeBetaInstanceDisksInterfaceEnum") :
        ]
...
class InstanceDisksModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceDisksModeEnum.Value(
            "ComputeBetaInstanceDisksModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceDisksModeEnum.Name(resource)[
            len("ComputeBetaInstanceDisksModeEnum") :
        ]
...
class InstanceDisksTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceDisksTypeEnum.Value(
            "ComputeBetaInstanceDisksTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceDisksTypeEnum.Name(resource)[
            len("ComputeBetaInstanceDisksTypeEnum") :
        ]
...
class InstanceNetworkInterfacesAccessConfigsNetworkTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum.Value(
            "ComputeBetaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum.Name(
            resource
        )[
            len("ComputeBetaInstanceNetworkInterfacesAccessConfigsNetworkTierEnum") :
        ]
...
class InstanceNetworkInterfacesAccessConfigsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceNetworkInterfacesAccessConfigsTypeEnum.Value(
            "ComputeBetaInstanceNetworkInterfacesAccessConfigsTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            instance_pb2.ComputeBetaInstanceNetworkInterfacesAccessConfigsTypeEnum.Name(
                resource
            )[len("ComputeBetaInstanceNetworkInterfacesAccessConfigsTypeEnum") :]
        )
...
class InstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum.Value(
            "ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum.Name(
            resource
        )[
            len(
                "ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsNetworkTierEnum"
            ) :
        ]
...
class InstanceNetworkInterfacesIPv6AccessConfigsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum.Value(
            "ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum.Name(
            resource
        )[
            len("ComputeBetaInstanceNetworkInterfacesIPv6AccessConfigsTypeEnum") :
        ]
...
class InstanceStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceStatusEnum.Value(
            "ComputeBetaInstanceStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.ComputeBetaInstanceStatusEnum.Name(resource)[
            len("ComputeBetaInstanceStatusEnum") :
        ]
