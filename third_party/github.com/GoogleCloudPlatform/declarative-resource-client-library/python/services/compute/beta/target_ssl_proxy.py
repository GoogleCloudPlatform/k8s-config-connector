...
class TargetSslProxy(object):
    ...
    def apply(self):
        stub = target_ssl_proxy_pb2_grpc.ComputeBetaTargetSslProxyServiceStub(
            channel.Channel()
        )
        request = target_ssl_proxy_pb2.ApplyComputeBetaTargetSslProxyRequest()
        ...
        response = stub.ApplyComputeBetaTargetSslProxy(request)
    ...
    def delete(self):
        ...
        request = target_ssl_proxy_pb2.DeleteComputeBetaTargetSslProxyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.id):
            request.resource.id = Primitive.to_proto(self.id)
        ...
        response = stub.DeleteComputeBetaTargetSslProxy(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = target_ssl_proxy_pb2.ListComputeBetaTargetSslProxyRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListComputeBetaTargetSslProxy(request).items

    def to_proto(self):
        resource = target_ssl_proxy_pb2.ComputeBetaTargetSslProxy()
        if Primitive.to_proto(self.id):
...
class TargetSslProxyProxyHeaderEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return target_ssl_proxy_pb2.ComputeBetaTargetSslProxyProxyHeaderEnum.Value(
            "ComputeBetaTargetSslProxyProxyHeaderEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return target_ssl_proxy_pb2.ComputeBetaTargetSslProxyProxyHeaderEnum.Name(
            resource
        )[len("ComputeBetaTargetSslProxyProxyHeaderEnum") :]
