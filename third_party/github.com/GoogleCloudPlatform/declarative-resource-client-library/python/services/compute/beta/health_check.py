...
class HealthCheck(object):
    ...
    def apply(self):
        stub = health_check_pb2_grpc.ComputeBetaHealthCheckServiceStub(
            channel.Channel()
        )
        request = health_check_pb2.ApplyComputeBetaHealthCheckRequest()
        ...
        response = stub.ApplyComputeBetaHealthCheck(request)
    ...
    def delete(self):
        ...
        request = health_check_pb2.DeleteComputeBetaHealthCheckRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.check_interval_sec):
            request.resource.check_interval_sec = Primitive.to_proto(
                self.check_interval_sec
        ...
        response = stub.DeleteComputeBetaHealthCheck(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = health_check_pb2.ListComputeBetaHealthCheckRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListComputeBetaHealthCheck(request).items

    def to_proto(self):
        resource = health_check_pb2.ComputeBetaHealthCheck()
        if Primitive.to_proto(self.check_interval_sec):
...
class HealthCheckHttp2HealthCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = health_check_pb2.ComputeBetaHealthCheckHttp2HealthCheck()
...
class HealthCheckHttpHealthCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = health_check_pb2.ComputeBetaHealthCheckHttpHealthCheck()
        if Primitive.to_proto(resource.port):
            res.port = Primitive.to_proto(resource.port)
        if Primitive.to_proto(resource.port_name):
            res.port_name = Primitive.to_proto(resource.port_name)
...
class HealthCheckHttpsHealthCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = health_check_pb2.ComputeBetaHealthCheckHttpsHealthCheck()
        if Primitive.to_proto(resource.port):
            res.port = Primitive.to_proto(resource.port)
        if Primitive.to_proto(resource.port_name):
            res.port_name = Primitive.to_proto(resource.port_name)
...
class HealthCheckSslHealthCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = health_check_pb2.ComputeBetaHealthCheckSslHealthCheck()
        if Primitive.to_proto(resource.port):
            res.port = Primitive.to_proto(resource.port)
        if Primitive.to_proto(resource.port_name):
            res.port_name = Primitive.to_proto(resource.port_name)
...
class HealthCheckTcpHealthCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = health_check_pb2.ComputeBetaHealthCheckTcpHealthCheck()
        if Primitive.to_proto(resource.port):
            res.port = Primitive.to_proto(resource.port)
        if Primitive.to_proto(resource.port_name):
            res.port_name = Primitive.to_proto(resource.port_name)
...
class HealthCheckHttp2HealthCheckPortSpecificationEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttp2HealthCheckPortSpecificationEnum.Value(
            "ComputeBetaHealthCheckHttp2HealthCheckPortSpecificationEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttp2HealthCheckPortSpecificationEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckHttp2HealthCheckPortSpecificationEnum") :
        ]
...
class HealthCheckHttp2HealthCheckProxyHeaderEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttp2HealthCheckProxyHeaderEnum.Value(
            "ComputeBetaHealthCheckHttp2HealthCheckProxyHeaderEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttp2HealthCheckProxyHeaderEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckHttp2HealthCheckProxyHeaderEnum") :
        ]
...
class HealthCheckHttpHealthCheckPortSpecificationEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpHealthCheckPortSpecificationEnum.Value(
            "ComputeBetaHealthCheckHttpHealthCheckPortSpecificationEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpHealthCheckPortSpecificationEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckHttpHealthCheckPortSpecificationEnum") :
        ]
...
class HealthCheckHttpHealthCheckProxyHeaderEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpHealthCheckProxyHeaderEnum.Value(
            "ComputeBetaHealthCheckHttpHealthCheckProxyHeaderEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpHealthCheckProxyHeaderEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckHttpHealthCheckProxyHeaderEnum") :
        ]
...
class HealthCheckHttpsHealthCheckPortSpecificationEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpsHealthCheckPortSpecificationEnum.Value(
            "ComputeBetaHealthCheckHttpsHealthCheckPortSpecificationEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpsHealthCheckPortSpecificationEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckHttpsHealthCheckPortSpecificationEnum") :
        ]
...
class HealthCheckHttpsHealthCheckProxyHeaderEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpsHealthCheckProxyHeaderEnum.Value(
            "ComputeBetaHealthCheckHttpsHealthCheckProxyHeaderEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckHttpsHealthCheckProxyHeaderEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckHttpsHealthCheckProxyHeaderEnum") :
        ]
...
class HealthCheckSslHealthCheckPortSpecificationEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckSslHealthCheckPortSpecificationEnum.Value(
            "ComputeBetaHealthCheckSslHealthCheckPortSpecificationEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckSslHealthCheckPortSpecificationEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckSslHealthCheckPortSpecificationEnum") :
        ]
...
class HealthCheckSslHealthCheckProxyHeaderEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckSslHealthCheckProxyHeaderEnum.Value(
            "ComputeBetaHealthCheckSslHealthCheckProxyHeaderEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckSslHealthCheckProxyHeaderEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckSslHealthCheckProxyHeaderEnum") :
        ]
...
class HealthCheckTcpHealthCheckPortSpecificationEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckTcpHealthCheckPortSpecificationEnum.Value(
            "ComputeBetaHealthCheckTcpHealthCheckPortSpecificationEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckTcpHealthCheckPortSpecificationEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckTcpHealthCheckPortSpecificationEnum") :
        ]
...
class HealthCheckTcpHealthCheckProxyHeaderEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckTcpHealthCheckProxyHeaderEnum.Value(
            "ComputeBetaHealthCheckTcpHealthCheckProxyHeaderEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckTcpHealthCheckProxyHeaderEnum.Name(
            resource
        )[
            len("ComputeBetaHealthCheckTcpHealthCheckProxyHeaderEnum") :
        ]
...
class HealthCheckTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckTypeEnum.Value(
            "ComputeBetaHealthCheckTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return health_check_pb2.ComputeBetaHealthCheckTypeEnum.Name(resource)[
            len("ComputeBetaHealthCheckTypeEnum") :
        ]
