...
class Image(object):
    ...
    def apply(self):
        stub = image_pb2_grpc.ComputeBetaImageServiceStub(channel.Channel())
        request = image_pb2.ApplyComputeBetaImageRequest()
        ...
        response = stub.ApplyComputeBetaImage(request)
    ...
    def delete(self):
        stub = image_pb2_grpc.ComputeBetaImageServiceStub(channel.Channel())
        request = image_pb2.DeleteComputeBetaImageRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
        ...
        response = stub.DeleteComputeBetaImage(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = image_pb2_grpc.ComputeBetaImageServiceStub(channel.Channel())
        request = image_pb2.ListComputeBetaImageRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListComputeBetaImage(request).items

    def to_proto(self):
        resource = image_pb2.ComputeBetaImage()
        if Primitive.to_proto(self.description):
...
class ImageImageEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageImageEncryptionKey()
...
class ImageRawDisk(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageRawDisk()
...
class ImageShieldedInstanceInitialState(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageShieldedInstanceInitialState()
...
class ImageShieldedInstanceInitialStatePk(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageShieldedInstanceInitialStatePk()
...
class ImageShieldedInstanceInitialStateKek(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageShieldedInstanceInitialStateKek()
        if Primitive.to_proto(resource.content):
            res.content = Primitive.to_proto(resource.content)
...
class ImageShieldedInstanceInitialStateDb(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageShieldedInstanceInitialStateDb()
        if Primitive.to_proto(resource.content):
            res.content = Primitive.to_proto(resource.content)
...
class ImageShieldedInstanceInitialStateDbx(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageShieldedInstanceInitialStateDbx()
        if Primitive.to_proto(resource.content):
            res.content = Primitive.to_proto(resource.content)
...
class ImageSourceDiskEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageSourceDiskEncryptionKey()
        if Primitive.to_proto(resource.raw_key):
            res.raw_key = Primitive.to_proto(resource.raw_key)
        if Primitive.to_proto(resource.kms_key_name):
            res.kms_key_name = Primitive.to_proto(resource.kms_key_name)
...
class ImageSourceImageEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageSourceImageEncryptionKey()
        if Primitive.to_proto(resource.raw_key):
            res.raw_key = Primitive.to_proto(resource.raw_key)
        if Primitive.to_proto(resource.kms_key_name):
            res.kms_key_name = Primitive.to_proto(resource.kms_key_name)
...
class ImageSourceSnapshotEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageSourceSnapshotEncryptionKey()
        if Primitive.to_proto(resource.raw_key):
            res.raw_key = Primitive.to_proto(resource.raw_key)
        if Primitive.to_proto(resource.kms_key_name):
            res.kms_key_name = Primitive.to_proto(resource.kms_key_name)
...
class ImageDeprecated(object):
    ...
    def to_proto(self, resource):
        ...
        res = image_pb2.ComputeBetaImageDeprecated()
...
class ImageRawDiskContainerTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageRawDiskContainerTypeEnum.Value(
            "ComputeBetaImageRawDiskContainerTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageRawDiskContainerTypeEnum.Name(resource)[
            len("ComputeBetaImageRawDiskContainerTypeEnum") :
        ]
...
class ImageShieldedInstanceInitialStatePkFileTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStatePkFileTypeEnum.Value(
            "ComputeBetaImageShieldedInstanceInitialStatePkFileTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStatePkFileTypeEnum.Name(
            resource
        )[
            len("ComputeBetaImageShieldedInstanceInitialStatePkFileTypeEnum") :
        ]
...
class ImageShieldedInstanceInitialStateKekFileTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStateKekFileTypeEnum.Value(
            "ComputeBetaImageShieldedInstanceInitialStateKekFileTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStateKekFileTypeEnum.Name(
            resource
        )[
            len("ComputeBetaImageShieldedInstanceInitialStateKekFileTypeEnum") :
        ]
...
class ImageShieldedInstanceInitialStateDbFileTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStateDbFileTypeEnum.Value(
            "ComputeBetaImageShieldedInstanceInitialStateDbFileTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStateDbFileTypeEnum.Name(
            resource
        )[
            len("ComputeBetaImageShieldedInstanceInitialStateDbFileTypeEnum") :
        ]
...
class ImageShieldedInstanceInitialStateDbxFileTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStateDbxFileTypeEnum.Value(
            "ComputeBetaImageShieldedInstanceInitialStateDbxFileTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageShieldedInstanceInitialStateDbxFileTypeEnum.Name(
            resource
        )[
            len("ComputeBetaImageShieldedInstanceInitialStateDbxFileTypeEnum") :
        ]
...
class ImageSourceTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageSourceTypeEnum.Value(
            "ComputeBetaImageSourceTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageSourceTypeEnum.Name(resource)[
            len("ComputeBetaImageSourceTypeEnum") :
        ]
...
class ImageStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageStatusEnum.Value(
            "ComputeBetaImageStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageStatusEnum.Name(resource)[
            len("ComputeBetaImageStatusEnum") :
        ]
...
class ImageDeprecatedStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageDeprecatedStateEnum.Value(
            "ComputeBetaImageDeprecatedStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return image_pb2.ComputeBetaImageDeprecatedStateEnum.Name(resource)[
            len("ComputeBetaImageDeprecatedStateEnum") :
        ]
