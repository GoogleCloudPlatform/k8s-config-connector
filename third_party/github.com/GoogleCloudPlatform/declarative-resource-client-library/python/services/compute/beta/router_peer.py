...
class RouterPeer(object):
    ...
    def apply(self):
        ...
        request = router_peer_pb2.ApplyComputeBetaRouterPeerRequest()
        ...
        response = stub.ApplyComputeBetaRouterPeer(request)
    ...
    def list(self, project, region, service_account_file=""):
        stub = router_peer_pb2_grpc.ComputeBetaRouterPeerServiceStub(channel.Channel())
        request = router_peer_pb2.ListComputeBetaRouterPeerRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Region = region

        return stub.ListComputeBetaRouterPeer(request).items
...
class RouterPeerAdvertisedIPRanges(object):
    ...
    def to_proto(self, resource):
        ...
        res = router_peer_pb2.ComputeBetaRouterPeerAdvertisedIPRanges()
