...
class InterconnectAttachment(object):
    ...
    def apply(self):
        stub = interconnect_attachment_pb2_grpc.ComputeBetaInterconnectAttachmentServiceStub(
            channel.Channel()
        )
        request = (
            interconnect_attachment_pb2.ApplyComputeBetaInterconnectAttachmentRequest()
        )
        ...
        response = stub.ApplyComputeBetaInterconnectAttachment(request)
    ...
    def delete(self):
        ...
        request = (
            interconnect_attachment_pb2.DeleteComputeBetaInterconnectAttachmentRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
        ...
        response = stub.DeleteComputeBetaInterconnectAttachment(request)
    ...
    def list(self, project, region, service_account_file=""):
        ...
        request = (
            interconnect_attachment_pb2.ListComputeBetaInterconnectAttachmentRequest()
        )
        ...
        return stub.ListComputeBetaInterconnectAttachment(request).items

    def to_proto(self):
        resource = interconnect_attachment_pb2.ComputeBetaInterconnectAttachment()
        if Primitive.to_proto(self.description):
...
class InterconnectAttachmentPrivateInterconnectInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentPrivateInterconnectInfo()
        )
...
class InterconnectAttachmentPartnerMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentPartnerMetadata()
        )
...
class InterconnectAttachmentOperationalStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentOperationalStatusEnum.Value(
            "ComputeBetaInterconnectAttachmentOperationalStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentOperationalStatusEnum.Name(
            resource
        )[
            len("ComputeBetaInterconnectAttachmentOperationalStatusEnum") :
        ]
...
class InterconnectAttachmentTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentTypeEnum.Value(
                "ComputeBetaInterconnectAttachmentTypeEnum%s" % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentTypeEnum.Name(
                resource
            )[len("ComputeBetaInterconnectAttachmentTypeEnum") :]
        )
...
class InterconnectAttachmentEdgeAvailabilityDomainEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentEdgeAvailabilityDomainEnum.Value(
            "ComputeBetaInterconnectAttachmentEdgeAvailabilityDomainEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentEdgeAvailabilityDomainEnum.Name(
            resource
        )[
            len("ComputeBetaInterconnectAttachmentEdgeAvailabilityDomainEnum") :
        ]
...
class InterconnectAttachmentBandwidthEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentBandwidthEnum.Value(
            "ComputeBetaInterconnectAttachmentBandwidthEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentBandwidthEnum.Name(
            resource
        )[
            len("ComputeBetaInterconnectAttachmentBandwidthEnum") :
        ]
...
class InterconnectAttachmentStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentStateEnum.Value(
            "ComputeBetaInterconnectAttachmentStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentStateEnum.Name(
                resource
            )[len("ComputeBetaInterconnectAttachmentStateEnum") :]
        )
...
class InterconnectAttachmentEncryptionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentEncryptionEnum.Value(
            "ComputeBetaInterconnectAttachmentEncryptionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentEncryptionEnum.Name(
            resource
        )[
            len("ComputeBetaInterconnectAttachmentEncryptionEnum") :
        ]
