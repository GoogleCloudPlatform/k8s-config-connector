...
class Interconnect(object):
    ...
    def apply(self):
        stub = interconnect_pb2_grpc.ComputeBetaInterconnectServiceStub(
            channel.Channel()
        )
        request = interconnect_pb2.ApplyComputeBetaInterconnectRequest()
        ...
        response = stub.ApplyComputeBetaInterconnect(request)
    ...
    def delete(self):
        ...
        request = interconnect_pb2.DeleteComputeBetaInterconnectRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
        ...
        response = stub.DeleteComputeBetaInterconnect(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = interconnect_pb2.ListComputeBetaInterconnectRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListComputeBetaInterconnect(request).items

    def to_proto(self):
        resource = interconnect_pb2.ComputeBetaInterconnect()
        if Primitive.to_proto(self.description):
...
class InterconnectExpectedOutages(object):
    ...
    def to_proto(self, resource):
        ...
        res = interconnect_pb2.ComputeBetaInterconnectExpectedOutages()
...
class InterconnectCircuitInfos(object):
    ...
    def to_proto(self, resource):
        ...
        res = interconnect_pb2.ComputeBetaInterconnectCircuitInfos()
...
class InterconnectLinkTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectLinkTypeEnum.Value(
            "ComputeBetaInterconnectLinkTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectLinkTypeEnum.Name(resource)[
            len("ComputeBetaInterconnectLinkTypeEnum") :
        ]
...
class InterconnectInterconnectTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectInterconnectTypeEnum.Value(
            "ComputeBetaInterconnectInterconnectTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectInterconnectTypeEnum.Name(
            resource
        )[len("ComputeBetaInterconnectInterconnectTypeEnum") :]
...
class InterconnectOperationalStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectOperationalStatusEnum.Value(
            "ComputeBetaInterconnectOperationalStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectOperationalStatusEnum.Name(
            resource
        )[len("ComputeBetaInterconnectOperationalStatusEnum") :]
...
class InterconnectExpectedOutagesSourceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectExpectedOutagesSourceEnum.Value(
            "ComputeBetaInterconnectExpectedOutagesSourceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectExpectedOutagesSourceEnum.Name(
            resource
        )[len("ComputeBetaInterconnectExpectedOutagesSourceEnum") :]
...
class InterconnectExpectedOutagesStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectExpectedOutagesStateEnum.Value(
            "ComputeBetaInterconnectExpectedOutagesStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectExpectedOutagesStateEnum.Name(
            resource
        )[len("ComputeBetaInterconnectExpectedOutagesStateEnum") :]
...
class InterconnectExpectedOutagesIssueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectExpectedOutagesIssueTypeEnum.Value(
            "ComputeBetaInterconnectExpectedOutagesIssueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectExpectedOutagesIssueTypeEnum.Name(
            resource
        )[
            len("ComputeBetaInterconnectExpectedOutagesIssueTypeEnum") :
        ]
...
class InterconnectStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectStateEnum.Value(
            "ComputeBetaInterconnectStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_pb2.ComputeBetaInterconnectStateEnum.Name(resource)[
            len("ComputeBetaInterconnectStateEnum") :
        ]
