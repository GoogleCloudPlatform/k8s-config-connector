...
class SslPolicy(object):
    ...
    def apply(self):
        ...
        request = ssl_policy_pb2.ApplyComputeBetaSslPolicyRequest()
        ...
        response = stub.ApplyComputeBetaSslPolicy(request)
    ...
    def list(self, project, service_account_file=""):
        stub = ssl_policy_pb2_grpc.ComputeBetaSslPolicyServiceStub(channel.Channel())
        request = ssl_policy_pb2.ListComputeBetaSslPolicyRequest()
...
class SslPolicyWarning(object):
    ...
    def to_proto(self, resource):
        ...
        res = ssl_policy_pb2.ComputeBetaSslPolicyWarning()
...
class SslPolicyWarningData(object):
    ...
    def to_proto(self, resource):
        ...
        res = ssl_policy_pb2.ComputeBetaSslPolicyWarningData()
...
class SslPolicyProfileEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ssl_policy_pb2.ComputeBetaSslPolicyProfileEnum.Value(
            "ComputeBetaSslPolicyProfileEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ssl_policy_pb2.ComputeBetaSslPolicyProfileEnum.Name(resource)[
            len("ComputeBetaSslPolicyProfileEnum") :
        ]
...
class SslPolicyMinTlsVersionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ssl_policy_pb2.ComputeBetaSslPolicyMinTlsVersionEnum.Value(
            "ComputeBetaSslPolicyMinTlsVersionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ssl_policy_pb2.ComputeBetaSslPolicyMinTlsVersionEnum.Name(resource)[
            len("ComputeBetaSslPolicyMinTlsVersionEnum") :
        ]
