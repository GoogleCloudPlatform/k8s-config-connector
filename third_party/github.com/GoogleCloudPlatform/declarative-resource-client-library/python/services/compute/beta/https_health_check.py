...
class HttpsHealthCheck(object):
    ...
    def apply(self):
        stub = https_health_check_pb2_grpc.ComputeBetaHttpsHealthCheckServiceStub(
            channel.Channel()
        )
        request = https_health_check_pb2.ApplyComputeBetaHttpsHealthCheckRequest()
        ...
        response = stub.ApplyComputeBetaHttpsHealthCheck(request)
    ...
    def delete(self):
        ...
        request = https_health_check_pb2.DeleteComputeBetaHttpsHealthCheckRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.check_interval_sec):
            request.resource.check_interval_sec = Primitive.to_proto(
                self.check_interval_sec
        ...
        response = stub.DeleteComputeBetaHttpsHealthCheck(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = https_health_check_pb2.ListComputeBetaHttpsHealthCheckRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListComputeBetaHttpsHealthCheck(request).items

    def to_proto(self):
        resource = https_health_check_pb2.ComputeBetaHttpsHealthCheck()
        if Primitive.to_proto(self.check_interval_sec):
