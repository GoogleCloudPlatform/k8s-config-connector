...
class NetworkEndpointGroup(object):
    ...
    def apply(self):
        ...
        request = (
            network_endpoint_group_pb2.ApplyComputeBetaNetworkEndpointGroupRequest()
        )
        ...
        response = stub.ApplyComputeBetaNetworkEndpointGroup(request)
    ...
    def delete(self):
        ...
        request = (
            network_endpoint_group_pb2.DeleteComputeBetaNetworkEndpointGroupRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = (
            network_endpoint_group_pb2.ListComputeBetaNetworkEndpointGroupRequest()
        )
    ...
    def to_proto(self):
        resource = network_endpoint_group_pb2.ComputeBetaNetworkEndpointGroup()
        if Primitive.to_proto(self.name):
...
class NetworkEndpointGroupCloudRun(object):
    ...
    def to_proto(self, resource):
        ...
        res = network_endpoint_group_pb2.ComputeBetaNetworkEndpointGroupCloudRun()
...
class NetworkEndpointGroupAppEngine(object):
    ...
    def to_proto(self, resource):
        ...
        res = network_endpoint_group_pb2.ComputeBetaNetworkEndpointGroupAppEngine()
        if Primitive.to_proto(resource.service):
            res.service = Primitive.to_proto(resource.service)
...
class NetworkEndpointGroupCloudFunction(object):
    ...
    def to_proto(self, resource):
        ...
        res = network_endpoint_group_pb2.ComputeBetaNetworkEndpointGroupCloudFunction()
...
class NetworkEndpointGroupNetworkEndpointTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_endpoint_group_pb2.ComputeBetaNetworkEndpointGroupNetworkEndpointTypeEnum.Value(
            "ComputeBetaNetworkEndpointGroupNetworkEndpointTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_endpoint_group_pb2.ComputeBetaNetworkEndpointGroupNetworkEndpointTypeEnum.Name(
            resource
        )[
            len("ComputeBetaNetworkEndpointGroupNetworkEndpointTypeEnum") :
        ]
