...
class Autoscaler(object):
    ...
    def apply(self):
        ...
        request = autoscaler_pb2.ApplyComputeBetaAutoscalerRequest()
        ...
        response = stub.ApplyComputeBetaAutoscaler(request)
    ...
    def list(self, project, location, service_account_file=""):
        stub = autoscaler_pb2_grpc.ComputeBetaAutoscalerServiceStub(channel.Channel())
        request = autoscaler_pb2.ListComputeBetaAutoscalerRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListComputeBetaAutoscaler(request).items
...
class AutoscalerAutoscalingPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicy()
...
class AutoscalerAutoscalingPolicyScaleInControl(object):
    ...
    def to_proto(self, resource):
        ...
        res = autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyScaleInControl()
...
class AutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicas(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyScaleInControlMaxScaledInReplicas()
        )
...
class AutoscalerAutoscalingPolicyCpuUtilization(object):
    ...
    def to_proto(self, resource):
        ...
        res = autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyCpuUtilization()
...
class AutoscalerAutoscalingPolicyCustomMetricUtilizations(object):
    def __init__(
        ...
        filter: str = None,
        single_instance_assignment: float = None,
    ):
        self.metric = metric
        self.utilization_target = utilization_target
        self.utilization_target_type = utilization_target_type
        self.filter = filter
        self.single_instance_assignment = single_instance_assignment
    ...
    def to_proto(self, resource):
        ...
        res = (
            autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyCustomMetricUtilizations()
        )
        ...
        if Primitive.to_proto(resource.single_instance_assignment):
            res.single_instance_assignment = Primitive.to_proto(
                resource.single_instance_assignment
            )
        return res
    ...
    def from_proto(self, resource):
        ...
        return AutoscalerAutoscalingPolicyCustomMetricUtilizations(
            ...
            single_instance_assignment=Primitive.from_proto(
                resource.single_instance_assignment
            ),
        )
...
class AutoscalerAutoscalingPolicyLoadBalancingUtilization(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyLoadBalancingUtilization()
        )
        if Primitive.to_proto(resource.utilization_target):
            res.utilization_target = Primitive.to_proto(resource.utilization_target)
        return res
...
class AutoscalerStatusDetails(object):
    ...
    def to_proto(self, resource):
        ...
        res = autoscaler_pb2.ComputeBetaAutoscalerStatusDetails()
...
class AutoscalerAutoscalingPolicyCustomMetricUtilizationsUtilizationTargetTypeEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyCustomMetricUtilizationsUtilizationTargetTypeEnum.Value(
            "ComputeBetaAutoscalerAutoscalingPolicyCustomMetricUtilizationsUtilizationTargetTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyCustomMetricUtilizationsUtilizationTargetTypeEnum.Name(
            resource
        )[
            len(
                "ComputeBetaAutoscalerAutoscalingPolicyCustomMetricUtilizationsUtilizationTargetTypeEnum"
            ) :
        ]
...
class AutoscalerAutoscalingPolicyModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyModeEnum.Value(
            "ComputeBetaAutoscalerAutoscalingPolicyModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerAutoscalingPolicyModeEnum.Name(
            resource
        )[len("ComputeBetaAutoscalerAutoscalingPolicyModeEnum") :]
...
class AutoscalerStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerStatusEnum.Value(
            "ComputeBetaAutoscalerStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerStatusEnum.Name(resource)[
            len("ComputeBetaAutoscalerStatusEnum") :
        ]
...
class AutoscalerStatusDetailsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerStatusDetailsTypeEnum.Value(
            "ComputeBetaAutoscalerStatusDetailsTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return autoscaler_pb2.ComputeBetaAutoscalerStatusDetailsTypeEnum.Name(resource)[
            len("ComputeBetaAutoscalerStatusDetailsTypeEnum") :
        ]
