...
class TargetVpnGateway(object):
    ...
    def apply(self):
        ...
        request = target_vpn_gateway_pb2.ApplyComputeBetaTargetVpnGatewayRequest()
        ...
        response = stub.ApplyComputeBetaTargetVpnGateway(request)
    ...
    def list(self, project, region, service_account_file=""):
        ...
        request = target_vpn_gateway_pb2.ListComputeBetaTargetVpnGatewayRequest()
...
class TargetVpnGatewayStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return target_vpn_gateway_pb2.ComputeBetaTargetVpnGatewayStatusEnum.Value(
            "ComputeBetaTargetVpnGatewayStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return target_vpn_gateway_pb2.ComputeBetaTargetVpnGatewayStatusEnum.Name(
            resource
        )[len("ComputeBetaTargetVpnGatewayStatusEnum") :]
