...
class NetworkFirewallPolicyAssociation(object):
    ...
    def apply(self):
        stub = network_firewall_policy_association_pb2_grpc.ComputeNetworkFirewallPolicyAssociationServiceStub(
            channel.Channel()
        )
        request = (
            network_firewall_policy_association_pb2.ApplyComputeNetworkFirewallPolicyAssociationRequest()
        )
        ...
        response = stub.ApplyComputeNetworkFirewallPolicyAssociation(request)
    ...
    def delete(self):
        ...
        request = (
            network_firewall_policy_association_pb2.DeleteComputeNetworkFirewallPolicyAssociationRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeNetworkFirewallPolicyAssociation(request)
    ...
    def list(self, project, location, firewallPolicy, service_account_file=""):
        ...
        request = (
            network_firewall_policy_association_pb2.ListComputeNetworkFirewallPolicyAssociationRequest()
        )
        ...
        return stub.ListComputeNetworkFirewallPolicyAssociation(request).items

    def to_proto(self):
        resource = (
            network_firewall_policy_association_pb2.ComputeNetworkFirewallPolicyAssociation()
        )
        if Primitive.to_proto(self.name):
