...
class PacketMirroring(object):
    ...
    def apply(self):
        stub = packet_mirroring_pb2_grpc.ComputePacketMirroringServiceStub(
            channel.Channel()
        )
        request = packet_mirroring_pb2.ApplyComputePacketMirroringRequest()
        ...
        response = stub.ApplyComputePacketMirroring(request)
    ...
    def delete(self):
        ...
        request = packet_mirroring_pb2.DeleteComputePacketMirroringRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputePacketMirroring(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = packet_mirroring_pb2.ListComputePacketMirroringRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListComputePacketMirroring(request).items

    def to_proto(self):
        resource = packet_mirroring_pb2.ComputePacketMirroring()
        if Primitive.to_proto(self.name):
...
class PacketMirroringNetwork(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputePacketMirroringNetwork()
...
class PacketMirroringCollectorIlb(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputePacketMirroringCollectorIlb()
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
        if Primitive.to_proto(resource.canonical_url):
            res.canonical_url = Primitive.to_proto(resource.canonical_url)
...
class PacketMirroringMirroredResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputePacketMirroringMirroredResources()
...
class PacketMirroringMirroredResourcesSubnetworks(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputePacketMirroringMirroredResourcesSubnetworks()
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
        if Primitive.to_proto(resource.canonical_url):
            res.canonical_url = Primitive.to_proto(resource.canonical_url)
...
class PacketMirroringMirroredResourcesInstances(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputePacketMirroringMirroredResourcesInstances()
        if Primitive.to_proto(resource.url):
            res.url = Primitive.to_proto(resource.url)
        if Primitive.to_proto(resource.canonical_url):
            res.canonical_url = Primitive.to_proto(resource.canonical_url)
...
class PacketMirroringFilter(object):
    ...
    def to_proto(self, resource):
        ...
        res = packet_mirroring_pb2.ComputePacketMirroringFilter()
...
class PacketMirroringFilterDirectionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return packet_mirroring_pb2.ComputePacketMirroringFilterDirectionEnum.Value(
            "ComputePacketMirroringFilterDirectionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return packet_mirroring_pb2.ComputePacketMirroringFilterDirectionEnum.Name(
            resource
        )[len("ComputePacketMirroringFilterDirectionEnum") :]
...
class PacketMirroringEnableEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return packet_mirroring_pb2.ComputePacketMirroringEnableEnum.Value(
            "ComputePacketMirroringEnableEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return packet_mirroring_pb2.ComputePacketMirroringEnableEnum.Name(resource)[
            len("ComputePacketMirroringEnableEnum") :
        ]
