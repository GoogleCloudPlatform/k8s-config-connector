...
class InstanceTemplateProperties(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_template_pb2.ComputeInstanceTemplateProperties()
...
class InstanceTemplatePropertiesDisks(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_template_pb2.ComputeInstanceTemplatePropertiesDisks()
...
class InstanceTemplatePropertiesDisksDiskEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesDisksDiskEncryptionKey()
        )
...
class InstanceTemplatePropertiesDisksInitializeParams(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesDisksInitializeParams()
        )
...
class InstanceTemplatePropertiesDisksInitializeParamsSourceSnapshotEncryptionKey(
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesDisksInitializeParamsSourceSnapshotEncryptionKey()
        )
        if Primitive.to_proto(resource.raw_key):
            res.raw_key = Primitive.to_proto(resource.raw_key)
        if Primitive.to_proto(resource.sha256):
...
class InstanceTemplatePropertiesDisksInitializeParamsSourceImageEncryptionKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesDisksInitializeParamsSourceImageEncryptionKey()
        )
        if Primitive.to_proto(resource.raw_key):
            res.raw_key = Primitive.to_proto(resource.raw_key)
        if Primitive.to_proto(resource.sha256):
...
class InstanceTemplatePropertiesDisksGuestOSFeatures(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesDisksGuestOSFeatures()
        )
...
class InstanceTemplatePropertiesReservationAffinity(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesReservationAffinity()
        )
...
class InstanceTemplatePropertiesGuestAccelerators(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_template_pb2.ComputeInstanceTemplatePropertiesGuestAccelerators()
...
class InstanceTemplatePropertiesNetworkInterfaces(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_template_pb2.ComputeInstanceTemplatePropertiesNetworkInterfaces()
...
class InstanceTemplatePropertiesNetworkInterfacesAccessConfigs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigs()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class InstanceTemplatePropertiesNetworkInterfacesAliasIPRanges(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesNetworkInterfacesAliasIPRanges()
        )
...
class InstanceTemplatePropertiesShieldedInstanceConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesShieldedInstanceConfig()
        )
...
class InstanceTemplatePropertiesScheduling(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_template_pb2.ComputeInstanceTemplatePropertiesScheduling()
...
class InstanceTemplatePropertiesSchedulingNodeAffinities(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_template_pb2.ComputeInstanceTemplatePropertiesSchedulingNodeAffinities()
        )
        if Primitive.to_proto(resource.key):
            res.key = Primitive.to_proto(resource.key)
...
class InstanceTemplatePropertiesServiceAccounts(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_template_pb2.ComputeInstanceTemplatePropertiesServiceAccounts()
...
class InstanceTemplatePropertiesDisksInterfaceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesDisksInterfaceEnum.Value(
            "ComputeInstanceTemplatePropertiesDisksInterfaceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesDisksInterfaceEnum.Name(
            resource
        )[
            len("ComputeInstanceTemplatePropertiesDisksInterfaceEnum") :
        ]
...
class InstanceTemplatePropertiesDisksModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesDisksModeEnum.Value(
            "ComputeInstanceTemplatePropertiesDisksModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesDisksModeEnum.Name(
            resource
        )[
            len("ComputeInstanceTemplatePropertiesDisksModeEnum") :
        ]
...
class InstanceTemplatePropertiesDisksTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesDisksTypeEnum.Value(
            "ComputeInstanceTemplatePropertiesDisksTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesDisksTypeEnum.Name(
            resource
        )[
            len("ComputeInstanceTemplatePropertiesDisksTypeEnum") :
        ]
...
class InstanceTemplatePropertiesNetworkInterfacesAccessConfigsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsTypeEnum.Value(
            "ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsTypeEnum.Name(
            resource
        )[
            len(
                "ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsTypeEnum"
            ) :
        ]
...
class InstanceTemplatePropertiesNetworkInterfacesAccessConfigsNetworkTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsNetworkTierEnum.Value(
            "ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsNetworkTierEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsNetworkTierEnum.Name(
            resource
        )[
            len(
                "ComputeInstanceTemplatePropertiesNetworkInterfacesAccessConfigsNetworkTierEnum"
            ) :
        ]
...
class InstanceTemplatePropertiesSchedulingNodeAffinitiesOperatorEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesSchedulingNodeAffinitiesOperatorEnum.Value(
            "ComputeInstanceTemplatePropertiesSchedulingNodeAffinitiesOperatorEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_template_pb2.ComputeInstanceTemplatePropertiesSchedulingNodeAffinitiesOperatorEnum.Name(
            resource
        )[
            len(
                "ComputeInstanceTemplatePropertiesSchedulingNodeAffinitiesOperatorEnum"
            ) :
        ]
