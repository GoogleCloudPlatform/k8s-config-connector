...
class TargetHttpProxy(object):
    ...
    def apply(self):
        stub = target_http_proxy_pb2_grpc.ComputeTargetHttpProxyServiceStub(
            channel.Channel()
        )
        request = target_http_proxy_pb2.ApplyComputeTargetHttpProxyRequest()
        ...
        response = stub.ApplyComputeTargetHttpProxy(request)
    ...
    def delete(self):
        ...
        request = target_http_proxy_pb2.DeleteComputeTargetHttpProxyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeTargetHttpProxy(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = target_http_proxy_pb2.ListComputeTargetHttpProxyRequest()
