...
class ServiceAttachment(object):
    ...
    def apply(self):
        stub = service_attachment_pb2_grpc.ComputeServiceAttachmentServiceStub(
            channel.Channel()
        )
        request = service_attachment_pb2.ApplyComputeServiceAttachmentRequest()
        ...
        response = stub.ApplyComputeServiceAttachment(request)
    ...
    def delete(self):
        ...
        request = service_attachment_pb2.DeleteComputeServiceAttachmentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteComputeServiceAttachment(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = service_attachment_pb2.ListComputeServiceAttachmentRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListComputeServiceAttachment(request).items

    def to_proto(self):
        resource = service_attachment_pb2.ComputeServiceAttachment()
        if Primitive.to_proto(self.name):
...
class ServiceAttachmentConnectedEndpoints(object):
    ...
    def to_proto(self, resource):
        ...
        res = service_attachment_pb2.ComputeServiceAttachmentConnectedEndpoints()
...
class ServiceAttachmentConsumerAcceptLists(object):
    ...
    def to_proto(self, resource):
        ...
        res = service_attachment_pb2.ComputeServiceAttachmentConsumerAcceptLists()
...
class ServiceAttachmentPscServiceAttachmentId(object):
    ...
    def to_proto(self, resource):
        ...
        res = service_attachment_pb2.ComputeServiceAttachmentPscServiceAttachmentId()
...
class ServiceAttachmentConnectionPreferenceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeServiceAttachmentConnectionPreferenceEnum.Value(
            "ComputeServiceAttachmentConnectionPreferenceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeServiceAttachmentConnectionPreferenceEnum.Name(
            resource
        )[
            len("ComputeServiceAttachmentConnectionPreferenceEnum") :
        ]
...
class ServiceAttachmentConnectedEndpointsStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeServiceAttachmentConnectedEndpointsStatusEnum.Value(
            "ComputeServiceAttachmentConnectedEndpointsStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_attachment_pb2.ComputeServiceAttachmentConnectedEndpointsStatusEnum.Name(
            resource
        )[
            len("ComputeServiceAttachmentConnectedEndpointsStatusEnum") :
        ]
