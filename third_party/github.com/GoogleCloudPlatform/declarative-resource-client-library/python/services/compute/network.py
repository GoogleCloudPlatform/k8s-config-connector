...
class NetworkRoutingConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = network_pb2.ComputeNetworkRoutingConfig()
...
class NetworkRoutingConfigRoutingModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_pb2.ComputeNetworkRoutingConfigRoutingModeEnum.Value(
            "ComputeNetworkRoutingConfigRoutingModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_pb2.ComputeNetworkRoutingConfigRoutingModeEnum.Name(resource)[
            len("ComputeNetworkRoutingConfigRoutingModeEnum") :
        ]
