...
class Reservation(object):
    ...
    def apply(self):
        stub = reservation_pb2_grpc.ComputeReservationServiceStub(channel.Channel())
...
class ReservationSpecificReservation(object):
    ...
    def to_proto(self, resource):
        ...
        res = reservation_pb2.ComputeReservationSpecificReservation()
...
class ReservationSpecificReservationInstanceProperties(object):
    ...
    def to_proto(self, resource):
        ...
        res = reservation_pb2.ComputeReservationSpecificReservationInstanceProperties()
...
class ReservationSpecificReservationInstancePropertiesGuestAccelerators(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            reservation_pb2.ComputeReservationSpecificReservationInstancePropertiesGuestAccelerators()
        )
...
class ReservationSpecificReservationInstancePropertiesLocalSsds(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            reservation_pb2.ComputeReservationSpecificReservationInstancePropertiesLocalSsds()
        )
...
class ReservationSpecificReservationInstancePropertiesLocalSsdsInterfaceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return reservation_pb2.ComputeReservationSpecificReservationInstancePropertiesLocalSsdsInterfaceEnum.Value(
            "ComputeReservationSpecificReservationInstancePropertiesLocalSsdsInterfaceEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return reservation_pb2.ComputeReservationSpecificReservationInstancePropertiesLocalSsdsInterfaceEnum.Name(
            resource
        )[
            len(
                "ComputeReservationSpecificReservationInstancePropertiesLocalSsdsInterfaceEnum"
            ) :
        ]
...
class ReservationStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return reservation_pb2.ComputeReservationStatusEnum.Value(
            "ComputeReservationStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return reservation_pb2.ComputeReservationStatusEnum.Name(resource)[
            len("ComputeReservationStatusEnum") :
        ]
