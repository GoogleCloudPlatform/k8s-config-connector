...
class BackendBucket(object):
    ...
    def apply(self):
        ...
        request = backend_bucket_pb2.ApplyComputeBackendBucketRequest()
        ...
        response = stub.ApplyComputeBackendBucket(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = backend_bucket_pb2.ListComputeBackendBucketRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListComputeBackendBucket(request).items
...
class BackendBucketCdnPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = backend_bucket_pb2.ComputeBackendBucketCdnPolicy()
