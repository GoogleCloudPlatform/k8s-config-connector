...
class NetworkEndpoint(object):
    ...
    def apply(self):
        stub = network_endpoint_pb2_grpc.ComputeNetworkEndpointServiceStub(
            channel.Channel()
        )
        request = network_endpoint_pb2.ApplyComputeNetworkEndpointRequest()
        ...
        response = stub.ApplyComputeNetworkEndpoint(request)
    ...
    def delete(self):
        ...
        request = network_endpoint_pb2.DeleteComputeNetworkEndpointRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.port):
            request.resource.port = Primitive.to_proto(self.port)
        ...
        response = stub.DeleteComputeNetworkEndpoint(request)
    ...
    def list(self, project, location, group, service_account_file=""):
        ...
        request = network_endpoint_pb2.ListComputeNetworkEndpointRequest()
        ...
        return stub.ListComputeNetworkEndpoint(request).items

    def to_proto(self):
        resource = network_endpoint_pb2.ComputeNetworkEndpoint()
        if Primitive.to_proto(self.port):
