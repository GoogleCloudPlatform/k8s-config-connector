...
class NetworkFirewallPolicyRule(object):
    ...
    def apply(self):
        stub = network_firewall_policy_rule_pb2_grpc.ComputeNetworkFirewallPolicyRuleServiceStub(
            channel.Channel()
        )
        request = (
            network_firewall_policy_rule_pb2.ApplyComputeNetworkFirewallPolicyRuleRequest()
        )
    ...
    def delete(self):
        ...
        request = (
            network_firewall_policy_rule_pb2.DeleteComputeNetworkFirewallPolicyRuleRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
        ...
        response = stub.DeleteComputeNetworkFirewallPolicyRule(request)
    ...
    def list(self, project, location, firewallPolicy, service_account_file=""):
        ...
        request = (
            network_firewall_policy_rule_pb2.ListComputeNetworkFirewallPolicyRuleRequest()
        )
        ...
        return stub.ListComputeNetworkFirewallPolicyRule(request).items
...
class NetworkFirewallPolicyRuleMatch(object):
    ...
    def to_proto(self, resource):
        ...
        res = network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleMatch()
...
class NetworkFirewallPolicyRuleMatchLayer4Configs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleMatchLayer4Configs()
        )
...
class NetworkFirewallPolicyRuleMatchSrcSecureTags(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleMatchSrcSecureTags()
        )
...
class NetworkFirewallPolicyRuleTargetSecureTags(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleTargetSecureTags()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class NetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum.Value(
            "ComputeNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum.Name(
            resource
        )[
            len("ComputeNetworkFirewallPolicyRuleMatchSrcSecureTagsStateEnum") :
        ]
...
class NetworkFirewallPolicyRuleDirectionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleDirectionEnum.Value(
            "ComputeNetworkFirewallPolicyRuleDirectionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleDirectionEnum.Name(
            resource
        )[
            len("ComputeNetworkFirewallPolicyRuleDirectionEnum") :
        ]
...
class NetworkFirewallPolicyRuleTargetSecureTagsStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleTargetSecureTagsStateEnum.Value(
            "ComputeNetworkFirewallPolicyRuleTargetSecureTagsStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return network_firewall_policy_rule_pb2.ComputeNetworkFirewallPolicyRuleTargetSecureTagsStateEnum.Name(
            resource
        )[
            len("ComputeNetworkFirewallPolicyRuleTargetSecureTagsStateEnum") :
        ]
