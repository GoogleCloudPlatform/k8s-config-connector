...
class Config(object):
    ...
    def apply(self):
        stub = config_pb2_grpc.IdentitytoolkitAlphaConfigServiceStub(channel.Channel())
        request = config_pb2.ApplyIdentitytoolkitAlphaConfigRequest()
        ...
        response = stub.ApplyIdentitytoolkitAlphaConfig(request)
    ...
    def delete(self):
        stub = config_pb2_grpc.IdentitytoolkitAlphaConfigServiceStub(channel.Channel())
        request = config_pb2.DeleteIdentitytoolkitAlphaConfigRequest()
        request.service_account_file = self.service_account_file
        if ConfigSignIn.to_proto(self.sign_in):
            request.resource.sign_in.CopyFrom(ConfigSignIn.to_proto(self.sign_in))
        else:
        ...
        response = stub.DeleteIdentitytoolkitAlphaConfig(request)

    @classmethod
    def list(self, service_account_file=""):
        stub = config_pb2_grpc.IdentitytoolkitAlphaConfigServiceStub(channel.Channel())
        request = config_pb2.ListIdentitytoolkitAlphaConfigRequest()
        request.service_account_file = service_account_file
        return stub.ListIdentitytoolkitAlphaConfig(request).items

    def to_proto(self):
        resource = config_pb2.IdentitytoolkitAlphaConfig()
        if ConfigSignIn.to_proto(self.sign_in):
...
class ConfigSignIn(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigSignIn()
...
class ConfigSignInEmail(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigSignInEmail()
...
class ConfigSignInEmailHashConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigSignInEmailHashConfig()
...
class ConfigSignInPhoneNumber(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigSignInPhoneNumber()
        if Primitive.to_proto(resource.enabled):
            res.enabled = Primitive.to_proto(resource.enabled)
...
class ConfigSignInAnonymous(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigSignInAnonymous()
        if Primitive.to_proto(resource.enabled):
            res.enabled = Primitive.to_proto(resource.enabled)
        return res
...
class ConfigSignInHashConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigSignInHashConfig()
...
class ConfigNotification(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigNotification()
...
class ConfigNotificationSendEmail(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmail()
...
class ConfigNotificationSendEmailSmtp(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailSmtp()
...
class ConfigNotificationSendEmailDnsInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailDnsInfo()
...
class ConfigNotificationSendSms(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigNotificationSendSms()
...
class ConfigNotificationSendSmsSmsTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigNotificationSendSmsSmsTemplate()
...
class ConfigQuota(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigQuota()
...
class ConfigQuotaSignUpQuotaConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigQuotaSignUpQuotaConfig()
...
class ConfigMonitoring(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigMonitoring()
...
class ConfigMonitoringRequestLogging(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigMonitoringRequestLogging()
        if Primitive.to_proto(resource.enabled):
            res.enabled = Primitive.to_proto(resource.enabled)
        return res
...
class ConfigMultiTenant(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigMultiTenant()
...
class ConfigClient(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigClient()
...
class ConfigClientPermissions(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigClientPermissions()
...
class ConfigMfa(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigMfa()
...
class ConfigBlockingFunctions(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigBlockingFunctions()
...
class ConfigBlockingFunctionsTriggers(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitAlphaConfigBlockingFunctionsTriggers()
...
class ConfigSignInEmailHashConfigAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigSignInEmailHashConfigAlgorithmEnum.Value(
            "IdentitytoolkitAlphaConfigSignInEmailHashConfigAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigSignInEmailHashConfigAlgorithmEnum.Name(
            resource
        )[
            len("IdentitytoolkitAlphaConfigSignInEmailHashConfigAlgorithmEnum") :
        ]
...
class ConfigSignInHashConfigAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigSignInHashConfigAlgorithmEnum.Value(
            "IdentitytoolkitAlphaConfigSignInHashConfigAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigSignInHashConfigAlgorithmEnum.Name(
            resource
        )[len("IdentitytoolkitAlphaConfigSignInHashConfigAlgorithmEnum") :]
...
class ConfigNotificationSendEmailMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailMethodEnum.Value(
                "IdentitytoolkitAlphaConfigNotificationSendEmailMethodEnum%s" % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailMethodEnum.Name(
                resource
            )[len("IdentitytoolkitAlphaConfigNotificationSendEmailMethodEnum") :]
        )
...
class ConfigNotificationSendEmailSmtpSecurityModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailSmtpSecurityModeEnum.Value(
            "IdentitytoolkitAlphaConfigNotificationSendEmailSmtpSecurityModeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailSmtpSecurityModeEnum.Name(
            resource
        )[
            len("IdentitytoolkitAlphaConfigNotificationSendEmailSmtpSecurityModeEnum") :
        ]
...
class ConfigNotificationSendEmailDnsInfoCustomDomainStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailDnsInfoCustomDomainStateEnum.Value(
            "IdentitytoolkitAlphaConfigNotificationSendEmailDnsInfoCustomDomainStateEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailDnsInfoCustomDomainStateEnum.Name(
            resource
        )[
            len(
...
class ConfigSubtypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigSubtypeEnum.Value(
            "IdentitytoolkitAlphaConfigSubtypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigSubtypeEnum.Name(resource)[
            len("IdentitytoolkitAlphaConfigSubtypeEnum") :
        ]
...
class ConfigMfaStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigMfaStateEnum.Value(
            "IdentitytoolkitAlphaConfigMfaStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigMfaStateEnum.Name(resource)[
            len("IdentitytoolkitAlphaConfigMfaStateEnum") :
        ]
