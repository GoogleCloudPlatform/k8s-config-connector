...
class Config(object):
    ...
    def apply(self):
        stub = config_pb2_grpc.IdentitytoolkitConfigServiceStub(channel.Channel())
        request = config_pb2.ApplyIdentitytoolkitConfigRequest()
        ...
        response = stub.ApplyIdentitytoolkitConfig(request)
    ...
    def delete(self):
        stub = config_pb2_grpc.IdentitytoolkitConfigServiceStub(channel.Channel())
        request = config_pb2.DeleteIdentitytoolkitConfigRequest()
        request.service_account_file = self.service_account_file
        if ConfigSignIn.to_proto(self.sign_in):
            request.resource.sign_in.CopyFrom(ConfigSignIn.to_proto(self.sign_in))
        else:
        ...
        response = stub.DeleteIdentitytoolkitConfig(request)

    @classmethod
    def list(self, service_account_file=""):
        stub = config_pb2_grpc.IdentitytoolkitConfigServiceStub(channel.Channel())
        request = config_pb2.ListIdentitytoolkitConfigRequest()
        request.service_account_file = service_account_file
        return stub.ListIdentitytoolkitConfig(request).items

    def to_proto(self):
        resource = config_pb2.IdentitytoolkitConfig()
        if ConfigSignIn.to_proto(self.sign_in):
...
class ConfigSignIn(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigSignIn()
...
class ConfigSignInEmail(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigSignInEmail()
...
class ConfigSignInEmailHashConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigSignInEmailHashConfig()
...
class ConfigSignInPhoneNumber(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigSignInPhoneNumber()
        if Primitive.to_proto(resource.enabled):
            res.enabled = Primitive.to_proto(resource.enabled)
...
class ConfigSignInAnonymous(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigSignInAnonymous()
        if Primitive.to_proto(resource.enabled):
            res.enabled = Primitive.to_proto(resource.enabled)
        return res
...
class ConfigSignInHashConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigSignInHashConfig()
...
class ConfigNotification(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotification()
...
class ConfigNotificationSendEmail(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotificationSendEmail()
...
class ConfigNotificationSendEmailSmtp(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotificationSendEmailSmtp()
...
class ConfigNotificationSendEmailResetPasswordTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            config_pb2.IdentitytoolkitConfigNotificationSendEmailResetPasswordTemplate()
        )
...
class ConfigNotificationSendEmailVerifyEmailTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotificationSendEmailVerifyEmailTemplate()
        if Primitive.to_proto(resource.sender_local_part):
            res.sender_local_part = Primitive.to_proto(resource.sender_local_part)
        if Primitive.to_proto(resource.subject):
            res.subject = Primitive.to_proto(resource.subject)
...
class ConfigNotificationSendEmailChangeEmailTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotificationSendEmailChangeEmailTemplate()
        if Primitive.to_proto(resource.sender_local_part):
            res.sender_local_part = Primitive.to_proto(resource.sender_local_part)
        if Primitive.to_proto(resource.subject):
            res.subject = Primitive.to_proto(resource.subject)
...
class ConfigNotificationSendEmailDnsInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotificationSendEmailDnsInfo()
...
class ConfigNotificationSendEmailRevertSecondFactorAdditionTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            config_pb2.IdentitytoolkitConfigNotificationSendEmailRevertSecondFactorAdditionTemplate()
        )
        if Primitive.to_proto(resource.sender_local_part):
            res.sender_local_part = Primitive.to_proto(resource.sender_local_part)
        if Primitive.to_proto(resource.subject):
...
class ConfigNotificationSendSms(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotificationSendSms()
...
class ConfigNotificationSendSmsSmsTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigNotificationSendSmsSmsTemplate()
...
class ConfigQuota(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigQuota()
...
class ConfigQuotaSignUpQuotaConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigQuotaSignUpQuotaConfig()
...
class ConfigMonitoring(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigMonitoring()
...
class ConfigMonitoringRequestLogging(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigMonitoringRequestLogging()
        if Primitive.to_proto(resource.enabled):
            res.enabled = Primitive.to_proto(resource.enabled)
        return res
...
class ConfigMultiTenant(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigMultiTenant()
...
class ConfigClient(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigClient()
...
class ConfigClientPermissions(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigClientPermissions()
...
class ConfigMfa(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigMfa()
...
class ConfigBlockingFunctions(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigBlockingFunctions()
...
class ConfigBlockingFunctionsTriggers(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigBlockingFunctionsTriggers()
...
class ConfigSignInEmailHashConfigAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigSignInEmailHashConfigAlgorithmEnum.Value(
            "IdentitytoolkitConfigSignInEmailHashConfigAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigSignInEmailHashConfigAlgorithmEnum.Name(
            resource
        )[len("IdentitytoolkitConfigSignInEmailHashConfigAlgorithmEnum") :]
...
class ConfigSignInHashConfigAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigSignInHashConfigAlgorithmEnum.Value(
            "IdentitytoolkitConfigSignInHashConfigAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigSignInHashConfigAlgorithmEnum.Name(
            resource
        )[len("IdentitytoolkitConfigSignInHashConfigAlgorithmEnum") :]
...
class ConfigNotificationSendEmailMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailMethodEnum.Value(
            "IdentitytoolkitConfigNotificationSendEmailMethodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailMethodEnum.Name(
            resource
        )[len("IdentitytoolkitConfigNotificationSendEmailMethodEnum") :]
...
class ConfigNotificationSendEmailSmtpSecurityModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailSmtpSecurityModeEnum.Value(
            "IdentitytoolkitConfigNotificationSendEmailSmtpSecurityModeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailSmtpSecurityModeEnum.Name(
            resource
        )[
            len("IdentitytoolkitConfigNotificationSendEmailSmtpSecurityModeEnum") :
        ]
...
class ConfigNotificationSendEmailResetPasswordTemplateBodyFormatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailResetPasswordTemplateBodyFormatEnum.Value(
            "IdentitytoolkitConfigNotificationSendEmailResetPasswordTemplateBodyFormatEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailResetPasswordTemplateBodyFormatEnum.Name(
            resource
        )[
            len(
                "IdentitytoolkitConfigNotificationSendEmailResetPasswordTemplateBodyFormatEnum"
            ) :
        ]
...
class ConfigNotificationSendEmailVerifyEmailTemplateBodyFormatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailVerifyEmailTemplateBodyFormatEnum.Value(
            "IdentitytoolkitConfigNotificationSendEmailVerifyEmailTemplateBodyFormatEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailVerifyEmailTemplateBodyFormatEnum.Name(
            resource
        )[
            len(
                "IdentitytoolkitConfigNotificationSendEmailVerifyEmailTemplateBodyFormatEnum"
            ) :
        ]
...
class ConfigNotificationSendEmailChangeEmailTemplateBodyFormatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailChangeEmailTemplateBodyFormatEnum.Value(
            "IdentitytoolkitConfigNotificationSendEmailChangeEmailTemplateBodyFormatEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailChangeEmailTemplateBodyFormatEnum.Name(
            resource
        )[
            len(
                "IdentitytoolkitConfigNotificationSendEmailChangeEmailTemplateBodyFormatEnum"
            ) :
        ]
...
class ConfigNotificationSendEmailDnsInfoCustomDomainStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailDnsInfoCustomDomainStateEnum.Value(
            "IdentitytoolkitConfigNotificationSendEmailDnsInfoCustomDomainStateEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailDnsInfoCustomDomainStateEnum.Name(
            resource
        )[
            len(
                "IdentitytoolkitConfigNotificationSendEmailDnsInfoCustomDomainStateEnum"
            ) :
        ]
...
class ConfigNotificationSendEmailRevertSecondFactorAdditionTemplateBodyFormatEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailRevertSecondFactorAdditionTemplateBodyFormatEnum.Value(
            "IdentitytoolkitConfigNotificationSendEmailRevertSecondFactorAdditionTemplateBodyFormatEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigNotificationSendEmailRevertSecondFactorAdditionTemplateBodyFormatEnum.Name(
            resource
        )[
            len(
                "IdentitytoolkitConfigNotificationSendEmailRevertSecondFactorAdditionTemplateBodyFormatEnum"
            ) :
        ]
...
class ConfigSubtypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigSubtypeEnum.Value(
            "IdentitytoolkitConfigSubtypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigSubtypeEnum.Name(resource)[
            len("IdentitytoolkitConfigSubtypeEnum") :
        ]
...
class ConfigMfaStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigMfaStateEnum.Value(
            "IdentitytoolkitConfigMfaStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigMfaStateEnum.Name(resource)[
            len("IdentitytoolkitConfigMfaStateEnum") :
        ]
