...
class OAuthIdpConfig(object):
    ...
    def apply(self):
        stub = oauth_idp_config_pb2_grpc.IdentitytoolkitBetaOAuthIdpConfigServiceStub(
            channel.Channel()
        )
        request = oauth_idp_config_pb2.ApplyIdentitytoolkitBetaOAuthIdpConfigRequest()
        ...
        response = stub.ApplyIdentitytoolkitBetaOAuthIdpConfig(request)
    ...
    def delete(self):
        ...
        request = oauth_idp_config_pb2.DeleteIdentitytoolkitBetaOAuthIdpConfigRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteIdentitytoolkitBetaOAuthIdpConfig(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = oauth_idp_config_pb2.ListIdentitytoolkitBetaOAuthIdpConfigRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListIdentitytoolkitBetaOAuthIdpConfig(request).items

    def to_proto(self):
        resource = oauth_idp_config_pb2.IdentitytoolkitBetaOAuthIdpConfig()
        if Primitive.to_proto(self.name):
...
class OAuthIdpConfigResponseType(object):
    ...
    def to_proto(self, resource):
        ...
        res = oauth_idp_config_pb2.IdentitytoolkitBetaOAuthIdpConfigResponseType()
