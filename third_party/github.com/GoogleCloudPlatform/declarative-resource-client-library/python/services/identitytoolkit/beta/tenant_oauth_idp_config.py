...
class TenantOAuthIdpConfig(object):
    ...
    def apply(self):
        ...
        request = (
            tenant_oauth_idp_config_pb2.ApplyIdentitytoolkitBetaTenantOAuthIdpConfigRequest()
        )
        ...
        response = stub.ApplyIdentitytoolkitBetaTenantOAuthIdpConfig(request)
    ...
    def delete(self):
        ...
        request = (
            tenant_oauth_idp_config_pb2.DeleteIdentitytoolkitBetaTenantOAuthIdpConfigRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = tenant_oauth_idp_config_pb2.IdentitytoolkitBetaTenantOAuthIdpConfig()
        if Primitive.to_proto(self.name):
...
class TenantOAuthIdpConfigResponseType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            tenant_oauth_idp_config_pb2.IdentitytoolkitBetaTenantOAuthIdpConfigResponseType()
        )
