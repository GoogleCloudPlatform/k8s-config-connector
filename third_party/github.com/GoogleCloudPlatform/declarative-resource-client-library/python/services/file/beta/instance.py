...
from google3.cloud.graphite.mmv2.services.google.file import instance_pb2
from google3.cloud.graphite.mmv2.services.google.file import instance_pb2_grpc
...
class Instance(object):
    ...
    def apply(self):
        stub = instance_pb2_grpc.FileBetaInstanceServiceStub(channel.Channel())
        request = instance_pb2.ApplyFileBetaInstanceRequest()
        ...
        response = stub.ApplyFileBetaInstance(request)
    ...
    def delete(self):
        stub = instance_pb2_grpc.FileBetaInstanceServiceStub(channel.Channel())
        request = instance_pb2.DeleteFileBetaInstanceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteFileBetaInstance(request)

    def list(self):
        stub = instance_pb2_grpc.FileBetaInstanceServiceStub(channel.Channel())
        request = instance_pb2.ListFileBetaInstanceRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListFileBetaInstance(request).items

    def to_proto(self):
        resource = instance_pb2.FileBetaInstance()
        if Primitive.to_proto(self.name):
...
class InstanceFileShares(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FileBetaInstanceFileShares()
...
class InstanceFileSharesNfsExportOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FileBetaInstanceFileSharesNfsExportOptions()
...
class InstanceNetworks(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FileBetaInstanceNetworks()
...
class InstanceStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceStateEnum.Value(
            "FileBetaInstanceStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceStateEnum.Name(resource)[
            len("FileBetaInstanceStateEnum") :
        ]
...
class InstanceTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceTierEnum.Value(
            "FileBetaInstanceTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceTierEnum.Name(resource)[
            len("FileBetaInstanceTierEnum") :
        ]
...
class InstanceFileSharesNfsExportOptionsAccessModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceFileSharesNfsExportOptionsAccessModeEnum.Value(
            "FileBetaInstanceFileSharesNfsExportOptionsAccessModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceFileSharesNfsExportOptionsAccessModeEnum.Name(
            resource
        )[
            len("FileBetaInstanceFileSharesNfsExportOptionsAccessModeEnum") :
        ]
...
class InstanceFileSharesNfsExportOptionsSquashModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceFileSharesNfsExportOptionsSquashModeEnum.Value(
            "FileBetaInstanceFileSharesNfsExportOptionsSquashModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceFileSharesNfsExportOptionsSquashModeEnum.Name(
            resource
        )[
            len("FileBetaInstanceFileSharesNfsExportOptionsSquashModeEnum") :
        ]
...
class InstanceNetworksModesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceNetworksModesEnum.Value(
            "FileBetaInstanceNetworksModesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileBetaInstanceNetworksModesEnum.Name(resource)[
            len("FileBetaInstanceNetworksModesEnum") :
        ]
