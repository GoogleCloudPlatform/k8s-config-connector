...
class InstanceFileShares(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FileInstanceFileShares()
...
class InstanceFileSharesNfsExportOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FileInstanceFileSharesNfsExportOptions()
...
class InstanceNetworks(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.FileInstanceNetworks()
...
class InstanceStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceStateEnum.Value(
            "FileInstanceStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceStateEnum.Name(resource)[
            len("FileInstanceStateEnum") :
        ]
...
class InstanceTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceTierEnum.Value(
            "FileInstanceTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceTierEnum.Name(resource)[
            len("FileInstanceTierEnum") :
        ]
...
class InstanceFileSharesNfsExportOptionsAccessModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceFileSharesNfsExportOptionsAccessModeEnum.Value(
            "FileInstanceFileSharesNfsExportOptionsAccessModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceFileSharesNfsExportOptionsAccessModeEnum.Name(
            resource
        )[len("FileInstanceFileSharesNfsExportOptionsAccessModeEnum") :]
...
class InstanceFileSharesNfsExportOptionsSquashModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceFileSharesNfsExportOptionsSquashModeEnum.Value(
            "FileInstanceFileSharesNfsExportOptionsSquashModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceFileSharesNfsExportOptionsSquashModeEnum.Name(
            resource
        )[len("FileInstanceFileSharesNfsExportOptionsSquashModeEnum") :]
...
class InstanceNetworksModesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceNetworksModesEnum.Value(
            "FileInstanceNetworksModesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.FileInstanceNetworksModesEnum.Name(resource)[
            len("FileInstanceNetworksModesEnum") :
        ]
