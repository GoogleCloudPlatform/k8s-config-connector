...
class Attestor(object):
    ...
    def apply(self):
        stub = attestor_pb2_grpc.BinaryauthorizationBetaAttestorServiceStub(
            channel.Channel()
        )
        request = attestor_pb2.ApplyBinaryauthorizationBetaAttestorRequest()
        ...
        response = stub.ApplyBinaryauthorizationBetaAttestor(request)
    ...
    def delete(self):
        ...
        request = attestor_pb2.DeleteBinaryauthorizationBetaAttestorRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteBinaryauthorizationBetaAttestor(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = attestor_pb2.ListBinaryauthorizationBetaAttestorRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListBinaryauthorizationBetaAttestor(request).items

    def to_proto(self):
        resource = attestor_pb2.BinaryauthorizationBetaAttestor()
        if Primitive.to_proto(self.name):
...
class AttestorUserOwnedDrydockNote(object):
    ...
    def to_proto(self, resource):
        ...
        res = attestor_pb2.BinaryauthorizationBetaAttestorUserOwnedDrydockNote()
...
class AttestorUserOwnedDrydockNotePublicKeys(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            attestor_pb2.BinaryauthorizationBetaAttestorUserOwnedDrydockNotePublicKeys()
        )
...
class AttestorUserOwnedDrydockNotePublicKeysPkixPublicKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            attestor_pb2.BinaryauthorizationBetaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKey()
        )
...
class AttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return attestor_pb2.BinaryauthorizationBetaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum.Value(
            "BinaryauthorizationBetaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return attestor_pb2.BinaryauthorizationBetaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum.Name(
            resource
        )[
            len(
                "BinaryauthorizationBetaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum"
            ) :
        ]
