...
class Attestor(object):
    ...
    def apply(self):
        stub = attestor_pb2_grpc.BinaryauthorizationAlphaAttestorServiceStub(
            channel.Channel()
        )
        request = attestor_pb2.ApplyBinaryauthorizationAlphaAttestorRequest()
        ...
        response = stub.ApplyBinaryauthorizationAlphaAttestor(request)
    ...
    def delete(self):
        ...
        request = attestor_pb2.DeleteBinaryauthorizationAlphaAttestorRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteBinaryauthorizationAlphaAttestor(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = attestor_pb2.ListBinaryauthorizationAlphaAttestorRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListBinaryauthorizationAlphaAttestor(request).items

    def to_proto(self):
        resource = attestor_pb2.BinaryauthorizationAlphaAttestor()
        if Primitive.to_proto(self.name):
...
class AttestorUserOwnedDrydockNote(object):
    ...
    def to_proto(self, resource):
        ...
        res = attestor_pb2.BinaryauthorizationAlphaAttestorUserOwnedDrydockNote()
...
class AttestorUserOwnedDrydockNotePublicKeys(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            attestor_pb2.BinaryauthorizationAlphaAttestorUserOwnedDrydockNotePublicKeys()
        )
...
class AttestorUserOwnedDrydockNotePublicKeysPkixPublicKey(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            attestor_pb2.BinaryauthorizationAlphaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKey()
        )
...
class AttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return attestor_pb2.BinaryauthorizationAlphaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum.Value(
            "BinaryauthorizationAlphaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return attestor_pb2.BinaryauthorizationAlphaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum.Name(
            resource
        )[
            len(
                "BinaryauthorizationAlphaAttestorUserOwnedDrydockNotePublicKeysPkixPublicKeySignatureAlgorithmEnum"
            ) :
        ]
