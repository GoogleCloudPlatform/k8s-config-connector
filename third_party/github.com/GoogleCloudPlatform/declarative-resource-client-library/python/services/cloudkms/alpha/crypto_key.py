...
class CryptoKey(object):
    ...
    def apply(self):
        ...
        request = crypto_key_pb2.ApplyCloudkmsAlphaCryptoKeyRequest()
        ...
        response = stub.ApplyCloudkmsAlphaCryptoKey(request)
    ...
    def delete(self):
        stub = crypto_key_pb2_grpc.CloudkmsAlphaCryptoKeyServiceStub(channel.Channel())
        request = crypto_key_pb2.DeleteCloudkmsAlphaCryptoKeyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = crypto_key_pb2.CloudkmsAlphaCryptoKey()
        if Primitive.to_proto(self.name):
...
class CryptoKeyPrimary(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimary()
...
class CryptoKeyPrimaryAttestation(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryAttestation()
...
class CryptoKeyPrimaryAttestationCertChains(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryAttestationCertChains()
...
class CryptoKeyPrimaryExternalProtectionLevelOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryExternalProtectionLevelOptions()
        )
...
class CryptoKeyVersionTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsAlphaCryptoKeyVersionTemplate()
...
class CryptoKeyPrimaryStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryStateEnum.Value(
            "CloudkmsAlphaCryptoKeyPrimaryStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryStateEnum.Name(resource)[
            len("CloudkmsAlphaCryptoKeyPrimaryStateEnum") :
        ]
...
class CryptoKeyPrimaryProtectionLevelEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryProtectionLevelEnum.Value(
            "CloudkmsAlphaCryptoKeyPrimaryProtectionLevelEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryProtectionLevelEnum.Name(
            resource
        )[len("CloudkmsAlphaCryptoKeyPrimaryProtectionLevelEnum") :]
...
class CryptoKeyPrimaryAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryAlgorithmEnum.Value(
            "CloudkmsAlphaCryptoKeyPrimaryAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryAlgorithmEnum.Name(resource)[
            len("CloudkmsAlphaCryptoKeyPrimaryAlgorithmEnum") :
        ]
...
class CryptoKeyPrimaryAttestationFormatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryAttestationFormatEnum.Value(
            "CloudkmsAlphaCryptoKeyPrimaryAttestationFormatEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPrimaryAttestationFormatEnum.Name(
            resource
        )[len("CloudkmsAlphaCryptoKeyPrimaryAttestationFormatEnum") :]
...
class CryptoKeyPurposeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPurposeEnum.Value(
            "CloudkmsAlphaCryptoKeyPurposeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyPurposeEnum.Name(resource)[
            len("CloudkmsAlphaCryptoKeyPurposeEnum") :
        ]
...
class CryptoKeyVersionTemplateProtectionLevelEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyVersionTemplateProtectionLevelEnum.Value(
            "CloudkmsAlphaCryptoKeyVersionTemplateProtectionLevelEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyVersionTemplateProtectionLevelEnum.Name(
            resource
        )[
            len("CloudkmsAlphaCryptoKeyVersionTemplateProtectionLevelEnum") :
        ]
...
class CryptoKeyVersionTemplateAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyVersionTemplateAlgorithmEnum.Value(
            "CloudkmsAlphaCryptoKeyVersionTemplateAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsAlphaCryptoKeyVersionTemplateAlgorithmEnum.Name(
            resource
        )[len("CloudkmsAlphaCryptoKeyVersionTemplateAlgorithmEnum") :]
