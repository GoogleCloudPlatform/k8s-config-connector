...
class EkmConnection(object):
    ...
    def apply(self):
        stub = ekm_connection_pb2_grpc.CloudkmsEkmConnectionServiceStub(
            channel.Channel()
        )
        request = ekm_connection_pb2.ApplyCloudkmsEkmConnectionRequest()
        ...
        response = stub.ApplyCloudkmsEkmConnection(request)
    ...
    def delete(self):
        ...
        request = ekm_connection_pb2.DeleteCloudkmsEkmConnectionRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudkmsEkmConnection(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = ekm_connection_pb2.ListCloudkmsEkmConnectionRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListCloudkmsEkmConnection(request).items

    def to_proto(self):
        resource = ekm_connection_pb2.CloudkmsEkmConnection()
        if Primitive.to_proto(self.name):
...
class EkmConnectionServiceResolvers(object):
    ...
    def to_proto(self, resource):
        ...
        res = ekm_connection_pb2.CloudkmsEkmConnectionServiceResolvers()
...
class EkmConnectionServiceResolversServerCertificates(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ekm_connection_pb2.CloudkmsEkmConnectionServiceResolversServerCertificates()
        )
