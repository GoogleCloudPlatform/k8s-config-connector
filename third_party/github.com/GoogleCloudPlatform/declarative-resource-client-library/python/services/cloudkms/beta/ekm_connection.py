...
class EkmConnection(object):
    ...
    def apply(self):
        stub = ekm_connection_pb2_grpc.CloudkmsBetaEkmConnectionServiceStub(
            channel.Channel()
        )
        request = ekm_connection_pb2.ApplyCloudkmsBetaEkmConnectionRequest()
        ...
        response = stub.ApplyCloudkmsBetaEkmConnection(request)
    ...
    def delete(self):
        ...
        request = ekm_connection_pb2.DeleteCloudkmsBetaEkmConnectionRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudkmsBetaEkmConnection(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = ekm_connection_pb2.ListCloudkmsBetaEkmConnectionRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListCloudkmsBetaEkmConnection(request).items

    def to_proto(self):
        resource = ekm_connection_pb2.CloudkmsBetaEkmConnection()
        if Primitive.to_proto(self.name):
...
class EkmConnectionServiceResolvers(object):
    ...
    def to_proto(self, resource):
        ...
        res = ekm_connection_pb2.CloudkmsBetaEkmConnectionServiceResolvers()
...
class EkmConnectionServiceResolversServerCertificates(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ekm_connection_pb2.CloudkmsBetaEkmConnectionServiceResolversServerCertificates()
        )
