...
class CryptoKey(object):
    ...
    def apply(self):
        stub = crypto_key_pb2_grpc.CloudkmsBetaCryptoKeyServiceStub(channel.Channel())
        request = crypto_key_pb2.ApplyCloudkmsBetaCryptoKeyRequest()
        ...
        response = stub.ApplyCloudkmsBetaCryptoKey(request)
    ...
    def delete(self):
        stub = crypto_key_pb2_grpc.CloudkmsBetaCryptoKeyServiceStub(channel.Channel())
        request = crypto_key_pb2.DeleteCloudkmsBetaCryptoKeyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudkmsBetaCryptoKey(request)

    @classmethod
    def list(self, project, location, keyRing, service_account_file=""):
        stub = crypto_key_pb2_grpc.CloudkmsBetaCryptoKeyServiceStub(channel.Channel())
        request = crypto_key_pb2.ListCloudkmsBetaCryptoKeyRequest()
        ...
        return stub.ListCloudkmsBetaCryptoKey(request).items

    def to_proto(self):
        resource = crypto_key_pb2.CloudkmsBetaCryptoKey()
        if Primitive.to_proto(self.name):
...
class CryptoKeyPrimary(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsBetaCryptoKeyPrimary()
...
class CryptoKeyPrimaryAttestation(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryAttestation()
...
class CryptoKeyPrimaryAttestationCertChains(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryAttestationCertChains()
...
class CryptoKeyPrimaryExternalProtectionLevelOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryExternalProtectionLevelOptions()
        )
...
class CryptoKeyVersionTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = crypto_key_pb2.CloudkmsBetaCryptoKeyVersionTemplate()
...
class CryptoKeyPrimaryStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryStateEnum.Value(
            "CloudkmsBetaCryptoKeyPrimaryStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryStateEnum.Name(resource)[
            len("CloudkmsBetaCryptoKeyPrimaryStateEnum") :
        ]
...
class CryptoKeyPrimaryProtectionLevelEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryProtectionLevelEnum.Value(
            "CloudkmsBetaCryptoKeyPrimaryProtectionLevelEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryProtectionLevelEnum.Name(
            resource
        )[len("CloudkmsBetaCryptoKeyPrimaryProtectionLevelEnum") :]
...
class CryptoKeyPrimaryAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryAlgorithmEnum.Value(
            "CloudkmsBetaCryptoKeyPrimaryAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryAlgorithmEnum.Name(resource)[
            len("CloudkmsBetaCryptoKeyPrimaryAlgorithmEnum") :
        ]
...
class CryptoKeyPrimaryAttestationFormatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryAttestationFormatEnum.Value(
            "CloudkmsBetaCryptoKeyPrimaryAttestationFormatEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPrimaryAttestationFormatEnum.Name(
            resource
        )[len("CloudkmsBetaCryptoKeyPrimaryAttestationFormatEnum") :]
...
class CryptoKeyPurposeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPurposeEnum.Value(
            "CloudkmsBetaCryptoKeyPurposeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyPurposeEnum.Name(resource)[
            len("CloudkmsBetaCryptoKeyPurposeEnum") :
        ]
...
class CryptoKeyVersionTemplateProtectionLevelEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyVersionTemplateProtectionLevelEnum.Value(
            "CloudkmsBetaCryptoKeyVersionTemplateProtectionLevelEnum%s" % resource
        )
...
class CryptoKeyVersionTemplateAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyVersionTemplateAlgorithmEnum.Value(
            "CloudkmsBetaCryptoKeyVersionTemplateAlgorithmEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return crypto_key_pb2.CloudkmsBetaCryptoKeyVersionTemplateAlgorithmEnum.Name(
            resource
        )[len("CloudkmsBetaCryptoKeyVersionTemplateAlgorithmEnum") :]
