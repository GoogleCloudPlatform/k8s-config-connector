...
class Key(object):
    ...
    def apply(self):
        stub = key_pb2_grpc.ApikeysKeyServiceStub(channel.Channel())
        request = key_pb2.ApplyApikeysKeyRequest()
    ...
    def delete(self):
        stub = key_pb2_grpc.ApikeysKeyServiceStub(channel.Channel())
        request = key_pb2.DeleteApikeysKeyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApikeysKey(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = key_pb2_grpc.ApikeysKeyServiceStub(channel.Channel())
        request = key_pb2.ListApikeysKeyRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListApikeysKey(request).items

    def to_proto(self):
        resource = key_pb2.ApikeysKey()
        if Primitive.to_proto(self.name):
...
class KeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysKeyRestrictions()
...
class KeyRestrictionsBrowserKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysKeyRestrictionsBrowserKeyRestrictions()
...
class KeyRestrictionsServerKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysKeyRestrictionsServerKeyRestrictions()
...
class KeyRestrictionsAndroidKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysKeyRestrictionsAndroidKeyRestrictions()
...
class KeyRestrictionsAndroidKeyRestrictionsAllowedApplications(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysKeyRestrictionsAndroidKeyRestrictionsAllowedApplications()
...
class KeyRestrictionsIosKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysKeyRestrictionsIosKeyRestrictions()
...
class KeyRestrictionsApiTargets(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysKeyRestrictionsApiTargets()
