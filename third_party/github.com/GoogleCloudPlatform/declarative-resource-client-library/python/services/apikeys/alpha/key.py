...
class Key(object):
    ...
    def apply(self):
        stub = key_pb2_grpc.ApikeysAlphaKeyServiceStub(channel.Channel())
        request = key_pb2.ApplyApikeysAlphaKeyRequest()
        ...
        response = stub.ApplyApikeysAlphaKey(request)
    ...
    def delete(self):
        stub = key_pb2_grpc.ApikeysAlphaKeyServiceStub(channel.Channel())
        request = key_pb2.DeleteApikeysAlphaKeyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteApikeysAlphaKey(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = key_pb2_grpc.ApikeysAlphaKeyServiceStub(channel.Channel())
        request = key_pb2.ListApikeysAlphaKeyRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListApikeysAlphaKey(request).items

    def to_proto(self):
        resource = key_pb2.ApikeysAlphaKey()
        if Primitive.to_proto(self.name):
...
class KeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysAlphaKeyRestrictions()
...
class KeyRestrictionsBrowserKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysAlphaKeyRestrictionsBrowserKeyRestrictions()
...
class KeyRestrictionsServerKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysAlphaKeyRestrictionsServerKeyRestrictions()
...
class KeyRestrictionsAndroidKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysAlphaKeyRestrictionsAndroidKeyRestrictions()
...
class KeyRestrictionsAndroidKeyRestrictionsAllowedApplications(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            key_pb2.ApikeysAlphaKeyRestrictionsAndroidKeyRestrictionsAllowedApplications()
        )
...
class KeyRestrictionsIosKeyRestrictions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysAlphaKeyRestrictionsIosKeyRestrictions()
...
class KeyRestrictionsApiTargets(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.ApikeysAlphaKeyRestrictionsApiTargets()
