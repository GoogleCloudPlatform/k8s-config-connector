...
class InspectTemplate(object):
    ...
    def apply(self):
        stub = inspect_template_pb2_grpc.DlpInspectTemplateServiceStub(
            channel.Channel()
        )
        request = inspect_template_pb2.ApplyDlpInspectTemplateRequest()
        ...
        response = stub.ApplyDlpInspectTemplate(request)
    ...
    def delete(self):
        ...
        request = inspect_template_pb2.DeleteDlpInspectTemplateRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDlpInspectTemplate(request)
    ...
    def list(self, location, parent, service_account_file=""):
        ...
        request = inspect_template_pb2.ListDlpInspectTemplateRequest()
        request.service_account_file = service_account_file
        request.Location = location

        request.Parent = parent

        return stub.ListDlpInspectTemplate(request).items

    def to_proto(self):
        resource = inspect_template_pb2.DlpInspectTemplate()
        if Primitive.to_proto(self.name):
...
class InspectTemplateInspectConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfig()
...
class InspectTemplateInspectConfigInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfigInfoTypes()
...
class InspectTemplateInspectConfigLimits(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfigLimits()
...
class InspectTemplateInspectConfigLimitsMaxFindingsPerInfoType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigLimitsMaxFindingsPerInfoType()
        )
...
class InspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoType()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigCustomInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypes()
...
class InspectTemplateInspectConfigCustomInfoTypesInfoType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesInfoType()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigCustomInfoTypesDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDictionary()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDictionaryWordList(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDictionaryWordList()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDictionaryCloudStoragePath(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDictionaryCloudStoragePath()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesRegex()
...
class InspectTemplateInspectConfigCustomInfoTypesSurrogateType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesSurrogateType()
        )
        return res
...
class InspectTemplateInspectConfigCustomInfoTypesStoredType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesStoredType()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class InspectTemplateInspectConfigRuleSet(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSet()
...
class InspectTemplateInspectConfigRuleSetInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetInfoTypes()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigRuleSetRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRules()
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesHotwordRule()
        )
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleHotwordRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesHotwordRuleHotwordRegex()
        )
        if Primitive.to_proto(resource.pattern):
            res.pattern = Primitive.to_proto(resource.pattern)
        if int64Array.to_proto(resource.group_indexes):
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleProximity(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesHotwordRuleProximity()
        )
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustment(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustment()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRule()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionary()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryWordList(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryWordList()
        )
        if Primitive.to_proto(resource.words):
            res.words.extend(Primitive.to_proto(resource.words))
        return res
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryCloudStoragePath(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryCloudStoragePath()
        )
        if Primitive.to_proto(resource.path):
            res.path = Primitive.to_proto(resource.path)
        return res
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleRegex()
        )
        if Primitive.to_proto(resource.pattern):
            res.pattern = Primitive.to_proto(resource.pattern)
        if int64Array.to_proto(resource.group_indexes):
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypes()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypesInfoTypes(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypesInfoTypes()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum.Value(
            "DlpInspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum.Name(
            resource
        )[
            len("DlpInspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum") :
        ]
...
class InspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum.Value(
            "DlpInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum.Name(
            resource
        )[
            len("DlpInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum") :
        ]
...
class InspectTemplateInspectConfigContentOptionsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigContentOptionsEnum.Value(
            "DlpInspectTemplateInspectConfigContentOptionsEnum%s" % resource
        )
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Value(
            "DlpInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Name(
            resource
        )[
            len(
                "DlpInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum"
            ) :
        ]
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum.Value(
            "DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum.Name(
            resource
        )[
            len(
                "DlpInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum"
            ) :
        ]
