...
class StoredInfoType(object):
    ...
    def apply(self):
        stub = stored_info_type_pb2_grpc.DlpStoredInfoTypeServiceStub(channel.Channel())
        request = stored_info_type_pb2.ApplyDlpStoredInfoTypeRequest()
        ...
        response = stub.ApplyDlpStoredInfoType(request)
    ...
    def delete(self):
        stub = stored_info_type_pb2_grpc.DlpStoredInfoTypeServiceStub(channel.Channel())
        request = stored_info_type_pb2.DeleteDlpStoredInfoTypeRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDlpStoredInfoType(request)

    @classmethod
    def list(self, location, parent, service_account_file=""):
        stub = stored_info_type_pb2_grpc.DlpStoredInfoTypeServiceStub(channel.Channel())
        request = stored_info_type_pb2.ListDlpStoredInfoTypeRequest()
        request.service_account_file = service_account_file
        request.Location = location

        request.Parent = parent

        return stub.ListDlpStoredInfoType(request).items

    def to_proto(self):
        resource = stored_info_type_pb2.DlpStoredInfoType()
        if Primitive.to_proto(self.name):
...
class StoredInfoTypeLargeCustomDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpStoredInfoTypeLargeCustomDictionary()
...
class StoredInfoTypeLargeCustomDictionaryOutputPath(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpStoredInfoTypeLargeCustomDictionaryOutputPath()
...
class StoredInfoTypeLargeCustomDictionaryCloudStorageFileSet(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpStoredInfoTypeLargeCustomDictionaryCloudStorageFileSet()
        )
...
class StoredInfoTypeLargeCustomDictionaryBigQueryField(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpStoredInfoTypeLargeCustomDictionaryBigQueryField()
...
class StoredInfoTypeLargeCustomDictionaryBigQueryFieldTable(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpStoredInfoTypeLargeCustomDictionaryBigQueryFieldTable()
        )
...
class StoredInfoTypeLargeCustomDictionaryBigQueryFieldField(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpStoredInfoTypeLargeCustomDictionaryBigQueryFieldField()
        )
...
class StoredInfoTypeDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpStoredInfoTypeDictionary()
...
class StoredInfoTypeDictionaryWordList(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpStoredInfoTypeDictionaryWordList()
...
class StoredInfoTypeDictionaryCloudStoragePath(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpStoredInfoTypeDictionaryCloudStoragePath()
        if Primitive.to_proto(resource.path):
            res.path = Primitive.to_proto(resource.path)
        return res
...
class StoredInfoTypeRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpStoredInfoTypeRegex()
