...
class StoredInfoType(object):
    ...
    def apply(self):
        stub = stored_info_type_pb2_grpc.DlpAlphaStoredInfoTypeServiceStub(
            channel.Channel()
        )
        request = stored_info_type_pb2.ApplyDlpAlphaStoredInfoTypeRequest()
        ...
        response = stub.ApplyDlpAlphaStoredInfoType(request)
    ...
    def delete(self):
        ...
        request = stored_info_type_pb2.DeleteDlpAlphaStoredInfoTypeRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDlpAlphaStoredInfoType(request)
    ...
    def list(self, location, parent, service_account_file=""):
        ...
        request = stored_info_type_pb2.ListDlpAlphaStoredInfoTypeRequest()
        request.service_account_file = service_account_file
        request.Location = location

        request.Parent = parent

        return stub.ListDlpAlphaStoredInfoType(request).items

    def to_proto(self):
        resource = stored_info_type_pb2.DlpAlphaStoredInfoType()
        if Primitive.to_proto(self.name):
...
class StoredInfoTypeLargeCustomDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpAlphaStoredInfoTypeLargeCustomDictionary()
...
class StoredInfoTypeLargeCustomDictionaryOutputPath(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpAlphaStoredInfoTypeLargeCustomDictionaryOutputPath()
        )
...
class StoredInfoTypeLargeCustomDictionaryCloudStorageFileSet(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpAlphaStoredInfoTypeLargeCustomDictionaryCloudStorageFileSet()
        )
...
class StoredInfoTypeLargeCustomDictionaryBigQueryField(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpAlphaStoredInfoTypeLargeCustomDictionaryBigQueryField()
        )
...
class StoredInfoTypeLargeCustomDictionaryBigQueryFieldTable(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpAlphaStoredInfoTypeLargeCustomDictionaryBigQueryFieldTable()
        )
...
class StoredInfoTypeLargeCustomDictionaryBigQueryFieldField(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            stored_info_type_pb2.DlpAlphaStoredInfoTypeLargeCustomDictionaryBigQueryFieldField()
        )
...
class StoredInfoTypeDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpAlphaStoredInfoTypeDictionary()
...
class StoredInfoTypeDictionaryWordList(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpAlphaStoredInfoTypeDictionaryWordList()
...
class StoredInfoTypeDictionaryCloudStoragePath(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpAlphaStoredInfoTypeDictionaryCloudStoragePath()
        if Primitive.to_proto(resource.path):
            res.path = Primitive.to_proto(resource.path)
        return res
...
class StoredInfoTypeRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = stored_info_type_pb2.DlpAlphaStoredInfoTypeRegex()
