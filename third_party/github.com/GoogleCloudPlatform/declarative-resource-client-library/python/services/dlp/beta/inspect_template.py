...
class InspectTemplate(object):
    ...
    def apply(self):
        ...
        request = inspect_template_pb2.ApplyDlpBetaInspectTemplateRequest()
    ...
    def delete(self):
        ...
        request = inspect_template_pb2.DeleteDlpBetaInspectTemplateRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = inspect_template_pb2.DlpBetaInspectTemplate()
        if Primitive.to_proto(self.name):
...
class InspectTemplateInspectConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpBetaInspectTemplateInspectConfig()
...
class InspectTemplateInspectConfigInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpBetaInspectTemplateInspectConfigInfoTypes()
...
class InspectTemplateInspectConfigLimits(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpBetaInspectTemplateInspectConfigLimits()
...
class InspectTemplateInspectConfigLimitsMaxFindingsPerInfoType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigLimitsMaxFindingsPerInfoType()
        )
...
class InspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigLimitsMaxFindingsPerInfoTypeInfoType()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigCustomInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypes()
...
class InspectTemplateInspectConfigCustomInfoTypesInfoType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesInfoType()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigCustomInfoTypesDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesDictionary()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDictionaryWordList(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesDictionaryWordList()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDictionaryCloudStoragePath(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesDictionaryCloudStoragePath()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesRegex()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesSurrogateType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesSurrogateType()
        )
        return res
...
class InspectTemplateInspectConfigCustomInfoTypesStoredType(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesStoredType()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
...
class InspectTemplateInspectConfigRuleSet(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSet()
...
class InspectTemplateInspectConfigRuleSetInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetInfoTypes()
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigRuleSetRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRules()
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRule()
        )
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleHotwordRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRuleHotwordRegex()
        )
        if Primitive.to_proto(resource.pattern):
            res.pattern = Primitive.to_proto(resource.pattern)
        if int64Array.to_proto(resource.group_indexes):
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleProximity(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRuleProximity()
        )
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustment(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustment()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRule()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionary(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionary()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryWordList(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryWordList()
        )
        if Primitive.to_proto(resource.words):
            res.words.extend(Primitive.to_proto(resource.words))
        return res
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryCloudStoragePath(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleDictionaryCloudStoragePath()
        )
        if Primitive.to_proto(resource.path):
            res.path = Primitive.to_proto(resource.path)
        return res
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleRegex(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleRegex()
        )
        if Primitive.to_proto(resource.pattern):
            res.pattern = Primitive.to_proto(resource.pattern)
        if int64Array.to_proto(resource.group_indexes):
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypes()
        )
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypesInfoTypes(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleExcludeInfoTypesInfoTypes()
        )
        if Primitive.to_proto(resource.name):
            res.name = Primitive.to_proto(resource.name)
        return res
...
class InspectTemplateInspectConfigMinLikelihoodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigMinLikelihoodEnum.Value(
            "DlpBetaInspectTemplateInspectConfigMinLikelihoodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigMinLikelihoodEnum.Name(
            resource
        )[
            len("DlpBetaInspectTemplateInspectConfigMinLikelihoodEnum") :
        ]
...
class InspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum.Value(
            "DlpBetaInspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesLikelihoodEnum.Name(
            resource
        )[
...
class InspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum.Value(
            "DlpBetaInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum.Name(
            resource
        )[
            len("DlpBetaInspectTemplateInspectConfigCustomInfoTypesExclusionTypeEnum") :
        ]
...
class InspectTemplateInspectConfigContentOptionsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigContentOptionsEnum.Value(
            "DlpBetaInspectTemplateInspectConfigContentOptionsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigContentOptionsEnum.Name(
            resource
        )[
            len("DlpBetaInspectTemplateInspectConfigContentOptionsEnum") :
        ]
...
class InspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Value(
            "DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Name(
            resource
        )[
            len(
                "DlpBetaInspectTemplateInspectConfigRuleSetRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum"
            ) :
        ]
...
class InspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum.Value(
            "DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum.Name(
            resource
        )[
            len(
                "DlpBetaInspectTemplateInspectConfigRuleSetRulesExclusionRuleMatchingTypeEnum"
            ) :
        ]
