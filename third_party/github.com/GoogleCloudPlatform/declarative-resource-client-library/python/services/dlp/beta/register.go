...
import (
	...
	sdkgrpc "github.com/GoogleCloudPlatform/declarative-resource-client-library/python/proto/dlp/beta/dlp_beta_go_proto"
)
...
func RegisterServers(s *grpc.Server) {
	...
	sdkgrpc.RegisterDlpBetaJobTriggerServiceServer(s, &JobTriggerServer{})
