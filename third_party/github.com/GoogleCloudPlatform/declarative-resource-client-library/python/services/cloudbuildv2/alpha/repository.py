...
class Repository(object):
    ...
    def apply(self):
        stub = repository_pb2_grpc.Cloudbuildv2AlphaRepositoryServiceStub(
            channel.Channel()
        )
        request = repository_pb2.ApplyCloudbuildv2AlphaRepositoryRequest()
        ...
        response = stub.ApplyCloudbuildv2AlphaRepository(request)
    ...
    def delete(self):
        ...
        request = repository_pb2.DeleteCloudbuildv2AlphaRepositoryRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudbuildv2AlphaRepository(request)
    ...
    def list(self, project, location, connection, service_account_file=""):
        ...
        request = repository_pb2.ListCloudbuildv2AlphaRepositoryRequest()
        ...
        return stub.ListCloudbuildv2AlphaRepository(request).items

    def to_proto(self):
        resource = repository_pb2.Cloudbuildv2AlphaRepository()
        if Primitive.to_proto(self.name):
