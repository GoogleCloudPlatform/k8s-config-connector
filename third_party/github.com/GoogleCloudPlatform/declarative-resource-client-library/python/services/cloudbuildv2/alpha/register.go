...
func RegisterServers(s *grpc.Server) {
	sdkgrpc.RegisterCloudbuildv2AlphaConnectionServiceServer(s, &ConnectionServer{})
	sdkgrpc.RegisterCloudbuildv2AlphaRepositoryServiceServer(s, &RepositoryServer{})
}
