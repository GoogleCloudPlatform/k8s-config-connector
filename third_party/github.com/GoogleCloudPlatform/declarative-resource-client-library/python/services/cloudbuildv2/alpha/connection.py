...
class Connection(object):
    ...
    def apply(self):
        stub = connection_pb2_grpc.Cloudbuildv2AlphaConnectionServiceStub(
            channel.Channel()
        )
        request = connection_pb2.ApplyCloudbuildv2AlphaConnectionRequest()
        ...
        response = stub.ApplyCloudbuildv2AlphaConnection(request)
    ...
    def delete(self):
        ...
        request = connection_pb2.DeleteCloudbuildv2AlphaConnectionRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudbuildv2AlphaConnection(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = connection_pb2.ListCloudbuildv2AlphaConnectionRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListCloudbuildv2AlphaConnection(request).items

    def to_proto(self):
        resource = connection_pb2.Cloudbuildv2AlphaConnection()
        if Primitive.to_proto(self.name):
...
class ConnectionGithubConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = connection_pb2.Cloudbuildv2AlphaConnectionGithubConfig()
...
class ConnectionGithubConfigAuthorizerCredential(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            connection_pb2.Cloudbuildv2AlphaConnectionGithubConfigAuthorizerCredential()
        )
...
class ConnectionGithubEnterpriseConfigServiceDirectoryConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            connection_pb2.Cloudbuildv2AlphaConnectionGithubEnterpriseConfigServiceDirectoryConfig()
        )
...
class ConnectionGitlabConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = connection_pb2.Cloudbuildv2AlphaConnectionGitlabConfig()
        if Primitive.to_proto(resource.host_uri):
            res.host_uri = Primitive.to_proto(resource.host_uri)
        if Primitive.to_proto(resource.webhook_secret_secret_version):
            res.webhook_secret_secret_version = Primitive.to_proto(
...
class ConnectionGitlabConfigReadAuthorizerCredential(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            connection_pb2.Cloudbuildv2AlphaConnectionGitlabConfigReadAuthorizerCredential()
        )
...
class ConnectionGitlabConfigAuthorizerCredential(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            connection_pb2.Cloudbuildv2AlphaConnectionGitlabConfigAuthorizerCredential()
        )
        if Primitive.to_proto(resource.user_token_secret_version):
            res.user_token_secret_version = Primitive.to_proto(
                resource.user_token_secret_version
...
class ConnectionGitlabConfigServiceDirectoryConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            connection_pb2.Cloudbuildv2AlphaConnectionGitlabConfigServiceDirectoryConfig()
        )
        if Primitive.to_proto(resource.service):
            res.service = Primitive.to_proto(resource.service)
        return res
...
class ConnectionInstallationStateStageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            connection_pb2.Cloudbuildv2AlphaConnectionInstallationStateStageEnum.Value(
                "Cloudbuildv2AlphaConnectionInstallationStateStageEnum%s" % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            connection_pb2.Cloudbuildv2AlphaConnectionInstallationStateStageEnum.Name(
                resource
            )[len("Cloudbuildv2AlphaConnectionInstallationStateStageEnum") :]
        )
