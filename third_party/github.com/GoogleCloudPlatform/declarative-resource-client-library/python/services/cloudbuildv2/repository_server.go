...
func ProtoToRepository(p *cloudbuildv2pb.Cloudbuildv2Repository) *cloudbuildv2.Repository {
...
func RepositoryToProto(resource *cloudbuildv2.Repository) *cloudbuildv2pb.Cloudbuildv2Repository {
	p := &cloudbuildv2pb.Cloudbuildv2Repository{}
...
func (s *RepositoryServer) applyRepository(ctx context.Context, c *cloudbuildv2.Client, request *cloudbuildv2pb.ApplyCloudbuildv2RepositoryRequest) (*cloudbuildv2pb.Cloudbuildv2Repository, error) {
...
// applyCloudbuildv2Repository handles the gRPC request by passing it to the underlying Repository Apply() method.
func (s *RepositoryServer) ApplyCloudbuildv2Repository(ctx context.Context, request *cloudbuildv2pb.ApplyCloudbuildv2RepositoryRequest) (*cloudbuildv2pb.Cloudbuildv2Repository, error) {
...
func (s *RepositoryServer) DeleteCloudbuildv2Repository(ctx context.Context, request *cloudbuildv2pb.DeleteCloudbuildv2RepositoryRequest) (*emptypb.Empty, error) {
...
// ListCloudbuildv2Repository handles the gRPC request by passing it to the underlying RepositoryList() method.
func (s *RepositoryServer) ListCloudbuildv2Repository(ctx context.Context, request *cloudbuildv2pb.ListCloudbuildv2RepositoryRequest) (*cloudbuildv2pb.ListCloudbuildv2RepositoryResponse, error) {
	cl, err := createConfigRepository(ctx, request.GetServiceAccountFile())
	if err != nil {
		return nil, err
	}
	...
	var protos []*cloudbuildv2pb.Cloudbuildv2Repository
	for _, r := range resources.Items {
		rp := RepositoryToProto(r)
		protos = append(protos, rp)
	}
	p := &cloudbuildv2pb.ListCloudbuildv2RepositoryResponse{}
	p.SetItems(protos)
	return p, nil
}

func createConfigRepository(ctx context.Context, service_account_file string) (*cloudbuildv2.Client, error) {
