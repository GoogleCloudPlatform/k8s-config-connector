...
class Connection(object):
    ...
    def apply(self):
        stub = connection_pb2_grpc.Cloudbuildv2BetaConnectionServiceStub(
            channel.Channel()
        )
        request = connection_pb2.ApplyCloudbuildv2BetaConnectionRequest()
        ...
        response = stub.ApplyCloudbuildv2BetaConnection(request)
    ...
    def delete(self):
        ...
        request = connection_pb2.DeleteCloudbuildv2BetaConnectionRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudbuildv2BetaConnection(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = connection_pb2.ListCloudbuildv2BetaConnectionRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListCloudbuildv2BetaConnection(request).items

    def to_proto(self):
        resource = connection_pb2.Cloudbuildv2BetaConnection()
        if Primitive.to_proto(self.name):
...
class ConnectionGithubConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = connection_pb2.Cloudbuildv2BetaConnectionGithubConfig()
...
class ConnectionGithubConfigAuthorizerCredential(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            connection_pb2.Cloudbuildv2BetaConnectionGithubConfigAuthorizerCredential()
        )
...
class ConnectionGithubEnterpriseConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = connection_pb2.Cloudbuildv2BetaConnectionGithubEnterpriseConfig()
...
class ConnectionGithubEnterpriseConfigServiceDirectoryConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            connection_pb2.Cloudbuildv2BetaConnectionGithubEnterpriseConfigServiceDirectoryConfig()
        )
...
class ConnectionInstallationState(object):
    ...
    def to_proto(self, resource):
        ...
        res = connection_pb2.Cloudbuildv2BetaConnectionInstallationState()
...
class ConnectionInstallationStateStageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            connection_pb2.Cloudbuildv2BetaConnectionInstallationStateStageEnum.Value(
                "Cloudbuildv2BetaConnectionInstallationStateStageEnum%s" % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return connection_pb2.Cloudbuildv2BetaConnectionInstallationStateStageEnum.Name(
            resource
        )[len("Cloudbuildv2BetaConnectionInstallationStateStageEnum") :]
