...
class Job(object):
    ...
    def apply(self):
        stub = job_pb2_grpc.CloudschedulerBetaJobServiceStub(channel.Channel())
        request = job_pb2.ApplyCloudschedulerBetaJobRequest()
        ...
        response = stub.ApplyCloudschedulerBetaJob(request)
    ...
    def delete(self):
        stub = job_pb2_grpc.CloudschedulerBetaJobServiceStub(channel.Channel())
        request = job_pb2.DeleteCloudschedulerBetaJobRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudschedulerBetaJob(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = job_pb2_grpc.CloudschedulerBetaJobServiceStub(channel.Channel())
        request = job_pb2.ListCloudschedulerBetaJobRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListCloudschedulerBetaJob(request).items

    def to_proto(self):
        resource = job_pb2.CloudschedulerBetaJob()
        if Primitive.to_proto(self.name):
...
class JobPubsubTarget(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobPubsubTarget()
...
class JobAppEngineHttpTarget(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobAppEngineHttpTarget()
...
class JobAppEngineHttpTargetAppEngineRouting(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobAppEngineHttpTargetAppEngineRouting()
...
class JobHttpTarget(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobHttpTarget()
...
class JobHttpTargetOAuthToken(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobHttpTargetOAuthToken()
...
class JobHttpTargetOidcToken(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobHttpTargetOidcToken()
        if Primitive.to_proto(resource.service_account_email):
            res.service_account_email = Primitive.to_proto(
                resource.service_account_email
            )
...
class JobStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobStatus()
...
class JobStatusDetails(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobStatusDetails()
...
class JobRetryConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerBetaJobRetryConfig()
...
class JobAppEngineHttpTargetHttpMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerBetaJobAppEngineHttpTargetHttpMethodEnum.Value(
            "CloudschedulerBetaJobAppEngineHttpTargetHttpMethodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerBetaJobAppEngineHttpTargetHttpMethodEnum.Name(
            resource
        )[len("CloudschedulerBetaJobAppEngineHttpTargetHttpMethodEnum") :]
...
class JobHttpTargetHttpMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerBetaJobHttpTargetHttpMethodEnum.Value(
            "CloudschedulerBetaJobHttpTargetHttpMethodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerBetaJobHttpTargetHttpMethodEnum.Name(resource)[
            len("CloudschedulerBetaJobHttpTargetHttpMethodEnum") :
        ]
...
class JobStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerBetaJobStateEnum.Value(
            "CloudschedulerBetaJobStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerBetaJobStateEnum.Name(resource)[
            len("CloudschedulerBetaJobStateEnum") :
        ]
