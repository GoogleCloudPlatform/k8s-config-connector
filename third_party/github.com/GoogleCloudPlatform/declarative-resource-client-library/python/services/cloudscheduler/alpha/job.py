...
class Job(object):
    ...
    def apply(self):
        stub = job_pb2_grpc.CloudschedulerAlphaJobServiceStub(channel.Channel())
        request = job_pb2.ApplyCloudschedulerAlphaJobRequest()
        ...
        response = stub.ApplyCloudschedulerAlphaJob(request)
    ...
    def delete(self):
        stub = job_pb2_grpc.CloudschedulerAlphaJobServiceStub(channel.Channel())
        request = job_pb2.DeleteCloudschedulerAlphaJobRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudschedulerAlphaJob(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = job_pb2_grpc.CloudschedulerAlphaJobServiceStub(channel.Channel())
        request = job_pb2.ListCloudschedulerAlphaJobRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListCloudschedulerAlphaJob(request).items

    def to_proto(self):
        resource = job_pb2.CloudschedulerAlphaJob()
        if Primitive.to_proto(self.name):
...
class JobPubsubTarget(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobPubsubTarget()
...
class JobAppEngineHttpTarget(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobAppEngineHttpTarget()
...
class JobAppEngineHttpTargetAppEngineRouting(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobAppEngineHttpTargetAppEngineRouting()
...
class JobHttpTarget(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobHttpTarget()
...
class JobHttpTargetOAuthToken(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobHttpTargetOAuthToken()
...
class JobHttpTargetOidcToken(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobHttpTargetOidcToken()
        if Primitive.to_proto(resource.service_account_email):
            res.service_account_email = Primitive.to_proto(
                resource.service_account_email
            )
...
class JobStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobStatus()
...
class JobStatusDetails(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobStatusDetails()
...
class JobRetryConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = job_pb2.CloudschedulerAlphaJobRetryConfig()
...
class JobAppEngineHttpTargetHttpMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerAlphaJobAppEngineHttpTargetHttpMethodEnum.Value(
            "CloudschedulerAlphaJobAppEngineHttpTargetHttpMethodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerAlphaJobAppEngineHttpTargetHttpMethodEnum.Name(
            resource
        )[len("CloudschedulerAlphaJobAppEngineHttpTargetHttpMethodEnum") :]
...
class JobHttpTargetHttpMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerAlphaJobHttpTargetHttpMethodEnum.Value(
            "CloudschedulerAlphaJobHttpTargetHttpMethodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerAlphaJobHttpTargetHttpMethodEnum.Name(resource)[
            len("CloudschedulerAlphaJobHttpTargetHttpMethodEnum") :
        ]
...
class JobStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerAlphaJobStateEnum.Value(
            "CloudschedulerAlphaJobStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return job_pb2.CloudschedulerAlphaJobStateEnum.Name(resource)[
            len("CloudschedulerAlphaJobStateEnum") :
        ]
