...
from google3.cloud.graphite.mmv2.services.google.gkemulticloud import azure_cluster_pb2
...
class AzureCluster(object):
    ...
    def apply(self):
        stub = azure_cluster_pb2_grpc.GkemulticloudAlphaAzureClusterServiceStub(
            channel.Channel()
        )
        request = azure_cluster_pb2.ApplyGkemulticloudAlphaAzureClusterRequest()
        ...
        response = stub.ApplyGkemulticloudAlphaAzureCluster(request)
    ...
    def delete(self):
        ...
        request = azure_cluster_pb2.DeleteGkemulticloudAlphaAzureClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteGkemulticloudAlphaAzureCluster(request)

    def list(self):
        stub = azure_cluster_pb2_grpc.GkemulticloudAlphaAzureClusterServiceStub(
            channel.Channel()
        )
        request = azure_cluster_pb2.ListGkemulticloudAlphaAzureClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListGkemulticloudAlphaAzureCluster(request).items

    def to_proto(self):
        resource = azure_cluster_pb2.GkemulticloudAlphaAzureCluster()
        if Primitive.to_proto(self.name):
...
class AzureClusterNetworking(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterNetworking()
...
class AzureClusterControlPlane(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterControlPlane()
...
class AzureClusterControlPlaneSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterControlPlaneSshConfig()
...
class AzureClusterControlPlaneRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterControlPlaneRootVolume()
...
class AzureClusterControlPlaneMainVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterControlPlaneMainVolume()
        if Primitive.to_proto(resource.size_gib):
            res.size_gib = Primitive.to_proto(resource.size_gib)
        return res
...
class AzureClusterControlPlaneDatabaseEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            azure_cluster_pb2.GkemulticloudAlphaAzureClusterControlPlaneDatabaseEncryption()
        )
...
class AzureClusterAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterAuthorization()
...
class AzureClusterAuthorizationAdminUsers(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterAuthorizationAdminUsers()
...
class AzureClusterWorkloadIdentityConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAlphaAzureClusterWorkloadIdentityConfig()
...
class AzureClusterStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return azure_cluster_pb2.GkemulticloudAlphaAzureClusterStateEnum.Value(
            "GkemulticloudAlphaAzureClusterStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return azure_cluster_pb2.GkemulticloudAlphaAzureClusterStateEnum.Name(resource)[
            len("GkemulticloudAlphaAzureClusterStateEnum") :
        ]
