...
class AzureNodePool(object):
    ...
    def apply(self):
        stub = azure_node_pool_pb2_grpc.GkemulticloudAlphaAzureNodePoolServiceStub(
            channel.Channel()
        )
        request = azure_node_pool_pb2.ApplyGkemulticloudAlphaAzureNodePoolRequest()
        ...
        response = stub.ApplyGkemulticloudAlphaAzureNodePool(request)
    ...
    def delete(self):
        ...
        request = azure_node_pool_pb2.DeleteGkemulticloudAlphaAzureNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteGkemulticloudAlphaAzureNodePool(request)

    def list(self):
        stub = azure_node_pool_pb2_grpc.GkemulticloudAlphaAzureNodePoolServiceStub(
            channel.Channel()
        )
        request = azure_node_pool_pb2.ListGkemulticloudAlphaAzureNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListGkemulticloudAlphaAzureNodePool(request).items

    def to_proto(self):
        resource = azure_node_pool_pb2.GkemulticloudAlphaAzureNodePool()
        if Primitive.to_proto(self.name):
...
class AzureNodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAlphaAzureNodePoolConfig()
...
class AzureNodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAlphaAzureNodePoolConfigRootVolume()
...
class AzureNodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAlphaAzureNodePoolConfigSshConfig()
...
class AzureNodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAlphaAzureNodePoolAutoscaling()
...
class AzureNodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAlphaAzureNodePoolMaxPodsConstraint()
...
class AzureNodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return azure_node_pool_pb2.GkemulticloudAlphaAzureNodePoolStateEnum.Value(
            "GkemulticloudAlphaAzureNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return azure_node_pool_pb2.GkemulticloudAlphaAzureNodePoolStateEnum.Name(
            resource
        )[len("GkemulticloudAlphaAzureNodePoolStateEnum") :]
