...
class AwsCluster(object):
    ...
    def apply(self):
        stub = aws_cluster_pb2_grpc.GkemulticloudAlphaAwsClusterServiceStub(
            channel.Channel()
        )
        request = aws_cluster_pb2.ApplyGkemulticloudAlphaAwsClusterRequest()
        ...
        response = stub.ApplyGkemulticloudAlphaAwsCluster(request)
    ...
    def delete(self):
        ...
        request = aws_cluster_pb2.DeleteGkemulticloudAlphaAwsClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteGkemulticloudAlphaAwsCluster(request)

    def list(self):
        stub = aws_cluster_pb2_grpc.GkemulticloudAlphaAwsClusterServiceStub(
            channel.Channel()
        )
        request = aws_cluster_pb2.ListGkemulticloudAlphaAwsClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListGkemulticloudAlphaAwsCluster(request).items

    def to_proto(self):
        resource = aws_cluster_pb2.GkemulticloudAlphaAwsCluster()
        if Primitive.to_proto(self.name):
...
class AwsClusterNetworking(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterNetworking()
...
class AwsClusterControlPlane(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlane()
...
class AwsClusterControlPlaneSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneSshConfig()
...
class AwsClusterControlPlaneRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneRootVolume()
...
class AwsClusterControlPlaneMainVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneMainVolume()
        if Primitive.to_proto(resource.size_gib):
            res.size_gib = Primitive.to_proto(resource.size_gib)
...
class AwsClusterControlPlaneDatabaseEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneDatabaseEncryption()
        )
        if Primitive.to_proto(resource.kms_key_arn):
            res.kms_key_arn = Primitive.to_proto(resource.kms_key_arn)
        return res
...
class AwsClusterControlPlaneAwsServicesAuthentication(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneAwsServicesAuthentication()
        )
...
class AwsClusterAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterAuthorization()
...
class AwsClusterAuthorizationAdminUsers(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterAuthorizationAdminUsers()
...
class AwsClusterWorkloadIdentityConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAlphaAwsClusterWorkloadIdentityConfig()
...
class AwsClusterControlPlaneRootVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum.Value(
            "GkemulticloudAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("GkemulticloudAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum") :
        ]
...
class AwsClusterControlPlaneMainVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum.Value(
            "GkemulticloudAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("GkemulticloudAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum") :
        ]
...
class AwsClusterStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAlphaAwsClusterStateEnum.Value(
            "GkemulticloudAlphaAwsClusterStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAlphaAwsClusterStateEnum.Name(resource)[
            len("GkemulticloudAlphaAwsClusterStateEnum") :
        ]
