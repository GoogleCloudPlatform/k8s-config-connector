...
class AwsNodePool(object):
    ...
    def apply(self):
        stub = aws_node_pool_pb2_grpc.GkemulticloudAlphaAwsNodePoolServiceStub(
            channel.Channel()
        )
        request = aws_node_pool_pb2.ApplyGkemulticloudAlphaAwsNodePoolRequest()
        ...
        response = stub.ApplyGkemulticloudAlphaAwsNodePool(request)
    ...
    def delete(self):
        ...
        request = aws_node_pool_pb2.DeleteGkemulticloudAlphaAwsNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteGkemulticloudAlphaAwsNodePool(request)

    def list(self):
        stub = aws_node_pool_pb2_grpc.GkemulticloudAlphaAwsNodePoolServiceStub(
            channel.Channel()
        )
        request = aws_node_pool_pb2.ListGkemulticloudAlphaAwsNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListGkemulticloudAlphaAwsNodePool(request).items

    def to_proto(self):
        resource = aws_node_pool_pb2.GkemulticloudAlphaAwsNodePool()
        if Primitive.to_proto(self.name):
...
class AwsNodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfig()
...
class AwsNodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfigRootVolume()
...
class AwsNodePoolConfigTaints(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfigTaints()
...
class AwsNodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfigSshConfig()
...
class AwsNodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolAutoscaling()
...
class AwsNodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolMaxPodsConstraint()
...
class AwsNodePoolConfigRootVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum.Value(
            "GkemulticloudAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("GkemulticloudAlphaAwsNodePoolConfigRootVolumeVolumeTypeEnum") :
        ]
...
class AwsNodePoolConfigTaintsEffectEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfigTaintsEffectEnum.Value(
            "GkemulticloudAlphaAwsNodePoolConfigTaintsEffectEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolConfigTaintsEffectEnum.Name(
            resource
        )[
            len("GkemulticloudAlphaAwsNodePoolConfigTaintsEffectEnum") :
        ]
...
class AwsNodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolStateEnum.Value(
            "GkemulticloudAlphaAwsNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAlphaAwsNodePoolStateEnum.Name(resource)[
            len("GkemulticloudAlphaAwsNodePoolStateEnum") :
        ]
