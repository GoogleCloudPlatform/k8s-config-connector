...
class AzureCluster(object):
    ...
    def apply(self):
        ...
        request = azure_cluster_pb2.ApplyGkemulticloudBetaAzureClusterRequest()
        ...
        response = stub.ApplyGkemulticloudBetaAzureCluster(request)
    ...
    def delete(self):
        ...
        request = azure_cluster_pb2.DeleteGkemulticloudBetaAzureClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = azure_cluster_pb2.GkemulticloudBetaAzureCluster()
        if Primitive.to_proto(self.name):
...
class AzureClusterNetworking(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterNetworking()
...
class AzureClusterControlPlane(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterControlPlane()
...
class AzureClusterControlPlaneSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterControlPlaneSshConfig()
...
class AzureClusterControlPlaneRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterControlPlaneRootVolume()
...
class AzureClusterControlPlaneMainVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterControlPlaneMainVolume()
        if Primitive.to_proto(resource.size_gib):
            res.size_gib = Primitive.to_proto(resource.size_gib)
        return res
...
class AzureClusterControlPlaneDatabaseEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            azure_cluster_pb2.GkemulticloudBetaAzureClusterControlPlaneDatabaseEncryption()
        )
...
class AzureClusterAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterAuthorization()
...
class AzureClusterAuthorizationAdminUsers(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterAuthorizationAdminUsers()
...
class AzureClusterWorkloadIdentityConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudBetaAzureClusterWorkloadIdentityConfig()
...
class AzureClusterStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return azure_cluster_pb2.GkemulticloudBetaAzureClusterStateEnum.Value(
            "GkemulticloudBetaAzureClusterStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return azure_cluster_pb2.GkemulticloudBetaAzureClusterStateEnum.Name(resource)[
            len("GkemulticloudBetaAzureClusterStateEnum") :
        ]
