...
class AzureNodePool(object):
    ...
    def apply(self):
        ...
        request = azure_node_pool_pb2.ApplyGkemulticloudAzureNodePoolRequest()
        ...
        response = stub.ApplyGkemulticloudAzureNodePool(request)
    ...
    def delete(self):
        ...
        request = azure_node_pool_pb2.DeleteGkemulticloudAzureNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = azure_node_pool_pb2.GkemulticloudAzureNodePool()
        if Primitive.to_proto(self.name):
...
class AzureNodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAzureNodePoolConfig()
...
class AzureNodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAzureNodePoolConfigRootVolume()
...
class AzureNodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAzureNodePoolConfigSshConfig()
...
class AzureNodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAzureNodePoolAutoscaling()
...
class AzureNodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_node_pool_pb2.GkemulticloudAzureNodePoolMaxPodsConstraint()
...
class AzureNodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return azure_node_pool_pb2.GkemulticloudAzureNodePoolStateEnum.Value(
            "GkemulticloudAzureNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return azure_node_pool_pb2.GkemulticloudAzureNodePoolStateEnum.Name(resource)[
            len("GkemulticloudAzureNodePoolStateEnum") :
        ]
