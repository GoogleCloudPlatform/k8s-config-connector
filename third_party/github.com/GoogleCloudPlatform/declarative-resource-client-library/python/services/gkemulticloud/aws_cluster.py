...
class AwsCluster(object):
    ...
    def apply(self):
        ...
        request = aws_cluster_pb2.ApplyGkemulticloudAwsClusterRequest()
        ...
        response = stub.ApplyGkemulticloudAwsCluster(request)
    ...
    def delete(self):
        ...
        request = aws_cluster_pb2.DeleteGkemulticloudAwsClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = aws_cluster_pb2.GkemulticloudAwsCluster()
        if Primitive.to_proto(self.name):
...
class AwsClusterNetworking(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterNetworking()
...
class AwsClusterControlPlane(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterControlPlane()
...
class AwsClusterControlPlaneSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneSshConfig()
...
class AwsClusterControlPlaneRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneRootVolume()
...
class AwsClusterControlPlaneMainVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneMainVolume()
        if Primitive.to_proto(resource.size_gib):
            res.size_gib = Primitive.to_proto(resource.size_gib)
...
class AwsClusterControlPlaneDatabaseEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneDatabaseEncryption()
        if Primitive.to_proto(resource.kms_key_arn):
            res.kms_key_arn = Primitive.to_proto(resource.kms_key_arn)
        return res
...
class AwsClusterControlPlaneAwsServicesAuthentication(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneAwsServicesAuthentication()
        )
...
class AwsClusterAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterAuthorization()
...
class AwsClusterAuthorizationAdminUsers(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterAuthorizationAdminUsers()
...
class AwsClusterWorkloadIdentityConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.GkemulticloudAwsClusterWorkloadIdentityConfig()
...
class AwsClusterControlPlaneRootVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneRootVolumeVolumeTypeEnum.Value(
            "GkemulticloudAwsClusterControlPlaneRootVolumeVolumeTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneRootVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("GkemulticloudAwsClusterControlPlaneRootVolumeVolumeTypeEnum") :
        ]
...
class AwsClusterControlPlaneMainVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneMainVolumeVolumeTypeEnum.Value(
            "GkemulticloudAwsClusterControlPlaneMainVolumeVolumeTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAwsClusterControlPlaneMainVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("GkemulticloudAwsClusterControlPlaneMainVolumeVolumeTypeEnum") :
        ]
...
class AwsClusterStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAwsClusterStateEnum.Value(
            "GkemulticloudAwsClusterStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.GkemulticloudAwsClusterStateEnum.Name(resource)[
            len("GkemulticloudAwsClusterStateEnum") :
        ]
