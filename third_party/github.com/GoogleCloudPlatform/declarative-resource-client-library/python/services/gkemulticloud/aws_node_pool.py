...
class AwsNodePool(object):
    ...
    def apply(self):
        ...
        request = aws_node_pool_pb2.ApplyGkemulticloudAwsNodePoolRequest()
        ...
        response = stub.ApplyGkemulticloudAwsNodePool(request)
    ...
    def delete(self):
        ...
        request = aws_node_pool_pb2.DeleteGkemulticloudAwsNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = aws_node_pool_pb2.GkemulticloudAwsNodePool()
        if Primitive.to_proto(self.name):
...
class AwsNodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAwsNodePoolConfig()
...
class AwsNodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAwsNodePoolConfigRootVolume()
...
class AwsNodePoolConfigTaints(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAwsNodePoolConfigTaints()
...
class AwsNodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAwsNodePoolConfigSshConfig()
...
class AwsNodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAwsNodePoolAutoscaling()
...
class AwsNodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_node_pool_pb2.GkemulticloudAwsNodePoolMaxPodsConstraint()
...
class AwsNodePoolConfigRootVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAwsNodePoolConfigRootVolumeVolumeTypeEnum.Value(
            "GkemulticloudAwsNodePoolConfigRootVolumeVolumeTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAwsNodePoolConfigRootVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("GkemulticloudAwsNodePoolConfigRootVolumeVolumeTypeEnum") :
        ]
...
class AwsNodePoolConfigTaintsEffectEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAwsNodePoolConfigTaintsEffectEnum.Value(
            "GkemulticloudAwsNodePoolConfigTaintsEffectEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAwsNodePoolConfigTaintsEffectEnum.Name(
            resource
        )[len("GkemulticloudAwsNodePoolConfigTaintsEffectEnum") :]
...
class AwsNodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAwsNodePoolStateEnum.Value(
            "GkemulticloudAwsNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_node_pool_pb2.GkemulticloudAwsNodePoolStateEnum.Name(resource)[
            len("GkemulticloudAwsNodePoolStateEnum") :
        ]
