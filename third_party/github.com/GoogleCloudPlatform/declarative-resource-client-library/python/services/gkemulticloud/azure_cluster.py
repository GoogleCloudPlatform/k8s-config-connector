...
class AzureCluster(object):
    ...
    def apply(self):
        ...
        request = azure_cluster_pb2.ApplyGkemulticloudAzureClusterRequest()
        ...
        response = stub.ApplyGkemulticloudAzureCluster(request)
    ...
    def delete(self):
        ...
        request = azure_cluster_pb2.DeleteGkemulticloudAzureClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteGkemulticloudAzureCluster(request)
    ...
    def to_proto(self):
        resource = azure_cluster_pb2.GkemulticloudAzureCluster()
        if Primitive.to_proto(self.name):
...
class AzureClusterNetworking(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterNetworking()
...
class AzureClusterControlPlane(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterControlPlane()
...
class AzureClusterControlPlaneSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterControlPlaneSshConfig()
...
class AzureClusterControlPlaneRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterControlPlaneRootVolume()
...
class AzureClusterControlPlaneMainVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterControlPlaneMainVolume()
        if Primitive.to_proto(resource.size_gib):
            res.size_gib = Primitive.to_proto(resource.size_gib)
        return res
...
class AzureClusterControlPlaneDatabaseEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            azure_cluster_pb2.GkemulticloudAzureClusterControlPlaneDatabaseEncryption()
        )
...
class AzureClusterAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterAuthorization()
...
class AzureClusterAuthorizationAdminUsers(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterAuthorizationAdminUsers()
...
class AzureClusterWorkloadIdentityConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = azure_cluster_pb2.GkemulticloudAzureClusterWorkloadIdentityConfig()
...
class AzureClusterStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return azure_cluster_pb2.GkemulticloudAzureClusterStateEnum.Value(
            "GkemulticloudAzureClusterStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return azure_cluster_pb2.GkemulticloudAzureClusterStateEnum.Name(resource)[
            len("GkemulticloudAzureClusterStateEnum") :
        ]
