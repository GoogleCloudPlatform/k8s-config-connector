...
import (
	...
	sdkgrpc "github.com/GoogleCloudPlatform/declarative-resource-client-library/python/proto/cloudresourcemanager/beta/cloudresourcemanager_beta_go_proto"
)
...
func RegisterServers(s *grpc.Server) {
	...
	sdkgrpc.RegisterCloudresourcemanagerBetaTagValueServiceServer(s, &TagValueServer{})
}
