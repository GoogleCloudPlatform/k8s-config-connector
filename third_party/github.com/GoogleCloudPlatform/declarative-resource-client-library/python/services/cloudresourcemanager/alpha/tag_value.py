...
class TagValue(object):
    ...
    def apply(self):
        stub = tag_value_pb2_grpc.CloudresourcemanagerAlphaTagValueServiceStub(
            channel.Channel()
        )
        request = tag_value_pb2.ApplyCloudresourcemanagerAlphaTagValueRequest()
        ...
        response = stub.ApplyCloudresourcemanagerAlphaTagValue(request)
    ...
    def delete(self):
        ...
        request = tag_value_pb2.DeleteCloudresourcemanagerAlphaTagValueRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteCloudresourcemanagerAlphaTagValue(request)
    ...
    def list(self, service_account_file=""):
        ...
        request = tag_value_pb2.ListCloudresourcemanagerAlphaTagValueRequest()
        request.service_account_file = service_account_file
        return stub.ListCloudresourcemanagerAlphaTagValue(request).items

    def to_proto(self):
        resource = tag_value_pb2.CloudresourcemanagerAlphaTagValue()
        if Primitive.to_proto(self.name):
