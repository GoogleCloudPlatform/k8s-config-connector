...
class FolderStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return folder_pb2.CloudresourcemanagerFolderStateEnum.Value(
            "CloudresourcemanagerFolderStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return folder_pb2.CloudresourcemanagerFolderStateEnum.Name(resource)[
            len("CloudresourcemanagerFolderStateEnum") :
        ]
