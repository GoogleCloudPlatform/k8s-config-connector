...
class Ruleset(object):
    ...
    def apply(self):
        stub = ruleset_pb2_grpc.FirebaserulesRulesetServiceStub(channel.Channel())
        request = ruleset_pb2.ApplyFirebaserulesRulesetRequest()
        ...
        response = stub.ApplyFirebaserulesRuleset(request)
    ...
    def delete(self):
        stub = ruleset_pb2_grpc.FirebaserulesRulesetServiceStub(channel.Channel())
        request = ruleset_pb2.DeleteFirebaserulesRulesetRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteFirebaserulesRuleset(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = ruleset_pb2_grpc.FirebaserulesRulesetServiceStub(channel.Channel())
        request = ruleset_pb2.ListFirebaserulesRulesetRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListFirebaserulesRuleset(request).items

    def to_proto(self):
        resource = ruleset_pb2.FirebaserulesRuleset()
        if Primitive.to_proto(self.name):
...
class RulesetSource(object):
    ...
    def to_proto(self, resource):
        ...
        res = ruleset_pb2.FirebaserulesRulesetSource()
...
class RulesetSourceFiles(object):
    ...
    def to_proto(self, resource):
        ...
        res = ruleset_pb2.FirebaserulesRulesetSourceFiles()
...
class RulesetMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = ruleset_pb2.FirebaserulesRulesetMetadata()
...
class RulesetSourceLanguageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ruleset_pb2.FirebaserulesRulesetSourceLanguageEnum.Value(
            "FirebaserulesRulesetSourceLanguageEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ruleset_pb2.FirebaserulesRulesetSourceLanguageEnum.Name(resource)[
            len("FirebaserulesRulesetSourceLanguageEnum") :
        ]
