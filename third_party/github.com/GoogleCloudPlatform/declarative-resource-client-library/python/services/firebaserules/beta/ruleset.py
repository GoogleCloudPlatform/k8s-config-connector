...
class Ruleset(object):
    ...
    def apply(self):
        stub = ruleset_pb2_grpc.FirebaserulesBetaRulesetServiceStub(channel.Channel())
        request = ruleset_pb2.ApplyFirebaserulesBetaRulesetRequest()
        ...
        response = stub.ApplyFirebaserulesBetaRuleset(request)
    ...
    def delete(self):
        stub = ruleset_pb2_grpc.FirebaserulesBetaRulesetServiceStub(channel.Channel())
        request = ruleset_pb2.DeleteFirebaserulesBetaRulesetRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteFirebaserulesBetaRuleset(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = ruleset_pb2_grpc.FirebaserulesBetaRulesetServiceStub(channel.Channel())
        request = ruleset_pb2.ListFirebaserulesBetaRulesetRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListFirebaserulesBetaRuleset(request).items

    def to_proto(self):
        resource = ruleset_pb2.FirebaserulesBetaRuleset()
        if Primitive.to_proto(self.name):
...
class RulesetSource(object):
    ...
    def to_proto(self, resource):
        ...
        res = ruleset_pb2.FirebaserulesBetaRulesetSource()
...
class RulesetSourceFiles(object):
    ...
    def to_proto(self, resource):
        ...
        res = ruleset_pb2.FirebaserulesBetaRulesetSourceFiles()
...
class RulesetMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = ruleset_pb2.FirebaserulesBetaRulesetMetadata()
...
class RulesetSourceLanguageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ruleset_pb2.FirebaserulesBetaRulesetSourceLanguageEnum.Value(
            "FirebaserulesBetaRulesetSourceLanguageEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ruleset_pb2.FirebaserulesBetaRulesetSourceLanguageEnum.Name(resource)[
            len("FirebaserulesBetaRulesetSourceLanguageEnum") :
        ]
