...
class CertificateTemplate(object):
    ...
    def apply(self):
        ...
        response = stub.ApplyPrivatecaBetaCertificateTemplate(request)
    ...
    def delete(self):
        ...
        response = stub.DeletePrivatecaBetaCertificateTemplate(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        return stub.ListPrivatecaBetaCertificateTemplate(request).items

    def to_proto(self):
        resource = certificate_template_pb2.PrivatecaBetaCertificateTemplate()
        if Primitive.to_proto(self.name):
...
class CertificateTemplatePredefinedValues(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValues()
        )
...
class CertificateTemplatePredefinedValuesKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesKeyUsage()
        )
...
class CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesKeyUsageBaseKeyUsage()
        )
...
class CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage()
        )
...
class CertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsages(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsages()
        )
...
class CertificateTemplatePredefinedValuesCaOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesCaOptions()
        )
...
class CertificateTemplatePredefinedValuesPolicyIds(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesPolicyIds()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CertificateTemplatePredefinedValuesAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesAdditionalExtensions()
        )
...
class CertificateTemplatePredefinedValuesAdditionalExtensionsObjectId(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePredefinedValuesAdditionalExtensionsObjectId()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CertificateTemplateIdentityConstraints(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplateIdentityConstraints()
        )
...
class CertificateTemplateIdentityConstraintsCelExpression(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplateIdentityConstraintsCelExpression()
        )
...
class CertificateTemplatePassthroughExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePassthroughExtensions()
        )
...
class CertificateTemplatePassthroughExtensionsAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaBetaCertificateTemplatePassthroughExtensionsAdditionalExtensions()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CertificateTemplatePassthroughExtensionsKnownExtensionsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return certificate_template_pb2.PrivatecaBetaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum.Value(
            "PrivatecaBetaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return certificate_template_pb2.PrivatecaBetaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum.Name(
            resource
        )[
            len(
                "PrivatecaBetaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum"
            ) :
        ]
