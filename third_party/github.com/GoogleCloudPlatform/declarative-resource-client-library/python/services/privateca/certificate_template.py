...
class CertificateTemplate(object):
    ...
    def apply(self):
        ...
        request = certificate_template_pb2.ApplyPrivatecaCertificateTemplateRequest()
        ...
        response = stub.ApplyPrivatecaCertificateTemplate(request)
    ...
    def delete(self):
        ...
        request = certificate_template_pb2.DeletePrivatecaCertificateTemplateRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def to_proto(self):
        resource = certificate_template_pb2.PrivatecaCertificateTemplate()
        if Primitive.to_proto(self.name):
...
class CertificateTemplatePredefinedValues(object):
    ...
    def to_proto(self, resource):
        ...
        res = certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValues()
...
class CertificateTemplatePredefinedValuesKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesKeyUsage()
        )
...
class CertificateTemplatePredefinedValuesKeyUsageBaseKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesKeyUsageBaseKeyUsage()
        )
...
class CertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesKeyUsageExtendedKeyUsage()
        )
...
class CertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsages(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesKeyUsageUnknownExtendedKeyUsages()
        )
...
class CertificateTemplatePredefinedValuesCaOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesCaOptions()
        )
...
class CertificateTemplatePredefinedValuesPolicyIds(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesPolicyIds()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CertificateTemplatePredefinedValuesAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesAdditionalExtensions()
        )
...
class CertificateTemplatePredefinedValuesAdditionalExtensionsObjectId(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePredefinedValuesAdditionalExtensionsObjectId()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CertificateTemplateIdentityConstraints(object):
    ...
    def to_proto(self, resource):
        ...
        res = certificate_template_pb2.PrivatecaCertificateTemplateIdentityConstraints()
...
class CertificateTemplateIdentityConstraintsCelExpression(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplateIdentityConstraintsCelExpression()
        )
...
class CertificateTemplatePassthroughExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePassthroughExtensions()
        )
...
class CertificateTemplatePassthroughExtensionsAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            certificate_template_pb2.PrivatecaCertificateTemplatePassthroughExtensionsAdditionalExtensions()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CertificateTemplatePassthroughExtensionsKnownExtensionsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return certificate_template_pb2.PrivatecaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum.Value(
            "PrivatecaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return certificate_template_pb2.PrivatecaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum.Name(
            resource
        )[
            len(
                "PrivatecaCertificateTemplatePassthroughExtensionsKnownExtensionsEnum"
            ) :
        ]
