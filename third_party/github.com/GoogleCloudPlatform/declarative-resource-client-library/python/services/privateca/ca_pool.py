...
class CaPool(object):
    ...
    def apply(self):
        stub = ca_pool_pb2_grpc.PrivatecaCaPoolServiceStub(channel.Channel())
        request = ca_pool_pb2.ApplyPrivatecaCaPoolRequest()
        ...
        response = stub.ApplyPrivatecaCaPool(request)
    ...
    def delete(self):
        stub = ca_pool_pb2_grpc.PrivatecaCaPoolServiceStub(channel.Channel())
        request = ca_pool_pb2.DeletePrivatecaCaPoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeletePrivatecaCaPool(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = ca_pool_pb2_grpc.PrivatecaCaPoolServiceStub(channel.Channel())
        request = ca_pool_pb2.ListPrivatecaCaPoolRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListPrivatecaCaPool(request).items

    def to_proto(self):
        resource = ca_pool_pb2.PrivatecaCaPool()
        if Primitive.to_proto(self.name):
...
class CaPoolIssuancePolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicy()
...
class CaPoolIssuancePolicyAllowedKeyTypes(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyAllowedKeyTypes()
...
class CaPoolIssuancePolicyAllowedKeyTypesRsa(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyAllowedKeyTypesRsa()
...
class CaPoolIssuancePolicyAllowedKeyTypesEllipticCurve(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurve()
...
class CaPoolIssuancePolicyAllowedIssuanceModes(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyAllowedIssuanceModes()
...
class CaPoolIssuancePolicyBaselineValues(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValues()
...
class CaPoolIssuancePolicyBaselineValuesKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesKeyUsage()
...
class CaPoolIssuancePolicyBaselineValuesKeyUsageBaseKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesKeyUsageBaseKeyUsage()
        )
...
class CaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesKeyUsageExtendedKeyUsage()
        )
...
class CaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsages(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesKeyUsageUnknownExtendedKeyUsages()
        )
...
class CaPoolIssuancePolicyBaselineValuesCaOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesCaOptions()
...
class CaPoolIssuancePolicyBaselineValuesPolicyIds(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesPolicyIds()
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CaPoolIssuancePolicyBaselineValuesAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesAdditionalExtensions()
        )
...
class CaPoolIssuancePolicyBaselineValuesAdditionalExtensionsObjectId(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaCaPoolIssuancePolicyBaselineValuesAdditionalExtensionsObjectId()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CaPoolIssuancePolicyIdentityConstraints(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyIdentityConstraints()
...
class CaPoolIssuancePolicyIdentityConstraintsCelExpression(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaCaPoolIssuancePolicyIdentityConstraintsCelExpression()
        )
...
class CaPoolIssuancePolicyPassthroughExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolIssuancePolicyPassthroughExtensions()
...
class CaPoolIssuancePolicyPassthroughExtensionsAdditionalExtensions(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            ca_pool_pb2.PrivatecaCaPoolIssuancePolicyPassthroughExtensionsAdditionalExtensions()
        )
        if int64Array.to_proto(resource.object_id_path):
            res.object_id_path.extend(int64Array.to_proto(resource.object_id_path))
        return res
...
class CaPoolPublishingOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = ca_pool_pb2.PrivatecaCaPoolPublishingOptions()
...
class CaPoolTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaCaPoolTierEnum.Value(
            "PrivatecaCaPoolTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaCaPoolTierEnum.Name(resource)[
            len("PrivatecaCaPoolTierEnum") :
        ]
...
class CaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum.Value(
            "PrivatecaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum.Name(
            resource
        )[
            len(
                "PrivatecaCaPoolIssuancePolicyAllowedKeyTypesEllipticCurveSignatureAlgorithmEnum"
            ) :
        ]
...
class CaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum.Value(
            "PrivatecaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return ca_pool_pb2.PrivatecaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum.Name(
            resource
        )[
            len(
                "PrivatecaCaPoolIssuancePolicyPassthroughExtensionsKnownExtensionsEnum"
            ) :
        ]
