...
class UptimeCheckConfig(object):
    ...
    def apply(self):
        ...
        request = uptime_check_config_pb2.ApplyMonitoringUptimeCheckConfigRequest()
        ...
        response = stub.ApplyMonitoringUptimeCheckConfig(request)
...
class UptimeCheckConfigMonitoredResource(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringUptimeCheckConfigMonitoredResource()
...
class UptimeCheckConfigResourceGroup(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringUptimeCheckConfigResourceGroup()
...
class UptimeCheckConfigHttpCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringUptimeCheckConfigHttpCheck()
...
class UptimeCheckConfigHttpCheckAuthInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringUptimeCheckConfigHttpCheckAuthInfo()
...
class UptimeCheckConfigTcpCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringUptimeCheckConfigTcpCheck()
        if Primitive.to_proto(resource.port):
            res.port = Primitive.to_proto(resource.port)
        return res
...
class UptimeCheckConfigContentMatchers(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringUptimeCheckConfigContentMatchers()
...
class UptimeCheckConfigResourceGroupResourceTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigResourceGroupResourceTypeEnum.Value(
            "MonitoringUptimeCheckConfigResourceGroupResourceTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigResourceGroupResourceTypeEnum.Name(
            resource
        )[
            len("MonitoringUptimeCheckConfigResourceGroupResourceTypeEnum") :
        ]
...
class UptimeCheckConfigHttpCheckRequestMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigHttpCheckRequestMethodEnum.Value(
            "MonitoringUptimeCheckConfigHttpCheckRequestMethodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigHttpCheckRequestMethodEnum.Name(
            resource
        )[
            len("MonitoringUptimeCheckConfigHttpCheckRequestMethodEnum") :
        ]
...
class UptimeCheckConfigHttpCheckContentTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigHttpCheckContentTypeEnum.Value(
            "MonitoringUptimeCheckConfigHttpCheckContentTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigHttpCheckContentTypeEnum.Name(
            resource
        )[
            len("MonitoringUptimeCheckConfigHttpCheckContentTypeEnum") :
        ]
...
class UptimeCheckConfigContentMatchersMatcherEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigContentMatchersMatcherEnum.Value(
            "MonitoringUptimeCheckConfigContentMatchersMatcherEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringUptimeCheckConfigContentMatchersMatcherEnum.Name(
            resource
        )[
            len("MonitoringUptimeCheckConfigContentMatchersMatcherEnum") :
        ]
