...
class MonitoredProject(object):
    ...
    def apply(self):
        stub = monitored_project_pb2_grpc.MonitoringAlphaMonitoredProjectServiceStub(
            channel.Channel()
        )
        request = monitored_project_pb2.ApplyMonitoringAlphaMonitoredProjectRequest()
        ...
        response = stub.ApplyMonitoringAlphaMonitoredProject(request)
    ...
    def delete(self):
        ...
        request = monitored_project_pb2.DeleteMonitoringAlphaMonitoredProjectRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteMonitoringAlphaMonitoredProject(request)
    ...
    def list(self, metricsScope, service_account_file=""):
        ...
        request = monitored_project_pb2.ListMonitoringAlphaMonitoredProjectRequest()
        request.service_account_file = service_account_file
        request.MetricsScope = metricsScope

        return stub.ListMonitoringAlphaMonitoredProject(request).items

    def to_proto(self):
        resource = monitored_project_pb2.MonitoringAlphaMonitoredProject()
        if Primitive.to_proto(self.name):
