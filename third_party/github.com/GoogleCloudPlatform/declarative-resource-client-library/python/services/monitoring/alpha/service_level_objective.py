...
class ServiceLevelObjective(object):
    ...
    def apply(self):
        stub = service_level_objective_pb2_grpc.MonitoringAlphaServiceLevelObjectiveServiceStub(
            channel.Channel()
        )
        request = (
            service_level_objective_pb2.ApplyMonitoringAlphaServiceLevelObjectiveRequest()
        )
    ...
    def delete(self):
        ...
        request = (
            service_level_objective_pb2.DeleteMonitoringAlphaServiceLevelObjectiveRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteMonitoringAlphaServiceLevelObjective(request)
    ...
    def list(self, project, service, service_account_file=""):
        ...
        request = (
            service_level_objective_pb2.ListMonitoringAlphaServiceLevelObjectiveRequest()
        )
        ...
        return stub.ListMonitoringAlphaServiceLevelObjective(request).items

    def to_proto(self):
        resource = service_level_objective_pb2.MonitoringAlphaServiceLevelObjective()
        if Primitive.to_proto(self.name):
...
class ServiceLevelObjectiveServiceLevelIndicator(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicator()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorBasicSli(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSli()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorBasicSliAvailability(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliAvailability()
        )
        return res
...
class ServiceLevelObjectiveServiceLevelIndicatorBasicSliLatency(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliLatency()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationAvailability(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationAvailability()
        )
        return res
...
class ServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationLatency(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationLatency()
        )
        if Primitive.to_proto(resource.threshold):
            res.threshold = Primitive.to_proto(resource.threshold)
...
class ServiceLevelObjectiveServiceLevelIndicatorRequestBased(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorRequestBased()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorRequestBasedGoodTotalRatio(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorRequestBasedGoodTotalRatio()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorRequestBasedDistributionCut(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorRequestBasedDistributionCut()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorRequestBasedDistributionCutRange(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorRequestBasedDistributionCutRange()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBased(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBased()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThreshold(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThreshold()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformance(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformance()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformanceGoodTotalRatio(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformanceGoodTotalRatio()
        )
        if Primitive.to_proto(resource.good_service_filter):
            res.good_service_filter = Primitive.to_proto(resource.good_service_filter)
        if Primitive.to_proto(resource.bad_service_filter):
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformanceDistributionCut(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformanceDistributionCut()
        )
        if Primitive.to_proto(resource.distribution_filter):
            res.distribution_filter = Primitive.to_proto(resource.distribution_filter)
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformanceDistributionCutRange(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdPerformanceDistributionCutRange()
        )
        if Primitive.to_proto(resource.min):
            res.min = Primitive.to_proto(resource.min)
        if Primitive.to_proto(resource.max):
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformance(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformance()
        )
        if Primitive.to_proto(resource.method):
            res.method.extend(Primitive.to_proto(resource.method))
        if Primitive.to_proto(resource.location):
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceAvailability(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceAvailability()
        )
        return res
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceLatency(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceLatency()
        )
        if Primitive.to_proto(resource.threshold):
            res.threshold = Primitive.to_proto(resource.threshold)
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationAvailability(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationAvailability()
        )
        return res
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationLatency(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationLatency()
        )
        if Primitive.to_proto(resource.threshold):
            res.threshold = Primitive.to_proto(resource.threshold)
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricMeanInRange(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricMeanInRange()
        )
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricMeanInRangeRange(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricMeanInRangeRange()
        )
        if Primitive.to_proto(resource.min):
            res.min = Primitive.to_proto(resource.min)
        if Primitive.to_proto(resource.max):
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricSumInRange(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricSumInRange()
        )
        if Primitive.to_proto(resource.time_series):
            res.time_series = Primitive.to_proto(resource.time_series)
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricSumInRangeRange(
    ...
    def to_proto(self, resource):
        ...
        res = (
            service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedMetricSumInRangeRange()
        )
        if Primitive.to_proto(resource.min):
            res.min = Primitive.to_proto(resource.min)
        if Primitive.to_proto(resource.max):
...
class ServiceLevelObjectiveServiceLevelIndicatorBasicSliLatencyExperienceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliLatencyExperienceEnum.Value(
            "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliLatencyExperienceEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliLatencyExperienceEnum.Name(
            resource
        )[
            len(
                "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliLatencyExperienceEnum"
            ) :
        ]
...
class ServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationLatencyExperienceEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationLatencyExperienceEnum.Value(
            "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationLatencyExperienceEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationLatencyExperienceEnum.Name(
            resource
        )[
            len(
                "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorBasicSliOperationLatencyExperienceEnum"
            ) :
        ]
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceLatencyExperienceEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceLatencyExperienceEnum.Value(
            "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceLatencyExperienceEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceLatencyExperienceEnum.Name(
            resource
        )[
            len(
                "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceLatencyExperienceEnum"
            ) :
        ]
...
class ServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationLatencyExperienceEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationLatencyExperienceEnum.Value(
            "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationLatencyExperienceEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationLatencyExperienceEnum.Name(
            resource
        )[
            len(
                "MonitoringAlphaServiceLevelObjectiveServiceLevelIndicatorWindowsBasedGoodTotalRatioThresholdBasicSliPerformanceOperationLatencyExperienceEnum"
            ) :
        ]
...
class ServiceLevelObjectiveCalendarPeriodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveCalendarPeriodEnum.Value(
            "MonitoringAlphaServiceLevelObjectiveCalendarPeriodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return service_level_objective_pb2.MonitoringAlphaServiceLevelObjectiveCalendarPeriodEnum.Name(
            resource
        )[
            len("MonitoringAlphaServiceLevelObjectiveCalendarPeriodEnum") :
        ]
