...
class MetricDescriptor(object):
    ...
    def apply(self):
        ...
        request = metric_descriptor_pb2.ApplyMonitoringAlphaMetricDescriptorRequest()
        ...
        response = stub.ApplyMonitoringAlphaMetricDescriptor(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = metric_descriptor_pb2.ListMonitoringAlphaMetricDescriptorRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListMonitoringAlphaMetricDescriptor(request).items

    def to_proto(self):
        resource = metric_descriptor_pb2.MonitoringAlphaMetricDescriptor()
        if Primitive.to_proto(self.type):
...
class MetricDescriptorLabels(object):
    ...
    def to_proto(self, resource):
        ...
        res = metric_descriptor_pb2.MonitoringAlphaMetricDescriptorLabels()
...
class MetricDescriptorMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = metric_descriptor_pb2.MonitoringAlphaMetricDescriptorMetadata()
...
class MetricDescriptorLabelsValueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringAlphaMetricDescriptorLabelsValueTypeEnum.Value(
            "MonitoringAlphaMetricDescriptorLabelsValueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringAlphaMetricDescriptorLabelsValueTypeEnum.Name(
            resource
        )[
            len("MonitoringAlphaMetricDescriptorLabelsValueTypeEnum") :
        ]
...
class MetricDescriptorMetricKindEnum(object):
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringAlphaMetricDescriptorMetricKindEnum.Name(
            resource
        )[len("MonitoringAlphaMetricDescriptorMetricKindEnum") :]
...
class MetricDescriptorValueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringAlphaMetricDescriptorValueTypeEnum.Value(
            "MonitoringAlphaMetricDescriptorValueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringAlphaMetricDescriptorValueTypeEnum.Name(
            resource
        )[len("MonitoringAlphaMetricDescriptorValueTypeEnum") :]
...
class MetricDescriptorMetadataLaunchStageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringAlphaMetricDescriptorMetadataLaunchStageEnum.Value(
            "MonitoringAlphaMetricDescriptorMetadataLaunchStageEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringAlphaMetricDescriptorMetadataLaunchStageEnum.Name(
            resource
        )[
            len("MonitoringAlphaMetricDescriptorMetadataLaunchStageEnum") :
        ]
