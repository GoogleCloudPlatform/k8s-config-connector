...
class MonitoredProject(object):
    ...
    def apply(self):
        stub = monitored_project_pb2_grpc.MonitoringBetaMonitoredProjectServiceStub(
            channel.Channel()
        )
        request = monitored_project_pb2.ApplyMonitoringBetaMonitoredProjectRequest()
        ...
        response = stub.ApplyMonitoringBetaMonitoredProject(request)
    ...
    def delete(self):
        ...
        request = monitored_project_pb2.DeleteMonitoringBetaMonitoredProjectRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteMonitoringBetaMonitoredProject(request)
    ...
    def list(self, metricsScope, service_account_file=""):
        ...
        request = monitored_project_pb2.ListMonitoringBetaMonitoredProjectRequest()
        request.service_account_file = service_account_file
        request.MetricsScope = metricsScope

        return stub.ListMonitoringBetaMonitoredProject(request).items

    def to_proto(self):
        resource = monitored_project_pb2.MonitoringBetaMonitoredProject()
        if Primitive.to_proto(self.name):
