...
class Group(object):
    ...
    def apply(self):
        ...
        request = group_pb2.ApplyMonitoringBetaGroupRequest()
        ...
        response = stub.ApplyMonitoringBetaGroup(request)
    ...
    def delete(self):
        stub = group_pb2_grpc.MonitoringBetaGroupServiceStub(channel.Channel())
        request = group_pb2.DeleteMonitoringBetaGroupRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.display_name):
            request.resource.display_name = Primitive.to_proto(self.display_name)
    ...
    def to_proto(self):
        resource = group_pb2.MonitoringBetaGroup()
        if Primitive.to_proto(self.display_name):
