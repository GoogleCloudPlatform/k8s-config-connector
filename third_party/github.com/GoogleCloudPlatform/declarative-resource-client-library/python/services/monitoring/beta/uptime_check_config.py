...
class UptimeCheckConfig(object):
    ...
    def apply(self):
        stub = uptime_check_config_pb2_grpc.MonitoringBetaUptimeCheckConfigServiceStub(
            channel.Channel()
        )
        request = uptime_check_config_pb2.ApplyMonitoringBetaUptimeCheckConfigRequest()
        ...
        response = stub.ApplyMonitoringBetaUptimeCheckConfig(request)
    ...
    def delete(self):
        ...
        request = uptime_check_config_pb2.DeleteMonitoringBetaUptimeCheckConfigRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteMonitoringBetaUptimeCheckConfig(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = uptime_check_config_pb2.ListMonitoringBetaUptimeCheckConfigRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListMonitoringBetaUptimeCheckConfig(request).items

    def to_proto(self):
        resource = uptime_check_config_pb2.MonitoringBetaUptimeCheckConfig()
        if Primitive.to_proto(self.name):
...
class UptimeCheckConfigMonitoredResource(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigMonitoredResource()
...
class UptimeCheckConfigResourceGroup(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigResourceGroup()
...
class UptimeCheckConfigHttpCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigHttpCheck()
...
class UptimeCheckConfigHttpCheckAuthInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigHttpCheckAuthInfo()
...
class UptimeCheckConfigTcpCheck(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigTcpCheck()
        if Primitive.to_proto(resource.port):
            res.port = Primitive.to_proto(resource.port)
        return res
...
class UptimeCheckConfigContentMatchers(object):
    ...
    def to_proto(self, resource):
        ...
        res = uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigContentMatchers()
...
class UptimeCheckConfigResourceGroupResourceTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigResourceGroupResourceTypeEnum.Value(
            "MonitoringBetaUptimeCheckConfigResourceGroupResourceTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigResourceGroupResourceTypeEnum.Name(
            resource
        )[
            len("MonitoringBetaUptimeCheckConfigResourceGroupResourceTypeEnum") :
        ]
...
class UptimeCheckConfigHttpCheckRequestMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigHttpCheckRequestMethodEnum.Value(
            "MonitoringBetaUptimeCheckConfigHttpCheckRequestMethodEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigHttpCheckRequestMethodEnum.Name(
            resource
        )[
            len("MonitoringBetaUptimeCheckConfigHttpCheckRequestMethodEnum") :
        ]
...
class UptimeCheckConfigHttpCheckContentTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigHttpCheckContentTypeEnum.Value(
            "MonitoringBetaUptimeCheckConfigHttpCheckContentTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigHttpCheckContentTypeEnum.Name(
            resource
        )[
            len("MonitoringBetaUptimeCheckConfigHttpCheckContentTypeEnum") :
        ]
...
class UptimeCheckConfigContentMatchersMatcherEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigContentMatchersMatcherEnum.Value(
            "MonitoringBetaUptimeCheckConfigContentMatchersMatcherEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return uptime_check_config_pb2.MonitoringBetaUptimeCheckConfigContentMatchersMatcherEnum.Name(
            resource
        )[
            len("MonitoringBetaUptimeCheckConfigContentMatchersMatcherEnum") :
        ]
