...
class MetricDescriptor(object):
    ...
    def apply(self):
        ...
        request = metric_descriptor_pb2.ApplyMonitoringBetaMetricDescriptorRequest()
        ...
        response = stub.ApplyMonitoringBetaMetricDescriptor(request)
    ...
    def delete(self):
        ...
        request = metric_descriptor_pb2.DeleteMonitoringBetaMetricDescriptorRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.type):
            request.resource.type = Primitive.to_proto(self.type)
    ...
    def to_proto(self):
        resource = metric_descriptor_pb2.MonitoringBetaMetricDescriptor()
        if Primitive.to_proto(self.type):
...
class MetricDescriptorLabels(object):
    ...
    def to_proto(self, resource):
        ...
        res = metric_descriptor_pb2.MonitoringBetaMetricDescriptorLabels()
...
class MetricDescriptorMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = metric_descriptor_pb2.MonitoringBetaMetricDescriptorMetadata()
...
class MetricDescriptorLabelsValueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorLabelsValueTypeEnum.Value(
            "MonitoringBetaMetricDescriptorLabelsValueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorLabelsValueTypeEnum.Name(
            resource
        )[
            len("MonitoringBetaMetricDescriptorLabelsValueTypeEnum") :
        ]
...
class MetricDescriptorMetricKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorMetricKindEnum.Value(
            "MonitoringBetaMetricDescriptorMetricKindEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorMetricKindEnum.Name(
            resource
        )[len("MonitoringBetaMetricDescriptorMetricKindEnum") :]
...
class MetricDescriptorValueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorValueTypeEnum.Value(
            "MonitoringBetaMetricDescriptorValueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorValueTypeEnum.Name(
            resource
        )[len("MonitoringBetaMetricDescriptorValueTypeEnum") :]
...
class MetricDescriptorMetadataLaunchStageEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorMetadataLaunchStageEnum.Value(
            "MonitoringBetaMetricDescriptorMetadataLaunchStageEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorMetadataLaunchStageEnum.Name(
            resource
        )[
            len("MonitoringBetaMetricDescriptorMetadataLaunchStageEnum") :
        ]
...
class MetricDescriptorLaunchStageEnum(object):
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metric_descriptor_pb2.MonitoringBetaMetricDescriptorLaunchStageEnum.Name(
            resource
        )[len("MonitoringBetaMetricDescriptorLaunchStageEnum") :]
