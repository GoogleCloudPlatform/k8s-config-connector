...
class NotificationChannel(object):
    ...
    def apply(self):
        stub = (
            notification_channel_pb2_grpc.MonitoringBetaNotificationChannelServiceStub(
                channel.Channel()
            )
        )
        request = (
            notification_channel_pb2.ApplyMonitoringBetaNotificationChannelRequest()
        )
        ...
        response = stub.ApplyMonitoringBetaNotificationChannel(request)
    ...
    def delete(self):
        ...
        request = (
            notification_channel_pb2.DeleteMonitoringBetaNotificationChannelRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.description):
            request.resource.description = Primitive.to_proto(self.description)
        ...
        response = stub.DeleteMonitoringBetaNotificationChannel(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = (
            notification_channel_pb2.ListMonitoringBetaNotificationChannelRequest()
        )
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListMonitoringBetaNotificationChannel(request).items

    def to_proto(self):
        resource = notification_channel_pb2.MonitoringBetaNotificationChannel()
        if Primitive.to_proto(self.description):
...
class NotificationChannelVerificationStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return notification_channel_pb2.MonitoringBetaNotificationChannelVerificationStatusEnum.Value(
            "MonitoringBetaNotificationChannelVerificationStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return notification_channel_pb2.MonitoringBetaNotificationChannelVerificationStatusEnum.Name(
            resource
        )[
            len("MonitoringBetaNotificationChannelVerificationStatusEnum") :
        ]
