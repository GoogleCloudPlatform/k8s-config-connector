...
class ServerTlsPolicy(object):
    ...
    def apply(self):
        stub = server_tls_policy_pb2_grpc.NetworksecurityBetaServerTlsPolicyServiceStub(
            channel.Channel()
        )
        request = server_tls_policy_pb2.ApplyNetworksecurityBetaServerTlsPolicyRequest()
        ...
        response = stub.ApplyNetworksecurityBetaServerTlsPolicy(request)
    ...
    def delete(self):
        ...
        request = (
            server_tls_policy_pb2.DeleteNetworksecurityBetaServerTlsPolicyRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworksecurityBetaServerTlsPolicy(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = server_tls_policy_pb2.ListNetworksecurityBetaServerTlsPolicyRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListNetworksecurityBetaServerTlsPolicy(request).items

    def to_proto(self):
        resource = server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicy()
        if Primitive.to_proto(self.name):
...
class ServerTlsPolicyServerCertificate(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicyServerCertificate()
        )
...
class ServerTlsPolicyServerCertificateGrpcEndpoint(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicyServerCertificateGrpcEndpoint()
        )
...
class ServerTlsPolicyServerCertificateCertificateProviderInstance(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicyServerCertificateCertificateProviderInstance()
        )
...
class ServerTlsPolicyMtlsPolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicyMtlsPolicy()
...
class ServerTlsPolicyMtlsPolicyClientValidationCa(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicyMtlsPolicyClientValidationCa()
        )
...
class ServerTlsPolicyMtlsPolicyClientValidationCaGrpcEndpoint(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicyMtlsPolicyClientValidationCaGrpcEndpoint()
        )
        if Primitive.to_proto(resource.target_uri):
            res.target_uri = Primitive.to_proto(resource.target_uri)
        return res
...
class ServerTlsPolicyMtlsPolicyClientValidationCaCertificateProviderInstance(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            server_tls_policy_pb2.NetworksecurityBetaServerTlsPolicyMtlsPolicyClientValidationCaCertificateProviderInstance()
        )
        if Primitive.to_proto(resource.plugin_instance):
            res.plugin_instance = Primitive.to_proto(resource.plugin_instance)
        return res
