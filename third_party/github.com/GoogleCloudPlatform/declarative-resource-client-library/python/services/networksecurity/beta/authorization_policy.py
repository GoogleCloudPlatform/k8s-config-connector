...
class AuthorizationPolicy(object):
    ...
    def apply(self):
        stub = authorization_policy_pb2_grpc.NetworksecurityBetaAuthorizationPolicyServiceStub(
            channel.Channel()
        )
        request = (
            authorization_policy_pb2.ApplyNetworksecurityBetaAuthorizationPolicyRequest()
        )
        ...
        response = stub.ApplyNetworksecurityBetaAuthorizationPolicy(request)
    ...
    def delete(self):
        ...
        request = (
            authorization_policy_pb2.DeleteNetworksecurityBetaAuthorizationPolicyRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteNetworksecurityBetaAuthorizationPolicy(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = (
            authorization_policy_pb2.ListNetworksecurityBetaAuthorizationPolicyRequest()
        )
        ...
        return stub.ListNetworksecurityBetaAuthorizationPolicy(request).items

    def to_proto(self):
        resource = authorization_policy_pb2.NetworksecurityBetaAuthorizationPolicy()
        if Primitive.to_proto(self.name):
...
class AuthorizationPolicyRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = authorization_policy_pb2.NetworksecurityBetaAuthorizationPolicyRules()
...
class AuthorizationPolicyRulesSources(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            authorization_policy_pb2.NetworksecurityBetaAuthorizationPolicyRulesSources()
        )
...
class AuthorizationPolicyRulesDestinations(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            authorization_policy_pb2.NetworksecurityBetaAuthorizationPolicyRulesDestinations()
        )
...
class AuthorizationPolicyRulesDestinationsHttpHeaderMatch(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            authorization_policy_pb2.NetworksecurityBetaAuthorizationPolicyRulesDestinationsHttpHeaderMatch()
        )
...
class AuthorizationPolicyActionEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return authorization_policy_pb2.NetworksecurityBetaAuthorizationPolicyActionEnum.Value(
            "NetworksecurityBetaAuthorizationPolicyActionEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return authorization_policy_pb2.NetworksecurityBetaAuthorizationPolicyActionEnum.Name(
            resource
        )[
            len("NetworksecurityBetaAuthorizationPolicyActionEnum") :
        ]
