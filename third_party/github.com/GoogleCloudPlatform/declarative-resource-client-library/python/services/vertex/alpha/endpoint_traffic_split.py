...
class EndpointTrafficSplit(object):
    ...
    def apply(self):
        stub = (
            endpoint_traffic_split_pb2_grpc.VertexAlphaEndpointTrafficSplitServiceStub(
                channel.Channel()
            )
        )
        request = (
            endpoint_traffic_split_pb2.ApplyVertexAlphaEndpointTrafficSplitRequest()
        )
        ...
        response = stub.ApplyVertexAlphaEndpointTrafficSplit(request)
    ...
    def delete(self):
        ...
        request = (
            endpoint_traffic_split_pb2.DeleteVertexAlphaEndpointTrafficSplitRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.endpoint):
            request.resource.endpoint = Primitive.to_proto(self.endpoint)
        ...
        response = stub.DeleteVertexAlphaEndpointTrafficSplit(request)
    ...
    def list(self, location, service_account_file=""):
        ...
        request = (
            endpoint_traffic_split_pb2.ListVertexAlphaEndpointTrafficSplitRequest()
        )
        request.service_account_file = service_account_file
        request.Location = location

        return stub.ListVertexAlphaEndpointTrafficSplit(request).items

    def to_proto(self):
        resource = endpoint_traffic_split_pb2.VertexAlphaEndpointTrafficSplit()
        if Primitive.to_proto(self.endpoint):
...
class EndpointTrafficSplitTrafficSplit(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_traffic_split_pb2.VertexAlphaEndpointTrafficSplitTrafficSplit()
