...
from google3.cloud.graphite.mmv2.services.google.vertex import metadata_schema_pb2
from google3.cloud.graphite.mmv2.services.google.vertex import metadata_schema_pb2_grpc
...
class MetadataSchema(object):
    ...
    def apply(self):
        stub = metadata_schema_pb2_grpc.VertexAlphaMetadataSchemaServiceStub(
            channel.Channel()
        )
        request = metadata_schema_pb2.ApplyVertexAlphaMetadataSchemaRequest()
        ...
        response = stub.ApplyVertexAlphaMetadataSchema(request)
    ...
    def delete(self):
        ...
        request = metadata_schema_pb2.DeleteVertexAlphaMetadataSchemaRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexAlphaMetadataSchema(request)
    ...
    def list(self, project, location, metadataStore, service_account_file=""):
        ...
        request = metadata_schema_pb2.ListVertexAlphaMetadataSchemaRequest()
        ...
        return stub.ListVertexAlphaMetadataSchema(request).items

    def to_proto(self):
        resource = metadata_schema_pb2.VertexAlphaMetadataSchema()
        if Primitive.to_proto(self.name):
...
class MetadataSchemaSchemaTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexAlphaMetadataSchemaSchemaTypeEnum.Value(
            "VertexAlphaMetadataSchemaSchemaTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexAlphaMetadataSchemaSchemaTypeEnum.Name(
            resource
        )[len("VertexAlphaMetadataSchemaSchemaTypeEnum") :]
