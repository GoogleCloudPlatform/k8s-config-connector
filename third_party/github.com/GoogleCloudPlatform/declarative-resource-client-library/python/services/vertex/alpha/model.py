...
from google3.cloud.graphite.mmv2.services.google.vertex import model_pb2
from google3.cloud.graphite.mmv2.services.google.vertex import model_pb2_grpc
...
class Model(object):
    ...
    def apply(self):
        stub = model_pb2_grpc.VertexAlphaModelServiceStub(channel.Channel())
        request = model_pb2.ApplyVertexAlphaModelRequest()
        ...
        response = stub.ApplyVertexAlphaModel(request)
    ...
    def delete(self):
        stub = model_pb2_grpc.VertexAlphaModelServiceStub(channel.Channel())
        request = model_pb2.DeleteVertexAlphaModelRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexAlphaModel(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = model_pb2_grpc.VertexAlphaModelServiceStub(channel.Channel())
        request = model_pb2.ListVertexAlphaModelRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexAlphaModel(request).items

    def to_proto(self):
        resource = model_pb2.VertexAlphaModel()
        if Primitive.to_proto(self.name):
...
class ModelSupportedExportFormats(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelSupportedExportFormats()
...
class ModelOriginalModelInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelOriginalModelInfo()
...
class ModelContainerSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelContainerSpec()
...
class ModelContainerSpecEnv(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelContainerSpecEnv()
...
class ModelContainerSpecPorts(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelContainerSpecPorts()
...
class ModelContainerSpecAcceleratorRequirements(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelContainerSpecAcceleratorRequirements()
...
class ModelDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelDeployedModels()
...
class ModelEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexAlphaModelEncryptionSpec()
...
class ModelSupportedExportFormatsExportableContentsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexAlphaModelSupportedExportFormatsExportableContentsEnum.Value(
            "VertexAlphaModelSupportedExportFormatsExportableContentsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            model_pb2.VertexAlphaModelSupportedExportFormatsExportableContentsEnum.Name(
                resource
            )[len("VertexAlphaModelSupportedExportFormatsExportableContentsEnum") :]
        )
...
class ModelContainerSpecAcceleratorRequirementsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexAlphaModelContainerSpecAcceleratorRequirementsTypeEnum.Value(
            "VertexAlphaModelContainerSpecAcceleratorRequirementsTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            model_pb2.VertexAlphaModelContainerSpecAcceleratorRequirementsTypeEnum.Name(
                resource
            )[len("VertexAlphaModelContainerSpecAcceleratorRequirementsTypeEnum") :]
        )
...
class ModelSupportedDeploymentResourcesTypesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexAlphaModelSupportedDeploymentResourcesTypesEnum.Value(
            "VertexAlphaModelSupportedDeploymentResourcesTypesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexAlphaModelSupportedDeploymentResourcesTypesEnum.Name(
            resource
        )[len("VertexAlphaModelSupportedDeploymentResourcesTypesEnum") :]
