...
func ProtoToVertexAlphaEndpointTrafficSplitTrafficSplit(p *alphapb.VertexAlphaEndpointTrafficSplitTrafficSplit) *alpha.EndpointTrafficSplitTrafficSplit {
	if p == nil {
		return nil
	}
...
func ProtoToEndpointTrafficSplit(p *alphapb.VertexAlphaEndpointTrafficSplit) *alpha.EndpointTrafficSplit {
	...
	for _, r := range p.GetTrafficSplit() {
		obj.TrafficSplit = append(obj.TrafficSplit, *ProtoToVertexAlphaEndpointTrafficSplitTrafficSplit(r))
	}
	return obj
}

// EndpointTrafficSplitTrafficSplitToProto converts a EndpointTrafficSplitTrafficSplit object to its proto representation.
func VertexAlphaEndpointTrafficSplitTrafficSplitToProto(o *alpha.EndpointTrafficSplitTrafficSplit) *alphapb.VertexAlphaEndpointTrafficSplitTrafficSplit {
	if o == nil {
		return nil
	}
	p := &alphapb.VertexAlphaEndpointTrafficSplitTrafficSplit{}
...
func EndpointTrafficSplitToProto(resource *alpha.EndpointTrafficSplit) *alphapb.VertexAlphaEndpointTrafficSplit {
	p := &alphapb.VertexAlphaEndpointTrafficSplit{}
	p.SetEndpoint(dcl.ValueOrEmptyString(resource.Endpoint))
	p.SetProject(dcl.ValueOrEmptyString(resource.Project))
	p.SetLocation(dcl.ValueOrEmptyString(resource.Location))
	p.SetEtag(dcl.ValueOrEmptyString(resource.Etag))
	sTrafficSplit := make([]*alphapb.VertexAlphaEndpointTrafficSplitTrafficSplit, len(resource.TrafficSplit))
	for i, r := range resource.TrafficSplit {
		sTrafficSplit[i] = VertexAlphaEndpointTrafficSplitTrafficSplitToProto(&r)
	}
...
func (s *EndpointTrafficSplitServer) applyEndpointTrafficSplit(ctx context.Context, c *alpha.Client, request *alphapb.ApplyVertexAlphaEndpointTrafficSplitRequest) (*alphapb.VertexAlphaEndpointTrafficSplit, error) {
...
// applyVertexAlphaEndpointTrafficSplit handles the gRPC request by passing it to the underlying EndpointTrafficSplit Apply() method.
func (s *EndpointTrafficSplitServer) ApplyVertexAlphaEndpointTrafficSplit(ctx context.Context, request *alphapb.ApplyVertexAlphaEndpointTrafficSplitRequest) (*alphapb.VertexAlphaEndpointTrafficSplit, error) {
...
func (s *EndpointTrafficSplitServer) DeleteVertexAlphaEndpointTrafficSplit(ctx context.Context, request *alphapb.DeleteVertexAlphaEndpointTrafficSplitRequest) (*emptypb.Empty, error) {

	return nil, errors.New("no delete endpoint for EndpointTrafficSplit")

}

// ListVertexAlphaEndpointTrafficSplit is a no-op method because EndpointTrafficSplit has no list method.
func (s *EndpointTrafficSplitServer) ListVertexAlphaEndpointTrafficSplit(_ context.Context, _ *alphapb.ListVertexAlphaEndpointTrafficSplitRequest) (*alphapb.ListVertexAlphaEndpointTrafficSplitResponse, error) {
	return nil, nil
}
