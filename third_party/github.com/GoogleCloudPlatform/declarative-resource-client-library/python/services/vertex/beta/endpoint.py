...
class Endpoint(object):
    ...
    def apply(self):
        stub = endpoint_pb2_grpc.VertexBetaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ApplyVertexBetaEndpointRequest()
        ...
        response = stub.ApplyVertexBetaEndpoint(request)
    ...
    def delete(self):
        stub = endpoint_pb2_grpc.VertexBetaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.DeleteVertexBetaEndpointRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexBetaEndpoint(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = endpoint_pb2_grpc.VertexBetaEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ListVertexBetaEndpointRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexBetaEndpoint(request).items

    def to_proto(self):
        resource = endpoint_pb2.VertexBetaEndpoint()
        if Primitive.to_proto(self.name):
...
class EndpointDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexBetaEndpointDeployedModels()
...
class EndpointDeployedModelsDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexBetaEndpointDeployedModelsDedicatedResources()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexBetaEndpointDeployedModelsDedicatedResourcesMachineSpec()
        )
...
class EndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexBetaEndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs()
        )
...
class EndpointDeployedModelsAutomaticResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexBetaEndpointDeployedModelsAutomaticResources()
        if Primitive.to_proto(resource.min_replica_count):
            res.min_replica_count = Primitive.to_proto(resource.min_replica_count)
        if Primitive.to_proto(resource.max_replica_count):
            res.max_replica_count = Primitive.to_proto(resource.max_replica_count)
...
class EndpointDeployedModelsPrivateEndpoints(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexBetaEndpointDeployedModelsPrivateEndpoints()
...
class EndpointEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexBetaEndpointEncryptionSpec()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Value(
            "VertexBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Name(
            resource
        )[
            len(
                "VertexBetaEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum"
            ) :
        ]
