...
class ModelDeployment(object):
    ...
    def apply(self):
        stub = model_deployment_pb2_grpc.VertexBetaModelDeploymentServiceStub(
            channel.Channel()
        )
        request = model_deployment_pb2.ApplyVertexBetaModelDeploymentRequest()
        ...
        response = stub.ApplyVertexBetaModelDeployment(request)
    ...
    def delete(self):
        ...
        request = model_deployment_pb2.DeleteVertexBetaModelDeploymentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.model):
            request.resource.model = Primitive.to_proto(self.model)
        ...
        response = stub.DeleteVertexBetaModelDeployment(request)
    ...
    def list(self, project, location, endpoint, service_account_file=""):
        ...
        request = model_deployment_pb2.ListVertexBetaModelDeploymentRequest()
        ...
        return stub.ListVertexBetaModelDeployment(request).items

    def to_proto(self):
        resource = model_deployment_pb2.VertexBetaModelDeployment()
        if Primitive.to_proto(self.model):
...
class ModelDeploymentDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_deployment_pb2.VertexBetaModelDeploymentDedicatedResources()
...
class ModelDeploymentDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            model_deployment_pb2.VertexBetaModelDeploymentDedicatedResourcesMachineSpec()
        )
