...
class Model(object):
    ...
    def apply(self):
        stub = model_pb2_grpc.VertexBetaModelServiceStub(channel.Channel())
        request = model_pb2.ApplyVertexBetaModelRequest()
        ...
        response = stub.ApplyVertexBetaModel(request)
    ...
    def delete(self):
        stub = model_pb2_grpc.VertexBetaModelServiceStub(channel.Channel())
        request = model_pb2.DeleteVertexBetaModelRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexBetaModel(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = model_pb2_grpc.VertexBetaModelServiceStub(channel.Channel())
        request = model_pb2.ListVertexBetaModelRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexBetaModel(request).items

    def to_proto(self):
        resource = model_pb2.VertexBetaModel()
        if Primitive.to_proto(self.name):
...
class ModelSupportedExportFormats(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelSupportedExportFormats()
...
class ModelOriginalModelInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelOriginalModelInfo()
...
class ModelContainerSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelContainerSpec()
...
class ModelContainerSpecEnv(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelContainerSpecEnv()
...
class ModelContainerSpecPorts(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelContainerSpecPorts()
...
class ModelContainerSpecAcceleratorRequirements(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelContainerSpecAcceleratorRequirements()
...
class ModelDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelDeployedModels()
...
class ModelEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexBetaModelEncryptionSpec()
...
class ModelSupportedExportFormatsExportableContentsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            model_pb2.VertexBetaModelSupportedExportFormatsExportableContentsEnum.Value(
                "VertexBetaModelSupportedExportFormatsExportableContentsEnum%s"
                % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            model_pb2.VertexBetaModelSupportedExportFormatsExportableContentsEnum.Name(
                resource
            )[len("VertexBetaModelSupportedExportFormatsExportableContentsEnum") :]
        )
...
class ModelContainerSpecAcceleratorRequirementsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return (
            model_pb2.VertexBetaModelContainerSpecAcceleratorRequirementsTypeEnum.Value(
                "VertexBetaModelContainerSpecAcceleratorRequirementsTypeEnum%s"
                % resource
            )
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return (
            model_pb2.VertexBetaModelContainerSpecAcceleratorRequirementsTypeEnum.Name(
                resource
            )[len("VertexBetaModelContainerSpecAcceleratorRequirementsTypeEnum") :]
        )
...
class ModelSupportedDeploymentResourcesTypesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexBetaModelSupportedDeploymentResourcesTypesEnum.Value(
            "VertexBetaModelSupportedDeploymentResourcesTypesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexBetaModelSupportedDeploymentResourcesTypesEnum.Name(
            resource
        )[len("VertexBetaModelSupportedDeploymentResourcesTypesEnum") :]
