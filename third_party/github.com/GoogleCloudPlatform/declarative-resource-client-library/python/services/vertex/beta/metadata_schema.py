...
class MetadataSchema(object):
    ...
    def apply(self):
        stub = metadata_schema_pb2_grpc.VertexBetaMetadataSchemaServiceStub(
            channel.Channel()
        )
        request = metadata_schema_pb2.ApplyVertexBetaMetadataSchemaRequest()
        ...
        response = stub.ApplyVertexBetaMetadataSchema(request)
    ...
    def delete(self):
        ...
        request = metadata_schema_pb2.DeleteVertexBetaMetadataSchemaRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexBetaMetadataSchema(request)
    ...
    def list(self, project, location, metadataStore, service_account_file=""):
        ...
        request = metadata_schema_pb2.ListVertexBetaMetadataSchemaRequest()
        ...
        return stub.ListVertexBetaMetadataSchema(request).items

    def to_proto(self):
        resource = metadata_schema_pb2.VertexBetaMetadataSchema()
        if Primitive.to_proto(self.name):
...
class MetadataSchemaSchemaTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexBetaMetadataSchemaSchemaTypeEnum.Value(
            "VertexBetaMetadataSchemaSchemaTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexBetaMetadataSchemaSchemaTypeEnum.Name(
            resource
        )[len("VertexBetaMetadataSchemaSchemaTypeEnum") :]
