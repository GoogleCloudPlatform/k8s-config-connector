...
from google3.cloud.graphite.mmv2.services.google.vertex import (
...
class EndpointTrafficSplit(object):
    ...
    def apply(self):
        stub = (
            endpoint_traffic_split_pb2_grpc.VertexBetaEndpointTrafficSplitServiceStub(
                channel.Channel()
            )
        )
        request = (
            endpoint_traffic_split_pb2.ApplyVertexBetaEndpointTrafficSplitRequest()
        )
        ...
        response = stub.ApplyVertexBetaEndpointTrafficSplit(request)
    ...
    def delete(self):
        ...
        request = (
            endpoint_traffic_split_pb2.DeleteVertexBetaEndpointTrafficSplitRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.endpoint):
            request.resource.endpoint = Primitive.to_proto(self.endpoint)
        ...
        response = stub.DeleteVertexBetaEndpointTrafficSplit(request)
    ...
    def list(self, location, service_account_file=""):
        ...
        request = endpoint_traffic_split_pb2.ListVertexBetaEndpointTrafficSplitRequest()
        request.service_account_file = service_account_file
        request.Location = location

        return stub.ListVertexBetaEndpointTrafficSplit(request).items

    def to_proto(self):
        resource = endpoint_traffic_split_pb2.VertexBetaEndpointTrafficSplit()
        if Primitive.to_proto(self.endpoint):
...
class EndpointTrafficSplitTrafficSplit(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_traffic_split_pb2.VertexBetaEndpointTrafficSplitTrafficSplit()
