...
class MetadataStore(object):
    ...
    def apply(self):
        stub = metadata_store_pb2_grpc.VertexBetaMetadataStoreServiceStub(
            channel.Channel()
        )
        request = metadata_store_pb2.ApplyVertexBetaMetadataStoreRequest()
        ...
        response = stub.ApplyVertexBetaMetadataStore(request)
    ...
    def delete(self):
        ...
        request = metadata_store_pb2.DeleteVertexBetaMetadataStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexBetaMetadataStore(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = metadata_store_pb2.ListVertexBetaMetadataStoreRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexBetaMetadataStore(request).items

    def to_proto(self):
        resource = metadata_store_pb2.VertexBetaMetadataStore()
        if Primitive.to_proto(self.name):
...
class MetadataStoreEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexBetaMetadataStoreEncryptionSpec()
...
class MetadataStoreState(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexBetaMetadataStoreState()
