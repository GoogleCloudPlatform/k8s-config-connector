...
class Endpoint(object):
    ...
    def apply(self):
        stub = endpoint_pb2_grpc.VertexEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ApplyVertexEndpointRequest()
        ...
        response = stub.ApplyVertexEndpoint(request)
    ...
    def delete(self):
        stub = endpoint_pb2_grpc.VertexEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.DeleteVertexEndpointRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexEndpoint(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = endpoint_pb2_grpc.VertexEndpointServiceStub(channel.Channel())
        request = endpoint_pb2.ListVertexEndpointRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexEndpoint(request).items

    def to_proto(self):
        resource = endpoint_pb2.VertexEndpoint()
        if Primitive.to_proto(self.name):
...
class EndpointDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexEndpointDeployedModels()
...
class EndpointDeployedModelsDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexEndpointDeployedModelsDedicatedResources()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexEndpointDeployedModelsDedicatedResourcesMachineSpec()
...
class EndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            endpoint_pb2.VertexEndpointDeployedModelsDedicatedResourcesAutoscalingMetricSpecs()
        )
...
class EndpointDeployedModelsAutomaticResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexEndpointDeployedModelsAutomaticResources()
        if Primitive.to_proto(resource.min_replica_count):
            res.min_replica_count = Primitive.to_proto(resource.min_replica_count)
        if Primitive.to_proto(resource.max_replica_count):
            res.max_replica_count = Primitive.to_proto(resource.max_replica_count)
...
class EndpointDeployedModelsPrivateEndpoints(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexEndpointDeployedModelsPrivateEndpoints()
...
class EndpointEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_pb2.VertexEndpointEncryptionSpec()
...
class EndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Value(
            "VertexEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return endpoint_pb2.VertexEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum.Name(
            resource
        )[
            len(
                "VertexEndpointDeployedModelsDedicatedResourcesMachineSpecAcceleratorTypeEnum"
            ) :
        ]
