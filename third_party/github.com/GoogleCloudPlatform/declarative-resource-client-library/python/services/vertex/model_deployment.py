...
class ModelDeployment(object):
    ...
    def apply(self):
        stub = model_deployment_pb2_grpc.VertexModelDeploymentServiceStub(
            channel.Channel()
        )
        request = model_deployment_pb2.ApplyVertexModelDeploymentRequest()
        ...
        response = stub.ApplyVertexModelDeployment(request)
    ...
    def delete(self):
        ...
        request = model_deployment_pb2.DeleteVertexModelDeploymentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.model):
            request.resource.model = Primitive.to_proto(self.model)
        ...
        response = stub.DeleteVertexModelDeployment(request)
    ...
    def list(self, project, location, endpoint, service_account_file=""):
        ...
        request = model_deployment_pb2.ListVertexModelDeploymentRequest()
        ...
        return stub.ListVertexModelDeployment(request).items

    def to_proto(self):
        resource = model_deployment_pb2.VertexModelDeployment()
        if Primitive.to_proto(self.model):
...
class ModelDeploymentDedicatedResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_deployment_pb2.VertexModelDeploymentDedicatedResources()
...
class ModelDeploymentDedicatedResourcesMachineSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_deployment_pb2.VertexModelDeploymentDedicatedResourcesMachineSpec()
