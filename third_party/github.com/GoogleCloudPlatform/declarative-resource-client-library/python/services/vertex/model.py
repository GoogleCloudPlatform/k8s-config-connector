...
class Model(object):
    ...
    def apply(self):
        stub = model_pb2_grpc.VertexModelServiceStub(channel.Channel())
        request = model_pb2.ApplyVertexModelRequest()
        ...
        response = stub.ApplyVertexModel(request)
    ...
    def delete(self):
        stub = model_pb2_grpc.VertexModelServiceStub(channel.Channel())
        request = model_pb2.DeleteVertexModelRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexModel(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = model_pb2_grpc.VertexModelServiceStub(channel.Channel())
        request = model_pb2.ListVertexModelRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexModel(request).items

    def to_proto(self):
        resource = model_pb2.VertexModel()
        if Primitive.to_proto(self.name):
...
class ModelSupportedExportFormats(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexModelSupportedExportFormats()
...
class ModelOriginalModelInfo(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexModelOriginalModelInfo()
...
class ModelContainerSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexModelContainerSpec()
...
class ModelContainerSpecEnv(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexModelContainerSpecEnv()
...
class ModelContainerSpecPorts(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexModelContainerSpecPorts()
...
class ModelDeployedModels(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexModelDeployedModels()
...
class ModelEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexModelEncryptionSpec()
...
class ModelSupportedExportFormatsExportableContentsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexModelSupportedExportFormatsExportableContentsEnum.Value(
            "VertexModelSupportedExportFormatsExportableContentsEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexModelSupportedExportFormatsExportableContentsEnum.Name(
            resource
        )[len("VertexModelSupportedExportFormatsExportableContentsEnum") :]
...
class ModelSupportedDeploymentResourcesTypesEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexModelSupportedDeploymentResourcesTypesEnum.Value(
            "VertexModelSupportedDeploymentResourcesTypesEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexModelSupportedDeploymentResourcesTypesEnum.Name(
            resource
        )[len("VertexModelSupportedDeploymentResourcesTypesEnum") :]
