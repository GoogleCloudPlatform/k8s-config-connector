...
class MetadataStore(object):
    ...
    def apply(self):
        stub = metadata_store_pb2_grpc.VertexMetadataStoreServiceStub(channel.Channel())
        request = metadata_store_pb2.ApplyVertexMetadataStoreRequest()
        ...
        response = stub.ApplyVertexMetadataStore(request)
    ...
    def delete(self):
        stub = metadata_store_pb2_grpc.VertexMetadataStoreServiceStub(channel.Channel())
        request = metadata_store_pb2.DeleteVertexMetadataStoreRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexMetadataStore(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = metadata_store_pb2_grpc.VertexMetadataStoreServiceStub(channel.Channel())
        request = metadata_store_pb2.ListVertexMetadataStoreRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListVertexMetadataStore(request).items

    def to_proto(self):
        resource = metadata_store_pb2.VertexMetadataStore()
        if Primitive.to_proto(self.name):
...
class MetadataStoreEncryptionSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexMetadataStoreEncryptionSpec()
...
class MetadataStoreState(object):
    ...
    def to_proto(self, resource):
        ...
        res = metadata_store_pb2.VertexMetadataStoreState()
