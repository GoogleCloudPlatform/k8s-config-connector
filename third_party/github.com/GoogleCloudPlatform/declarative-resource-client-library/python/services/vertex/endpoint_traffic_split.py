...
class EndpointTrafficSplit(object):
    ...
    def apply(self):
        stub = endpoint_traffic_split_pb2_grpc.VertexEndpointTrafficSplitServiceStub(
            channel.Channel()
        )
        request = endpoint_traffic_split_pb2.ApplyVertexEndpointTrafficSplitRequest()
        ...
        response = stub.ApplyVertexEndpointTrafficSplit(request)
    ...
    def delete(self):
        ...
        request = endpoint_traffic_split_pb2.DeleteVertexEndpointTrafficSplitRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.endpoint):
            request.resource.endpoint = Primitive.to_proto(self.endpoint)
        ...
        response = stub.DeleteVertexEndpointTrafficSplit(request)
    ...
    def list(self, location, service_account_file=""):
        ...
        request = endpoint_traffic_split_pb2.ListVertexEndpointTrafficSplitRequest()
        request.service_account_file = service_account_file
        request.Location = location

        return stub.ListVertexEndpointTrafficSplit(request).items

    def to_proto(self):
        resource = endpoint_traffic_split_pb2.VertexEndpointTrafficSplit()
        if Primitive.to_proto(self.endpoint):
...
class EndpointTrafficSplitTrafficSplit(object):
    ...
    def to_proto(self, resource):
        ...
        res = endpoint_traffic_split_pb2.VertexEndpointTrafficSplitTrafficSplit()
