...
class MetadataSchema(object):
    ...
    def apply(self):
        stub = metadata_schema_pb2_grpc.VertexMetadataSchemaServiceStub(
            channel.Channel()
        )
        request = metadata_schema_pb2.ApplyVertexMetadataSchemaRequest()
        ...
        response = stub.ApplyVertexMetadataSchema(request)
    ...
    def delete(self):
        ...
        request = metadata_schema_pb2.DeleteVertexMetadataSchemaRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteVertexMetadataSchema(request)
    ...
    def list(self, project, location, metadataStore, service_account_file=""):
        ...
        request = metadata_schema_pb2.ListVertexMetadataSchemaRequest()
        ...
        return stub.ListVertexMetadataSchema(request).items

    def to_proto(self):
        resource = metadata_schema_pb2.VertexMetadataSchema()
        if Primitive.to_proto(self.name):
...
class MetadataSchemaSchemaTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexMetadataSchemaSchemaTypeEnum.Value(
            "VertexMetadataSchemaSchemaTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return metadata_schema_pb2.VertexMetadataSchemaSchemaTypeEnum.Name(resource)[
            len("VertexMetadataSchemaSchemaTypeEnum") :
        ]
