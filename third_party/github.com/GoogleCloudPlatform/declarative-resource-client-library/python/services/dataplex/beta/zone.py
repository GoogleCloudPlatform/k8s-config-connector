...
class Zone(object):
    ...
    def apply(self):
        stub = zone_pb2_grpc.DataplexBetaZoneServiceStub(channel.Channel())
        request = zone_pb2.ApplyDataplexBetaZoneRequest()
        ...
        response = stub.ApplyDataplexBetaZone(request)
    ...
    def delete(self):
        stub = zone_pb2_grpc.DataplexBetaZoneServiceStub(channel.Channel())
        request = zone_pb2.DeleteDataplexBetaZoneRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDataplexBetaZone(request)

    @classmethod
    def list(self, project, location, lake, service_account_file=""):
        stub = zone_pb2_grpc.DataplexBetaZoneServiceStub(channel.Channel())
        request = zone_pb2.ListDataplexBetaZoneRequest()
        ...
        return stub.ListDataplexBetaZone(request).items

    def to_proto(self):
        resource = zone_pb2.DataplexBetaZone()
        if Primitive.to_proto(self.name):
...
class ZoneDiscoverySpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexBetaZoneDiscoverySpec()
...
class ZoneDiscoverySpecCsvOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexBetaZoneDiscoverySpecCsvOptions()
...
class ZoneDiscoverySpecJsonOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexBetaZoneDiscoverySpecJsonOptions()
        if Primitive.to_proto(resource.encoding):
            res.encoding = Primitive.to_proto(resource.encoding)
        if Primitive.to_proto(resource.disable_type_inference):
            res.disable_type_inference = Primitive.to_proto(
...
class ZoneResourceSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexBetaZoneResourceSpec()
...
class ZoneAssetStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = zone_pb2.DataplexBetaZoneAssetStatus()
...
class ZoneStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexBetaZoneStateEnum.Value(
            "DataplexBetaZoneStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexBetaZoneStateEnum.Name(resource)[
            len("DataplexBetaZoneStateEnum") :
        ]
...
class ZoneTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexBetaZoneTypeEnum.Value(
            "DataplexBetaZoneTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexBetaZoneTypeEnum.Name(resource)[
            len("DataplexBetaZoneTypeEnum") :
        ]
...
class ZoneResourceSpecLocationTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexBetaZoneResourceSpecLocationTypeEnum.Value(
            "DataplexBetaZoneResourceSpecLocationTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return zone_pb2.DataplexBetaZoneResourceSpecLocationTypeEnum.Name(resource)[
            len("DataplexBetaZoneResourceSpecLocationTypeEnum") :
        ]
