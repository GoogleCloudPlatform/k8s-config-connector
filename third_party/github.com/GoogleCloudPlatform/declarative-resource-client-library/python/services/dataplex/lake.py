...
class Lake(object):
    ...
    def apply(self):
        stub = lake_pb2_grpc.DataplexLakeServiceStub(channel.Channel())
        request = lake_pb2.ApplyDataplexLakeRequest()
        ...
        response = stub.ApplyDataplexLake(request)
    ...
    def delete(self):
        stub = lake_pb2_grpc.DataplexLakeServiceStub(channel.Channel())
        request = lake_pb2.DeleteDataplexLakeRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteDataplexLake(request)

    @classmethod
    def list(self, project, location, service_account_file=""):
        stub = lake_pb2_grpc.DataplexLakeServiceStub(channel.Channel())
        request = lake_pb2.ListDataplexLakeRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListDataplexLake(request).items

    def to_proto(self):
        resource = lake_pb2.DataplexLake()
        if Primitive.to_proto(self.name):
...
class LakeMetastore(object):
    ...
    def to_proto(self, resource):
        ...
        res = lake_pb2.DataplexLakeMetastore()
...
class LakeAssetStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = lake_pb2.DataplexLakeAssetStatus()
...
class LakeMetastoreStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = lake_pb2.DataplexLakeMetastoreStatus()
...
class LakeStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexLakeStateEnum.Value(
            "DataplexLakeStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexLakeStateEnum.Name(resource)[
            len("DataplexLakeStateEnum") :
        ]
...
class LakeMetastoreStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexLakeMetastoreStatusStateEnum.Value(
            "DataplexLakeMetastoreStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return lake_pb2.DataplexLakeMetastoreStatusStateEnum.Name(resource)[
            len("DataplexLakeMetastoreStatusStateEnum") :
        ]
