...
class Asset(object):
    ...
    def apply(self):
        ...
        request = asset_pb2.ApplyDataplexAssetRequest()
        ...
        response = stub.ApplyDataplexAsset(request)
    ...
    def delete(self):
        stub = asset_pb2_grpc.DataplexAssetServiceStub(channel.Channel())
        request = asset_pb2.DeleteDataplexAssetRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
    ...
    def list(self, project, location, dataplexZone, lake, service_account_file=""):
        ...
        return stub.ListDataplexAsset(request).items

    def to_proto(self):
        resource = asset_pb2.DataplexAsset()
        if Primitive.to_proto(self.name):
...
class AssetResourceSpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetResourceSpec()
...
class AssetResourceStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetResourceStatus()
...
class AssetSecurityStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetSecurityStatus()
...
class AssetDiscoverySpec(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetDiscoverySpec()
...
class AssetDiscoverySpecCsvOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetDiscoverySpecCsvOptions()
...
class AssetDiscoverySpecJsonOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetDiscoverySpecJsonOptions()
        if Primitive.to_proto(resource.encoding):
            res.encoding = Primitive.to_proto(resource.encoding)
        if Primitive.to_proto(resource.disable_type_inference):
            res.disable_type_inference = Primitive.to_proto(
...
class AssetDiscoveryStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetDiscoveryStatus()
...
class AssetDiscoveryStatusStats(object):
    ...
    def to_proto(self, resource):
        ...
        res = asset_pb2.DataplexAssetDiscoveryStatusStats()
...
class AssetStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetStateEnum.Value(
            "DataplexAssetStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetStateEnum.Name(resource)[
            len("DataplexAssetStateEnum") :
        ]
...
class AssetResourceSpecTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetResourceSpecTypeEnum.Value(
            "DataplexAssetResourceSpecTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetResourceSpecTypeEnum.Name(resource)[
            len("DataplexAssetResourceSpecTypeEnum") :
        ]
...
class AssetResourceSpecReadAccessModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetResourceSpecReadAccessModeEnum.Value(
            "DataplexAssetResourceSpecReadAccessModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetResourceSpecReadAccessModeEnum.Name(resource)[
            len("DataplexAssetResourceSpecReadAccessModeEnum") :
        ]
...
class AssetResourceStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetResourceStatusStateEnum.Value(
            "DataplexAssetResourceStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetResourceStatusStateEnum.Name(resource)[
            len("DataplexAssetResourceStatusStateEnum") :
        ]
...
class AssetSecurityStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetSecurityStatusStateEnum.Value(
            "DataplexAssetSecurityStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetSecurityStatusStateEnum.Name(resource)[
            len("DataplexAssetSecurityStatusStateEnum") :
        ]
...
class AssetDiscoveryStatusStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetDiscoveryStatusStateEnum.Value(
            "DataplexAssetDiscoveryStatusStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return asset_pb2.DataplexAssetDiscoveryStatusStateEnum.Name(resource)[
            len("DataplexAssetDiscoveryStatusStateEnum") :
        ]
