...
class KeyWafSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.RecaptchaenterpriseKeyWafSettings()
...
class KeyWafSettingsWafServiceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseKeyWafSettingsWafServiceEnum.Value(
            "RecaptchaenterpriseKeyWafSettingsWafServiceEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseKeyWafSettingsWafServiceEnum.Name(resource)[
            len("RecaptchaenterpriseKeyWafSettingsWafServiceEnum") :
        ]
...
class KeyWafSettingsWafFeatureEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseKeyWafSettingsWafFeatureEnum.Value(
            "RecaptchaenterpriseKeyWafSettingsWafFeatureEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseKeyWafSettingsWafFeatureEnum.Name(resource)[
            len("RecaptchaenterpriseKeyWafSettingsWafFeatureEnum") :
        ]
