...
class Key(object):
    ...
    def apply(self):
        stub = key_pb2_grpc.RecaptchaenterpriseAlphaKeyServiceStub(channel.Channel())
        request = key_pb2.ApplyRecaptchaenterpriseAlphaKeyRequest()
        ...
        response = stub.ApplyRecaptchaenterpriseAlphaKey(request)
    ...
    def delete(self):
        stub = key_pb2_grpc.RecaptchaenterpriseAlphaKeyServiceStub(channel.Channel())
        request = key_pb2.DeleteRecaptchaenterpriseAlphaKeyRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteRecaptchaenterpriseAlphaKey(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = key_pb2_grpc.RecaptchaenterpriseAlphaKeyServiceStub(channel.Channel())
        request = key_pb2.ListRecaptchaenterpriseAlphaKeyRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListRecaptchaenterpriseAlphaKey(request).items

    def to_proto(self):
        resource = key_pb2.RecaptchaenterpriseAlphaKey()
        if Primitive.to_proto(self.name):
...
class KeyWebSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.RecaptchaenterpriseAlphaKeyWebSettings()
...
class KeyAndroidSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.RecaptchaenterpriseAlphaKeyAndroidSettings()
...
class KeyIosSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.RecaptchaenterpriseAlphaKeyIosSettings()
...
class KeyTestingOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = key_pb2.RecaptchaenterpriseAlphaKeyTestingOptions()
...
class KeyWebSettingsIntegrationTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseAlphaKeyWebSettingsIntegrationTypeEnum.Value(
            "RecaptchaenterpriseAlphaKeyWebSettingsIntegrationTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseAlphaKeyWebSettingsIntegrationTypeEnum.Name(
            resource
        )[len("RecaptchaenterpriseAlphaKeyWebSettingsIntegrationTypeEnum") :]
...
class KeyWebSettingsChallengeSecurityPreferenceEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseAlphaKeyWebSettingsChallengeSecurityPreferenceEnum.Value(
            "RecaptchaenterpriseAlphaKeyWebSettingsChallengeSecurityPreferenceEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return key_pb2.RecaptchaenterpriseAlphaKeyWebSettingsChallengeSecurityPreferenceEnum.Name(
            resource
        )[
            len(
                "RecaptchaenterpriseAlphaKeyWebSettingsChallengeSecurityPreferenceEnum"
            ) :
        ]
