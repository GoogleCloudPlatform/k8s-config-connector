...
class PatchDeployment(object):
    ...
    def apply(self):
        stub = patch_deployment_pb2_grpc.OsconfigPatchDeploymentServiceStub(
            channel.Channel()
        )
        request = patch_deployment_pb2.ApplyOsconfigPatchDeploymentRequest()
        ...
        response = stub.ApplyOsconfigPatchDeployment(request)
    ...
    def delete(self):
        ...
        request = patch_deployment_pb2.DeleteOsconfigPatchDeploymentRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteOsconfigPatchDeployment(request)
    ...
    def list(self, project, service_account_file=""):
        ...
        request = patch_deployment_pb2.ListOsconfigPatchDeploymentRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListOsconfigPatchDeployment(request).items

    def to_proto(self):
        resource = patch_deployment_pb2.OsconfigPatchDeployment()
        if Primitive.to_proto(self.name):
...
class PatchDeploymentInstanceFilter(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentInstanceFilter()
...
class PatchDeploymentInstanceFilterGroupLabels(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentInstanceFilterGroupLabels()
...
class PatchDeploymentPatchConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfig()
...
class PatchDeploymentPatchConfigApt(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigApt()
...
class PatchDeploymentPatchConfigYum(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigYum()
...
class PatchDeploymentPatchConfigGoo(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigGoo()
        return res
...
class PatchDeploymentPatchConfigZypper(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigZypper()
...
class PatchDeploymentPatchConfigWindowsUpdate(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigWindowsUpdate()
...
class PatchDeploymentPatchConfigPreStep(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStep()
...
class PatchDeploymentPatchConfigPreStepLinuxExecStepConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepLinuxExecStepConfig()
        )
...
class PatchDeploymentPatchConfigPreStepLinuxExecStepConfigGcsObject(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepLinuxExecStepConfigGcsObject()
        )
...
class PatchDeploymentPatchConfigPreStepWindowsExecStepConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepWindowsExecStepConfig()
        )
        if Primitive.to_proto(resource.local_path):
            res.local_path = Primitive.to_proto(resource.local_path)
...
class PatchDeploymentPatchConfigPreStepWindowsExecStepConfigGcsObject(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepWindowsExecStepConfigGcsObject()
        )
        if Primitive.to_proto(resource.bucket):
            res.bucket = Primitive.to_proto(resource.bucket)
        if Primitive.to_proto(resource.object):
...
class PatchDeploymentPatchConfigPostStep(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStep()
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepLinuxExecStepConfig()
        )
        if Primitive.to_proto(resource.local_path):
            res.local_path = Primitive.to_proto(resource.local_path)
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepLinuxExecStepConfigGcsObject()
        )
        if Primitive.to_proto(resource.bucket):
            res.bucket = Primitive.to_proto(resource.bucket)
        if Primitive.to_proto(resource.object):
...
class PatchDeploymentPatchConfigPostStepWindowsExecStepConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepWindowsExecStepConfig()
        )
        if Primitive.to_proto(resource.local_path):
            res.local_path = Primitive.to_proto(resource.local_path)
...
class PatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepWindowsExecStepConfigGcsObject()
        )
        if Primitive.to_proto(resource.bucket):
            res.bucket = Primitive.to_proto(resource.bucket)
        if Primitive.to_proto(resource.object):
...
class PatchDeploymentOneTimeSchedule(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentOneTimeSchedule()
...
class PatchDeploymentRecurringSchedule(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentRecurringSchedule()
...
class PatchDeploymentRecurringScheduleTimeZone(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleTimeZone()
...
class PatchDeploymentRecurringScheduleTimeOfDay(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleTimeOfDay()
...
class PatchDeploymentRecurringScheduleWeekly(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleWeekly()
...
class PatchDeploymentRecurringScheduleMonthly(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleMonthly()
...
class PatchDeploymentRecurringScheduleMonthlyWeekDayOfMonth(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleMonthlyWeekDayOfMonth()
        )
...
class PatchDeploymentRollout(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentRollout()
...
class PatchDeploymentRolloutDisruptionBudget(object):
    ...
    def to_proto(self, resource):
        ...
        res = patch_deployment_pb2.OsconfigPatchDeploymentRolloutDisruptionBudget()
...
class PatchDeploymentPatchConfigRebootConfigEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigRebootConfigEnum.Value(
            "OsconfigPatchDeploymentPatchConfigRebootConfigEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigRebootConfigEnum.Name(
            resource
        )[
            len("OsconfigPatchDeploymentPatchConfigRebootConfigEnum") :
        ]
...
class PatchDeploymentPatchConfigAptTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigAptTypeEnum.Value(
            "OsconfigPatchDeploymentPatchConfigAptTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigAptTypeEnum.Name(
            resource
        )[len("OsconfigPatchDeploymentPatchConfigAptTypeEnum") :]
...
class PatchDeploymentPatchConfigWindowsUpdateClassificationsEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigWindowsUpdateClassificationsEnum.Value(
            "OsconfigPatchDeploymentPatchConfigWindowsUpdateClassificationsEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigWindowsUpdateClassificationsEnum.Name(
            resource
        )[
            len("OsconfigPatchDeploymentPatchConfigWindowsUpdateClassificationsEnum") :
        ]
...
class PatchDeploymentPatchConfigPreStepLinuxExecStepConfigInterpreterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepLinuxExecStepConfigInterpreterEnum.Value(
            "OsconfigPatchDeploymentPatchConfigPreStepLinuxExecStepConfigInterpreterEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepLinuxExecStepConfigInterpreterEnum.Name(
            resource
        )[
            len(
...
class PatchDeploymentPatchConfigPreStepWindowsExecStepConfigInterpreterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepWindowsExecStepConfigInterpreterEnum.Value(
            "OsconfigPatchDeploymentPatchConfigPreStepWindowsExecStepConfigInterpreterEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPreStepWindowsExecStepConfigInterpreterEnum.Name(
            resource
        )[
            len(
...
class PatchDeploymentPatchConfigPostStepLinuxExecStepConfigInterpreterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepLinuxExecStepConfigInterpreterEnum.Value(
            "OsconfigPatchDeploymentPatchConfigPostStepLinuxExecStepConfigInterpreterEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepLinuxExecStepConfigInterpreterEnum.Name(
            resource
        )[
            len(
...
class PatchDeploymentPatchConfigPostStepWindowsExecStepConfigInterpreterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepWindowsExecStepConfigInterpreterEnum.Value(
            "OsconfigPatchDeploymentPatchConfigPostStepWindowsExecStepConfigInterpreterEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentPatchConfigPostStepWindowsExecStepConfigInterpreterEnum.Name(
            resource
        )[
            len(
...
class PatchDeploymentRecurringScheduleFrequencyEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleFrequencyEnum.Value(
            "OsconfigPatchDeploymentRecurringScheduleFrequencyEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleFrequencyEnum.Name(
            resource
        )[
            len("OsconfigPatchDeploymentRecurringScheduleFrequencyEnum") :
        ]
...
class PatchDeploymentRecurringScheduleWeeklyDayOfWeekEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleWeeklyDayOfWeekEnum.Value(
            "OsconfigPatchDeploymentRecurringScheduleWeeklyDayOfWeekEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleWeeklyDayOfWeekEnum.Name(
            resource
        )[
            len("OsconfigPatchDeploymentRecurringScheduleWeeklyDayOfWeekEnum") :
        ]
...
class PatchDeploymentRecurringScheduleMonthlyWeekDayOfMonthDayOfWeekEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleMonthlyWeekDayOfMonthDayOfWeekEnum.Value(
            "OsconfigPatchDeploymentRecurringScheduleMonthlyWeekDayOfMonthDayOfWeekEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRecurringScheduleMonthlyWeekDayOfMonthDayOfWeekEnum.Name(
            resource
        )[
            len(
                "OsconfigPatchDeploymentRecurringScheduleMonthlyWeekDayOfMonthDayOfWeekEnum"
            ) :
        ]
...
class PatchDeploymentRolloutModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRolloutModeEnum.Value(
            "OsconfigPatchDeploymentRolloutModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return patch_deployment_pb2.OsconfigPatchDeploymentRolloutModeEnum.Name(
            resource
        )[len("OsconfigPatchDeploymentRolloutModeEnum") :]
