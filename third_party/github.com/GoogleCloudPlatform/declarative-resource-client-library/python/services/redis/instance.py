...
class InstanceServerCaCerts(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.RedisInstanceServerCaCerts()
...
class InstanceMaintenancePolicy(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.RedisInstanceMaintenancePolicy()
        if Primitive.to_proto(resource.create_time):
            res.create_time = Primitive.to_proto(resource.create_time)
...
class InstanceMaintenancePolicyWeeklyMaintenanceWindow(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.RedisInstanceMaintenancePolicyWeeklyMaintenanceWindow()
...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_pb2.RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowStartTime()
        )
...
class InstanceMaintenanceSchedule(object):
    ...
    def to_proto(self, resource):
        ...
        res = instance_pb2.RedisInstanceMaintenanceSchedule()
...
class InstanceStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceStateEnum.Value(
            "RedisInstanceStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceStateEnum.Name(resource)[
            len("RedisInstanceStateEnum") :
        ]
...
class InstanceTierEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceTierEnum.Value(
            "RedisInstanceTierEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceTierEnum.Name(resource)[
            len("RedisInstanceTierEnum") :
        ]
...
class InstanceConnectModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceConnectModeEnum.Value(
            "RedisInstanceConnectModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceConnectModeEnum.Name(resource)[
            len("RedisInstanceConnectModeEnum") :
        ]
...
class InstanceTransitEncryptionModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceTransitEncryptionModeEnum.Value(
            "RedisInstanceTransitEncryptionModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceTransitEncryptionModeEnum.Name(resource)[
            len("RedisInstanceTransitEncryptionModeEnum") :
        ]
...
class InstanceMaintenancePolicyWeeklyMaintenanceWindowDayEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowDayEnum.Value(
            "RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowDayEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return instance_pb2.RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowDayEnum.Name(
            resource
        )[
            len("RedisInstanceMaintenancePolicyWeeklyMaintenanceWindowDayEnum") :
        ]
