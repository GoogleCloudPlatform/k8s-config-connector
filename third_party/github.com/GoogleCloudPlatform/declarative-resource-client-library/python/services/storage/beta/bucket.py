...
class Bucket(object):
    ...
    def apply(self):
        stub = bucket_pb2_grpc.StorageBetaBucketServiceStub(channel.Channel())
        request = bucket_pb2.ApplyStorageBetaBucketRequest()
        ...
        response = stub.ApplyStorageBetaBucket(request)
    ...
    def delete(self):
        stub = bucket_pb2_grpc.StorageBetaBucketServiceStub(channel.Channel())
        request = bucket_pb2.DeleteStorageBetaBucketRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.project):
            request.resource.project = Primitive.to_proto(self.project)
        ...
        if BucketWebsite.to_proto(self.website):
            ...
            request.resource.ClearField("website")
        response = stub.DeleteStorageBetaBucket(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = bucket_pb2_grpc.StorageBetaBucketServiceStub(channel.Channel())
        request = bucket_pb2.ListStorageBetaBucketRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListStorageBetaBucket(request).items

    def to_proto(self):
        resource = bucket_pb2.StorageBetaBucket()
        if Primitive.to_proto(self.project):
...
class BucketCors(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketCors()
...
class BucketLifecycle(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketLifecycle()
...
class BucketLifecycleRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketLifecycleRule()
...
class BucketLifecycleRuleAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketLifecycleRuleAction()
...
class BucketLifecycleRuleCondition(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketLifecycleRuleCondition()
...
class BucketLogging(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketLogging()
...
class BucketVersioning(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketVersioning()
...
class BucketWebsite(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageBetaBucketWebsite()
...
class BucketLifecycleRuleActionTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageBetaBucketLifecycleRuleActionTypeEnum.Value(
            "StorageBetaBucketLifecycleRuleActionTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageBetaBucketLifecycleRuleActionTypeEnum.Name(resource)[
            len("StorageBetaBucketLifecycleRuleActionTypeEnum") :
        ]
...
class BucketLifecycleRuleConditionWithStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageBetaBucketLifecycleRuleConditionWithStateEnum.Value(
            "StorageBetaBucketLifecycleRuleConditionWithStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageBetaBucketLifecycleRuleConditionWithStateEnum.Name(
            resource
        )[len("StorageBetaBucketLifecycleRuleConditionWithStateEnum") :]
...
class BucketStorageClassEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageBetaBucketStorageClassEnum.Value(
            "StorageBetaBucketStorageClassEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageBetaBucketStorageClassEnum.Name(resource)[
            len("StorageBetaBucketStorageClassEnum") :
        ]
