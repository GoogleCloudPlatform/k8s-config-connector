...
class Bucket(object):
    ...
    def apply(self):
        ...
        request = bucket_pb2.ApplyStorageAlphaBucketRequest()
        ...
        response = stub.ApplyStorageAlphaBucket(request)
    ...
    def delete(self):
        stub = bucket_pb2_grpc.StorageAlphaBucketServiceStub(channel.Channel())
        request = bucket_pb2.DeleteStorageAlphaBucketRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.project):
            request.resource.project = Primitive.to_proto(self.project)
    ...
    def to_proto(self):
        resource = bucket_pb2.StorageAlphaBucket()
        if Primitive.to_proto(self.project):
...
class BucketCors(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketCors()
...
class BucketLifecycle(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketLifecycle()
...
class BucketLifecycleRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketLifecycleRule()
...
class BucketLifecycleRuleAction(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketLifecycleRuleAction()
...
class BucketLifecycleRuleCondition(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketLifecycleRuleCondition()
...
class BucketLogging(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketLogging()
...
class BucketVersioning(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketVersioning()
...
class BucketWebsite(object):
    ...
    def to_proto(self, resource):
        ...
        res = bucket_pb2.StorageAlphaBucketWebsite()
...
class BucketLifecycleRuleActionTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageAlphaBucketLifecycleRuleActionTypeEnum.Value(
            "StorageAlphaBucketLifecycleRuleActionTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageAlphaBucketLifecycleRuleActionTypeEnum.Name(resource)[
            len("StorageAlphaBucketLifecycleRuleActionTypeEnum") :
        ]
...
class BucketLifecycleRuleConditionWithStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageAlphaBucketLifecycleRuleConditionWithStateEnum.Value(
            "StorageAlphaBucketLifecycleRuleConditionWithStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageAlphaBucketLifecycleRuleConditionWithStateEnum.Name(
            resource
        )[len("StorageAlphaBucketLifecycleRuleConditionWithStateEnum") :]
...
class BucketStorageClassEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageAlphaBucketStorageClassEnum.Value(
            "StorageAlphaBucketStorageClassEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return bucket_pb2.StorageAlphaBucketStorageClassEnum.Name(resource)[
            len("StorageAlphaBucketStorageClassEnum") :
        ]
