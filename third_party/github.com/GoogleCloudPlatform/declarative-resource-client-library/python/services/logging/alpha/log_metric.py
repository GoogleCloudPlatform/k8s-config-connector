...
class LogMetric(object):
    ...
    def apply(self):
        stub = log_metric_pb2_grpc.LoggingAlphaLogMetricServiceStub(channel.Channel())
        request = log_metric_pb2.ApplyLoggingAlphaLogMetricRequest()
        ...
        response = stub.ApplyLoggingAlphaLogMetric(request)
    ...
    def delete(self):
        stub = log_metric_pb2_grpc.LoggingAlphaLogMetricServiceStub(channel.Channel())
        request = log_metric_pb2.DeleteLoggingAlphaLogMetricRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteLoggingAlphaLogMetric(request)

    @classmethod
    def list(self, project, service_account_file=""):
        stub = log_metric_pb2_grpc.LoggingAlphaLogMetricServiceStub(channel.Channel())
        request = log_metric_pb2.ListLoggingAlphaLogMetricRequest()
        request.service_account_file = service_account_file
        request.Project = project

        return stub.ListLoggingAlphaLogMetric(request).items

    def to_proto(self):
        resource = log_metric_pb2.LoggingAlphaLogMetric()
        if Primitive.to_proto(self.name):
...
class LogMetricMetricDescriptor(object):
    ...
    def to_proto(self, resource):
        ...
        res = log_metric_pb2.LoggingAlphaLogMetricMetricDescriptor()
...
class LogMetricMetricDescriptorLabels(object):
    ...
    def to_proto(self, resource):
        ...
        res = log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorLabels()
...
class LogMetricMetricDescriptorMetadata(object):
    ...
    def to_proto(self, resource):
        ...
        res = log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorMetadata()
...
class LogMetricBucketOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = log_metric_pb2.LoggingAlphaLogMetricBucketOptions()
...
class LogMetricBucketOptionsLinearBuckets(object):
    ...
    def to_proto(self, resource):
        ...
        res = log_metric_pb2.LoggingAlphaLogMetricBucketOptionsLinearBuckets()
...
class LogMetricBucketOptionsExponentialBuckets(object):
    ...
    def to_proto(self, resource):
        ...
        res = log_metric_pb2.LoggingAlphaLogMetricBucketOptionsExponentialBuckets()
        if Primitive.to_proto(resource.num_finite_buckets):
            res.num_finite_buckets = Primitive.to_proto(resource.num_finite_buckets)
...
class LogMetricBucketOptionsExplicitBuckets(object):
    ...
    def to_proto(self, resource):
        ...
        res = log_metric_pb2.LoggingAlphaLogMetricBucketOptionsExplicitBuckets()
...
class LogMetricMetricDescriptorLabelsValueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorLabelsValueTypeEnum.Value(
            "LoggingAlphaLogMetricMetricDescriptorLabelsValueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorLabelsValueTypeEnum.Name(
            resource
        )[
            len("LoggingAlphaLogMetricMetricDescriptorLabelsValueTypeEnum") :
        ]
...
class LogMetricMetricDescriptorMetricKindEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorMetricKindEnum.Value(
            "LoggingAlphaLogMetricMetricDescriptorMetricKindEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorMetricKindEnum.Name(
            resource
        )[len("LoggingAlphaLogMetricMetricDescriptorMetricKindEnum") :]
...
class LogMetricMetricDescriptorValueTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorValueTypeEnum.Value(
            "LoggingAlphaLogMetricMetricDescriptorValueTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorValueTypeEnum.Name(
            resource
        )[len("LoggingAlphaLogMetricMetricDescriptorValueTypeEnum") :]
...
class LogMetricMetricDescriptorLaunchStageEnum(object):
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return log_metric_pb2.LoggingAlphaLogMetricMetricDescriptorLaunchStageEnum.Name(
            resource
        )[len("LoggingAlphaLogMetricMetricDescriptorLaunchStageEnum") :]
