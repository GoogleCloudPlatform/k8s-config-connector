...
class NodePool(object):
    ...
    def apply(self):
        stub = node_pool_pb2_grpc.ContainerawsBetaNodePoolServiceStub(channel.Channel())
        request = node_pool_pb2.ApplyContainerawsBetaNodePoolRequest()
        ...
        response = stub.ApplyContainerawsBetaNodePool(request)
    ...
    def delete(self):
        stub = node_pool_pb2_grpc.ContainerawsBetaNodePoolServiceStub(channel.Channel())
        request = node_pool_pb2.DeleteContainerawsBetaNodePoolRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteContainerawsBetaNodePool(request)

    @classmethod
    def list(self, project, location, cluster, service_account_file=""):
        stub = node_pool_pb2_grpc.ContainerawsBetaNodePoolServiceStub(channel.Channel())
        request = node_pool_pb2.ListContainerawsBetaNodePoolRequest()
        ...
        return stub.ListContainerawsBetaNodePool(request).items

    def to_proto(self):
        resource = node_pool_pb2.ContainerawsBetaNodePool()
        if Primitive.to_proto(self.name):
...
class NodePoolConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfig()
...
class NodePoolConfigRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfigRootVolume()
...
class NodePoolConfigTaints(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfigTaints()
...
class NodePoolConfigConfigEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfigConfigEncryption()
        if Primitive.to_proto(resource.kms_key_arn):
            res.kms_key_arn = Primitive.to_proto(resource.kms_key_arn)
        return res
...
class NodePoolConfigSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfigSshConfig()
...
class NodePoolConfigSpotConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfigSpotConfig()
...
class NodePoolConfigInstancePlacement(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfigInstancePlacement()
...
class NodePoolConfigAutoscalingMetricsCollection(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolConfigAutoscalingMetricsCollection()
...
class NodePoolAutoscaling(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolAutoscaling()
...
class NodePoolMaxPodsConstraint(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolMaxPodsConstraint()
...
class NodePoolManagement(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolManagement()
...
class NodePoolUpdateSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolUpdateSettings()
...
class NodePoolUpdateSettingsSurgeSettings(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolUpdateSettingsSurgeSettings()
...
class NodePoolConfigTaintsEffectEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolConfigTaintsEffectEnum.Value(
            "ContainerawsBetaNodePoolConfigTaintsEffectEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolConfigTaintsEffectEnum.Name(
            resource
        )[len("ContainerawsBetaNodePoolConfigTaintsEffectEnum") :]
...
class NodePoolConfigInstancePlacementTenancyEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolConfigInstancePlacementTenancyEnum.Value(
            "ContainerawsBetaNodePoolConfigInstancePlacementTenancyEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolConfigInstancePlacementTenancyEnum.Name(
            resource
        )[
            len("ContainerawsBetaNodePoolConfigInstancePlacementTenancyEnum") :
        ]
...
class NodePoolStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolStateEnum.Value(
            "ContainerawsBetaNodePoolStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolStateEnum.Name(resource)[
            len("ContainerawsBetaNodePoolStateEnum") :
        ]
