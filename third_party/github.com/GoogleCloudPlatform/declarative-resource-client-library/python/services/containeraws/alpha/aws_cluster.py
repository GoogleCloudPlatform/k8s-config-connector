...
from google3.cloud.graphite.mmv2.services.google.container_aws import aws_cluster_pb2
from google3.cloud.graphite.mmv2.services.google.container_aws import (
...
class AwsCluster(object):
    ...
    def apply(self):
        stub = aws_cluster_pb2_grpc.ContainerawsAlphaAwsClusterServiceStub(
            channel.Channel()
        )
        request = aws_cluster_pb2.ApplyContainerawsAlphaAwsClusterRequest()
        ...
        response = stub.ApplyContainerawsAlphaAwsCluster(request)
    ...
    def delete(self):
        ...
        request = aws_cluster_pb2.DeleteContainerawsAlphaAwsClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteContainerawsAlphaAwsCluster(request)

    def list(self):
        stub = aws_cluster_pb2_grpc.ContainerawsAlphaAwsClusterServiceStub(
            channel.Channel()
        )
        request = aws_cluster_pb2.ListContainerawsAlphaAwsClusterRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        return stub.ListContainerawsAlphaAwsCluster(request).items

    def to_proto(self):
        resource = aws_cluster_pb2.ContainerawsAlphaAwsCluster()
        if Primitive.to_proto(self.name):
...
class AwsClusterNetworking(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterNetworking()
...
class AwsClusterControlPlane(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlane()
...
class AwsClusterControlPlaneSshConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneSshConfig()
...
class AwsClusterControlPlaneRootVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneRootVolume()
...
class AwsClusterControlPlaneMainVolume(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneMainVolume()
        if Primitive.to_proto(resource.size_gib):
            res.size_gib = Primitive.to_proto(resource.size_gib)
...
class AwsClusterControlPlaneDatabaseEncryption(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneDatabaseEncryption()
        )
        if Primitive.to_proto(resource.kms_key_arn):
            res.kms_key_arn = Primitive.to_proto(resource.kms_key_arn)
        return res
...
class AwsClusterControlPlaneAwsServicesAuthentication(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneAwsServicesAuthentication()
        )
...
class AwsClusterAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterAuthorization()
...
class AwsClusterAuthorizationAdminUsers(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterAuthorizationAdminUsers()
...
class AwsClusterWorkloadIdentityConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = aws_cluster_pb2.ContainerawsAlphaAwsClusterWorkloadIdentityConfig()
...
class AwsClusterControlPlaneRootVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum.Value(
            "ContainerawsAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("ContainerawsAlphaAwsClusterControlPlaneRootVolumeVolumeTypeEnum") :
        ]
...
class AwsClusterControlPlaneMainVolumeVolumeTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum.Value(
            "ContainerawsAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.ContainerawsAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum.Name(
            resource
        )[
            len("ContainerawsAlphaAwsClusterControlPlaneMainVolumeVolumeTypeEnum") :
        ]
...
class AwsClusterStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.ContainerawsAlphaAwsClusterStateEnum.Value(
            "ContainerawsAlphaAwsClusterStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return aws_cluster_pb2.ContainerawsAlphaAwsClusterStateEnum.Name(resource)[
            len("ContainerawsAlphaAwsClusterStateEnum") :
        ]
