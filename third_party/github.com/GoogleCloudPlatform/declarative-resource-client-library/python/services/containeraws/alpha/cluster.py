...
class ClusterAuthorizationAdminGroups(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerawsAlphaClusterAuthorizationAdminGroups()
...
class ClusterMonitoringConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerawsAlphaClusterMonitoringConfig()
...
class ClusterMonitoringConfigManagedPrometheusConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            cluster_pb2.ContainerawsAlphaClusterMonitoringConfigManagedPrometheusConfig()
        )
...
class ClusterBinaryAuthorization(object):
    ...
    def to_proto(self, resource):
        ...
        res = cluster_pb2.ContainerawsAlphaClusterBinaryAuthorization()
...
class ClusterBinaryAuthorizationEvaluationModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return cluster_pb2.ContainerawsAlphaClusterBinaryAuthorizationEvaluationModeEnum.Value(
            "ContainerawsAlphaClusterBinaryAuthorizationEvaluationModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return cluster_pb2.ContainerawsAlphaClusterBinaryAuthorizationEvaluationModeEnum.Name(
            resource
        )[
            len("ContainerawsAlphaClusterBinaryAuthorizationEvaluationModeEnum") :
        ]
