...
class FirebaseProject(object):
    ...
    def apply(self):
        stub = firebase_project_pb2_grpc.FirebaseAlphaFirebaseProjectServiceStub(
            channel.Channel()
        )
        request = firebase_project_pb2.ApplyFirebaseAlphaFirebaseProjectRequest()
        ...
        response = stub.ApplyFirebaseAlphaFirebaseProject(request)
    ...
    def delete(self):
        ...
        request = firebase_project_pb2.DeleteFirebaseAlphaFirebaseProjectRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.display_name):
            request.resource.display_name = Primitive.to_proto(self.display_name)
        ...
        response = stub.DeleteFirebaseAlphaFirebaseProject(request)
    ...
    def list(self, service_account_file=""):
        ...
        request = firebase_project_pb2.ListFirebaseAlphaFirebaseProjectRequest()
        request.service_account_file = service_account_file
        return stub.ListFirebaseAlphaFirebaseProject(request).items

    def to_proto(self):
        resource = firebase_project_pb2.FirebaseAlphaFirebaseProject()
        if Primitive.to_proto(self.display_name):
...
class FirebaseProjectResources(object):
    ...
    def to_proto(self, resource):
        ...
        res = firebase_project_pb2.FirebaseAlphaFirebaseProjectResources()
...
class FirebaseProjectStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return firebase_project_pb2.FirebaseAlphaFirebaseProjectStateEnum.Value(
            "FirebaseAlphaFirebaseProjectStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return firebase_project_pb2.FirebaseAlphaFirebaseProjectStateEnum.Name(
            resource
        )[len("FirebaseAlphaFirebaseProjectStateEnum") :]
