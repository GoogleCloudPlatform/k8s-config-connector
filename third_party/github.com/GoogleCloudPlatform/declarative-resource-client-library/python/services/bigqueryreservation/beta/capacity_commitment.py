...
class CapacityCommitment(object):
    ...
    def apply(self):
        stub = capacity_commitment_pb2_grpc.BigqueryreservationBetaCapacityCommitmentServiceStub(
            channel.Channel()
        )
        request = (
            capacity_commitment_pb2.ApplyBigqueryreservationBetaCapacityCommitmentRequest()
        )
        ...
        response = stub.ApplyBigqueryreservationBetaCapacityCommitment(request)
    ...
    def delete(self):
        ...
        request = (
            capacity_commitment_pb2.DeleteBigqueryreservationBetaCapacityCommitmentRequest()
        )
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteBigqueryreservationBetaCapacityCommitment(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = (
            capacity_commitment_pb2.ListBigqueryreservationBetaCapacityCommitmentRequest()
        )
        ...
        return stub.ListBigqueryreservationBetaCapacityCommitment(request).items

    def to_proto(self):
        resource = capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitment()
        if Primitive.to_proto(self.name):
...
class CapacityCommitmentFailureStatus(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentFailureStatus()
        )
...
class CapacityCommitmentFailureStatusDetails(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentFailureStatusDetails()
        )
...
class CapacityCommitmentPlanEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentPlanEnum.Value(
            "BigqueryreservationBetaCapacityCommitmentPlanEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentPlanEnum.Name(
            resource
        )[
            len("BigqueryreservationBetaCapacityCommitmentPlanEnum") :
        ]
...
class CapacityCommitmentStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentStateEnum.Value(
            "BigqueryreservationBetaCapacityCommitmentStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentStateEnum.Name(
            resource
        )[
            len("BigqueryreservationBetaCapacityCommitmentStateEnum") :
        ]
...
class CapacityCommitmentRenewalPlanEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentRenewalPlanEnum.Value(
            "BigqueryreservationBetaCapacityCommitmentRenewalPlanEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return capacity_commitment_pb2.BigqueryreservationBetaCapacityCommitmentRenewalPlanEnum.Name(
            resource
        )[
            len("BigqueryreservationBetaCapacityCommitmentRenewalPlanEnum") :
        ]
