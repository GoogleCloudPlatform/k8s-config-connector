...
class Assignment(object):
    ...
    def apply(self):
        ...
        response = stub.ApplyBigqueryreservationBetaAssignment(request)
...
class AssignmentJobTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return assignment_pb2.BigqueryreservationBetaAssignmentJobTypeEnum.Value(
            "BigqueryreservationBetaAssignmentJobTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return assignment_pb2.BigqueryreservationBetaAssignmentJobTypeEnum.Name(
            resource
        )[len("BigqueryreservationBetaAssignmentJobTypeEnum") :]
...
class AssignmentStateEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return assignment_pb2.BigqueryreservationBetaAssignmentStateEnum.Value(
            "BigqueryreservationBetaAssignmentStateEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return assignment_pb2.BigqueryreservationBetaAssignmentStateEnum.Name(resource)[
            len("BigqueryreservationBetaAssignmentStateEnum") :
        ]
