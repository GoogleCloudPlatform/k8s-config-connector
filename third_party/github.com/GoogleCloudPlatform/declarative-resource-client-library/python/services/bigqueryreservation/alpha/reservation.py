...
class Reservation(object):
    ...
    def apply(self):
        stub = reservation_pb2_grpc.BigqueryreservationAlphaReservationServiceStub(
            channel.Channel()
        )
        request = reservation_pb2.ApplyBigqueryreservationAlphaReservationRequest()
        ...
        response = stub.ApplyBigqueryreservationAlphaReservation(request)
    ...
    def delete(self):
        ...
        request = reservation_pb2.DeleteBigqueryreservationAlphaReservationRequest()
        request.service_account_file = self.service_account_file
        if Primitive.to_proto(self.name):
            request.resource.name = Primitive.to_proto(self.name)
        ...
        response = stub.DeleteBigqueryreservationAlphaReservation(request)
    ...
    def list(self, project, location, service_account_file=""):
        ...
        request = reservation_pb2.ListBigqueryreservationAlphaReservationRequest()
        request.service_account_file = service_account_file
        request.Project = project

        request.Location = location

        return stub.ListBigqueryreservationAlphaReservation(request).items

    def to_proto(self):
        resource = reservation_pb2.BigqueryreservationAlphaReservation()
        if Primitive.to_proto(self.name):
