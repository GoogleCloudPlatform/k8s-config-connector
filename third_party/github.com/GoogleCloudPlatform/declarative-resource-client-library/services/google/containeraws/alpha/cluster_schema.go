							...
							"controlPlane": &dcl.Property{
								...
								Properties: map[string]*dcl.Property{
									...
									"instancePlacement": &dcl.Property{
										Type:          "object",
										GoName:        "InstancePlacement",
										GoType:        "ClusterControlPlaneInstancePlacement",
										Description:   "Details of placement information for an instance.",
										Immutable:     true,
										ServerDefault: true,
										Properties: map[string]*dcl.Property{
											"tenancy": &dcl.Property{
												Type:          "string",
												GoName:        "Tenancy",
												GoType:        "ClusterControlPlaneInstancePlacementTenancyEnum",
									...
									"componentConfig": &dcl.Property{
										...
										Properties: map[string]*dcl.Property{
											"enableComponents": &dcl.Property{
												...
												Items: &dcl.Property{
													Type:   "string",
													GoType: "ClusterLoggingConfigComponentConfigEnableComponentsEnum",
													Enum: []string{
