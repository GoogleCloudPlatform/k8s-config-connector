...
func (r *WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig) UnmarshalJSON(data []byte) error {
	var res jsonWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig
	if err := json.Unmarshal(data, &res); err != nil {
		return err
	}
	...
	if len(m) == 0 {
		*r = *EmptyWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig
	} else {

		r.NamespacedGkeDeploymentTarget = res.NamespacedGkeDeploymentTarget

	}
	return nil
}

// This object is used to assert a desired state where this WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig is
// empty. Go lacks global const objects, but this object should be treated
// as one. Modifying this object will have undesirable results.
...
type jsonWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
...
func (r *WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) UnmarshalJSON(data []byte) error {
	var res jsonWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
	if err := json.Unmarshal(data, &res); err != nil {
		return err
	}
	...
	if len(m) == 0 {
		*r = *EmptyWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
	} else {

		r.TargetGkeCluster = res.TargetGkeCluster

		r.ClusterNamespace = res.ClusterNamespace

	}
	return nil
}

// This object is used to assert a desired state where this WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget is
// empty. Go lacks global const objects, but this object should be treated
// as one. Modifying this object will have undesirable results.
...
type jsonWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig

func (r *WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig) UnmarshalJSON(data []byte) error {
	var res jsonWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig
	if err := json.Unmarshal(data, &res); err != nil {
		return err
	}
	...
	if len(m) == 0 {
		*r = *EmptyWorkflowTemplatePlacementManagedClusterConfigMetastoreConfig
	} else {
...
// This object is used to assert a desired state where this WorkflowTemplatePlacementManagedClusterConfigMetastoreConfig is
// empty. Go lacks global const objects, but this object should be treated
// as one. Modifying this object will have undesirable results.
