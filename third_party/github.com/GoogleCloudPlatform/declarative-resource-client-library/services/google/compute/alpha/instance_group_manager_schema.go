				...
				"InstanceGroupManager": &dcl.Component{
					...
					SchemaProperty: dcl.Property{
						...
						Properties: map[string]*dcl.Property{
							...
							"failoverAction": &dcl.Property{
								Type:        "string",
								GoName:      "FailoverAction",
								GoType:      "InstanceGroupManagerFailoverActionEnum",
								...
								Properties: map[string]*dcl.Property{
									"preservedState": &dcl.Property{
										...
										Properties: map[string]*dcl.Property{
											...
											"externalIps": &dcl.Property{
												Type: "object",
												AdditionalProperties: &dcl.Property{
													Type:   "object",
													GoType: "InstanceGroupManagerStatefulPolicyPreservedStateExternalIps",
													Properties: map[string]*dcl.Property{
														"autoDelete": &dcl.Property{
															Type:        "string",
															GoName:      "AutoDelete",
															GoType:      "InstanceGroupManagerStatefulPolicyPreservedStateExternalIpsAutoDeleteEnum",
											...
											"internalIps": &dcl.Property{
												Type: "object",
												AdditionalProperties: &dcl.Property{
													Type:   "object",
													GoType: "InstanceGroupManagerStatefulPolicyPreservedStateInternalIps",
													Properties: map[string]*dcl.Property{
														"autoDelete": &dcl.Property{
															Type:        "string",
															GoName:      "AutoDelete",
															GoType:      "InstanceGroupManagerStatefulPolicyPreservedStateInternalIpsAutoDeleteEnum",
															Description: "These stateful IPs will never be released during autohealing, update or VM instance recreate operations. This flag is used to configure if the IP reservation should be deleted after it is no longer used by the group, e.g. when the given instance or the whole group is deleted. Possible values: NEVER, ON_PERMANENT_INSTANCE_DELETION",
															Enum: []string{
																"NEVER",
																"ON_PERMANENT_INSTANCE_DELETION",
							...
							"updatePolicy": &dcl.Property{
								...
								Properties: map[string]*dcl.Property{
									...
									"mostDisruptiveAllowedAction": &dcl.Property{
										Type:        "string",
										GoName:      "MostDisruptiveAllowedAction",
										GoType:      "InstanceGroupManagerUpdatePolicyMostDisruptiveAllowedActionEnum",
