	...
	return &dcl.Schema{
		...
		Components: &dcl.Components{
			Schemas: map[string]*dcl.Component{
				"AppleApp": &dcl.Component{
					Title:           "AppleApp",
					ID:              "projects/{{project}}/iosApps/{{name}}",
					...
					SchemaProperty: dcl.Property{
						...
						Properties: map[string]*dcl.Property{
							...
							"appId": &dcl.Property{
								...
								GoName:      "AppId",
								ReadOnly:    true,
								Description: "Output only. Immutable. The globally unique, Firebase-assigned identifier for the `AppleApp`. This identifier should be treated as an opaque token, as the data format is not specified.",
								Immutable:   true,
							},
							"appStoreId": &dcl.Property{
								Type:        "string",
								GoName:      "AppStoreId",
								Description: "The automatically generated Apple ID assigned to the Apple app by Apple in the Apple App Store.",
							},
							"bundleId": &dcl.Property{
								Type:        "string",
								GoName:      "BundleId",
								Description: "Immutable. The canonical bundle ID of the Apple app as it would appear in the Apple AppStore.",
								Immutable:   true,
							},
							...
							"projectId": &dcl.Property{
								...
								GoName:      "ProjectId",
								ReadOnly:    true,
								Description: "Output only. Immutable. A user-assigned unique identifier of the parent FirebaseProject for the `AppleApp`.",
								Immutable:   true,
							},
							"teamId": &dcl.Property{
								Type:        "string",
